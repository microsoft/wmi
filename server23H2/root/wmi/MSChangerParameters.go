...
func NewMSChangerParametersEx1(instance *cim.WmiInstance) (newInstance *MSChangerParameters, err error) {
...
func NewMSChangerParametersEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSChangerParameters, err error) {
