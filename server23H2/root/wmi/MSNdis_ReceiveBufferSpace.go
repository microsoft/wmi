...
func NewMSNdis_ReceiveBufferSpaceEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveBufferSpace, err error) {
...
func NewMSNdis_ReceiveBufferSpaceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_ReceiveBufferSpace, err error) {
