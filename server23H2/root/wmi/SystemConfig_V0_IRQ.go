...
func NewSystemConfig_V0_IRQEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_IRQ, err error) {
...
func NewSystemConfig_V0_IRQEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V0_IRQ, err error) {
