...
func NewSetInfoPolicy_StartEx1(instance *cim.WmiInstance) (newInstance *SetInfoPolicy_Start, err error) {
...
func NewSetInfoPolicy_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SetInfoPolicy_Start, err error) {
