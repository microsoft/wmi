...
func NewMSNdis_80211_ReceivedSignalStrengthEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_ReceivedSignalStrength, err error) {
...
func NewMSNdis_80211_ReceivedSignalStrengthEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_ReceivedSignalStrength, err error) {
