...
func NewKernelQueueDequeueEx1(instance *cim.WmiInstance) (newInstance *KernelQueueDequeue, err error) {
...
func NewKernelQueueDequeueEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *KernelQueueDequeue, err error) {
