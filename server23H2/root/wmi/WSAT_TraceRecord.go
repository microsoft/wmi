...
func NewWSAT_TraceRecordEx1(instance *cim.WmiInstance) (newInstance *WSAT_TraceRecord, err error) {
...
func NewWSAT_TraceRecordEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WSAT_TraceRecord, err error) {
