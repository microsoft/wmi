...
func NewSamAddMemToAliasEx1(instance *cim.WmiInstance) (newInstance *SamAddMemToAlias, err error) {
...
func NewSamAddMemToAliasEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamAddMemToAlias, err error) {
