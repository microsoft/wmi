...
func NewPageFault_VirtualRotateEx1(instance *cim.WmiInstance) (newInstance *PageFault_VirtualRotate, err error) {
...
func NewPageFault_VirtualRotateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PageFault_VirtualRotate, err error) {
