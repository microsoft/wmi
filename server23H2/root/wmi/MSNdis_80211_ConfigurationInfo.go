...
func NewMSNdis_80211_ConfigurationInfoEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_ConfigurationInfo, err error) {
...
func NewMSNdis_80211_ConfigurationInfoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_ConfigurationInfo, err error) {
