...
func NewSystemConfig_V2_LogDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_LogDisk, err error) {
...
func NewSystemConfig_V2_LogDiskEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_LogDisk, err error) {
