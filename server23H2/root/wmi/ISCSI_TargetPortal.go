...
func NewISCSI_TargetPortalEx1(instance *cim.WmiInstance) (newInstance *ISCSI_TargetPortal, err error) {
...
func NewISCSI_TargetPortalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ISCSI_TargetPortal, err error) {
