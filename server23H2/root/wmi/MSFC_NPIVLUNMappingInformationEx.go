...
func NewMSFC_NPIVLUNMappingInformationExEx1(instance *cim.WmiInstance) (newInstance *MSFC_NPIVLUNMappingInformationEx, err error) {
...
func NewMSFC_NPIVLUNMappingInformationExEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFC_NPIVLUNMappingInformationEx, err error) {
