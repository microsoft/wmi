...
func NewHeader_Extension_V1_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_Extension_V1_TypeGroup, err error) {
...
func NewHeader_Extension_V1_TypeGroupEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Header_Extension_V1_TypeGroup, err error) {
