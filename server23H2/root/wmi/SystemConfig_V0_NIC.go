...
func NewSystemConfig_V0_NICEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_NIC, err error) {
...
func NewSystemConfig_V0_NICEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V0_NIC, err error) {
