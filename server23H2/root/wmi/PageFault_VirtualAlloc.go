...
func NewPageFault_VirtualAllocEx1(instance *cim.WmiInstance) (newInstance *PageFault_VirtualAlloc, err error) {
...
func NewPageFault_VirtualAllocEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PageFault_VirtualAlloc, err error) {
