...
func NewKernelIdleStateChangeEx1(instance *cim.WmiInstance) (newInstance *KernelIdleStateChange, err error) {
...
func NewKernelIdleStateChangeEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *KernelIdleStateChange, err error) {
