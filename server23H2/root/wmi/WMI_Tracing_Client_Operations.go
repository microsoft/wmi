...
func NewWMI_Tracing_Client_OperationsEx1(instance *cim.WmiInstance) (newInstance *WMI_Tracing_Client_Operations, err error) {
...
func NewWMI_Tracing_Client_OperationsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WMI_Tracing_Client_Operations, err error) {
