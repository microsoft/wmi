...
func NewRegistry_HiveDestroyEx1(instance *cim.WmiInstance) (newInstance *Registry_HiveDestroy, err error) {
...
func NewRegistry_HiveDestroyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Registry_HiveDestroy, err error) {
