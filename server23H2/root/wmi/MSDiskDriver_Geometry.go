...
func NewMSDiskDriver_GeometryEx1(instance *cim.WmiInstance) (newInstance *MSDiskDriver_Geometry, err error) {
...
func NewMSDiskDriver_GeometryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSDiskDriver_Geometry, err error) {
