...
func NewSystemConfig_V2_ServicesEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_Services, err error) {
...
func NewSystemConfig_V2_ServicesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_Services, err error) {
