...
func NewHeapTraceProviderEx1(instance *cim.WmiInstance) (newInstance *HeapTraceProvider, err error) {
...
func NewHeapTraceProviderEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HeapTraceProvider, err error) {
