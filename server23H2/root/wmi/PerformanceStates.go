...
func NewPerformanceStatesEx1(instance *cim.WmiInstance) (newInstance *PerformanceStates, err error) {
...
func NewPerformanceStatesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PerformanceStates, err error) {
