...
func NewSystemConfig_V1_PhyDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_PhyDisk, err error) {
...
func NewSystemConfig_V1_PhyDiskEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V1_PhyDisk, err error) {
