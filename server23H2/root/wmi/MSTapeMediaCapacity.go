...
func NewMSTapeMediaCapacityEx1(instance *cim.WmiInstance) (newInstance *MSTapeMediaCapacity, err error) {
...
func NewMSTapeMediaCapacityEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSTapeMediaCapacity, err error) {
