...
func NewUdpIp_TypeGroup2Ex1(instance *cim.WmiInstance) (newInstance *UdpIp_TypeGroup2, err error) {
...
func NewUdpIp_TypeGroup2Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *UdpIp_TypeGroup2, err error) {
