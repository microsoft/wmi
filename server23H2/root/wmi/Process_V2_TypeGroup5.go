...
func NewProcess_V2_TypeGroup5Ex1(instance *cim.WmiInstance) (newInstance *Process_V2_TypeGroup5, err error) {
...
func NewProcess_V2_TypeGroup5Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Process_V2_TypeGroup5, err error) {
