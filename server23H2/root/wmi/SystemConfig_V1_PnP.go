...
func NewSystemConfig_V1_PnPEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_PnP, err error) {
...
func NewSystemConfig_V1_PnPEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V1_PnP, err error) {
