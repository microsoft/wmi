...
func NewRegistry_V0_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Registry_V0_TypeGroup1, err error) {
	tmp, err := NewRegistry_V0Ex1(instance)
...
func NewRegistry_V0_TypeGroup1Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Registry_V0_TypeGroup1, err error) {
	tmp, err := NewRegistry_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
