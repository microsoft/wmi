...
func NewMSNdis_80211_ReloadDefaultsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_ReloadDefaults, err error) {
...
func NewMSNdis_80211_ReloadDefaultsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_ReloadDefaults, err error) {
