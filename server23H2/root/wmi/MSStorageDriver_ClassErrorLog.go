...
func NewMSStorageDriver_ClassErrorLogEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_ClassErrorLog, err error) {
...
func NewMSStorageDriver_ClassErrorLogEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSStorageDriver_ClassErrorLog, err error) {
