...
func NewMSNdis_FddiDownstreamNodeLongEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiDownstreamNodeLong, err error) {
...
func NewMSNdis_FddiDownstreamNodeLongEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_FddiDownstreamNodeLong, err error) {
