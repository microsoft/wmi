...
func NewSystemConfig_V0_LogDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_LogDisk, err error) {
...
func NewSystemConfig_V0_LogDiskEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V0_LogDisk, err error) {
