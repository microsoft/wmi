...
func NewHeapCommitDecommitEx1(instance *cim.WmiInstance) (newInstance *HeapCommitDecommit, err error) {
...
func NewHeapCommitDecommitEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HeapCommitDecommit, err error) {
