...
func NewMSNdis_SetHDSplitParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_SetHDSplitParameters, err error) {
...
func NewMSNdis_SetHDSplitParametersEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_SetHDSplitParameters, err error) {
...
func (instance *MSNdis_SetHDSplitParameters) WmiSetHDSplitParameters( /* IN */ MethodHeader MSNdis_WmiMethodHeader,
	...
	_, err = instance.InvokeMethod("WmiSetHDSplitParameters", MethodHeader, HDSplitParameters)
	if err != nil {
		return
	}
	return
