...
func NewWmiMonitorBrightnessEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorBrightness, err error) {
...
func NewWmiMonitorBrightnessEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WmiMonitorBrightness, err error) {
