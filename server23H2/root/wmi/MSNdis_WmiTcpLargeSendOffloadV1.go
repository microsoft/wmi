...
func NewMSNdis_WmiTcpLargeSendOffloadV1Ex1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiTcpLargeSendOffloadV1, err error) {
...
func NewMSNdis_WmiTcpLargeSendOffloadV1Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_WmiTcpLargeSendOffloadV1, err error) {
