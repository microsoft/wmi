...
func NewSystemConfig_V1_CPUEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_CPU, err error) {
...
func NewSystemConfig_V1_CPUEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V1_CPU, err error) {
