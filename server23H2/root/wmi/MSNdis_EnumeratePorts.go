...
func NewMSNdis_EnumeratePortsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_EnumeratePorts, err error) {
...
func NewMSNdis_EnumeratePortsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_EnumeratePorts, err error) {
...
func (instance *MSNdis_EnumeratePorts) WmiEnumeratePorts( /* IN */ Header MSNdis_WmiMethodHeader,
	/* OUT */ Ports MSNdis_PortArray) (err error) {
	_, err = instance.InvokeMethod("WmiEnumeratePorts", Header)
	if err != nil {
		return
	}
	return
