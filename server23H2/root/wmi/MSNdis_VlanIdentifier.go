...
func NewMSNdis_VlanIdentifierEx1(instance *cim.WmiInstance) (newInstance *MSNdis_VlanIdentifier, err error) {
...
func NewMSNdis_VlanIdentifierEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_VlanIdentifier, err error) {
