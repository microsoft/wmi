...
func NewMSNdis_ReceiveQueueInfoArrayEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveQueueInfoArray, err error) {
...
func NewMSNdis_ReceiveQueueInfoArrayEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_ReceiveQueueInfoArray, err error) {
