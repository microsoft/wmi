...
func NewMSNdis_FddiFramesLostEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiFramesLost, err error) {
...
func NewMSNdis_FddiFramesLostEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_FddiFramesLost, err error) {
