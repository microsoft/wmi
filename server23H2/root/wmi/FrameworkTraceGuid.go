...
func NewFrameworkTraceGuidEx1(instance *cim.WmiInstance) (newInstance *FrameworkTraceGuid, err error) {
...
func NewFrameworkTraceGuidEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FrameworkTraceGuid, err error) {
