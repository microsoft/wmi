...
func NewMSNdis_TcpOffloadCurrentConfigEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TcpOffloadCurrentConfig, err error) {
...
func NewMSNdis_TcpOffloadCurrentConfigEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_TcpOffloadCurrentConfig, err error) {
...
func (instance *MSNdis_TcpOffloadCurrentConfig) WmiQueryCurrentOffloadConfig( /* IN */ Header MSNdis_WmiMethodHeader,
	...
	_, err = instance.InvokeMethod("WmiQueryCurrentOffloadConfig", Header)
	if err != nil {
		return
	}
	return
