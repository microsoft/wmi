...
func NewSamShutdownSamSrv_StartEx1(instance *cim.WmiInstance) (newInstance *SamShutdownSamSrv_Start, err error) {
...
func NewSamShutdownSamSrv_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamShutdownSamSrv_Start, err error) {
