...
func NewSamAddMemGrp_StartEx1(instance *cim.WmiInstance) (newInstance *SamAddMemGrp_Start, err error) {
...
func NewSamAddMemGrp_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamAddMemGrp_Start, err error) {
