...
func NewMSNdis_WmiIPSecOffloadV1_IPv4ESPEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiIPSecOffloadV1_IPv4ESP, err error) {
...
func NewMSNdis_WmiIPSecOffloadV1_IPv4ESPEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_WmiIPSecOffloadV1_IPv4ESP, err error) {
