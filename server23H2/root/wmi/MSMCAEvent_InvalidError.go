...
func NewMSMCAEvent_InvalidErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_InvalidError, err error) {
...
func NewMSMCAEvent_InvalidErrorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSMCAEvent_InvalidError, err error) {
