...
func NewSystemConfig_V3_IRQEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V3_IRQ, err error) {
...
func NewSystemConfig_V3_IRQEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V3_IRQ, err error) {
