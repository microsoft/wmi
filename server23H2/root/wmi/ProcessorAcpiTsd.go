...
func NewProcessorAcpiTsdEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiTsd, err error) {
...
func NewProcessorAcpiTsdEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ProcessorAcpiTsd, err error) {
