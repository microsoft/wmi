...
func NewIdleStateAccountingExEx1(instance *cim.WmiInstance) (newInstance *IdleStateAccountingEx, err error) {
...
func NewIdleStateAccountingExEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *IdleStateAccountingEx, err error) {
