...
func NewHeapAffinitySlotAssignedEx1(instance *cim.WmiInstance) (newInstance *HeapAffinitySlotAssigned, err error) {
...
func NewHeapAffinitySlotAssignedEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HeapAffinitySlotAssigned, err error) {
