...
func NewNtlmValidateUser_EndEx1(instance *cim.WmiInstance) (newInstance *NtlmValidateUser_End, err error) {
...
func NewNtlmValidateUser_EndEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *NtlmValidateUser_End, err error) {
