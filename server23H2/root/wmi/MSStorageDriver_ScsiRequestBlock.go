...
func NewMSStorageDriver_ScsiRequestBlockEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_ScsiRequestBlock, err error) {
...
func NewMSStorageDriver_ScsiRequestBlockEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSStorageDriver_ScsiRequestBlock, err error) {
