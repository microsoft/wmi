...
func NewMSiSCSI_LB_OperationsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_LB_Operations, err error) {
...
func NewMSiSCSI_LB_OperationsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSiSCSI_LB_Operations, err error) {
...
func (instance *MSiSCSI_LB_Operations) SetLoadBalancePolicy( /* IN */ LoadBalancePolicies ISCSI_Supported_LB_Policies,
	...
	_, err = instance.InvokeMethod("SetLoadBalancePolicy", LoadBalancePolicies)
	if err != nil {
		return
	}
	return
