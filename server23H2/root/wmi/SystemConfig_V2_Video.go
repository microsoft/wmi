...
func NewSystemConfig_V2_VideoEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_Video, err error) {
...
func NewSystemConfig_V2_VideoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_Video, err error) {
