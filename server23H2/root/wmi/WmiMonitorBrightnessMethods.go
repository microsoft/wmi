...
func NewWmiMonitorBrightnessMethodsEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorBrightnessMethods, err error) {
...
func NewWmiMonitorBrightnessMethodsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WmiMonitorBrightnessMethods, err error) {
...
func (instance *WmiMonitorBrightnessMethods) WmiSetBrightness( /* IN */ Timeout uint32,
	/* IN */ Brightness uint8) (err error) {
	_, err = instance.InvokeMethodWithReturn("WmiSetBrightness", Timeout, Brightness)
	if err != nil {
		return
	}
	return
...
func (instance *WmiMonitorBrightnessMethods) WmiRevertToPolicyBrightness() (err error) {
	_, err = instance.InvokeMethodWithReturn("WmiRevertToPolicyBrightness")
	if err != nil {
		return
	}
	return
...
func (instance *WmiMonitorBrightnessMethods) WmiSetALSBrightnessState( /* IN */ State bool) (err error) {
	_, err = instance.InvokeMethodWithReturn("WmiSetALSBrightnessState", State)
	if err != nil {
		return
	}
	return
...
// <param name="Brightness" type="uint8 "></param>
func (instance *WmiMonitorBrightnessMethods) WmiSetALSBrightness( /* IN */ Brightness uint8) (err error) {
	_, err = instance.InvokeMethodWithReturn("WmiSetALSBrightness", Brightness)
	if err != nil {
		return
	}
	return
