...
func NewMSNdis_ReceiveQueueParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveQueueParameters, err error) {
...
func NewMSNdis_ReceiveQueueParametersEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_ReceiveQueueParameters, err error) {
