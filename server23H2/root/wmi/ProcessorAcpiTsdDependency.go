...
func NewProcessorAcpiTsdDependencyEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiTsdDependency, err error) {
...
func NewProcessorAcpiTsdDependencyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ProcessorAcpiTsdDependency, err error) {
