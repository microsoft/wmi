...
func NewProcessorAcpiTssStateEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiTssState, err error) {
...
func NewProcessorAcpiTssStateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ProcessorAcpiTssState, err error) {
