...
func NewMS_SM_FabricAndDomainManagementMethodsEx1(instance *cim.WmiInstance) (newInstance *MS_SM_FabricAndDomainManagementMethods, err error) {
...
func NewMS_SM_FabricAndDomainManagementMethodsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MS_SM_FabricAndDomainManagementMethods, err error) {
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendTEST( /* IN */ HbaPortWWN []uint8,
	...
	_, err = instance.InvokeMethod("SM_SendTEST", HbaPortWWN, DestWWN, DestFCID, ReqBufferSize, ReqBuffer)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendECHO( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendECHO", HbaPortWWN, DestWWN, DestFCID, InRespBufferMaxSize, ReqBufferSize, ReqBuffer)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendSMPPassThru( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendSMPPassThru", HbaPortWWN, DestPortWWN, DomainPortWWN, InRespBufferMaxSize, ReqBufferSize, ReqBuffer)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendCTPassThru( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendCTPassThru", HbaPortWWN, InRespBufferMaxSize, ReqBufferSize, ReqBuffer)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_GetRNIDMgmtInfo( /* OUT */ HBAStatus uint32,
	...
	_, err = instance.InvokeMethod("SM_GetRNIDMgmtInfo")
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SetRNIDMgmtInfo( /* IN */ MgmtInfo HBAFC3MgmtInfo,
	/* OUT */ HBAStatus uint32) (err error) {
	_, err = instance.InvokeMethod("SM_SetRNIDMgmtInfo", MgmtInfo)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendRNID( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendRNID", HbaPortWWN, DestWWN, DestFCID, NodeIdDataFormat, InRespBufferMaxSize)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendRPL( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendRPL", HbaPortWWN, AgentWWN, AgentDomain, PortIndex, InRespBufferMaxSize)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendRPS( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendRPS", HbaPortWWN, AgentWWN, ObjectWWN, AgentDomain, ObjectPortNumber, InRespBufferMaxSize)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendSRL( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendSRL", HbaPortWWN, WWN, Domain, InRespBufferMaxSize)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendLIRR( /* IN */ SourceWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendLIRR", SourceWWN, DestWWN, Function, Type, InRespBufferMaxSize)
	if err != nil {
		return
	}
	return
...
func (instance *MS_SM_FabricAndDomainManagementMethods) SM_SendRLS( /* IN */ HbaPortWWN []uint8,
	...
	/* OUT */ OutRespBufferSize uint32,
	/* OUT */ RespBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("SM_SendRLS", HbaPortWWN, DestWWN, InRespBufferMaxSize)
	if err != nil {
		return
	}
	return
