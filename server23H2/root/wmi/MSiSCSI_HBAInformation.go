...
func NewMSiSCSI_HBAInformationEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_HBAInformation, err error) {
...
func NewMSiSCSI_HBAInformationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSiSCSI_HBAInformation, err error) {
