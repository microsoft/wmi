...
func NewEnumTrustedDoms_EndEx1(instance *cim.WmiInstance) (newInstance *EnumTrustedDoms_End, err error) {
...
func NewEnumTrustedDoms_EndEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *EnumTrustedDoms_End, err error) {
