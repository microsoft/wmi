...
func NewSystemConfig_V1_NICEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_NIC, err error) {
...
func NewSystemConfig_V1_NICEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V1_NIC, err error) {
