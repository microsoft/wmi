...
func NewSamCompCreate_StartEx1(instance *cim.WmiInstance) (newInstance *SamCompCreate_Start, err error) {
...
func NewSamCompCreate_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamCompCreate_Start, err error) {
