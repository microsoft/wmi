...
func NewHeader_DbgIdRSDS_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_DbgIdRSDS_TypeGroup, err error) {
...
func NewHeader_DbgIdRSDS_TypeGroupEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Header_DbgIdRSDS_TypeGroup, err error) {
