...
func NewNlSecChanlSetup_EndEx1(instance *cim.WmiInstance) (newInstance *NlSecChanlSetup_End, err error) {
...
func NewNlSecChanlSetup_EndEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *NlSecChanlSetup_End, err error) {
