...
func NewISCSI_IP_AddressEx1(instance *cim.WmiInstance) (newInstance *ISCSI_IP_Address, err error) {
...
func NewISCSI_IP_AddressEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ISCSI_IP_Address, err error) {
