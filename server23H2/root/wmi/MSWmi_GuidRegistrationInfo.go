...
func NewMSWmi_GuidRegistrationInfoEx1(instance *cim.WmiInstance) (newInstance *MSWmi_GuidRegistrationInfo, err error) {
...
func NewMSWmi_GuidRegistrationInfoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSWmi_GuidRegistrationInfo, err error) {
