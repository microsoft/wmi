...
func NewSamEnumAliasesInDomEx1(instance *cim.WmiInstance) (newInstance *SamEnumAliasesInDom, err error) {
...
func NewSamEnumAliasesInDomEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamEnumAliasesInDom, err error) {
