...
func NewMSNdis_PMAdminConfigParamEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PMAdminConfigParam, err error) {
...
func NewMSNdis_PMAdminConfigParamEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_PMAdminConfigParam, err error) {
