...
func NewMS_SMHBA_SCSIENTRYEx1(instance *cim.WmiInstance) (newInstance *MS_SMHBA_SCSIENTRY, err error) {
...
func NewMS_SMHBA_SCSIENTRYEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MS_SMHBA_SCSIENTRY, err error) {
