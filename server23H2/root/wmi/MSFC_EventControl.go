...
func NewMSFC_EventControlEx1(instance *cim.WmiInstance) (newInstance *MSFC_EventControl, err error) {
...
func NewMSFC_EventControlEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFC_EventControl, err error) {
...
func (instance *MSFC_EventControl) AddTarget( /* IN */ HbaPortWWN []uint8,
	...
	_, err = instance.InvokeMethod("AddTarget", HbaPortWWN, DiscoveredPortWWN, AllTargets)
	if err != nil {
		return
	}
	return
...
func (instance *MSFC_EventControl) RemoveTarget( /* IN */ HbaPortWWN []uint8,
	...
	/* IN */ AllTargets uint32,
	/* OUT */ HBAStatus uint32) (err error) {
	_, err = instance.InvokeMethod("RemoveTarget", HbaPortWWN, DiscoveredPortWWN, AllTargets)
	if err != nil {
		return
	}
	return
...
func (instance *MSFC_EventControl) AddPort( /* IN */ PortWWN []uint8,
	/* OUT */ HBAStatus uint32) (err error) {
	_, err = instance.InvokeMethod("AddPort", PortWWN)
	if err != nil {
		return
	}
	return
...
func (instance *MSFC_EventControl) RemovePort( /* IN */ PortWWN []uint8,
	/* OUT */ HBAStatus uint32) (err error) {
	_, err = instance.InvokeMethod("RemovePort", PortWWN)
	if err != nil {
		return
	}
	return
...
// <param name="HBAStatus" type="uint32 "></param>
func (instance *MSFC_EventControl) AddLink( /* OUT */ HBAStatus uint32) (err error) {
	_, err = instance.InvokeMethod("AddLink")
	if err != nil {
		return
	}
	return
...
// <param name="HBAStatus" type="uint32 "></param>
func (instance *MSFC_EventControl) RemoveLink( /* OUT */ HBAStatus uint32) (err error) {
	_, err = instance.InvokeMethod("RemoveLink")
	if err != nil {
		return
	}
	return
