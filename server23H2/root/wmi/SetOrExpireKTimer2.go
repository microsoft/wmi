...
func NewSetOrExpireKTimer2Ex1(instance *cim.WmiInstance) (newInstance *SetOrExpireKTimer2, err error) {
...
func NewSetOrExpireKTimer2Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SetOrExpireKTimer2, err error) {
