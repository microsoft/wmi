...
func NewImage_V0_LoadEx1(instance *cim.WmiInstance) (newInstance *Image_V0_Load, err error) {
	tmp, err := NewImage_V0Ex1(instance)
...
func NewImage_V0_LoadEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Image_V0_Load, err error) {
	tmp, err := NewImage_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
