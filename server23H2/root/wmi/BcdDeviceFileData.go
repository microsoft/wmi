...
func NewBcdDeviceFileDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceFileData, err error) {
...
func NewBcdDeviceFileDataEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *BcdDeviceFileData, err error) {
