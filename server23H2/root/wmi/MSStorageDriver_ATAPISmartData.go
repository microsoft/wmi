...
func NewMSStorageDriver_ATAPISmartDataEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_ATAPISmartData, err error) {
...
func NewMSStorageDriver_ATAPISmartDataEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSStorageDriver_ATAPISmartData, err error) {
