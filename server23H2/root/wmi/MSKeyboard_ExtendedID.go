...
func NewMSKeyboard_ExtendedIDEx1(instance *cim.WmiInstance) (newInstance *MSKeyboard_ExtendedID, err error) {
...
func NewMSKeyboard_ExtendedIDEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSKeyboard_ExtendedID, err error) {
