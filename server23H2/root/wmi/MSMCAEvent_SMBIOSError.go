...
func NewMSMCAEvent_SMBIOSErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_SMBIOSError, err error) {
...
func NewMSMCAEvent_SMBIOSErrorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSMCAEvent_SMBIOSError, err error) {
