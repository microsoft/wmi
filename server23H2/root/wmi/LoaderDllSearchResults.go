...
func NewLoaderDllSearchResultsEx1(instance *cim.WmiInstance) (newInstance *LoaderDllSearchResults, err error) {
...
func NewLoaderDllSearchResultsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *LoaderDllSearchResults, err error) {
