...
func NewISCSI_Supported_LB_PoliciesEx1(instance *cim.WmiInstance) (newInstance *ISCSI_Supported_LB_Policies, err error) {
...
func NewISCSI_Supported_LB_PoliciesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ISCSI_Supported_LB_Policies, err error) {
