...
func NewMSNdis_PMAdminConfigStateEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PMAdminConfigState, err error) {
...
func NewMSNdis_PMAdminConfigStateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_PMAdminConfigState, err error) {
