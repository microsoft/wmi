...
func NewMSiSCSIInitiator_PersistentDevicesEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_PersistentDevices, err error) {
...
func NewMSiSCSIInitiator_PersistentDevicesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSiSCSIInitiator_PersistentDevices, err error) {
