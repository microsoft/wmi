...
const (
	...
	BusError_Participation_Local_Processor_Responded_To_Request BusError_Participation = 1
	// Local_Processor_Observed_Error_As_Third_Party enum
	BusError_Participation_Local_Processor_Observed_Error_As_Third_Party BusError_Participation = 2
	// Generic enum
