...
func NewMSNdis_LinkParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_LinkParameters, err error) {
...
func NewMSNdis_LinkParametersEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_LinkParameters, err error) {
