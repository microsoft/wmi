...
func NewMS_SMHBA_FC_PortEx1(instance *cim.WmiInstance) (newInstance *MS_SMHBA_FC_Port, err error) {
...
func NewMS_SMHBA_FC_PortEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MS_SMHBA_FC_Port, err error) {
