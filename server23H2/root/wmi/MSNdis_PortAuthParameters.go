...
func NewMSNdis_PortAuthParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PortAuthParameters, err error) {
...
func NewMSNdis_PortAuthParametersEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_PortAuthParameters, err error) {
