...
func NewWmiMonitorColorXYZinCIEEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorColorXYZinCIE, err error) {
...
func NewWmiMonitorColorXYZinCIEEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WmiMonitorColorXYZinCIE, err error) {
