...
func NewSystemConfig_V4_MobilePlatformEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V4_MobilePlatform, err error) {
...
func NewSystemConfig_V4_MobilePlatformEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V4_MobilePlatform, err error) {
