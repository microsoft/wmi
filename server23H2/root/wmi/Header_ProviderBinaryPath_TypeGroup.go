...
func NewHeader_ProviderBinaryPath_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_ProviderBinaryPath_TypeGroup, err error) {
...
func NewHeader_ProviderBinaryPath_TypeGroupEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Header_ProviderBinaryPath_TypeGroup, err error) {
