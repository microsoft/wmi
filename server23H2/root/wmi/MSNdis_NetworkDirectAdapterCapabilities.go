...
func NewMSNdis_NetworkDirectAdapterCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NetworkDirectAdapterCapabilities, err error) {
...
func NewMSNdis_NetworkDirectAdapterCapabilitiesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_NetworkDirectAdapterCapabilities, err error) {
