...
func NewISCSI_TargetPortalGroupEx1(instance *cim.WmiInstance) (newInstance *ISCSI_TargetPortalGroup, err error) {
...
func NewISCSI_TargetPortalGroupEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ISCSI_TargetPortalGroup, err error) {
