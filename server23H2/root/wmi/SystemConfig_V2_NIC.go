...
func NewSystemConfig_V2_NICEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_NIC, err error) {
...
func NewSystemConfig_V2_NICEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_NIC, err error) {
