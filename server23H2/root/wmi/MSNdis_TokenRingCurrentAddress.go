...
func NewMSNdis_TokenRingCurrentAddressEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TokenRingCurrentAddress, err error) {
...
func NewMSNdis_TokenRingCurrentAddressEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_TokenRingCurrentAddress, err error) {
