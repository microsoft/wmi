...
func NewSystemConfig_V0_CPUEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_CPU, err error) {
...
func NewSystemConfig_V0_CPUEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V0_CPU, err error) {
