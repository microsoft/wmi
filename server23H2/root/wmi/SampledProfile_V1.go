...
func NewSampledProfile_V1Ex1(instance *cim.WmiInstance) (newInstance *SampledProfile_V1, err error) {
...
func NewSampledProfile_V1Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SampledProfile_V1, err error) {
