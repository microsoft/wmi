...
func NewDriverCompleteRequestReturnEx1(instance *cim.WmiInstance) (newInstance *DriverCompleteRequestReturn, err error) {
...
func NewDriverCompleteRequestReturnEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DriverCompleteRequestReturn, err error) {
