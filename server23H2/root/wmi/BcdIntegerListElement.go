...
func NewBcdIntegerListElementEx1(instance *cim.WmiInstance) (newInstance *BcdIntegerListElement, err error) {
...
func NewBcdIntegerListElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *BcdIntegerListElement, err error) {
