...
func NewMSNdis_StatusLinkStateEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusLinkState, err error) {
...
func NewMSNdis_StatusLinkStateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_StatusLinkState, err error) {
