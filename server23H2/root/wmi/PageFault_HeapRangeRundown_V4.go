...
func NewPageFault_HeapRangeRundown_V4Ex1(instance *cim.WmiInstance) (newInstance *PageFault_HeapRangeRundown_V4, err error) {
	tmp, err := NewPageFaultEx1(instance)
...
func NewPageFault_HeapRangeRundown_V4Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PageFault_HeapRangeRundown_V4, err error) {
	tmp, err := NewPageFaultEx6(hostName, wmiNamespace, userName, password, domainName, query)
