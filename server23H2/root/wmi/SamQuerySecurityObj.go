...
func NewSamQuerySecurityObjEx1(instance *cim.WmiInstance) (newInstance *SamQuerySecurityObj, err error) {
...
func NewSamQuerySecurityObjEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamQuerySecurityObj, err error) {
