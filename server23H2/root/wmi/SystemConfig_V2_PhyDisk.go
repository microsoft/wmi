...
func NewSystemConfig_V2_PhyDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_PhyDisk, err error) {
...
func NewSystemConfig_V2_PhyDiskEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_PhyDisk, err error) {
