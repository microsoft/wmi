...
func NewSamSetMemAttrsOfGrp_StartEx1(instance *cim.WmiInstance) (newInstance *SamSetMemAttrsOfGrp_Start, err error) {
...
func NewSamSetMemAttrsOfGrp_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamSetMemAttrsOfGrp_Start, err error) {
