...
func NewISCSI_RedirectSessionInfoEx1(instance *cim.WmiInstance) (newInstance *ISCSI_RedirectSessionInfo, err error) {
...
func NewISCSI_RedirectSessionInfoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ISCSI_RedirectSessionInfo, err error) {
