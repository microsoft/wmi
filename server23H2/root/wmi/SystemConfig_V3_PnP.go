...
func NewSystemConfig_V3_PnPEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V3_PnP, err error) {
...
func NewSystemConfig_V3_PnPEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V3_PnP, err error) {
