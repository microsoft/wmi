...
func NewTcpIp_TypeGroup4Ex1(instance *cim.WmiInstance) (newInstance *TcpIp_TypeGroup4, err error) {
...
func NewTcpIp_TypeGroup4Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *TcpIp_TypeGroup4, err error) {
