...
func NewMSNdis_80211_ReceiveAntennaSelectedEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_ReceiveAntennaSelected, err error) {
...
func NewMSNdis_80211_ReceiveAntennaSelectedEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_ReceiveAntennaSelected, err error) {
