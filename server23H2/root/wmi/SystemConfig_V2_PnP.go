...
func NewSystemConfig_V2_PnPEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_PnP, err error) {
...
func NewSystemConfig_V2_PnPEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_PnP, err error) {
