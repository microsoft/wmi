...
func NewMSiSCSIInitiator_PortalEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_Portal, err error) {
...
func NewMSiSCSIInitiator_PortalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSiSCSIInitiator_Portal, err error) {
