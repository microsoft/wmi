...
func NewMSNdis_NotifyAdapterRemovalEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NotifyAdapterRemoval, err error) {
...
func NewMSNdis_NotifyAdapterRemovalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_NotifyAdapterRemoval, err error) {
