...
func NewSamEnumAliasesInDom_StartEx1(instance *cim.WmiInstance) (newInstance *SamEnumAliasesInDom_Start, err error) {
...
func NewSamEnumAliasesInDom_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamEnumAliasesInDom_Start, err error) {
