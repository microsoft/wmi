...
func NewMSFC_DH_Chap_ParametersEx1(instance *cim.WmiInstance) (newInstance *MSFC_DH_Chap_Parameters, err error) {
...
func NewMSFC_DH_Chap_ParametersEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFC_DH_Chap_Parameters, err error) {
