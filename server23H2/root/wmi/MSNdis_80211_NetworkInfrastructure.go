...
func NewMSNdis_80211_NetworkInfrastructureEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_NetworkInfrastructure, err error) {
...
func NewMSNdis_80211_NetworkInfrastructureEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_NetworkInfrastructure, err error) {
