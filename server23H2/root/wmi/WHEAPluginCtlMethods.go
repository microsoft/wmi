...
func NewWHEAPluginCtlMethodsEx1(instance *cim.WmiInstance) (newInstance *WHEAPluginCtlMethods, err error) {
...
func NewWHEAPluginCtlMethodsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WHEAPluginCtlMethods, err error) {
...
func (instance *WHEAPluginCtlMethods) WheaPluginCtlInterfaceRtn( /* IN */ InputLength uint32,
	...
	/* OUT */ OutputBuffer []uint8) (err error) {
	_, err = instance.InvokeMethod("WheaPluginCtlInterfaceRtn", InputLength, InputBuffer)
	if err != nil {
		return
	}
	return
