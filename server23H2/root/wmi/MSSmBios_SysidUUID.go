...
func NewMSSmBios_SysidUUIDEx1(instance *cim.WmiInstance) (newInstance *MSSmBios_SysidUUID, err error) {
...
func NewMSSmBios_SysidUUIDEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSSmBios_SysidUUID, err error) {
