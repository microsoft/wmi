...
func NewTcpIp_V1_TypeGroup2Ex1(instance *cim.WmiInstance) (newInstance *TcpIp_V1_TypeGroup2, err error) {
...
func NewTcpIp_V1_TypeGroup2Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *TcpIp_V1_TypeGroup2, err error) {
