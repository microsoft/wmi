...
func NewSystemConfig_V1_VideoEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_Video, err error) {
...
func NewSystemConfig_V1_VideoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V1_Video, err error) {
