...
func NewCIM_ResourcePoolConfigurationServiceEx1(instance *cim.WmiInstance) (newInstance *CIM_ResourcePoolConfigurationService, err error) {
...
func NewCIM_ResourcePoolConfigurationServiceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CIM_ResourcePoolConfigurationService, err error) {
...
func (instance *CIM_ResourcePoolConfigurationService) CreateResourcePool( /* IN */ ElementName string,
	...
	retVal, err := instance.InvokeMethodAsync("CreateResourcePool", Action, PercentComplete, Timeout, ElementName, HostResources, ResourceType)
	if err != nil {
		return
	}
...
func (instance *CIM_ResourcePoolConfigurationService) CreateChildResourcePool( /* IN */ ElementName string,
	...
	/*Custon IN*/ PercentComplete uint32,
	/*Custon IN*/ Timeout uint32) (result uint32, err error) {
	retVal, err := instance.InvokeMethodAsync("CreateChildResourcePool", Action, PercentComplete, Timeout, ElementName, Settings, ParentPool)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *CIM_ResourcePoolConfigurationService) DeleteResourcePool( /* IN */ Pool CIM_ResourcePool,
	...
	/*Custon IN*/ PercentComplete uint32,
	/*Custon IN*/ Timeout uint32) (result uint32, err error) {
	retVal, err := instance.InvokeMethodAsync("DeleteResourcePool", Action, PercentComplete, Timeout, Pool)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *CIM_ResourcePoolConfigurationService) AddResourcesToResourcePool( /* IN */ HostResources []CIM_LogicalDevice,
	...
	/*Custon IN*/ PercentComplete uint32,
	/*Custon IN*/ Timeout uint32) (result uint32, err error) {
	retVal, err := instance.InvokeMethodAsync("AddResourcesToResourcePool", Action, PercentComplete, Timeout, HostResources, Pool)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *CIM_ResourcePoolConfigurationService) RemoveResourcesFromResourcePool( /* IN */ HostResources []CIM_LogicalDevice,
	...
	/*Custon IN*/ PercentComplete uint32,
	/*Custon IN*/ Timeout uint32) (result uint32, err error) {
	retVal, err := instance.InvokeMethodAsync("RemoveResourcesFromResourcePool", Action, PercentComplete, Timeout, HostResources, Pool)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *CIM_ResourcePoolConfigurationService) ChangeParentResourcePool( /* IN */ ChildPool CIM_ResourcePool,
	...
	/*Custon IN*/ PercentComplete uint32,
	/*Custon IN*/ Timeout uint32) (result uint32, err error) {
	retVal, err := instance.InvokeMethodAsync("ChangeParentResourcePool", Action, PercentComplete, Timeout, ChildPool, ParentPool, Settings)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
