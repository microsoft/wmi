...
const (
	...
	// Firmware enum
	VirtualSystemSettingData_VirtualSlitType_Firmware VirtualSystemSettingData_VirtualSlitType = 1
	// Measured enum
	VirtualSystemSettingData_VirtualSlitType_Measured VirtualSystemSettingData_VirtualSlitType = 2
