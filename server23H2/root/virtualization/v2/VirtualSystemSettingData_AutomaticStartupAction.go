...
const (
	...
	VirtualSystemSettingData_AutomaticStartupAction_Restart_if_previously_active VirtualSystemSettingData_AutomaticStartupAction = 3
	// Always_startup enum
	VirtualSystemSettingData_AutomaticStartupAction_Always_startup VirtualSystemSettingData_AutomaticStartupAction = 4
	// DMTF_Reserved enum
