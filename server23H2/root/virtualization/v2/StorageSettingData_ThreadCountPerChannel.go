...
const (
	...
	// Low enum
	StorageSettingData_ThreadCountPerChannel_Low StorageSettingData_ThreadCountPerChannel = 1
	// Medium enum
	StorageSettingData_ThreadCountPerChannel_Medium StorageSettingData_ThreadCountPerChannel = 2
	// High enum
