...
func NewMsvm_EthernetSwitchPortAclSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPortAclSettingData, err error) {
...
func NewMsvm_EthernetSwitchPortAclSettingDataEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_EthernetSwitchPortAclSettingData, err error) {
