...
func Newads_ntfrssettingsEx1(instance *cim.WmiInstance) (newInstance *ads_ntfrssettings, err error) {
...
func Newads_ntfrssettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_ntfrssettings, err error) {
