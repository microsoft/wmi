...
func Newads_msmqsitelinkEx1(instance *cim.WmiInstance) (newInstance *ads_msmqsitelink, err error) {
...
func Newads_msmqsitelinkEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msmqsitelink, err error) {
