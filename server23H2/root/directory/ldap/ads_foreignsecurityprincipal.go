...
func Newads_foreignsecurityprincipalEx1(instance *cim.WmiInstance) (newInstance *ads_foreignsecurityprincipal, err error) {
...
func Newads_foreignsecurityprincipalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_foreignsecurityprincipal, err error) {
