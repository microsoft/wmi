...
func Newads_organizationalunitEx1(instance *cim.WmiInstance) (newInstance *ads_organizationalunit, err error) {
...
func Newads_organizationalunitEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_organizationalunit, err error) {
