...
func Newads_msds_appdataEx1(instance *cim.WmiInstance) (newInstance *ads_msds_appdata, err error) {
...
func Newads_msds_appdataEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msds_appdata, err error) {
