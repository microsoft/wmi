...
func Newads_intellimirrorscpEx1(instance *cim.WmiInstance) (newInstance *ads_intellimirrorscp, err error) {
...
func Newads_intellimirrorscpEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_intellimirrorscp, err error) {
