...
func Newds_connectionpointEx1(instance *cim.WmiInstance) (newInstance *ds_connectionpoint, err error) {
...
func Newds_connectionpointEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ds_connectionpoint, err error) {
