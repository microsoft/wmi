...
func Newads_msdfsr_topologyEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_topology, err error) {
...
func Newads_msdfsr_topologyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msdfsr_topology, err error) {
