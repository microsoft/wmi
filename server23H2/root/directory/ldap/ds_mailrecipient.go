...
func Newds_mailrecipientEx1(instance *cim.WmiInstance) (newInstance *ds_mailrecipient, err error) {
...
func Newds_mailrecipientEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ds_mailrecipient, err error) {
