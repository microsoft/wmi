...
func Newads_ntfrsreplicasetEx1(instance *cim.WmiInstance) (newInstance *ads_ntfrsreplicaset, err error) {
...
func Newads_ntfrsreplicasetEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_ntfrsreplicaset, err error) {
