...
func Newads_mstapi_rtconferenceEx1(instance *cim.WmiInstance) (newInstance *ads_mstapi_rtconference, err error) {
...
func Newads_mstapi_rtconferenceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_mstapi_rtconference, err error) {
