...
func Newads_msds_shadowprincipalcontainerEx1(instance *cim.WmiInstance) (newInstance *ads_msds_shadowprincipalcontainer, err error) {
...
func Newads_msds_shadowprincipalcontainerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msds_shadowprincipalcontainer, err error) {
