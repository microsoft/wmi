...
func Newads_mssfu30networkuserEx1(instance *cim.WmiInstance) (newInstance *ads_mssfu30networkuser, err error) {
...
func Newads_mssfu30networkuserEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_mssfu30networkuser, err error) {
