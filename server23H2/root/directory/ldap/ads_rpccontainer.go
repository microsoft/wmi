...
func Newads_rpccontainerEx1(instance *cim.WmiInstance) (newInstance *ads_rpccontainer, err error) {
...
func Newads_rpccontainerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_rpccontainer, err error) {
