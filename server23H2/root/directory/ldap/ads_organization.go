...
func Newads_organizationEx1(instance *cim.WmiInstance) (newInstance *ads_organization, err error) {
...
func Newads_organizationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_organization, err error) {
