...
func Newads_applicationprocessEx1(instance *cim.WmiInstance) (newInstance *ads_applicationprocess, err error) {
...
func Newads_applicationprocessEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_applicationprocess, err error) {
