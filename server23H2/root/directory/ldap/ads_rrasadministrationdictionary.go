...
func Newads_rrasadministrationdictionaryEx1(instance *cim.WmiInstance) (newInstance *ads_rrasadministrationdictionary, err error) {
...
func Newads_rrasadministrationdictionaryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_rrasadministrationdictionary, err error) {
