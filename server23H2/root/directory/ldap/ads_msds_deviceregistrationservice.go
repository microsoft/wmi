...
func Newads_msds_deviceregistrationserviceEx1(instance *cim.WmiInstance) (newInstance *ads_msds_deviceregistrationservice, err error) {
...
func Newads_msds_deviceregistrationserviceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msds_deviceregistrationservice, err error) {
