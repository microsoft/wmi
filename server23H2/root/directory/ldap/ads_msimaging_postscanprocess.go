...
func Newads_msimaging_postscanprocessEx1(instance *cim.WmiInstance) (newInstance *ads_msimaging_postscanprocess, err error) {
...
func Newads_msimaging_postscanprocessEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msimaging_postscanprocess, err error) {
