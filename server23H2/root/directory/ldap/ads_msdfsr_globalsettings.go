...
func Newads_msdfsr_globalsettingsEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_globalsettings, err error) {
...
func Newads_msdfsr_globalsettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msdfsr_globalsettings, err error) {
