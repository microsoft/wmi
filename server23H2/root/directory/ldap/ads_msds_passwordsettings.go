...
func Newads_msds_passwordsettingsEx1(instance *cim.WmiInstance) (newInstance *ads_msds_passwordsettings, err error) {
...
func Newads_msds_passwordsettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msds_passwordsettings, err error) {
