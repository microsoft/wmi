...
func Newds_samdomainbaseEx1(instance *cim.WmiInstance) (newInstance *ds_samdomainbase, err error) {
...
func Newds_samdomainbaseEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ds_samdomainbase, err error) {
