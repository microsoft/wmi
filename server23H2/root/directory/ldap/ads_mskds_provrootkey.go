...
func Newads_mskds_provrootkeyEx1(instance *cim.WmiInstance) (newInstance *ads_mskds_provrootkey, err error) {
...
func Newads_mskds_provrootkeyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_mskds_provrootkey, err error) {
