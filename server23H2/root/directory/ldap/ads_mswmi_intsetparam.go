...
func Newads_mswmi_intsetparamEx1(instance *cim.WmiInstance) (newInstance *ads_mswmi_intsetparam, err error) {
...
func Newads_mswmi_intsetparamEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_mswmi_intsetparam, err error) {
