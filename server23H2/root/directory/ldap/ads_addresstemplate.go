...
func Newads_addresstemplateEx1(instance *cim.WmiInstance) (newInstance *ads_addresstemplate, err error) {
...
func Newads_addresstemplateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_addresstemplate, err error) {
