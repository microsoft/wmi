...
func Newads_groupofnamesEx1(instance *cim.WmiInstance) (newInstance *ads_groupofnames, err error) {
...
func Newads_groupofnamesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_groupofnames, err error) {
