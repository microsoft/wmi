...
func Newds_mswmi_rangeparamEx1(instance *cim.WmiInstance) (newInstance *ds_mswmi_rangeparam, err error) {
...
func Newds_mswmi_rangeparamEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ds_mswmi_rangeparam, err error) {
