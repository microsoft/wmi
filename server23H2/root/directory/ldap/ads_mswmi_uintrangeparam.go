...
func Newads_mswmi_uintrangeparamEx1(instance *cim.WmiInstance) (newInstance *ads_mswmi_uintrangeparam, err error) {
...
func Newads_mswmi_uintrangeparamEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_mswmi_uintrangeparam, err error) {
