...
func NewWin32_PerfRawData_Counters_RemoteFXNetworkEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_RemoteFXNetwork, err error) {
...
func NewWin32_PerfRawData_Counters_RemoteFXNetworkEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_RemoteFXNetwork, err error) {
