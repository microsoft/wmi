...
func NewMDM_DeviceStatus_UAC01Ex1(instance *cim.WmiInstance) (newInstance *MDM_DeviceStatus_UAC01, err error) {
...
func NewMDM_DeviceStatus_UAC01Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_DeviceStatus_UAC01, err error) {
