...
func NewMDM_Update_ApprovedUpdates01_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_Update_ApprovedUpdates01_01, err error) {
...
func NewMDM_Update_ApprovedUpdates01_01Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Update_ApprovedUpdates01_01, err error) {
