...
func NewMDM_Policy_User_Config01_Experience02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_User_Config01_Experience02, err error) {
...
func NewMDM_Policy_User_Config01_Experience02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Policy_User_Config01_Experience02, err error) {
