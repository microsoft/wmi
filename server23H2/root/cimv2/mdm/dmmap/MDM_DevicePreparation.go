...
func NewMDM_DevicePreparationEx1(instance *cim.WmiInstance) (newInstance *MDM_DevicePreparation, err error) {
...
func NewMDM_DevicePreparationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_DevicePreparation, err error) {
