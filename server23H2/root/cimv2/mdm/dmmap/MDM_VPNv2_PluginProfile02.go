...
func NewMDM_VPNv2_PluginProfile02Ex1(instance *cim.WmiInstance) (newInstance *MDM_VPNv2_PluginProfile02, err error) {
...
func NewMDM_VPNv2_PluginProfile02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_VPNv2_PluginProfile02, err error) {
