...
func NewMDM_DeviceStatus_OS01Ex1(instance *cim.WmiInstance) (newInstance *MDM_DeviceStatus_OS01, err error) {
...
func NewMDM_DeviceStatus_OS01Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_DeviceStatus_OS01, err error) {
