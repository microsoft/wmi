...
func NewMDM_WindowsDefenderApplicationGuardEx1(instance *cim.WmiInstance) (newInstance *MDM_WindowsDefenderApplicationGuard, err error) {
...
func NewMDM_WindowsDefenderApplicationGuardEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_WindowsDefenderApplicationGuard, err error) {
