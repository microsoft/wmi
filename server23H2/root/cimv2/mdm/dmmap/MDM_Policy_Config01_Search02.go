...
func NewMDM_Policy_Config01_Search02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_Search02, err error) {
...
func NewMDM_Policy_Config01_Search02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Policy_Config01_Search02, err error) {
