...
func NewMDM_Policy_Config01_MSSLegacy02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_MSSLegacy02, err error) {
...
func NewMDM_Policy_Config01_MSSLegacy02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Policy_Config01_MSSLegacy02, err error) {
