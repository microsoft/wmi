...
func NewMDM_Firewall_PrivateProfile02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Firewall_PrivateProfile02, err error) {
...
func NewMDM_Firewall_PrivateProfile02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Firewall_PrivateProfile02, err error) {
