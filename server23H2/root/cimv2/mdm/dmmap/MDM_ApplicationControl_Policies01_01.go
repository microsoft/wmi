...
func NewMDM_ApplicationControl_Policies01_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_ApplicationControl_Policies01_01, err error) {
...
func NewMDM_ApplicationControl_Policies01_01Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_ApplicationControl_Policies01_01, err error) {
