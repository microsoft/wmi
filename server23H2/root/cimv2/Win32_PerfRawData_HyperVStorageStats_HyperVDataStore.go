...
func NewWin32_PerfRawData_HyperVStorageStats_HyperVDataStoreEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_HyperVStorageStats_HyperVDataStore, err error) {
...
func NewWin32_PerfRawData_HyperVStorageStats_HyperVDataStoreEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_HyperVStorageStats_HyperVDataStore, err error) {
