...
func NewWin32_PerfFormattedData_Counters_RDMAActivityEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_RDMAActivity, err error) {
...
func NewWin32_PerfFormattedData_Counters_RDMAActivityEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_RDMAActivity, err error) {
