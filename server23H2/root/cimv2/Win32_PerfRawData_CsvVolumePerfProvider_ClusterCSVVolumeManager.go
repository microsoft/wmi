...
func NewWin32_PerfRawData_CsvVolumePerfProvider_ClusterCSVVolumeManagerEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_CsvVolumePerfProvider_ClusterCSVVolumeManager, err error) {
...
func NewWin32_PerfRawData_CsvVolumePerfProvider_ClusterCSVVolumeManagerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_CsvVolumePerfProvider_ClusterCSVVolumeManager, err error) {
