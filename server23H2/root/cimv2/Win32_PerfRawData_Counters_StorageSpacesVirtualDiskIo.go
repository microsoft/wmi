...
func NewWin32_PerfRawData_Counters_StorageSpacesVirtualDiskIoEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_StorageSpacesVirtualDiskIo, err error) {
...
func NewWin32_PerfRawData_Counters_StorageSpacesVirtualDiskIoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_StorageSpacesVirtualDiskIo, err error) {
