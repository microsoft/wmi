...
func NewMsft_WmiProvider_CreateClassEnumAsyncEvent_PreEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_CreateClassEnumAsyncEvent_Pre, err error) {
...
func NewMsft_WmiProvider_CreateClassEnumAsyncEvent_PreEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msft_WmiProvider_CreateClassEnumAsyncEvent_Pre, err error) {
