...
func NewWin32_PerfFormattedData_Counters_ReFSBucketizedPerformanceEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_ReFSBucketizedPerformance, err error) {
...
func NewWin32_PerfFormattedData_Counters_ReFSBucketizedPerformanceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_ReFSBucketizedPerformance, err error) {
