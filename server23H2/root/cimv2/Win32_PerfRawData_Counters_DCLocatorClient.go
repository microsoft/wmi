...
func NewWin32_PerfRawData_Counters_DCLocatorClientEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_DCLocatorClient, err error) {
...
func NewWin32_PerfRawData_Counters_DCLocatorClientEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_DCLocatorClient, err error) {
