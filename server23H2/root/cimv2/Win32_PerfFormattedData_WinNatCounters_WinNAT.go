...
func NewWin32_PerfFormattedData_WinNatCounters_WinNATEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_WinNatCounters_WinNAT, err error) {
...
func NewWin32_PerfFormattedData_WinNatCounters_WinNATEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_WinNatCounters_WinNAT, err error) {
