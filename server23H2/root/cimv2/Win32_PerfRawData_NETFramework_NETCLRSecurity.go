...
func NewWin32_PerfRawData_NETFramework_NETCLRSecurityEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_NETFramework_NETCLRSecurity, err error) {
...
func NewWin32_PerfRawData_NETFramework_NETCLRSecurityEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_NETFramework_NETCLRSecurity, err error) {
