...
func NewWin32_PerfRawData_Counters_HyperVVirtualMachineBusEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_HyperVVirtualMachineBus, err error) {
...
func NewWin32_PerfRawData_Counters_HyperVVirtualMachineBusEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_HyperVVirtualMachineBus, err error) {
