...
func NewWin32_PowerSettingDefinitionEx1(instance *cim.WmiInstance) (newInstance *Win32_PowerSettingDefinition, err error) {
...
func NewWin32_PowerSettingDefinitionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PowerSettingDefinition, err error) {
