...
func NewWin32_PerfFormattedData_Counters_IPsecDoSProtectionEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_IPsecDoSProtection, err error) {
...
func NewWin32_PerfFormattedData_Counters_IPsecDoSProtectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_IPsecDoSProtection, err error) {
