...
func NewWin32_PerfRawData_Counters_StorageSpacesWriteCacheEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_StorageSpacesWriteCache, err error) {
...
func NewWin32_PerfRawData_Counters_StorageSpacesWriteCacheEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_StorageSpacesWriteCache, err error) {
