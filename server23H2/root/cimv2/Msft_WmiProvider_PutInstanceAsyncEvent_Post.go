...
func NewMsft_WmiProvider_PutInstanceAsyncEvent_PostEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_PutInstanceAsyncEvent_Post, err error) {
...
func NewMsft_WmiProvider_PutInstanceAsyncEvent_PostEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msft_WmiProvider_PutInstanceAsyncEvent_Post, err error) {
