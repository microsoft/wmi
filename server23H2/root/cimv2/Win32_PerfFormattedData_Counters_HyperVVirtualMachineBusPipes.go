...
func NewWin32_PerfFormattedData_Counters_HyperVVirtualMachineBusPipesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_HyperVVirtualMachineBusPipes, err error) {
...
func NewWin32_PerfFormattedData_Counters_HyperVVirtualMachineBusPipesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_HyperVVirtualMachineBusPipes, err error) {
