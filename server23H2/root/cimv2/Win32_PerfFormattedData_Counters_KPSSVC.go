...
func NewWin32_PerfFormattedData_Counters_KPSSVCEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_KPSSVC, err error) {
...
func NewWin32_PerfFormattedData_Counters_KPSSVCEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_KPSSVC, err error) {
