...
func NewWin32_PerfRawData_Counters_StorportUnitQueueEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_StorportUnitQueue, err error) {
...
func NewWin32_PerfRawData_Counters_StorportUnitQueueEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_StorportUnitQueue, err error) {
