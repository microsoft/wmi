...
func NewWin32_PerfRawData_HvStats_HyperVHypervisorPartitionEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_HvStats_HyperVHypervisorPartition, err error) {
...
func NewWin32_PerfRawData_HvStats_HyperVHypervisorPartitionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_HvStats_HyperVHypervisorPartition, err error) {
