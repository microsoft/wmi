...
func NewWin32_PerfFormattedData_Counters_LSALookupsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_LSALookups, err error) {
...
func NewWin32_PerfFormattedData_Counters_LSALookupsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_LSALookups, err error) {
