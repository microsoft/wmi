...
func NewWin32_PerfFormattedData_Counters_VHDBucketizedPerformanceEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_VHDBucketizedPerformance, err error) {
...
func NewWin32_PerfFormattedData_Counters_VHDBucketizedPerformanceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_VHDBucketizedPerformance, err error) {
