...
func NewWin32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterfaceEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterface, err error) {
...
func NewWin32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterfaceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterface, err error) {
