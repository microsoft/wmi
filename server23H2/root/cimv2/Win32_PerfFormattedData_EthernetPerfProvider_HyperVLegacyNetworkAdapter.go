...
func NewWin32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter, err error) {
...
func NewWin32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapterEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter, err error) {
