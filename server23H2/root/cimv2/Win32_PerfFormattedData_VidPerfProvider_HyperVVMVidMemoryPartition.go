...
func NewWin32_PerfFormattedData_VidPerfProvider_HyperVVMVidMemoryPartitionEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_VidPerfProvider_HyperVVMVidMemoryPartition, err error) {
...
func NewWin32_PerfFormattedData_VidPerfProvider_HyperVVMVidMemoryPartitionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_VidPerfProvider_HyperVVMVidMemoryPartition, err error) {
