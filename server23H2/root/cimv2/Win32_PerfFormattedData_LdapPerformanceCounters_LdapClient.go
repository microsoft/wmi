...
func NewWin32_PerfFormattedData_LdapPerformanceCounters_LdapClientEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_LdapPerformanceCounters_LdapClient, err error) {
...
func NewWin32_PerfFormattedData_LdapPerformanceCounters_LdapClientEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_LdapPerformanceCounters_LdapClient, err error) {
