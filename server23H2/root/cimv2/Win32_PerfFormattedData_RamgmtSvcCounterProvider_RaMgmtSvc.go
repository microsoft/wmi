...
func NewWin32_PerfFormattedData_RamgmtSvcCounterProvider_RaMgmtSvcEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_RamgmtSvcCounterProvider_RaMgmtSvc, err error) {
...
func NewWin32_PerfFormattedData_RamgmtSvcCounterProvider_RaMgmtSvcEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_RamgmtSvcCounterProvider_RaMgmtSvc, err error) {
