...
func NewWin32_PerfFormattedData_PerfOS_MemoryEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_PerfOS_Memory, err error) {
...
func NewWin32_PerfFormattedData_PerfOS_MemoryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_PerfOS_Memory, err error) {
