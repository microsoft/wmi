...
func NewWin32_PerfFormattedData_Counters_SynchronizationEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_Synchronization, err error) {
...
func NewWin32_PerfFormattedData_Counters_SynchronizationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_Synchronization, err error) {
