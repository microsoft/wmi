...
func NewWin32_PerfFormattedData_PerfNet_BrowserEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_PerfNet_Browser, err error) {
...
func NewWin32_PerfFormattedData_PerfNet_BrowserEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_PerfNet_Browser, err error) {
