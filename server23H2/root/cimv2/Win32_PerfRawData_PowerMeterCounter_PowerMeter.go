...
func NewWin32_PerfRawData_PowerMeterCounter_PowerMeterEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_PowerMeterCounter_PowerMeter, err error) {
...
func NewWin32_PerfRawData_PowerMeterCounter_PowerMeterEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_PowerMeterCounter_PowerMeter, err error) {
