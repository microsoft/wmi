...
const (
	...
	// FreeSpaceWiped enum
	EncryptableVolume_WipingStatus_FreeSpaceWiped EncryptableVolume_WipingStatus = 1
	// FreeSpaceWipingInProgress enum
	EncryptableVolume_WipingStatus_FreeSpaceWipingInProgress EncryptableVolume_WipingStatus = 2
