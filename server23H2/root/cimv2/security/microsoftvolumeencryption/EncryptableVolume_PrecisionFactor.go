...
const (
	...
	// _1 enum
	EncryptableVolume_PrecisionFactor__1 EncryptableVolume_PrecisionFactor = 1
	// _2 enum
	EncryptableVolume_PrecisionFactor__2 EncryptableVolume_PrecisionFactor = 2
	// _3 enum
	EncryptableVolume_PrecisionFactor__3 EncryptableVolume_PrecisionFactor = 3
	// _4 enum
