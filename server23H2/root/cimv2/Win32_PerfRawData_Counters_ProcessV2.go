...
func NewWin32_PerfRawData_Counters_ProcessV2Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_ProcessV2, err error) {
...
func NewWin32_PerfRawData_Counters_ProcessV2Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_ProcessV2, err error) {
