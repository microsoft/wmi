...
func NewWin32_PerfRawData_APPPOOLCountersProvider_APPPOOLWASEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_APPPOOLCountersProvider_APPPOOLWAS, err error) {
...
func NewWin32_PerfRawData_APPPOOLCountersProvider_APPPOOLWASEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_APPPOOLCountersProvider_APPPOOLWAS, err error) {
