...
func NewSystemSpecificCollectionEx1(instance *cim.WmiInstance) (newInstance *SystemSpecificCollection, err error) {
...
func NewSystemSpecificCollectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemSpecificCollection, err error) {
