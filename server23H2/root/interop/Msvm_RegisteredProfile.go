...
func NewMsvm_RegisteredProfileEx1(instance *cim.WmiInstance) (newInstance *Msvm_RegisteredProfile, err error) {
...
func NewMsvm_RegisteredProfileEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_RegisteredProfile, err error) {
