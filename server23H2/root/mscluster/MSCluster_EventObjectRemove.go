...
func NewMSCluster_EventObjectRemoveEx1(instance *cim.WmiInstance) (newInstance *MSCluster_EventObjectRemove, err error) {
...
func NewMSCluster_EventObjectRemoveEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSCluster_EventObjectRemove, err error) {
