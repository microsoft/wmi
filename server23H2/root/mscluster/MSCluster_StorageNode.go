...
func (instance *MSCluster_StorageNode) AddStorageNode( /* IN */ Name string,
	...
	/* IN */ Location string,
	/* IN */ Flags uint32,
	/* OUT */ AddedStorageNode MSCluster_StorageNode) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("AddStorageNode", Name, Description, Location, Flags)
	if err != nil {
		return
	}
...
func (instance *MSCluster_StorageNode) SetStorageNode( /* IN */ NewName string,
	...
	retVal, err := instance.InvokeMethodWithReturn("SetStorageNode", NewName, Description, Location, Flags)
	if err != nil {
		return
	}
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_StorageNode) RemoveStorageNode( /* IN */ Flags uint32) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("RemoveStorageNode", Flags)
	if err != nil {
		return
	}
	result = uint32(retVal)
