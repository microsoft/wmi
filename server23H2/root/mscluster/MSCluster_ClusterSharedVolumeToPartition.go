...
func NewMSCluster_ClusterSharedVolumeToPartitionEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ClusterSharedVolumeToPartition, err error) {
...
func NewMSCluster_ClusterSharedVolumeToPartitionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSCluster_ClusterSharedVolumeToPartition, err error) {
