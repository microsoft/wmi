...
func NewMSCluster_GroupSetEx1(instance *cim.WmiInstance) (newInstance *MSCluster_GroupSet, err error) {
...
func NewMSCluster_GroupSetEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSCluster_GroupSet, err error) {
...
func (instance *MSCluster_GroupSet) CreateSet( /* IN */ Name string,
	/* IN */ Group []string,
	/* IN */ provider []string,
	/* OUT */ CreatedSet MSCluster_GroupSet) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("CreateSet", Name, Group, provider)
	if err != nil {
		return
	}
...
func (instance *MSCluster_GroupSet) CreateAvailabilitySet( /* IN */ Name string,
	...
	/* OUT */ CreatedSet MSCluster_GroupSet) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("CreateAvailabilitySet", Name, Group, UpdateDomains, FaultDomains, ReserveSpareNode)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *MSCluster_GroupSet) GetSetFrom( /* IN */ ContainedGroup string,
	...
	/* OUT */ Sets []MSCluster_GroupSet) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetSetFrom", ContainedGroup, Name, provider, DependentGroup)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_GroupSet) AddSetProvider( /* IN */ provider string) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("AddSetProvider", provider)
	if err != nil {
		return
	}
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_GroupSet) RemoveSetProvider( /* IN */ provider string) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("RemoveSetProvider", provider)
	if err != nil {
		return
	}
	result = uint32(retVal)
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_GroupSet) AddGroupToSet( /* IN */ Group string) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("AddGroupToSet", Group)
	if err != nil {
		return
	}
	result = uint32(retVal)
...
func (instance *MSCluster_GroupSet) AddGroupToSetEx( /* IN */ Group string,
	...
	/* IN */ Reserved uint64) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("AddGroupToSetEx", Group, FaultDomain, UpdateDomain, Reserved)
	if err != nil {
		return
	}
	result = uint32(retVal)
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_GroupSet) RemoveGroupFromSet( /* IN */ Group string) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("RemoveGroupFromSet", Group)
	if err != nil {
		return
	}
	result = uint32(retVal)
...
func (instance *MSCluster_GroupSet) SetSet( /* IN */ StartupDelayTrigger uint32,
	...
	/* IN */ IsGlobal bool,
	/* IN */ StartupDelay uint32) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("SetSet", StartupDelayTrigger, StartupCount, IsGlobal, StartupDelay)
	if err != nil {
		return
	}
	result = uint32(retVal)
...
func (instance *MSCluster_GroupSet) GetGroups( /* IN */ DependentGroup string,
	...
	/* OUT */ Groups []string) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetGroups", DependentGroup, ProviderGroup)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *MSCluster_GroupSet) RemoveProviderForGroup( /* IN */ Group string,
	/* IN */ ProviderGroup string,
	/* IN */ provider string) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("RemoveProviderForGroup", Group, ProviderGroup, provider)
	if err != nil {
		return
	}
	result = uint32(retVal)
...
func (instance *MSCluster_GroupSet) AddProviderForGroup( /* IN */ Group string,
	/* IN */ ProviderGroup string,
	/* IN */ provider string) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("AddProviderForGroup", Group, ProviderGroup, provider)
	if err != nil {
		return
	}
	result = uint32(retVal)
