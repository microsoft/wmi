...
func NewCIM_WebApplicationProxyConfigurationEx1(instance *cim.WmiInstance) (newInstance *CIM_WebApplicationProxyConfiguration, err error) {
...
func NewCIM_WebApplicationProxyConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CIM_WebApplicationProxyConfiguration, err error) {
...
func (instance *CIM_WebApplicationProxyConfiguration) Get( /* OUT */ cmdletOutput AppProxyGlobalConfiguration) (result uint32, err error) {
...
func (instance *CIM_WebApplicationProxyConfiguration) Set( /* IN */ ADFSUrl string,
	...
	/* IN */ UserIdleTimeoutAction string) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("Set", ADFSUrl, ADFSTokenSigningCertificatePublicKey, ADFSWebApplicationProxyRelyingPartyUri, RegenerateAccessCookiesEncryptionKey, ConnectedServersName, OAuthAuthenticationURL, ConfigurationChangesPollingIntervalSec, UpgradeConfigurationVersion, ADFSTokenAcceptanceDurationSec, ADFSSignOutURL, UserIdleTimeoutSec, UserIdleTimeoutAction)
	if err != nil {
		return
	}
