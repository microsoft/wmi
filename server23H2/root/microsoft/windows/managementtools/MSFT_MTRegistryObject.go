...
func NewMSFT_MTRegistryObjectEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTRegistryObject, err error) {
...
func NewMSFT_MTRegistryObjectEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_MTRegistryObject, err error) {
