...
func NewPS_VpnSstpProxyRuleEx1(instance *cim.WmiInstance) (newInstance *PS_VpnSstpProxyRule, err error) {
...
func NewPS_VpnSstpProxyRuleEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_VpnSstpProxyRule, err error) {
...
func (instance *PS_VpnSstpProxyRule) Add( /* IN */ Rule []VpnSstpProxyRule,
	/* IN */ PassThru bool,
	/* OUT */ cmdletOutput []VpnSstpProxyRule) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Add", Rule, PassThru)
	if err != nil {
		return
	}
...
func (instance *PS_VpnSstpProxyRule) New( /* IN */ TenantID string,
	...
	/* OUT */ cmdletOutput VpnSstpProxyRule) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("New", TenantID, GatewayAddress)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_VpnSstpProxyRule) Set( /* IN */ TenantID string,
	...
	/* IN */ PassThru bool,
	/* OUT */ cmdletOutput VpnSstpProxyRule) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Set", TenantID, GatewayAddress, PassThru)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
// <param name="cmdletOutput" type="VpnSstpProxyRule []"></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *PS_VpnSstpProxyRule) Get( /* OUT */ cmdletOutput []VpnSstpProxyRule) (result uint32, err error) {
...
func (instance *PS_VpnSstpProxyRule) Remove( /* IN */ TenantID []string,
	...
	retVal, err := instance.InvokeMethodWithReturn("Remove", TenantID, Force)
	if err != nil {
		return
	}
