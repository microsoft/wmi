...
func NewVpnS2SInterfaceStatisticsEx1(instance *cim.WmiInstance) (newInstance *VpnS2SInterfaceStatistics, err error) {
...
func NewVpnS2SInterfaceStatisticsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *VpnS2SInterfaceStatistics, err error) {
