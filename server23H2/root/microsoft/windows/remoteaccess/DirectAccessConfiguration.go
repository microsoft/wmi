...
func NewDirectAccessConfigurationEx1(instance *cim.WmiInstance) (newInstance *DirectAccessConfiguration, err error) {
...
func NewDirectAccessConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DirectAccessConfiguration, err error) {
