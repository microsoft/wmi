...
func NewRemoteAccessHealthMonitorEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessHealthMonitor, err error) {
...
func NewRemoteAccessHealthMonitorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessHealthMonitor, err error) {
