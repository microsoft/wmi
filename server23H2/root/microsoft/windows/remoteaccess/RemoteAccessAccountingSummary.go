...
func NewRemoteAccessAccountingSummaryEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessAccountingSummary, err error) {
...
func NewRemoteAccessAccountingSummaryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessAccountingSummary, err error) {
