...
func NewRemoteAccessRadiusServerPurposeEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessRadiusServerPurpose, err error) {
...
func NewRemoteAccessRadiusServerPurposeEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessRadiusServerPurpose, err error) {
