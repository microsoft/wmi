...
func NewPS_VpnConnectionTriggerEx1(instance *cim.WmiInstance) (newInstance *PS_VpnConnectionTrigger, err error) {
...
func NewPS_VpnConnectionTriggerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_VpnConnectionTrigger, err error) {
