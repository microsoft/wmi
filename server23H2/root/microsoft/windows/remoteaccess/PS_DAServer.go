...
func NewPS_DAServerEx1(instance *cim.WmiInstance) (newInstance *PS_DAServer, err error) {
...
func NewPS_DAServerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_DAServer, err error) {
...
func (instance *PS_DAServer) SetByChangeDAInstallationType( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput DAServer) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByChangeDAInstallationType", ComputerName, PassThru, Force, DAInstallType)
	if err != nil {
		return
	}
...
func (instance *PS_DAServer) SetByDisableComputerCertAuth( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput DAServer) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByDisableComputerCertAuth", ComputerName, PassThru, Force, InternalIPv6Prefix, ClientIPv6Prefix, DisableComputerCertAuthentication, TeredoState, ConnectToAddress)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_DAServer) SetByEnableComputerCertAuth( /* IN */ ComputerName string,
	...
	/* IN */ TeredoState string,
	/* OUT */ cmdletOutput DAServer) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByEnableComputerCertAuth", ComputerName, PassThru, Force, UserAuthentication, IPsecRootCertificate, IntermediateRootCertificate, EntrypointName, ClientIPv6Prefix, ConnectToAddress, InternalIPv6Prefix, TeredoState)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
