...
func NewVpnServerIPsecCustomConfigurationEx1(instance *cim.WmiInstance) (newInstance *VpnServerIPsecCustomConfiguration, err error) {
...
func NewVpnServerIPsecCustomConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *VpnServerIPsecCustomConfiguration, err error) {
