...
func NewDAClientDnsConfigurationEx1(instance *cim.WmiInstance) (newInstance *DAClientDnsConfiguration, err error) {
...
func NewDAClientDnsConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DAClientDnsConfiguration, err error) {
