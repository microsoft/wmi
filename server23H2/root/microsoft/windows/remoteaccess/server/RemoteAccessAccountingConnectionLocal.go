...
func NewRemoteAccessAccountingConnectionLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessAccountingConnectionLocal, err error) {
...
func NewRemoteAccessAccountingConnectionLocalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessAccountingConnectionLocal, err error) {
