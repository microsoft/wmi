...
func NewDACorpPrefixConfigurationEx1(instance *cim.WmiInstance) (newInstance *DACorpPrefixConfiguration, err error) {
...
func NewDACorpPrefixConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DACorpPrefixConfiguration, err error) {
