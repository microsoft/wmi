...
func NewPS_RemoteAccessAccountingStatisticsSummaryEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessAccountingStatisticsSummary, err error) {
...
func NewPS_RemoteAccessAccountingStatisticsSummaryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_RemoteAccessAccountingStatisticsSummary, err error) {
...
func (instance *PS_RemoteAccessAccountingStatisticsSummary) GetByAccountingStatistics( /* IN */ StartDateTime string,
	...
	/* OUT */ cmdletOutput RemoteAccessAccountingConnectionSummaryLocal) (result uint32, err error) {
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *PS_RemoteAccessAccountingStatisticsSummary) GetByActiveStatistics( /* OUT */ cmdletOutput RemoteAccessActiveConnectionSummaryLocal) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetByActiveStatistics")
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
