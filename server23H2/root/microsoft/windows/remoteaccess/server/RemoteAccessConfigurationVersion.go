...
func NewRemoteAccessConfigurationVersionEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessConfigurationVersion, err error) {
...
func NewRemoteAccessConfigurationVersionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessConfigurationVersion, err error) {
