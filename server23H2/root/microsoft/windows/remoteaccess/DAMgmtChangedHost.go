...
func NewDAMgmtChangedHostEx1(instance *cim.WmiInstance) (newInstance *DAMgmtChangedHost, err error) {
	tmp, err := NewDAMgmtHostExEx1(instance)
...
func NewDAMgmtChangedHostEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DAMgmtChangedHost, err error) {
	tmp, err := NewDAMgmtHostExEx6(hostName, wmiNamespace, userName, password, domainName, query)
