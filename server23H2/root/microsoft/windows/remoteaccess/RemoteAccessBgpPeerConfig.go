...
func NewRemoteAccessBgpPeerConfigEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessBgpPeerConfig, err error) {
...
func NewRemoteAccessBgpPeerConfigEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessBgpPeerConfig, err error) {
