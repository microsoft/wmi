...
func NewPS_VpnTrafficSelectorEx1(instance *cim.WmiInstance) (newInstance *PS_VpnTrafficSelector, err error) {
...
func NewPS_VpnTrafficSelectorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_VpnTrafficSelector, err error) {
...
func (instance *PS_VpnTrafficSelector) New( /* IN */ IPAddressRange []string,
	...
	/* IN */ Type uint32,
	/* OUT */ cmdletOutput VpnTrafficSelector) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("New", IPAddressRange, PortRange, ProtocolId, TsPayloadId, Type)
	if err != nil {
		return
	}
