...
func NewPS_DANetworkLocationServerEx1(instance *cim.WmiInstance) (newInstance *PS_DANetworkLocationServer, err error) {
...
func NewPS_DANetworkLocationServerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_DANetworkLocationServer, err error) {
...
func (instance *PS_DANetworkLocationServer) SetByExternalServer( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput DANetworkLocationServer) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByExternalServer", ComputerName, Force, PassThru, Url, CheckReachability)
	if err != nil {
		return
	}
...
func (instance *PS_DANetworkLocationServer) SetByOnDAServer( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput DANetworkLocationServer) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByOnDAServer", ComputerName, Force, PassThru, Certificate, NlsOnDAServer)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_DANetworkLocationServer) Get( /* IN */ CheckReachability bool,
	...
	/* OUT */ cmdletOutput DANetworkLocationServer) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Get", CheckReachability, ComputerName)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
