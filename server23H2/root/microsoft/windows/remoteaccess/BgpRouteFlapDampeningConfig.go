...
func NewBgpRouteFlapDampeningConfigEx1(instance *cim.WmiInstance) (newInstance *BgpRouteFlapDampeningConfig, err error) {
...
func NewBgpRouteFlapDampeningConfigEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *BgpRouteFlapDampeningConfig, err error) {
