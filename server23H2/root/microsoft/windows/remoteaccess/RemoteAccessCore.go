...
func NewRemoteAccessCoreEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessCore, err error) {
...
func NewRemoteAccessCoreEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessCore, err error) {
