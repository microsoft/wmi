...
func NewRemoteAccessLoadBalancerNodeEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessLoadBalancerNode, err error) {
...
func NewRemoteAccessLoadBalancerNodeEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessLoadBalancerNode, err error) {
