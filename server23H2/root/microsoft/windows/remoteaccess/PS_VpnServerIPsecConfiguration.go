...
func NewPS_VpnServerIPsecConfigurationEx1(instance *cim.WmiInstance) (newInstance *PS_VpnServerIPsecConfiguration, err error) {
...
func NewPS_VpnServerIPsecConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_VpnServerIPsecConfiguration, err error) {
...
func (instance *PS_VpnServerIPsecConfiguration) SetByCustomPolicy( /* IN */ PassThru bool,
	...
	/* IN */ L2tpPorts uint32,
	/* IN */ GrePorts uint32,
	/* OUT */ cmdletOutput VpnServerIPsecConfiguration) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByCustomPolicy", PassThru, TunnelType, IdleDisconnectSeconds, SALifeTimeSeconds, MMSALifeTimeSeconds, SADataSizeForRenegotiationKilobytes, CustomPolicy, EncryptionMethod, IntegrityCheckMethod, SstpPorts, CipherTransformConstants, PfsGroup, AuthenticationTransformConstants, DHGroup, Ikev2Ports, L2tpPorts, GrePorts)
	if err != nil {
		return
	}
...
func (instance *PS_VpnServerIPsecConfiguration) SetByEncryptionType( /* IN */ PassThru bool,
	...
	/* IN */ GrePorts uint32,
	/* OUT */ cmdletOutput VpnServerIPsecConfiguration) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByEncryptionType", PassThru, TunnelType, EncryptionType, IdleDisconnectSeconds, Ikev2Ports, SADataSizeForRenegotiationKilobytes, SALifeTimeSeconds, MMSALifeTimeSeconds, L2tpPorts, SstpPorts, GrePorts)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_VpnServerIPsecConfiguration) SetByRevertToDefault( /* IN */ PassThru bool,
	...
	/* OUT */ cmdletOutput VpnServerIPsecConfiguration) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByRevertToDefault", PassThru, TunnelType, RevertToDefault)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_VpnServerIPsecConfiguration) Get( /* IN */ TunnelType uint32,
	/* OUT */ cmdletOutput VpnServerIPsecConfiguration) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Get", TunnelType)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
