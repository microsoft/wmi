...
func NewDAServerConfigurationEx1(instance *cim.WmiInstance) (newInstance *DAServerConfiguration, err error) {
...
func NewDAServerConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DAServerConfiguration, err error) {
