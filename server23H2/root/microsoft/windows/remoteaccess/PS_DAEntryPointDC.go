...
func NewPS_DAEntryPointDCEx1(instance *cim.WmiInstance) (newInstance *PS_DAEntryPointDC, err error) {
...
func NewPS_DAEntryPointDCEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_DAEntryPointDC, err error) {
...
func (instance *PS_DAEntryPointDC) Get( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput []DADomainController) (result uint32, err error) {
...
func (instance *PS_DAEntryPointDC) SetByDCName( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput []DADomainController) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByDCName", ComputerName, NewDC, Force, PassThru, ExistingDC)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_DAEntryPointDC) SetByEntryPoint( /* IN */ ComputerName string,
	...
	/* IN */ EntryPointName string,
	/* OUT */ cmdletOutput []DADomainController) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByEntryPoint", ComputerName, NewDC, Force, PassThru, EntryPointName)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
