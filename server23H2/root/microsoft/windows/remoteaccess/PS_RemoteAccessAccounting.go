...
func NewPS_RemoteAccessAccountingEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessAccounting, err error) {
...
func NewPS_RemoteAccessAccountingEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_RemoteAccessAccounting, err error) {
...
func (instance *PS_RemoteAccessAccounting) SetByDisableAccounting( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput RemoteAccessAccounting) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByDisableAccounting", ComputerName, PassThru, DisableAccountingType)
	if err != nil {
		return
	}
...
func (instance *PS_RemoteAccessAccounting) SetByEnableAccounting( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput RemoteAccessAccounting) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetByEnableAccounting", ComputerName, PassThru, RadiusServer, SharedSecret, RadiusPort, RadiusScore, RadiusTimeout, AccountingOnOffMsg, EnableAccountingType)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
