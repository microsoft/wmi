...
func NewPS_BgpPeerEx1(instance *cim.WmiInstance) (newInstance *PS_BgpPeer, err error) {
...
func NewPS_BgpPeerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_BgpPeer, err error) {
...
func (instance *PS_BgpPeer) Add( /* IN */ Name string,
	...
	/* OUT */ cmdletOutput BgpPeerConfig) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Add", Name, LocalIPAddress, PeerIPAddress, LocalASN, PeerASN, OperationMode, PeeringMode, HoldTimeSec, IdleHoldTimeSec, Weight, RouteReflectorClient, MaxAllowedPrefix, PassThru, RoutingDomain, GracefulRestart, GracefulRestartTime)
	if err != nil {
		return
	}
...
func (instance *PS_BgpPeer) Set( /* IN */ Name string,
	...
	/* IN */ GracefulRestartTime uint16,
	/* OUT */ cmdletOutput BgpPeerConfig) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Set", Name, LocalIPAddress, PeerIPAddress, LocalASN, PeerASN, OperationMode, PeeringMode, HoldTimeSec, IdleHoldTimeSec, Weight, RouteReflectorClient, MaxAllowedPrefix, RoutingDomain, PassThru, Force, ClearPrefixLimit, GracefulRestart, GracefulRestartTime)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_BgpPeer) Start( /* IN */ RoutingDomain string,
	...
	retVal, err := instance.InvokeMethodWithReturn("Start", RoutingDomain, Name)
	if err != nil {
		return
	}
	result = uint32(retVal)
...
func (instance *PS_BgpPeer) Stop( /* IN */ Name []string,
	/* IN */ RoutingDomain string,
	/* IN */ Force bool) (result uint32, err error) {
	retVal, err := instance.InvokeMethodWithReturn("Stop", Name, RoutingDomain, Force)
	if err != nil {
		return
	}
	result = uint32(retVal)
