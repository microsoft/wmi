...
func NewPS_BgpCustomRouteEx1(instance *cim.WmiInstance) (newInstance *PS_BgpCustomRoute, err error) {
...
func NewPS_BgpCustomRouteEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_BgpCustomRoute, err error) {
...
func (instance *PS_BgpCustomRoute) Add( /* IN */ PassThru bool,
	...
	/* IN */ Interface []string,
	/* IN */ Network []string,
	/* OUT */ cmdletOutput BgpCustomNetworkInfo) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Add", PassThru, RoutingDomain, Interface, Network)
	if err != nil {
		return
	}
...
func (instance *PS_BgpCustomRoute) Remove( /* IN */ Network []string,
	...
	retVal, err := instance.InvokeMethodWithReturn("Remove", Network, Interface, Force, RoutingDomain)
	if err != nil {
		return
	}
