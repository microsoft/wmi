...
func NewRemoteAccessS2SConfigurationEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessS2SConfiguration, err error) {
...
func NewRemoteAccessS2SConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessS2SConfiguration, err error) {
