...
func NewMSFT_SmbClientCertificateMappingEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbClientCertificateMapping, err error) {
...
func NewMSFT_SmbClientCertificateMappingEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_SmbClientCertificateMapping, err error) {
...
func (instance *MSFT_SmbClientCertificateMapping) AddClientCertificateMapping( /* IN */ Namespace string,
	...
	/* IN */ Type uint32,
	/* IN */ Flags uint32,
	/* OUT */ CreatedMapping MSFT_SmbClientCertificateMapping) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("AddClientCertificateMapping", Namespace, IssuerName, Subject, Thumbprint, DisplayName, StoreName, Type, Flags)
	if err != nil {
		return
	}
...
func (instance *MSFT_SmbClientCertificateMapping) SetClientCertificateMapping( /* IN */ Namespace string,
	...
	/* IN */ Flags uint32,
	/* OUT */ CreatedMapping MSFT_SmbClientCertificateMapping) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("SetClientCertificateMapping", Namespace, IssuerName, Thumbprint, StoreName, Flags)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
