...
const (
	...
	// Uncompressed enum
	DedupProperties_ReFSDedupCompressionFormat_Uncompressed DedupProperties_ReFSDedupCompressionFormat = 1
	// LZ4 enum
	DedupProperties_ReFSDedupCompressionFormat_LZ4 DedupProperties_ReFSDedupCompressionFormat = 2
	// ZSTD enum
