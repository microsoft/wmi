...
func NewConfigProtectedDataSectionEx1(instance *cim.WmiInstance) (newInstance *ConfigProtectedDataSection, err error) {
...
func NewConfigProtectedDataSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ConfigProtectedDataSection, err error) {
