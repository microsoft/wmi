...
func NewSqlCacheDependencyDatabaseEx1(instance *cim.WmiInstance) (newInstance *SqlCacheDependencyDatabase, err error) {
...
func NewSqlCacheDependencyDatabaseEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SqlCacheDependencyDatabase, err error) {
