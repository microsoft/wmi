...
func NewConnectionStringsSectionEx1(instance *cim.WmiInstance) (newInstance *ConnectionStringsSection, err error) {
...
func NewConnectionStringsSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ConnectionStringsSection, err error) {
