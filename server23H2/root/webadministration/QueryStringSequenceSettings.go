...
func NewQueryStringSequenceSettingsEx1(instance *cim.WmiInstance) (newInstance *QueryStringSequenceSettings, err error) {
...
func NewQueryStringSequenceSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *QueryStringSequenceSettings, err error) {
