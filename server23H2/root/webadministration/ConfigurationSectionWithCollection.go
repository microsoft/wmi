...
func NewConfigurationSectionWithCollectionEx1(instance *cim.WmiInstance) (newInstance *ConfigurationSectionWithCollection, err error) {
...
func NewConfigurationSectionWithCollectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ConfigurationSectionWithCollection, err error) {
...
func (instance *ConfigurationSectionWithCollection) Get( /* IN */ CollectionName string,
	...
	/* OUT */ Element CollectionElement) (err error) {
	_, err = instance.InvokeMethod("Get", CollectionName, ElementIdentifier)
	if err != nil {
		return
	}
	return
...
func (instance *ConfigurationSectionWithCollection) Add( /* IN */ CollectionName string,
	/* IN */ Element CollectionElement) (err error) {
	_, err = instance.InvokeMethodWithReturn("Add", CollectionName, Element)
	if err != nil {
		return
	}
	return
...
func (instance *ConfigurationSectionWithCollection) Remove( /* IN */ CollectionName string,
	/* IN */ Element CollectionElement) (err error) {
	_, err = instance.InvokeMethodWithReturn("Remove", CollectionName, Element)
	if err != nil {
		return
	}
	return
...
// <param name="CollectionName" type="string "></param>
func (instance *ConfigurationSectionWithCollection) Clear( /* IN */ CollectionName string) (err error) {
	_, err = instance.InvokeMethodWithReturn("Clear", CollectionName)
	if err != nil {
		return
	}
	return
