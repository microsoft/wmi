...
func NewTraceAreaSettingsEx1(instance *cim.WmiInstance) (newInstance *TraceAreaSettings, err error) {
...
func NewTraceAreaSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *TraceAreaSettings, err error) {
