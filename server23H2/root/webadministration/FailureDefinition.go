...
func NewFailureDefinitionEx1(instance *cim.WmiInstance) (newInstance *FailureDefinition, err error) {
...
func NewFailureDefinitionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FailureDefinition, err error) {
