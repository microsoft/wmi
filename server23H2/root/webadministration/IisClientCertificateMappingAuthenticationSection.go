...
func NewIisClientCertificateMappingAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *IisClientCertificateMappingAuthenticationSection, err error) {
...
func NewIisClientCertificateMappingAuthenticationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *IisClientCertificateMappingAuthenticationSection, err error) {
