...
func NewProtocolsSectionEx1(instance *cim.WmiInstance) (newInstance *ProtocolsSection, err error) {
...
func NewProtocolsSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ProtocolsSection, err error) {
