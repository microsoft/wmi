...
func NewServerRuntimeSectionEx1(instance *cim.WmiInstance) (newInstance *ServerRuntimeSection, err error) {
...
func NewServerRuntimeSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ServerRuntimeSection, err error) {
