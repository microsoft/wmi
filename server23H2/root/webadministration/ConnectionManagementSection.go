...
func NewConnectionManagementSectionEx1(instance *cim.WmiInstance) (newInstance *ConnectionManagementSection, err error) {
...
func NewConnectionManagementSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ConnectionManagementSection, err error) {
