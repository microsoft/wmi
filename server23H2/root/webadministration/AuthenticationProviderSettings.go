...
func NewAuthenticationProviderSettingsEx1(instance *cim.WmiInstance) (newInstance *AuthenticationProviderSettings, err error) {
...
func NewAuthenticationProviderSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *AuthenticationProviderSettings, err error) {
