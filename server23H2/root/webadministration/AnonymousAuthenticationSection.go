...
func NewAnonymousAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *AnonymousAuthenticationSection, err error) {
...
func NewAnonymousAuthenticationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *AnonymousAuthenticationSection, err error) {
