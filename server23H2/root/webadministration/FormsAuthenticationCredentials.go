...
func NewFormsAuthenticationCredentialsEx1(instance *cim.WmiInstance) (newInstance *FormsAuthenticationCredentials, err error) {
...
func NewFormsAuthenticationCredentialsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FormsAuthenticationCredentials, err error) {
