...
func NewEventMappingSettingsEx1(instance *cim.WmiInstance) (newInstance *EventMappingSettings, err error) {
...
func NewEventMappingSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *EventMappingSettings, err error) {
