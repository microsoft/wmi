...
func NewAuthorizationSectionEx1(instance *cim.WmiInstance) (newInstance *AuthorizationSection, err error) {
...
func NewAuthorizationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *AuthorizationSection, err error) {
