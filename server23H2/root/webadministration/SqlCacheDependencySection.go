...
func NewSqlCacheDependencySectionEx1(instance *cim.WmiInstance) (newInstance *SqlCacheDependencySection, err error) {
...
func NewSqlCacheDependencySectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SqlCacheDependencySection, err error) {
