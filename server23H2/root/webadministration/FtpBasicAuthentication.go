...
func NewFtpBasicAuthenticationEx1(instance *cim.WmiInstance) (newInstance *FtpBasicAuthentication, err error) {
...
func NewFtpBasicAuthenticationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpBasicAuthentication, err error) {
