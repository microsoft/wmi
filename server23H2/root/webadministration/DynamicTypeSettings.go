...
func NewDynamicTypeSettingsEx1(instance *cim.WmiInstance) (newInstance *DynamicTypeSettings, err error) {
...
func NewDynamicTypeSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DynamicTypeSettings, err error) {
