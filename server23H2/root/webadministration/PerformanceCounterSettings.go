...
func NewPerformanceCounterSettingsEx1(instance *cim.WmiInstance) (newInstance *PerformanceCounterSettings, err error) {
...
func NewPerformanceCounterSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PerformanceCounterSettings, err error) {
