...
func NewPassportAuthenticationEx1(instance *cim.WmiInstance) (newInstance *PassportAuthentication, err error) {
...
func NewPassportAuthenticationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PassportAuthentication, err error) {
