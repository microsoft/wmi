...
func NewHttpCompressionMimeTypeElementEx1(instance *cim.WmiInstance) (newInstance *HttpCompressionMimeTypeElement, err error) {
...
func NewHttpCompressionMimeTypeElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HttpCompressionMimeTypeElement, err error) {
