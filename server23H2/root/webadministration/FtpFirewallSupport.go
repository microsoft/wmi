...
func NewFtpFirewallSupportEx1(instance *cim.WmiInstance) (newInstance *FtpFirewallSupport, err error) {
...
func NewFtpFirewallSupportEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpFirewallSupport, err error) {
