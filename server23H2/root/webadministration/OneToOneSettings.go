...
func NewOneToOneSettingsEx1(instance *cim.WmiInstance) (newInstance *OneToOneSettings, err error) {
...
func NewOneToOneSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *OneToOneSettings, err error) {
