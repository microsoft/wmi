...
func NewValidationSectionEx1(instance *cim.WmiInstance) (newInstance *ValidationSection, err error) {
...
func NewValidationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ValidationSection, err error) {
