...
func NewWebDavFileSystemSettingsEx1(instance *cim.WmiInstance) (newInstance *WebDavFileSystemSettings, err error) {
...
func NewWebDavFileSystemSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WebDavFileSystemSettings, err error) {
