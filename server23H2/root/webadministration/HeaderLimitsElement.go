...
func NewHeaderLimitsElementEx1(instance *cim.WmiInstance) (newInstance *HeaderLimitsElement, err error) {
...
func NewHeaderLimitsElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HeaderLimitsElement, err error) {
