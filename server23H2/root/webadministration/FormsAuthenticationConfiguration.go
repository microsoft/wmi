...
func NewFormsAuthenticationConfigurationEx1(instance *cim.WmiInstance) (newInstance *FormsAuthenticationConfiguration, err error) {
...
func NewFormsAuthenticationConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FormsAuthenticationConfiguration, err error) {
