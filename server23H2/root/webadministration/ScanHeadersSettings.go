...
func NewScanHeadersSettingsEx1(instance *cim.WmiInstance) (newInstance *ScanHeadersSettings, err error) {
...
func NewScanHeadersSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ScanHeadersSettings, err error) {
