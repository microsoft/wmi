...
func NewHttpErrorsSectionEx1(instance *cim.WmiInstance) (newInstance *HttpErrorsSection, err error) {
...
func NewHttpErrorsSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HttpErrorsSection, err error) {
