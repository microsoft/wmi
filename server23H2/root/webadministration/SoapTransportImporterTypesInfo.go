...
func NewSoapTransportImporterTypesInfoEx1(instance *cim.WmiInstance) (newInstance *SoapTransportImporterTypesInfo, err error) {
...
func NewSoapTransportImporterTypesInfoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SoapTransportImporterTypesInfo, err error) {
