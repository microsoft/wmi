...
func NewDiagnosticsSettingsEx1(instance *cim.WmiInstance) (newInstance *DiagnosticsSettings, err error) {
...
func NewDiagnosticsSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DiagnosticsSettings, err error) {
