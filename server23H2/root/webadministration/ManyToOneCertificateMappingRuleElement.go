...
func NewManyToOneCertificateMappingRuleElementEx1(instance *cim.WmiInstance) (newInstance *ManyToOneCertificateMappingRuleElement, err error) {
...
func NewManyToOneCertificateMappingRuleElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ManyToOneCertificateMappingRuleElement, err error) {
