...
func NewApplicationPoolFailureSettingsEx1(instance *cim.WmiInstance) (newInstance *ApplicationPoolFailureSettings, err error) {
...
func NewApplicationPoolFailureSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ApplicationPoolFailureSettings, err error) {
