...
func NewTraceUrlSettingsEx1(instance *cim.WmiInstance) (newInstance *TraceUrlSettings, err error) {
...
func NewTraceUrlSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *TraceUrlSettings, err error) {
