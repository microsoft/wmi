...
func NewServiceAutoStartProvidersSectionEx1(instance *cim.WmiInstance) (newInstance *ServiceAutoStartProvidersSection, err error) {
...
func NewServiceAutoStartProvidersSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ServiceAutoStartProvidersSection, err error) {
