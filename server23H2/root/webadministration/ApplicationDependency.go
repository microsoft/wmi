...
func NewApplicationDependencyEx1(instance *cim.WmiInstance) (newInstance *ApplicationDependency, err error) {
...
func NewApplicationDependencyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ApplicationDependency, err error) {
