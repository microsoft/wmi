...
func NewUrlMappingsSectionEx1(instance *cim.WmiInstance) (newInstance *UrlMappingsSection, err error) {
...
func NewUrlMappingsSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *UrlMappingsSection, err error) {
