...
func NewTransactionsDefaultSettingsSectionEx1(instance *cim.WmiInstance) (newInstance *TransactionsDefaultSettingsSection, err error) {
...
func NewTransactionsDefaultSettingsSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *TransactionsDefaultSettingsSection, err error) {
