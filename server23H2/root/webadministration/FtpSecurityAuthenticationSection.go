...
func NewFtpSecurityAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *FtpSecurityAuthenticationSection, err error) {
...
func NewFtpSecurityAuthenticationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpSecurityAuthenticationSection, err error) {
