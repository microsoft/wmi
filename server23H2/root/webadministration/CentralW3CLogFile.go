...
func NewCentralW3CLogFileEx1(instance *cim.WmiInstance) (newInstance *CentralW3CLogFile, err error) {
...
func NewCentralW3CLogFileEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CentralW3CLogFile, err error) {
