...
func NewHttpModulesSectionEx1(instance *cim.WmiInstance) (newInstance *HttpModulesSection, err error) {
...
func NewHttpModulesSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HttpModulesSection, err error) {
