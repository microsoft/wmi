...
func NewFastCgiEnvironmentElementEx1(instance *cim.WmiInstance) (newInstance *FastCgiEnvironmentElement, err error) {
...
func NewFastCgiEnvironmentElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FastCgiEnvironmentElement, err error) {
