...
func NewWebSocketSectionEx1(instance *cim.WmiInstance) (newInstance *WebSocketSection, err error) {
...
func NewWebSocketSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WebSocketSection, err error) {
