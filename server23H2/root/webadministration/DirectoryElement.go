...
func NewDirectoryElementEx1(instance *cim.WmiInstance) (newInstance *DirectoryElement, err error) {
...
func NewDirectoryElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DirectoryElement, err error) {
