...
func NewFtpProviderDefinitionElementEx1(instance *cim.WmiInstance) (newInstance *FtpProviderDefinitionElement, err error) {
...
func NewFtpProviderDefinitionElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpProviderDefinitionElement, err error) {
