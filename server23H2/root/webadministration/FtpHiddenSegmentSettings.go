...
func NewFtpHiddenSegmentSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpHiddenSegmentSettings, err error) {
...
func NewFtpHiddenSegmentSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpHiddenSegmentSettings, err error) {
