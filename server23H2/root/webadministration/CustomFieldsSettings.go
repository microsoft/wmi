...
func NewCustomFieldsSettingsEx1(instance *cim.WmiInstance) (newInstance *CustomFieldsSettings, err error) {
...
func NewCustomFieldsSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CustomFieldsSettings, err error) {
