...
func NewConfigurationSectionEx1(instance *cim.WmiInstance) (newInstance *ConfigurationSection, err error) {
...
func NewConfigurationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ConfigurationSection, err error) {
...
func (instance *ConfigurationSection) RevertToParent( /* OPTIONAL IN */ PropertyName string) (err error) {
...
func (instance *ConfigurationSection) GetAllowDefinition( /* OUT */ AllowDefinition string) (err error) {
	_, err = instance.InvokeMethod("GetAllowDefinition")
	if err != nil {
		return
	}
	return
...
// <param name="AllowDefinition" type="string "></param>
func (instance *ConfigurationSection) SetAllowDefinition( /* IN */ AllowDefinition string) (err error) {
	_, err = instance.InvokeMethodWithReturn("SetAllowDefinition", AllowDefinition)
	if err != nil {
		return
	}
	return
...
func (instance *ConfigurationSection) GetAllowLocation( /* OUT */ AllowLocation string) (err error) {
	_, err = instance.InvokeMethod("GetAllowLocation")
	if err != nil {
		return
	}
	return
...
// <param name="AllowLocation" type="string "></param>
func (instance *ConfigurationSection) SetAllowLocation( /* IN */ AllowLocation string) (err error) {
	_, err = instance.InvokeMethodWithReturn("SetAllowLocation", AllowLocation)
	if err != nil {
		return
	}
	return
