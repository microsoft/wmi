...
func NewBypassListSettingsEx1(instance *cim.WmiInstance) (newInstance *BypassListSettings, err error) {
...
func NewBypassListSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *BypassListSettings, err error) {
