...
func NewSystemDiagnosticsSectionEx1(instance *cim.WmiInstance) (newInstance *SystemDiagnosticsSection, err error) {
...
func NewSystemDiagnosticsSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemDiagnosticsSection, err error) {
