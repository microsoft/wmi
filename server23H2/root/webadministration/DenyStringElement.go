...
func NewDenyStringElementEx1(instance *cim.WmiInstance) (newInstance *DenyStringElement, err error) {
...
func NewDenyStringElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DenyStringElement, err error) {
