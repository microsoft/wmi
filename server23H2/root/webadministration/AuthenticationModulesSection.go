...
func NewAuthenticationModulesSectionEx1(instance *cim.WmiInstance) (newInstance *AuthenticationModulesSection, err error) {
...
func NewAuthenticationModulesSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *AuthenticationModulesSection, err error) {
