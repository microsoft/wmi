...
func NewHttpRuntimeSectionEx1(instance *cim.WmiInstance) (newInstance *HttpRuntimeSection, err error) {
...
func NewHttpRuntimeSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HttpRuntimeSection, err error) {
