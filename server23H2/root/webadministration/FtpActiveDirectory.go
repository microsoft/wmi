...
func NewFtpActiveDirectoryEx1(instance *cim.WmiInstance) (newInstance *FtpActiveDirectory, err error) {
...
func NewFtpActiveDirectoryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpActiveDirectory, err error) {
