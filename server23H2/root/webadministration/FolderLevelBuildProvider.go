...
func NewFolderLevelBuildProviderEx1(instance *cim.WmiInstance) (newInstance *FolderLevelBuildProvider, err error) {
...
func NewFolderLevelBuildProviderEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FolderLevelBuildProvider, err error) {
