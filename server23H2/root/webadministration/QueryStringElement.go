...
func NewQueryStringElementEx1(instance *cim.WmiInstance) (newInstance *QueryStringElement, err error) {
...
func NewQueryStringElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *QueryStringElement, err error) {
