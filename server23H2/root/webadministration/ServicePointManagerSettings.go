...
func NewServicePointManagerSettingsEx1(instance *cim.WmiInstance) (newInstance *ServicePointManagerSettings, err error) {
...
func NewServicePointManagerSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ServicePointManagerSettings, err error) {
