...
func NewSoapExtensionImporterTypesSettingsEx1(instance *cim.WmiInstance) (newInstance *SoapExtensionImporterTypesSettings, err error) {
...
func NewSoapExtensionImporterTypesSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SoapExtensionImporterTypesSettings, err error) {
