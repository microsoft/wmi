...
func NewFtpProviderDefinitionElementActivationEx1(instance *cim.WmiInstance) (newInstance *FtpProviderDefinitionElementActivation, err error) {
...
func NewFtpProviderDefinitionElementActivationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpProviderDefinitionElementActivation, err error) {
