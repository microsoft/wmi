...
func NewSoapServerProtocolFactoryEx1(instance *cim.WmiInstance) (newInstance *SoapServerProtocolFactory, err error) {
...
func NewSoapServerProtocolFactoryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SoapServerProtocolFactory, err error) {
