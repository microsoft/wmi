...
func NewListenerAdaptersSectionEx1(instance *cim.WmiInstance) (newInstance *ListenerAdaptersSection, err error) {
...
func NewListenerAdaptersSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ListenerAdaptersSection, err error) {
