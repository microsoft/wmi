...
func NewApplicationContainsVirtualDirectoryEx1(instance *cim.WmiInstance) (newInstance *ApplicationContainsVirtualDirectory, err error) {
...
func NewApplicationContainsVirtualDirectoryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ApplicationContainsVirtualDirectory, err error) {
