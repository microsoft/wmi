...
func NewHttpHandlersSectionEx1(instance *cim.WmiInstance) (newInstance *HttpHandlersSection, err error) {
...
func NewHttpHandlersSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HttpHandlersSection, err error) {
