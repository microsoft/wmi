...
func NewServerEx1(instance *cim.WmiInstance) (newInstance *Server, err error) {
...
func NewServerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Server, err error) {
...
func (instance *Server) BeginUpdateBatch( /* IN */ Path string) (err error) {
	_, err = instance.InvokeMethodWithReturn("BeginUpdateBatch", Path)
	if err != nil {
		return
	}
	return
...
func (instance *Server) EndUpdateBatch( /* OPTIONAL IN */ DoCommitChanges bool) (err error) {
	_, err = instance.InvokeMethodWithReturn("EndUpdateBatch", DoCommitChanges)
	if err != nil {
		return
	}
	return
...
func (instance *Server) GetMetadata( /* IN */ Name string) (result string, err error) {
	retVal, err := instance.InvokeMethodWithReturn("GetMetadata", Name)
	if err != nil {
		return
	}
...
func (instance *Server) SetMetadata( /* IN */ Name string,
	...
	_, err = instance.InvokeMethodWithReturn("SetMetadata", Name, Value)
	if err != nil {
		return
	}
	return
