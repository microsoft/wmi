...
func NewOneToOneCertificateMappingElementEx1(instance *cim.WmiInstance) (newInstance *OneToOneCertificateMappingElement, err error) {
...
func NewOneToOneCertificateMappingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *OneToOneCertificateMappingElement, err error) {
