...
func NewConfigurationHistorySectionEx1(instance *cim.WmiInstance) (newInstance *ConfigurationHistorySection, err error) {
...
func NewConfigurationHistorySectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ConfigurationHistorySection, err error) {
