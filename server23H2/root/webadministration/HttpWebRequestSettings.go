...
func NewHttpWebRequestSettingsEx1(instance *cim.WmiInstance) (newInstance *HttpWebRequestSettings, err error) {
...
func NewHttpWebRequestSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HttpWebRequestSettings, err error) {
