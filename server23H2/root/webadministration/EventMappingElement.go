...
func NewEventMappingElementEx1(instance *cim.WmiInstance) (newInstance *EventMappingElement, err error) {
...
func NewEventMappingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *EventMappingElement, err error) {
