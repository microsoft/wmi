...
func NewApplicationElementDefaultsEx1(instance *cim.WmiInstance) (newInstance *ApplicationElementDefaults, err error) {
...
func NewApplicationElementDefaultsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ApplicationElementDefaults, err error) {
