...
func NewProviderFactoryElementEx1(instance *cim.WmiInstance) (newInstance *ProviderFactoryElement, err error) {
...
func NewProviderFactoryElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ProviderFactoryElement, err error) {
