...
func NewApplicationInitializationSectionEx1(instance *cim.WmiInstance) (newInstance *ApplicationInitializationSection, err error) {
...
func NewApplicationInitializationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ApplicationInitializationSection, err error) {
