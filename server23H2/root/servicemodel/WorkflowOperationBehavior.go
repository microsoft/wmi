...
func NewWorkflowOperationBehaviorEx1(instance *cim.WmiInstance) (newInstance *WorkflowOperationBehavior, err error) {
...
func NewWorkflowOperationBehaviorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WorkflowOperationBehavior, err error) {
