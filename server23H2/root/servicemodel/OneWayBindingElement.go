...
func NewOneWayBindingElementEx1(instance *cim.WmiInstance) (newInstance *OneWayBindingElement, err error) {
...
func NewOneWayBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *OneWayBindingElement, err error) {
