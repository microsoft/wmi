...
func NewDurableServiceAttributeEx1(instance *cim.WmiInstance) (newInstance *DurableServiceAttribute, err error) {
...
func NewDurableServiceAttributeEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DurableServiceAttribute, err error) {
