...
func NewMtomMessageEncodingBindingElementEx1(instance *cim.WmiInstance) (newInstance *MtomMessageEncodingBindingElement, err error) {
...
func NewMtomMessageEncodingBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MtomMessageEncodingBindingElement, err error) {
