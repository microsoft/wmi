...
func NewMessageEncodingBindingElementEx1(instance *cim.WmiInstance) (newInstance *MessageEncodingBindingElement, err error) {
...
func NewMessageEncodingBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MessageEncodingBindingElement, err error) {
