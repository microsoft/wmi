...
func NewHttpsTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *HttpsTransportBindingElement, err error) {
	tmp, err := NewHttpTransportBindingElementEx1(instance)
...
func NewHttpsTransportBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HttpsTransportBindingElement, err error) {
	tmp, err := NewHttpTransportBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
