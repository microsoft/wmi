...
func NewExtendedProtectionPolicyEx1(instance *cim.WmiInstance) (newInstance *ExtendedProtectionPolicy, err error) {
...
func NewExtendedProtectionPolicyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ExtendedProtectionPolicy, err error) {
