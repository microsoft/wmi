...
func NewPeerTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *PeerTransportBindingElement, err error) {
...
func NewPeerTransportBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PeerTransportBindingElement, err error) {
