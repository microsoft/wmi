...
func NewCallbackBehaviorEx1(instance *cim.WmiInstance) (newInstance *CallbackBehavior, err error) {
...
func NewCallbackBehaviorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CallbackBehavior, err error) {
