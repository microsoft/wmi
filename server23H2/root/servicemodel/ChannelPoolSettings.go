...
func NewChannelPoolSettingsEx1(instance *cim.WmiInstance) (newInstance *ChannelPoolSettings, err error) {
...
func NewChannelPoolSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ChannelPoolSettings, err error) {
