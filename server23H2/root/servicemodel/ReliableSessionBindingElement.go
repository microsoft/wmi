...
func NewReliableSessionBindingElementEx1(instance *cim.WmiInstance) (newInstance *ReliableSessionBindingElement, err error) {
...
func NewReliableSessionBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ReliableSessionBindingElement, err error) {
