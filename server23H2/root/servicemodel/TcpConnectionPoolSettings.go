...
func NewTcpConnectionPoolSettingsEx1(instance *cim.WmiInstance) (newInstance *TcpConnectionPoolSettings, err error) {
...
func NewTcpConnectionPoolSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *TcpConnectionPoolSettings, err error) {
