...
func NewCustomBindingElementEx1(instance *cim.WmiInstance) (newInstance *CustomBindingElement, err error) {
...
func NewCustomBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CustomBindingElement, err error) {
