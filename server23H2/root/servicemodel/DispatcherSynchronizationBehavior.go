...
func NewDispatcherSynchronizationBehaviorEx1(instance *cim.WmiInstance) (newInstance *DispatcherSynchronizationBehavior, err error) {
...
func NewDispatcherSynchronizationBehaviorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DispatcherSynchronizationBehavior, err error) {
