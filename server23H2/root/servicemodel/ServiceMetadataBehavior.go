...
func NewServiceMetadataBehaviorEx1(instance *cim.WmiInstance) (newInstance *ServiceMetadataBehavior, err error) {
...
func NewServiceMetadataBehaviorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ServiceMetadataBehavior, err error) {
