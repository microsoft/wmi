...
func NewMsmqIntegrationBindingElementEx1(instance *cim.WmiInstance) (newInstance *MsmqIntegrationBindingElement, err error) {
...
func NewMsmqIntegrationBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MsmqIntegrationBindingElement, err error) {
