...
func NewPnrpPeerResolverBindingElementEx1(instance *cim.WmiInstance) (newInstance *PnrpPeerResolverBindingElement, err error) {
...
func NewPnrpPeerResolverBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PnrpPeerResolverBindingElement, err error) {
