...
func NewWebInvokeAttributeEx1(instance *cim.WmiInstance) (newInstance *WebInvokeAttribute, err error) {
...
func NewWebInvokeAttributeEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WebInvokeAttribute, err error) {
