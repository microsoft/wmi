...
const (
	...
	// Installable enum
	SoftwareElement_SoftwareElementState_Installable SoftwareElement_SoftwareElementState = 1
	// Executable enum
	SoftwareElement_SoftwareElementState_Executable SoftwareElement_SoftwareElementState = 2
	// Running enum
