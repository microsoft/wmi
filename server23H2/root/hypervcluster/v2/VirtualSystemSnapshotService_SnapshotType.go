...
const (
	...
	// Disk_Snapshot enum
	VirtualSystemSnapshotService_SnapshotType_Disk_Snapshot VirtualSystemSnapshotService_SnapshotType = 3
	// DMTF_Reserved enum
	VirtualSystemSnapshotService_SnapshotType_DMTF_Reserved VirtualSystemSnapshotService_SnapshotType = 4
