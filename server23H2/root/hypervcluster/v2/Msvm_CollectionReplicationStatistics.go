...
func NewMsvm_CollectionReplicationStatisticsEx1(instance *cim.WmiInstance) (newInstance *Msvm_CollectionReplicationStatistics, err error) {
...
func NewMsvm_CollectionReplicationStatisticsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_CollectionReplicationStatistics, err error) {
