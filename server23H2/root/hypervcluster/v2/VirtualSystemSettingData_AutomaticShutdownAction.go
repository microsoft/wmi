...
const (
	...
	// Save_state enum
	VirtualSystemSettingData_AutomaticShutdownAction_Save_state VirtualSystemSettingData_AutomaticShutdownAction = 3
	// Shutdown enum
	VirtualSystemSettingData_AutomaticShutdownAction_Shutdown VirtualSystemSettingData_AutomaticShutdownAction = 4
	// DMTF_Reserved enum
