...
func NewMsvm_ManagementCollectionEx1(instance *cim.WmiInstance) (newInstance *Msvm_ManagementCollection, err error) {
...
func NewMsvm_ManagementCollectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_ManagementCollection, err error) {
