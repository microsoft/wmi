...
const (
	...
	// _10 enum
	SmbMultichannelConnection_SmbInstance__10 SmbMultichannelConnection_SmbInstance = 1
	// _56 enum
	SmbMultichannelConnection_SmbInstance__56 SmbMultichannelConnection_SmbInstance = 2
	// _57 enum
