...
func NewPS_VpnConnectionIPsecConfigurationEx1(instance *cim.WmiInstance) (newInstance *PS_VpnConnectionIPsecConfiguration, err error) {
...
func NewPS_VpnConnectionIPsecConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_VpnConnectionIPsecConfiguration, err error) {
