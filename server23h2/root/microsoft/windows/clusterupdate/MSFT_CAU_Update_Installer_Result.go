...
func NewMSFT_CAU_Update_Installer_ResultEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAU_Update_Installer_Result, err error) {
...
func NewMSFT_CAU_Update_Installer_ResultEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_CAU_Update_Installer_Result, err error) {
