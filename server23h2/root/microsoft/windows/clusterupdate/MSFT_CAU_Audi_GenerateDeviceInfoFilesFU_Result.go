...
func NewMSFT_CAU_Audi_GenerateDeviceInfoFilesFU_ResultEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAU_Audi_GenerateDeviceInfoFilesFU_Result, err error) {
...
func NewMSFT_CAU_Audi_GenerateDeviceInfoFilesFU_ResultEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_CAU_Audi_GenerateDeviceInfoFilesFU_Result, err error) {
