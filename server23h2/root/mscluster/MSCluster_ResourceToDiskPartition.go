...
func NewMSCluster_ResourceToDiskPartitionEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ResourceToDiskPartition, err error) {
...
func NewMSCluster_ResourceToDiskPartitionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSCluster_ResourceToDiskPartition, err error) {
