...
func NewBcdDeviceLocateStringDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceLocateStringData, err error) {
...
func NewBcdDeviceLocateStringDataEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *BcdDeviceLocateStringData, err error) {
