...
func NewMSNdis_WmiSetHeaderEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiSetHeader, err error) {
...
func NewMSNdis_WmiSetHeaderEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_WmiSetHeader, err error) {
