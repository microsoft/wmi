...
func NewDiskIo_V1_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *DiskIo_V1_TypeGroup1, err error) {
...
func NewDiskIo_V1_TypeGroup1Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DiskIo_V1_TypeGroup1, err error) {
