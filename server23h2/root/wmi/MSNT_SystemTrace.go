...
func NewMSNT_SystemTraceEx1(instance *cim.WmiInstance) (newInstance *MSNT_SystemTrace, err error) {
...
func NewMSNT_SystemTraceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNT_SystemTrace, err error) {
