...
func NewMSDiskDriver_PerformanceEx1(instance *cim.WmiInstance) (newInstance *MSDiskDriver_Performance, err error) {
...
func NewMSDiskDriver_PerformanceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSDiskDriver_Performance, err error) {
