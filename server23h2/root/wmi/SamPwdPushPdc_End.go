...
func NewSamPwdPushPdc_EndEx1(instance *cim.WmiInstance) (newInstance *SamPwdPushPdc_End, err error) {
...
func NewSamPwdPushPdc_EndEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamPwdPushPdc_End, err error) {
