...
func NewMSNdis_QueryReceiveFilterCurrentCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_QueryReceiveFilterCurrentCapabilities, err error) {
...
func NewMSNdis_QueryReceiveFilterCurrentCapabilitiesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_QueryReceiveFilterCurrentCapabilities, err error) {
...
func (instance *MSNdis_QueryReceiveFilterCurrentCapabilities) WmiQueryReceiveFilterCurrentCapabilities( /* IN */ Header MSNdis_WmiMethodHeader,
	/* OUT */ ReceiveFilterCurrentCapabilities MSNdis_ReceiveFilterCapabilities) (err error) {
	_, err = instance.InvokeMethod("WmiQueryReceiveFilterCurrentCapabilities", Header)
	if err != nil {
		return
	}
	return
