...
func NewIdleAccountingExEx1(instance *cim.WmiInstance) (newInstance *IdleAccountingEx, err error) {
...
func NewIdleAccountingExEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *IdleAccountingEx, err error) {
