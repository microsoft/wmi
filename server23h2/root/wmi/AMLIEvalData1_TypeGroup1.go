...
func NewAMLIEvalData1_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *AMLIEvalData1_TypeGroup1, err error) {
	tmp, err := NewAMLIEvalData1Ex1(instance)
...
func NewAMLIEvalData1_TypeGroup1Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *AMLIEvalData1_TypeGroup1, err error) {
	tmp, err := NewAMLIEvalData1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
