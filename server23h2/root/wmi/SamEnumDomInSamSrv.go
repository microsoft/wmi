...
func NewSamEnumDomInSamSrvEx1(instance *cim.WmiInstance) (newInstance *SamEnumDomInSamSrv, err error) {
...
func NewSamEnumDomInSamSrvEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamEnumDomInSamSrv, err error) {
