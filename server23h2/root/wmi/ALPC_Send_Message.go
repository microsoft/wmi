...
func NewALPC_Send_MessageEx1(instance *cim.WmiInstance) (newInstance *ALPC_Send_Message, err error) {
...
func NewALPC_Send_MessageEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ALPC_Send_Message, err error) {
