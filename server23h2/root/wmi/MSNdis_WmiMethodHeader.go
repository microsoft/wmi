...
func NewMSNdis_WmiMethodHeaderEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiMethodHeader, err error) {
...
func NewMSNdis_WmiMethodHeaderEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_WmiMethodHeader, err error) {
