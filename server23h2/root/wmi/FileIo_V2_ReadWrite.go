...
func NewFileIo_V2_ReadWriteEx1(instance *cim.WmiInstance) (newInstance *FileIo_V2_ReadWrite, err error) {
...
func NewFileIo_V2_ReadWriteEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FileIo_V2_ReadWrite, err error) {
