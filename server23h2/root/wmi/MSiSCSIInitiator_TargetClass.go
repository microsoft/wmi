...
func NewMSiSCSIInitiator_TargetClassEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_TargetClass, err error) {
...
func NewMSiSCSIInitiator_TargetClassEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSiSCSIInitiator_TargetClass, err error) {
...
func (instance *MSiSCSIInitiator_TargetClass) Login( /* IN */ IsInformationalSession bool,
	...
	retVal, err := instance.InvokeMethod("Login", IsInformationalSession, InitiatorPortNumber, TargetPortal, SecurityFlags, Mappings, LoginOptions, key, IsPersistent)
	if err != nil {
		return
	}
