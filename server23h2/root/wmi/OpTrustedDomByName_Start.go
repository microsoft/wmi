...
func NewOpTrustedDomByName_StartEx1(instance *cim.WmiInstance) (newInstance *OpTrustedDomByName_Start, err error) {
...
func NewOpTrustedDomByName_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *OpTrustedDomByName_Start, err error) {
