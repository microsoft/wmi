...
func NewMSStorageDriver_FailurePredictFunctionEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_FailurePredictFunction, err error) {
...
func NewMSStorageDriver_FailurePredictFunctionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSStorageDriver_FailurePredictFunction, err error) {
...
func (instance *MSStorageDriver_FailurePredictFunction) AllowPerformanceHit( /* IN */ Allow bool) (err error) {
	_, err = instance.InvokeMethodWithReturn("AllowPerformanceHit", Allow)
	if err != nil {
		return
	}
	return
...
func (instance *MSStorageDriver_FailurePredictFunction) EnableDisableHardwareFailurePrediction( /* IN */ Enable bool) (err error) {
	_, err = instance.InvokeMethodWithReturn("EnableDisableHardwareFailurePrediction", Enable)
	if err != nil {
		return
	}
	return
...
func (instance *MSStorageDriver_FailurePredictFunction) EnableDisableFailurePredictionPolling( /* IN */ Period uint32,
	/* IN */ Enable bool) (err error) {
	_, err = instance.InvokeMethodWithReturn("EnableDisableFailurePredictionPolling", Period, Enable)
	if err != nil {
		return
	}
	return
...
func (instance *MSStorageDriver_FailurePredictFunction) GetFailurePredictionCapability( /* OUT */ Capability uint32) (err error) {
	_, err = instance.InvokeMethod("GetFailurePredictionCapability")
	if err != nil {
		return
	}
	return
...
func (instance *MSStorageDriver_FailurePredictFunction) EnableOfflineDiags( /* OUT */ Success bool) (err error) {
	_, err = instance.InvokeMethod("EnableOfflineDiags")
	if err != nil {
		return
	}
	return
...
func (instance *MSStorageDriver_FailurePredictFunction) ReadLogSectors( /* IN */ LogAddress uint8,
	...
	/* OUT */ Length uint32,
	/* OUT */ LogSectors []uint8) (err error) {
	_, err = instance.InvokeMethod("ReadLogSectors", LogAddress, SectorCount)
	if err != nil {
		return
	}
	return
...
func (instance *MSStorageDriver_FailurePredictFunction) WriteLogSectors( /* IN */ LogAddress uint8,
	...
	/* IN */ Length uint32,
	/* IN */ LogSectors []uint8,
	/* OUT */ Success bool) (err error) {
	_, err = instance.InvokeMethod("WriteLogSectors", LogAddress, SectorCount, Length, LogSectors)
	if err != nil {
		return
	}
	return
...
func (instance *MSStorageDriver_FailurePredictFunction) ExecuteSelfTest( /* IN */ Subcommand uint8,
	/* OUT */ ReturnCode uint32) (err error) {
	_, err = instance.InvokeMethod("ExecuteSelfTest", Subcommand)
	if err != nil {
		return
	}
	return
