...
func NewMSiSCSI_InitiatorLoginStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_InitiatorLoginStatistics, err error) {
...
func NewMSiSCSI_InitiatorLoginStatisticsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSiSCSI_InitiatorLoginStatistics, err error) {
