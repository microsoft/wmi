...
func NewSamRemoveMemFromForeignDomEx1(instance *cim.WmiInstance) (newInstance *SamRemoveMemFromForeignDom, err error) {
...
func NewSamRemoveMemFromForeignDomEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamRemoveMemFromForeignDom, err error) {
