...
func NewMS_SystemInformationEx1(instance *cim.WmiInstance) (newInstance *MS_SystemInformation, err error) {
...
func NewMS_SystemInformationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MS_SystemInformation, err error) {
