...
func NewSpinLockConfig_V3Ex1(instance *cim.WmiInstance) (newInstance *SpinLockConfig_V3, err error) {
...
func NewSpinLockConfig_V3Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SpinLockConfig_V3, err error) {
