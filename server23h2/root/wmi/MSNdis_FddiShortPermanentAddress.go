...
func NewMSNdis_FddiShortPermanentAddressEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiShortPermanentAddress, err error) {
...
func NewMSNdis_FddiShortPermanentAddressEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_FddiShortPermanentAddress, err error) {
