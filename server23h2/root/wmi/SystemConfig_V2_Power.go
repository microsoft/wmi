...
func NewSystemConfig_V2_PowerEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_Power, err error) {
...
func NewSystemConfig_V2_PowerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_Power, err error) {
