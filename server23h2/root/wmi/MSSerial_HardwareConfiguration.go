...
func NewMSSerial_HardwareConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSSerial_HardwareConfiguration, err error) {
...
func NewMSSerial_HardwareConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSSerial_HardwareConfiguration, err error) {
