...
func NewIdleExitLatencyEx1(instance *cim.WmiInstance) (newInstance *IdleExitLatency, err error) {
	tmp, err := NewPowerEventsEx1(instance)
...
func NewIdleExitLatencyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *IdleExitLatency, err error) {
	tmp, err := NewPowerEventsEx6(hostName, wmiNamespace, userName, password, domainName, query)
