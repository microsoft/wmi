...
func NewMSTapeProblemIoErrorEx1(instance *cim.WmiInstance) (newInstance *MSTapeProblemIoError, err error) {
...
func NewMSTapeProblemIoErrorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSTapeProblemIoError, err error) {
