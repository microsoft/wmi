...
func NewSystemConfig_V2_DPIEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_DPI, err error) {
...
func NewSystemConfig_V2_DPIEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V2_DPI, err error) {
