...
const (
	...
	// LargeToSmall enum
	ProcessorSettingData_L3ProcessorDistributionPolicy_LargeToSmall ProcessorSettingData_L3ProcessorDistributionPolicy = 1
	// EvenSmallToLarge enum
	ProcessorSettingData_L3ProcessorDistributionPolicy_EvenSmallToLarge ProcessorSettingData_L3ProcessorDistributionPolicy = 2
