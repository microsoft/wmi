...
func NewMsvm_MediaPresentEx1(instance *cim.WmiInstance) (newInstance *Msvm_MediaPresent, err error) {
...
func NewMsvm_MediaPresentEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_MediaPresent, err error) {
