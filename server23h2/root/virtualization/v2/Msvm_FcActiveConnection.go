...
func NewMsvm_FcActiveConnectionEx1(instance *cim.WmiInstance) (newInstance *Msvm_FcActiveConnection, err error) {
...
func NewMsvm_FcActiveConnectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_FcActiveConnection, err error) {
