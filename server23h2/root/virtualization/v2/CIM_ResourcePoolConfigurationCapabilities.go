...
func NewCIM_ResourcePoolConfigurationCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *CIM_ResourcePoolConfigurationCapabilities, err error) {
...
func NewCIM_ResourcePoolConfigurationCapabilitiesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CIM_ResourcePoolConfigurationCapabilities, err error) {
