...
func NewMsvm_HostedDependencyEx1(instance *cim.WmiInstance) (newInstance *Msvm_HostedDependency, err error) {
...
func NewMsvm_HostedDependencyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_HostedDependency, err error) {
