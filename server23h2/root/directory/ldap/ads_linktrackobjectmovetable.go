...
func Newads_linktrackobjectmovetableEx1(instance *cim.WmiInstance) (newInstance *ads_linktrackobjectmovetable, err error) {
...
func Newads_linktrackobjectmovetableEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_linktrackobjectmovetable, err error) {
