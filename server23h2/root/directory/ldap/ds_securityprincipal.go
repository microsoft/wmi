...
func Newds_securityprincipalEx1(instance *cim.WmiInstance) (newInstance *ds_securityprincipal, err error) {
...
func Newds_securityprincipalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ds_securityprincipal, err error) {
