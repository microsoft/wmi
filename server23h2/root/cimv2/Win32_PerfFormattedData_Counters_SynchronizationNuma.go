...
func NewWin32_PerfFormattedData_Counters_SynchronizationNumaEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_SynchronizationNuma, err error) {
...
func NewWin32_PerfFormattedData_Counters_SynchronizationNumaEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_SynchronizationNuma, err error) {
