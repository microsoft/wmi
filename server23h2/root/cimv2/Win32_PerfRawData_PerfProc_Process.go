...
func NewWin32_PerfRawData_PerfProc_ProcessEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_PerfProc_Process, err error) {
...
func NewWin32_PerfRawData_PerfProc_ProcessEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_PerfProc_Process, err error) {
