...
func NewWin32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplicationsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications, err error) {
...
func NewWin32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplicationsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications, err error) {
