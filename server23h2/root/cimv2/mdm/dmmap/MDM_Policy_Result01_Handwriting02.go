...
func NewMDM_Policy_Result01_Handwriting02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_Handwriting02, err error) {
...
func NewMDM_Policy_Result01_Handwriting02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Policy_Result01_Handwriting02, err error) {
