...
const (
	...
	EncryptableVolume_BindingState_DisabledByPolicy EncryptableVolume_BindingState = 1
	// Possible enum
	EncryptableVolume_BindingState_Possible EncryptableVolume_BindingState = 2
	// Bound enum
