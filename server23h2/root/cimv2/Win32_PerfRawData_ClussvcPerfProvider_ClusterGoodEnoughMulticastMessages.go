...
func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessagesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessages, err error) {
...
func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessagesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessages, err error) {
