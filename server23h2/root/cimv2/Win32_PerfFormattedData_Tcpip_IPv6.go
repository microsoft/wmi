...
func NewWin32_PerfFormattedData_Tcpip_IPv6Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Tcpip_IPv6, err error) {
...
func NewWin32_PerfFormattedData_Tcpip_IPv6Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Tcpip_IPv6, err error) {
