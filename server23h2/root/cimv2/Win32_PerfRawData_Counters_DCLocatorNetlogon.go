...
func NewWin32_PerfRawData_Counters_DCLocatorNetlogonEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_DCLocatorNetlogon, err error) {
...
func NewWin32_PerfRawData_Counters_DCLocatorNetlogonEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_DCLocatorNetlogon, err error) {
