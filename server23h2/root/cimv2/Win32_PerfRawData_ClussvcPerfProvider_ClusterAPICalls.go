...
func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterAPICallsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls, err error) {
...
func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterAPICallsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls, err error) {
