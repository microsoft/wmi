...
func NewWin32_PerfRawData_Counters_PacerFlowEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_PacerFlow, err error) {
...
func NewWin32_PerfRawData_Counters_PacerFlowEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_PacerFlow, err error) {
