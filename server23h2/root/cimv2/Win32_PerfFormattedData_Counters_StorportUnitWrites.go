...
func NewWin32_PerfFormattedData_Counters_StorportUnitWritesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_StorportUnitWrites, err error) {
...
func NewWin32_PerfFormattedData_Counters_StorportUnitWritesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_StorportUnitWrites, err error) {
