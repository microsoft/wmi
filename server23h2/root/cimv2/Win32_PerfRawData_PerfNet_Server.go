...
func NewWin32_PerfRawData_PerfNet_ServerEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_PerfNet_Server, err error) {
...
func NewWin32_PerfRawData_PerfNet_ServerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_PerfNet_Server, err error) {
