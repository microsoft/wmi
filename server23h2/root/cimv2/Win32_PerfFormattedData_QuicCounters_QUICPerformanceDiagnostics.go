...
func NewWin32_PerfFormattedData_QuicCounters_QUICPerformanceDiagnosticsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_QuicCounters_QUICPerformanceDiagnostics, err error) {
...
func NewWin32_PerfFormattedData_QuicCounters_QUICPerformanceDiagnosticsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_QuicCounters_QUICPerformanceDiagnostics, err error) {
