...
type SMTPEventConsumer struct { 
	*__EventConsumer
	...
	func NewSMTPEventConsumerEx1(instance *cim.WmiInstance) (newInstance *SMTPEventConsumer, err error) {tmp, err := New__EventConsumerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SMTPEventConsumer, err error) {tmp, err := New__EventConsumerEx6(hostName, wmiNamespace, userName, password, domainName, query)
