...
type LogFileEventConsumer struct { 
	*__EventConsumer
	...
	func NewLogFileEventConsumerEx1(instance *cim.WmiInstance) (newInstance *LogFileEventConsumer, err error) {tmp, err := New__EventConsumerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LogFileEventConsumer, err error) {tmp, err := New__EventConsumerEx6(hostName, wmiNamespace, userName, password, domainName, query)
