...
type MSFT_CliFormat struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CliFormatEx1(instance *cim.WmiInstance) (newInstance *MSFT_CliFormat, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CliFormat, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
