...
type MSFT_CliTranslateTable struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CliTranslateTableEx1(instance *cim.WmiInstance) (newInstance *MSFT_CliTranslateTable, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CliTranslateTable, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
