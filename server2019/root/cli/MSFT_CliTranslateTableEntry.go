...
type MSFT_CliTranslateTableEntry struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CliTranslateTableEntryEx1(instance *cim.WmiInstance) (newInstance *MSFT_CliTranslateTableEntry, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CliTranslateTableEntry, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
