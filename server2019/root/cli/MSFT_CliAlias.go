...
type MSFT_CliAlias struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CliAliasEx1(instance *cim.WmiInstance) (newInstance *MSFT_CliAlias, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CliAlias, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
