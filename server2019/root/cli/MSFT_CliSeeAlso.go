...
type MSFT_CliSeeAlso struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CliSeeAlsoEx1(instance *cim.WmiInstance) (newInstance *MSFT_CliSeeAlso, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CliSeeAlso, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
