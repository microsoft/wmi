...
type MSFT_CliVerb struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CliVerbEx1(instance *cim.WmiInstance) (newInstance *MSFT_CliVerb, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CliVerb, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
