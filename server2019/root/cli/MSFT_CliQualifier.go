...
type MSFT_CliQualifier struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CliQualifierEx1(instance *cim.WmiInstance) (newInstance *MSFT_CliQualifier, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CliQualifier, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
