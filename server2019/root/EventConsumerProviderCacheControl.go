...
type __EventConsumerProviderCacheControl struct { 
	*__CacheControl
	...
	func New__EventConsumerProviderCacheControlEx1(instance *cim.WmiInstance) (newInstance *__EventConsumerProviderCacheControl, err error) {tmp, err := New__CacheControlEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__EventConsumerProviderCacheControl, err error) {tmp, err := New__CacheControlEx6(hostName, wmiNamespace, userName, password, domainName, query)
