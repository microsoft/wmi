...
type __ProviderHostQuotaConfiguration struct { 
	*__SystemClass
	...
	func New__ProviderHostQuotaConfigurationEx1(instance *cim.WmiInstance) (newInstance *__ProviderHostQuotaConfiguration, err error) {tmp, err := New__SystemClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ProviderHostQuotaConfiguration, err error) {tmp, err := New__SystemClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
