...
type RsopPlanningModeProvider struct { 
	*cim.WmiInstance
	...
	func NewRsopPlanningModeProviderEx1(instance *cim.WmiInstance) (newInstance *RsopPlanningModeProvider, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RsopPlanningModeProvider, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *RsopPlanningModeProvider) RsopCreateSession( /* IN */ flags uint32,
 ...
 /* OUT */ hResult uint32,
 /* OUT */ ExtendedInfo uint32) (err error) {_, err = instance.InvokeMethod("RsopCreateSession" , flags, computerName, computerSOM, computerSecurityGroups, computerGPOFilters, userName, userSOM, userSecurityGroups, userGPOFilters, site)
	if err != nil { return }
	return
