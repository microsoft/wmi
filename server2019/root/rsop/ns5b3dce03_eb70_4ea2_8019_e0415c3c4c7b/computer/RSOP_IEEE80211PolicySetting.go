...
type RSOP_IEEE80211PolicySetting struct { 
	*RSOP_PolicySetting
	...
	func NewRSOP_IEEE80211PolicySettingEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEEE80211PolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEEE80211PolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
