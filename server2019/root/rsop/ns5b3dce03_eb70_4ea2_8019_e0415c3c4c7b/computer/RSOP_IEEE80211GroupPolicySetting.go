...
type RSOP_IEEE80211GroupPolicySetting struct { 
	*RSOP_PolicySetting
	...
	func NewRSOP_IEEE80211GroupPolicySettingEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEEE80211GroupPolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEEE80211GroupPolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
