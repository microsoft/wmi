...
type RSOP_ScriptCmd struct { 
	*cim.WmiInstance
	...
	func NewRSOP_ScriptCmdEx1(instance *cim.WmiInstance) (newInstance *RSOP_ScriptCmd, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_ScriptCmd, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
