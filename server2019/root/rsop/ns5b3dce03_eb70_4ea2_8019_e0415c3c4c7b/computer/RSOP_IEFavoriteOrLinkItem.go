...
type RSOP_IEFavoriteOrLinkItem struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEFavoriteOrLinkItemEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEFavoriteOrLinkItem, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEFavoriteOrLinkItem, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
