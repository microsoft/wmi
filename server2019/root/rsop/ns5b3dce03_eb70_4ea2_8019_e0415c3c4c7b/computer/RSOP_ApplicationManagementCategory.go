...
type RSOP_ApplicationManagementCategory struct { 
	*cim.WmiInstance
	...
	func NewRSOP_ApplicationManagementCategoryEx1(instance *cim.WmiInstance) (newInstance *RSOP_ApplicationManagementCategory, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_ApplicationManagementCategory, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
