...
type RSOP_Session struct { 
	*cim.WmiInstance
	...
	func NewRSOP_SessionEx1(instance *cim.WmiInstance) (newInstance *RSOP_Session, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_Session, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
