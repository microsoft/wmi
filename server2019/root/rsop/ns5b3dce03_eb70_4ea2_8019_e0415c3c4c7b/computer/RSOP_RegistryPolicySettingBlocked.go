...
type RSOP_RegistryPolicySettingBlocked struct { 
	*RSOP_PolicySettingBlocked
	...
	func NewRSOP_RegistryPolicySettingBlockedEx1(instance *cim.WmiInstance) (newInstance *RSOP_RegistryPolicySettingBlocked, err error) {tmp, err := NewRSOP_PolicySettingBlockedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_RegistryPolicySettingBlocked, err error) {tmp, err := NewRSOP_PolicySettingBlockedEx6(hostName, wmiNamespace, userName, password, domainName, query)
