...
type RSOP_SecuritySettingNumericBlocked struct { 
	*RSOP_SecuritySettingsBlocked
	...
	func NewRSOP_SecuritySettingNumericBlockedEx1(instance *cim.WmiInstance) (newInstance *RSOP_SecuritySettingNumericBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_SecuritySettingNumericBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx6(hostName, wmiNamespace, userName, password, domainName, query)
