...
type RSOP_ScriptPolicySetting struct { 
	*RSOP_PolicySetting
	...
	func NewRSOP_ScriptPolicySettingEx1(instance *cim.WmiInstance) (newInstance *RSOP_ScriptPolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_ScriptPolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
