...
type RSoP_PolicySettingLink struct { 
	*cim.WmiInstance
	...
	func NewRSoP_PolicySettingLinkEx1(instance *cim.WmiInstance) (newInstance *RSoP_PolicySettingLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSoP_PolicySettingLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
