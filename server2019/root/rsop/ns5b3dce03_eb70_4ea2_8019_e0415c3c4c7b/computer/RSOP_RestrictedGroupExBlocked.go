...
type RSOP_RestrictedGroupExBlocked struct { 
	*RSOP_SecuritySettingsBlocked
	...
	func NewRSOP_RestrictedGroupExBlockedEx1(instance *cim.WmiInstance) (newInstance *RSOP_RestrictedGroupExBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_RestrictedGroupExBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx6(hostName, wmiNamespace, userName, password, domainName, query)
