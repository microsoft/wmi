...
type RSOP_IEProxySettings struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEProxySettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEProxySettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEProxySettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
