...
type RSOP_IEFavoriteItemLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEFavoriteItemLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEFavoriteItemLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEFavoriteItemLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
