...
type RSOP_IEConnectionWinINetSettingsLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEConnectionWinINetSettingsLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionWinINetSettingsLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionWinINetSettingsLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
