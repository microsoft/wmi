...
type RSOP_IEAuthenticodeCertificate struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEAuthenticodeCertificateEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEAuthenticodeCertificate, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEAuthenticodeCertificate, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
