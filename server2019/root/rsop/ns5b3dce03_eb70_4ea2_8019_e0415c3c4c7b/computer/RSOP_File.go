...
type RSOP_File struct { 
	*RSOP_SecuritySettings
	...
	func NewRSOP_FileEx1(instance *cim.WmiInstance) (newInstance *RSOP_File, err error) {tmp, err := NewRSOP_SecuritySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_File, err error) {tmp, err := NewRSOP_SecuritySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
