...
type RSOP_PolmkrSetting struct { 
	*RSOP_PolicySetting
	...
	func NewRSOP_PolmkrSettingEx1(instance *cim.WmiInstance) (newInstance *RSOP_PolmkrSetting, err error) {tmp, err := NewRSOP_PolicySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_PolmkrSetting, err error) {tmp, err := NewRSOP_PolicySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
