...
type RSOP_SecuritySettingBoolean struct { 
	*RSOP_SecuritySettings
	...
	func NewRSOP_SecuritySettingBooleanEx1(instance *cim.WmiInstance) (newInstance *RSOP_SecuritySettingBoolean, err error) {tmp, err := NewRSOP_SecuritySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_SecuritySettingBoolean, err error) {tmp, err := NewRSOP_SecuritySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
