...
type RSOP_IESecurityContentRatings struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IESecurityContentRatingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IESecurityContentRatings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IESecurityContentRatings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
