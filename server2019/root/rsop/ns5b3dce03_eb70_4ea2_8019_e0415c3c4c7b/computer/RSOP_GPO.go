...
type RSOP_GPO struct { 
	*cim.WmiInstance
	...
	func NewRSOP_GPOEx1(instance *cim.WmiInstance) (newInstance *RSOP_GPO, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_GPO, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
