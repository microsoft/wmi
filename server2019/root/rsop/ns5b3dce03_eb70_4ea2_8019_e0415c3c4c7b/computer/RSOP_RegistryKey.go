...
type RSOP_RegistryKey struct { 
	*RSOP_SecuritySettings
	...
	func NewRSOP_RegistryKeyEx1(instance *cim.WmiInstance) (newInstance *RSOP_RegistryKey, err error) {tmp, err := NewRSOP_SecuritySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_RegistryKey, err error) {tmp, err := NewRSOP_SecuritySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
