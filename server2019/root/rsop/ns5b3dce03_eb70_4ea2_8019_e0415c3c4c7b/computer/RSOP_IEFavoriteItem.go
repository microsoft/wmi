...
type RSOP_IEFavoriteItem struct { 
	*RSOP_IEFavoriteOrLinkItem
	...
	func NewRSOP_IEFavoriteItemEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEFavoriteItem, err error) {tmp, err := NewRSOP_IEFavoriteOrLinkItemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEFavoriteItem, err error) {tmp, err := NewRSOP_IEFavoriteOrLinkItemEx6(hostName, wmiNamespace, userName, password, domainName, query)
