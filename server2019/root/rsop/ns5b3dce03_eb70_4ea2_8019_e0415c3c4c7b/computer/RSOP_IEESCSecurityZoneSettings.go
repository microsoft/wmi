...
type RSOP_IEESCSecurityZoneSettings struct { 
	*RSOP_IESecurityZoneSettings
	...
	func NewRSOP_IEESCSecurityZoneSettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEESCSecurityZoneSettings, err error) {tmp, err := NewRSOP_IESecurityZoneSettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEESCSecurityZoneSettings, err error) {tmp, err := NewRSOP_IESecurityZoneSettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
