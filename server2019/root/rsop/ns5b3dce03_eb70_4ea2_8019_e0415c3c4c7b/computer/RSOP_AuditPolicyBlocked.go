...
type RSOP_AuditPolicyBlocked struct { 
	*RSOP_SecuritySettingsBlocked
	...
	func NewRSOP_AuditPolicyBlockedEx1(instance *cim.WmiInstance) (newInstance *RSOP_AuditPolicyBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_AuditPolicyBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx6(hostName, wmiNamespace, userName, password, domainName, query)
