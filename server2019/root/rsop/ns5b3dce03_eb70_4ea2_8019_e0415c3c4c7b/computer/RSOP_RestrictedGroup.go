...
type RSOP_RestrictedGroup struct { 
	*RSOP_SecuritySettings
	...
	func NewRSOP_RestrictedGroupEx1(instance *cim.WmiInstance) (newInstance *RSOP_RestrictedGroup, err error) {tmp, err := NewRSOP_SecuritySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_RestrictedGroup, err error) {tmp, err := NewRSOP_SecuritySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
