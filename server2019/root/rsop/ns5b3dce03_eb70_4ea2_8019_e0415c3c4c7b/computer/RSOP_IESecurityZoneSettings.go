...
type RSOP_IESecurityZoneSettings struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IESecurityZoneSettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IESecurityZoneSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IESecurityZoneSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
