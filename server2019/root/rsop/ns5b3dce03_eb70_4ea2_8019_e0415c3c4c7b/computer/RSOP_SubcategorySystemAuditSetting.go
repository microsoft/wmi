...
type RSOP_SubcategorySystemAuditSetting struct { 
	*RSOP_PolicySetting
	...
	func NewRSOP_SubcategorySystemAuditSettingEx1(instance *cim.WmiInstance) (newInstance *RSOP_SubcategorySystemAuditSetting, err error) {tmp, err := NewRSOP_PolicySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_SubcategorySystemAuditSetting, err error) {tmp, err := NewRSOP_PolicySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
