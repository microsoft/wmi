...
type RSOP_IEESC struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEESCEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEESC, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEESC, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
