...
type RSOP_IEConnectionSettingsLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEConnectionSettingsLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionSettingsLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionSettingsLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
