...
type RSOP_IEESCPrivacySettings struct { 
	*RSOP_IEPrivacySettings
	...
	func NewRSOP_IEESCPrivacySettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEESCPrivacySettings, err error) {tmp, err := NewRSOP_IEPrivacySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEESCPrivacySettings, err error) {tmp, err := NewRSOP_IEPrivacySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
