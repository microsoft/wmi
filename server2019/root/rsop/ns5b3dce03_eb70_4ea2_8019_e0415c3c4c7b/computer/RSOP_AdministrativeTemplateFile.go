...
type RSOP_AdministrativeTemplateFile struct { 
	*cim.WmiInstance
	...
	func NewRSOP_AdministrativeTemplateFileEx1(instance *cim.WmiInstance) (newInstance *RSOP_AdministrativeTemplateFile, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_AdministrativeTemplateFile, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
