...
type RSOP_IEConnectionWinINetSettings struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEConnectionWinINetSettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionWinINetSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionWinINetSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
