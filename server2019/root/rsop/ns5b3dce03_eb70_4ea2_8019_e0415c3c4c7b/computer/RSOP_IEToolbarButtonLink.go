...
type RSOP_IEToolbarButtonLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEToolbarButtonLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEToolbarButtonLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEToolbarButtonLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
