...
type RSOP_IEConnectionDialUpSettings struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEConnectionDialUpSettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionDialUpSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionDialUpSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
