...
type RSOP_IEProgramSettings struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEProgramSettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEProgramSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEProgramSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
