...
type RSOP_PolicySettingBlocked struct { 
	*cim.WmiInstance
	...
	func NewRSOP_PolicySettingBlockedEx1(instance *cim.WmiInstance) (newInstance *RSOP_PolicySettingBlocked, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_PolicySettingBlocked, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
