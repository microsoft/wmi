...
type RSOP_IELinkItemLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IELinkItemLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_IELinkItemLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IELinkItemLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
