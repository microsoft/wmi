...
type RSOP_UserPrivilegeRightBlocked struct { 
	*RSOP_SecuritySettingsBlocked
	...
	func NewRSOP_UserPrivilegeRightBlockedEx1(instance *cim.WmiInstance) (newInstance *RSOP_UserPrivilegeRightBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_UserPrivilegeRightBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx6(hostName, wmiNamespace, userName, password, domainName, query)
