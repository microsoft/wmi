...
type RSOP_SecurityEventLogSettingBoolean struct { 
	*RSOP_SecuritySettings
	...
	func NewRSOP_SecurityEventLogSettingBooleanEx1(instance *cim.WmiInstance) (newInstance *RSOP_SecurityEventLogSettingBoolean, err error) {tmp, err := NewRSOP_SecuritySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_SecurityEventLogSettingBoolean, err error) {tmp, err := NewRSOP_SecuritySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
