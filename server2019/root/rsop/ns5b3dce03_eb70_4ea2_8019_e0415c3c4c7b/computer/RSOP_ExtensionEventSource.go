...
type RSOP_ExtensionEventSource struct { 
	*cim.WmiInstance
	...
	func NewRSOP_ExtensionEventSourceEx1(instance *cim.WmiInstance) (newInstance *RSOP_ExtensionEventSource, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_ExtensionEventSource, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
