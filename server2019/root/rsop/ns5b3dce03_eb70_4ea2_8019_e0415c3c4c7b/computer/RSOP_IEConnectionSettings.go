...
type RSOP_IEConnectionSettings struct { 
	*RSOP_IEProxySettings
	...
	func NewRSOP_IEConnectionSettingsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionSettings, err error) {tmp, err := NewRSOP_IEProxySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionSettings, err error) {tmp, err := NewRSOP_IEProxySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
