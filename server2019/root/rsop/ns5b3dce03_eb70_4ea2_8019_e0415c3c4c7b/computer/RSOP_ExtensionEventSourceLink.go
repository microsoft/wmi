...
type RSOP_ExtensionEventSourceLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_ExtensionEventSourceLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_ExtensionEventSourceLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_ExtensionEventSourceLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
