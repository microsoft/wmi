...
type RSOP_SecurityEventLogSettingNumericBlocked struct { 
	*RSOP_SecuritySettingsBlocked
	...
	func NewRSOP_SecurityEventLogSettingNumericBlockedEx1(instance *cim.WmiInstance) (newInstance *RSOP_SecurityEventLogSettingNumericBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_SecurityEventLogSettingNumericBlocked, err error) {tmp, err := NewRSOP_SecuritySettingsBlockedEx6(hostName, wmiNamespace, userName, password, domainName, query)
