...
type RSOP_IEConnectionDialUpCredentialsLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEConnectionDialUpCredentialsLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionDialUpCredentialsLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionDialUpCredentialsLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
