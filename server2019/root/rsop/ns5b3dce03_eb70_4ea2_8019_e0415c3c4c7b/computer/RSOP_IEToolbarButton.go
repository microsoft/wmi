...
type RSOP_IEToolbarButton struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEToolbarButtonEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEToolbarButton, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEToolbarButton, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
