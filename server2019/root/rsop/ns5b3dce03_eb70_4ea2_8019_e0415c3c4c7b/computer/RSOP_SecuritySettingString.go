...
type RSOP_SecuritySettingString struct { 
	*RSOP_SecuritySettings
	...
	func NewRSOP_SecuritySettingStringEx1(instance *cim.WmiInstance) (newInstance *RSOP_SecuritySettingString, err error) {tmp, err := NewRSOP_SecuritySettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_SecuritySettingString, err error) {tmp, err := NewRSOP_SecuritySettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
