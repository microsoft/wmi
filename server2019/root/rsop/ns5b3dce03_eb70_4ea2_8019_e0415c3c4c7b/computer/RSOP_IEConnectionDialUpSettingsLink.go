...
type RSOP_IEConnectionDialUpSettingsLink struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEConnectionDialUpSettingsLinkEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionDialUpSettingsLink, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionDialUpSettingsLink, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
