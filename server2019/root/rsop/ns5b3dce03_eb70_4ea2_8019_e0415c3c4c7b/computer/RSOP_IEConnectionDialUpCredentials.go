...
type RSOP_IEConnectionDialUpCredentials struct { 
	*cim.WmiInstance
	...
	func NewRSOP_IEConnectionDialUpCredentialsEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEConnectionDialUpCredentials, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEConnectionDialUpCredentials, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
