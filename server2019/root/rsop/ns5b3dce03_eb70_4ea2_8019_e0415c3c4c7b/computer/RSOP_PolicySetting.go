...
type RSOP_PolicySetting struct { 
	*cim.WmiInstance
	...
	func NewRSOP_PolicySettingEx1(instance *cim.WmiInstance) (newInstance *RSOP_PolicySetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_PolicySetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
