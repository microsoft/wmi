...
type RSOP_ExtensionStatus struct { 
	*cim.WmiInstance
	...
	func NewRSOP_ExtensionStatusEx1(instance *cim.WmiInstance) (newInstance *RSOP_ExtensionStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_ExtensionStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
