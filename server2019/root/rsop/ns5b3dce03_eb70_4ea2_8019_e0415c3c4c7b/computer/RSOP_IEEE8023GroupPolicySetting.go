...
type RSOP_IEEE8023GroupPolicySetting struct { 
	*RSOP_PolicySetting
	...
	func NewRSOP_IEEE8023GroupPolicySettingEx1(instance *cim.WmiInstance) (newInstance *RSOP_IEEE8023GroupPolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RSOP_IEEE8023GroupPolicySetting, err error) {tmp, err := NewRSOP_PolicySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
