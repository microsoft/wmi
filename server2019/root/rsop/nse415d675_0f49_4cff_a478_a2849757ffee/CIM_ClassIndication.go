...
type CIM_ClassIndication struct { 
	*CIM_Indication
	...
	func NewCIM_ClassIndicationEx1(instance *cim.WmiInstance) (newInstance *CIM_ClassIndication, err error) {tmp, err := NewCIM_IndicationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ClassIndication, err error) {tmp, err := NewCIM_IndicationEx6(hostName, wmiNamespace, userName, password, domainName, query)
