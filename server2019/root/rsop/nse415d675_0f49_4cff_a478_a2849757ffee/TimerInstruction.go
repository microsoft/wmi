...
type __TimerInstruction struct { 
	*__EventGenerator
	...
	func New__TimerInstructionEx1(instance *cim.WmiInstance) (newInstance *__TimerInstruction, err error) {tmp, err := New__EventGeneratorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__TimerInstruction, err error) {tmp, err := New__EventGeneratorEx6(hostName, wmiNamespace, userName, password, domainName, query)
