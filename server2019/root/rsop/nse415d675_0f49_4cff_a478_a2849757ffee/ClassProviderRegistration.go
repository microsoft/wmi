...
type __ClassProviderRegistration struct { 
	*__ObjectProviderRegistration
	...
	func New__ClassProviderRegistrationEx1(instance *cim.WmiInstance) (newInstance *__ClassProviderRegistration, err error) {tmp, err := New__ObjectProviderRegistrationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ClassProviderRegistration, err error) {tmp, err := New__ObjectProviderRegistrationEx6(hostName, wmiNamespace, userName, password, domainName, query)
