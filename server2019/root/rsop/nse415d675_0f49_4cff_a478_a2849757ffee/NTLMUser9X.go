...
type __NTLMUser9X struct { 
	*__SecurityRelatedClass
	...
	func New__NTLMUser9XEx1(instance *cim.WmiInstance) (newInstance *__NTLMUser9X, err error) {tmp, err := New__SecurityRelatedClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__NTLMUser9X, err error) {tmp, err := New__SecurityRelatedClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
