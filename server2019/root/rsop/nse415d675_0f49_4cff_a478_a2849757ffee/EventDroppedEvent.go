...
type __EventDroppedEvent struct { 
	*__SystemEvent
	...
	func New__EventDroppedEventEx1(instance *cim.WmiInstance) (newInstance *__EventDroppedEvent, err error) {tmp, err := New__SystemEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__EventDroppedEvent, err error) {tmp, err := New__SystemEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
