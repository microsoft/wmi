...
type CIM_ClassModification struct { 
	*CIM_ClassIndication
	...
	func NewCIM_ClassModificationEx1(instance *cim.WmiInstance) (newInstance *CIM_ClassModification, err error) {tmp, err := NewCIM_ClassIndicationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ClassModification, err error) {tmp, err := NewCIM_ClassIndicationEx6(hostName, wmiNamespace, userName, password, domainName, query)
