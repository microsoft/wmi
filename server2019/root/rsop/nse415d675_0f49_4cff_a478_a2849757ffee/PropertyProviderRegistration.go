...
type __PropertyProviderRegistration struct { 
	*__ProviderRegistration
	...
	func New__PropertyProviderRegistrationEx1(instance *cim.WmiInstance) (newInstance *__PropertyProviderRegistration, err error) {tmp, err := New__ProviderRegistrationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__PropertyProviderRegistration, err error) {tmp, err := New__ProviderRegistrationEx6(hostName, wmiNamespace, userName, password, domainName, query)
