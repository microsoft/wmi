...
type __QOSFailureEvent struct { 
	*__EventDroppedEvent
	...
	func New__QOSFailureEventEx1(instance *cim.WmiInstance) (newInstance *__QOSFailureEvent, err error) {tmp, err := New__EventDroppedEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__QOSFailureEvent, err error) {tmp, err := New__EventDroppedEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
