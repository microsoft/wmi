...
type __EventConsumer struct { 
	*__IndicationRelated
	...
	func New__EventConsumerEx1(instance *cim.WmiInstance) (newInstance *__EventConsumer, err error) {tmp, err := New__IndicationRelatedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__EventConsumer, err error) {tmp, err := New__IndicationRelatedEx6(hostName, wmiNamespace, userName, password, domainName, query)
