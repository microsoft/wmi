...
type __ClassOperationEvent struct { 
	*__Event
	...
	func New__ClassOperationEventEx1(instance *cim.WmiInstance) (newInstance *__ClassOperationEvent, err error) {tmp, err := New__EventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ClassOperationEvent, err error) {tmp, err := New__EventEx6(hostName, wmiNamespace, userName, password, domainName, query)
