...
type __TimerEvent struct { 
	*__Event
	...
	func New__TimerEventEx1(instance *cim.WmiInstance) (newInstance *__TimerEvent, err error) {tmp, err := New__EventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__TimerEvent, err error) {tmp, err := New__EventEx6(hostName, wmiNamespace, userName, password, domainName, query)
