...
type __Win32Provider struct { 
	*__Provider
	...
	func New__Win32ProviderEx1(instance *cim.WmiInstance) (newInstance *__Win32Provider, err error) {tmp, err := New__ProviderEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__Win32Provider, err error) {tmp, err := New__ProviderEx6(hostName, wmiNamespace, userName, password, domainName, query)
