...
type __ConsumerFailureEvent struct { 
	*__EventDroppedEvent
	...
	func New__ConsumerFailureEventEx1(instance *cim.WmiInstance) (newInstance *__ConsumerFailureEvent, err error) {tmp, err := New__EventDroppedEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ConsumerFailureEvent, err error) {tmp, err := New__EventDroppedEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
