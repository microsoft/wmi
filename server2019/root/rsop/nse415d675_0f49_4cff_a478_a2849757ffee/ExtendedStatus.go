...
type __ExtendedStatus struct { 
	*__NotifyStatus
	...
	func New__ExtendedStatusEx1(instance *cim.WmiInstance) (newInstance *__ExtendedStatus, err error) {tmp, err := New__NotifyStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ExtendedStatus, err error) {tmp, err := New__NotifyStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
