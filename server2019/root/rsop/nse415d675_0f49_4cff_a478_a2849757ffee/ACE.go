...
type __ACE struct { 
	*__SecurityRelatedClass
	...
	func New__ACEEx1(instance *cim.WmiInstance) (newInstance *__ACE, err error) {tmp, err := New__SecurityRelatedClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ACE, err error) {tmp, err := New__SecurityRelatedClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
