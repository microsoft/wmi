...
type __Event struct { 
	*__IndicationRelated
	...
	func New__EventEx1(instance *cim.WmiInstance) (newInstance *__Event, err error) {tmp, err := New__IndicationRelatedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__Event, err error) {tmp, err := New__IndicationRelatedEx6(hostName, wmiNamespace, userName, password, domainName, query)
