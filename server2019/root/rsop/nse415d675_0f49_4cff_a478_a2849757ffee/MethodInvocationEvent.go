...
type __MethodInvocationEvent struct { 
	*__InstanceOperationEvent
	...
	func New__MethodInvocationEventEx1(instance *cim.WmiInstance) (newInstance *__MethodInvocationEvent, err error) {tmp, err := New__InstanceOperationEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__MethodInvocationEvent, err error) {tmp, err := New__InstanceOperationEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
