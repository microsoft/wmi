...
type __TimerNextFiring struct { 
	*__IndicationRelated
	...
	func New__TimerNextFiringEx1(instance *cim.WmiInstance) (newInstance *__TimerNextFiring, err error) {tmp, err := New__IndicationRelatedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__TimerNextFiring, err error) {tmp, err := New__IndicationRelatedEx6(hostName, wmiNamespace, userName, password, domainName, query)
