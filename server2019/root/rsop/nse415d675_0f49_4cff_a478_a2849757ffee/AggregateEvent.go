...
type __AggregateEvent struct { 
	*__IndicationRelated
	...
	func New__AggregateEventEx1(instance *cim.WmiInstance) (newInstance *__AggregateEvent, err error) {tmp, err := New__IndicationRelatedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__AggregateEvent, err error) {tmp, err := New__IndicationRelatedEx6(hostName, wmiNamespace, userName, password, domainName, query)
