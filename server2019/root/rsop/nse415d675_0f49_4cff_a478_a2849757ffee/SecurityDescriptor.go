...
type __SecurityDescriptor struct { 
	*__SecurityRelatedClass
	...
	func New__SecurityDescriptorEx1(instance *cim.WmiInstance) (newInstance *__SecurityDescriptor, err error) {tmp, err := New__SecurityRelatedClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__SecurityDescriptor, err error) {tmp, err := New__SecurityRelatedClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
