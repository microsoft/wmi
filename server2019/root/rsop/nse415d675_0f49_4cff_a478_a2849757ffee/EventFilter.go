...
type __EventFilter struct { 
	*__IndicationRelated
	...
	func New__EventFilterEx1(instance *cim.WmiInstance) (newInstance *__EventFilter, err error) {tmp, err := New__IndicationRelatedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__EventFilter, err error) {tmp, err := New__IndicationRelatedEx6(hostName, wmiNamespace, userName, password, domainName, query)
