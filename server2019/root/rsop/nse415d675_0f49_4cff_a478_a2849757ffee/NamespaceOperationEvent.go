...
type __NamespaceOperationEvent struct { 
	*__Event
	...
	func New__NamespaceOperationEventEx1(instance *cim.WmiInstance) (newInstance *__NamespaceOperationEvent, err error) {tmp, err := New__EventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__NamespaceOperationEvent, err error) {tmp, err := New__EventEx6(hostName, wmiNamespace, userName, password, domainName, query)
