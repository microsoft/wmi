...
type __Trustee struct { 
	*__SecurityRelatedClass
	...
	func New__TrusteeEx1(instance *cim.WmiInstance) (newInstance *__Trustee, err error) {tmp, err := New__SecurityRelatedClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__Trustee, err error) {tmp, err := New__SecurityRelatedClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
