...
type DtcTransactionInfo struct { 
	*cim.WmiInstance
	...
	func NewDtcTransactionInfoEx1(instance *cim.WmiInstance) (newInstance *DtcTransactionInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DtcTransactionInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
