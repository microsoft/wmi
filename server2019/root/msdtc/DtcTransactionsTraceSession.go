...
type DtcTransactionsTraceSession struct { 
	*cim.WmiInstance
	...
	func NewDtcTransactionsTraceSessionEx1(instance *cim.WmiInstance) (newInstance *DtcTransactionsTraceSession, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DtcTransactionsTraceSession, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
