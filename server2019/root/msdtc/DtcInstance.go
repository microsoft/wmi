...
type DtcInstance struct { 
	*cim.WmiInstance
	...
	func NewDtcInstanceEx1(instance *cim.WmiInstance) (newInstance *DtcInstance, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DtcInstance, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
