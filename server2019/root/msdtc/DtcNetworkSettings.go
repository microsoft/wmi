...
type DtcNetworkSettings struct { 
	*cim.WmiInstance
	...
	func NewDtcNetworkSettingsEx1(instance *cim.WmiInstance) (newInstance *DtcNetworkSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DtcNetworkSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
