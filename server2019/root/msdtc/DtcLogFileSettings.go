...
type DtcLogFileSettings struct { 
	*cim.WmiInstance
	...
	func NewDtcLogFileSettingsEx1(instance *cim.WmiInstance) (newInstance *DtcLogFileSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DtcLogFileSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
