...
type DtcTransactionsTraceSettings struct { 
	*cim.WmiInstance
	...
	func NewDtcTransactionsTraceSettingsEx1(instance *cim.WmiInstance) (newInstance *DtcTransactionsTraceSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DtcTransactionsTraceSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
