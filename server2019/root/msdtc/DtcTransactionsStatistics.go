...
type DtcTransactionsStatistics struct { 
	*cim.WmiInstance
	...
	func NewDtcTransactionsStatisticsEx1(instance *cim.WmiInstance) (newInstance *DtcTransactionsStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DtcTransactionsStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
