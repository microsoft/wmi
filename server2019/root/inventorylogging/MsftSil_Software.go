...
type MsftSil_Software struct { 
	*MsftSil_Data
	...
	func NewMsftSil_SoftwareEx1(instance *cim.WmiInstance) (newInstance *MsftSil_Software, err error) {tmp, err := NewMsftSil_DataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftSil_Software, err error) {tmp, err := NewMsftSil_DataEx6(hostName, wmiNamespace, userName, password, domainName, query)
