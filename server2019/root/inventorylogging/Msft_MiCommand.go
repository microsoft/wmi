...
type Msft_MiCommand struct { 
	*Msft_MiStream
	...
	func NewMsft_MiCommandEx1(instance *cim.WmiInstance) (newInstance *Msft_MiCommand, err error) {tmp, err := NewMsft_MiStreamEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_MiCommand, err error) {tmp, err := NewMsft_MiStreamEx6(hostName, wmiNamespace, userName, password, domainName, query)
