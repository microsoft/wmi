...
type Msft_MiQuery struct { 
	*Msft_MiStream
	...
	func NewMsft_MiQueryEx1(instance *cim.WmiInstance) (newInstance *Msft_MiQuery, err error) {tmp, err := NewMsft_MiStreamEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_MiQuery, err error) {tmp, err := NewMsft_MiStreamEx6(hostName, wmiNamespace, userName, password, domainName, query)
