...
type Msft_MiCompare struct { 
	*Msft_MiStream
	...
	func NewMsft_MiCompareEx1(instance *cim.WmiInstance) (newInstance *Msft_MiCompare, err error) {tmp, err := NewMsft_MiStreamEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_MiCompare, err error) {tmp, err := NewMsft_MiStreamEx6(hostName, wmiNamespace, userName, password, domainName, query)
