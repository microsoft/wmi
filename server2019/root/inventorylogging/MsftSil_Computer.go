...
type MsftSil_Computer struct { 
	*MsftSil_Data
	...
	func NewMsftSil_ComputerEx1(instance *cim.WmiInstance) (newInstance *MsftSil_Computer, err error) {tmp, err := NewMsftSil_DataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftSil_Computer, err error) {tmp, err := NewMsftSil_DataEx6(hostName, wmiNamespace, userName, password, domainName, query)
