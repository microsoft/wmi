...
type Msft_MiMerge struct { 
	*Msft_MiStream
	...
	func NewMsft_MiMergeEx1(instance *cim.WmiInstance) (newInstance *Msft_MiMerge, err error) {tmp, err := NewMsft_MiStreamEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_MiMerge, err error) {tmp, err := NewMsft_MiStreamEx6(hostName, wmiNamespace, userName, password, domainName, query)
