...
type MsftSil_ComputerIdentity struct { 
	*MsftSil_Data
	...
	func NewMsftSil_ComputerIdentityEx1(instance *cim.WmiInstance) (newInstance *MsftSil_ComputerIdentity, err error) {tmp, err := NewMsftSil_DataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftSil_ComputerIdentity, err error) {tmp, err := NewMsftSil_DataEx6(hostName, wmiNamespace, userName, password, domainName, query)
