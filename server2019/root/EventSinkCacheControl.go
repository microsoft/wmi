...
type __EventSinkCacheControl struct { 
	*__CacheControl
	...
	func New__EventSinkCacheControlEx1(instance *cim.WmiInstance) (newInstance *__EventSinkCacheControl, err error) {tmp, err := New__CacheControlEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__EventSinkCacheControl, err error) {tmp, err := New__CacheControlEx6(hostName, wmiNamespace, userName, password, domainName, query)
