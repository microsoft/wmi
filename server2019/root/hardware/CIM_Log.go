...
type CIM_Log struct { 
	*CIM_EnabledLogicalElement
	...
	func NewCIM_LogEx1(instance *cim.WmiInstance) (newInstance *CIM_Log, err error) {tmp, err := NewCIM_EnabledLogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Log, err error) {tmp, err := NewCIM_EnabledLogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_Log) ClearLog() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ClearLog" );
	if err != nil { return }
