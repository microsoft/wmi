...
type CIM_RecordLog struct { 
	*CIM_Log
	...
	func NewCIM_RecordLogEx1(instance *cim.WmiInstance) (newInstance *CIM_RecordLog, err error) {tmp, err := NewCIM_LogEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RecordLog, err error) {tmp, err := NewCIM_LogEx6(hostName, wmiNamespace, userName, password, domainName, query)
