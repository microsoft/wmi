...
type CIM_Group struct { 
	*CIM_Collection
	...
	func NewCIM_GroupEx1(instance *cim.WmiInstance) (newInstance *CIM_Group, err error) {tmp, err := NewCIM_CollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Group, err error) {tmp, err := NewCIM_CollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
