...
type __ArbitratorConfiguration struct { 
	*__SystemClass
	...
	func New__ArbitratorConfigurationEx1(instance *cim.WmiInstance) (newInstance *__ArbitratorConfiguration, err error) {tmp, err := New__SystemClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ArbitratorConfiguration, err error) {tmp, err := New__SystemClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
