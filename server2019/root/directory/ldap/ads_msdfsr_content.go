...
type ads_msdfsr_content struct { 
	*ds_top
	...
	func Newads_msdfsr_contentEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_content, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdfsr_content, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
