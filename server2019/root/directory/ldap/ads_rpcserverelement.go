...
type ads_rpcserverelement struct { 
	*ds_rpcentry
	...
	func Newads_rpcserverelementEx1(instance *cim.WmiInstance) (newInstance *ads_rpcserverelement, err error) {tmp, err := Newds_rpcentryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_rpcserverelement, err error) {tmp, err := Newds_rpcentryEx6(hostName, wmiNamespace, userName, password, domainName, query)
