...
type ads_printqueue struct { 
	*ds_connectionpoint
	...
	func Newads_printqueueEx1(instance *cim.WmiInstance) (newInstance *ads_printqueue, err error) {tmp, err := Newds_connectionpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_printqueue, err error) {tmp, err := Newds_connectionpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
