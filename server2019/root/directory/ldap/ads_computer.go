...
type ads_computer struct { 
	*ads_user
	...
	func Newads_computerEx1(instance *cim.WmiInstance) (newInstance *ads_computer, err error) {tmp, err := Newads_userEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_computer, err error) {tmp, err := Newads_userEx6(hostName, wmiNamespace, userName, password, domainName, query)
