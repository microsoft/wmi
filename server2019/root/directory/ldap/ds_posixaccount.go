...
type ds_posixaccount struct { 
	*ds_top
	...
	func Newds_posixaccountEx1(instance *cim.WmiInstance) (newInstance *ds_posixaccount, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_posixaccount, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
