...
type ads_dsa struct { 
	*ads_applicationentity
	...
	func Newads_dsaEx1(instance *cim.WmiInstance) (newInstance *ads_dsa, err error) {tmp, err := Newads_applicationentityEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_dsa, err error) {tmp, err := Newads_applicationentityEx6(hostName, wmiNamespace, userName, password, domainName, query)
