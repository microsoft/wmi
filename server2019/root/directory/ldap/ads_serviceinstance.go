...
func Newads_serviceinstanceEx1(instance *cim.WmiInstance) (newInstance *ads_serviceinstance, err error) {
...
func Newads_serviceinstanceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_serviceinstance, err error) {
