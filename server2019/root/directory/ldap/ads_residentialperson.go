...
type ads_residentialperson struct { 
	*ads_person
	...
	func Newads_residentialpersonEx1(instance *cim.WmiInstance) (newInstance *ads_residentialperson, err error) {tmp, err := Newads_personEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_residentialperson, err error) {tmp, err := Newads_personEx6(hostName, wmiNamespace, userName, password, domainName, query)
