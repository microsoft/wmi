...
type DSClass_To_DNInstance struct { 
	*cim.WmiInstance
	...
	func NewDSClass_To_DNInstanceEx1(instance *cim.WmiInstance) (newInstance *DSClass_To_DNInstance, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DSClass_To_DNInstance, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
