...
type ads_linktrackvolentry struct { 
	*ds_leaf
	...
	func Newads_linktrackvolentryEx1(instance *cim.WmiInstance) (newInstance *ads_linktrackvolentry, err error) {tmp, err := Newds_leafEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_linktrackvolentry, err error) {tmp, err := Newds_leafEx6(hostName, wmiNamespace, userName, password, domainName, query)
