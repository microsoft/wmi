...
type ads_mswmi_objectencoding struct { 
	*ds_top
	...
	func Newads_mswmi_objectencodingEx1(instance *cim.WmiInstance) (newInstance *ads_mswmi_objectencoding, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mswmi_objectencoding, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
