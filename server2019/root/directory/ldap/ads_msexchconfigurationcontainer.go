...
type ads_msexchconfigurationcontainer struct { 
	*ads_container
	...
	func Newads_msexchconfigurationcontainerEx1(instance *cim.WmiInstance) (newInstance *ads_msexchconfigurationcontainer, err error) {tmp, err := Newads_containerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msexchconfigurationcontainer, err error) {tmp, err := Newads_containerEx6(hostName, wmiNamespace, userName, password, domainName, query)
