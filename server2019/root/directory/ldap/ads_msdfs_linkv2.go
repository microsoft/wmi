...
type ads_msdfs_linkv2 struct { 
	*ds_top
	...
	func Newads_msdfs_linkv2Ex1(instance *cim.WmiInstance) (newInstance *ads_msdfs_linkv2, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdfs_linkv2, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
