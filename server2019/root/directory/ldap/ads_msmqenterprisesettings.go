...
type ads_msmqenterprisesettings struct { 
	*ds_top
	...
	func Newads_msmqenterprisesettingsEx1(instance *cim.WmiInstance) (newInstance *ads_msmqenterprisesettings, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msmqenterprisesettings, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
