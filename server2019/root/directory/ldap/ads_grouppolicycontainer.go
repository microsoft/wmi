...
type ads_grouppolicycontainer struct { 
	*ads_container
	...
	func Newads_grouppolicycontainerEx1(instance *cim.WmiInstance) (newInstance *ads_grouppolicycontainer, err error) {tmp, err := Newads_containerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_grouppolicycontainer, err error) {tmp, err := Newads_containerEx6(hostName, wmiNamespace, userName, password, domainName, query)
