...
type ads_msieee80211_policy struct { 
	*ds_top
	...
	func Newads_msieee80211_policyEx1(instance *cim.WmiInstance) (newInstance *ads_msieee80211_policy, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msieee80211_policy, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
