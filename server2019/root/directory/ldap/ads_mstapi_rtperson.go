...
type ads_mstapi_rtperson struct { 
	*ds_top
	...
	func Newads_mstapi_rtpersonEx1(instance *cim.WmiInstance) (newInstance *ads_mstapi_rtperson, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mstapi_rtperson, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
