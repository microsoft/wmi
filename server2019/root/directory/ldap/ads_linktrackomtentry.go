...
type ads_linktrackomtentry struct { 
	*ds_leaf
	...
	func Newads_linktrackomtentryEx1(instance *cim.WmiInstance) (newInstance *ads_linktrackomtentry, err error) {tmp, err := Newds_leafEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_linktrackomtentry, err error) {tmp, err := Newds_leafEx6(hostName, wmiNamespace, userName, password, domainName, query)
