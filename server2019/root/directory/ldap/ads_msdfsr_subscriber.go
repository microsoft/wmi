...
type ads_msdfsr_subscriber struct { 
	*ds_top
	...
	func Newads_msdfsr_subscriberEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_subscriber, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdfsr_subscriber, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
