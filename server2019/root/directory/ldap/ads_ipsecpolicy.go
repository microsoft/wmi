...
type ads_ipsecpolicy struct { 
	*ds_ipsecbase
	...
	func Newads_ipsecpolicyEx1(instance *cim.WmiInstance) (newInstance *ads_ipsecpolicy, err error) {tmp, err := Newds_ipsecbaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ipsecpolicy, err error) {tmp, err := Newds_ipsecbaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
