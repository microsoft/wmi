...
type ads_msds_resourcepropertylist struct { 
	*ds_top
	...
	func Newads_msds_resourcepropertylistEx1(instance *cim.WmiInstance) (newInstance *ads_msds_resourcepropertylist, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msds_resourcepropertylist, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
