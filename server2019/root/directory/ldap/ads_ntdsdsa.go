...
type ads_ntdsdsa struct { 
	*ds_applicationsettings
	...
	func Newads_ntdsdsaEx1(instance *cim.WmiInstance) (newInstance *ads_ntdsdsa, err error) {tmp, err := Newds_applicationsettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ntdsdsa, err error) {tmp, err := Newds_applicationsettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
