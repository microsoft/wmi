...
type ads_msds_app_configuration struct { 
	*ds_applicationsettings
	...
	func Newads_msds_app_configurationEx1(instance *cim.WmiInstance) (newInstance *ads_msds_app_configuration, err error) {tmp, err := Newds_applicationsettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msds_app_configuration, err error) {tmp, err := Newds_applicationsettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
