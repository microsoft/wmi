...
type ads_oncrpc struct { 
	*ds_top
	...
	func Newads_oncrpcEx1(instance *cim.WmiInstance) (newInstance *ads_oncrpc, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_oncrpc, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
