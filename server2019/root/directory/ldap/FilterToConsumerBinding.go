...
root "github.com/microsoft/wmi/server2019/root"
...
type __FilterToConsumerBinding struct { 
	*__IndicationRelated
	...
	func New__FilterToConsumerBindingEx1(instance *cim.WmiInstance) (newInstance *__FilterToConsumerBinding, err error) {tmp, err := New__IndicationRelatedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__FilterToConsumerBinding, err error) {tmp, err := New__IndicationRelatedEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *__FilterToConsumerBinding) SetPropertyConsumer(value root.__EventConsumer) (err error) { 
    return instance.SetProperty("Consumer", (value))
}

// GetConsumer gets the value of Consumer for the instance
func (instance *__FilterToConsumerBinding) GetPropertyConsumer()(value root.__EventConsumer, err error) { 
    ...
    valuetmp, ok := retValue.(root.__EventConsumer); 
    if !ok {
        err = errors.Wrapf(errors.InvalidType, " root.__EventConsumer is Invalid. Expected %s", reflect.TypeOf(retValue))
        return  
    }

    value = root.__EventConsumer(valuetmp)
...
func (instance *__FilterToConsumerBinding) SetPropertyFilter(value root.__EventFilter) (err error) { 
    return instance.SetProperty("Filter", (value))
}

// GetFilter gets the value of Filter for the instance
func (instance *__FilterToConsumerBinding) GetPropertyFilter()(value root.__EventFilter, err error) { 
    ...
    valuetmp, ok := retValue.(root.__EventFilter); 
    if !ok {
        err = errors.Wrapf(errors.InvalidType, " root.__EventFilter is Invalid. Expected %s", reflect.TypeOf(retValue))
        return  
    }

    value = root.__EventFilter(valuetmp)
