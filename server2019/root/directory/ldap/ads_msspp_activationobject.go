...
type ads_msspp_activationobject struct { 
	*ds_top
	...
	func Newads_msspp_activationobjectEx1(instance *cim.WmiInstance) (newInstance *ads_msspp_activationobject, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msspp_activationobject, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
