...
type ads_sitelinkbridge struct { 
	*ds_top
	...
	func Newads_sitelinkbridgeEx1(instance *cim.WmiInstance) (newInstance *ads_sitelinkbridge, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_sitelinkbridge, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
