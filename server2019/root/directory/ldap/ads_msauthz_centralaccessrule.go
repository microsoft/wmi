...
type ads_msauthz_centralaccessrule struct { 
	*ds_top
	...
	func Newads_msauthz_centralaccessruleEx1(instance *cim.WmiInstance) (newInstance *ads_msauthz_centralaccessrule, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msauthz_centralaccessrule, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
