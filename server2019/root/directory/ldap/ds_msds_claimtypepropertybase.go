...
type ds_msds_claimtypepropertybase struct { 
	*ds_top
	...
	func Newds_msds_claimtypepropertybaseEx1(instance *cim.WmiInstance) (newInstance *ds_msds_claimtypepropertybase, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_msds_claimtypepropertybase, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
