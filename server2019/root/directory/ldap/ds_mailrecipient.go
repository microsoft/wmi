...
// ds_mailrecipient struct
type ds_mailrecipient struct { 
	*ds_top
	...
	func Newds_mailrecipientEx1(instance *cim.WmiInstance) (newInstance *ds_mailrecipient, err error) {tmp, err := Newds_topEx1(instance)
		
	if err != nil { return }
	newInstance = &ds_mailrecipient {
	ds_top: tmp,
	}
	return
	}
	...
	func Newds_mailrecipientEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_mailrecipient, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *ds_mailrecipient) SetPropertyDS_garbageCollPeriod(value int32) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_garbageCollPeriod()(value int32, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_info(value string) (err error) { 
    return instance.SetProperty("DS_info", (value))
}

// GetDS_info gets the value of DS_info for the instance
func (instance *ds_mailrecipient) GetPropertyDS_info()(value string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_labeledURI(value []string) (err error) { 
    return instance.SetProperty("DS_labeledURI", (value))
}

// GetDS_labeledURI gets the value of DS_labeledURI for the instance
func (instance *ds_mailrecipient) GetPropertyDS_labeledURI()(value []string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_legacyExchangeDN(value string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_legacyExchangeDN()(value string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_msDS_ExternalDirectoryObjectId(value string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_msDS_ExternalDirectoryObjectId()(value string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_msDS_GeoCoordinatesAltitude(value int64) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_msDS_GeoCoordinatesAltitude()(value int64, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_msDS_GeoCoordinatesLatitude(value int64) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_msDS_GeoCoordinatesLatitude()(value int64, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_msDS_GeoCoordinatesLongitude(value int64) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_msDS_GeoCoordinatesLongitude()(value int64, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_msDS_PhoneticDisplayName(value string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_msDS_PhoneticDisplayName()(value string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_msExchAssistantName(value string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_msExchAssistantName()(value string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_msExchLabeledURI(value []string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_msExchLabeledURI()(value []string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_secretary(value []string) (err error) { 
    return instance.SetProperty("DS_secretary", (value))
}

// GetDS_secretary gets the value of DS_secretary for the instance
func (instance *ds_mailrecipient) GetPropertyDS_secretary()(value []string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_showInAddressBook(value []string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_showInAddressBook()(value []string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_telephoneNumber(value string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_telephoneNumber()(value string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_textEncodedORAddress(value string) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_textEncodedORAddress()(value string, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_userCert(value Uint8Array) (err error) { 
    return instance.SetProperty("DS_userCert", (value))
}

// GetDS_userCert gets the value of DS_userCert for the instance
func (instance *ds_mailrecipient) GetPropertyDS_userCert()(value Uint8Array, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_userCertificate(value []Uint8Array) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_userCertificate()(value []Uint8Array, err error) { 
...
func (instance *ds_mailrecipient) SetPropertyDS_userSMIMECertificate(value []Uint8Array) (err error) { 
...
func (instance *ds_mailrecipient) GetPropertyDS_userSMIMECertificate()(value []Uint8Array, err error) { 
