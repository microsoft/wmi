...
// ds_samdomainbase struct
type ds_samdomainbase struct { 
	*ds_top
	...
	func Newds_samdomainbaseEx1(instance *cim.WmiInstance) (newInstance *ds_samdomainbase, err error) {tmp, err := Newds_topEx1(instance)
		
	if err != nil { return }
	newInstance = &ds_samdomainbase {
	ds_top: tmp,
	}
	return
	}
	...
	func Newds_samdomainbaseEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_samdomainbase, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *ds_samdomainbase) SetPropertyDS_creationTime(value int64) (err error) { 
    return instance.SetProperty("DS_creationTime", (value))
}

// GetDS_creationTime gets the value of DS_creationTime for the instance
func (instance *ds_samdomainbase) GetPropertyDS_creationTime()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_domainReplica(value string) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_domainReplica()(value string, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_forceLogoff(value int64) (err error) { 
    return instance.SetProperty("DS_forceLogoff", (value))
}

// GetDS_forceLogoff gets the value of DS_forceLogoff for the instance
func (instance *ds_samdomainbase) GetPropertyDS_forceLogoff()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_lockoutDuration(value int64) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_lockoutDuration()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_lockOutObservationWindow(value int64) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_lockOutObservationWindow()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_lockoutThreshold(value int32) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_lockoutThreshold()(value int32, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_maxPwdAge(value int64) (err error) { 
    return instance.SetProperty("DS_maxPwdAge", (value))
}

// GetDS_maxPwdAge gets the value of DS_maxPwdAge for the instance
func (instance *ds_samdomainbase) GetPropertyDS_maxPwdAge()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_minPwdAge(value int64) (err error) { 
    return instance.SetProperty("DS_minPwdAge", (value))
}

// GetDS_minPwdAge gets the value of DS_minPwdAge for the instance
func (instance *ds_samdomainbase) GetPropertyDS_minPwdAge()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_minPwdLength(value int32) (err error) { 
    return instance.SetProperty("DS_minPwdLength", (value))
}

// GetDS_minPwdLength gets the value of DS_minPwdLength for the instance
func (instance *ds_samdomainbase) GetPropertyDS_minPwdLength()(value int32, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_modifiedCount(value int64) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_modifiedCount()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_modifiedCountAtLastProm(value int64) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_modifiedCountAtLastProm()(value int64, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_nextRid(value int32) (err error) { 
    return instance.SetProperty("DS_nextRid", (value))
}

// GetDS_nextRid gets the value of DS_nextRid for the instance
func (instance *ds_samdomainbase) GetPropertyDS_nextRid()(value int32, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_objectSid(value Uint8Array) (err error) { 
    return instance.SetProperty("DS_objectSid", (value))
}

// GetDS_objectSid gets the value of DS_objectSid for the instance
func (instance *ds_samdomainbase) GetPropertyDS_objectSid()(value Uint8Array, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_oEMInformation(value string) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_oEMInformation()(value string, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_pwdHistoryLength(value int32) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_pwdHistoryLength()(value int32, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_pwdProperties(value int32) (err error) { 
...
func (instance *ds_samdomainbase) GetPropertyDS_pwdProperties()(value int32, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_serverRole(value int32) (err error) { 
    return instance.SetProperty("DS_serverRole", (value))
}

// GetDS_serverRole gets the value of DS_serverRole for the instance
func (instance *ds_samdomainbase) GetPropertyDS_serverRole()(value int32, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_serverState(value int32) (err error) { 
    return instance.SetProperty("DS_serverState", (value))
}

// GetDS_serverState gets the value of DS_serverState for the instance
func (instance *ds_samdomainbase) GetPropertyDS_serverState()(value int32, err error) { 
...
func (instance *ds_samdomainbase) SetPropertyDS_uASCompat(value int32) (err error) { 
    return instance.SetProperty("DS_uASCompat", (value))
}

// GetDS_uASCompat gets the value of DS_uASCompat for the instance
func (instance *ds_samdomainbase) GetPropertyDS_uASCompat()(value int32, err error) { 
