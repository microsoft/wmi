...
type ads_msds_resourceproperty struct { 
	*ds_msds_claimtypepropertybase
	...
	func Newads_msds_resourcepropertyEx1(instance *cim.WmiInstance) (newInstance *ads_msds_resourceproperty, err error) {tmp, err := Newds_msds_claimtypepropertybaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msds_resourceproperty, err error) {tmp, err := Newds_msds_claimtypepropertybaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
