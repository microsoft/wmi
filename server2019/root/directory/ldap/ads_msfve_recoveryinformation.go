...
type ads_msfve_recoveryinformation struct { 
	*ds_top
	...
	func Newads_msfve_recoveryinformationEx1(instance *cim.WmiInstance) (newInstance *ads_msfve_recoveryinformation, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msfve_recoveryinformation, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
