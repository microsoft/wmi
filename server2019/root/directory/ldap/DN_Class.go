...
type DN_Class struct { 
	*cim.WmiInstance
	...
	func NewDN_ClassEx1(instance *cim.WmiInstance) (newInstance *DN_Class, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DN_Class, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
