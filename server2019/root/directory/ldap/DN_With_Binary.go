...
type DN_With_Binary struct { 
	*cim.WmiInstance
	...
	func NewDN_With_BinaryEx1(instance *cim.WmiInstance) (newInstance *DN_With_Binary, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DN_With_Binary, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
