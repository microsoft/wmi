...
type ads_ntfrssubscriptions struct { 
	*ds_top
	...
	func Newads_ntfrssubscriptionsEx1(instance *cim.WmiInstance) (newInstance *ads_ntfrssubscriptions, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ntfrssubscriptions, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
