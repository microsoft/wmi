...
type ads_attributeschema struct { 
	*ds_top
	...
	func Newads_attributeschemaEx1(instance *cim.WmiInstance) (newInstance *ads_attributeschema, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_attributeschema, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
