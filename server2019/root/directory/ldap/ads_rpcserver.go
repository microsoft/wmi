...
type ads_rpcserver struct { 
	*ds_rpcentry
	...
	func Newads_rpcserverEx1(instance *cim.WmiInstance) (newInstance *ads_rpcserver, err error) {tmp, err := Newds_rpcentryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_rpcserver, err error) {tmp, err := Newds_rpcentryEx6(hostName, wmiNamespace, userName, password, domainName, query)
