...
type ads_nismap struct { 
	*ds_top
	...
	func Newads_nismapEx1(instance *cim.WmiInstance) (newInstance *ads_nismap, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_nismap, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
