...
type ads_ms_sql_sqlpublication struct { 
	*ds_top
	...
	func Newads_ms_sql_sqlpublicationEx1(instance *cim.WmiInstance) (newInstance *ads_ms_sql_sqlpublication, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ms_sql_sqlpublication, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
