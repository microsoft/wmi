...
type ads_ntdsservice struct { 
	*ds_top
	...
	func Newads_ntdsserviceEx1(instance *cim.WmiInstance) (newInstance *ads_ntdsservice, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ntdsservice, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
