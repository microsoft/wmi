...
type ads_msdfsr_member struct { 
	*ds_top
	...
	func Newads_msdfsr_memberEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_member, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdfsr_member, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
