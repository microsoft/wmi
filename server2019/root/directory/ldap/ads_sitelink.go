...
type ads_sitelink struct { 
	*ds_top
	...
	func Newads_sitelinkEx1(instance *cim.WmiInstance) (newInstance *ads_sitelink, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_sitelink, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
