...
type ds_ieee802device struct { 
	*ds_top
	...
	func Newds_ieee802deviceEx1(instance *cim.WmiInstance) (newInstance *ds_ieee802device, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_ieee802device, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
