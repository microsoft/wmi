...
type ads_msdns_serversettings struct { 
	*ds_top
	...
	func Newads_msdns_serversettingsEx1(instance *cim.WmiInstance) (newInstance *ads_msdns_serversettings, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdns_serversettings, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
