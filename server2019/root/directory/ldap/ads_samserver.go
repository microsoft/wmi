...
type ads_samserver struct { 
	*ds_securityobject
	...
	func Newads_samserverEx1(instance *cim.WmiInstance) (newInstance *ads_samserver, err error) {tmp, err := Newds_securityobjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_samserver, err error) {tmp, err := Newds_securityobjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
