...
type ads_rpcgroup struct { 
	*ds_rpcentry
	...
	func Newads_rpcgroupEx1(instance *cim.WmiInstance) (newInstance *ads_rpcgroup, err error) {tmp, err := Newds_rpcentryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_rpcgroup, err error) {tmp, err := Newds_rpcentryEx6(hostName, wmiNamespace, userName, password, domainName, query)
