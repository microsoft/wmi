...
type ds_shadowaccount struct { 
	*ds_top
	...
	func Newds_shadowaccountEx1(instance *cim.WmiInstance) (newInstance *ds_shadowaccount, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_shadowaccount, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
