...
type ads_ipsecnfa struct { 
	*ds_ipsecbase
	...
	func Newads_ipsecnfaEx1(instance *cim.WmiInstance) (newInstance *ads_ipsecnfa, err error) {tmp, err := Newds_ipsecbaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ipsecnfa, err error) {tmp, err := Newds_ipsecbaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
