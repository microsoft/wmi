...
type ds_top struct { 
	*DS_LDAP_Root_Class
	...
	func Newds_topEx1(instance *cim.WmiInstance) (newInstance *ds_top, err error) {tmp, err := NewDS_LDAP_Root_ClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_top, err error) {tmp, err := NewDS_LDAP_Root_ClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
