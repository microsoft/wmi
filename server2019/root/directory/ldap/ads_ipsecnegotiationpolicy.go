...
type ads_ipsecnegotiationpolicy struct { 
	*ds_ipsecbase
	...
	func Newads_ipsecnegotiationpolicyEx1(instance *cim.WmiInstance) (newInstance *ads_ipsecnegotiationpolicy, err error) {tmp, err := Newds_ipsecbaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ipsecnegotiationpolicy, err error) {tmp, err := Newds_ipsecbaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
