...
type ads_mssfu30netid struct { 
	*ds_top
	...
	func Newads_mssfu30netidEx1(instance *cim.WmiInstance) (newInstance *ads_mssfu30netid, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mssfu30netid, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
