...
type ads_ms_sql_sqldatabase struct { 
	*ds_top
	...
	func Newads_ms_sql_sqldatabaseEx1(instance *cim.WmiInstance) (newInstance *ads_ms_sql_sqldatabase, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ms_sql_sqldatabase, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
