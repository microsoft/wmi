...
type ads_indexservercatalog struct { 
	*ds_connectionpoint
	...
	func Newads_indexservercatalogEx1(instance *cim.WmiInstance) (newInstance *ads_indexservercatalog, err error) {tmp, err := Newds_connectionpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_indexservercatalog, err error) {tmp, err := Newds_connectionpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
