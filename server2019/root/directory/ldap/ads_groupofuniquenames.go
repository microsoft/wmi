...
type ads_groupofuniquenames struct { 
	*ds_top
	...
	func Newads_groupofuniquenamesEx1(instance *cim.WmiInstance) (newInstance *ads_groupofuniquenames, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_groupofuniquenames, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
