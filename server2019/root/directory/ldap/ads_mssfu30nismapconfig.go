...
type ads_mssfu30nismapconfig struct { 
	*ds_top
	...
	func Newads_mssfu30nismapconfigEx1(instance *cim.WmiInstance) (newInstance *ads_mssfu30nismapconfig, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mssfu30nismapconfig, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
