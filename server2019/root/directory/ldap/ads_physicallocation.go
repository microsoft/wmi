...
type ads_physicallocation struct { 
	*ads_locality
	...
	func Newads_physicallocationEx1(instance *cim.WmiInstance) (newInstance *ads_physicallocation, err error) {tmp, err := Newads_localityEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_physicallocation, err error) {tmp, err := Newads_localityEx6(hostName, wmiNamespace, userName, password, domainName, query)
