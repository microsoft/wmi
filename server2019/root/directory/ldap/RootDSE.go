...
type RootDSE struct { 
	*cim.WmiInstance
	...
	func NewRootDSEEx1(instance *cim.WmiInstance) (newInstance *RootDSE, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RootDSE, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
