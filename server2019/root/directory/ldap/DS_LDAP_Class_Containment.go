...
type DS_LDAP_Class_Containment struct { 
	*cim.WmiInstance
	...
	func NewDS_LDAP_Class_ContainmentEx1(instance *cim.WmiInstance) (newInstance *DS_LDAP_Class_Containment, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DS_LDAP_Class_Containment, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
