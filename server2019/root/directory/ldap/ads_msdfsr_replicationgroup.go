...
type ads_msdfsr_replicationgroup struct { 
	*ds_top
	...
	func Newads_msdfsr_replicationgroupEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_replicationgroup, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdfsr_replicationgroup, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
