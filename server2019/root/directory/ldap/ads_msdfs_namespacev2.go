...
func Newads_msdfs_namespacev2Ex1(instance *cim.WmiInstance) (newInstance *ads_msdfs_namespacev2, err error) {
...
func Newads_msdfs_namespacev2Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_msdfs_namespacev2, err error) {
