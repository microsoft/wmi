...
type ads_remotestorageservicepoint struct { 
	*ads_serviceadministrationpoint
	...
	func Newads_remotestorageservicepointEx1(instance *cim.WmiInstance) (newInstance *ads_remotestorageservicepoint, err error) {tmp, err := Newads_serviceadministrationpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_remotestorageservicepoint, err error) {tmp, err := Newads_serviceadministrationpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
