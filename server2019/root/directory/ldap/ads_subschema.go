...
type ads_subschema struct { 
	*ds_top
	...
	func Newads_subschemaEx1(instance *cim.WmiInstance) (newInstance *ads_subschema, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_subschema, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
