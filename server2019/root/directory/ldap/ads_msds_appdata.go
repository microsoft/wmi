...
// ads_msds_appdata struct
type ads_msds_appdata struct { 
	*ds_applicationsettings
	...
	func Newads_msds_appdataEx1(instance *cim.WmiInstance) (newInstance *ads_msds_appdata, err error) {tmp, err := Newds_applicationsettingsEx1(instance)
		
	if err != nil { return }
	newInstance = &ads_msds_appdata {
	...
	func Newads_msds_appdataEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msds_appdata, err error) {tmp, err := Newds_applicationsettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *ads_msds_appdata) SetPropertyDS_keywords(value []string) (err error) { 
    return instance.SetProperty("DS_keywords", (value))
}

// GetDS_keywords gets the value of DS_keywords for the instance
func (instance *ads_msds_appdata) GetPropertyDS_keywords()(value []string, err error) { 
...
func (instance *ads_msds_appdata) SetPropertyDS_managedBy(value string) (err error) { 
    return instance.SetProperty("DS_managedBy", (value))
}

// GetDS_managedBy gets the value of DS_managedBy for the instance
func (instance *ads_msds_appdata) GetPropertyDS_managedBy()(value string, err error) { 
...
func (instance *ads_msds_appdata) SetPropertyDS_msDS_ByteArray(value []Uint8Array) (err error) { 
...
func (instance *ads_msds_appdata) GetPropertyDS_msDS_ByteArray()(value []Uint8Array, err error) { 
...
func (instance *ads_msds_appdata) SetPropertyDS_msDS_DateTime(value []string) (err error) { 
...
func (instance *ads_msds_appdata) GetPropertyDS_msDS_DateTime()(value []string, err error) { 
...
func (instance *ads_msds_appdata) SetPropertyDS_msDS_Integer(value []int32) (err error) { 
    return instance.SetProperty("DS_msDS_Integer", (value))
}

// GetDS_msDS_Integer gets the value of DS_msDS_Integer for the instance
func (instance *ads_msds_appdata) GetPropertyDS_msDS_Integer()(value []int32, err error) { 
...
func (instance *ads_msds_appdata) SetPropertyDS_msDS_ObjectReference(value []string) (err error) { 
...
func (instance *ads_msds_appdata) GetPropertyDS_msDS_ObjectReference()(value []string, err error) { 
...
func (instance *ads_msds_appdata) SetPropertyDS_owner(value string) (err error) { 
    return instance.SetProperty("DS_owner", (value))
}

// GetDS_owner gets the value of DS_owner for the instance
func (instance *ads_msds_appdata) GetPropertyDS_owner()(value string, err error) { 
