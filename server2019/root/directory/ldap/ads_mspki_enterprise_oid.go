...
type ads_mspki_enterprise_oid struct { 
	*ds_top
	...
	func Newads_mspki_enterprise_oidEx1(instance *cim.WmiInstance) (newInstance *ads_mspki_enterprise_oid, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mspki_enterprise_oid, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
