...
type ds_domainrelatedobject struct { 
	*ds_top
	...
	func Newds_domainrelatedobjectEx1(instance *cim.WmiInstance) (newInstance *ds_domainrelatedobject, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ds_domainrelatedobject, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
