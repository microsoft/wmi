...
type ads_trusteddomain struct { 
	*ds_leaf
	...
	func Newads_trusteddomainEx1(instance *cim.WmiInstance) (newInstance *ads_trusteddomain, err error) {tmp, err := Newds_leafEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_trusteddomain, err error) {tmp, err := Newds_leafEx6(hostName, wmiNamespace, userName, password, domainName, query)
