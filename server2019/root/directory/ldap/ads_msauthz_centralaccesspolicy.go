...
type ads_msauthz_centralaccesspolicy struct { 
	*ds_top
	...
	func Newads_msauthz_centralaccesspolicyEx1(instance *cim.WmiInstance) (newInstance *ads_msauthz_centralaccesspolicy, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msauthz_centralaccesspolicy, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
