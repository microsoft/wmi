...
type ads_ipservice struct { 
	*ds_top
	...
	func Newads_ipserviceEx1(instance *cim.WmiInstance) (newInstance *ads_ipservice, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ipservice, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
