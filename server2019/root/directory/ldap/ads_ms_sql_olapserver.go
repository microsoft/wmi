...
func Newads_ms_sql_olapserverEx1(instance *cim.WmiInstance) (newInstance *ads_ms_sql_olapserver, err error) {
...
func Newads_ms_sql_olapserverEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_ms_sql_olapserver, err error) {
