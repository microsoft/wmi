...
type ads_nisnetgroup struct { 
	*ds_top
	...
	func Newads_nisnetgroupEx1(instance *cim.WmiInstance) (newInstance *ads_nisnetgroup, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_nisnetgroup, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
