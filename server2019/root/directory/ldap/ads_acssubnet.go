...
type ads_acssubnet struct { 
	*ds_top
	...
	func Newads_acssubnetEx1(instance *cim.WmiInstance) (newInstance *ads_acssubnet, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_acssubnet, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
