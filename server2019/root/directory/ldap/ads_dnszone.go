...
type ads_dnszone struct { 
	*ds_top
	...
	func Newads_dnszoneEx1(instance *cim.WmiInstance) (newInstance *ads_dnszone, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_dnszone, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
