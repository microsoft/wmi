...
type ads_ms_sql_sqlserver struct { 
	*ads_serviceconnectionpoint
	...
	func Newads_ms_sql_sqlserverEx1(instance *cim.WmiInstance) (newInstance *ads_ms_sql_sqlserver, err error) {tmp, err := Newads_serviceconnectionpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ms_sql_sqlserver, err error) {tmp, err := Newads_serviceconnectionpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
