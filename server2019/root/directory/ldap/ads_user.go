...
type ads_user struct { 
	*ads_organizationalperson
	...
	func Newads_userEx1(instance *cim.WmiInstance) (newInstance *ads_user, err error) {tmp, err := Newads_organizationalpersonEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_user, err error) {tmp, err := Newads_organizationalpersonEx6(hostName, wmiNamespace, userName, password, domainName, query)
