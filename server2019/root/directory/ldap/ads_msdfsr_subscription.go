...
type ads_msdfsr_subscription struct { 
	*ds_top
	...
	func Newads_msdfsr_subscriptionEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_subscription, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdfsr_subscription, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
