...
type ads_msds_azoperation struct { 
	*ds_top
	...
	func Newads_msds_azoperationEx1(instance *cim.WmiInstance) (newInstance *ads_msds_azoperation, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msds_azoperation, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
