...
type ads_volume struct { 
	*ds_connectionpoint
	...
	func Newads_volumeEx1(instance *cim.WmiInstance) (newInstance *ads_volume, err error) {tmp, err := Newds_connectionpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_volume, err error) {tmp, err := Newds_connectionpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
