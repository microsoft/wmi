...
type ads_lostandfound struct { 
	*ds_top
	...
	func Newads_lostandfoundEx1(instance *cim.WmiInstance) (newInstance *ads_lostandfound, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_lostandfound, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
