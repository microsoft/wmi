...
type ads_mscom_partitionset struct { 
	*ds_top
	...
	func Newads_mscom_partitionsetEx1(instance *cim.WmiInstance) (newInstance *ads_mscom_partitionset, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mscom_partitionset, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
