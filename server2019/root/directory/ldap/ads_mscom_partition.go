...
type ads_mscom_partition struct { 
	*ds_top
	...
	func Newads_mscom_partitionEx1(instance *cim.WmiInstance) (newInstance *ads_mscom_partition, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mscom_partition, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
