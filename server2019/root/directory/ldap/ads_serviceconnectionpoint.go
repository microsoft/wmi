...
type ads_serviceconnectionpoint struct { 
	*ds_connectionpoint
	...
	func Newads_serviceconnectionpointEx1(instance *cim.WmiInstance) (newInstance *ads_serviceconnectionpoint, err error) {tmp, err := Newds_connectionpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_serviceconnectionpoint, err error) {tmp, err := Newds_connectionpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
