...
type ads_mswmi_simplepolicytemplate struct { 
	*ads_mswmi_policytemplate
	...
	func Newads_mswmi_simplepolicytemplateEx1(instance *cim.WmiInstance) (newInstance *ads_mswmi_simplepolicytemplate, err error) {tmp, err := Newads_mswmi_policytemplateEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mswmi_simplepolicytemplate, err error) {tmp, err := Newads_mswmi_policytemplateEx6(hostName, wmiNamespace, userName, password, domainName, query)
