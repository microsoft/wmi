...
type ads_organizationalperson struct { 
	*ads_person
	...
	func Newads_organizationalpersonEx1(instance *cim.WmiInstance) (newInstance *ads_organizationalperson, err error) {tmp, err := Newads_personEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_organizationalperson, err error) {tmp, err := Newads_personEx6(hostName, wmiNamespace, userName, password, domainName, query)
