...
type ads_applicationversion struct { 
	*ds_applicationsettings
	...
	func Newads_applicationversionEx1(instance *cim.WmiInstance) (newInstance *ads_applicationversion, err error) {tmp, err := Newds_applicationsettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_applicationversion, err error) {tmp, err := Newds_applicationsettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
