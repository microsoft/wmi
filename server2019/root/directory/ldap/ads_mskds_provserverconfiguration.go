...
type ads_mskds_provserverconfiguration struct { 
	*ds_top
	...
	func Newads_mskds_provserverconfigurationEx1(instance *cim.WmiInstance) (newInstance *ads_mskds_provserverconfiguration, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mskds_provserverconfiguration, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
