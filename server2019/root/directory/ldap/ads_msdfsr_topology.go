...
// ads_msdfsr_topology struct
type ads_msdfsr_topology struct { 
	*ds_top
	...
	func Newads_msdfsr_topologyEx1(instance *cim.WmiInstance) (newInstance *ads_msdfsr_topology, err error) {tmp, err := Newds_topEx1(instance)
		
	if err != nil { return }
	newInstance = &ads_msdfsr_topology {
	ds_top: tmp,
	}
	return
	}
	...
	func Newads_msdfsr_topologyEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msdfsr_topology, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *ads_msdfsr_topology) SetPropertyDS_msDFSR_Extension(value Uint8Array) (err error) { 
...
func (instance *ads_msdfsr_topology) GetPropertyDS_msDFSR_Extension()(value Uint8Array, err error) { 
...
func (instance *ads_msdfsr_topology) SetPropertyDS_msDFSR_Flags(value int32) (err error) { 
    return instance.SetProperty("DS_msDFSR_Flags", (value))
}

// GetDS_msDFSR_Flags gets the value of DS_msDFSR_Flags for the instance
func (instance *ads_msdfsr_topology) GetPropertyDS_msDFSR_Flags()(value int32, err error) { 
...
func (instance *ads_msdfsr_topology) SetPropertyDS_msDFSR_Options(value int32) (err error) { 
...
func (instance *ads_msdfsr_topology) GetPropertyDS_msDFSR_Options()(value int32, err error) { 
...
func (instance *ads_msdfsr_topology) SetPropertyDS_msDFSR_Options2(value int32) (err error) { 
...
func (instance *ads_msdfsr_topology) GetPropertyDS_msDFSR_Options2()(value int32, err error) { 
