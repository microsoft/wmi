...
type ads_rrasadministrationconnectionpoint struct { 
	*ads_serviceadministrationpoint
	...
	func Newads_rrasadministrationconnectionpointEx1(instance *cim.WmiInstance) (newInstance *ads_rrasadministrationconnectionpoint, err error) {tmp, err := Newads_serviceadministrationpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_rrasadministrationconnectionpoint, err error) {tmp, err := Newads_serviceadministrationpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
