...
type ads_licensingsitesettings struct { 
	*ds_applicationsitesettings
	...
	func Newads_licensingsitesettingsEx1(instance *cim.WmiInstance) (newInstance *ads_licensingsitesettings, err error) {tmp, err := Newds_applicationsitesettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_licensingsitesettings, err error) {tmp, err := Newds_applicationsitesettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
