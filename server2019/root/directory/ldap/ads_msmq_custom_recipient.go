...
type ads_msmq_custom_recipient struct { 
	*ds_top
	...
	func Newads_msmq_custom_recipientEx1(instance *cim.WmiInstance) (newInstance *ads_msmq_custom_recipient, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msmq_custom_recipient, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
