...
type ads_mswmi_realrangeparam struct { 
	*ads_mswmi_rangeparam
	...
	func Newads_mswmi_realrangeparamEx1(instance *cim.WmiInstance) (newInstance *ads_mswmi_realrangeparam, err error) {tmp, err := Newads_mswmi_rangeparamEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mswmi_realrangeparam, err error) {tmp, err := Newads_mswmi_rangeparamEx6(hostName, wmiNamespace, userName, password, domainName, query)
