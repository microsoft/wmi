...
type ads_rpcprofileelement struct { 
	*ds_rpcentry
	...
	func Newads_rpcprofileelementEx1(instance *cim.WmiInstance) (newInstance *ads_rpcprofileelement, err error) {tmp, err := Newds_rpcentryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_rpcprofileelement, err error) {tmp, err := Newds_rpcentryEx6(hostName, wmiNamespace, userName, password, domainName, query)
