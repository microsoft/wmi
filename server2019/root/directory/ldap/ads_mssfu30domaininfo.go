...
type ads_mssfu30domaininfo struct { 
	*ds_top
	...
	func Newads_mssfu30domaininfoEx1(instance *cim.WmiInstance) (newInstance *ads_mssfu30domaininfo, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mssfu30domaininfo, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
