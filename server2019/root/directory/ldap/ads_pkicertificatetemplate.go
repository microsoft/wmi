...
func Newads_pkicertificatetemplateEx1(instance *cim.WmiInstance) (newInstance *ads_pkicertificatetemplate, err error) {
...
func Newads_pkicertificatetemplateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ads_pkicertificatetemplate, err error) {
