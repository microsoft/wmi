...
type ads_msds_groupmanagedserviceaccount struct { 
	*ads_computer
	...
	func Newads_msds_groupmanagedserviceaccountEx1(instance *cim.WmiInstance) (newInstance *ads_msds_groupmanagedserviceaccount, err error) {tmp, err := Newads_computerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msds_groupmanagedserviceaccount, err error) {tmp, err := Newads_computerEx6(hostName, wmiNamespace, userName, password, domainName, query)
