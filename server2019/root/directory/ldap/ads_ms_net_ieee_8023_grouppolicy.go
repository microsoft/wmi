...
type ads_ms_net_ieee_8023_grouppolicy struct { 
	*ds_top
	...
	func Newads_ms_net_ieee_8023_grouppolicyEx1(instance *cim.WmiInstance) (newInstance *ads_ms_net_ieee_8023_grouppolicy, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ms_net_ieee_8023_grouppolicy, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
