...
type ads_rfc822localpart struct { 
	*ds_domain
	...
	func Newads_rfc822localpartEx1(instance *cim.WmiInstance) (newInstance *ads_rfc822localpart, err error) {tmp, err := Newds_domainEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_rfc822localpart, err error) {tmp, err := Newds_domainEx6(hostName, wmiNamespace, userName, password, domainName, query)
