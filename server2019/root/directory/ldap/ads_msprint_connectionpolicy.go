...
type ads_msprint_connectionpolicy struct { 
	*ds_top
	...
	func Newads_msprint_connectionpolicyEx1(instance *cim.WmiInstance) (newInstance *ads_msprint_connectionpolicy, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_msprint_connectionpolicy, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
