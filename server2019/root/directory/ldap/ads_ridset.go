...
type ads_ridset struct { 
	*ds_top
	...
	func Newads_ridsetEx1(instance *cim.WmiInstance) (newInstance *ads_ridset, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ridset, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
