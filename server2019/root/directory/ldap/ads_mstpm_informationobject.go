...
type ads_mstpm_informationobject struct { 
	*ds_top
	...
	func Newads_mstpm_informationobjectEx1(instance *cim.WmiInstance) (newInstance *ads_mstpm_informationobject, err error) {tmp, err := Newds_topEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_mstpm_informationobject, err error) {tmp, err := Newds_topEx6(hostName, wmiNamespace, userName, password, domainName, query)
