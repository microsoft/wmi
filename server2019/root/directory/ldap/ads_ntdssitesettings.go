...
type ads_ntdssitesettings struct { 
	*ds_applicationsitesettings
	...
	func Newads_ntdssitesettingsEx1(instance *cim.WmiInstance) (newInstance *ads_ntdssitesettings, err error) {tmp, err := Newds_applicationsitesettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ads_ntdssitesettings, err error) {tmp, err := Newds_applicationsitesettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
