...
type __Subject struct { 
	*__SecurityRelatedClass
	...
	func New__SubjectEx1(instance *cim.WmiInstance) (newInstance *__Subject, err error) {tmp, err := New__SecurityRelatedClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__Subject, err error) {tmp, err := New__SecurityRelatedClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
