...
type CIM_RegisteredSpecification struct { 
	*CIM_ManagedElement
	...
	func NewCIM_RegisteredSpecificationEx1(instance *cim.WmiInstance) (newInstance *CIM_RegisteredSpecification, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RegisteredSpecification, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
