...
type WMI_extension struct { 
	*__Win32Provider
	...
	func NewWMI_extensionEx1(instance *cim.WmiInstance) (newInstance *WMI_extension, err error) {tmp, err := New__Win32ProviderEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WMI_extension, err error) {tmp, err := New__Win32ProviderEx6(hostName, wmiNamespace, userName, password, domainName, query)
