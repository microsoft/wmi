...
type ProxyService struct { 
	*cim.WmiInstance
	...
	func NewProxyServiceEx1(instance *cim.WmiInstance) (newInstance *ProxyService, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProxyService, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
