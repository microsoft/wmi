...
type VirtualDirectory struct { 
	*ConfiguredObject
	...
	func NewVirtualDirectoryEx1(instance *cim.WmiInstance) (newInstance *VirtualDirectory, err error) {tmp, err := NewConfiguredObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VirtualDirectory, err error) {tmp, err := NewConfiguredObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *VirtualDirectory) Create( /* IN */ VirtualDirectoryPath string,
 ...
 /* IN */ SiteName string) (err error) {_, err = instance.InvokeMethodWithReturn("Create" , VirtualDirectoryPath, ApplicationPath, PhysicalPath, SiteName);
	if err != nil { return }
	return
...
func (instance *VirtualDirectory) RevertToParent( /* OPTIONAL IN */ PropertyName string) (err error) {_, err = instance.InvokeMethodWithReturn("RevertToParent" , PropertyName);
	if err != nil { return }
	return
