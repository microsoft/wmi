...
type WebServicesProtocolSettings struct { 
	*EmbeddedObject
	...
	func NewWebServicesProtocolSettingsEx1(instance *cim.WmiInstance) (newInstance *WebServicesProtocolSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebServicesProtocolSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
