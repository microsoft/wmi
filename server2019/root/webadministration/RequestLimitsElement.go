...
type RequestLimitsElement struct { 
	*EmbeddedObject
	...
	func NewRequestLimitsElementEx1(instance *cim.WmiInstance) (newInstance *RequestLimitsElement, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RequestLimitsElement, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
