...
type NameImageElement struct { 
	*CollectionElement
	...
	func NewNameImageElementEx1(instance *cim.WmiInstance) (newInstance *NameImageElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NameImageElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
