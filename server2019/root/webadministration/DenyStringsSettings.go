...
type DenyStringsSettings struct { 
	*EmbeddedObject
	...
	func NewDenyStringsSettingsEx1(instance *cim.WmiInstance) (newInstance *DenyStringsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DenyStringsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
