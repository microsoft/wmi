...
type TraceFailedRequestsLogging struct { 
	*EmbeddedObject
	...
	func NewTraceFailedRequestsLoggingEx1(instance *cim.WmiInstance) (newInstance *TraceFailedRequestsLogging, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceFailedRequestsLogging, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
