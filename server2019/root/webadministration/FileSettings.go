...
type FileSettings struct { 
	*EmbeddedObject
	...
	func NewFileSettingsEx1(instance *cim.WmiInstance) (newInstance *FileSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
