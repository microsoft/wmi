...
type FtpSessionsSettings struct { 
	*EmbeddedObject
	...
	func NewFtpSessionsSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpSessionsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpSessionsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
