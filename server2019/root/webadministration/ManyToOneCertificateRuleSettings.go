...
type ManyToOneCertificateRuleSettings struct { 
	*EmbeddedObject
	...
	func NewManyToOneCertificateRuleSettingsEx1(instance *cim.WmiInstance) (newInstance *ManyToOneCertificateRuleSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ManyToOneCertificateRuleSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
