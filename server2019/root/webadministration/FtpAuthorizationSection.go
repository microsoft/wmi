...
type FtpAuthorizationSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewFtpAuthorizationSectionEx1(instance *cim.WmiInstance) (newInstance *FtpAuthorizationSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpAuthorizationSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
