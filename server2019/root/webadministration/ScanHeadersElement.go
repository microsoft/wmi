...
func NewScanHeadersElementEx1(instance *cim.WmiInstance) (newInstance *ScanHeadersElement, err error) {
...
func NewScanHeadersElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ScanHeadersElement, err error) {
