...
type WebDavLockStoresSettings struct { 
	*EmbeddedObject
	...
	func NewWebDavLockStoresSettingsEx1(instance *cim.WmiInstance) (newInstance *WebDavLockStoresSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavLockStoresSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
