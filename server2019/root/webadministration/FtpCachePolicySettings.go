...
func NewFtpCachePolicySettingsEx1(instance *cim.WmiInstance) (newInstance *FtpCachePolicySettings, err error) {
...
func NewFtpCachePolicySettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FtpCachePolicySettings, err error) {
