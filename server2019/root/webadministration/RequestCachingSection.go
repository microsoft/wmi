...
type RequestCachingSection struct { 
	*ConfigurationSection
	...
	func NewRequestCachingSectionEx1(instance *cim.WmiInstance) (newInstance *RequestCachingSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RequestCachingSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
