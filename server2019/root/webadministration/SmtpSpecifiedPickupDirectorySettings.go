...
type SmtpSpecifiedPickupDirectorySettings struct { 
	*EmbeddedObject
	...
	func NewSmtpSpecifiedPickupDirectorySettingsEx1(instance *cim.WmiInstance) (newInstance *SmtpSpecifiedPickupDirectorySettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SmtpSpecifiedPickupDirectorySettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
