...
type SystemWebDeploymentSection struct { 
	*ConfigurationSection
	...
	func NewSystemWebDeploymentSectionEx1(instance *cim.WmiInstance) (newInstance *SystemWebDeploymentSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemWebDeploymentSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
