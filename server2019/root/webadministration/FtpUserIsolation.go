...
type FtpUserIsolation struct { 
	*EmbeddedObject
	...
	func NewFtpUserIsolationEx1(instance *cim.WmiInstance) (newInstance *FtpUserIsolation, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpUserIsolation, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
