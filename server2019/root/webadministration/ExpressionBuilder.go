...
type ExpressionBuilder struct { 
	*CollectionElement
	...
	func NewExpressionBuilderEx1(instance *cim.WmiInstance) (newInstance *ExpressionBuilder, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ExpressionBuilder, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
