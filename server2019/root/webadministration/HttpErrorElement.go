...
type HttpErrorElement struct { 
	*CollectionElement
	...
	func NewHttpErrorElementEx1(instance *cim.WmiInstance) (newInstance *HttpErrorElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpErrorElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
