...
type ObjectConfigurationAssociation struct { 
	*cim.WmiInstance
	...
	func NewObjectConfigurationAssociationEx1(instance *cim.WmiInstance) (newInstance *ObjectConfigurationAssociation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ObjectConfigurationAssociation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
