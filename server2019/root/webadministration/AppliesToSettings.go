...
type AppliesToSettings struct { 
	*EmbeddedObject
	...
	func NewAppliesToSettingsEx1(instance *cim.WmiInstance) (newInstance *AppliesToSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AppliesToSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
