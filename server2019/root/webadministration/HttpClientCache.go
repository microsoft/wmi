...
type HttpClientCache struct { 
	*EmbeddedObject
	...
	func NewHttpClientCacheEx1(instance *cim.WmiInstance) (newInstance *HttpClientCache, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpClientCache, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
