...
type FtpSecurity struct { 
	*EmbeddedObject
	...
	func NewFtpSecurityEx1(instance *cim.WmiInstance) (newInstance *FtpSecurity, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpSecurity, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
