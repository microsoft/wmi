...
type ProfileElement struct { 
	*CollectionElement
	...
	func NewProfileElementEx1(instance *cim.WmiInstance) (newInstance *ProfileElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProfileElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
