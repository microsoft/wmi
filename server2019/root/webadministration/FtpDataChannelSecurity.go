...
type FtpDataChannelSecurity struct { 
	*EmbeddedObject
	...
	func NewFtpDataChannelSecurityEx1(instance *cim.WmiInstance) (newInstance *FtpDataChannelSecurity, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpDataChannelSecurity, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
