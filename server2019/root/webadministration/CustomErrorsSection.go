...
func NewCustomErrorsSectionEx1(instance *cim.WmiInstance) (newInstance *CustomErrorsSection, err error) {
...
func NewCustomErrorsSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CustomErrorsSection, err error) {
