...
type KeyValueElement struct { 
	*CollectionElement
	...
	func NewKeyValueElementEx1(instance *cim.WmiInstance) (newInstance *KeyValueElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KeyValueElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
