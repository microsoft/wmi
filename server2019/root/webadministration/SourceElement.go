...
type SourceElement struct { 
	*CollectionElement
	...
	func NewSourceElementEx1(instance *cim.WmiInstance) (newInstance *SourceElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SourceElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
