...
type DenyByConcurrentRequestsSettings struct { 
	*EmbeddedObject
	...
	func NewDenyByConcurrentRequestsSettingsEx1(instance *cim.WmiInstance) (newInstance *DenyByConcurrentRequestsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DenyByConcurrentRequestsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
