...
type FtpSslClientCertificates struct { 
	*EmbeddedObject
	...
	func NewFtpSslClientCertificatesEx1(instance *cim.WmiInstance) (newInstance *FtpSslClientCertificates, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpSslClientCertificates, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
