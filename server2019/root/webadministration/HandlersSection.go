...
type HandlersSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewHandlersSectionEx1(instance *cim.WmiInstance) (newInstance *HandlersSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HandlersSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
