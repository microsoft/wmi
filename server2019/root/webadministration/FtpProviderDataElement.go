...
type FtpProviderDataElement struct { 
	*CollectionElement
	...
	func NewFtpProviderDataElementEx1(instance *cim.WmiInstance) (newInstance *FtpProviderDataElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpProviderDataElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
