...
type HeaderLimitsSettings struct { 
	*EmbeddedObject
	...
	func NewHeaderLimitsSettingsEx1(instance *cim.WmiInstance) (newInstance *HeaderLimitsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeaderLimitsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
