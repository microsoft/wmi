...
type AppDomain struct { 
	*Object
	...
	func NewAppDomainEx1(instance *cim.WmiInstance) (newInstance *AppDomain, err error) {tmp, err := NewObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AppDomain, err error) {tmp, err := NewObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
// 
func (instance *AppDomain) Unload() (err error) {_, err = instance.InvokeMethodWithReturn("Unload" );
	if err != nil { return }
	return
