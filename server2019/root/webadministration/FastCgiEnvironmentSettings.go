...
type FastCgiEnvironmentSettings struct { 
	*EmbeddedObject
	...
	func NewFastCgiEnvironmentSettingsEx1(instance *cim.WmiInstance) (newInstance *FastCgiEnvironmentSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FastCgiEnvironmentSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
