...
type DbProviderFactorySettings struct { 
	*EmbeddedObject
	...
	func NewDbProviderFactorySettingsEx1(instance *cim.WmiInstance) (newInstance *DbProviderFactorySettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DbProviderFactorySettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
