...
type FtpHostNameSupport struct { 
	*EmbeddedObject
	...
	func NewFtpHostNameSupportEx1(instance *cim.WmiInstance) (newInstance *FtpHostNameSupport, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpHostNameSupport, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
