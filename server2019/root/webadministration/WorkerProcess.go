...
func NewWorkerProcessEx1(instance *cim.WmiInstance) (newInstance *WorkerProcess, err error) {
...
func NewWorkerProcessEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WorkerProcess, err error) {
...
func (instance *WorkerProcess) GetState() (result uint32, err error) {
...
func (instance *WorkerProcess) GetExecutingRequests( /* OUT */ OutputElement []HttpRequest) (err error) {
	_, err = instance.InvokeMethod("GetExecutingRequests")
	if err != nil {
		return
	}
	return
