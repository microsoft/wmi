...
type ProxySettings struct { 
	*EmbeddedObject
	...
	func NewProxySettingsEx1(instance *cim.WmiInstance) (newInstance *ProxySettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProxySettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
