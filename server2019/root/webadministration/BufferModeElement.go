...
type BufferModeElement struct { 
	*CollectionElement
	...
	func NewBufferModeElementEx1(instance *cim.WmiInstance) (newInstance *BufferModeElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BufferModeElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
