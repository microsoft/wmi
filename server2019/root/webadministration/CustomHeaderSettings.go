...
type CustomHeaderSettings struct { 
	*EmbeddedObject
	...
	func NewCustomHeaderSettingsEx1(instance *cim.WmiInstance) (newInstance *CustomHeaderSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CustomHeaderSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
