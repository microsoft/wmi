...
type WebDavAuthoringRulesSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewWebDavAuthoringRulesSectionEx1(instance *cim.WmiInstance) (newInstance *WebDavAuthoringRulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavAuthoringRulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
