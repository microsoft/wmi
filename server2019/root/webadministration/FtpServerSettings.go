...
type FtpServerSettings struct { 
	*EmbeddedObject
	...
	func NewFtpServerSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpServerSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpServerSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
