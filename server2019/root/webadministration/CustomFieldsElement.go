...
type CustomFieldsElement struct { 
	*CollectionElement
	...
	func NewCustomFieldsElementEx1(instance *cim.WmiInstance) (newInstance *CustomFieldsElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CustomFieldsElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
