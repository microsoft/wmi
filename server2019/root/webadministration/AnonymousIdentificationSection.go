...
type AnonymousIdentificationSection struct { 
	*ConfigurationSection
	...
	func NewAnonymousIdentificationSectionEx1(instance *cim.WmiInstance) (newInstance *AnonymousIdentificationSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AnonymousIdentificationSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
