...
func NewWsdlHelpGeneratorInfoEx1(instance *cim.WmiInstance) (newInstance *WsdlHelpGeneratorInfo, err error) {
...
func NewWsdlHelpGeneratorInfoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WsdlHelpGeneratorInfo, err error) {
