...
type TraceAreaDefinition struct { 
	*CollectionElement
	...
	func NewTraceAreaDefinitionEx1(instance *cim.WmiInstance) (newInstance *TraceAreaDefinition, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceAreaDefinition, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
