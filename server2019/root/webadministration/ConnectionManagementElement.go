...
type ConnectionManagementElement struct { 
	*CollectionElement
	...
	func NewConnectionManagementElementEx1(instance *cim.WmiInstance) (newInstance *ConnectionManagementElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ConnectionManagementElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
