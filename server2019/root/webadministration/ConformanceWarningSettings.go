...
type ConformanceWarningSettings struct { 
	*EmbeddedObject
	...
	func NewConformanceWarningSettingsEx1(instance *cim.WmiInstance) (newInstance *ConformanceWarningSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ConformanceWarningSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
