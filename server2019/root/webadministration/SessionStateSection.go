...
type SessionStateSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewSessionStateSectionEx1(instance *cim.WmiInstance) (newInstance *SessionStateSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SessionStateSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
