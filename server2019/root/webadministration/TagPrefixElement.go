...
type TagPrefixElement struct { 
	*CollectionElement
	...
	func NewTagPrefixElementEx1(instance *cim.WmiInstance) (newInstance *TagPrefixElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TagPrefixElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
