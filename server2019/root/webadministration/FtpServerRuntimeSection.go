...
type FtpServerRuntimeSection struct { 
	*ConfigurationSection
	...
	func NewFtpServerRuntimeSectionEx1(instance *cim.WmiInstance) (newInstance *FtpServerRuntimeSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpServerRuntimeSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
