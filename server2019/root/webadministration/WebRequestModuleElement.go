...
type WebRequestModuleElement struct { 
	*CollectionElement
	...
	func NewWebRequestModuleElementEx1(instance *cim.WmiInstance) (newInstance *WebRequestModuleElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebRequestModuleElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
