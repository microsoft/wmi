...
type FtpCommandFiltering struct { 
	*EmbeddedObject
	...
	func NewFtpCommandFilteringEx1(instance *cim.WmiInstance) (newInstance *FtpCommandFiltering, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpCommandFiltering, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
