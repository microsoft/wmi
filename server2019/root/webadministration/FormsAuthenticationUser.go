...
func NewFormsAuthenticationUserEx1(instance *cim.WmiInstance) (newInstance *FormsAuthenticationUser, err error) {
...
func NewFormsAuthenticationUserEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *FormsAuthenticationUser, err error) {
