...
type FtpProviderDataSettings struct { 
	*CollectionElement
	...
	func NewFtpProviderDataSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpProviderDataSettings, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpProviderDataSettings, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
