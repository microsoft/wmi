...
type FtpCustomAuthorization struct { 
	*EmbeddedObject
	...
	func NewFtpCustomAuthorizationEx1(instance *cim.WmiInstance) (newInstance *FtpCustomAuthorization, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpCustomAuthorization, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
