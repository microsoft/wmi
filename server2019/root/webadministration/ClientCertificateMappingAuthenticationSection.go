...
type ClientCertificateMappingAuthenticationSection struct { 
	*ConfigurationSection
	...
	func NewClientCertificateMappingAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *ClientCertificateMappingAuthenticationSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClientCertificateMappingAuthenticationSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
