...
type FtpProviderElement struct { 
	*CollectionElement
	...
	func NewFtpProviderElementEx1(instance *cim.WmiInstance) (newInstance *FtpProviderElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpProviderElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
