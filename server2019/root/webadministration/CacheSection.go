...
type CacheSection struct { 
	*ConfigurationSection
	...
	func NewCacheSectionEx1(instance *cim.WmiInstance) (newInstance *CacheSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CacheSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
