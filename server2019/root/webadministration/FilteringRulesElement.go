...
type FilteringRulesElement struct { 
	*CollectionElement
	...
	func NewFilteringRulesElementEx1(instance *cim.WmiInstance) (newInstance *FilteringRulesElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FilteringRulesElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
