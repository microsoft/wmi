...
type CompilerElement struct { 
	*CollectionElement
	...
	func NewCompilerElementEx1(instance *cim.WmiInstance) (newInstance *CompilerElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CompilerElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
