...
type DirectoryBrowseSection struct { 
	*ConfigurationSection
	...
	func NewDirectoryBrowseSectionEx1(instance *cim.WmiInstance) (newInstance *DirectoryBrowseSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DirectoryBrowseSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
