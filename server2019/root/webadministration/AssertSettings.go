...
type AssertSettings struct { 
	*EmbeddedObject
	...
	func NewAssertSettingsEx1(instance *cim.WmiInstance) (newInstance *AssertSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AssertSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
