...
type PeriodicRestartSettings struct { 
	*EmbeddedObject
	...
	func NewPeriodicRestartSettingsEx1(instance *cim.WmiInstance) (newInstance *PeriodicRestartSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PeriodicRestartSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
