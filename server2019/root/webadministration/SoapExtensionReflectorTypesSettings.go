...
type SoapExtensionReflectorTypesSettings struct { 
	*EmbeddedObject
	...
	func NewSoapExtensionReflectorTypesSettingsEx1(instance *cim.WmiInstance) (newInstance *SoapExtensionReflectorTypesSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SoapExtensionReflectorTypesSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
