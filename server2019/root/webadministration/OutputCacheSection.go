...
func NewOutputCacheSectionEx1(instance *cim.WmiInstance) (newInstance *OutputCacheSection, err error) {
...
func NewOutputCacheSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *OutputCacheSection, err error) {
