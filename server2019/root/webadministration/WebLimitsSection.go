...
type WebLimitsSection struct { 
	*ConfigurationSection
	...
	func NewWebLimitsSectionEx1(instance *cim.WmiInstance) (newInstance *WebLimitsSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebLimitsSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
