...
type IsapiCgiRestrictionElement struct { 
	*CollectionElement
	...
	func NewIsapiCgiRestrictionElementEx1(instance *cim.WmiInstance) (newInstance *IsapiCgiRestrictionElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IsapiCgiRestrictionElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
