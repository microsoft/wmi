...
type TraceSettings struct { 
	*EmbeddedObject
	...
	func NewTraceSettingsEx1(instance *cim.WmiInstance) (newInstance *TraceSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
