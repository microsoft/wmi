...
type FilteringRulesSettings struct { 
	*EmbeddedObject
	...
	func NewFilteringRulesSettingsEx1(instance *cim.WmiInstance) (newInstance *FilteringRulesSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FilteringRulesSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
