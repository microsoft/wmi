...
type SectionInformation struct { 
	*EmbeddedObject
	...
	func NewSectionInformationEx1(instance *cim.WmiInstance) (newInstance *SectionInformation, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SectionInformation, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
