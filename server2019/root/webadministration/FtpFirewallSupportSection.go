...
type FtpFirewallSupportSection struct { 
	*ConfigurationSection
	...
	func NewFtpFirewallSupportSectionEx1(instance *cim.WmiInstance) (newInstance *FtpFirewallSupportSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpFirewallSupportSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
