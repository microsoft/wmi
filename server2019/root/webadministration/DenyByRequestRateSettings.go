...
type DenyByRequestRateSettings struct { 
	*EmbeddedObject
	...
	func NewDenyByRequestRateSettingsEx1(instance *cim.WmiInstance) (newInstance *DenyByRequestRateSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DenyByRequestRateSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
