...
type ProfileSettings struct { 
	*EmbeddedObject
	...
	func NewProfileSettingsEx1(instance *cim.WmiInstance) (newInstance *ProfileSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProfileSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
