...
type HttpCookiesSection struct { 
	*ConfigurationSection
	...
	func NewHttpCookiesSectionEx1(instance *cim.WmiInstance) (newInstance *HttpCookiesSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpCookiesSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
