...
type SourceListenerSettings struct { 
	*EmbeddedObject
	...
	func NewSourceListenerSettingsEx1(instance *cim.WmiInstance) (newInstance *SourceListenerSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SourceListenerSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
