...
type IPSecuritySection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewIPSecuritySectionEx1(instance *cim.WmiInstance) (newInstance *IPSecuritySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IPSecuritySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
