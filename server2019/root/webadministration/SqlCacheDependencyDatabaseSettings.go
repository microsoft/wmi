...
type SqlCacheDependencyDatabaseSettings struct { 
	*EmbeddedObject
	...
	func NewSqlCacheDependencyDatabaseSettingsEx1(instance *cim.WmiInstance) (newInstance *SqlCacheDependencyDatabaseSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SqlCacheDependencyDatabaseSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
