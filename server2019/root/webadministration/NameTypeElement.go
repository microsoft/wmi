...
type NameTypeElement struct { 
	*CollectionElement
	...
	func NewNameTypeElementEx1(instance *cim.WmiInstance) (newInstance *NameTypeElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NameTypeElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
