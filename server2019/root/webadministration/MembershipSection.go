...
type MembershipSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewMembershipSectionEx1(instance *cim.WmiInstance) (newInstance *MembershipSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MembershipSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
