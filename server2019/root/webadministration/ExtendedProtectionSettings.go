...
type ExtendedProtectionSettings struct { 
	*EmbeddedObject
	...
	func NewExtendedProtectionSettingsEx1(instance *cim.WmiInstance) (newInstance *ExtendedProtectionSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ExtendedProtectionSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
