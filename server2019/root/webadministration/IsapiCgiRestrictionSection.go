...
type IsapiCgiRestrictionSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewIsapiCgiRestrictionSectionEx1(instance *cim.WmiInstance) (newInstance *IsapiCgiRestrictionSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IsapiCgiRestrictionSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
