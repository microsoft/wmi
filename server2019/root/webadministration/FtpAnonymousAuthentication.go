...
type FtpAnonymousAuthentication struct { 
	*EmbeddedObject
	...
	func NewFtpAnonymousAuthenticationEx1(instance *cim.WmiInstance) (newInstance *FtpAnonymousAuthentication, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpAnonymousAuthentication, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
