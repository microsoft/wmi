...
func NewWebServicesSectionEx1(instance *cim.WmiInstance) (newInstance *WebServicesSection, err error) {
...
func NewWebServicesSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WebServicesSection, err error) {
