...
type SchemaImporterExtensionsSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewSchemaImporterExtensionsSectionEx1(instance *cim.WmiInstance) (newInstance *SchemaImporterExtensionsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SchemaImporterExtensionsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
