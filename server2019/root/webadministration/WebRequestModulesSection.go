...
type WebRequestModulesSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewWebRequestModulesSectionEx1(instance *cim.WmiInstance) (newInstance *WebRequestModulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebRequestModulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
