...
type FullTrustAssembliesSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewFullTrustAssembliesSectionEx1(instance *cim.WmiInstance) (newInstance *FullTrustAssembliesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FullTrustAssembliesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
