...
type FtpCredentialsCacheElement struct { 
	*CollectionElement
	...
	func NewFtpCredentialsCacheElementEx1(instance *cim.WmiInstance) (newInstance *FtpCredentialsCacheElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpCredentialsCacheElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
