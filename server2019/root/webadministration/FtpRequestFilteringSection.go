...
type FtpRequestFilteringSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewFtpRequestFilteringSectionEx1(instance *cim.WmiInstance) (newInstance *FtpRequestFilteringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpRequestFilteringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
