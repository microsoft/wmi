...
type TagMapElement struct { 
	*CollectionElement
	...
	func NewTagMapElementEx1(instance *cim.WmiInstance) (newInstance *TagMapElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TagMapElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
