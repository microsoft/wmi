...
type BasicAuthenticationSection struct { 
	*ConfigurationSection
	...
	func NewBasicAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *BasicAuthenticationSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BasicAuthenticationSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
