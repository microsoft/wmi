...
type BufferModeSettings struct { 
	*EmbeddedObject
	...
	func NewBufferModeSettingsEx1(instance *cim.WmiInstance) (newInstance *BufferModeSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BufferModeSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
