...
type CachingProfileElement struct { 
	*CollectionElement
	...
	func NewCachingProfileElementEx1(instance *cim.WmiInstance) (newInstance *CachingProfileElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CachingProfileElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
