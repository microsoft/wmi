...
type WebDavAuthoringSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewWebDavAuthoringSectionEx1(instance *cim.WmiInstance) (newInstance *WebDavAuthoringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavAuthoringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
