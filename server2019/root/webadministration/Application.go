...
func NewApplicationEx1(instance *cim.WmiInstance) (newInstance *Application, err error) {
...
func NewApplicationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Application, err error) {
...
func (instance *Application) Create( /* IN */ ApplicationPath string,
	/* IN */ SiteName string,
	/* OPTIONAL IN */ PhysicalPath string) (err error) {
	_, err = instance.InvokeMethodWithReturn("Create", ApplicationPath, SiteName, PhysicalPath)
	if err != nil {
		return
	}
	return
...
func (instance *Application) RevertToParent( /* OPTIONAL IN */ PropertyName string) (err error) {
