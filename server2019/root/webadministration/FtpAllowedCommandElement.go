...
type FtpAllowedCommandElement struct { 
	*CollectionElement
	...
	func NewFtpAllowedCommandElementEx1(instance *cim.WmiInstance) (newInstance *FtpAllowedCommandElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpAllowedCommandElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
