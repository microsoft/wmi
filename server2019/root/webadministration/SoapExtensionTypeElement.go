...
type SoapExtensionTypeElement struct { 
	*CollectionElement
	...
	func NewSoapExtensionTypeElementEx1(instance *cim.WmiInstance) (newInstance *SoapExtensionTypeElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SoapExtensionTypeElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
