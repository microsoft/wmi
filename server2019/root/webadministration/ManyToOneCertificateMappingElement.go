...
type ManyToOneCertificateMappingElement struct { 
	*CollectionElement
	...
	func NewManyToOneCertificateMappingElementEx1(instance *cim.WmiInstance) (newInstance *ManyToOneCertificateMappingElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ManyToOneCertificateMappingElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
