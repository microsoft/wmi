...
type WebServicesProtocolElement struct { 
	*CollectionElement
	...
	func NewWebServicesProtocolElementEx1(instance *cim.WmiInstance) (newInstance *WebServicesProtocolElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebServicesProtocolElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
