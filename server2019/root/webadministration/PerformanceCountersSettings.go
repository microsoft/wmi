...
type PerformanceCountersSettings struct { 
	*EmbeddedObject
	...
	func NewPerformanceCountersSettingsEx1(instance *cim.WmiInstance) (newInstance *PerformanceCountersSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PerformanceCountersSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
