...
type HttpLoggingSection struct { 
	*ConfigurationSection
	...
	func NewHttpLoggingSectionEx1(instance *cim.WmiInstance) (newInstance *HttpLoggingSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpLoggingSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
