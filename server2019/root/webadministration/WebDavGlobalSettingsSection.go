...
type WebDavGlobalSettingsSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewWebDavGlobalSettingsSectionEx1(instance *cim.WmiInstance) (newInstance *WebDavGlobalSettingsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavGlobalSettingsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
