...
func NewSoapEnvelopeProcessingInfoEx1(instance *cim.WmiInstance) (newInstance *SoapEnvelopeProcessingInfo, err error) {
...
func NewSoapEnvelopeProcessingInfoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SoapEnvelopeProcessingInfo, err error) {
