...
type SwitchSettings struct { 
	*EmbeddedObject
	...
	func NewSwitchSettingsEx1(instance *cim.WmiInstance) (newInstance *SwitchSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SwitchSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
