...
type VerbElement struct { 
	*CollectionElement
	...
	func NewVerbElementEx1(instance *cim.WmiInstance) (newInstance *VerbElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VerbElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
