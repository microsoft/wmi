...
type IPAddressFilterElement struct { 
	*CollectionElement
	...
	func NewIPAddressFilterElementEx1(instance *cim.WmiInstance) (newInstance *IPAddressFilterElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IPAddressFilterElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
