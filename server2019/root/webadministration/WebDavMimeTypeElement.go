...
type WebDavMimeTypeElement struct { 
	*CollectionElement
	...
	func NewWebDavMimeTypeElementEx1(instance *cim.WmiInstance) (newInstance *WebDavMimeTypeElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavMimeTypeElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
