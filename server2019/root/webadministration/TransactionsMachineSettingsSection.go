...
type TransactionsMachineSettingsSection struct { 
	*ConfigurationSection
	...
	func NewTransactionsMachineSettingsSectionEx1(instance *cim.WmiInstance) (newInstance *TransactionsMachineSettingsSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TransactionsMachineSettingsSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
