...
type HostingEnvironmentSection struct { 
	*ConfigurationSection
	...
	func NewHostingEnvironmentSectionEx1(instance *cim.WmiInstance) (newInstance *HostingEnvironmentSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HostingEnvironmentSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
