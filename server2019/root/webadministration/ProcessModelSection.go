...
type ProcessModelSection struct { 
	*ConfigurationSection
	...
	func NewProcessModelSectionEx1(instance *cim.WmiInstance) (newInstance *ProcessModelSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessModelSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
