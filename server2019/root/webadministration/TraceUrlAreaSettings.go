...
type TraceUrlAreaSettings struct { 
	*EmbeddedObject
	...
	func NewTraceUrlAreaSettingsEx1(instance *cim.WmiInstance) (newInstance *TraceUrlAreaSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceUrlAreaSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
