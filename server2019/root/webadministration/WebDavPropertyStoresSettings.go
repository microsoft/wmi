...
func NewWebDavPropertyStoresSettingsEx1(instance *cim.WmiInstance) (newInstance *WebDavPropertyStoresSettings, err error) {
...
func NewWebDavPropertyStoresSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WebDavPropertyStoresSettings, err error) {
