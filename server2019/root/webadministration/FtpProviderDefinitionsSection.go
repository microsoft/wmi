...
type FtpProviderDefinitionsSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewFtpProviderDefinitionsSectionEx1(instance *cim.WmiInstance) (newInstance *FtpProviderDefinitionsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpProviderDefinitionsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
