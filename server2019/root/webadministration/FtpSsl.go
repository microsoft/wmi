...
type FtpSsl struct { 
	*EmbeddedObject
	...
	func NewFtpSslEx1(instance *cim.WmiInstance) (newInstance *FtpSsl, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpSsl, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
