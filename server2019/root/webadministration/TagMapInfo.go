...
type TagMapInfo struct { 
	*EmbeddedObject
	...
	func NewTagMapInfoEx1(instance *cim.WmiInstance) (newInstance *TagMapInfo, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TagMapInfo, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
