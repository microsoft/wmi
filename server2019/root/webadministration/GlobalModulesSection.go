...
type GlobalModulesSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewGlobalModulesSectionEx1(instance *cim.WmiInstance) (newInstance *GlobalModulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GlobalModulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
