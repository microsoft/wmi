...
type FtpIpSecuritySection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewFtpIpSecuritySectionEx1(instance *cim.WmiInstance) (newInstance *FtpIpSecuritySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpIpSecuritySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
