...
type AuthorizationRule struct { 
	*CollectionElement
	...
	func NewAuthorizationRuleEx1(instance *cim.WmiInstance) (newInstance *AuthorizationRule, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AuthorizationRule, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
