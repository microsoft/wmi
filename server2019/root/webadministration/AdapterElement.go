...
type AdapterElement struct { 
	*CollectionElement
	...
	func NewAdapterElementEx1(instance *cim.WmiInstance) (newInstance *AdapterElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AdapterElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
