...
type SessionPageStateSection struct { 
	*ConfigurationSection
	...
	func NewSessionPageStateSectionEx1(instance *cim.WmiInstance) (newInstance *SessionPageStateSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SessionPageStateSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
