...
type HttpTracingSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewHttpTracingSectionEx1(instance *cim.WmiInstance) (newInstance *HttpTracingSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpTracingSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
