...
type ModulesSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewModulesSectionEx1(instance *cim.WmiInstance) (newInstance *ModulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ModulesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
