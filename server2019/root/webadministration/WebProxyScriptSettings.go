...
type WebProxyScriptSettings struct { 
	*EmbeddedObject
	...
	func NewWebProxyScriptSettingsEx1(instance *cim.WmiInstance) (newInstance *WebProxyScriptSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebProxyScriptSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
