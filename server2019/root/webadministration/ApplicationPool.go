...
type ApplicationPool struct { 
	*Object
	...
	func NewApplicationPoolEx1(instance *cim.WmiInstance) (newInstance *ApplicationPool, err error) {tmp, err := NewObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ApplicationPool, err error) {tmp, err := NewObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *ApplicationPool) GetState() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("GetState" );
	if err != nil { return }
...
// 
func (instance *ApplicationPool) Start() (err error) {_, err = instance.InvokeMethodWithReturn("Start" );
	if err != nil { return }
	return
...
// 
func (instance *ApplicationPool) Stop() (err error) {_, err = instance.InvokeMethodWithReturn("Stop" );
	if err != nil { return }
	return
...
// 
func (instance *ApplicationPool) Recycle() (err error) {_, err = instance.InvokeMethodWithReturn("Recycle" );
	if err != nil { return }
	return
...
func (instance *ApplicationPool) GetApplicationPoolSid() (result string, err error) {retVal, err := instance.InvokeMethodWithReturn("GetApplicationPoolSid" );
	if err != nil { return }
...
func (instance *ApplicationPool) Create( /* IN */ Name string,
 /* OPTIONAL IN */ AutoStart bool) (err error) {_, err = instance.InvokeMethodWithReturn("Create" , Name, AutoStart);
	if err != nil { return }
	return
...
func (instance *ApplicationPool) RevertToParent( /* OPTIONAL IN */ PropertyName string) (err error) {_, err = instance.InvokeMethodWithReturn("RevertToParent" , PropertyName);
	if err != nil { return }
	return
