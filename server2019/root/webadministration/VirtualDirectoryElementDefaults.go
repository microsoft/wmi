...
type VirtualDirectoryElementDefaults struct { 
	*EmbeddedObject
	...
	func NewVirtualDirectoryElementDefaultsEx1(instance *cim.WmiInstance) (newInstance *VirtualDirectoryElementDefaults, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VirtualDirectoryElementDefaults, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
