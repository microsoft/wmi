...
type CachingSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewCachingSectionEx1(instance *cim.WmiInstance) (newInstance *CachingSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CachingSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
