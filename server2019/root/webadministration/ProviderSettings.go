...
func NewProviderSettingsEx1(instance *cim.WmiInstance) (newInstance *ProviderSettings, err error) {
...
func NewProviderSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ProviderSettings, err error) {
