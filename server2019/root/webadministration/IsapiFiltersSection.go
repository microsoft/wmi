...
type IsapiFiltersSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewIsapiFiltersSectionEx1(instance *cim.WmiInstance) (newInstance *IsapiFiltersSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IsapiFiltersSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
