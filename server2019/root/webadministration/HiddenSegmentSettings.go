...
type HiddenSegmentSettings struct { 
	*EmbeddedObject
	...
	func NewHiddenSegmentSettingsEx1(instance *cim.WmiInstance) (newInstance *HiddenSegmentSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HiddenSegmentSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
