...
type OdbcLoggingSection struct { 
	*ConfigurationSection
	...
	func NewOdbcLoggingSectionEx1(instance *cim.WmiInstance) (newInstance *OdbcLoggingSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *OdbcLoggingSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
