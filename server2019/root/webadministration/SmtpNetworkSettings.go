...
type SmtpNetworkSettings struct { 
	*EmbeddedObject
	...
	func NewSmtpNetworkSettingsEx1(instance *cim.WmiInstance) (newInstance *SmtpNetworkSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SmtpNetworkSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
