...
type TraceProviderDefinition struct { 
	*CollectionElement
	...
	func NewTraceProviderDefinitionEx1(instance *cim.WmiInstance) (newInstance *TraceProviderDefinition, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceProviderDefinition, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
