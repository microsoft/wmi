...
type Site struct { 
	*ConfiguredObject
	...
	func NewSiteEx1(instance *cim.WmiInstance) (newInstance *Site, err error) {tmp, err := NewConfiguredObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Site, err error) {tmp, err := NewConfiguredObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Site) RevertToParent( /* OPTIONAL IN */ PropertyName string) (err error) {_, err = instance.InvokeMethodWithReturn("RevertToParent" , PropertyName);
	if err != nil { return }
	return
...
func (instance *Site) GetState( /* OPTIONAL IN */ ProtocolName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("GetState" , ProtocolName);
	if err != nil { return }
...
// <param name="ProtocolName" type="string "></param>
func (instance *Site) Start( /* OPTIONAL IN */ ProtocolName string) (err error) {_, err = instance.InvokeMethodWithReturn("Start" , ProtocolName);
	if err != nil { return }
	return
...
// <param name="ProtocolName" type="string "></param>
func (instance *Site) Stop( /* OPTIONAL IN */ ProtocolName string) (err error) {_, err = instance.InvokeMethodWithReturn("Stop" , ProtocolName);
	if err != nil { return }
	return
...
func (instance *Site) Create( /* IN */ Name string,
 ...
 /* OPTIONAL IN */ ServerAutoStart bool) (err error) {_, err = instance.InvokeMethodWithReturn("Create" , Name, Bindings, PhysicalPath, ServerAutoStart);
	if err != nil { return }
	return
