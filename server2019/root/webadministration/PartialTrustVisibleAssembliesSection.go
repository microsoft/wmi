...
type PartialTrustVisibleAssembliesSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewPartialTrustVisibleAssembliesSectionEx1(instance *cim.WmiInstance) (newInstance *PartialTrustVisibleAssembliesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PartialTrustVisibleAssembliesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
