...
type CentralLogFileSettings struct { 
	*EmbeddedObject
	...
	func NewCentralLogFileSettingsEx1(instance *cim.WmiInstance) (newInstance *CentralLogFileSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CentralLogFileSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
