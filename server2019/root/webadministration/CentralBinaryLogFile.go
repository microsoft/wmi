...
type CentralBinaryLogFile struct { 
	*EmbeddedObject
	...
	func NewCentralBinaryLogFileEx1(instance *cim.WmiInstance) (newInstance *CentralBinaryLogFile, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CentralBinaryLogFile, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
