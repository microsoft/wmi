...
type TrustSection struct { 
	*ConfigurationSection
	...
	func NewTrustSectionEx1(instance *cim.WmiInstance) (newInstance *TrustSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TrustSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
