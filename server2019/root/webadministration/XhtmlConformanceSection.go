...
type XhtmlConformanceSection struct { 
	*ConfigurationSection
	...
	func NewXhtmlConformanceSectionEx1(instance *cim.WmiInstance) (newInstance *XhtmlConformanceSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *XhtmlConformanceSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
