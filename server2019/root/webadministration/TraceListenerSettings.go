...
type TraceListenerSettings struct { 
	*EmbeddedObject
	...
	func NewTraceListenerSettingsEx1(instance *cim.WmiInstance) (newInstance *TraceListenerSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceListenerSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
