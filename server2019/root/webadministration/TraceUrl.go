...
type TraceUrl struct { 
	*CollectionElement
	...
	func NewTraceUrlEx1(instance *cim.WmiInstance) (newInstance *TraceUrl, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceUrl, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
