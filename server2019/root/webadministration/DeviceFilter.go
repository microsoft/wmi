...
type DeviceFilter struct { 
	*CollectionElement
	...
	func NewDeviceFilterEx1(instance *cim.WmiInstance) (newInstance *DeviceFilter, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DeviceFilter, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
