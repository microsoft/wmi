...
type GlobalizationSection struct { 
	*ConfigurationSection
	...
	func NewGlobalizationSectionEx1(instance *cim.WmiInstance) (newInstance *GlobalizationSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GlobalizationSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
