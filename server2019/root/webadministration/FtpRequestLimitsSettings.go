...
type FtpRequestLimitsSettings struct { 
	*EmbeddedObject
	...
	func NewFtpRequestLimitsSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpRequestLimitsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpRequestLimitsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
