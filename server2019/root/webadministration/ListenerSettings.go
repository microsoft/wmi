...
type ListenerSettings struct { 
	*EmbeddedObject
	...
	func NewListenerSettingsEx1(instance *cim.WmiInstance) (newInstance *ListenerSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ListenerSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
