...
type ServerSideIncludeSection struct { 
	*ConfigurationSection
	...
	func NewServerSideIncludeSectionEx1(instance *cim.WmiInstance) (newInstance *ServerSideIncludeSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServerSideIncludeSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
