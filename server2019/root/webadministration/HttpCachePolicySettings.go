...
type HttpCachePolicySettings struct { 
	*EmbeddedObject
	...
	func NewHttpCachePolicySettingsEx1(instance *cim.WmiInstance) (newInstance *HttpCachePolicySettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpCachePolicySettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
