...
type ProvidersSettings struct { 
	*EmbeddedObject
	...
	func NewProvidersSettingsEx1(instance *cim.WmiInstance) (newInstance *ProvidersSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProvidersSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
