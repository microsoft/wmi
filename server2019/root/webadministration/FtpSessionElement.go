...
type FtpSessionElement struct { 
	*CollectionElement
	...
	func NewFtpSessionElementEx1(instance *cim.WmiInstance) (newInstance *FtpSessionElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpSessionElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
