...
type ObjectContainerAssociation struct { 
	*cim.WmiInstance
	...
	func NewObjectContainerAssociationEx1(instance *cim.WmiInstance) (newInstance *ObjectContainerAssociation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ObjectContainerAssociation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
