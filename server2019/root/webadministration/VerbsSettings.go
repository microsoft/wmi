...
type VerbsSettings struct { 
	*EmbeddedObject
	...
	func NewVerbsSettingsEx1(instance *cim.WmiInstance) (newInstance *VerbsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VerbsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
