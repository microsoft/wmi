...
type ApplicationPoolProcessorSettings struct { 
	*EmbeddedObject
	...
	func NewApplicationPoolProcessorSettingsEx1(instance *cim.WmiInstance) (newInstance *ApplicationPoolProcessorSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ApplicationPoolProcessorSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
