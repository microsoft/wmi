...
type WebDavPropertiesSettings struct { 
	*EmbeddedObject
	...
	func NewWebDavPropertiesSettingsEx1(instance *cim.WmiInstance) (newInstance *WebDavPropertiesSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavPropertiesSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
