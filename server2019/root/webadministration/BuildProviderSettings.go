...
type BuildProviderSettings struct { 
	*EmbeddedObject
	...
	func NewBuildProviderSettingsEx1(instance *cim.WmiInstance) (newInstance *BuildProviderSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BuildProviderSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
