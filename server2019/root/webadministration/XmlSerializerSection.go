...
type XmlSerializerSection struct { 
	*ConfigurationSection
	...
	func NewXmlSerializerSectionEx1(instance *cim.WmiInstance) (newInstance *XmlSerializerSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *XmlSerializerSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
