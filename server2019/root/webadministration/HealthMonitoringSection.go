...
type HealthMonitoringSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewHealthMonitoringSectionEx1(instance *cim.WmiInstance) (newInstance *HealthMonitoringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HealthMonitoringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
