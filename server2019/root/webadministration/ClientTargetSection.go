...
type ClientTargetSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewClientTargetSectionEx1(instance *cim.WmiInstance) (newInstance *ClientTargetSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClientTargetSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
