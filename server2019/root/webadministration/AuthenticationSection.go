...
type AuthenticationSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *AuthenticationSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AuthenticationSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
