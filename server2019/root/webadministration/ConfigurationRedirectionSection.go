...
type ConfigurationRedirectionSection struct { 
	*ConfigurationSection
	...
	func NewConfigurationRedirectionSectionEx1(instance *cim.WmiInstance) (newInstance *ConfigurationRedirectionSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ConfigurationRedirectionSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
