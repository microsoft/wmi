...
type ProcessModelSettings struct { 
	*EmbeddedObject
	...
	func NewProcessModelSettingsEx1(instance *cim.WmiInstance) (newInstance *ProcessModelSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessModelSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
