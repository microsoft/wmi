...
type FtpDirectoryBrowse struct { 
	*EmbeddedObject
	...
	func NewFtpDirectoryBrowseEx1(instance *cim.WmiInstance) (newInstance *FtpDirectoryBrowse, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpDirectoryBrowse, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
