...
type AspSection struct { 
	*ConfigurationSection
	...
	func NewAspSectionEx1(instance *cim.WmiInstance) (newInstance *AspSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AspSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
