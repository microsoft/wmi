...
type FtpCredentialsCacheSettings struct { 
	*EmbeddedObject
	...
	func NewFtpCredentialsCacheSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpCredentialsCacheSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpCredentialsCacheSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
