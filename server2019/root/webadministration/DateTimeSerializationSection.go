...
type DateTimeSerializationSection struct { 
	*ConfigurationSection
	...
	func NewDateTimeSerializationSectionEx1(instance *cim.WmiInstance) (newInstance *DateTimeSerializationSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DateTimeSerializationSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
