...
type WebDavLocksSettings struct { 
	*EmbeddedObject
	...
	func NewWebDavLocksSettingsEx1(instance *cim.WmiInstance) (newInstance *WebDavLocksSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavLocksSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
