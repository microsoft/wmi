...
type FtpClientCertAuthentication struct { 
	*EmbeddedObject
	...
	func NewFtpClientCertAuthenticationEx1(instance *cim.WmiInstance) (newInstance *FtpClientCertAuthentication, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpClientCertAuthentication, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
