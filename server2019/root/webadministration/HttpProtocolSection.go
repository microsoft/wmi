...
type HttpProtocolSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewHttpProtocolSectionEx1(instance *cim.WmiInstance) (newInstance *HttpProtocolSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpProtocolSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
