...
type TraceProviderDefinitionsSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewTraceProviderDefinitionsSectionEx1(instance *cim.WmiInstance) (newInstance *TraceProviderDefinitionsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceProviderDefinitionsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
