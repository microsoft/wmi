...
type SoapExtensionTypesInfo struct { 
	*EmbeddedObject
	...
	func NewSoapExtensionTypesInfoEx1(instance *cim.WmiInstance) (newInstance *SoapExtensionTypesInfo, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SoapExtensionTypesInfo, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
