...
type ListenerElement struct { 
	*TypedElement
	...
	func NewListenerElementEx1(instance *cim.WmiInstance) (newInstance *ListenerElement, err error) {tmp, err := NewTypedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ListenerElement, err error) {tmp, err := NewTypedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
