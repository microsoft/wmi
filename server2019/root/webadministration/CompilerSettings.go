...
type CompilerSettings struct { 
	*EmbeddedObject
	...
	func NewCompilerSettingsEx1(instance *cim.WmiInstance) (newInstance *CompilerSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CompilerSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
