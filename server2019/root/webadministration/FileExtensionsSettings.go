...
type FileExtensionsSettings struct { 
	*EmbeddedObject
	...
	func NewFileExtensionsSettingsEx1(instance *cim.WmiInstance) (newInstance *FileExtensionsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileExtensionsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
