...
type CachingProfileSettings struct { 
	*EmbeddedObject
	...
	func NewCachingProfileSettingsEx1(instance *cim.WmiInstance) (newInstance *CachingProfileSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CachingProfileSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
