...
type SiteElementDefaults struct { 
	*EmbeddedObject
	...
	func NewSiteElementDefaultsEx1(instance *cim.WmiInstance) (newInstance *SiteElementDefaults, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SiteElementDefaults, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
