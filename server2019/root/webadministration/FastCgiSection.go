...
type FastCgiSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewFastCgiSectionEx1(instance *cim.WmiInstance) (newInstance *FastCgiSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FastCgiSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
