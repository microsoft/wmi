...
type AppInitApps struct { 
	*CollectionElement
	...
	func NewAppInitAppsEx1(instance *cim.WmiInstance) (newInstance *AppInitApps, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AppInitApps, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
