...
type CompilationSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewCompilationSectionEx1(instance *cim.WmiInstance) (newInstance *CompilationSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CompilationSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
