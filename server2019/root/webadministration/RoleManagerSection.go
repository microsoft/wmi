...
type RoleManagerSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewRoleManagerSectionEx1(instance *cim.WmiInstance) (newInstance *RoleManagerSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RoleManagerSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
