...
type AssemblyElement struct { 
	*CollectionElement
	...
	func NewAssemblyElementEx1(instance *cim.WmiInstance) (newInstance *AssemblyElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AssemblyElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
