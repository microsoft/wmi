...
type AuthenticationModuleElement struct { 
	*CollectionElement
	...
	func NewAuthenticationModuleElementEx1(instance *cim.WmiInstance) (newInstance *AuthenticationModuleElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AuthenticationModuleElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
