...
type FtpAuthorizationRule struct { 
	*CollectionElement
	...
	func NewFtpAuthorizationRuleEx1(instance *cim.WmiInstance) (newInstance *FtpAuthorizationRule, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpAuthorizationRule, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
