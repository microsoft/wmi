...
type ApplicationPoolElementDefaults struct { 
	*EmbeddedObject
	...
	func NewApplicationPoolElementDefaultsEx1(instance *cim.WmiInstance) (newInstance *ApplicationPoolElementDefaults, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ApplicationPoolElementDefaults, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
