...
type DirectorySettings struct { 
	*EmbeddedObject
	...
	func NewDirectorySettingsEx1(instance *cim.WmiInstance) (newInstance *DirectorySettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DirectorySettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
