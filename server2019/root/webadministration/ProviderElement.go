...
type ProviderElement struct { 
	*CollectionElement
	...
	func NewProviderElementEx1(instance *cim.WmiInstance) (newInstance *ProviderElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProviderElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
