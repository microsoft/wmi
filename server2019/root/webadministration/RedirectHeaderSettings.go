...
type RedirectHeaderSettings struct { 
	*EmbeddedObject
	...
	func NewRedirectHeaderSettingsEx1(instance *cim.WmiInstance) (newInstance *RedirectHeaderSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RedirectHeaderSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
