...
type IsapiFilterElement struct { 
	*CollectionElement
	...
	func NewIsapiFilterElementEx1(instance *cim.WmiInstance) (newInstance *IsapiFilterElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IsapiFilterElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
