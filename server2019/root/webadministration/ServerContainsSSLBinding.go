...
func NewServerContainsSSLBindingEx1(instance *cim.WmiInstance) (newInstance *ServerContainsSSLBinding, err error) {
...
func NewServerContainsSSLBindingEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ServerContainsSSLBinding, err error) {
