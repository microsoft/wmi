...
type FtpCachingSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewFtpCachingSectionEx1(instance *cim.WmiInstance) (newInstance *FtpCachingSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpCachingSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
