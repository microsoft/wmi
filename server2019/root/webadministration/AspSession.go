...
type AspSession struct { 
	*EmbeddedObject
	...
	func NewAspSessionEx1(instance *cim.WmiInstance) (newInstance *AspSession, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AspSession, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
