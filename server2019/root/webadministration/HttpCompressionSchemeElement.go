...
type HttpCompressionSchemeElement struct { 
	*CollectionElement
	...
	func NewHttpCompressionSchemeElementEx1(instance *cim.WmiInstance) (newInstance *HttpCompressionSchemeElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpCompressionSchemeElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
