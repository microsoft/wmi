...
type DenyQueryStringSequenceSettings struct { 
	*EmbeddedObject
	...
	func NewDenyQueryStringSequenceSettingsEx1(instance *cim.WmiInstance) (newInstance *DenyQueryStringSequenceSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DenyQueryStringSequenceSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
