...
type WebControlsSection struct { 
	*ConfigurationSection
	...
	func NewWebControlsSectionEx1(instance *cim.WmiInstance) (newInstance *WebControlsSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebControlsSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
