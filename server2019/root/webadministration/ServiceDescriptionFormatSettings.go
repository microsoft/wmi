...
type ServiceDescriptionFormatSettings struct { 
	*EmbeddedObject
	...
	func NewServiceDescriptionFormatSettingsEx1(instance *cim.WmiInstance) (newInstance *ServiceDescriptionFormatSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceDescriptionFormatSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
