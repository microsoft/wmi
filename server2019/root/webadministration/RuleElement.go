...
type RuleElement struct { 
	*CollectionElement
	...
	func NewRuleElementEx1(instance *cim.WmiInstance) (newInstance *RuleElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RuleElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
