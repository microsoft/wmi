...
type ExpressionBuilderSettings struct { 
	*EmbeddedObject
	...
	func NewExpressionBuilderSettingsEx1(instance *cim.WmiInstance) (newInstance *ExpressionBuilderSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ExpressionBuilderSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
