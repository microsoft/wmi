...
type FtpFileExtensionsSettings struct { 
	*EmbeddedObject
	...
	func NewFtpFileExtensionsSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpFileExtensionsSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpFileExtensionsSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
