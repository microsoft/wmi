...
type HttpHandlerAction struct { 
	*CollectionElement
	...
	func NewHttpHandlerActionEx1(instance *cim.WmiInstance) (newInstance *HttpHandlerAction, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpHandlerAction, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
