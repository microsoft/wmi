...
type MachineKeySection struct { 
	*ConfigurationSection
	...
	func NewMachineKeySectionEx1(instance *cim.WmiInstance) (newInstance *MachineKeySection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MachineKeySection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
