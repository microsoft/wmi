...
type FtpDenyByFailureSettings struct { 
	*EmbeddedObject
	...
	func NewFtpDenyByFailureSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpDenyByFailureSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpDenyByFailureSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
