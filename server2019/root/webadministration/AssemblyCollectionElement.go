...
type AssemblyCollectionElement struct { 
	*CollectionElement
	...
	func NewAssemblyCollectionElementEx1(instance *cim.WmiInstance) (newInstance *AssemblyCollectionElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AssemblyCollectionElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
