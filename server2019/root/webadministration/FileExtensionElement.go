...
type FileExtensionElement struct { 
	*CollectionElement
	...
	func NewFileExtensionElementEx1(instance *cim.WmiInstance) (newInstance *FileExtensionElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileExtensionElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
