...
type HttpCompressionSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewHttpCompressionSectionEx1(instance *cim.WmiInstance) (newInstance *HttpCompressionSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpCompressionSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
