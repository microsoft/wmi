...
type FtpLogSection struct { 
	*ConfigurationSection
	...
	func NewFtpLogSectionEx1(instance *cim.WmiInstance) (newInstance *FtpLogSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpLogSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
