...
type BypassElement struct { 
	*CollectionElement
	...
	func NewBypassElementEx1(instance *cim.WmiInstance) (newInstance *BypassElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BypassElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
