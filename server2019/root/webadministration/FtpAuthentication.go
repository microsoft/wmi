...
type FtpAuthentication struct { 
	*EmbeddedObject
	...
	func NewFtpAuthenticationEx1(instance *cim.WmiInstance) (newInstance *FtpAuthentication, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpAuthentication, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
