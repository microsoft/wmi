...
type SecurityPolicySection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewSecurityPolicySectionEx1(instance *cim.WmiInstance) (newInstance *SecurityPolicySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SecurityPolicySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
