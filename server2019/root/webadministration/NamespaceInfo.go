...
type NamespaceInfo struct { 
	*EmbeddedObject
	...
	func NewNamespaceInfoEx1(instance *cim.WmiInstance) (newInstance *NamespaceInfo, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NamespaceInfo, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
