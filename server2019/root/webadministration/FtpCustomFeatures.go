...
type FtpCustomFeatures struct { 
	*EmbeddedObject
	...
	func NewFtpCustomFeaturesEx1(instance *cim.WmiInstance) (newInstance *FtpCustomFeatures, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpCustomFeatures, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
