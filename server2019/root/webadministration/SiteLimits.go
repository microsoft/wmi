...
type SiteLimits struct { 
	*EmbeddedObject
	...
	func NewSiteLimitsEx1(instance *cim.WmiInstance) (newInstance *SiteLimits, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SiteLimits, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
