...
type OutputCacheProfileSettings struct { 
	*EmbeddedObject
	...
	func NewOutputCacheProfileSettingsEx1(instance *cim.WmiInstance) (newInstance *OutputCacheProfileSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *OutputCacheProfileSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
