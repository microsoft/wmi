...
type ConnectionStringSettings struct { 
	*CollectionElement
	...
	func NewConnectionStringSettingsEx1(instance *cim.WmiInstance) (newInstance *ConnectionStringSettings, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ConnectionStringSettings, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
