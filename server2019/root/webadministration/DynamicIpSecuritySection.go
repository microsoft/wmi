...
type DynamicIpSecuritySection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewDynamicIpSecuritySectionEx1(instance *cim.WmiInstance) (newInstance *DynamicIpSecuritySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DynamicIpSecuritySection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
