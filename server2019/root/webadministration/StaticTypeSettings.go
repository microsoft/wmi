...
func NewStaticTypeSettingsEx1(instance *cim.WmiInstance) (newInstance *StaticTypeSettings, err error) {
...
func NewStaticTypeSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *StaticTypeSettings, err error) {
