...
type StaticContentSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewStaticContentSectionEx1(instance *cim.WmiInstance) (newInstance *StaticContentSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *StaticContentSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
