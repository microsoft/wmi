...
type AssemblySettings struct { 
	*EmbeddedObject
	...
	func NewAssemblySettingsEx1(instance *cim.WmiInstance) (newInstance *AssemblySettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AssemblySettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
