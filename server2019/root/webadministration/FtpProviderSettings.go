...
type FtpProviderSettings struct { 
	*EmbeddedObject
	...
	func NewFtpProviderSettingsEx1(instance *cim.WmiInstance) (newInstance *FtpProviderSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpProviderSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
