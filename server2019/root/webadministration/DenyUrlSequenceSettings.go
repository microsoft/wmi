...
type DenyUrlSequenceSettings struct { 
	*EmbeddedObject
	...
	func NewDenyUrlSequenceSettingsEx1(instance *cim.WmiInstance) (newInstance *DenyUrlSequenceSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DenyUrlSequenceSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
