...
type SystemCodeDomSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewSystemCodeDomSectionEx1(instance *cim.WmiInstance) (newInstance *SystemCodeDomSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemCodeDomSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
