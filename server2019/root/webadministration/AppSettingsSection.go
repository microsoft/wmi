...
type AppSettingsSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewAppSettingsSectionEx1(instance *cim.WmiInstance) (newInstance *AppSettingsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AppSettingsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
