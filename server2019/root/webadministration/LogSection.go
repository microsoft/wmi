...
type LogSection struct { 
	*ConfigurationSection
	...
	func NewLogSectionEx1(instance *cim.WmiInstance) (newInstance *LogSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LogSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
