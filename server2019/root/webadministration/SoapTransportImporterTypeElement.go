...
type SoapTransportImporterTypeElement struct { 
	*CollectionElement
	...
	func NewSoapTransportImporterTypeElementEx1(instance *cim.WmiInstance) (newInstance *SoapTransportImporterTypeElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SoapTransportImporterTypeElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
