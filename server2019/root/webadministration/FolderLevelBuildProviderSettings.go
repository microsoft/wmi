...
type FolderLevelBuildProviderSettings struct { 
	*EmbeddedObject
	...
	func NewFolderLevelBuildProviderSettingsEx1(instance *cim.WmiInstance) (newInstance *FolderLevelBuildProviderSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FolderLevelBuildProviderSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
