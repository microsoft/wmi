...
type FtpCustomAuthentication struct { 
	*EmbeddedObject
	...
	func NewFtpCustomAuthenticationEx1(instance *cim.WmiInstance) (newInstance *FtpCustomAuthentication, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpCustomAuthentication, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
