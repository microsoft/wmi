...
type DeviceFiltersSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewDeviceFiltersSectionEx1(instance *cim.WmiInstance) (newInstance *DeviceFiltersSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DeviceFiltersSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
