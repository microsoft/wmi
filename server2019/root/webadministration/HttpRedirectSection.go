...
type HttpRedirectSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewHttpRedirectSectionEx1(instance *cim.WmiInstance) (newInstance *HttpRedirectSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpRedirectSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
