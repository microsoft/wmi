...
type MobileControlsSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewMobileControlsSectionEx1(instance *cim.WmiInstance) (newInstance *MobileControlsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MobileControlsSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
