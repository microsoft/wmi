...
type SegmentElement struct { 
	*CollectionElement
	...
	func NewSegmentElementEx1(instance *cim.WmiInstance) (newInstance *SegmentElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SegmentElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
