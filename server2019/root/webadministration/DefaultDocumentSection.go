...
type DefaultDocumentSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewDefaultDocumentSectionEx1(instance *cim.WmiInstance) (newInstance *DefaultDocumentSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DefaultDocumentSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
