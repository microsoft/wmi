...
type TraceAreaElement struct { 
	*CollectionElement
	...
	func NewTraceAreaElementEx1(instance *cim.WmiInstance) (newInstance *TraceAreaElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceAreaElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
