...
type RequestFilteringSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewRequestFilteringSectionEx1(instance *cim.WmiInstance) (newInstance *RequestFilteringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RequestFilteringSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
