...
type DigestAuthenticationSection struct { 
	*ConfigurationSection
	...
	func NewDigestAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *DigestAuthenticationSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DigestAuthenticationSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
