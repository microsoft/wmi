...
type TypedElement struct { 
	*EmbeddedObject
	...
	func NewTypedElementEx1(instance *cim.WmiInstance) (newInstance *TypedElement, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TypedElement, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
