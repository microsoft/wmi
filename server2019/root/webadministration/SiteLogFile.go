...
type SiteLogFile struct { 
	*EmbeddedObject
	...
	func NewSiteLogFileEx1(instance *cim.WmiInstance) (newInstance *SiteLogFile, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SiteLogFile, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
