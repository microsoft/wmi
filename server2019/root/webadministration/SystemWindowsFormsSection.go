...
type SystemWindowsFormsSection struct { 
	*ConfigurationSection
	...
	func NewSystemWindowsFormsSectionEx1(instance *cim.WmiInstance) (newInstance *SystemWindowsFormsSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemWindowsFormsSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
