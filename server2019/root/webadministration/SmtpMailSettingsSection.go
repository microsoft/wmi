...
type SmtpMailSettingsSection struct { 
	*ConfigurationSection
	...
	func NewSmtpMailSettingsSectionEx1(instance *cim.WmiInstance) (newInstance *SmtpMailSettingsSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SmtpMailSettingsSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
