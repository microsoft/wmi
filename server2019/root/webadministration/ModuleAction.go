...
type ModuleAction struct { 
	*CollectionElement
	...
	func NewModuleActionEx1(instance *cim.WmiInstance) (newInstance *ModuleAction, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ModuleAction, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
