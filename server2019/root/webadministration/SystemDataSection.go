...
type SystemDataSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewSystemDataSectionEx1(instance *cim.WmiInstance) (newInstance *SystemDataSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemDataSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
