...
type FtpMessages struct { 
	*EmbeddedObject
	...
	func NewFtpMessagesEx1(instance *cim.WmiInstance) (newInstance *FtpMessages, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpMessages, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
