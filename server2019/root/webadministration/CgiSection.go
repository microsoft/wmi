...
type CgiSection struct { 
	*ConfigurationSection
	...
	func NewCgiSectionEx1(instance *cim.WmiInstance) (newInstance *CgiSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CgiSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
