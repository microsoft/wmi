...
type RuleSettings struct { 
	*EmbeddedObject
	...
	func NewRuleSettingsEx1(instance *cim.WmiInstance) (newInstance *RuleSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RuleSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
