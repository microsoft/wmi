...
type UrlCompressionSection struct { 
	*ConfigurationSection
	...
	func NewUrlCompressionSectionEx1(instance *cim.WmiInstance) (newInstance *UrlCompressionSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UrlCompressionSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
