...
type FtpLogFile struct { 
	*EmbeddedObject
	...
	func NewFtpLogFileEx1(instance *cim.WmiInstance) (newInstance *FtpLogFile, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FtpLogFile, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
