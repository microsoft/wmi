...
type SiteMapSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewSiteMapSectionEx1(instance *cim.WmiInstance) (newInstance *SiteMapSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SiteMapSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
