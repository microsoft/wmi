...
type AspCache struct { 
	*EmbeddedObject
	...
	func NewAspCacheEx1(instance *cim.WmiInstance) (newInstance *AspCache, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AspCache, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
