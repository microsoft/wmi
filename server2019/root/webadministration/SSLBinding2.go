...
type SSLBinding2 struct { 
	*Object
	...
	func NewSSLBinding2Ex1(instance *cim.WmiInstance) (newInstance *SSLBinding2, err error) {tmp, err := NewObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SSLBinding2, err error) {tmp, err := NewObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SSLBinding2) Create( /* IN */ IPAddress string,
 ...
 /* IN */ StoreName string,
 /* IN */ HostName string) (err error) {_, err = instance.InvokeMethodWithReturn("Create" , IPAddress, Port, CertificateHash, StoreName, HostName);
	if err != nil { return }
	return
