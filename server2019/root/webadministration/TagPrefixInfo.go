...
type TagPrefixInfo struct { 
	*EmbeddedObject
	...
	func NewTagPrefixInfoEx1(instance *cim.WmiInstance) (newInstance *TagPrefixInfo, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TagPrefixInfo, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
