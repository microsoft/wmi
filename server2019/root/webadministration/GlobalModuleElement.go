...
type GlobalModuleElement struct { 
	*CollectionElement
	...
	func NewGlobalModuleElementEx1(instance *cim.WmiInstance) (newInstance *GlobalModuleElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GlobalModuleElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
