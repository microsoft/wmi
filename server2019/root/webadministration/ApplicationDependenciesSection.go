...
type ApplicationDependenciesSection struct { 
	*ConfigurationSectionWithCollection
	...
	func NewApplicationDependenciesSectionEx1(instance *cim.WmiInstance) (newInstance *ApplicationDependenciesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ApplicationDependenciesSection, err error) {tmp, err := NewConfigurationSectionWithCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
