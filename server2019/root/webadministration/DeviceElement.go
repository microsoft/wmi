...
type DeviceElement struct { 
	*CollectionElement
	...
	func NewDeviceElementEx1(instance *cim.WmiInstance) (newInstance *DeviceElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DeviceElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
