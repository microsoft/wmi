...
func NewOutputCacheProfileEx1(instance *cim.WmiInstance) (newInstance *OutputCacheProfile, err error) {
...
func NewOutputCacheProfileEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *OutputCacheProfile, err error) {
