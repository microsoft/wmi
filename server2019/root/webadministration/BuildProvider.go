...
type BuildProvider struct { 
	*CollectionElement
	...
	func NewBuildProviderEx1(instance *cim.WmiInstance) (newInstance *BuildProvider, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BuildProvider, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
