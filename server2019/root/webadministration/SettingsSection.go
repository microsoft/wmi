...
type SettingsSection struct { 
	*ConfigurationSection
	...
	func NewSettingsSectionEx1(instance *cim.WmiInstance) (newInstance *SettingsSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SettingsSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
