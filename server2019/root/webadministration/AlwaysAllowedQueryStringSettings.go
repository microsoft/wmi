...
type AlwaysAllowedQueryStringSettings struct { 
	*EmbeddedObject
	...
	func NewAlwaysAllowedQueryStringSettingsEx1(instance *cim.WmiInstance) (newInstance *AlwaysAllowedQueryStringSettings, err error) {tmp, err := NewEmbeddedObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AlwaysAllowedQueryStringSettings, err error) {tmp, err := NewEmbeddedObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
