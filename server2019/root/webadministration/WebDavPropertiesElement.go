...
type WebDavPropertiesElement struct { 
	*CollectionElement
	...
	func NewWebDavPropertiesElementEx1(instance *cim.WmiInstance) (newInstance *WebDavPropertiesElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebDavPropertiesElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
