...
func NewSiteContainsConfigurationSectionEx1(instance *cim.WmiInstance) (newInstance *SiteContainsConfigurationSection, err error) {
...
func NewSiteContainsConfigurationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SiteContainsConfigurationSection, err error) {
