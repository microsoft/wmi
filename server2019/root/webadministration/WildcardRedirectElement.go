...
type WildcardRedirectElement struct { 
	*CollectionElement
	...
	func NewWildcardRedirectElementEx1(instance *cim.WmiInstance) (newInstance *WildcardRedirectElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WildcardRedirectElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
