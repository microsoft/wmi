...
func NewDefaultProxySectionEx1(instance *cim.WmiInstance) (newInstance *DefaultProxySection, err error) {
...
func NewDefaultProxySectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DefaultProxySection, err error) {
