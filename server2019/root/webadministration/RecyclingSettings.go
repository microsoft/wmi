...
func NewRecyclingSettingsEx1(instance *cim.WmiInstance) (newInstance *RecyclingSettings, err error) {
...
func NewRecyclingSettingsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RecyclingSettings, err error) {
