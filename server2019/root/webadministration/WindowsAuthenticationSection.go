...
func NewWindowsAuthenticationSectionEx1(instance *cim.WmiInstance) (newInstance *WindowsAuthenticationSection, err error) {
...
func NewWindowsAuthenticationSectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WindowsAuthenticationSection, err error) {
