...
type AccessSection struct { 
	*ConfigurationSection
	...
	func NewAccessSectionEx1(instance *cim.WmiInstance) (newInstance *AccessSection, err error) {tmp, err := NewConfigurationSectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AccessSection, err error) {tmp, err := NewConfigurationSectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
