...
type NamespaceElement struct { 
	*CollectionElement
	...
	func NewNamespaceElementEx1(instance *cim.WmiInstance) (newInstance *NamespaceElement, err error) {tmp, err := NewCollectionElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NamespaceElement, err error) {tmp, err := NewCollectionElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
