...
type MSCluster_ResourceGroup struct { 
	*MSCluster_LogicalElement
	...
	func NewMSCluster_ResourceGroupEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ResourceGroup, err error) {tmp, err := NewMSCluster_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ResourceGroup, err error) {tmp, err := NewMSCluster_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_ResourceGroup) BringOnline( /* IN */ TimeOut uint32,
 /* IN */ Flags uint32,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("BringOnline" , TimeOut, Flags, Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) MoveToNewNode( /* IN */ NodeName string,
 /* IN */ TimeOut uint32) (err error) {_, err = instance.InvokeMethodWithReturn("MoveToNewNode" , NodeName, TimeOut);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) MoveToNewNodeEx( /* IN */ NodeName string,
 /* IN */ Parameters MSCluster_Property,
 /* IN */ Flags uint32,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("MoveToNewNodeEx" , NodeName, Parameters, Flags, Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) MoveToNewNodeParams( /* IN */ NodeName string,
 /* IN */ Parameters []uint8,
 /* IN */ Flags uint32,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("MoveToNewNodeParams" , NodeName, Parameters, Flags, Reason);
	if err != nil { return }
	return
...
// <param name="Flags" type="uint32 "></param>
func (instance *MSCluster_ResourceGroup) CancelOperation( /* IN */ Flags uint32) (err error) {_, err = instance.InvokeMethodWithReturn("CancelOperation" , Flags);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) CreateGroup( /* IN */ GroupName string,
 /* IN */ GroupType uint32,
 /* IN/OUT */ Id string) (err error) {_, err = instance.InvokeMethod("CreateGroup" , GroupName, GroupType)
	if err != nil { return }
	return
...
// <param name="Reason" type="string "></param>
func (instance *MSCluster_ResourceGroup) DeleteGroup( /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("DeleteGroup" , Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) DestroyGroup( /* IN */ Options uint32,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("DestroyGroup" , Options, Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) SetPreferredOwners( /* IN */ NodeNames []string,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("SetPreferredOwners" , NodeNames, Reason);
	if err != nil { return }
	return
...
// <param name="NodeNames" type="string []"></param>
func (instance *MSCluster_ResourceGroup) GetPreferredOwners( /* OUT */ NodeNames []string) (err error) {_, err = instance.InvokeMethod("GetPreferredOwners" )
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) GetGroupType() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("GetGroupType" );
	if err != nil { return }
...
// <param name="GroupType" type="uint32 "></param>
func (instance *MSCluster_ResourceGroup) SetGroupType( /* IN */ GroupType uint32) (err error) {_, err = instance.InvokeMethodWithReturn("SetGroupType" , GroupType);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceGroup) ExecuteGroupControl( /* IN */ ControlCode int32,
 ...
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethod("ExecuteGroupControl" , ControlCode, InputBuffer, Reason)
	if err != nil { return }
	return
