...
type MSCluster_ClusterDiskPartition struct { 
	*MSCluster_LogicalElement
	...
	func NewMSCluster_ClusterDiskPartitionEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ClusterDiskPartition, err error) {tmp, err := NewMSCluster_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ClusterDiskPartition, err error) {tmp, err := NewMSCluster_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
