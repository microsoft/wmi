...
type MSCluster_EventClusterCallback struct { 
	*MSCluster_Event
	...
	func NewMSCluster_EventClusterCallbackEx1(instance *cim.WmiInstance) (newInstance *MSCluster_EventClusterCallback, err error) {tmp, err := NewMSCluster_EventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_EventClusterCallback, err error) {tmp, err := NewMSCluster_EventEx6(hostName, wmiNamespace, userName, password, domainName, query)
