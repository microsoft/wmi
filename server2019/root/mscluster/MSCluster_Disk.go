...
type MSCluster_Disk struct { 
	*MSCluster_ClusterDisk
	...
	func NewMSCluster_DiskEx1(instance *cim.WmiInstance) (newInstance *MSCluster_Disk, err error) {tmp, err := NewMSCluster_ClusterDiskEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_Disk, err error) {tmp, err := NewMSCluster_ClusterDiskEx6(hostName, wmiNamespace, userName, password, domainName, query)
