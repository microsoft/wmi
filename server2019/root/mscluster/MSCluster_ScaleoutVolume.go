...
type MSCluster_ScaleoutVolume struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_ScaleoutVolumeEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ScaleoutVolume, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ScaleoutVolume, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_ScaleoutVolume) NewScaleoutVolume( /* IN */ VolumeName string,
 ...
 /* OUT */ CreatedScaleoutVolume MSCluster_ScaleoutVolume) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewScaleoutVolume" , VolumeName, MaxMetadataVolumeSize, ZoneGroupId)
	if err != nil { return }
...
func (instance *MSCluster_ScaleoutVolume) AddDataZoneToSV( /* IN */ ZoneId string,
 ...
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddDataZoneToSV" , ZoneId, ZoneGroupId, sizeInBytes, ZoneTargetPath, ZoneVolume, ZoneResource)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) RemoveSVDataZone( /* IN */ VolumeName string,
 ...
 /* IN */ force bool,
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveSVDataZone" , VolumeName, ZoneId, ClusterName, ResourceName, force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) DeleteSV( /* IN */ VolumeName string,
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("DeleteSV" , VolumeName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) GetSVInformation( /* IN */ VolumeName string,
 /* OUT */ RetrievedScaleoutVolume MSCluster_ScaleoutVolume) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSVInformation" , VolumeName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_ScaleoutVolume) GetAllSV( /* OUT */ Guids []MSCluster_ScaleoutVolume) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetAllSV" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) SuspendSVDataZone( /* IN */ zoneId string,
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("SuspendSVDataZone" , zoneId)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) ResumeSVDataZone( /* IN */ zoneId string,
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("ResumeSVDataZone" , zoneId)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) RetireSVDataZone( /* IN */ zoneId string,
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("RetireSVDataZone" , zoneId)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) UpdateGroupIdForSVDataZone( /* IN */ zoneId string,
 /* IN */ zoneGroupId string,
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("UpdateGroupIdForSVDataZone" , zoneId, zoneGroupId)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ScaleoutVolume) GetZoneInformation( /* IN */ zoneId string,
 /* OUT */ RetrievedScaleoutZone MSCluster_ScaleoutZone) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetZoneInformation" , zoneId)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
