...
type MSCluster_AffinityRule struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_AffinityRuleEx1(instance *cim.WmiInstance) (newInstance *MSCluster_AffinityRule, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_AffinityRule, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_AffinityRule) CreateAffinityRule( /* IN */ Name string,
 /* IN */ RuleType uint32,
 /* OUT */ CreatedAffinityRule MSCluster_AffinityRule) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateAffinityRule" , Name, RuleType)
	if err != nil { return }
...
func (instance *MSCluster_AffinityRule) SetAffinityRule( /* IN */ RuleType uint32,
 /* IN */ Enabled uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetAffinityRule" , RuleType, Enabled);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_AffinityRule) AddGroupToAffinityRule( /* IN */ Groups []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddGroupToAffinityRule" , Groups);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_AffinityRule) RemoveGroupFromAffinityRule( /* IN */ Groups []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveGroupFromAffinityRule" , Groups);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_AffinityRule) AddClusterSharedVolumeToAffinityRule( /* IN */ ClusterSharedVolumes []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddClusterSharedVolumeToAffinityRule" , ClusterSharedVolumes);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_AffinityRule) RemoveClusterSharedVolumeFromAffinityRule( /* IN */ ClusterSharedVolumes []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveClusterSharedVolumeFromAffinityRule" , ClusterSharedVolumes);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_AffinityRule) RemoveAffinityRule() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveAffinityRule" );
	if err != nil { return }
	result = uint32(retVal)
	return
