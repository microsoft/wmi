...
type MSCluster_Event struct { 
	*__ExtrinsicEvent
	...
	func NewMSCluster_EventEx1(instance *cim.WmiInstance) (newInstance *MSCluster_Event, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_Event, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
