...
type MSCluster_ClusterSharedVolume struct { 
	*MSCluster_LogicalElement
	...
	func NewMSCluster_ClusterSharedVolumeEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ClusterSharedVolume, err error) {tmp, err := NewMSCluster_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ClusterSharedVolume, err error) {tmp, err := NewMSCluster_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
// 
func (instance *MSCluster_ClusterSharedVolume) TurnOnMaintenance() (err error) {_, err = instance.InvokeMethodWithReturn("TurnOnMaintenance" );
	if err != nil { return }
	return
...
// 
func (instance *MSCluster_ClusterSharedVolume) TurnOffMaintenance() (err error) {_, err = instance.InvokeMethodWithReturn("TurnOffMaintenance" );
	if err != nil { return }
	return
...
// 
func (instance *MSCluster_ClusterSharedVolume) TurnOnRedirectedAccess() (err error) {_, err = instance.InvokeMethodWithReturn("TurnOnRedirectedAccess" );
	if err != nil { return }
	return
...
// 
func (instance *MSCluster_ClusterSharedVolume) TurnOffRedirectedAccess() (err error) {_, err = instance.InvokeMethodWithReturn("TurnOffRedirectedAccess" );
	if err != nil { return }
	return
...
func (instance *MSCluster_ClusterSharedVolume) MoveToNewHost( /* IN */ HostName string) (err error) {_, err = instance.InvokeMethodWithReturn("MoveToNewHost" , HostName);
	if err != nil { return }
	return
