...
type MSCluster_LogicalElement struct { 
	*CIM_LogicalElement
	...
	func NewMSCluster_LogicalElementEx1(instance *cim.WmiInstance) (newInstance *MSCluster_LogicalElement, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_LogicalElement, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
