...
type MSCluster_FaultDomain struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_FaultDomainEx1(instance *cim.WmiInstance) (newInstance *MSCluster_FaultDomain, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_FaultDomain, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_FaultDomain) CreateFaultDomain( /* IN */ Name string,
 ...
 /* IN */ Location string,
 /* IN */ Flags uint32,
 /* OUT */ CreatedFaultDomain MSCluster_FaultDomain) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateFaultDomain" , Name, FaultDomain, FaultDomainType, Description, Location, Flags)
	if err != nil { return }
...
func (instance *MSCluster_FaultDomain) SetFaultDomainXML( /* IN */ XML string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetFaultDomainXML" , XML, Flags);
	if err != nil { return }
...
func (instance *MSCluster_FaultDomain) GetFaultDomainXML( /* OUT */ XML string,
 /* OPTIONAL IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetFaultDomainXML" , Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_FaultDomain) MoveFaultDomain( /* IN */ FaultDomain string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("MoveFaultDomain" , FaultDomain, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSCluster_FaultDomain) GetChildren( /* OUT */ Children []MSCluster_FaultDomain,
 /* OPTIONAL IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetChildren" , Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_FaultDomain) GetStorageNodes( /* OUT */ StorageNodes []MSCluster_StorageNode,
 /* OPTIONAL IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetStorageNodes" , Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_FaultDomain) SetFaultDomain( /* IN */ NewName string,
 ...
 /* IN */ Description string,
 /* IN */ Location string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetFaultDomain" , NewName, FaultDomain, Description, Location, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_FaultDomain) RemoveFaultDomain( /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveFaultDomain" , Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
