...
type MSCluster_NetworkInterface struct { 
	*CIM_LogicalDevice
	...
	func NewMSCluster_NetworkInterfaceEx1(instance *cim.WmiInstance) (newInstance *MSCluster_NetworkInterface, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_NetworkInterface, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_NetworkInterface) ExecuteNetworkInterfaceControl( /* IN */ ControlCode int32,
 ...
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethod("ExecuteNetworkInterfaceControl" , ControlCode, InputBuffer, Reason)
	if err != nil { return }
	return
