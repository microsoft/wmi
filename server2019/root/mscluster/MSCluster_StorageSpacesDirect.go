...
type MSCluster_StorageSpacesDirect struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_StorageSpacesDirectEx1(instance *cim.WmiInstance) (newInstance *MSCluster_StorageSpacesDirect, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_StorageSpacesDirect, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_StorageSpacesDirect) EnableStorageSpacesDirect( /* IN */ CacheState uint32,
 ...
 /* OUT */ StorageSpacesDirect MSCluster_StorageSpacesDirect) (result uint32, err error) {retVal, err := instance.InvokeMethod("EnableStorageSpacesDirect" , CacheState, CacheMetadataReserveBytes, XML, CacheDeviceModel, AutoConfig, CachePageSizeKBytes, PoolFriendlyName, SkipEligibilityChecks, CollectPerformanceHistory, BusTypesToUse, UseSedExclusively, SedProtectionState)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_StorageSpacesDirect) DisableStorageSpacesDirect( /* IN */ CleanupCache bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("DisableStorageSpacesDirect" , CleanupCache);
	if err != nil { return }
...
func (instance *MSCluster_StorageSpacesDirect) SetStorageSpacesDirect( /* IN */ CacheState uint32,
 ...
 /* IN */ Nodes []string,
 /* IN */ UseSedExclusively bool,
 /* IN */ SedProtectionState uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetStorageSpacesDirect" , CacheState, CacheModeHdd, CacheModeSsd, SkipEligibilityChecks, ScmUse, Nodes, UseSedExclusively, SedProtectionState);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSCluster_StorageSpacesDirect) GetStorageSpacesDirect( /* IN */ Node string,
 /* OUT */ TheStorageSpacesDirect MSCluster_StorageSpacesDirect) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetStorageSpacesDirect" , Node)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_StorageSpacesDirect) PostCreatePool( /* IN */ PoolUniqueId string,
 ...
 /* IN */ PoolHasNonCacheScm bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("PostCreatePool" , PoolUniqueId, nNodesInSite, PoolHasNonCacheHdd, PoolHasNonCacheSsd, PoolHasNonCacheScm);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSCluster_StorageSpacesDirect) RepairStorageSpacesDirect( /* IN */ SkipDiskRecovery bool,
 ...
 /* IN */ Node string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RepairStorageSpacesDirect" , SkipDiskRecovery, DisableStorageMaintenanceMode, RecoverUnboundDrives, Node);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSCluster_StorageSpacesDirect) SetStorageSpacesDirectDisk( /* IN */ CanBeClaimed bool,
 ...
 /* IN */ PhysicalDiskIds []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetStorageSpacesDirectDisk" , CanBeClaimed, Reset, CacheUsage, PhysicalDiskIds);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSCluster_StorageSpacesDirect) GetStorageSpacesDirectDisk( /* IN */ CanBeClaimed bool,
 /* OUT */ PhysicalDiskIds []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetStorageSpacesDirectDisk" , CanBeClaimed)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
