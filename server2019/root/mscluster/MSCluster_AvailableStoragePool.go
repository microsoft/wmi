...
type MSCluster_AvailableStoragePool struct { 
	*MSCluster_LogicalElement
	...
	func NewMSCluster_AvailableStoragePoolEx1(instance *cim.WmiInstance) (newInstance *MSCluster_AvailableStoragePool, err error) {tmp, err := NewMSCluster_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_AvailableStoragePool, err error) {tmp, err := NewMSCluster_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
// 
func (instance *MSCluster_AvailableStoragePool) AddToCluster() (err error) {_, err = instance.InvokeMethodWithReturn("AddToCluster" );
	if err != nil { return }
	return
