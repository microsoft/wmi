...
type CIM_LogicalDevice struct { 
	*CIM_LogicalElement
	...
	func NewCIM_LogicalDeviceEx1(instance *cim.WmiInstance) (newInstance *CIM_LogicalDevice, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_LogicalDevice, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
