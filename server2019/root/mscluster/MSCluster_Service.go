...
type MSCluster_Service struct { 
	*CIM_ClusteringService
	...
	func NewMSCluster_ServiceEx1(instance *cim.WmiInstance) (newInstance *MSCluster_Service, err error) {tmp, err := NewCIM_ClusteringServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_Service, err error) {tmp, err := NewCIM_ClusteringServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
// 
func (instance *MSCluster_Service) Start() (err error) {_, err = instance.InvokeMethodWithReturn("Start" );
	if err != nil { return }
	return
...
// 
func (instance *MSCluster_Service) Stop() (err error) {_, err = instance.InvokeMethodWithReturn("Stop" );
	if err != nil { return }
	return
