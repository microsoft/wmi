...
type MSCluster_Cluster struct { 
	*CIM_Cluster
	...
	func NewMSCluster_ClusterEx1(instance *cim.WmiInstance) (newInstance *MSCluster_Cluster, err error) {tmp, err := NewCIM_ClusterEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_Cluster, err error) {tmp, err := NewCIM_ClusterEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_Cluster) SetMajorityQuorum( /* IN */ Resource string,
 ...
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("SetMajorityQuorum" , Resource, QuorumPath, Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) SetDiskQuorum( /* IN */ Resource string,
 /* IN */ QuorumPath string,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("SetDiskQuorum" , Resource, QuorumPath, Reason);
	if err != nil { return }
	return
...
// <param name="Reason" type="string "></param>
func (instance *MSCluster_Cluster) SetNodeMajorityQuorum( /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("SetNodeMajorityQuorum" , Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) GetNodeClusterState( /* OUT */ ClusterState int32) (err error) {_, err = instance.InvokeMethod("GetNodeClusterState" )
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) CreateCluster( /* IN */ ClusterName string,
 ...
 /* IN */ AdministrativeAccessPoint uint32) (err error) {_, err = instance.InvokeMethodWithReturn("CreateCluster" , ClusterName, NodeNames, IPAddresses, SubnetMasks, AdministrativeAccessPoint);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) CreateClusterEx( /* IN */ ClusterName string,
 ...
 /* IN */ AdministrativeAccessPointResourceType uint32) (err error) {_, err = instance.InvokeMethodWithReturn("CreateClusterEx" , ClusterName, NodeNames, IPAddresses, SubnetMasks, AdministrativeAccessPoint, AdministrativeAccessPointResourceType);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) AddNode( /* IN */ NodeName string) (err error) {_, err = instance.InvokeMethodWithReturn("AddNode" , NodeName);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) EvictNode( /* IN */ NodeName string,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("EvictNode" , NodeName, Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) DestroyCluster( /* IN */ CleanupAD bool) (err error) {_, err = instance.InvokeMethodWithReturn("DestroyCluster" , CleanupAD);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) ForceCleanup( /* IN */ NodeName string,
 /* IN */ Timeout uint32) (err error) {_, err = instance.InvokeMethodWithReturn("ForceCleanup" , NodeName, Timeout);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) ExecuteClusterControl( /* IN */ ControlCode int32,
 ...
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethod("ExecuteClusterControl" , ControlCode, InputBuffer, Reason)
	if err != nil { return }
	return
...
// <param name="Resource" type="string "></param>
func (instance *MSCluster_Cluster) AddResourceToClusterSharedVolumes( /* IN */ Resource string) (err error) {_, err = instance.InvokeMethodWithReturn("AddResourceToClusterSharedVolumes" , Resource);
	if err != nil { return }
	return
...
// <param name="Resource" type="string "></param>
func (instance *MSCluster_Cluster) RemoveResourceFromClusterSharedVolumes( /* IN */ Resource string) (err error) {_, err = instance.InvokeMethodWithReturn("RemoveResourceFromClusterSharedVolumes" , Resource);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) GenerateValidationStatus( /* OUT */ Status MSCluster_ValidationStatus) (err error) {_, err = instance.InvokeMethod("GenerateValidationStatus" )
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) AddVirtualMachine( /* IN */ VirtualMachine string) (err error) {_, err = instance.InvokeMethodWithReturn("AddVirtualMachine" , VirtualMachine);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) VerifyPath( /* IN */ Path string,
 /* IN */ Group string,
 /* OUT */ result uint32) (err error) {_, err = instance.InvokeMethod("VerifyPath" , Path, Group)
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) AddClusterNameAccount( /* IN */ Name string,
 ...
 /* IN */ UserName string,
 /* IN */ Password string,
 /* IN */ AdministrativeAccessPoint uint32) (err error) {_, err = instance.InvokeMethodWithReturn("AddClusterNameAccount" , Name, DomainName, UserName, Password, AdministrativeAccessPoint);
	if err != nil { return }
	return
...
func (instance *MSCluster_Cluster) AddClusterNameAccountEx( /* IN */ Name string,
 ...
 /* IN */ upgradeVCOs uint32) (err error) {_, err = instance.InvokeMethodWithReturn("AddClusterNameAccountEx" , Name, DomainName, UserName, Password, AdministrativeAccessPoint, AdministrativeAccessPointResourceType, upgradeVCOs);
	if err != nil { return }
	return
