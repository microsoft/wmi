...
type MSCluster_ExtendedStatus struct { 
	*__ExtendedStatus
	...
	func NewMSCluster_ExtendedStatusEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ExtendedStatus, err error) {tmp, err := New__ExtendedStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ExtendedStatus, err error) {tmp, err := New__ExtendedStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
