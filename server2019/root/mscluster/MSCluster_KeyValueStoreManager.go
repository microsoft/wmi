...
type MSCluster_KeyValueStoreManager struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_KeyValueStoreManagerEx1(instance *cim.WmiInstance) (newInstance *MSCluster_KeyValueStoreManager, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_KeyValueStoreManager, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_KeyValueStoreManager) CreateKeyValueStoreManager( /* IN */ Name string,
 /* IN */ Path string,
 /* IN */ Flags uint32,
 /* OUT */ CreatedKeyValueStoreManager MSCluster_KeyValueStoreManager) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateKeyValueStoreManager" , Name, Path, Flags)
	if err != nil { return }
...
func (instance *MSCluster_KeyValueStoreManager) DeleteKeyValueStoreManager( /* IN */ Name string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("DeleteKeyValueStoreManager" , Name, Flags);
	if err != nil { return }
...
func (instance *MSCluster_KeyValueStoreManager) GetKeyValueStoreManagers( /* IN */ Flags uint32,
 /* OUT */ KeyValueStoreManagers []MSCluster_KeyValueStoreManager) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetKeyValueStoreManagers" , Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_KeyValueStoreManager) CreateKeyValueStore( /* IN */ Name string,
 /* IN */ Type uint32,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CreateKeyValueStore" , Name, Type, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSCluster_KeyValueStoreManager) DeleteKeyValueStore( /* IN */ Name string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("DeleteKeyValueStore" , Name, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSCluster_KeyValueStoreManager) GetKeyValueStores( /* IN */ Flags uint32,
 /* OUT */ KeyValueStores []MSCluster_KeyValueStore) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetKeyValueStores" , Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_KeyValueStoreManager) GetAllKeyValueStores( /* IN */ Flags uint32,
 /* OUT */ KeyValueStores []MSCluster_KeyValueStore) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetAllKeyValueStores" , Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
