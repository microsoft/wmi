...
type MSCluster_ScaleoutZone struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_ScaleoutZoneEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ScaleoutZone, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ScaleoutZone, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
