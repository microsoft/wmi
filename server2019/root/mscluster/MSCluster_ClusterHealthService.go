...
type MSCluster_ClusterHealthService struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_ClusterHealthServiceEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ClusterHealthService, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ClusterHealthService, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_ClusterHealthService) GetMetric( /* IN */ MetricName []string,
 ...
 /* IN */ Flags uint32,
 /* OUT */ Datapoints []MSCluster_HealthMetric) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetMetric" , MetricName, StreamName, Flags)
	if err != nil { return }
...
func (instance *MSCluster_ClusterHealthService) GetFault( /* IN */ ReportingKey string,
 ...
 /* OUT */ Faults []MSCluster_HealthFault) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetFault" , ReportingKey, ReportingType)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSCluster_ClusterHealthService) InvokeCommand( /* IN */ Name string,
 ...
 /* OUT */ Status int32) (result uint32, err error) {retVal, err := instance.InvokeMethod("InvokeCommand" , Name, Flags, Parameters, Timeout)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
