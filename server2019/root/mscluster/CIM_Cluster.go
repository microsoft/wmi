...
type CIM_Cluster struct { 
	*CIM_ComputerSystem
	...
	func NewCIM_ClusterEx1(instance *cim.WmiInstance) (newInstance *CIM_Cluster, err error) {tmp, err := NewCIM_ComputerSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Cluster, err error) {tmp, err := NewCIM_ComputerSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
