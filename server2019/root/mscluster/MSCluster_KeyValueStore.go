...
type MSCluster_KeyValueStore struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_KeyValueStoreEx1(instance *cim.WmiInstance) (newInstance *MSCluster_KeyValueStore, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_KeyValueStore, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
