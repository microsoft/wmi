...
type MSCluster_ResourceType struct { 
	*MSCluster_LogicalElement
	...
	func NewMSCluster_ResourceTypeEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ResourceType, err error) {tmp, err := NewMSCluster_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ResourceType, err error) {tmp, err := NewMSCluster_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_ResourceType) CreateResourceType( /* IN */ Name string,
 ...
 /* IN */ IsAlivePollInterval uint32) (err error) {_, err = instance.InvokeMethodWithReturn("CreateResourceType" , Name, DisplayName, DLLName, LooksAlivePollInterval, IsAlivePollInterval);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceType) DeleteResourceType( /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("DeleteResourceType" , Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceType) GetPossibleOwners( /* OUT */ NodeNames []string) (err error) {_, err = instance.InvokeMethod("GetPossibleOwners" )
	if err != nil { return }
	return
...
func (instance *MSCluster_ResourceType) ExecuteResourceTypeControl( /* IN */ ControlCode int32,
 ...
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethod("ExecuteResourceTypeControl" , ControlCode, InputBuffer, Reason)
	if err != nil { return }
	return
