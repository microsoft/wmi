...
type MSCluster_EventGroupStateChange struct { 
	*MSCluster_EventStateChange
	...
	func NewMSCluster_EventGroupStateChangeEx1(instance *cim.WmiInstance) (newInstance *MSCluster_EventGroupStateChange, err error) {tmp, err := NewMSCluster_EventStateChangeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_EventGroupStateChange, err error) {tmp, err := NewMSCluster_EventStateChangeEx6(hostName, wmiNamespace, userName, password, domainName, query)
