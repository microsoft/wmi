...
type MSCluster_MetricRecord struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_MetricRecordEx1(instance *cim.WmiInstance) (newInstance *MSCluster_MetricRecord, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_MetricRecord, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
