...
type MSCluster_MetricRecordReal64 struct { 
	*MSCluster_MetricRecord
	...
	func NewMSCluster_MetricRecordReal64Ex1(instance *cim.WmiInstance) (newInstance *MSCluster_MetricRecordReal64, err error) {tmp, err := NewMSCluster_MetricRecordEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_MetricRecordReal64, err error) {tmp, err := NewMSCluster_MetricRecordEx6(hostName, wmiNamespace, userName, password, domainName, query)
