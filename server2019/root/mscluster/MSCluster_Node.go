...
type MSCluster_Node struct { 
	*CIM_UnitaryComputerSystem
	...
	func NewMSCluster_NodeEx1(instance *cim.WmiInstance) (newInstance *MSCluster_Node, err error) {tmp, err := NewCIM_UnitaryComputerSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_Node, err error) {tmp, err := NewCIM_UnitaryComputerSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_Node) Pause( /* IN */ DrainType uint32,
 ...
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("Pause" , DrainType, TargetNode, Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_Node) Resume( /* IN */ FailbackType uint32,
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethodWithReturn("Resume" , FailbackType, Reason);
	if err != nil { return }
	return
...
func (instance *MSCluster_Node) WillEvictLoseQuorum( /* OPTIONAL IN */ Reason string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("WillEvictLoseQuorum" , Reason);
	if err != nil { return }
	result = (retVal > 0)
	return
...
// <param name="ReturnValue" type="bool "></param>
func (instance *MSCluster_Node) WillOfflineLoseQuorum( /* OPTIONAL IN */ Reason string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("WillOfflineLoseQuorum" , Reason);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *MSCluster_Node) ExecuteNodeControl( /* IN */ ControlCode int32,
 ...
 /* OPTIONAL IN */ Reason string) (err error) {_, err = instance.InvokeMethod("ExecuteNodeControl" , ControlCode, InputBuffer, Reason)
	if err != nil { return }
	return
