...
type MSCluster_HealthMetric struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_HealthMetricEx1(instance *cim.WmiInstance) (newInstance *MSCluster_HealthMetric, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_HealthMetric, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
