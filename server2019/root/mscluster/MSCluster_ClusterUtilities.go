...
type MSCluster_ClusterUtilities struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_ClusterUtilitiesEx1(instance *cim.WmiInstance) (newInstance *MSCluster_ClusterUtilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_ClusterUtilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_ClusterUtilities) IsClusterSupported() (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("IsClusterSupported" );
	if err != nil { return }
	result = (retVal > 0)
	return
...
// <param name="ReturnValue" type="bool "></param>
func (instance *MSCluster_ClusterUtilities) IsStorageSpacesDirectSupported() (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("IsStorageSpacesDirectSupported" );
	if err != nil { return }
	result = (retVal > 0)
	return
...
// <param name="ReturnValue" type="bool "></param>
func (instance *MSCluster_ClusterUtilities) IsStorageSpacesDirectCacheSupported() (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("IsStorageSpacesDirectCacheSupported" );
	if err != nil { return }
	result = (retVal > 0)
	return
