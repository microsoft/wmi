...
type MSCluster_EventResourceStateChange struct { 
	*MSCluster_EventStateChange
	...
	func NewMSCluster_EventResourceStateChangeEx1(instance *cim.WmiInstance) (newInstance *MSCluster_EventResourceStateChange, err error) {tmp, err := NewMSCluster_EventStateChangeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_EventResourceStateChange, err error) {tmp, err := NewMSCluster_EventStateChangeEx6(hostName, wmiNamespace, userName, password, domainName, query)
