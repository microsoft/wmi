...
type MSCluster_HCSVM struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_HCSVMEx1(instance *cim.WmiInstance) (newInstance *MSCluster_HCSVM, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_HCSVM, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSCluster_HCSVM) NewClusterHCSVM( /* IN */ Name string,
 ...
 /* OUT */ CreatedHCSVMCluster MSCluster_HCSVM) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewClusterHCSVM" , Name, SwitchName, ExtendedVmConfiguration, MemorySizeInMb, CpuCount, VhdPath, VmName, OfflineAction)
	if err != nil { return }
...
func (instance *MSCluster_HCSVM) RemoveClusterHCSVM( /* IN */ Name string,
 /* IN */ Force bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveClusterHCSVM" , Name, Force);
	if err != nil { return }
...
func (instance *MSCluster_HCSVM) SetClusterHCSVM( /* IN */ Name string,
 /* IN */ NewName string,
 /* IN */ ExtendedVmConfiguration string,
 /* IN */ OfflineAction uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetClusterHCSVM" , Name, NewName, ExtendedVmConfiguration, OfflineAction);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_HCSVM) StartClusterHCSVM( /* IN */ Name string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("StartClusterHCSVM" , Name);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSCluster_HCSVM) StopClusterHCSVM( /* IN */ Name string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("StopClusterHCSVM" , Name);
	if err != nil { return }
	result = uint32(retVal)
	return
