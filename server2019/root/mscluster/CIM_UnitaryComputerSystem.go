...
type CIM_UnitaryComputerSystem struct { 
	*CIM_ComputerSystem
	...
	func NewCIM_UnitaryComputerSystemEx1(instance *cim.WmiInstance) (newInstance *CIM_UnitaryComputerSystem, err error) {tmp, err := NewCIM_ComputerSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_UnitaryComputerSystem, err error) {tmp, err := NewCIM_ComputerSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
