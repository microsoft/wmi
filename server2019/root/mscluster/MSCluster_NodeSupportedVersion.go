...
type MSCluster_NodeSupportedVersion struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_NodeSupportedVersionEx1(instance *cim.WmiInstance) (newInstance *MSCluster_NodeSupportedVersion, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_NodeSupportedVersion, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
