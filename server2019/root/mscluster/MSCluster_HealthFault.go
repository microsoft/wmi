...
type MSCluster_HealthFault struct { 
	*cim.WmiInstance
	...
	func NewMSCluster_HealthFaultEx1(instance *cim.WmiInstance) (newInstance *MSCluster_HealthFault, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSCluster_HealthFault, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
