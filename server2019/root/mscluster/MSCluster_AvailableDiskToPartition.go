...
func NewMSCluster_AvailableDiskToPartitionEx1(instance *cim.WmiInstance) (newInstance *MSCluster_AvailableDiskToPartition, err error) {
...
func NewMSCluster_AvailableDiskToPartitionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSCluster_AvailableDiskToPartition, err error) {
