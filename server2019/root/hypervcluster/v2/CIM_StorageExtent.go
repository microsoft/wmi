...
type CIM_StorageExtent struct { 
	*CIM_LogicalDevice
	...
	func NewCIM_StorageExtentEx1(instance *cim.WmiInstance) (newInstance *CIM_StorageExtent, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_StorageExtent, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
