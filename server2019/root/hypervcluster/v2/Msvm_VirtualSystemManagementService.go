...
type Msvm_VirtualSystemManagementService struct { 
	*CIM_VirtualSystemManagementService
	...
	func NewMsvm_VirtualSystemManagementServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemManagementService, err error) {tmp, err := NewCIM_VirtualSystemManagementServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemManagementService, err error) {tmp, err := NewCIM_VirtualSystemManagementServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("DefinePlannedSystem", Action, PercentComplete, Timeout , SystemSettings, ResourceSettings, ReferenceConfiguration)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) ValidatePlannedSystem( /* IN */ PlannedSystem v2.Msvm_PlannedComputerSystem,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ValidatePlannedSystem", Action, PercentComplete, Timeout , PlannedSystem)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("UpgradeSystemVersion", Action, PercentComplete, Timeout , ComputerSystem, UpgradeSettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) ImportSystemDefinition( /* IN */ SystemDefinitionFile string,
 ...
 /* OUT */ ImportedSystem v2.Msvm_PlannedComputerSystem,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ImportSystemDefinition", Action, PercentComplete, Timeout , SystemDefinitionFile, SnapshotFolder, GenerateNewSystemIdentifier)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="Job" type="CIM_ConcreteJob "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) ImportSnapshotDefinitions( /* IN */ PlannedSystem v2.Msvm_PlannedComputerSystem,
 /* IN */ SnapshotFolder string,
 /* OUT */ ImportedSnapshots []Msvm_VirtualSystemSettingData,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ImportSnapshotDefinitions", Action, PercentComplete, Timeout , PlannedSystem, SnapshotFolder)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) RealizePlannedSystem( /* IN */ PlannedSystem v2.Msvm_PlannedComputerSystem,
 /* OUT */ ResultingSystem CIM_ComputerSystem,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RealizePlannedSystem", Action, PercentComplete, Timeout , PlannedSystem)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ExportSystemDefinition", Action, PercentComplete, Timeout , ComputerSystem, ExportDirectory, ExportSettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) AddFeatureSettings( /* IN */ AffectedConfiguration v2.Msvm_EthernetPortAllocationSettingData,
 /* IN */ FeatureSettings []string,
 /* OUT */ ResultingFeatureSettings []v2.Msvm_EthernetSwitchPortFeatureSettingData,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("AddFeatureSettings", Action, PercentComplete, Timeout , AffectedConfiguration, FeatureSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifyFeatureSettings", Action, PercentComplete, Timeout , FeatureSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="Job" type="CIM_ConcreteJob ">If the operation is long running, then optionally a job may be returned.</param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) RemoveFeatureSettings( /* IN */ FeatureSettings []v2.Msvm_EthernetSwitchPortFeatureSettingData,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RemoveFeatureSettings", Action, PercentComplete, Timeout , FeatureSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("AddBootSourceSettings", Action, PercentComplete, Timeout , AffectedConfiguration, BootSourceSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("AddGuestServiceSettings", Action, PercentComplete, Timeout , AffectedConfiguration, GuestServiceSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifyGuestServiceSettings", Action, PercentComplete, Timeout , GuestServiceSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RemoveBootSourceSettings", Action, PercentComplete, Timeout , BootSourceSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RemoveGuestServiceSettings", Action, PercentComplete, Timeout , GuestServiceSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) GetVirtualSystemThumbnailImage( /* IN */ TargetSystem CIM_VirtualSystemSettingData,
 ...
 /* OUT */ ImageData []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetVirtualSystemThumbnailImage" , TargetSystem, WidthPixels, HeightPixels)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) GetSummaryInformation( /* IN */ SettingData []CIM_VirtualSystemSettingData,
 ...
 /* OUT */ SummaryInformation []Msvm_SummaryInformationBase) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSummaryInformation" , SettingData, RequestedInformation)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) GetDefinitionFileSummaryInformation( /* IN */ DefinitionFiles []string,
 /* OUT */ SummaryInformation []Msvm_SummaryInformationBase) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetDefinitionFileSummaryInformation" , DefinitionFiles)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("AddKvpItems", Action, PercentComplete, Timeout , TargetSystem, DataItems)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifyKvpItems", Action, PercentComplete, Timeout , TargetSystem, DataItems)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RemoveKvpItems", Action, PercentComplete, Timeout , TargetSystem, DataItems)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) FormatError( /* IN */ Errors []string,
 /* OUT */ ErrorMessage string) (result uint32, err error) {retVal, err := instance.InvokeMethod("FormatError" , Errors)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifyDiskMergeSettings", Action, PercentComplete, Timeout , SettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) GenerateWwpn( /* IN */ NumberOfWwpns uint32,
 /* OUT */ GeneratedWwpn []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GenerateWwpn" , NumberOfWwpns)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) AddFibreChannelChap( /* IN */ FcPortSettings []string,
 ...
 /* IN */ SharedSecret []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddFibreChannelChap" , FcPortSettings, SecretEncoding, SharedSecret);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) RemoveFibreChannelChap( /* IN */ FcPortSettings []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveFibreChannelChap" , FcPortSettings);
	if err != nil { return }
	result = uint32(retVal)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("SetGuestNetworkAdapterConfiguration", Action, PercentComplete, Timeout , ComputerSystem, NetworkConfiguration)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) GetSizeOfSystemFiles( /* IN */ Vssd CIM_VirtualSystemSettingData,
 /* OUT */ Size uint64) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSizeOfSystemFiles" , Vssd)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) GetCurrentWwpnFromGenerator( /* OUT */ CurrentWwpn string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetCurrentWwpnFromGenerator" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) TestNetworkConnection( /* IN */ TargetNetworkAdapter v2.Msvm_EthernetPortAllocationSettingData,
 /* IN */ IsSender bool,
 /* IN */ SenderIP string,
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("TestNetworkConnection", Action, PercentComplete, Timeout , TargetNetworkAdapter, IsSender, SenderIP, ReceiverIP, ReceiverMac, IsolationId, SequenceNumber)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="Job" type="CIM_ConcreteJob ">If the operation is long running, then optionally a job may be returned.</param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) DiagnoseNetworkConnection( /* IN */ TargetNetworkAdapter v2.Msvm_EthernetPortAllocationSettingData,
 /* IN */ DiagnosticSettings string,
 /* OUT */ DiagnosticInformation string,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("DiagnoseNetworkConnection", Action, PercentComplete, Timeout , TargetNetworkAdapter, DiagnosticSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("SetInitialMachineConfigurationData", Action, PercentComplete, Timeout , TargetSystem, ImcData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemManagementService) AddSystemComponentSettings( /* IN */ AffectedConfiguration Msvm_VirtualSystemSettingData,
 ...
 /* OUT */ ResultingComponentSettings []v2.Msvm_SystemComponentSettingData,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("AddSystemComponentSettings", Action, PercentComplete, Timeout , AffectedConfiguration, ComponentSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifySystemComponentSettings", Action, PercentComplete, Timeout , ComponentSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="Job" type="CIM_ConcreteJob ">If the operation is long running, then optionally a job my be returned.</param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_VirtualSystemManagementService) RemoveSystemComponentSettings( /* IN */ ComponentSettings []v2.Msvm_SystemComponentSettingData,
 /* OUT */ Job CIM_ConcreteJob,
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RemoveSystemComponentSettings", Action, PercentComplete, Timeout , ComponentSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
