...
type CIM_TapeDrive struct { 
	*CIM_MediaAccessDevice
	...
	func NewCIM_TapeDriveEx1(instance *cim.WmiInstance) (newInstance *CIM_TapeDrive, err error) {tmp, err := NewCIM_MediaAccessDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_TapeDrive, err error) {tmp, err := NewCIM_MediaAccessDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
