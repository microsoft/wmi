...
type Msvm_CollectionReplicationSettingData struct { 
	*Msvm_CollectionSettingData
	...
	func NewMsvm_CollectionReplicationSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_CollectionReplicationSettingData, err error) {tmp, err := NewMsvm_CollectionSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_CollectionReplicationSettingData, err error) {tmp, err := NewMsvm_CollectionSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
