...
type CIM_LogicalIdentity struct { 
	*cim.WmiInstance
	...
	func NewCIM_LogicalIdentityEx1(instance *cim.WmiInstance) (newInstance *CIM_LogicalIdentity, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_LogicalIdentity, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
