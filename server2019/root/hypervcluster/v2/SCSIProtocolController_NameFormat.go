...
const (
	...
	// Other enum
	SCSIProtocolController_NameFormat_Other SCSIProtocolController_NameFormat = 1
	// FC_Port_WWN enum
	SCSIProtocolController_NameFormat_FC_Port_WWN SCSIProtocolController_NameFormat = 2
	// iSCSI_Name enum
