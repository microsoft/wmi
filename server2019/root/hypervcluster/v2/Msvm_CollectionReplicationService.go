...
func NewMsvm_CollectionReplicationServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_CollectionReplicationService, err error) {
...
func NewMsvm_CollectionReplicationServiceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_CollectionReplicationService, err error) {
