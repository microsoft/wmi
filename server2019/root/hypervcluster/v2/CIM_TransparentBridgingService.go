...
type CIM_TransparentBridgingService struct { 
	*CIM_ForwardingService
	...
	func NewCIM_TransparentBridgingServiceEx1(instance *cim.WmiInstance) (newInstance *CIM_TransparentBridgingService, err error) {tmp, err := NewCIM_ForwardingServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_TransparentBridgingService, err error) {tmp, err := NewCIM_ForwardingServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
