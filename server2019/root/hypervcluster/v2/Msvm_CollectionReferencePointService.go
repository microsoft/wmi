...
type Msvm_CollectionReferencePointService struct { 
	*CIM_Service
	...
	func NewMsvm_CollectionReferencePointServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_CollectionReferencePointService, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_CollectionReferencePointService, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("CreateReferencePoint", Action, PercentComplete, Timeout , Collection, ReferencePointSettings, ReferencePointType)
	if err != nil { return }
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("DestroyReferencePoint", Action, PercentComplete, Timeout , AffectedReferencePointCollection)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RemoveAssociatedData", Action, PercentComplete, Timeout , AffectedReferencePointCollection)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ExportReferencePoint", Action, PercentComplete, Timeout , ReferencePointCollection, ExportDirectory, ExportSettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
