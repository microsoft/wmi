...
type CIM_SettingsDefineState struct { 
	*cim.WmiInstance
	...
	func NewCIM_SettingsDefineStateEx1(instance *cim.WmiInstance) (newInstance *CIM_SettingsDefineState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SettingsDefineState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
