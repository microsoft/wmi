...
type CIM_ProtocolControllerForUnit struct { 
	*CIM_ProtocolControllerForDevice
	...
	func NewCIM_ProtocolControllerForUnitEx1(instance *cim.WmiInstance) (newInstance *CIM_ProtocolControllerForUnit, err error) {tmp, err := NewCIM_ProtocolControllerForDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProtocolControllerForUnit, err error) {tmp, err := NewCIM_ProtocolControllerForDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
