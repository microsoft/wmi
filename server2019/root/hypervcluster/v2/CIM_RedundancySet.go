...
type CIM_RedundancySet struct { 
	*CIM_SystemSpecificCollection
	...
	func NewCIM_RedundancySetEx1(instance *cim.WmiInstance) (newInstance *CIM_RedundancySet, err error) {tmp, err := NewCIM_SystemSpecificCollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RedundancySet, err error) {tmp, err := NewCIM_SystemSpecificCollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_RedundancySet) Failover( /* IN */ FailoverFrom CIM_ManagedElement,
 /* IN */ FailoverTo CIM_ManagedElement) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Failover" , FailoverFrom, FailoverTo);
	if err != nil { return }
