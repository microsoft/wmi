...
type Msvm_SnapshotCollection struct { 
	*CIM_Collection
	...
	func NewMsvm_SnapshotCollectionEx1(instance *cim.WmiInstance) (newInstance *Msvm_SnapshotCollection, err error) {tmp, err := NewCIM_CollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SnapshotCollection, err error) {tmp, err := NewCIM_CollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
