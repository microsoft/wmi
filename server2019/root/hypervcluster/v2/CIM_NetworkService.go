...
type CIM_NetworkService struct { 
	*CIM_Service
	...
	func NewCIM_NetworkServiceEx1(instance *cim.WmiInstance) (newInstance *CIM_NetworkService, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_NetworkService, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
