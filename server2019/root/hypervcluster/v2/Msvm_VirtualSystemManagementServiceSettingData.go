...
type Msvm_VirtualSystemManagementServiceSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_VirtualSystemManagementServiceSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemManagementServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemManagementServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
