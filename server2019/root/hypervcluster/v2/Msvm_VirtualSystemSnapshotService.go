...
type Msvm_VirtualSystemSnapshotService struct { 
	*CIM_VirtualSystemSnapshotService
	...
	func NewMsvm_VirtualSystemSnapshotServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemSnapshotService, err error) {tmp, err := NewCIM_VirtualSystemSnapshotServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemSnapshotService, err error) {tmp, err := NewCIM_VirtualSystemSnapshotServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("DestroySnapshotTree", Action, PercentComplete, Timeout , SnapshotSettingData)
	if err != nil { return }
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ClearSnapshotState", Action, PercentComplete, Timeout , SnapshotSettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ConvertToReferencePoint", Action, PercentComplete, Timeout , AffectedSnapshot, ReferencePointSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
