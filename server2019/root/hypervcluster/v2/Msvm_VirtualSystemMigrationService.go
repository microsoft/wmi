...
type Msvm_VirtualSystemMigrationService struct { 
	*CIM_VirtualSystemMigrationService
	...
	func NewMsvm_VirtualSystemMigrationServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemMigrationService, err error) {tmp, err := NewCIM_VirtualSystemMigrationServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemMigrationService, err error) {tmp, err := NewCIM_VirtualSystemMigrationServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("CheckVirtualSystemIsMigratable", Action, PercentComplete, Timeout , ComputerSystem, DestinationHost, MigrationSettingData, NewSystemSettingData, NewResourceSettingData)
	if err != nil { return }
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifyServiceSettings", Action, PercentComplete, Timeout , ServiceSettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("AddNetworkSettings", Action, PercentComplete, Timeout , NetworkSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RemoveNetworkSettings", Action, PercentComplete, Timeout , NetworkSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifyNetworkSettings", Action, PercentComplete, Timeout , NetworkSettings)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemMigrationService) GetSystemCompatibilityInfo( /* IN */ ComputerSystem CIM_ComputerSystem,
 /* OUT */ CompatibilityInfo []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSystemCompatibilityInfo" , ComputerSystem)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemMigrationService) CheckSystemCompatibilityInfo( /* IN */ CompatibilityInfo []uint8,
 /* OUT */ Reasons []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("CheckSystemCompatibilityInfo" , CompatibilityInfo)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemMigrationService) GetSystemCompatibilityVectors( /* IN */ ComputerSystem CIM_ComputerSystem,
 /* OUT */ CompatibilityVectors []v2.Msvm_CompatibilityVector) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSystemCompatibilityVectors" , ComputerSystem)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemMigrationService) GetProcessorFeatureLimits( /* IN */ Options string,
 /* OUT */ CompatibilityVectors []v2.Msvm_CompatibilityVector) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetProcessorFeatureLimits" , Options)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
