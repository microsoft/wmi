...
type CIM_NetworkPort struct { 
	*CIM_LogicalPort
	...
	func NewCIM_NetworkPortEx1(instance *cim.WmiInstance) (newInstance *CIM_NetworkPort, err error) {tmp, err := NewCIM_LogicalPortEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_NetworkPort, err error) {tmp, err := NewCIM_LogicalPortEx6(hostName, wmiNamespace, userName, password, domainName, query)
