...
type CIM_Service struct { 
	*CIM_EnabledLogicalElement
	...
	func NewCIM_ServiceEx1(instance *cim.WmiInstance) (newInstance *CIM_Service, err error) {tmp, err := NewCIM_EnabledLogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Service, err error) {tmp, err := NewCIM_EnabledLogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_Service) StartService() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("StartService" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_Service) StopService() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("StopService" );
	if err != nil { return }
	result = uint32(retVal)
	return
