...
const (
	...
	// IPv4 enum
	SwitchService_BridgeAddressType_IPv4 SwitchService_BridgeAddressType = 2
	// IPv6 enum
	SwitchService_BridgeAddressType_IPv6 SwitchService_BridgeAddressType = 3
	// MAC enum
	SwitchService_BridgeAddressType_MAC SwitchService_BridgeAddressType = 4
