...
type CIM_AlertIndication struct { 
	*CIM_ProcessIndication
	...
	func NewCIM_AlertIndicationEx1(instance *cim.WmiInstance) (newInstance *CIM_AlertIndication, err error) {tmp, err := NewCIM_ProcessIndicationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AlertIndication, err error) {tmp, err := NewCIM_ProcessIndicationEx6(hostName, wmiNamespace, userName, password, domainName, query)
