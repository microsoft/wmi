...
type Msvm_CollectionReferencePointSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_CollectionReferencePointSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_CollectionReferencePointSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_CollectionReferencePointSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
