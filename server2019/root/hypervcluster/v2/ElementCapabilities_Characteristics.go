...
const(
	...
	// Current enum
	ElementCapabilities_Characteristics_Current ElementCapabilities_Characteristics = 3
	// DMTF_Reserved enum
	ElementCapabilities_Characteristics_DMTF_Reserved ElementCapabilities_Characteristics = 4
