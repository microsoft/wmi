...
const (
	...
	// Restart enum
	VirtualSystemSettingData_AutomaticRecoveryAction_Restart VirtualSystemSettingData_AutomaticRecoveryAction = 3
	// Revert_to_snapshot enum
	VirtualSystemSettingData_AutomaticRecoveryAction_Revert_to_snapshot VirtualSystemSettingData_AutomaticRecoveryAction = 4
	// DMTF_Reserved enum
