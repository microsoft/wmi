...
func NewMsvm_ReferencePointOfVirtualSystemCollectionEx1(instance *cim.WmiInstance) (newInstance *Msvm_ReferencePointOfVirtualSystemCollection, err error) {
...
func NewMsvm_ReferencePointOfVirtualSystemCollectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_ReferencePointOfVirtualSystemCollection, err error) {
