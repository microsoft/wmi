...
type CIM_DVDDrive struct { 
	*CIM_MediaAccessDevice
	...
	func NewCIM_DVDDriveEx1(instance *cim.WmiInstance) (newInstance *CIM_DVDDrive, err error) {tmp, err := NewCIM_MediaAccessDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DVDDrive, err error) {tmp, err := NewCIM_MediaAccessDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
