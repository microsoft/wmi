...
type CIM_ActiveConnection struct { 
	*CIM_SAPSAPDependency
	...
	func NewCIM_ActiveConnectionEx1(instance *cim.WmiInstance) (newInstance *CIM_ActiveConnection, err error) {tmp, err := NewCIM_SAPSAPDependencyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ActiveConnection, err error) {tmp, err := NewCIM_SAPSAPDependencyEx6(hostName, wmiNamespace, userName, password, domainName, query)
