...
type CIM_CollectionOfMSEs struct { 
	*CIM_Collection
	...
	func NewCIM_CollectionOfMSEsEx1(instance *cim.WmiInstance) (newInstance *CIM_CollectionOfMSEs, err error) {tmp, err := NewCIM_CollectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CollectionOfMSEs, err error) {tmp, err := NewCIM_CollectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
