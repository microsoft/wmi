...
type CIM_LANEndpoint struct { 
	*CIM_ProtocolEndpoint
	...
	func NewCIM_LANEndpointEx1(instance *cim.WmiInstance) (newInstance *CIM_LANEndpoint, err error) {tmp, err := NewCIM_ProtocolEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_LANEndpoint, err error) {tmp, err := NewCIM_ProtocolEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
