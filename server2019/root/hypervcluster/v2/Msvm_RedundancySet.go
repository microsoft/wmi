...
type Msvm_RedundancySet struct { 
	*CIM_RedundancySet
	...
	func NewMsvm_RedundancySetEx1(instance *cim.WmiInstance) (newInstance *Msvm_RedundancySet, err error) {tmp, err := NewCIM_RedundancySetEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_RedundancySet, err error) {tmp, err := NewCIM_RedundancySetEx6(hostName, wmiNamespace, userName, password, domainName, query)
