...
type CIM_EthernetPortAllocationSettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewCIM_EthernetPortAllocationSettingDataEx1(instance *cim.WmiInstance) (newInstance *CIM_EthernetPortAllocationSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_EthernetPortAllocationSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
