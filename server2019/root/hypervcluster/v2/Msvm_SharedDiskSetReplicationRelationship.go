...
type Msvm_SharedDiskSetReplicationRelationship struct { 
	*cim.WmiInstance
	...
	func NewMsvm_SharedDiskSetReplicationRelationshipEx1(instance *cim.WmiInstance) (newInstance *Msvm_SharedDiskSetReplicationRelationship, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SharedDiskSetReplicationRelationship, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
