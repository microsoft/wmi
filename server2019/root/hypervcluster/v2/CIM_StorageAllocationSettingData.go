...
type CIM_StorageAllocationSettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewCIM_StorageAllocationSettingDataEx1(instance *cim.WmiInstance) (newInstance *CIM_StorageAllocationSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_StorageAllocationSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
