...
type CIM_System struct { 
	*CIM_EnabledLogicalElement
	...
	func NewCIM_SystemEx1(instance *cim.WmiInstance) (newInstance *CIM_System, err error) {tmp, err := NewCIM_EnabledLogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_System, err error) {tmp, err := NewCIM_EnabledLogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
