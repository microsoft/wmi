...
type Msvm_FailoverIndication struct { 
	*CIM_ProcessIndication
	...
	func NewMsvm_FailoverIndicationEx1(instance *cim.WmiInstance) (newInstance *Msvm_FailoverIndication, err error) {tmp, err := NewCIM_ProcessIndicationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_FailoverIndication, err error) {tmp, err := NewCIM_ProcessIndicationEx6(hostName, wmiNamespace, userName, password, domainName, query)
