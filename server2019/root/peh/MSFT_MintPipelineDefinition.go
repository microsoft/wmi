...
type MSFT_MintPipelineDefinition struct { 
	*MSFT_PipelineDefinition
	...
	func NewMSFT_MintPipelineDefinitionEx1(instance *cim.WmiInstance) (newInstance *MSFT_MintPipelineDefinition, err error) {tmp, err := NewMSFT_PipelineDefinitionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MintPipelineDefinition, err error) {tmp, err := NewMSFT_PipelineDefinitionEx6(hostName, wmiNamespace, userName, password, domainName, query)
