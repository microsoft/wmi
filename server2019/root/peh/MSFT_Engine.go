...
type MSFT_Engine struct { 
	*cim.WmiInstance
	...
	func NewMSFT_EngineEx1(instance *cim.WmiInstance) (newInstance *MSFT_Engine, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_Engine, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_Engine) CreateDefaultRunspace( /* IN */ runspaceName string,
 /* OUT */ runspace MSFT_Runspace) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateDefaultRunspace" , runspaceName)
	if err != nil { return }
