...
type MSFT_ExpressionIdentifier struct { 
	*MSFT_Expression
	...
	func NewMSFT_ExpressionIdentifierEx1(instance *cim.WmiInstance) (newInstance *MSFT_ExpressionIdentifier, err error) {tmp, err := NewMSFT_ExpressionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ExpressionIdentifier, err error) {tmp, err := NewMSFT_ExpressionEx6(hostName, wmiNamespace, userName, password, domainName, query)
