...
type MSFT_PipelineDefinition struct { 
	*cim.WmiInstance
	...
	func NewMSFT_PipelineDefinitionEx1(instance *cim.WmiInstance) (newInstance *MSFT_PipelineDefinition, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_PipelineDefinition, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
