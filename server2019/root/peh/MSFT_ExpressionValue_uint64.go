...
type MSFT_ExpressionValue_uint64 struct { 
	*MSFT_ExpressionValue
	...
	func NewMSFT_ExpressionValue_uint64Ex1(instance *cim.WmiInstance) (newInstance *MSFT_ExpressionValue_uint64, err error) {tmp, err := NewMSFT_ExpressionValueEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ExpressionValue_uint64, err error) {tmp, err := NewMSFT_ExpressionValueEx6(hostName, wmiNamespace, userName, password, domainName, query)
