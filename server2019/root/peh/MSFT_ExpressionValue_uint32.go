...
func NewMSFT_ExpressionValue_uint32Ex1(instance *cim.WmiInstance) (newInstance *MSFT_ExpressionValue_uint32, err error) {
...
func NewMSFT_ExpressionValue_uint32Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_ExpressionValue_uint32, err error) {
