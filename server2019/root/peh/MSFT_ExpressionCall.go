...
type MSFT_ExpressionCall struct { 
	*MSFT_Expression
	...
	func NewMSFT_ExpressionCallEx1(instance *cim.WmiInstance) (newInstance *MSFT_ExpressionCall, err error) {tmp, err := NewMSFT_ExpressionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ExpressionCall, err error) {tmp, err := NewMSFT_ExpressionEx6(hostName, wmiNamespace, userName, password, domainName, query)
