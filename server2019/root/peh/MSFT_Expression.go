...
type MSFT_Expression struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ExpressionEx1(instance *cim.WmiInstance) (newInstance *MSFT_Expression, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_Expression, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
