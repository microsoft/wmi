...
type MSFT_Runspace struct { 
	*cim.WmiInstance
	...
	func NewMSFT_RunspaceEx1(instance *cim.WmiInstance) (newInstance *MSFT_Runspace, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_Runspace, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_Runspace) CreatePipeline( /* IN */ pipelineDefinitionInstanceId string,
 ...
 /* IN */ args interface{},
 /* OUT */ pipeline MSFT_Pipeline) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreatePipeline" , pipelineDefinitionInstanceId, pipelineName, args)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_Runspace) ImportModule( /* IN */ modules []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ImportModule" , modules);
	if err != nil { return }
