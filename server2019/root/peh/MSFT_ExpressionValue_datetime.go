...
type MSFT_ExpressionValue_datetime struct { 
	*MSFT_ExpressionValue
	...
	func NewMSFT_ExpressionValue_datetimeEx1(instance *cim.WmiInstance) (newInstance *MSFT_ExpressionValue_datetime, err error) {tmp, err := NewMSFT_ExpressionValueEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ExpressionValue_datetime, err error) {tmp, err := NewMSFT_ExpressionValueEx6(hostName, wmiNamespace, userName, password, domainName, query)
