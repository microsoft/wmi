...
func NewMSFT_ExpressionValue_uint16Ex1(instance *cim.WmiInstance) (newInstance *MSFT_ExpressionValue_uint16, err error) {
...
func NewMSFT_ExpressionValue_uint16Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_ExpressionValue_uint16, err error) {
