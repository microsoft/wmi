...
type MSFT_ExpressionKeywordParameter struct { 
	*MSFT_ExpressionIdentifier
	...
	func NewMSFT_ExpressionKeywordParameterEx1(instance *cim.WmiInstance) (newInstance *MSFT_ExpressionKeywordParameter, err error) {tmp, err := NewMSFT_ExpressionIdentifierEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ExpressionKeywordParameter, err error) {tmp, err := NewMSFT_ExpressionIdentifierEx6(hostName, wmiNamespace, userName, password, domainName, query)
