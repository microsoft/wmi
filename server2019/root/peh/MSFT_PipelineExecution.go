...
type MSFT_PipelineExecution struct { 
	*cim.WmiInstance
	...
	func NewMSFT_PipelineExecutionEx1(instance *cim.WmiInstance) (newInstance *MSFT_PipelineExecution, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_PipelineExecution, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
