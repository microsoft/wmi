...
type __ObjectProviderCacheControl struct { 
	*__CacheControl
	...
	func New__ObjectProviderCacheControlEx1(instance *cim.WmiInstance) (newInstance *__ObjectProviderCacheControl, err error) {tmp, err := New__CacheControlEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ObjectProviderCacheControl, err error) {tmp, err := New__CacheControlEx6(hostName, wmiNamespace, userName, password, domainName, query)
