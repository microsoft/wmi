...
type KernelQueueEnqueue struct { 
	*Thread_V2
	...
	func NewKernelQueueEnqueueEx1(instance *cim.WmiInstance) (newInstance *KernelQueueEnqueue, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelQueueEnqueue, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
