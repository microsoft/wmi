...
type MSParallel_DeviceBytesTransferred struct { 
	*MSParallel
	...
	func NewMSParallel_DeviceBytesTransferredEx1(instance *cim.WmiInstance) (newInstance *MSParallel_DeviceBytesTransferred, err error) {tmp, err := NewMSParallelEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSParallel_DeviceBytesTransferred, err error) {tmp, err := NewMSParallelEx6(hostName, wmiNamespace, userName, password, domainName, query)
