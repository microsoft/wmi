...
type MSVerifierIrpLogInformation struct { 
	*cim.WmiInstance
	...
	func NewMSVerifierIrpLogInformationEx1(instance *cim.WmiInstance) (newInstance *MSVerifierIrpLogInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSVerifierIrpLogInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
