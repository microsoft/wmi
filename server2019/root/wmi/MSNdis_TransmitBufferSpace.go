...
type MSNdis_TransmitBufferSpace struct { 
	*MSNdis
	...
	func NewMSNdis_TransmitBufferSpaceEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TransmitBufferSpace, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TransmitBufferSpace, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
