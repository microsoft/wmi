...
type NCSICtlGuid struct { 
	*EventTrace
	...
	func NewNCSICtlGuidEx1(instance *cim.WmiInstance) (newInstance *NCSICtlGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NCSICtlGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
