...
type MSNdis_PortChar struct { 
	*MSNdis
	...
	func NewMSNdis_PortCharEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PortChar, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PortChar, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
