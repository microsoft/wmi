...
type dcbwmiDCBWMI struct { 
	*EventTrace
	...
	func NewdcbwmiDCBWMIEx1(instance *cim.WmiInstance) (newInstance *dcbwmiDCBWMI, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *dcbwmiDCBWMI, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
