...
type HeapSnapShot struct { 
	*HeapTrace
	...
	func NewHeapSnapShotEx1(instance *cim.WmiInstance) (newInstance *HeapSnapShot, err error) {tmp, err := NewHeapTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapSnapShot, err error) {tmp, err := NewHeapTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
