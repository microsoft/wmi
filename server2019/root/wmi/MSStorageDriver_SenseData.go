...
type MSStorageDriver_SenseData struct { 
	*cim.WmiInstance
	...
	func NewMSStorageDriver_SenseDataEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_SenseData, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSStorageDriver_SenseData, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
