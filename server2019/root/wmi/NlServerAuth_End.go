...
type NlServerAuth_End struct { 
	*NlServerAuth
	...
	func NewNlServerAuth_EndEx1(instance *cim.WmiInstance) (newInstance *NlServerAuth_End, err error) {tmp, err := NewNlServerAuthEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NlServerAuth_End, err error) {tmp, err := NewNlServerAuthEx6(hostName, wmiNamespace, userName, password, domainName, query)
