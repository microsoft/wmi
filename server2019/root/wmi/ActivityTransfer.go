...
type ActivityTransfer struct { 
	*WSAT_TraceEvent
	...
	func NewActivityTransferEx1(instance *cim.WmiInstance) (newInstance *ActivityTransfer, err error) {tmp, err := NewWSAT_TraceEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ActivityTransfer, err error) {tmp, err := NewWSAT_TraceEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
