...
type PoolAllocFree struct { 
	*PoolTrace
	...
	func NewPoolAllocFreeEx1(instance *cim.WmiInstance) (newInstance *PoolAllocFree, err error) {tmp, err := NewPoolTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PoolAllocFree, err error) {tmp, err := NewPoolTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
