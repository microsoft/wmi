...
type PageFault_VirtualAllocRundown struct { 
	*PageFault_V2
	...
	func NewPageFault_VirtualAllocRundownEx1(instance *cim.WmiInstance) (newInstance *PageFault_VirtualAllocRundown, err error) {tmp, err := NewPageFault_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PageFault_VirtualAllocRundown, err error) {tmp, err := NewPageFault_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
