...
type BcdDeviceLocateElementData struct { 
	*BcdDeviceLocateData
	...
	func NewBcdDeviceLocateElementDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceLocateElementData, err error) {tmp, err := NewBcdDeviceLocateDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdDeviceLocateElementData, err error) {tmp, err := NewBcdDeviceLocateDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
