...
type MSNdis_NicSwitchCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_NicSwitchCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NicSwitchCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_NicSwitchCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
