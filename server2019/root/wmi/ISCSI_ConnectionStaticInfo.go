...
type ISCSI_ConnectionStaticInfo struct { 
	*cim.WmiInstance
	...
	func NewISCSI_ConnectionStaticInfoEx1(instance *cim.WmiInstance) (newInstance *ISCSI_ConnectionStaticInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISCSI_ConnectionStaticInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
