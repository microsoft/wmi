...
// SystemConfig_V1_Video struct
type SystemConfig_V1_Video struct { 
	*SystemConfig_V1
	...
	func NewSystemConfig_V1_VideoEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_Video, err error) {tmp, err := NewSystemConfig_V1Ex1(instance)
		
	if err != nil { return }
	newInstance = &SystemConfig_V1_Video {
	SystemConfig_V1: tmp,
	}
	return
	}
	...
	func NewSystemConfig_V1_VideoEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V1_Video, err error) {tmp, err := NewSystemConfig_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SystemConfig_V1_Video) SetPropertyAdapterString(value []byte) (err error) { 
    return instance.SetProperty("AdapterString", (value))
}

// GetAdapterString gets the value of AdapterString for the instance
func (instance *SystemConfig_V1_Video) GetPropertyAdapterString()(value []byte, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyBiosString(value []byte) (err error) { 
    return instance.SetProperty("BiosString", (value))
}

// GetBiosString gets the value of BiosString for the instance
func (instance *SystemConfig_V1_Video) GetPropertyBiosString()(value []byte, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyBitsPerPixel(value uint32) (err error) { 
    return instance.SetProperty("BitsPerPixel", (value))
}

// GetBitsPerPixel gets the value of BitsPerPixel for the instance
func (instance *SystemConfig_V1_Video) GetPropertyBitsPerPixel()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyChipType(value []byte) (err error) { 
    return instance.SetProperty("ChipType", (value))
}

// GetChipType gets the value of ChipType for the instance
func (instance *SystemConfig_V1_Video) GetPropertyChipType()(value []byte, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyDACType(value []byte) (err error) { 
    return instance.SetProperty("DACType", (value))
}

// GetDACType gets the value of DACType for the instance
func (instance *SystemConfig_V1_Video) GetPropertyDACType()(value []byte, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyDeviceId(value []byte) (err error) { 
    return instance.SetProperty("DeviceId", (value))
}

// GetDeviceId gets the value of DeviceId for the instance
func (instance *SystemConfig_V1_Video) GetPropertyDeviceId()(value []byte, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyMemorySize(value uint32) (err error) { 
    return instance.SetProperty("MemorySize", (value))
}

// GetMemorySize gets the value of MemorySize for the instance
func (instance *SystemConfig_V1_Video) GetPropertyMemorySize()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyStateFlags(value uint32) (err error) { 
    return instance.SetProperty("StateFlags", (value))
}

// GetStateFlags gets the value of StateFlags for the instance
func (instance *SystemConfig_V1_Video) GetPropertyStateFlags()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyVRefresh(value uint32) (err error) { 
    return instance.SetProperty("VRefresh", (value))
}

// GetVRefresh gets the value of VRefresh for the instance
func (instance *SystemConfig_V1_Video) GetPropertyVRefresh()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyXResolution(value uint32) (err error) { 
    return instance.SetProperty("XResolution", (value))
}

// GetXResolution gets the value of XResolution for the instance
func (instance *SystemConfig_V1_Video) GetPropertyXResolution()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_Video) SetPropertyYResolution(value uint32) (err error) { 
    return instance.SetProperty("YResolution", (value))
}

// GetYResolution gets the value of YResolution for the instance
func (instance *SystemConfig_V1_Video) GetPropertyYResolution()(value uint32, err error) { 
