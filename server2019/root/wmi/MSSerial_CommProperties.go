...
type MSSerial_CommProperties struct { 
	*MSSerial
	...
	func NewMSSerial_CommPropertiesEx1(instance *cim.WmiInstance) (newInstance *MSSerial_CommProperties, err error) {tmp, err := NewMSSerialEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSerial_CommProperties, err error) {tmp, err := NewMSSerialEx6(hostName, wmiNamespace, userName, password, domainName, query)
