...
type MSNdis_PortArray struct { 
	*MSNdis
	...
	func NewMSNdis_PortArrayEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PortArray, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PortArray, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
