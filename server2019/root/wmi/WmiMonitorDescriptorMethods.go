...
type WmiMonitorDescriptorMethods struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorDescriptorMethodsEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorDescriptorMethods, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorDescriptorMethods, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *WmiMonitorDescriptorMethods) WmiGetMonitorRawEEdidV1Block( /* IN */ BlockId uint8,
 /* OUT */ BlockType uint8,
 /* OUT */ BlockContent []uint8) (err error) {_, err = instance.InvokeMethod("WmiGetMonitorRawEEdidV1Block" , BlockId)
	if err != nil { return }
	return
