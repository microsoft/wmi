...
type MSNdis_TcpConnectionOffloadCurrentConfig struct { 
	*MSNdis
	...
	func NewMSNdis_TcpConnectionOffloadCurrentConfigEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TcpConnectionOffloadCurrentConfig, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TcpConnectionOffloadCurrentConfig, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_TcpConnectionOffloadCurrentConfig) WmiQueryTcpConnectionOffloadCurrentConfig( /* IN */ Header MSNdis_WmiMethodHeader,
 /* OUT */ Offload MSNdis_WmiTcpConnectionOffload) (err error) {_, err = instance.InvokeMethod("WmiQueryTcpConnectionOffloadCurrentConfig" , Header)
	if err != nil { return }
	return
