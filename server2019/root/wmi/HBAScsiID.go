...
type HBAScsiID struct { 
	*cim.WmiInstance
	...
	func NewHBAScsiIDEx1(instance *cim.WmiInstance) (newInstance *HBAScsiID, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HBAScsiID, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
