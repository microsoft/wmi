...
type Header_PartitionInfoExtension_TypeGroup struct { 
	*EventTraceEvent
	...
	func NewHeader_PartitionInfoExtension_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_PartitionInfoExtension_TypeGroup, err error) {tmp, err := NewEventTraceEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Header_PartitionInfoExtension_TypeGroup, err error) {tmp, err := NewEventTraceEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
