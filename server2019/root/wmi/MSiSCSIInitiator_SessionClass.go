...
type MSiSCSIInitiator_SessionClass struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_SessionClassEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_SessionClass, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_SessionClass, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSiSCSIInitiator_SessionClass) Logout() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Logout" );
	if err != nil { return }
...
func (instance *MSiSCSIInitiator_SessionClass) SendScsiInquiry( /* IN */ Lun uint64,
 ...
 /* OUT */ SenseBuffer []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("SendScsiInquiry" , Lun, EvpdCmddt, PageCode)
	if err != nil { return }
...
func (instance *MSiSCSIInitiator_SessionClass) SendScsiReadCapacity( /* IN */ Lun uint64,
 /* OUT */ ScsiStatus uint8,
 /* OUT */ ResponseBuffer []uint8,
 /* OUT */ SenseBuffer []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("SendScsiReadCapacity" , Lun)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSiSCSIInitiator_SessionClass) SendScsiReportLuns( /* OUT */ ScsiStatus uint8,
 /* OUT */ ResponseBuffer []uint8,
 /* OUT */ SenseBuffer []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("SendScsiReportLuns" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSiSCSIInitiator_SessionClass) AddConnection( /* IN */ InitiatorPortNumber uint32,
 ...
 /* IN */ key []uint8,
 /* OUT */ UniqueConnectionId string) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddConnection" , InitiatorPortNumber, TargetPortal, SecurityFlags, LoginOptions, key)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSiSCSIInitiator_SessionClass) RemoveConnection( /* IN */ UniqueConnectionId string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveConnection" , UniqueConnectionId);
	if err != nil { return }
	result = uint32(retVal)
	return
