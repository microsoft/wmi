...
type ClusBfltDeviceMethods struct { 
	*cim.WmiInstance
	...
	func NewClusBfltDeviceMethodsEx1(instance *cim.WmiInstance) (newInstance *ClusBfltDeviceMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltDeviceMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *ClusBfltDeviceMethods) GetDeviceAttributes( /* IN */ DeviceGuid string,
 /* OUT */ Attributes uint32) (err error) {_, err = instance.InvokeMethod("GetDeviceAttributes" , DeviceGuid)
	if err != nil { return }
	return
...
func (instance *ClusBfltDeviceMethods) SetDeviceAttributes( /* IN */ DeviceGuid string,
 ...
 /* IN */ AttributesMask uint32) (err error) {_, err = instance.InvokeMethodWithReturn("SetDeviceAttributes" , DeviceGuid, Attributes, AttributesMask);
	if err != nil { return }
	return
...
func (instance *ClusBfltDeviceMethods) PauseDeviceIOs( /* IN */ DeviceGuid string,
 /* IN */ TimeMs uint32) (err error) {_, err = instance.InvokeMethodWithReturn("PauseDeviceIOs" , DeviceGuid, TimeMs);
	if err != nil { return }
	return
...
// <param name="DeviceGuid" type="string ">Device Id</param>
func (instance *ClusBfltDeviceMethods) ResumeDeviceIOs( /* IN */ DeviceGuid string) (err error) {_, err = instance.InvokeMethodWithReturn("ResumeDeviceIOs" , DeviceGuid);
	if err != nil { return }
	return
...
func (instance *ClusBfltDeviceMethods) RefreshRegParams( /* OUT */ fRebootRequired bool) (err error) {_, err = instance.InvokeMethod("RefreshRegParams" )
	if err != nil { return }
	return
