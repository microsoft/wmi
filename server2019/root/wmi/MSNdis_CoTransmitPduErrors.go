...
func NewMSNdis_CoTransmitPduErrorsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_CoTransmitPduErrors, err error) {
...
func NewMSNdis_CoTransmitPduErrorsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_CoTransmitPduErrors, err error) {
