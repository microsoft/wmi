...
func NewMSNdis_80211_ConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_Configuration, err error) {
...
func NewMSNdis_80211_ConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_Configuration, err error) {
