...
type StackWalk_TypeGroup1 struct { 
	*StackWalk
	...
	func NewStackWalk_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *StackWalk_TypeGroup1, err error) {tmp, err := NewStackWalkEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *StackWalk_TypeGroup1, err error) {tmp, err := NewStackWalkEx6(hostName, wmiNamespace, userName, password, domainName, query)
