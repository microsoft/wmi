...
type MSTapeDriveProblemEvent struct { 
	*WMIEvent
	...
	func NewMSTapeDriveProblemEventEx1(instance *cim.WmiInstance) (newInstance *MSTapeDriveProblemEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSTapeDriveProblemEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
