...
type HypercallPage struct { 
	*Image_V2
	...
	func NewHypercallPageEx1(instance *cim.WmiInstance) (newInstance *HypercallPage, err error) {tmp, err := NewImage_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HypercallPage, err error) {tmp, err := NewImage_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
