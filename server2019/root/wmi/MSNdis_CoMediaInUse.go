...
type MSNdis_CoMediaInUse struct { 
	*MSNdis
	...
	func NewMSNdis_CoMediaInUseEx1(instance *cim.WmiInstance) (newInstance *MSNdis_CoMediaInUse, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_CoMediaInUse, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
