...
type WHEAPolicyManagementMethods struct { 
	*WHEA
	...
	func NewWHEAPolicyManagementMethodsEx1(instance *cim.WmiInstance) (newInstance *WHEAPolicyManagementMethods, err error) {tmp, err := NewWHEAEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WHEAPolicyManagementMethods, err error) {tmp, err := NewWHEAEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *WHEAPolicyManagementMethods) WheaGetAllPolicyRtn( /* OUT */ Status uint32,
 /* OUT */ Count uint32,
 /* OUT */ Length uint32,
 /* OUT */ Values []uint8) (err error) {_, err = instance.InvokeMethod("WheaGetAllPolicyRtn" )
	if err != nil { return }
	return
...
func (instance *WHEAPolicyManagementMethods) WheaGetPolicyRtn( /* OUT */ Status uint32,
 ...
 /* OUT */ Value uint32) (err error) {_, err = instance.InvokeMethod("WheaGetPolicyRtn" , Type)
	if err != nil { return }
	return
...
func (instance *WHEAPolicyManagementMethods) WheaSetPolicyRtn( /* OUT */ Status uint32,
 /* OPTIONAL IN */ Type uint32,
 /* OPTIONAL IN */ Value uint32) (err error) {_, err = instance.InvokeMethod("WheaSetPolicyRtn" , Type, Value)
	if err != nil { return }
	return
...
// <param name="Status" type="uint32 "></param>
func (instance *WHEAPolicyManagementMethods) WheaCommitPolicyRtn( /* OUT */ Status uint32) (err error) {_, err = instance.InvokeMethod("WheaCommitPolicyRtn" )
	if err != nil { return }
	return
...
// <param name="Status" type="uint32 "></param>
func (instance *WHEAPolicyManagementMethods) WheaResetPolicyRtn( /* OUT */ Status uint32) (err error) {_, err = instance.InvokeMethod("WheaResetPolicyRtn" )
	if err != nil { return }
	return
