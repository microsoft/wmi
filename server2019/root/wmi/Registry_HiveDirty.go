...
type Registry_HiveDirty struct { 
	*Registry
	...
	func NewRegistry_HiveDirtyEx1(instance *cim.WmiInstance) (newInstance *Registry_HiveDirty, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_HiveDirty, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
