...
func NewWDMClassesOfDriverEx1(instance *cim.WmiInstance) (newInstance *WDMClassesOfDriver, err error) {
...
func NewWDMClassesOfDriverEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WDMClassesOfDriver, err error) {
