...
type SystemConfig_Virtualization struct { 
	*SystemConfig_V2
	...
	func NewSystemConfig_VirtualizationEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_Virtualization, err error) {tmp, err := NewSystemConfig_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_Virtualization, err error) {tmp, err := NewSystemConfig_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
