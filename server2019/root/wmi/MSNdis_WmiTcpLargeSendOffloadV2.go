...
type MSNdis_WmiTcpLargeSendOffloadV2 struct { 
	*MSNdis
	...
	func NewMSNdis_WmiTcpLargeSendOffloadV2Ex1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiTcpLargeSendOffloadV2, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiTcpLargeSendOffloadV2, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
