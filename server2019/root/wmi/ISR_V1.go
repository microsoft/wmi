...
type ISR_V1 struct { 
	*PerfInfo_V1
	...
	func NewISR_V1Ex1(instance *cim.WmiInstance) (newInstance *ISR_V1, err error) {tmp, err := NewPerfInfo_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISR_V1, err error) {tmp, err := NewPerfInfo_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
