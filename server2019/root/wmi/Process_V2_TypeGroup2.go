...
type Process_V2_TypeGroup2 struct { 
	*Process_V2
	...
	func NewProcess_V2_TypeGroup2Ex1(instance *cim.WmiInstance) (newInstance *Process_V2_TypeGroup2, err error) {tmp, err := NewProcess_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Process_V2_TypeGroup2, err error) {tmp, err := NewProcess_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
