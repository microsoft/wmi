...
type KernelThermalPolicyChange struct { 
	*WMIEvent
	...
	func NewKernelThermalPolicyChangeEx1(instance *cim.WmiInstance) (newInstance *KernelThermalPolicyChange, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelThermalPolicyChange, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
