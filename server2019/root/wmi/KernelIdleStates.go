...
type KernelIdleStates struct { 
	*MSKernelPpmClass
	...
	func NewKernelIdleStatesEx1(instance *cim.WmiInstance) (newInstance *KernelIdleStates, err error) {tmp, err := NewMSKernelPpmClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelIdleStates, err error) {tmp, err := NewMSKernelPpmClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
