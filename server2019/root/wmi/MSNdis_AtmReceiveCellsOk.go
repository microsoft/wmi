...
type MSNdis_AtmReceiveCellsOk struct { 
	*MSNdis
	...
	func NewMSNdis_AtmReceiveCellsOkEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmReceiveCellsOk, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmReceiveCellsOk, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
