...
type MSNdis_WmiTcpIpChecksumOffload struct { 
	*MSNdis
	...
	func NewMSNdis_WmiTcpIpChecksumOffloadEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiTcpIpChecksumOffload, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiTcpIpChecksumOffload, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
