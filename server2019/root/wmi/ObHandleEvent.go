...
type ObHandleEvent struct { 
	*ObTrace
	...
	func NewObHandleEventEx1(instance *cim.WmiInstance) (newInstance *ObHandleEvent, err error) {tmp, err := NewObTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ObHandleEvent, err error) {tmp, err := NewObTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
