...
type AntiStarvationBoost struct { 
	*Thread_V2
	...
	func NewAntiStarvationBoostEx1(instance *cim.WmiInstance) (newInstance *AntiStarvationBoost, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AntiStarvationBoost, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
