...
type BcdStringElement struct { 
	*BcdElement
	...
	func NewBcdStringElementEx1(instance *cim.WmiInstance) (newInstance *BcdStringElement, err error) {tmp, err := NewBcdElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdStringElement, err error) {tmp, err := NewBcdElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
