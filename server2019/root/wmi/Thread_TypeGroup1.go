...
type Thread_TypeGroup1 struct { 
	*Thread_V4
	...
	func NewThread_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Thread_TypeGroup1, err error) {tmp, err := NewThread_V4Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Thread_TypeGroup1, err error) {tmp, err := NewThread_V4Ex6(hostName, wmiNamespace, userName, password, domainName, query)
