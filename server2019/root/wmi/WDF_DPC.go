...
type WDF_DPC struct { 
	*PerfInfo_V2
	...
	func NewWDF_DPCEx1(instance *cim.WmiInstance) (newInstance *WDF_DPC, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WDF_DPC, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
