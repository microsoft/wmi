...
type MSiSCSIInitiator_PortalGroup struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_PortalGroupEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_PortalGroup, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_PortalGroup, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
