...
type MSNdis_StatusDevicePowerOnEx struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusDevicePowerOnExEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusDevicePowerOnEx, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusDevicePowerOnEx, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
