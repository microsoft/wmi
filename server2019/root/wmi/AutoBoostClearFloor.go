...
type AutoBoostClearFloor struct { 
	*Thread_V2
	...
	func NewAutoBoostClearFloorEx1(instance *cim.WmiInstance) (newInstance *AutoBoostClearFloor, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AutoBoostClearFloor, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
