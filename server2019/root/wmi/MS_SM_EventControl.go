...
type MS_SM_EventControl struct { 
	*cim.WmiInstance
	...
	func NewMS_SM_EventControlEx1(instance *cim.WmiInstance) (newInstance *MS_SM_EventControl, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SM_EventControl, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MS_SM_EventControl) SM_AddTarget( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_AddTarget" , HbaPortWWN, DiscoveredPortWWN, DomainPortWWN, AllTargets)
	if err != nil { return }
	return
...
func (instance *MS_SM_EventControl) SM_RemoveTarget( /* IN */ HbaPortWWN []uint8,
 ...
 /* IN */ DomainPortWWN []uint8,
 /* IN */ AllTargets uint32,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_RemoveTarget" , HbaPortWWN, DiscoveredPortWWN, DomainPortWWN, AllTargets)
	if err != nil { return }
	return
...
func (instance *MS_SM_EventControl) SM_AddPort( /* IN */ PortWWN []uint8,
 /* IN */ EventType uint32,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_AddPort" , PortWWN, EventType)
	if err != nil { return }
	return
...
func (instance *MS_SM_EventControl) SM_RemovePort( /* IN */ PortWWN []uint8,
 /* IN */ EventType uint32,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_RemovePort" , PortWWN, EventType)
	if err != nil { return }
	return
...
// <param name="HBAStatus" type="uint32 "></param>
func (instance *MS_SM_EventControl) SM_AddLink( /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_AddLink" )
	if err != nil { return }
	return
...
// <param name="HBAStatus" type="uint32 "></param>
func (instance *MS_SM_EventControl) SM_RemoveLink( /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_RemoveLink" )
	if err != nil { return }
	return
