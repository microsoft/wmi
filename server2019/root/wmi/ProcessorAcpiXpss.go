...
type ProcessorAcpiXpss struct { 
	*cim.WmiInstance
	...
	func NewProcessorAcpiXpssEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiXpss, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorAcpiXpss, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
