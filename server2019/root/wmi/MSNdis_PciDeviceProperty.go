...
type MSNdis_PciDeviceProperty struct { 
	*MSNdis
	...
	func NewMSNdis_PciDevicePropertyEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PciDeviceProperty, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PciDeviceProperty, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
