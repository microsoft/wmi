...
type TSRdpInitTrace struct { 
	*EventTrace
	...
	func NewTSRdpInitTraceEx1(instance *cim.WmiInstance) (newInstance *TSRdpInitTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TSRdpInitTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
