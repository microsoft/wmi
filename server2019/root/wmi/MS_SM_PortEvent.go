...
type MS_SM_PortEvent struct { 
	*WMIEvent
	...
	func NewMS_SM_PortEventEx1(instance *cim.WmiInstance) (newInstance *MS_SM_PortEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SM_PortEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
