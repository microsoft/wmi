...
type SamProcessMappedAttributes_Start struct { 
	*SamProcessMappedAttributes
	...
	func NewSamProcessMappedAttributes_StartEx1(instance *cim.WmiInstance) (newInstance *SamProcessMappedAttributes_Start, err error) {tmp, err := NewSamProcessMappedAttributesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamProcessMappedAttributes_Start, err error) {tmp, err := NewSamProcessMappedAttributesEx6(hostName, wmiNamespace, userName, password, domainName, query)
