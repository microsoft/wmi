...
type WHEAErrorSourceMethods struct { 
	*WHEA
	...
	func NewWHEAErrorSourceMethodsEx1(instance *cim.WmiInstance) (newInstance *WHEAErrorSourceMethods, err error) {tmp, err := NewWHEAEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WHEAErrorSourceMethods, err error) {tmp, err := NewWHEAEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *WHEAErrorSourceMethods) GetAllErrorSourcesRtn( /* OUT */ Status uint32,
 /* OUT */ Count uint32,
 /* OUT */ Length uint32,
 /* OUT */ ErrorSourceArray []uint8) (err error) {_, err = instance.InvokeMethod("GetAllErrorSourcesRtn" )
	if err != nil { return }
	return
...
func (instance *WHEAErrorSourceMethods) GetErrorSourceInfoRtn( /* OUT */ Status uint32,
 ...
 /* OUT */ Length uint32,
 /* OUT */ ErrorSourceInfo []uint8) (err error) {_, err = instance.InvokeMethod("GetErrorSourceInfoRtn" , ErrorSourceId)
	if err != nil { return }
	return
...
func (instance *WHEAErrorSourceMethods) SetErrorSourceInfoRtn( /* OUT */ Status uint32,
 ...
 /* OPTIONAL IN */ ErrorSourceInfo []uint8) (err error) {_, err = instance.InvokeMethod("SetErrorSourceInfoRtn" , Length, ErrorSourceInfo)
	if err != nil { return }
	return
...
func (instance *WHEAErrorSourceMethods) EnableErrorSourceRtn( /* OUT */ Status uint32,
 /* OPTIONAL IN */ ErrorSourceId uint32) (err error) {_, err = instance.InvokeMethod("EnableErrorSourceRtn" , ErrorSourceId)
	if err != nil { return }
	return
...
func (instance *WHEAErrorSourceMethods) DisableErrorSourceRtn( /* OUT */ Status uint32,
 /* OPTIONAL IN */ ErrorSourceId uint32) (err error) {_, err = instance.InvokeMethod("DisableErrorSourceRtn" , ErrorSourceId)
	if err != nil { return }
	return
