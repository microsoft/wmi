...
type MSNdis_PMCapabilitiesParam struct { 
	*MSNdis
	...
	func NewMSNdis_PMCapabilitiesParamEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PMCapabilitiesParam, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PMCapabilitiesParam, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
