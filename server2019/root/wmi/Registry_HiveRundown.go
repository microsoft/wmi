...
type Registry_HiveRundown struct { 
	*Registry
	...
	func NewRegistry_HiveRundownEx1(instance *cim.WmiInstance) (newInstance *Registry_HiveRundown, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_HiveRundown, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
