...
type MSiSCSI_MMIPSECStats struct { 
	*Win32_PerfRawData
	...
	func NewMSiSCSI_MMIPSECStatsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_MMIPSECStats, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_MMIPSECStats, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
