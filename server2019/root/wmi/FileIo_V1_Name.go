...
type FileIo_V1_Name struct { 
	*FileIo_V1
	...
	func NewFileIo_V1_NameEx1(instance *cim.WmiInstance) (newInstance *FileIo_V1_Name, err error) {tmp, err := NewFileIo_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_V1_Name, err error) {tmp, err := NewFileIo_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
