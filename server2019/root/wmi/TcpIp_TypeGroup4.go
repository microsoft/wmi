...
type TcpIp_TypeGroup4 struct { 
	*TcpIp
	...
	func NewTcpIp_TypeGroup4Ex1(instance *cim.WmiInstance) (newInstance *TcpIp_TypeGroup4, err error) {tmp, err := NewTcpIpEx1(instance)
		
	if err != nil { return }
	newInstance = &TcpIp_TypeGroup4 {
	TcpIp: tmp,
	}
	return
	}
	...
	func NewTcpIp_TypeGroup4Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TcpIp_TypeGroup4, err error) {tmp, err := NewTcpIpEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *TcpIp_TypeGroup4) SetPropertyconnid(value uint32) (err error) { 
    return instance.SetProperty("connid", (value))
}

// Getconnid gets the value of connid for the instance
func (instance *TcpIp_TypeGroup4) GetPropertyconnid()(value uint32, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertydaddr(value interface{}) (err error) { 
    return instance.SetProperty("daddr", (value))
}

// Getdaddr gets the value of daddr for the instance
func (instance *TcpIp_TypeGroup4) GetPropertydaddr()(value interface{}, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertydport(value interface{}) (err error) { 
    return instance.SetProperty("dport", (value))
}

// Getdport gets the value of dport for the instance
func (instance *TcpIp_TypeGroup4) GetPropertydport()(value interface{}, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertymss(value uint16) (err error) { 
    return instance.SetProperty("mss", (value))
}

// Getmss gets the value of mss for the instance
func (instance *TcpIp_TypeGroup4) GetPropertymss()(value uint16, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertyPID(value uint32) (err error) { 
    return instance.SetProperty("PID", (value))
}

// GetPID gets the value of PID for the instance
func (instance *TcpIp_TypeGroup4) GetPropertyPID()(value uint32, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertyrcvwin(value uint32) (err error) { 
    return instance.SetProperty("rcvwin", (value))
}

// Getrcvwin gets the value of rcvwin for the instance
func (instance *TcpIp_TypeGroup4) GetPropertyrcvwin()(value uint32, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertyrcvwinscale(value int16) (err error) { 
    return instance.SetProperty("rcvwinscale", (value))
}

// Getrcvwinscale gets the value of rcvwinscale for the instance
func (instance *TcpIp_TypeGroup4) GetPropertyrcvwinscale()(value int16, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertysackopt(value uint16) (err error) { 
    return instance.SetProperty("sackopt", (value))
}

// Getsackopt gets the value of sackopt for the instance
func (instance *TcpIp_TypeGroup4) GetPropertysackopt()(value uint16, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertysaddr(value interface{}) (err error) { 
    return instance.SetProperty("saddr", (value))
}

// Getsaddr gets the value of saddr for the instance
func (instance *TcpIp_TypeGroup4) GetPropertysaddr()(value interface{}, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertyseqnum(value uint32) (err error) { 
    return instance.SetProperty("seqnum", (value))
}

// Getseqnum gets the value of seqnum for the instance
func (instance *TcpIp_TypeGroup4) GetPropertyseqnum()(value uint32, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertysize(value uint32) (err error) { 
    return instance.SetProperty("size", (value))
}

// Getsize gets the value of size for the instance
func (instance *TcpIp_TypeGroup4) GetPropertysize()(value uint32, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertysndwinscale(value int16) (err error) { 
    return instance.SetProperty("sndwinscale", (value))
}

// Getsndwinscale gets the value of sndwinscale for the instance
func (instance *TcpIp_TypeGroup4) GetPropertysndwinscale()(value int16, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertysport(value interface{}) (err error) { 
    return instance.SetProperty("sport", (value))
}

// Getsport gets the value of sport for the instance
func (instance *TcpIp_TypeGroup4) GetPropertysport()(value interface{}, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertytsopt(value uint16) (err error) { 
    return instance.SetProperty("tsopt", (value))
}

// Gettsopt gets the value of tsopt for the instance
func (instance *TcpIp_TypeGroup4) GetPropertytsopt()(value uint16, err error) { 
...
func (instance *TcpIp_TypeGroup4) SetPropertywsopt(value uint16) (err error) { 
    return instance.SetProperty("wsopt", (value))
}

// Getwsopt gets the value of wsopt for the instance
func (instance *TcpIp_TypeGroup4) GetPropertywsopt()(value uint16, err error) { 
