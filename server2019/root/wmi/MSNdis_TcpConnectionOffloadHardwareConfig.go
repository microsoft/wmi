...
type MSNdis_TcpConnectionOffloadHardwareConfig struct { 
	*MSNdis
	...
	func NewMSNdis_TcpConnectionOffloadHardwareConfigEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TcpConnectionOffloadHardwareConfig, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TcpConnectionOffloadHardwareConfig, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_TcpConnectionOffloadHardwareConfig) WmiQueryTcpConnectionOffloadHardwareConfig( /* IN */ Header MSNdis_WmiMethodHeader,
 /* OUT */ Offload MSNdis_WmiTcpConnectionOffload) (err error) {_, err = instance.InvokeMethod("WmiQueryTcpConnectionOffloadHardwareConfig" , Header)
	if err != nil { return }
	return
