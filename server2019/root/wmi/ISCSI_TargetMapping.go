...
type ISCSI_TargetMapping struct { 
	*cim.WmiInstance
	...
	func NewISCSI_TargetMappingEx1(instance *cim.WmiInstance) (newInstance *ISCSI_TargetMapping, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISCSI_TargetMapping, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
