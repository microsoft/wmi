...
type MSPower_DeviceWakeEnable struct { 
	*MSPower
	...
	func NewMSPower_DeviceWakeEnableEx1(instance *cim.WmiInstance) (newInstance *MSPower_DeviceWakeEnable, err error) {tmp, err := NewMSPowerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSPower_DeviceWakeEnable, err error) {tmp, err := NewMSPowerEx6(hostName, wmiNamespace, userName, password, domainName, query)
