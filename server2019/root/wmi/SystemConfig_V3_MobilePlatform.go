...
type SystemConfig_V3_MobilePlatform struct { 
	*SystemConfig_V3
	...
	func NewSystemConfig_V3_MobilePlatformEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V3_MobilePlatform, err error) {tmp, err := NewSystemConfig_V3Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V3_MobilePlatform, err error) {tmp, err := NewSystemConfig_V3Ex6(hostName, wmiNamespace, userName, password, domainName, query)
