...
type AcpiPct struct { 
	*cim.WmiInstance
	...
	func NewAcpiPctEx1(instance *cim.WmiInstance) (newInstance *AcpiPct, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AcpiPct, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
