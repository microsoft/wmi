...
type Mark_V0 struct { 
	*PerfInfo_V0
	...
	func NewMark_V0Ex1(instance *cim.WmiInstance) (newInstance *Mark_V0, err error) {tmp, err := NewPerfInfo_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Mark_V0, err error) {tmp, err := NewPerfInfo_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
