...
type MSiSCSI_BootConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_BootConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_BootConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_BootConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
