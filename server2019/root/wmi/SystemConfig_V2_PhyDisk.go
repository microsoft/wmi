...
// SystemConfig_V2_PhyDisk struct
type SystemConfig_V2_PhyDisk struct { 
	*SystemConfig_V2
	...
	func NewSystemConfig_V2_PhyDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_PhyDisk, err error) {tmp, err := NewSystemConfig_V2Ex1(instance)
		
	if err != nil { return }
	newInstance = &SystemConfig_V2_PhyDisk {
	SystemConfig_V2: tmp,
	}
	return
	}
	...
	func NewSystemConfig_V2_PhyDiskEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V2_PhyDisk, err error) {tmp, err := NewSystemConfig_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyBootDriveLetter(value []byte) (err error) { 
    return instance.SetProperty("BootDriveLetter", (value))
}

// GetBootDriveLetter gets the value of BootDriveLetter for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertyBootDriveLetter()(value []byte, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyBytesPerSector(value uint32) (err error) { 
    return instance.SetProperty("BytesPerSector", (value))
}

// GetBytesPerSector gets the value of BytesPerSector for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertyBytesPerSector()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyCylinders(value uint64) (err error) { 
    return instance.SetProperty("Cylinders", (value))
}

// GetCylinders gets the value of Cylinders for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertyCylinders()(value uint64, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyDiskNumber(value uint32) (err error) { 
    return instance.SetProperty("DiskNumber", (value))
}

// GetDiskNumber gets the value of DiskNumber for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertyDiskNumber()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyManufacturer(value []byte) (err error) { 
    return instance.SetProperty("Manufacturer", (value))
}

// GetManufacturer gets the value of Manufacturer for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertyManufacturer()(value []byte, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyPad(value uint8) (err error) { 
    return instance.SetProperty("Pad", (value))
}

// GetPad gets the value of Pad for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertyPad()(value uint8, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyPartitionCount(value uint32) (err error) { 
    return instance.SetProperty("PartitionCount", (value))
}

// GetPartitionCount gets the value of PartitionCount for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertyPartitionCount()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertySCSILun(value uint32) (err error) { 
    return instance.SetProperty("SCSILun", (value))
}

// GetSCSILun gets the value of SCSILun for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertySCSILun()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertySCSIPath(value uint32) (err error) { 
    return instance.SetProperty("SCSIPath", (value))
}

// GetSCSIPath gets the value of SCSIPath for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertySCSIPath()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertySCSIPort(value uint32) (err error) { 
    return instance.SetProperty("SCSIPort", (value))
}

// GetSCSIPort gets the value of SCSIPort for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertySCSIPort()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertySCSITarget(value uint32) (err error) { 
    return instance.SetProperty("SCSITarget", (value))
}

// GetSCSITarget gets the value of SCSITarget for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertySCSITarget()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertySectorsPerTrack(value uint32) (err error) { 
    return instance.SetProperty("SectorsPerTrack", (value))
}

// GetSectorsPerTrack gets the value of SectorsPerTrack for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertySectorsPerTrack()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertySpare(value []byte) (err error) { 
    return instance.SetProperty("Spare", (value))
}

// GetSpare gets the value of Spare for the instance
func (instance *SystemConfig_V2_PhyDisk) GetPropertySpare()(value []byte, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyTracksPerCylinder(value uint32) (err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) GetPropertyTracksPerCylinder()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) SetPropertyWriteCacheEnabled(value uint8) (err error) { 
...
func (instance *SystemConfig_V2_PhyDisk) GetPropertyWriteCacheEnabled()(value uint8, err error) { 
