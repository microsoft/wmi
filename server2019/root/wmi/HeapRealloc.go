...
type HeapRealloc struct { 
	*HeapTrace_V2
	...
	func NewHeapReallocEx1(instance *cim.WmiInstance) (newInstance *HeapRealloc, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapRealloc, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
