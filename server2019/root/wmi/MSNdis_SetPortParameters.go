...
type MSNdis_SetPortParameters struct { 
	*MSNdis
	...
	func NewMSNdis_SetPortParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_SetPortParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_SetPortParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_SetPortParameters) WmiSetPortParameters( /* IN */ MethodHeader MSNdis_WmiMethodHeader,
 ...
 /* OUT */ OutputInfo MSNdis_WmiOutputInfo) (err error) {_, err = instance.InvokeMethod("WmiSetPortParameters" , MethodHeader, PortParameters)
	if err != nil { return }
	return
