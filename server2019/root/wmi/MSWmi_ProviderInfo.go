...
type MSWmi_ProviderInfo struct { 
	*MS_WmiInternal
	...
	func NewMSWmi_ProviderInfoEx1(instance *cim.WmiInstance) (newInstance *MSWmi_ProviderInfo, err error) {tmp, err := NewMS_WmiInternalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSWmi_ProviderInfo, err error) {tmp, err := NewMS_WmiInternalEx6(hostName, wmiNamespace, userName, password, domainName, query)
