...
type TcpIp_SendIPV4 struct { 
	*TcpIp
	...
	func NewTcpIp_SendIPV4Ex1(instance *cim.WmiInstance) (newInstance *TcpIp_SendIPV4, err error) {tmp, err := NewTcpIpEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TcpIp_SendIPV4, err error) {tmp, err := NewTcpIpEx6(hostName, wmiNamespace, userName, password, domainName, query)
