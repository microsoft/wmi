...
type MSNdis_ReceiveFilterInfo struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveFilterInfoEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveFilterInfo, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveFilterInfo, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
