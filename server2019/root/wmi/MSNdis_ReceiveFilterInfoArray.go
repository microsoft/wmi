...
type MSNdis_ReceiveFilterInfoArray struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveFilterInfoArrayEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveFilterInfoArray, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveFilterInfoArray, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
