...
type MSiSCSI_NICPerformance struct { 
	*Win32_PerfRawData
	...
	func NewMSiSCSI_NICPerformanceEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_NICPerformance, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_NICPerformance, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
