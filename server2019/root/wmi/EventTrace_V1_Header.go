...
type EventTrace_V1_Header struct { 
	*EventTraceEvent_V1
	...
	func NewEventTrace_V1_HeaderEx1(instance *cim.WmiInstance) (newInstance *EventTrace_V1_Header, err error) {tmp, err := NewEventTraceEvent_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *EventTrace_V1_Header, err error) {tmp, err := NewEventTraceEvent_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
