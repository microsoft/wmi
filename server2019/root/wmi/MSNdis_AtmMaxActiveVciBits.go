...
type MSNdis_AtmMaxActiveVciBits struct { 
	*MSNdis
	...
	func NewMSNdis_AtmMaxActiveVciBitsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmMaxActiveVciBits, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmMaxActiveVciBits, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
