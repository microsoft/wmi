...
type MSMCAEvent_BusError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_BusErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_BusError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_BusError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
