...
type ObHandleRundownEvent struct { 
	*ObTrace
	...
	func NewObHandleRundownEventEx1(instance *cim.WmiInstance) (newInstance *ObHandleRundownEvent, err error) {tmp, err := NewObTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ObHandleRundownEvent, err error) {tmp, err := NewObTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
