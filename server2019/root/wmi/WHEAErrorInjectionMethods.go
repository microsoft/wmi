...
type WHEAErrorInjectionMethods struct { 
	*WHEA
	...
	func NewWHEAErrorInjectionMethodsEx1(instance *cim.WmiInstance) (newInstance *WHEAErrorInjectionMethods, err error) {tmp, err := NewWHEAEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WHEAErrorInjectionMethods, err error) {tmp, err := NewWHEAEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *WHEAErrorInjectionMethods) GetErrorInjectionCapabilitiesRtn( /* OUT */ Status uint32,
 /* OUT */ Capabilities uint32) (err error) {_, err = instance.InvokeMethod("GetErrorInjectionCapabilitiesRtn" )
	if err != nil { return }
	return
...
func (instance *WHEAErrorInjectionMethods) InjectErrorRtn( /* IN */ ErrorType uint32,
 ...
 /* OUT */ Status uint32) (err error) {_, err = instance.InvokeMethod("InjectErrorRtn" , ErrorType, Parameter1, Parameter2, Parameter3, Parameter4)
	if err != nil { return }
	return
