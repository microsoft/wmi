...
type MSNdis_80211_Statistics struct { 
	*MSNdis
	...
	func NewMSNdis_80211_StatisticsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_Statistics, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_80211_Statistics, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
