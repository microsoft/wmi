...
type MSiSCSIInitiator_PersistentLoginClass struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_PersistentLoginClassEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_PersistentLoginClass, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_PersistentLoginClass, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
