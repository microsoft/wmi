...
type Heap_TypeGroup1 struct { 
	*HeapTrace_V2
	...
	func NewHeap_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Heap_TypeGroup1, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Heap_TypeGroup1, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
