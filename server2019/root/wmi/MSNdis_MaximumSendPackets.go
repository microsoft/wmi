...
func NewMSNdis_MaximumSendPacketsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_MaximumSendPackets, err error) {
...
func NewMSNdis_MaximumSendPacketsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_MaximumSendPackets, err error) {
