...
type TcpIp_Fail struct { 
	*TcpIp
	...
	func NewTcpIp_FailEx1(instance *cim.WmiInstance) (newInstance *TcpIp_Fail, err error) {tmp, err := NewTcpIpEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TcpIp_Fail, err error) {tmp, err := NewTcpIpEx6(hostName, wmiNamespace, userName, password, domainName, query)
