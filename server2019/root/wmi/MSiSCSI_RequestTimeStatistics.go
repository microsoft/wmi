...
type MSiSCSI_RequestTimeStatistics struct { 
	*Win32_PerfRawData
	...
	func NewMSiSCSI_RequestTimeStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_RequestTimeStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_RequestTimeStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
