...
func NewHostProcessTraceGuidEx1(instance *cim.WmiInstance) (newInstance *HostProcessTraceGuid, err error) {
...
func NewHostProcessTraceGuidEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HostProcessTraceGuid, err error) {
