...
type FileIo_Create struct { 
	*FileIo
	...
	func NewFileIo_CreateEx1(instance *cim.WmiInstance) (newInstance *FileIo_Create, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_Create, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
