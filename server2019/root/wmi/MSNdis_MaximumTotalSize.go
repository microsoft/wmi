...
type MSNdis_MaximumTotalSize struct { 
	*MSNdis
	...
	func NewMSNdis_MaximumTotalSizeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_MaximumTotalSize, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_MaximumTotalSize, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
