...
type MSNdis_CountedString struct { 
	*MSNdis
	...
	func NewMSNdis_CountedStringEx1(instance *cim.WmiInstance) (newInstance *MSNdis_CountedString, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_CountedString, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
