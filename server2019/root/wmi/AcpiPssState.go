...
type AcpiPssState struct { 
	*cim.WmiInstance
	...
	func NewAcpiPssStateEx1(instance *cim.WmiInstance) (newInstance *AcpiPssState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AcpiPssState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
