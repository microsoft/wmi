...
type MSFC_FibrePortHBAAttributes struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FibrePortHBAAttributesEx1(instance *cim.WmiInstance) (newInstance *MSFC_FibrePortHBAAttributes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FibrePortHBAAttributes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
