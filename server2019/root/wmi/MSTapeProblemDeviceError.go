...
type MSTapeProblemDeviceError struct { 
	*MSTapeDriver
	...
	func NewMSTapeProblemDeviceErrorEx1(instance *cim.WmiInstance) (newInstance *MSTapeProblemDeviceError, err error) {tmp, err := NewMSTapeDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSTapeProblemDeviceError, err error) {tmp, err := NewMSTapeDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
