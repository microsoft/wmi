...
type MSNdis_QueryPciDeviceCustomProperty struct { 
	*MSNdis
	...
	func NewMSNdis_QueryPciDeviceCustomPropertyEx1(instance *cim.WmiInstance) (newInstance *MSNdis_QueryPciDeviceCustomProperty, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_QueryPciDeviceCustomProperty, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_QueryPciDeviceCustomProperty) WmiQueryPciDeviceCustomProperty( /* IN */ Header MSNdis_WmiMethodHeader,
 /* OUT */ PciDeviceProperty MSNdis_PciDeviceProperty) (err error) {_, err = instance.InvokeMethod("WmiQueryPciDeviceCustomProperty" , Header)
	if err != nil { return }
	return
