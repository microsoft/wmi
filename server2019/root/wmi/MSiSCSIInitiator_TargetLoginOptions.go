...
type MSiSCSIInitiator_TargetLoginOptions struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_TargetLoginOptionsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_TargetLoginOptions, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_TargetLoginOptions, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
