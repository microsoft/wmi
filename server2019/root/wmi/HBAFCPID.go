...
type HBAFCPID struct { 
	*cim.WmiInstance
	...
	func NewHBAFCPIDEx1(instance *cim.WmiInstance) (newInstance *HBAFCPID, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HBAFCPID, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
