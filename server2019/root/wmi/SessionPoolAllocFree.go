...
type SessionPoolAllocFree struct { 
	*PoolTrace
	...
	func NewSessionPoolAllocFreeEx1(instance *cim.WmiInstance) (newInstance *SessionPoolAllocFree, err error) {tmp, err := NewPoolTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SessionPoolAllocFree, err error) {tmp, err := NewPoolTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
