...
type Registry_Config struct { 
	*Registry
	...
	func NewRegistry_ConfigEx1(instance *cim.WmiInstance) (newInstance *Registry_Config, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_Config, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
