...
type NtlmClientInitialize_Start struct { 
	*NtlmClientInitialize
	...
	func NewNtlmClientInitialize_StartEx1(instance *cim.WmiInstance) (newInstance *NtlmClientInitialize_Start, err error) {tmp, err := NewNtlmClientInitializeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NtlmClientInitialize_Start, err error) {tmp, err := NewNtlmClientInitializeEx6(hostName, wmiNamespace, userName, password, domainName, query)
