...
type ContextRegistersAMD64 struct { 
	*PerfInfo_V2
	...
	func NewContextRegistersAMD64Ex1(instance *cim.WmiInstance) (newInstance *ContextRegistersAMD64, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ContextRegistersAMD64, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
