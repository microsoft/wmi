...
type MSNdis_NetworkAddress struct { 
	*MSNdis
	...
	func NewMSNdis_NetworkAddressEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NetworkAddress, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_NetworkAddress, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
