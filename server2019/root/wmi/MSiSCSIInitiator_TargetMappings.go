...
type MSiSCSIInitiator_TargetMappings struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_TargetMappingsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_TargetMappings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_TargetMappings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
