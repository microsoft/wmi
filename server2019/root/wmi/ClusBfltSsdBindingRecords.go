...
type ClusBfltSsdBindingRecords struct { 
	*cim.WmiInstance
	...
	func NewClusBfltSsdBindingRecordsEx1(instance *cim.WmiInstance) (newInstance *ClusBfltSsdBindingRecords, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltSsdBindingRecords, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
