...
type MSMCAEvent_TLBError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_TLBErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_TLBError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_TLBError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
