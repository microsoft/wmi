...
type UdpIp_V0_TypeGroup1 struct { 
	*UdpIp_V0
	...
	func NewUdpIp_V0_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *UdpIp_V0_TypeGroup1, err error) {tmp, err := NewUdpIp_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UdpIp_V0_TypeGroup1, err error) {tmp, err := NewUdpIp_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
