...
type ProcessorBiosInfo struct { 
	*MSProcessorClass
	...
	func NewProcessorBiosInfoEx1(instance *cim.WmiInstance) (newInstance *ProcessorBiosInfo, err error) {tmp, err := NewMSProcessorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorBiosInfo, err error) {tmp, err := NewMSProcessorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
