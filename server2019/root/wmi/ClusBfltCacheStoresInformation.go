...
type ClusBfltCacheStoresInformation struct { 
	*cim.WmiInstance
	...
	func NewClusBfltCacheStoresInformationEx1(instance *cim.WmiInstance) (newInstance *ClusBfltCacheStoresInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltCacheStoresInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
