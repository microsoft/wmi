...
type MSAcpiInfo struct { 
	*cim.WmiInstance
	...
	func NewMSAcpiInfoEx1(instance *cim.WmiInstance) (newInstance *MSAcpiInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSAcpiInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
