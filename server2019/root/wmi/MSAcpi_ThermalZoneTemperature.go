...
type MSAcpi_ThermalZoneTemperature struct { 
	*MSAcpi
	...
	func NewMSAcpi_ThermalZoneTemperatureEx1(instance *cim.WmiInstance) (newInstance *MSAcpi_ThermalZoneTemperature, err error) {tmp, err := NewMSAcpiEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSAcpi_ThermalZoneTemperature, err error) {tmp, err := NewMSAcpiEx6(hostName, wmiNamespace, userName, password, domainName, query)
