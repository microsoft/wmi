...
type CSwitch_V1 struct { 
	*Thread_V1
	...
	func NewCSwitch_V1Ex1(instance *cim.WmiInstance) (newInstance *CSwitch_V1, err error) {tmp, err := NewThread_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CSwitch_V1, err error) {tmp, err := NewThread_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
