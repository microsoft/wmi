...
type MSiSCSI_SessionStatistics struct { 
	*Win32_PerfRawData
	...
	func NewMSiSCSI_SessionStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_SessionStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_SessionStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
