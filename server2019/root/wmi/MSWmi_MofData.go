...
type MSWmi_MofData struct { 
	*MS_WmiInternal
	...
	func NewMSWmi_MofDataEx1(instance *cim.WmiInstance) (newInstance *MSWmi_MofData, err error) {tmp, err := NewMS_WmiInternalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSWmi_MofData, err error) {tmp, err := NewMS_WmiInternalEx6(hostName, wmiNamespace, userName, password, domainName, query)
