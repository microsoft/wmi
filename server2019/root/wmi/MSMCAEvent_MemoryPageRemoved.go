...
type MSMCAEvent_MemoryPageRemoved struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_MemoryPageRemovedEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_MemoryPageRemoved, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_MemoryPageRemoved, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
