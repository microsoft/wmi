...
type MSNdis_WmiHDSplitCurrentConfig struct { 
	*MSNdis
	...
	func NewMSNdis_WmiHDSplitCurrentConfigEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiHDSplitCurrentConfig, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiHDSplitCurrentConfig, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
