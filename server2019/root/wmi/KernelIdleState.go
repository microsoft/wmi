...
type KernelIdleState struct { 
	*cim.WmiInstance
	...
	func NewKernelIdleStateEx1(instance *cim.WmiInstance) (newInstance *KernelIdleState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelIdleState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
