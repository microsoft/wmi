...
type MSNdis_StatusDevicePowerOn struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusDevicePowerOnEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusDevicePowerOn, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusDevicePowerOn, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
