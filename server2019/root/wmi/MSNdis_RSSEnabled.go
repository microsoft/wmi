...
type MSNdis_RSSEnabled struct { 
	*MSNdis
	...
	func NewMSNdis_RSSEnabledEx1(instance *cim.WmiInstance) (newInstance *MSNdis_RSSEnabled, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_RSSEnabled, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
