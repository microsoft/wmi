...
type DiskIo_V2_TypeGroup2 struct { 
	*DiskIo_V2
	...
	func NewDiskIo_V2_TypeGroup2Ex1(instance *cim.WmiInstance) (newInstance *DiskIo_V2_TypeGroup2, err error) {tmp, err := NewDiskIo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DiskIo_V2_TypeGroup2, err error) {tmp, err := NewDiskIo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
