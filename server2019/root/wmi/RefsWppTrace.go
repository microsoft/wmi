...
type RefsWppTrace struct { 
	*EventTrace
	...
	func NewRefsWppTraceEx1(instance *cim.WmiInstance) (newInstance *RefsWppTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RefsWppTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
