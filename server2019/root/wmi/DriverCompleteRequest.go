...
func NewDriverCompleteRequestEx1(instance *cim.WmiInstance) (newInstance *DriverCompleteRequest, err error) {
...
func NewDriverCompleteRequestEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DriverCompleteRequest, err error) {
