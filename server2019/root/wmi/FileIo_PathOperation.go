...
type FileIo_PathOperation struct { 
	*FileIo
	...
	func NewFileIo_PathOperationEx1(instance *cim.WmiInstance) (newInstance *FileIo_PathOperation, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_PathOperation, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
