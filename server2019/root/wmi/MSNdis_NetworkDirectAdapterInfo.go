...
type MSNdis_NetworkDirectAdapterInfo struct { 
	*MSNdis
	...
	func NewMSNdis_NetworkDirectAdapterInfoEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NetworkDirectAdapterInfo, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_NetworkDirectAdapterInfo, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
