...
type HeapAffinitySlotChanged struct { 
	*HeapTrace_V2
	...
	func NewHeapAffinitySlotChangedEx1(instance *cim.WmiInstance) (newInstance *HeapAffinitySlotChanged, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapAffinitySlotChanged, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
