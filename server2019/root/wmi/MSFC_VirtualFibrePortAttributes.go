...
type MSFC_VirtualFibrePortAttributes struct { 
	*cim.WmiInstance
	...
	func NewMSFC_VirtualFibrePortAttributesEx1(instance *cim.WmiInstance) (newInstance *MSFC_VirtualFibrePortAttributes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_VirtualFibrePortAttributes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
