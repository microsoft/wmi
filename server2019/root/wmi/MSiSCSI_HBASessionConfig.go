...
type MSiSCSI_HBASessionConfig struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_HBASessionConfigEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_HBASessionConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_HBASessionConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
