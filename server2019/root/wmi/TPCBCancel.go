...
type TPCBCancel struct { 
	*ThreadPoolTrace
	...
	func NewTPCBCancelEx1(instance *cim.WmiInstance) (newInstance *TPCBCancel, err error) {tmp, err := NewThreadPoolTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TPCBCancel, err error) {tmp, err := NewThreadPoolTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
