...
type MSiSCSI_PortalInfoClass struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_PortalInfoClassEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_PortalInfoClass, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_PortalInfoClass, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
