...
type BcdDeviceElement struct { 
	*BcdElement
	...
	func NewBcdDeviceElementEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceElement, err error) {tmp, err := NewBcdElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdDeviceElement, err error) {tmp, err := NewBcdElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
