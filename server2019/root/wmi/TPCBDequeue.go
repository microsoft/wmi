...
type TPCBDequeue struct { 
	*ThreadPoolTrace
	...
	func NewTPCBDequeueEx1(instance *cim.WmiInstance) (newInstance *TPCBDequeue, err error) {tmp, err := NewThreadPoolTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TPCBDequeue, err error) {tmp, err := NewThreadPoolTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
