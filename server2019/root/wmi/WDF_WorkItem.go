...
type WDF_WorkItem struct { 
	*PerfInfo_V2
	...
	func NewWDF_WorkItemEx1(instance *cim.WmiInstance) (newInstance *WDF_WorkItem, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WDF_WorkItem, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
