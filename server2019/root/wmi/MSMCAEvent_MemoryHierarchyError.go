...
type MSMCAEvent_MemoryHierarchyError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_MemoryHierarchyErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_MemoryHierarchyError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_MemoryHierarchyError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
