...
type MSNdis_AtmSupportedVcRates struct { 
	*MSNdis
	...
	func NewMSNdis_AtmSupportedVcRatesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmSupportedVcRates, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmSupportedVcRates, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
