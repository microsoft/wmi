...
type MSChangerProblemDeviceError struct { 
	*MSChangerDriver
	...
	func NewMSChangerProblemDeviceErrorEx1(instance *cim.WmiInstance) (newInstance *MSChangerProblemDeviceError, err error) {tmp, err := NewMSChangerDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSChangerProblemDeviceError, err error) {tmp, err := NewMSChangerDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
