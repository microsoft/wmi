...
type UmsDirectedSwitchEnd struct { 
	*UmsEvent
	...
	func NewUmsDirectedSwitchEndEx1(instance *cim.WmiInstance) (newInstance *UmsDirectedSwitchEnd, err error) {tmp, err := NewUmsEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UmsDirectedSwitchEnd, err error) {tmp, err := NewUmsEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
