...
type MSiSCSIInitiator_TargetAddress struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_TargetAddressEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_TargetAddress, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_TargetAddress, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
