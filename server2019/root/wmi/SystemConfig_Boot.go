...
type SystemConfig_Boot struct { 
	*SystemConfig_V2
	...
	func NewSystemConfig_BootEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_Boot, err error) {tmp, err := NewSystemConfig_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_Boot, err error) {tmp, err := NewSystemConfig_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
