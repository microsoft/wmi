...
type BcdUnknownElement struct { 
	*BcdElement
	...
	func NewBcdUnknownElementEx1(instance *cim.WmiInstance) (newInstance *BcdUnknownElement, err error) {tmp, err := NewBcdElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdUnknownElement, err error) {tmp, err := NewBcdElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
