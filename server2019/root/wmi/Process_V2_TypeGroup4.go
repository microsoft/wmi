...
type Process_V2_TypeGroup4 struct { 
	*Process_V2
	...
	func NewProcess_V2_TypeGroup4Ex1(instance *cim.WmiInstance) (newInstance *Process_V2_TypeGroup4, err error) {tmp, err := NewProcess_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Process_V2_TypeGroup4, err error) {tmp, err := NewProcess_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
