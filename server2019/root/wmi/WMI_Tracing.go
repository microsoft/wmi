...
type WMI_Tracing struct { 
	*EventTrace
	...
	func NewWMI_TracingEx1(instance *cim.WmiInstance) (newInstance *WMI_Tracing, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WMI_Tracing, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
