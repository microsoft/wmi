...
type MS_SMHBA_SAS_Port struct { 
	*cim.WmiInstance
	...
	func NewMS_SMHBA_SAS_PortEx1(instance *cim.WmiInstance) (newInstance *MS_SMHBA_SAS_Port, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SMHBA_SAS_Port, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
