...
type SystemConfig_V3_CPU struct { 
	*SystemConfig_V3
	...
	func NewSystemConfig_V3_CPUEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V3_CPU, err error) {tmp, err := NewSystemConfig_V3Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V3_CPU, err error) {tmp, err := NewSystemConfig_V3Ex6(hostName, wmiNamespace, userName, password, domainName, query)
