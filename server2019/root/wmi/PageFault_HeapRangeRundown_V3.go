...
type PageFault_HeapRangeRundown_V3 struct { 
	*PageFault_V2
	...
	func NewPageFault_HeapRangeRundown_V3Ex1(instance *cim.WmiInstance) (newInstance *PageFault_HeapRangeRundown_V3, err error) {tmp, err := NewPageFault_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PageFault_HeapRangeRundown_V3, err error) {tmp, err := NewPageFault_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
