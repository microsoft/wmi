...
type LoaderNewDllEvent struct { 
	*Image
	...
	func NewLoaderNewDllEventEx1(instance *cim.WmiInstance) (newInstance *LoaderNewDllEvent, err error) {tmp, err := NewImageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LoaderNewDllEvent, err error) {tmp, err := NewImageEx6(hostName, wmiNamespace, userName, password, domainName, query)
