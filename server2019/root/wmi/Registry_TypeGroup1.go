...
type Registry_TypeGroup1 struct { 
	*Registry
	...
	func NewRegistry_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Registry_TypeGroup1, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_TypeGroup1, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
