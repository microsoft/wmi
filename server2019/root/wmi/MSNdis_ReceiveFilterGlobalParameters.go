...
type MSNdis_ReceiveFilterGlobalParameters struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveFilterGlobalParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveFilterGlobalParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveFilterGlobalParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
