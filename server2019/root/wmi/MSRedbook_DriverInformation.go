...
type MSRedbook_DriverInformation struct { 
	*cim.WmiInstance
	...
	func NewMSRedbook_DriverInformationEx1(instance *cim.WmiInstance) (newInstance *MSRedbook_DriverInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSRedbook_DriverInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
