...
type MSMCAInfo_Entry struct { 
	*MSMCAInfo
	...
	func NewMSMCAInfo_EntryEx1(instance *cim.WmiInstance) (newInstance *MSMCAInfo_Entry, err error) {tmp, err := NewMSMCAInfoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAInfo_Entry, err error) {tmp, err := NewMSMCAInfoEx6(hostName, wmiNamespace, userName, password, domainName, query)
