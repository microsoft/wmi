...
type ProcessorAcpiXpssState struct { 
	*cim.WmiInstance
	...
	func NewProcessorAcpiXpssStateEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiXpssState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorAcpiXpssState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
