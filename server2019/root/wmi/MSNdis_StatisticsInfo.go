...
type MSNdis_StatisticsInfo struct { 
	*MSNdis
	...
	func NewMSNdis_StatisticsInfoEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatisticsInfo, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatisticsInfo, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
