...
type LoaderBaseEvent struct { 
	*Image_V2
	...
	func NewLoaderBaseEventEx1(instance *cim.WmiInstance) (newInstance *LoaderBaseEvent, err error) {tmp, err := NewImage_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LoaderBaseEvent, err error) {tmp, err := NewImage_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
