...
type SamEnumUsersInDom_Start struct { 
	*SamEnumUsersInDom
	...
	func NewSamEnumUsersInDom_StartEx1(instance *cim.WmiInstance) (newInstance *SamEnumUsersInDom_Start, err error) {tmp, err := NewSamEnumUsersInDomEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamEnumUsersInDom_Start, err error) {tmp, err := NewSamEnumUsersInDomEx6(hostName, wmiNamespace, userName, password, domainName, query)
