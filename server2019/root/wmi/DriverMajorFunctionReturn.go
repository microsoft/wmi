...
type DriverMajorFunctionReturn struct { 
	*DiskIo_V2
	...
	func NewDriverMajorFunctionReturnEx1(instance *cim.WmiInstance) (newInstance *DriverMajorFunctionReturn, err error) {tmp, err := NewDiskIo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DriverMajorFunctionReturn, err error) {tmp, err := NewDiskIo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
