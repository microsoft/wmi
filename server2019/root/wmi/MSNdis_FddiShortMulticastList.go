...
type MSNdis_FddiShortMulticastList struct { 
	*MSNdis
	...
	func NewMSNdis_FddiShortMulticastListEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiShortMulticastList, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_FddiShortMulticastList, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
