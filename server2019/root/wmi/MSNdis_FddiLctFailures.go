...
type MSNdis_FddiLctFailures struct { 
	*MSNdis
	...
	func NewMSNdis_FddiLctFailuresEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiLctFailures, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_FddiLctFailures, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
