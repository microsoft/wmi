...
type WMI_Query struct { 
	*cim.WmiInstance
	...
	func NewWMI_QueryEx1(instance *cim.WmiInstance) (newInstance *WMI_Query, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WMI_Query, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
