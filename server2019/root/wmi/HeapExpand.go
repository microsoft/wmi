...
type HeapExpand struct { 
	*HeapTrace
	...
	func NewHeapExpandEx1(instance *cim.WmiInstance) (newInstance *HeapExpand, err error) {tmp, err := NewHeapTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapExpand, err error) {tmp, err := NewHeapTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
