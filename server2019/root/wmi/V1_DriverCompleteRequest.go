...
type V1_DriverCompleteRequest struct { 
	*DiskIo_V1
	...
	func NewV1_DriverCompleteRequestEx1(instance *cim.WmiInstance) (newInstance *V1_DriverCompleteRequest, err error) {tmp, err := NewDiskIo_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *V1_DriverCompleteRequest, err error) {tmp, err := NewDiskIo_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
