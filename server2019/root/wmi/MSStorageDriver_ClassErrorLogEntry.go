...
type MSStorageDriver_ClassErrorLogEntry struct { 
	*cim.WmiInstance
	...
	func NewMSStorageDriver_ClassErrorLogEntryEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_ClassErrorLogEntry, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSStorageDriver_ClassErrorLogEntry, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
