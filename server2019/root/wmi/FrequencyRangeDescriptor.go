...
type FrequencyRangeDescriptor struct { 
	*cim.WmiInstance
	...
	func NewFrequencyRangeDescriptorEx1(instance *cim.WmiInstance) (newInstance *FrequencyRangeDescriptor, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FrequencyRangeDescriptor, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
