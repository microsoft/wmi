...
type MSNdis_NetworkDirectCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_NetworkDirectCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NetworkDirectCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_NetworkDirectCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
