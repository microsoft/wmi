...
type MSNdis_StatusDevicePowerOff struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusDevicePowerOffEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusDevicePowerOff, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusDevicePowerOff, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
