...
type ISCSI_PortalInfo struct { 
	*cim.WmiInstance
	...
	func NewISCSI_PortalInfoEx1(instance *cim.WmiInstance) (newInstance *ISCSI_PortalInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISCSI_PortalInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
