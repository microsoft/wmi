...
func NewEventTrace_V0_HeaderEx1(instance *cim.WmiInstance) (newInstance *EventTrace_V0_Header, err error) {
...
func NewEventTrace_V0_HeaderEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *EventTrace_V0_Header, err error) {
