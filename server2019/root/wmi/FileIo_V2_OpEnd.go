...
type FileIo_V2_OpEnd struct { 
	*FileIo_V2
	...
	func NewFileIo_V2_OpEndEx1(instance *cim.WmiInstance) (newInstance *FileIo_V2_OpEnd, err error) {tmp, err := NewFileIo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_V2_OpEnd, err error) {tmp, err := NewFileIo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
