...
type MSNdis_WmiReceiveScaleCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_WmiReceiveScaleCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiReceiveScaleCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiReceiveScaleCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
