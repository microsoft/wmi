...
type MSFC_FibrePortNPIVMethods struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FibrePortNPIVMethodsEx1(instance *cim.WmiInstance) (newInstance *MSFC_FibrePortNPIVMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FibrePortNPIVMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFC_FibrePortNPIVMethods) CreateVirtualPort( /* OUT */ Status FibrePortNPIVMethods_Status,
 ...
 /* OPTIONAL IN */ VirtualName []uint16) (err error) {_, err = instance.InvokeMethod("CreateVirtualPort" , WWPN, WWNN, Tag, VirtualName)
	if err != nil { return }
	return
...
func (instance *MSFC_FibrePortNPIVMethods) RemoveVirtualPort( /* OUT */ Status FibrePortNPIVMethods_Status,
 /* OPTIONAL IN */ WWPN []uint8) (err error) {_, err = instance.InvokeMethod("RemoveVirtualPort" , WWPN)
	if err != nil { return }
	return
