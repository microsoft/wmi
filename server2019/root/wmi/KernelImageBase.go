...
type KernelImageBase struct { 
	*Image_V2
	...
	func NewKernelImageBaseEx1(instance *cim.WmiInstance) (newInstance *KernelImageBase, err error) {tmp, err := NewImage_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelImageBase, err error) {tmp, err := NewImage_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
