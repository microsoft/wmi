...
type MS_SMHBA_PORTLUN struct { 
	*cim.WmiInstance
	...
	func NewMS_SMHBA_PORTLUNEx1(instance *cim.WmiInstance) (newInstance *MS_SMHBA_PORTLUN, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SMHBA_PORTLUN, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
