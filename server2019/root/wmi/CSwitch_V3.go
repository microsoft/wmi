...
type CSwitch_V3 struct { 
	*Thread_V3
	...
	func NewCSwitch_V3Ex1(instance *cim.WmiInstance) (newInstance *CSwitch_V3, err error) {tmp, err := NewThread_V3Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CSwitch_V3, err error) {tmp, err := NewThread_V3Ex6(hostName, wmiNamespace, userName, password, domainName, query)
