...
type CSwitch_V4 struct { 
	*Thread_V4
	...
	func NewCSwitch_V4Ex1(instance *cim.WmiInstance) (newInstance *CSwitch_V4, err error) {tmp, err := NewThread_V4Ex1(instance)
		
	if err != nil { return }
	newInstance = &CSwitch_V4 {
	Thread_V4: tmp,
	}
	return
	}
	...
	func NewCSwitch_V4Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CSwitch_V4, err error) {tmp, err := NewThread_V4Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CSwitch_V4) SetPropertyNewThreadId(value uint32) (err error) { 
    return instance.SetProperty("NewThreadId", (value))
}

// GetNewThreadId gets the value of NewThreadId for the instance
func (instance *CSwitch_V4) GetPropertyNewThreadId()(value uint32, err error) { 
...
func (instance *CSwitch_V4) SetPropertyNewThreadPriority(value int8) (err error) { 
...
func (instance *CSwitch_V4) GetPropertyNewThreadPriority()(value int8, err error) { 
...
func (instance *CSwitch_V4) SetPropertyNewThreadWaitTime(value uint32) (err error) { 
...
func (instance *CSwitch_V4) GetPropertyNewThreadWaitTime()(value uint32, err error) { 
...
func (instance *CSwitch_V4) SetPropertyOldThreadId(value uint32) (err error) { 
    return instance.SetProperty("OldThreadId", (value))
}

// GetOldThreadId gets the value of OldThreadId for the instance
func (instance *CSwitch_V4) GetPropertyOldThreadId()(value uint32, err error) { 
...
func (instance *CSwitch_V4) SetPropertyOldThreadPriority(value int8) (err error) { 
...
func (instance *CSwitch_V4) GetPropertyOldThreadPriority()(value int8, err error) { 
...
func (instance *CSwitch_V4) SetPropertyOldThreadState(value int8) (err error) { 
    return instance.SetProperty("OldThreadState", (value))
}

// GetOldThreadState gets the value of OldThreadState for the instance
func (instance *CSwitch_V4) GetPropertyOldThreadState()(value int8, err error) { 
...
func (instance *CSwitch_V4) SetPropertyOldThreadWaitIdealProcessor(value int8) (err error) { 
...
func (instance *CSwitch_V4) GetPropertyOldThreadWaitIdealProcessor()(value int8, err error) { 
...
func (instance *CSwitch_V4) SetPropertyOldThreadWaitReason(value int8) (err error) { 
...
func (instance *CSwitch_V4) GetPropertyOldThreadWaitReason()(value int8, err error) { 
...
func (instance *CSwitch_V4) SetPropertyPreviousCState(value uint8) (err error) { 
    return instance.SetProperty("PreviousCState", (value))
}

// GetPreviousCState gets the value of PreviousCState for the instance
func (instance *CSwitch_V4) GetPropertyPreviousCState()(value uint8, err error) { 
...
func (instance *CSwitch_V4) SetPropertyReserved(value uint32) (err error) { 
    return instance.SetProperty("Reserved", (value))
}

// GetReserved gets the value of Reserved for the instance
func (instance *CSwitch_V4) GetPropertyReserved()(value uint32, err error) { 
...
func (instance *CSwitch_V4) SetPropertySpareByte(value int8) (err error) { 
    return instance.SetProperty("SpareByte", (value))
}

// GetSpareByte gets the value of SpareByte for the instance
func (instance *CSwitch_V4) GetPropertySpareByte()(value int8, err error) { 
...
func (instance *CSwitch_V4) SetPropertyThreadFlags(value int8) (err error) { 
    return instance.SetProperty("ThreadFlags", (value))
}

// GetThreadFlags gets the value of ThreadFlags for the instance
func (instance *CSwitch_V4) GetPropertyThreadFlags()(value int8, err error) { 
