...
type MSiSCSI_QueryLBPolicy struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_QueryLBPolicyEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_QueryLBPolicy, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_QueryLBPolicy, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
