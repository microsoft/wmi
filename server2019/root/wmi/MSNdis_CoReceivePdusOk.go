...
type MSNdis_CoReceivePdusOk struct { 
	*MSNdis
	...
	func NewMSNdis_CoReceivePdusOkEx1(instance *cim.WmiInstance) (newInstance *MSNdis_CoReceivePdusOk, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_CoReceivePdusOk, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
