...
type SystemConfig_V0_PhyDisk struct { 
	*SystemConfig_V0
	...
	func NewSystemConfig_V0_PhyDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_PhyDisk, err error) {tmp, err := NewSystemConfig_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V0_PhyDisk, err error) {tmp, err := NewSystemConfig_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
