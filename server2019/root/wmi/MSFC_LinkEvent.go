...
type MSFC_LinkEvent struct { 
	*WMIEvent
	...
	func NewMSFC_LinkEventEx1(instance *cim.WmiInstance) (newInstance *MSFC_LinkEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_LinkEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
