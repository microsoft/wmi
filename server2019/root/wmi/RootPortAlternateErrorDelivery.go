...
type RootPortAlternateErrorDelivery struct { 
	*cim.WmiInstance
	...
	func NewRootPortAlternateErrorDeliveryEx1(instance *cim.WmiInstance) (newInstance *RootPortAlternateErrorDelivery, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RootPortAlternateErrorDelivery, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *RootPortAlternateErrorDelivery) EnableAlternateErrorDelivery( /* IN */ Segment uint16,
 ...
 /* IN */ Device uint8,
 /* IN */ Function uint8,
 /* OUT */ Status uint8) (err error) {_, err = instance.InvokeMethod("EnableAlternateErrorDelivery" , Segment, Bus, Device, Function)
	if err != nil { return }
	return
...
func (instance *RootPortAlternateErrorDelivery) DisableAlternateErrorDelivery( /* IN */ Segment uint16,
 ...
 /* IN */ Device uint8,
 /* IN */ Function uint8,
 /* OUT */ Status uint8) (err error) {_, err = instance.InvokeMethod("DisableAlternateErrorDelivery" , Segment, Bus, Device, Function)
	if err != nil { return }
	return
...
func (instance *RootPortAlternateErrorDelivery) ReenableErrorDelivery( /* IN */ Segment uint16,
 ...
 /* IN */ Device uint8,
 /* IN */ Function uint8,
 /* OUT */ Status uint8) (err error) {_, err = instance.InvokeMethod("ReenableErrorDelivery" , Segment, Bus, Device, Function)
	if err != nil { return }
	return
