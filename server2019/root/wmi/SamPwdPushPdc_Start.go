...
type SamPwdPushPdc_Start struct { 
	*SamPwdPushPdc
	...
	func NewSamPwdPushPdc_StartEx1(instance *cim.WmiInstance) (newInstance *SamPwdPushPdc_Start, err error) {tmp, err := NewSamPwdPushPdcEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamPwdPushPdc_Start, err error) {tmp, err := NewSamPwdPushPdcEx6(hostName, wmiNamespace, userName, password, domainName, query)
