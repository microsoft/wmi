...
type MSFC_EventBuffer struct { 
	*cim.WmiInstance
	...
	func NewMSFC_EventBufferEx1(instance *cim.WmiInstance) (newInstance *MSFC_EventBuffer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_EventBuffer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
