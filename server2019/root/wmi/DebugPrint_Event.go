...
type DebugPrint_Event struct { 
	*Debugger
	...
	func NewDebugPrint_EventEx1(instance *cim.WmiInstance) (newInstance *DebugPrint_Event, err error) {tmp, err := NewDebuggerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DebugPrint_Event, err error) {tmp, err := NewDebuggerEx6(hostName, wmiNamespace, userName, password, domainName, query)
