...
type MSFC_FibrePortHBAStatistics struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FibrePortHBAStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSFC_FibrePortHBAStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FibrePortHBAStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
