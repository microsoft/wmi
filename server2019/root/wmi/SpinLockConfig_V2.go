...
func NewSpinLockConfig_V2Ex1(instance *cim.WmiInstance) (newInstance *SpinLockConfig_V2, err error) {
...
func NewSpinLockConfig_V2Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SpinLockConfig_V2, err error) {
