...
type NetworkItemFactoryTrace struct { 
	*EventTrace
	...
	func NewNetworkItemFactoryTraceEx1(instance *cim.WmiInstance) (newInstance *NetworkItemFactoryTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NetworkItemFactoryTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
