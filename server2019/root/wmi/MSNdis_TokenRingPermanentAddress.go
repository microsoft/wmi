...
type MSNdis_TokenRingPermanentAddress struct { 
	*MSNdis
	...
	func NewMSNdis_TokenRingPermanentAddressEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TokenRingPermanentAddress, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TokenRingPermanentAddress, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
