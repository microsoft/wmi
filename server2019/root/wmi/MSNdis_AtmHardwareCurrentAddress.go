...
type MSNdis_AtmHardwareCurrentAddress struct { 
	*MSNdis
	...
	func NewMSNdis_AtmHardwareCurrentAddressEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmHardwareCurrentAddress, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmHardwareCurrentAddress, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
