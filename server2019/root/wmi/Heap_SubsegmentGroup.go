...
type Heap_SubsegmentGroup struct { 
	*HeapTrace_V2
	...
	func NewHeap_SubsegmentGroupEx1(instance *cim.WmiInstance) (newInstance *Heap_SubsegmentGroup, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Heap_SubsegmentGroup, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
