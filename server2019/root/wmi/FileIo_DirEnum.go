...
type FileIo_DirEnum struct { 
	*FileIo
	...
	func NewFileIo_DirEnumEx1(instance *cim.WmiInstance) (newInstance *FileIo_DirEnum, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_DirEnum, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
