...
type ISCSI_LUNList struct { 
	*cim.WmiInstance
	...
	func NewISCSI_LUNListEx1(instance *cim.WmiInstance) (newInstance *ISCSI_LUNList, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISCSI_LUNList, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
