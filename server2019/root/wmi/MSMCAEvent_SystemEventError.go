...
type MSMCAEvent_SystemEventError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_SystemEventErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_SystemEventError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_SystemEventError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
