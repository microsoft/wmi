...
type MSiSCSI_ManagementOperations struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_ManagementOperationsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_ManagementOperations, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_ManagementOperations, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSiSCSI_ManagementOperations) PingIPAddress( /* IN */ RequestCount uint32,
 ...
 /* OUT */ ResponsesReceived uint32) (err error) {_, err = instance.InvokeMethod("PingIPAddress" , RequestCount, RequestSize, Timeout, Address)
	if err != nil { return }
	return
