...
type MSNdis_ReceiveQueueInfo struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveQueueInfoEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveQueueInfo, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveQueueInfo, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
