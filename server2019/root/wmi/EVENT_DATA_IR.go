...
type EVENT_DATA_IR struct { 
	*WMIEvent
	...
	func NewEVENT_DATA_IREx1(instance *cim.WmiInstance) (newInstance *EVENT_DATA_IR, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *EVENT_DATA_IR, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
