...
type Thread_V0_TypeGroup1 struct { 
	*Thread_V0
	...
	func NewThread_V0_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Thread_V0_TypeGroup1, err error) {tmp, err := NewThread_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Thread_V0_TypeGroup1, err error) {tmp, err := NewThread_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
