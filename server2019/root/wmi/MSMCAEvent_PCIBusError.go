...
type MSMCAEvent_PCIBusError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_PCIBusErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_PCIBusError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_PCIBusError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
