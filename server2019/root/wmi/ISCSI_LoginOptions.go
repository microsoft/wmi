...
type ISCSI_LoginOptions struct { 
	*cim.WmiInstance
	...
	func NewISCSI_LoginOptionsEx1(instance *cim.WmiInstance) (newInstance *ISCSI_LoginOptions, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISCSI_LoginOptions, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
