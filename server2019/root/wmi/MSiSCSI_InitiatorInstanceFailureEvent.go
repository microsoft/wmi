...
type MSiSCSI_InitiatorInstanceFailureEvent struct { 
	*__ExtrinsicEvent
	...
	func NewMSiSCSI_InitiatorInstanceFailureEventEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_InitiatorInstanceFailureEvent, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_InitiatorInstanceFailureEvent, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
