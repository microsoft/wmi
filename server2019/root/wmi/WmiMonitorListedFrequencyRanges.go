...
type WmiMonitorListedFrequencyRanges struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorListedFrequencyRangesEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorListedFrequencyRanges, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorListedFrequencyRanges, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
