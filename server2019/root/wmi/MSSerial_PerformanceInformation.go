...
type MSSerial_PerformanceInformation struct { 
	*MSSerial
	...
	func NewMSSerial_PerformanceInformationEx1(instance *cim.WmiInstance) (newInstance *MSSerial_PerformanceInformation, err error) {tmp, err := NewMSSerialEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSerial_PerformanceInformation, err error) {tmp, err := NewMSSerialEx6(hostName, wmiNamespace, userName, password, domainName, query)
