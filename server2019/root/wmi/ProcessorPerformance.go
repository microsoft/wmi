...
type ProcessorPerformance struct { 
	*Win32_PerfRawData
	...
	func NewProcessorPerformanceEx1(instance *cim.WmiInstance) (newInstance *ProcessorPerformance, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorPerformance, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
