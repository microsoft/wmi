...
// SystemConfig_V2_LogDisk struct
type SystemConfig_V2_LogDisk struct { 
	*SystemConfig_V2
	...
	func NewSystemConfig_V2_LogDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_LogDisk, err error) {tmp, err := NewSystemConfig_V2Ex1(instance)
		
	if err != nil { return }
	newInstance = &SystemConfig_V2_LogDisk {
	SystemConfig_V2: tmp,
	}
	return
	}
	...
	func NewSystemConfig_V2_LogDiskEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V2_LogDisk, err error) {tmp, err := NewSystemConfig_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyBytesPerSector(value uint32) (err error) { 
    return instance.SetProperty("BytesPerSector", (value))
}

// GetBytesPerSector gets the value of BytesPerSector for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyBytesPerSector()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyDiskNumber(value uint32) (err error) { 
    return instance.SetProperty("DiskNumber", (value))
}

// GetDiskNumber gets the value of DiskNumber for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyDiskNumber()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyDriveLetterString(value []byte) (err error) { 
...
func (instance *SystemConfig_V2_LogDisk) GetPropertyDriveLetterString()(value []byte, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyDriveType(value uint32) (err error) { 
    return instance.SetProperty("DriveType", (value))
}

// GetDriveType gets the value of DriveType for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyDriveType()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyFileSystem(value []byte) (err error) { 
    return instance.SetProperty("FileSystem", (value))
}

// GetFileSystem gets the value of FileSystem for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyFileSystem()(value []byte, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyNumberOfFreeClusters(value int64) (err error) { 
...
func (instance *SystemConfig_V2_LogDisk) GetPropertyNumberOfFreeClusters()(value int64, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyPad1(value uint32) (err error) { 
    return instance.SetProperty("Pad1", (value))
}

// GetPad1 gets the value of Pad1 for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyPad1()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyPad2(value uint32) (err error) { 
    return instance.SetProperty("Pad2", (value))
}

// GetPad2 gets the value of Pad2 for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyPad2()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyPad3(value uint32) (err error) { 
    return instance.SetProperty("Pad3", (value))
}

// GetPad3 gets the value of Pad3 for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyPad3()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyPartitionNumber(value uint32) (err error) { 
    return instance.SetProperty("PartitionNumber", (value))
}

// GetPartitionNumber gets the value of PartitionNumber for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyPartitionNumber()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyPartitionSize(value uint64) (err error) { 
    return instance.SetProperty("PartitionSize", (value))
}

// GetPartitionSize gets the value of PartitionSize for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyPartitionSize()(value uint64, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertySectorsPerCluster(value uint32) (err error) { 
...
func (instance *SystemConfig_V2_LogDisk) GetPropertySectorsPerCluster()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertySize(value uint32) (err error) { 
    return instance.SetProperty("Size", (value))
}

// GetSize gets the value of Size for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertySize()(value uint32, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyStartOffset(value uint64) (err error) { 
    return instance.SetProperty("StartOffset", (value))
}

// GetStartOffset gets the value of StartOffset for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyStartOffset()(value uint64, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyTotalNumberOfClusters(value int64) (err error) { 
...
func (instance *SystemConfig_V2_LogDisk) GetPropertyTotalNumberOfClusters()(value int64, err error) { 
...
func (instance *SystemConfig_V2_LogDisk) SetPropertyVolumeExt(value uint32) (err error) { 
    return instance.SetProperty("VolumeExt", (value))
}

// GetVolumeExt gets the value of VolumeExt for the instance
func (instance *SystemConfig_V2_LogDisk) GetPropertyVolumeExt()(value uint32, err error) { 
