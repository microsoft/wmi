...
type KerbInitSecurityContext_End struct { 
	*KerbInitSecurityContext
	...
	func NewKerbInitSecurityContext_EndEx1(instance *cim.WmiInstance) (newInstance *KerbInitSecurityContext_End, err error) {tmp, err := NewKerbInitSecurityContextEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KerbInitSecurityContext_End, err error) {tmp, err := NewKerbInitSecurityContextEx6(hostName, wmiNamespace, userName, password, domainName, query)
