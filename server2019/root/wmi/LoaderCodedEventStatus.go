...
type LoaderCodedEventStatus struct { 
	*Image
	...
	func NewLoaderCodedEventStatusEx1(instance *cim.WmiInstance) (newInstance *LoaderCodedEventStatus, err error) {tmp, err := NewImageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LoaderCodedEventStatus, err error) {tmp, err := NewImageEx6(hostName, wmiNamespace, userName, password, domainName, query)
