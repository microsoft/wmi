...
type SystemConfig_V2_OpticalMedia struct { 
	*SystemConfig_V2
	...
	func NewSystemConfig_V2_OpticalMediaEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V2_OpticalMedia, err error) {tmp, err := NewSystemConfig_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V2_OpticalMedia, err error) {tmp, err := NewSystemConfig_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
