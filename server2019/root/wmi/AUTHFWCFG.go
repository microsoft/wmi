...
type AUTHFWCFG struct { 
	*EventTrace
	...
	func NewAUTHFWCFGEx1(instance *cim.WmiInstance) (newInstance *AUTHFWCFG, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AUTHFWCFG, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
