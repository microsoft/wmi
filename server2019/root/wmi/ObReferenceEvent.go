...
type ObReferenceEvent struct { 
	*ObTrace
	...
	func NewObReferenceEventEx1(instance *cim.WmiInstance) (newInstance *ObReferenceEvent, err error) {tmp, err := NewObTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ObReferenceEvent, err error) {tmp, err := NewObTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
