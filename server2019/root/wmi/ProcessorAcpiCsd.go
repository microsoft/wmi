...
type ProcessorAcpiCsd struct { 
	*MSProcessorClass
	...
	func NewProcessorAcpiCsdEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiCsd, err error) {tmp, err := NewMSProcessorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorAcpiCsd, err error) {tmp, err := NewMSProcessorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
