...
type MSNdis_HardwareStatus struct { 
	*MSNdis
	...
	func NewMSNdis_HardwareStatusEx1(instance *cim.WmiInstance) (newInstance *MSNdis_HardwareStatus, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_HardwareStatus, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
