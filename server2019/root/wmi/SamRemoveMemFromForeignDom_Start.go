...
type SamRemoveMemFromForeignDom_Start struct { 
	*SamRemoveMemFromForeignDom
	...
	func NewSamRemoveMemFromForeignDom_StartEx1(instance *cim.WmiInstance) (newInstance *SamRemoveMemFromForeignDom_Start, err error) {tmp, err := NewSamRemoveMemFromForeignDomEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamRemoveMemFromForeignDom_Start, err error) {tmp, err := NewSamRemoveMemFromForeignDomEx6(hostName, wmiNamespace, userName, password, domainName, query)
