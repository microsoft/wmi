...
type MSNdis_WmiTcpLargeSendOffloadV2_IPv6 struct { 
	*MSNdis
	...
	func NewMSNdis_WmiTcpLargeSendOffloadV2_IPv6Ex1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiTcpLargeSendOffloadV2_IPv6, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiTcpLargeSendOffloadV2_IPv6, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
