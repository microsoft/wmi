...
type KerbAcceptSecurityContext_End struct { 
	*KerbAcceptSecurityContext
	...
	func NewKerbAcceptSecurityContext_EndEx1(instance *cim.WmiInstance) (newInstance *KerbAcceptSecurityContext_End, err error) {tmp, err := NewKerbAcceptSecurityContextEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KerbAcceptSecurityContext_End, err error) {tmp, err := NewKerbAcceptSecurityContextEx6(hostName, wmiNamespace, userName, password, domainName, query)
