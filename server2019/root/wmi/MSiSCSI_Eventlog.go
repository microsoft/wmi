...
type MSiSCSI_Eventlog struct { 
	*__ExtrinsicEvent
	...
	func NewMSiSCSI_EventlogEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_Eventlog, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_Eventlog, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
