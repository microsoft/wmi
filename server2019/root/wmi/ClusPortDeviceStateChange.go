...
type ClusPortDeviceStateChange struct { 
	*WMIEvent
	...
	func NewClusPortDeviceStateChangeEx1(instance *cim.WmiInstance) (newInstance *ClusPortDeviceStateChange, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusPortDeviceStateChange, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
