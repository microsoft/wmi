...
type DiskIo_V0_TypeGroup1 struct { 
	*DiskIo_V0
	...
	func NewDiskIo_V0_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *DiskIo_V0_TypeGroup1, err error) {tmp, err := NewDiskIo_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DiskIo_V0_TypeGroup1, err error) {tmp, err := NewDiskIo_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
