...
type SamSetInfoAlias_Start struct { 
	*SamSetInfoAlias
	...
	func NewSamSetInfoAlias_StartEx1(instance *cim.WmiInstance) (newInstance *SamSetInfoAlias_Start, err error) {tmp, err := NewSamSetInfoAliasEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamSetInfoAlias_Start, err error) {tmp, err := NewSamSetInfoAliasEx6(hostName, wmiNamespace, userName, password, domainName, query)
