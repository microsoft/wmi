...
type SchannelDebugTrace struct { 
	*EventTrace
	...
	func NewSchannelDebugTraceEx1(instance *cim.WmiInstance) (newInstance *SchannelDebugTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SchannelDebugTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
