...
type MS_SM_TargetEvent struct { 
	*WMIEvent
	...
	func NewMS_SM_TargetEventEx1(instance *cim.WmiInstance) (newInstance *MS_SM_TargetEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SM_TargetEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
