...
type MSFC_HBAPortAttributesResults struct { 
	*cim.WmiInstance
	...
	func NewMSFC_HBAPortAttributesResultsEx1(instance *cim.WmiInstance) (newInstance *MSFC_HBAPortAttributesResults, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_HBAPortAttributesResults, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
