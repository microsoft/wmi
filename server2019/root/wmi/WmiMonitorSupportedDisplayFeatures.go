...
type WmiMonitorSupportedDisplayFeatures struct { 
	*cim.WmiInstance
	...
	func NewWmiMonitorSupportedDisplayFeaturesEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorSupportedDisplayFeatures, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorSupportedDisplayFeatures, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
