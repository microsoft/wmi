...
type NetworkProfileManagerTraceGUID struct { 
	*EventTrace
	...
	func NewNetworkProfileManagerTraceGUIDEx1(instance *cim.WmiInstance) (newInstance *NetworkProfileManagerTraceGUID, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NetworkProfileManagerTraceGUID, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
