...
type MSLSA_LookupIsolatedNameInTrustedDomains_TypeGroup1 struct { 
	*MSLSA_LookupIsolatedNameInTrustedDomains
	...
	func NewMSLSA_LookupIsolatedNameInTrustedDomains_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *MSLSA_LookupIsolatedNameInTrustedDomains_TypeGroup1, err error) {tmp, err := NewMSLSA_LookupIsolatedNameInTrustedDomainsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSLSA_LookupIsolatedNameInTrustedDomains_TypeGroup1, err error) {tmp, err := NewMSLSA_LookupIsolatedNameInTrustedDomainsEx6(hostName, wmiNamespace, userName, password, domainName, query)
