...
type UdpIp_V1_TypeGroup1 struct { 
	*UdpIp_V1
	...
	func NewUdpIp_V1_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *UdpIp_V1_TypeGroup1, err error) {tmp, err := NewUdpIp_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UdpIp_V1_TypeGroup1, err error) {tmp, err := NewUdpIp_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
