...
type WNFPublish struct { 
	*WNFTrace
	...
	func NewWNFPublishEx1(instance *cim.WmiInstance) (newInstance *WNFPublish, err error) {tmp, err := NewWNFTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WNFPublish, err error) {tmp, err := NewWNFTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
