...
type LoaderCodedEventPath struct { 
	*Image
	...
	func NewLoaderCodedEventPathEx1(instance *cim.WmiInstance) (newInstance *LoaderCodedEventPath, err error) {tmp, err := NewImageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LoaderCodedEventPath, err error) {tmp, err := NewImageEx6(hostName, wmiNamespace, userName, password, domainName, query)
