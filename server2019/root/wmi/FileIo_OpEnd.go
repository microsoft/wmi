...
type FileIo_OpEnd struct { 
	*FileIo
	...
	func NewFileIo_OpEndEx1(instance *cim.WmiInstance) (newInstance *FileIo_OpEnd, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_OpEnd, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
