...
type SplitIo_Info struct { 
	*SplitIo
	...
	func NewSplitIo_InfoEx1(instance *cim.WmiInstance) (newInstance *SplitIo_Info, err error) {tmp, err := NewSplitIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SplitIo_Info, err error) {tmp, err := NewSplitIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
