...
type ProcessorThrottleStateEvent struct { 
	*WMIEvent
	...
	func NewProcessorThrottleStateEventEx1(instance *cim.WmiInstance) (newInstance *ProcessorThrottleStateEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorThrottleStateEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
