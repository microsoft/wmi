...
type CertificateServicesClient_CredentialRoaming struct { 
	*EventTrace
	...
	func NewCertificateServicesClient_CredentialRoamingEx1(instance *cim.WmiInstance) (newInstance *CertificateServicesClient_CredentialRoaming, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CertificateServicesClient_CredentialRoaming, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
