...
type CounterCorruptionStatus struct { 
	*cim.WmiInstance
	...
	func NewCounterCorruptionStatusEx1(instance *cim.WmiInstance) (newInstance *CounterCorruptionStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CounterCorruptionStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
