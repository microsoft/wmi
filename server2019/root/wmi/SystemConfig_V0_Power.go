...
type SystemConfig_V0_Power struct { 
	*SystemConfig_V0
	...
	func NewSystemConfig_V0_PowerEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_Power, err error) {tmp, err := NewSystemConfig_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V0_Power, err error) {tmp, err := NewSystemConfig_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
