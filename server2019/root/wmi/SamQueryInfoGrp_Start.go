...
type SamQueryInfoGrp_Start struct { 
	*SamQueryInfoGrp
	...
	func NewSamQueryInfoGrp_StartEx1(instance *cim.WmiInstance) (newInstance *SamQueryInfoGrp_Start, err error) {tmp, err := NewSamQueryInfoGrpEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamQueryInfoGrp_Start, err error) {tmp, err := NewSamQueryInfoGrpEx6(hostName, wmiNamespace, userName, password, domainName, query)
