...
type MSSmBios_RawSMBiosTables struct { 
	*MS_SmBios
	...
	func NewMSSmBios_RawSMBiosTablesEx1(instance *cim.WmiInstance) (newInstance *MSSmBios_RawSMBiosTables, err error) {tmp, err := NewMS_SmBiosEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSmBios_RawSMBiosTables, err error) {tmp, err := NewMS_SmBiosEx6(hostName, wmiNamespace, userName, password, domainName, query)
