...
type MSNdis_NetworkDirectVersion struct { 
	*MSNdis
	...
	func NewMSNdis_NetworkDirectVersionEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NetworkDirectVersion, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_NetworkDirectVersion, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
