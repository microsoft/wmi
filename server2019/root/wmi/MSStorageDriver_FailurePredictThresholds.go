...
type MSStorageDriver_FailurePredictThresholds struct { 
	*MSStorageDriver
	...
	func NewMSStorageDriver_FailurePredictThresholdsEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_FailurePredictThresholds, err error) {tmp, err := NewMSStorageDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSStorageDriver_FailurePredictThresholds, err error) {tmp, err := NewMSStorageDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
