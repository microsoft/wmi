...
type ClusBfltPathMethods struct { 
	*cim.WmiInstance
	...
	func NewClusBfltPathMethodsEx1(instance *cim.WmiInstance) (newInstance *ClusBfltPathMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltPathMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *ClusBfltPathMethods) ReInitializeDisk( /* IN */ PathId uint32,
 /* IN */ Flags uint32) (err error) {_, err = instance.InvokeMethodWithReturn("ReInitializeDisk" , PathId, Flags);
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) CreateSsdCacheStore( /* IN */ PathId uint32,
 ...
 /* IN */ PageSize uint32) (err error) {_, err = instance.InvokeMethodWithReturn("CreateSsdCacheStore" , PathId, ReservePercentage, UnusedSize, PageSize);
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) PrepareHddForCache( /* IN */ PathId uint32,
 /* IN */ Options uint32) (err error) {_, err = instance.InvokeMethodWithReturn("PrepareHddForCache" , PathId, Options);
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) BindHddToCacheStore( /* IN */ PathId uint32,
 ...
 /* IN */ CacheStoreId string) (err error) {_, err = instance.InvokeMethodWithReturn("BindHddToCacheStore" , PathId, Attributes, CacheStoreId);
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) UnBindHdd( /* IN */ PathId uint32,
 /* IN */ Flags uint32) (err error) {_, err = instance.InvokeMethodWithReturn("UnBindHdd" , PathId, Flags);
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) QueryHddBinding( /* IN */ PathId uint32,
 /* OUT */ BindingInfo ClusBfltHddBindingInformation) (err error) {_, err = instance.InvokeMethod("QueryHddBinding" , PathId)
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) QueryCacheStores( /* IN */ PathId uint32,
 /* OUT */ CacheStores ClusBfltCacheStoresInformation) (err error) {_, err = instance.InvokeMethod("QueryCacheStores" , PathId)
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) QuerySsdBindingRecords( /* IN */ PathId uint32,
 ...
 /* OUT */ BindingRecords ClusBfltSsdBindingRecords) (err error) {_, err = instance.InvokeMethod("QuerySsdBindingRecords" , PathId, CacheStoreId)
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) DisableSsdBinding( /* IN */ PathId uint32,
 /* IN */ CacheStoreId string,
 /* IN */ BindingId string) (err error) {_, err = instance.InvokeMethodWithReturn("DisableSsdBinding" , PathId, CacheStoreId, BindingId);
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) GetPathIdByDeviceGuid( /* IN */ DeviceGuid string,
 ...
 /* IN */ Timeout uint32,
 /* OUT */ PathId uint32) (err error) {_, err = instance.InvokeMethod("GetPathIdByDeviceGuid" , DeviceGuid, PathType, Attributes, AttributesMask, Timeout)
	if err != nil { return }
	return
...
// <param name="PathId" type="uint32 ">Path Id</param>
func (instance *ClusBfltPathMethods) TrimDisk( /* IN */ PathId uint32) (err error) {_, err = instance.InvokeMethodWithReturn("TrimDisk" , PathId);
	if err != nil { return }
	return
...
func (instance *ClusBfltPathMethods) SetSsdBindingAttributes( /* IN */ PathId uint32,
 ...
 /* IN */ AttributesMask uint32,
 /* IN */ CacheStoreId string,
 /* IN */ BindingId string) (err error) {_, err = instance.InvokeMethodWithReturn("SetSsdBindingAttributes" , PathId, Attributes, AttributesMask, CacheStoreId, BindingId);
	if err != nil { return }
	return
