...
type WmiMonitorRawEEdidV1Block struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorRawEEdidV1BlockEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorRawEEdidV1Block, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorRawEEdidV1Block, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
