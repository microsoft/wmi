...
type WNFCallback struct { 
	*WNFTrace
	...
	func NewWNFCallbackEx1(instance *cim.WmiInstance) (newInstance *WNFCallback, err error) {tmp, err := NewWNFTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WNFCallback, err error) {tmp, err := NewWNFTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
