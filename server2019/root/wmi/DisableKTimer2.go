...
type DisableKTimer2 struct { 
	*PerfInfo_V2
	...
	func NewDisableKTimer2Ex1(instance *cim.WmiInstance) (newInstance *DisableKTimer2, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DisableKTimer2, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
