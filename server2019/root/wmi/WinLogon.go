...
type WinLogon struct { 
	*EventTrace
	...
	func NewWinLogonEx1(instance *cim.WmiInstance) (newInstance *WinLogon, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WinLogon, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
