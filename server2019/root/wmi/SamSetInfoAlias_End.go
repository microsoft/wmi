...
func NewSamSetInfoAlias_EndEx1(instance *cim.WmiInstance) (newInstance *SamSetInfoAlias_End, err error) {
...
func NewSamSetInfoAlias_EndEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamSetInfoAlias_End, err error) {
