...
type MSParallel_AllocFreeCounts struct { 
	*MSParallel
	...
	func NewMSParallel_AllocFreeCountsEx1(instance *cim.WmiInstance) (newInstance *MSParallel_AllocFreeCounts, err error) {tmp, err := NewMSParallelEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSParallel_AllocFreeCounts, err error) {tmp, err := NewMSParallelEx6(hostName, wmiNamespace, userName, password, domainName, query)
