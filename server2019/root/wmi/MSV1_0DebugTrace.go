...
type MSV1_0DebugTrace struct { 
	*EventTrace
	...
	func NewMSV1_0DebugTraceEx1(instance *cim.WmiInstance) (newInstance *MSV1_0DebugTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSV1_0DebugTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
