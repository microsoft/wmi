...
type ClusBfltHddBindingRecord struct { 
	*cim.WmiInstance
	...
	func NewClusBfltHddBindingRecordEx1(instance *cim.WmiInstance) (newInstance *ClusBfltHddBindingRecord, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltHddBindingRecord, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
