...
type CtlGuidUMB struct { 
	*EventTrace
	...
	func NewCtlGuidUMBEx1(instance *cim.WmiInstance) (newInstance *CtlGuidUMB, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CtlGuidUMB, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
