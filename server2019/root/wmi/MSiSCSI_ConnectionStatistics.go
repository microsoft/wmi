...
type MSiSCSI_ConnectionStatistics struct { 
	*Win32_PerfRawData
	...
	func NewMSiSCSI_ConnectionStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_ConnectionStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_ConnectionStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
