...
type FltIoInit struct { 
	*FileIo
	...
	func NewFltIoInitEx1(instance *cim.WmiInstance) (newInstance *FltIoInit, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FltIoInit, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
