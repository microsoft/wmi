...
type MSNdis_TokenRingLostFrames struct { 
	*MSNdis
	...
	func NewMSNdis_TokenRingLostFramesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TokenRingLostFrames, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TokenRingLostFrames, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
