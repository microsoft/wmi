...
type NtlmClientInitialize_End struct { 
	*NtlmClientInitialize
	...
	func NewNtlmClientInitialize_EndEx1(instance *cim.WmiInstance) (newInstance *NtlmClientInitialize_End, err error) {tmp, err := NewNtlmClientInitializeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NtlmClientInitialize_End, err error) {tmp, err := NewNtlmClientInitializeEx6(hostName, wmiNamespace, userName, password, domainName, query)
