...
type MSiSCSIInitiator_LUNList struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_LUNListEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_LUNList, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_LUNList, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
