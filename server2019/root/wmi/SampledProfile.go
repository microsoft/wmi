...
type SampledProfile struct { 
	*PerfInfo_V2
	...
	func NewSampledProfileEx1(instance *cim.WmiInstance) (newInstance *SampledProfile, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SampledProfile, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
