...
type TP_V2_TimerExpiration struct { 
	*ThreadPoolTrace_V2
	...
	func NewTP_V2_TimerExpirationEx1(instance *cim.WmiInstance) (newInstance *TP_V2_TimerExpiration, err error) {tmp, err := NewThreadPoolTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TP_V2_TimerExpiration, err error) {tmp, err := NewThreadPoolTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
