...
type MSNdis_NotifyAdapterArrival struct { 
	*WMIEvent
	...
	func NewMSNdis_NotifyAdapterArrivalEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NotifyAdapterArrival, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_NotifyAdapterArrival, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
