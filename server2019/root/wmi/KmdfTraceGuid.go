...
type KmdfTraceGuid struct { 
	*EventTrace
	...
	func NewKmdfTraceGuidEx1(instance *cim.WmiInstance) (newInstance *KmdfTraceGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KmdfTraceGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
