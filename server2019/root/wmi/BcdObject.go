...
type BcdObject struct { 
	*cim.WmiInstance
	...
	func NewBcdObjectEx1(instance *cim.WmiInstance) (newInstance *BcdObject, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdObject, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *BcdObject) EnumerateElementTypes( /* OUT */ Types []uint32) (result bool, err error) {retVal, err := instance.InvokeMethod("EnumerateElementTypes" )
	if err != nil { return }
...
// <param name="ReturnValue" type="bool "></param>
func (instance *BcdObject) EnumerateElements( /* OUT */ Elements []BcdElement) (result bool, err error) {retVal, err := instance.InvokeMethod("EnumerateElements" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = bool(retValue)
	return
...
func (instance *BcdObject) GetElement( /* IN */ Type uint32,
 /* OUT */ Element BcdElement) (result bool, err error) {retVal, err := instance.InvokeMethod("GetElement" , Type)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = bool(retValue)
	return
...
func (instance *BcdObject) GetElementWithFlags( /* IN */ Type uint32,
 /* IN */ Flags uint32,
 /* OUT */ Element BcdElement) (result bool, err error) {retVal, err := instance.InvokeMethod("GetElementWithFlags" , Type, Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = bool(retValue)
	return
...
func (instance *BcdObject) SetDeviceElement( /* IN */ Type uint32,
 ...
 /* IN */ AdditionalOptions string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDeviceElement" , Type, DeviceType, AdditionalOptions);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetPartitionDeviceElement( /* IN */ Type uint32,
 ...
 /* IN */ Path string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPartitionDeviceElement" , Type, DeviceType, AdditionalOptions, Path);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetPartitionDeviceElementWithFlags( /* IN */ Type uint32,
 ...
 /* IN */ AdditionalOptions string,
 /* IN */ Path string,
 /* IN */ Flags uint32) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPartitionDeviceElementWithFlags" , Type, DeviceType, AdditionalOptions, Path, Flags);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetFileDeviceElement( /* IN */ Type uint32,
 ...
 /* IN */ ParentPath string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetFileDeviceElement" , Type, DeviceType, AdditionalOptions, Path, ParentDeviceType, ParentAdditionalOptions, ParentPath);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetQualifiedPartitionDeviceElement( /* IN */ Type uint32,
 ...
 /* IN */ PartitionIdentifier string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetQualifiedPartitionDeviceElement" , Type, PartitionStyle, DiskSignature, PartitionIdentifier);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetVhdDeviceElement( /* IN */ Type uint32,
 ...
 /* IN */ CustomLocate uint32) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetVhdDeviceElement" , Type, Path, ParentDeviceType, ParentAdditionalOptions, ParentPath, CustomLocate);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetStringElement( /* IN */ Type uint32,
 /* IN */ String string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetStringElement" , Type, String);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetObjectElement( /* IN */ Type uint32,
 /* IN */ Id string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetObjectElement" , Type, Id);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetObjectListElement( /* IN */ Type uint32,
 /* IN */ Ids []string) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetObjectListElement" , Type, Ids);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetIntegerElement( /* IN */ Type uint32,
 /* IN */ Integer uint64) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetIntegerElement" , Type, Integer);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetIntegerListElement( /* IN */ Type uint32,
 /* IN */ Integers []uint64) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetIntegerListElement" , Type, Integers);
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *BcdObject) SetBooleanElement( /* IN */ Type uint32,
 /* IN */ Boolean bool) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("SetBooleanElement" , Type, Boolean);
	if err != nil { return }
	result = (retVal > 0)
	return
...
// <param name="ReturnValue" type="bool "></param>
func (instance *BcdObject) DeleteElement( /* IN */ Type uint32) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("DeleteElement" , Type);
	if err != nil { return }
	result = (retVal > 0)
	return
