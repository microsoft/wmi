...
func NewVideoModeDescriptorEx1(instance *cim.WmiInstance) (newInstance *VideoModeDescriptor, err error) {
...
func NewVideoModeDescriptorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *VideoModeDescriptor, err error) {
