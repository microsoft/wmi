...
type MSFC_FCAdapterHBAAttributes struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FCAdapterHBAAttributesEx1(instance *cim.WmiInstance) (newInstance *MSFC_FCAdapterHBAAttributes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FCAdapterHBAAttributes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
