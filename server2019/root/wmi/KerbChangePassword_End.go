...
type KerbChangePassword_End struct { 
	*KerbChangePassword
	...
	func NewKerbChangePassword_EndEx1(instance *cim.WmiInstance) (newInstance *KerbChangePassword_End, err error) {tmp, err := NewKerbChangePasswordEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KerbChangePassword_End, err error) {tmp, err := NewKerbChangePasswordEx6(hostName, wmiNamespace, userName, password, domainName, query)
