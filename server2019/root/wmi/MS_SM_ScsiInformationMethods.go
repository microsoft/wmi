...
type MS_SM_ScsiInformationMethods struct { 
	*cim.WmiInstance
	...
	func NewMS_SM_ScsiInformationMethodsEx1(instance *cim.WmiInstance) (newInstance *MS_SM_ScsiInformationMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SM_ScsiInformationMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MS_SM_ScsiInformationMethods) SM_ScsiInquiry( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ SenseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SM_ScsiInquiry" , HbaPortWWN, DiscoveredPortWWN, DomainPortWWN, SmhbaLUN, Cdb, InRespBufferMaxSize, InSenseBufferMaxSize)
	if err != nil { return }
	return
...
func (instance *MS_SM_ScsiInformationMethods) SM_ScsiReportLuns( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ OutSenseBufferSize uint32,
 /* OUT */ RespBuffer []uint8,
 /* OUT */ SenseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SM_ScsiReportLuns" , HbaPortWWN, DiscoveredPortWWN, DomainPortWWN, Cdb, InRespBufferMaxSize, InSenseBufferMaxSize)
	if err != nil { return }
	return
...
func (instance *MS_SM_ScsiInformationMethods) SM_ScsiReadCapacity( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ OutSenseBufferSize uint32,
 /* OUT */ RespBuffer []uint8,
 /* OUT */ SenseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SM_ScsiReadCapacity" , HbaPortWWN, DiscoveredPortWWN, DomainPortWWN, SmhbaLUN, Cdb, InRespBufferMaxSize, InSenseBufferMaxSize)
	if err != nil { return }
	return
