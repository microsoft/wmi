...
type MSStorageDriver_FailurePredictEvent struct { 
	*WMIEvent
	...
	func NewMSStorageDriver_FailurePredictEventEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_FailurePredictEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSStorageDriver_FailurePredictEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
