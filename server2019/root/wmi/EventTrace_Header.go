...
func NewEventTrace_HeaderEx1(instance *cim.WmiInstance) (newInstance *EventTrace_Header, err error) {
...
func NewEventTrace_HeaderEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *EventTrace_Header, err error) {
