...
type MSNdis_AtmMaxAal1PacketSize struct { 
	*MSNdis
	...
	func NewMSNdis_AtmMaxAal1PacketSizeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmMaxAal1PacketSize, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmMaxAal1PacketSize, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
