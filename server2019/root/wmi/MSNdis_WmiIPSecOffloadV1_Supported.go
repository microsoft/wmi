...
type MSNdis_WmiIPSecOffloadV1_Supported struct { 
	*MSNdis
	...
	func NewMSNdis_WmiIPSecOffloadV1_SupportedEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiIPSecOffloadV1_Supported, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiIPSecOffloadV1_Supported, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
