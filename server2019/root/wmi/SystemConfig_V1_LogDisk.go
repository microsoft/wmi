...
type SystemConfig_V1_LogDisk struct { 
	*SystemConfig_V1
	...
	func NewSystemConfig_V1_LogDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_LogDisk, err error) {tmp, err := NewSystemConfig_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V1_LogDisk, err error) {tmp, err := NewSystemConfig_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
