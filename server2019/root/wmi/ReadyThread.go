...
type ReadyThread struct { 
	*Thread_V2
	...
	func NewReadyThreadEx1(instance *cim.WmiInstance) (newInstance *ReadyThread, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ReadyThread, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
