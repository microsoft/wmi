...
type MSNdis_FddiRingManagmentState struct { 
	*MSNdis
	...
	func NewMSNdis_FddiRingManagmentStateEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiRingManagmentState, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_FddiRingManagmentState, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
