...
type HeapSubsegmentInitialize struct { 
	*HeapTrace_V2
	...
	func NewHeapSubsegmentInitializeEx1(instance *cim.WmiInstance) (newInstance *HeapSubsegmentInitialize, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapSubsegmentInitialize, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
