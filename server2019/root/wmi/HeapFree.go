...
type HeapFree struct { 
	*HeapTrace_V2
	...
	func NewHeapFreeEx1(instance *cim.WmiInstance) (newInstance *HeapFree, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapFree, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
