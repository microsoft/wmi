...
type BcdDeviceUnknownData struct { 
	*BcdDeviceData
	...
	func NewBcdDeviceUnknownDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceUnknownData, err error) {tmp, err := NewBcdDeviceDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdDeviceUnknownData, err error) {tmp, err := NewBcdDeviceDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
