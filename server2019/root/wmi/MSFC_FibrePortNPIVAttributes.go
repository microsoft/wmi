...
type MSFC_FibrePortNPIVAttributes struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FibrePortNPIVAttributesEx1(instance *cim.WmiInstance) (newInstance *MSFC_FibrePortNPIVAttributes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FibrePortNPIVAttributes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
