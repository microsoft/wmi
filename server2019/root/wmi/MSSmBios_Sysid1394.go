...
type MSSmBios_Sysid1394 struct { 
	*MS_SmBios
	...
	func NewMSSmBios_Sysid1394Ex1(instance *cim.WmiInstance) (newInstance *MSSmBios_Sysid1394, err error) {tmp, err := NewMS_SmBiosEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSmBios_Sysid1394, err error) {tmp, err := NewMS_SmBiosEx6(hostName, wmiNamespace, userName, password, domainName, query)
