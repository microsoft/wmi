...
type MSIde_PortDeviceInfo struct { 
	*MSIde
	...
	func NewMSIde_PortDeviceInfoEx1(instance *cim.WmiInstance) (newInstance *MSIde_PortDeviceInfo, err error) {tmp, err := NewMSIdeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSIde_PortDeviceInfo, err error) {tmp, err := NewMSIdeEx6(hostName, wmiNamespace, userName, password, domainName, query)
