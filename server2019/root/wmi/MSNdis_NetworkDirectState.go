...
func NewMSNdis_NetworkDirectStateEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NetworkDirectState, err error) {
...
func NewMSNdis_NetworkDirectStateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_NetworkDirectState, err error) {
