...
type MSNdis_StatusDot11LinkQuality struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusDot11LinkQualityEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusDot11LinkQuality, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusDot11LinkQuality, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
