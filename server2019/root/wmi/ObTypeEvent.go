...
type ObTypeEvent struct { 
	*ObTrace
	...
	func NewObTypeEventEx1(instance *cim.WmiInstance) (newInstance *ObTypeEvent, err error) {tmp, err := NewObTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ObTypeEvent, err error) {tmp, err := NewObTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
