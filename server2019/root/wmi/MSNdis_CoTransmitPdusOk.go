...
type MSNdis_CoTransmitPdusOk struct { 
	*MSNdis
	...
	func NewMSNdis_CoTransmitPdusOkEx1(instance *cim.WmiInstance) (newInstance *MSNdis_CoTransmitPdusOk, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_CoTransmitPdusOk, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
