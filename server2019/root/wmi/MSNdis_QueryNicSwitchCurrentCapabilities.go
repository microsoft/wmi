...
type MSNdis_QueryNicSwitchCurrentCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_QueryNicSwitchCurrentCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_QueryNicSwitchCurrentCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_QueryNicSwitchCurrentCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_QueryNicSwitchCurrentCapabilities) WmiQueryNICSwitchCurrentCapabilities( /* IN */ Header MSNdis_WmiMethodHeader,
 /* OUT */ NicSwitchCurrentCapabilities MSNdis_NicSwitchCapabilities) (err error) {_, err = instance.InvokeMethod("WmiQueryNICSwitchCurrentCapabilities" , Header)
	if err != nil { return }
	return
