...
type MS_SM_HbaApiVersion struct { 
	*cim.WmiInstance
	...
	func NewMS_SM_HbaApiVersionEx1(instance *cim.WmiInstance) (newInstance *MS_SM_HbaApiVersion, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SM_HbaApiVersion, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
