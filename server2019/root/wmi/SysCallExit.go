...
type SysCallExit struct { 
	*PerfInfo_V2
	...
	func NewSysCallExitEx1(instance *cim.WmiInstance) (newInstance *SysCallExit, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SysCallExit, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
