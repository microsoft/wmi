...
type MSNdis_TokenRingCurrentRingState struct { 
	*MSNdis
	...
	func NewMSNdis_TokenRingCurrentRingStateEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TokenRingCurrentRingState, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TokenRingCurrentRingState, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
