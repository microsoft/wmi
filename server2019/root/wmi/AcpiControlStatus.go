...
type AcpiControlStatus struct { 
	*cim.WmiInstance
	...
	func NewAcpiControlStatusEx1(instance *cim.WmiInstance) (newInstance *AcpiControlStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AcpiControlStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
