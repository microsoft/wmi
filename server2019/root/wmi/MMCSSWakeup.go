...
type MMCSSWakeup struct { 
	*MMCSSTrace
	...
	func NewMMCSSWakeupEx1(instance *cim.WmiInstance) (newInstance *MMCSSWakeup, err error) {tmp, err := NewMMCSSTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MMCSSWakeup, err error) {tmp, err := NewMMCSSTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
