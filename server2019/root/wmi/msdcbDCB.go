...
type msdcbDCB struct { 
	*EventTrace
	...
	func NewmsdcbDCBEx1(instance *cim.WmiInstance) (newInstance *msdcbDCB, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *msdcbDCB, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
