...
type HBAFCPBindingEntry struct { 
	*cim.WmiInstance
	...
	func NewHBAFCPBindingEntryEx1(instance *cim.WmiInstance) (newInstance *HBAFCPBindingEntry, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HBAFCPBindingEntry, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
