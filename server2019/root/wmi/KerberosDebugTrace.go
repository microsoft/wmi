...
type KerberosDebugTrace struct { 
	*EventTrace
	...
	func NewKerberosDebugTraceEx1(instance *cim.WmiInstance) (newInstance *KerberosDebugTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KerberosDebugTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
