...
type MSMouse_PortInformation struct { 
	*MSMouse
	...
	func NewMSMouse_PortInformationEx1(instance *cim.WmiInstance) (newInstance *MSMouse_PortInformation, err error) {tmp, err := NewMSMouseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMouse_PortInformation, err error) {tmp, err := NewMSMouseEx6(hostName, wmiNamespace, userName, password, domainName, query)
