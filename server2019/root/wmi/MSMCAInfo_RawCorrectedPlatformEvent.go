...
type MSMCAInfo_RawCorrectedPlatformEvent struct { 
	*WMIEvent
	...
	func NewMSMCAInfo_RawCorrectedPlatformEventEx1(instance *cim.WmiInstance) (newInstance *MSMCAInfo_RawCorrectedPlatformEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAInfo_RawCorrectedPlatformEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
