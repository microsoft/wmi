...
type CSwitch_V2 struct { 
	*Thread_V2
	...
	func NewCSwitch_V2Ex1(instance *cim.WmiInstance) (newInstance *CSwitch_V2, err error) {tmp, err := NewThread_V2Ex1(instance)
		
	if err != nil { return }
	newInstance = &CSwitch_V2 {
	Thread_V2: tmp,
	}
	return
	}
	...
	func NewCSwitch_V2Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CSwitch_V2, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CSwitch_V2) SetPropertyNewThreadId(value uint32) (err error) { 
    return instance.SetProperty("NewThreadId", (value))
}

// GetNewThreadId gets the value of NewThreadId for the instance
func (instance *CSwitch_V2) GetPropertyNewThreadId()(value uint32, err error) { 
...
func (instance *CSwitch_V2) SetPropertyNewThreadPriority(value int8) (err error) { 
...
func (instance *CSwitch_V2) GetPropertyNewThreadPriority()(value int8, err error) { 
...
func (instance *CSwitch_V2) SetPropertyNewThreadWaitTime(value uint32) (err error) { 
...
func (instance *CSwitch_V2) GetPropertyNewThreadWaitTime()(value uint32, err error) { 
...
func (instance *CSwitch_V2) SetPropertyOldThreadId(value uint32) (err error) { 
    return instance.SetProperty("OldThreadId", (value))
}

// GetOldThreadId gets the value of OldThreadId for the instance
func (instance *CSwitch_V2) GetPropertyOldThreadId()(value uint32, err error) { 
...
func (instance *CSwitch_V2) SetPropertyOldThreadPriority(value int8) (err error) { 
...
func (instance *CSwitch_V2) GetPropertyOldThreadPriority()(value int8, err error) { 
...
func (instance *CSwitch_V2) SetPropertyOldThreadState(value int8) (err error) { 
    return instance.SetProperty("OldThreadState", (value))
}

// GetOldThreadState gets the value of OldThreadState for the instance
func (instance *CSwitch_V2) GetPropertyOldThreadState()(value int8, err error) { 
...
func (instance *CSwitch_V2) SetPropertyOldThreadWaitIdealProcessor(value int8) (err error) { 
...
func (instance *CSwitch_V2) GetPropertyOldThreadWaitIdealProcessor()(value int8, err error) { 
...
func (instance *CSwitch_V2) SetPropertyOldThreadWaitMode(value int8) (err error) { 
...
func (instance *CSwitch_V2) GetPropertyOldThreadWaitMode()(value int8, err error) { 
...
func (instance *CSwitch_V2) SetPropertyOldThreadWaitReason(value int8) (err error) { 
...
func (instance *CSwitch_V2) GetPropertyOldThreadWaitReason()(value int8, err error) { 
...
func (instance *CSwitch_V2) SetPropertyPreviousCState(value uint8) (err error) { 
    return instance.SetProperty("PreviousCState", (value))
}

// GetPreviousCState gets the value of PreviousCState for the instance
func (instance *CSwitch_V2) GetPropertyPreviousCState()(value uint8, err error) { 
...
func (instance *CSwitch_V2) SetPropertyReserved(value uint32) (err error) { 
    return instance.SetProperty("Reserved", (value))
}

// GetReserved gets the value of Reserved for the instance
func (instance *CSwitch_V2) GetPropertyReserved()(value uint32, err error) { 
...
func (instance *CSwitch_V2) SetPropertySpareByte(value int8) (err error) { 
    return instance.SetProperty("SpareByte", (value))
}

// GetSpareByte gets the value of SpareByte for the instance
func (instance *CSwitch_V2) GetPropertySpareByte()(value int8, err error) { 
