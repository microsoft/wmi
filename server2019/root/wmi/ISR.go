...
type ISR struct { 
	*PerfInfo_V2
	...
	func NewISREx1(instance *cim.WmiInstance) (newInstance *ISR, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISR, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
