...
type Registry_V1_TypeGroup1 struct { 
	*Registry_V1
	...
	func NewRegistry_V1_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Registry_V1_TypeGroup1, err error) {tmp, err := NewRegistry_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_V1_TypeGroup1, err error) {tmp, err := NewRegistry_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
