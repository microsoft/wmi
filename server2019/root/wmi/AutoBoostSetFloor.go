...
type AutoBoostSetFloor struct { 
	*Thread_V2
	...
	func NewAutoBoostSetFloorEx1(instance *cim.WmiInstance) (newInstance *AutoBoostSetFloor, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AutoBoostSetFloor, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
