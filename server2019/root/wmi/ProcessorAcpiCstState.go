...
type ProcessorAcpiCstState struct { 
	*cim.WmiInstance
	...
	func NewProcessorAcpiCstStateEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiCstState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorAcpiCstState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
