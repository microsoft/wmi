...
type ALPC_Wait_For_New_Message struct { 
	*ALPC
	...
	func NewALPC_Wait_For_New_MessageEx1(instance *cim.WmiInstance) (newInstance *ALPC_Wait_For_New_Message, err error) {tmp, err := NewALPCEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ALPC_Wait_For_New_Message, err error) {tmp, err := NewALPCEx6(hostName, wmiNamespace, userName, password, domainName, query)
