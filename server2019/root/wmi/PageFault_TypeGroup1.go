...
type PageFault_TypeGroup1 struct { 
	*PageFault_V2
	...
	func NewPageFault_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *PageFault_TypeGroup1, err error) {tmp, err := NewPageFault_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PageFault_TypeGroup1, err error) {tmp, err := NewPageFault_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
