...
type MSStorageDriver_FailurePredictData struct { 
	*MSStorageDriver
	...
	func NewMSStorageDriver_FailurePredictDataEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_FailurePredictData, err error) {tmp, err := NewMSStorageDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSStorageDriver_FailurePredictData, err error) {tmp, err := NewMSStorageDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
