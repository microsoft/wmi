...
type MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive struct { 
	*MSNdis
	...
	func NewMSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceiveEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
