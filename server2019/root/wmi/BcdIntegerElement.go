...
type BcdIntegerElement struct { 
	*BcdElement
	...
	func NewBcdIntegerElementEx1(instance *cim.WmiInstance) (newInstance *BcdIntegerElement, err error) {tmp, err := NewBcdElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdIntegerElement, err error) {tmp, err := NewBcdElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
