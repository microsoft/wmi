...
type MSPower_DeviceEnable struct { 
	*MSPower
	...
	func NewMSPower_DeviceEnableEx1(instance *cim.WmiInstance) (newInstance *MSPower_DeviceEnable, err error) {tmp, err := NewMSPowerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSPower_DeviceEnable, err error) {tmp, err := NewMSPowerEx6(hostName, wmiNamespace, userName, password, domainName, query)
