...
type ISCSI_RedirectPortalInfo struct { 
	*cim.WmiInstance
	...
	func NewISCSI_RedirectPortalInfoEx1(instance *cim.WmiInstance) (newInstance *ISCSI_RedirectPortalInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISCSI_RedirectPortalInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
