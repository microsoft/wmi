...
type MSNdis_WmiOutputInfo struct { 
	*MSNdis
	...
	func NewMSNdis_WmiOutputInfoEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiOutputInfo, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiOutputInfo, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
