...
type MSChangerProblemEvent struct { 
	*WMIEvent
	...
	func NewMSChangerProblemEventEx1(instance *cim.WmiInstance) (newInstance *MSChangerProblemEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSChangerProblemEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
