...
type MSiSCSI_RedirectPortalInfoClass struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_RedirectPortalInfoClassEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_RedirectPortalInfoClass, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_RedirectPortalInfoClass, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
