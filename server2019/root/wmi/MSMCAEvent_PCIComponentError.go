...
type MSMCAEvent_PCIComponentError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_PCIComponentErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_PCIComponentError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_PCIComponentError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
