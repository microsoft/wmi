...
type DPC struct { 
	*PerfInfo_V2
	...
	func NewDPCEx1(instance *cim.WmiInstance) (newInstance *DPC, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DPC, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
