...
func NewPmcCounterProfileEx1(instance *cim.WmiInstance) (newInstance *PmcCounterProfile, err error) {
...
func NewPmcCounterProfileEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PmcCounterProfile, err error) {
