...
type MSiSCSI_RADIUSConfig struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_RADIUSConfigEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_RADIUSConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_RADIUSConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
