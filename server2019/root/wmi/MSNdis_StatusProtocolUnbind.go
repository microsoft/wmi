...
type MSNdis_StatusProtocolUnbind struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusProtocolUnbindEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusProtocolUnbind, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusProtocolUnbind, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
