...
type KernelPerfStateChange struct { 
	*WMIEvent
	...
	func NewKernelPerfStateChangeEx1(instance *cim.WmiInstance) (newInstance *KernelPerfStateChange, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelPerfStateChange, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
