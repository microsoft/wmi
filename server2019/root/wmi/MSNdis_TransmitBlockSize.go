...
type MSNdis_TransmitBlockSize struct { 
	*MSNdis
	...
	func NewMSNdis_TransmitBlockSizeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TransmitBlockSize, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TransmitBlockSize, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
