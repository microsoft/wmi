...
type IoTimerEvent struct { 
	*PerfInfo_V2
	...
	func NewIoTimerEventEx1(instance *cim.WmiInstance) (newInstance *IoTimerEvent, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IoTimerEvent, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
