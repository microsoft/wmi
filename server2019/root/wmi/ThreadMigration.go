...
type ThreadMigration struct { 
	*Thread_V2
	...
	func NewThreadMigrationEx1(instance *cim.WmiInstance) (newInstance *ThreadMigration, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ThreadMigration, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
