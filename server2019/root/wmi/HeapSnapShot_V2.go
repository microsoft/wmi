...
type HeapSnapShot_V2 struct { 
	*HeapTrace_V2
	...
	func NewHeapSnapShot_V2Ex1(instance *cim.WmiInstance) (newInstance *HeapSnapShot_V2, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapSnapShot_V2, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
