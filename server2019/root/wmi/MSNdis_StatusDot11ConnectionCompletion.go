...
type MSNdis_StatusDot11ConnectionCompletion struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusDot11ConnectionCompletionEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusDot11ConnectionCompletion, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusDot11ConnectionCompletion, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
