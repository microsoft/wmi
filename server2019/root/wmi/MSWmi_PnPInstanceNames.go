...
type MSWmi_PnPInstanceNames struct { 
	*MS_WmiInternal
	...
	func NewMSWmi_PnPInstanceNamesEx1(instance *cim.WmiInstance) (newInstance *MSWmi_PnPInstanceNames, err error) {tmp, err := NewMS_WmiInternalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSWmi_PnPInstanceNames, err error) {tmp, err := NewMS_WmiInternalEx6(hostName, wmiNamespace, userName, password, domainName, query)
