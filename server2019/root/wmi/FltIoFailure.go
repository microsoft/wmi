...
type FltIoFailure struct { 
	*FileIo
	...
	func NewFltIoFailureEx1(instance *cim.WmiInstance) (newInstance *FltIoFailure, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FltIoFailure, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
