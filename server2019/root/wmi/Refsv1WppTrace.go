...
type Refsv1WppTrace struct { 
	*EventTrace
	...
	func NewRefsv1WppTraceEx1(instance *cim.WmiInstance) (newInstance *Refsv1WppTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Refsv1WppTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
