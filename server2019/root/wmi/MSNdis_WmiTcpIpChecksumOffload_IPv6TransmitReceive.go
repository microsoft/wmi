...
func NewMSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceiveEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceive, err error) {
...
func NewMSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceiveEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceive, err error) {
