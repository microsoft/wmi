...
type MSNdis_WmiEnumAdapter struct { 
	*MSNdis
	...
	func NewMSNdis_WmiEnumAdapterEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiEnumAdapter, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiEnumAdapter, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
