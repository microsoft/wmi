...
type HBAFC3MgmtInfo struct { 
	*cim.WmiInstance
	...
	func NewHBAFC3MgmtInfoEx1(instance *cim.WmiInstance) (newInstance *HBAFC3MgmtInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HBAFC3MgmtInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
