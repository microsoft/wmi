...
type MSNdis_MaximumFrameSize struct { 
	*MSNdis
	...
	func NewMSNdis_MaximumFrameSizeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_MaximumFrameSize, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_MaximumFrameSize, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
