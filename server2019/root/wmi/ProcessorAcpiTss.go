...
type ProcessorAcpiTss struct { 
	*cim.WmiInstance
	...
	func NewProcessorAcpiTssEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiTss, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorAcpiTss, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
