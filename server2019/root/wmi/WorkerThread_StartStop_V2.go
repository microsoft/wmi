...
type WorkerThread_StartStop_V2 struct { 
	*Thread_V2
	...
	func NewWorkerThread_StartStop_V2Ex1(instance *cim.WmiInstance) (newInstance *WorkerThread_StartStop_V2, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WorkerThread_StartStop_V2, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
