...
type WmiMonitorID struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorIDEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorID, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorID, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
