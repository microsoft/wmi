...
func NewMSNdis_80211_ConfigurationFHEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_ConfigurationFH, err error) {
...
func NewMSNdis_80211_ConfigurationFHEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_ConfigurationFH, err error) {
