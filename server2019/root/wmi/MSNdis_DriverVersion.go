...
type MSNdis_DriverVersion struct { 
	*MSNdis
	...
	func NewMSNdis_DriverVersionEx1(instance *cim.WmiInstance) (newInstance *MSNdis_DriverVersion, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_DriverVersion, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
