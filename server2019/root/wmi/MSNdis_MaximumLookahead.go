...
type MSNdis_MaximumLookahead struct { 
	*MSNdis
	...
	func NewMSNdis_MaximumLookaheadEx1(instance *cim.WmiInstance) (newInstance *MSNdis_MaximumLookahead, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_MaximumLookahead, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
