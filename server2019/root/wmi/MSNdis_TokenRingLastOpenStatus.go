...
type MSNdis_TokenRingLastOpenStatus struct { 
	*MSNdis
	...
	func NewMSNdis_TokenRingLastOpenStatusEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TokenRingLastOpenStatus, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TokenRingLastOpenStatus, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
