...
type MSiSCSI_NICConfig struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_NICConfigEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_NICConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_NICConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
