...
type MSFC_AdapterEvent struct { 
	*WMIEvent
	...
	func NewMSFC_AdapterEventEx1(instance *cim.WmiInstance) (newInstance *MSFC_AdapterEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_AdapterEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
