...
type MSNdis_ReceiveFilterParameters struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveFilterParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveFilterParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveFilterParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
