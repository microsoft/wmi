...
type MSStorageDriver_FailurePredictStatus struct { 
	*MSStorageDriver
	...
	func NewMSStorageDriver_FailurePredictStatusEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_FailurePredictStatus, err error) {tmp, err := NewMSStorageDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSStorageDriver_FailurePredictStatus, err error) {tmp, err := NewMSStorageDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
