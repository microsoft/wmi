...
type NlServerAuth_Start struct { 
	*NlServerAuth
	...
	func NewNlServerAuth_StartEx1(instance *cim.WmiInstance) (newInstance *NlServerAuth_Start, err error) {tmp, err := NewNlServerAuthEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NlServerAuth_Start, err error) {tmp, err := NewNlServerAuthEx6(hostName, wmiNamespace, userName, password, domainName, query)
