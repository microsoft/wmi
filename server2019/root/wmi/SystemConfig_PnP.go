...
type SystemConfig_PnP struct { 
	*SystemConfig
	...
	func NewSystemConfig_PnPEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_PnP, err error) {tmp, err := NewSystemConfigEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_PnP, err error) {tmp, err := NewSystemConfigEx6(hostName, wmiNamespace, userName, password, domainName, query)
