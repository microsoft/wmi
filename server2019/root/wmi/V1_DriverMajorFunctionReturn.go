...
type V1_DriverMajorFunctionReturn struct { 
	*DiskIo_V1
	...
	func NewV1_DriverMajorFunctionReturnEx1(instance *cim.WmiInstance) (newInstance *V1_DriverMajorFunctionReturn, err error) {tmp, err := NewDiskIo_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *V1_DriverMajorFunctionReturn, err error) {tmp, err := NewDiskIo_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
