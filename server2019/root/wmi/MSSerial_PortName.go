...
type MSSerial_PortName struct { 
	*MSSerial
	...
	func NewMSSerial_PortNameEx1(instance *cim.WmiInstance) (newInstance *MSSerial_PortName, err error) {tmp, err := NewMSSerialEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSerial_PortName, err error) {tmp, err := NewMSSerialEx6(hostName, wmiNamespace, userName, password, domainName, query)
