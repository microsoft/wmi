...
type MSVerifierIrpLogEntry struct { 
	*cim.WmiInstance
	...
	func NewMSVerifierIrpLogEntryEx1(instance *cim.WmiInstance) (newInstance *MSVerifierIrpLogEntry, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSVerifierIrpLogEntry, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
