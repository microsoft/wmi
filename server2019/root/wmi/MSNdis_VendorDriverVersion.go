...
type MSNdis_VendorDriverVersion struct { 
	*MSNdis
	...
	func NewMSNdis_VendorDriverVersionEx1(instance *cim.WmiInstance) (newInstance *MSNdis_VendorDriverVersion, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_VendorDriverVersion, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
