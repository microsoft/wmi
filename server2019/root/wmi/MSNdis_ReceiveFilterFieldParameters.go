...
type MSNdis_ReceiveFilterFieldParameters struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveFilterFieldParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveFilterFieldParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveFilterFieldParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
