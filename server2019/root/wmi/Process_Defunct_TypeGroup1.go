...
type Process_Defunct_TypeGroup1 struct { 
	*Process
	...
	func NewProcess_Defunct_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Process_Defunct_TypeGroup1, err error) {tmp, err := NewProcessEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Process_Defunct_TypeGroup1, err error) {tmp, err := NewProcessEx6(hostName, wmiNamespace, userName, password, domainName, query)
