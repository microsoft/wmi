...
type MSiSCSIInitiator_IKEPresharedKeyAuthenticationInfo struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_IKEPresharedKeyAuthenticationInfoEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_IKEPresharedKeyAuthenticationInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_IKEPresharedKeyAuthenticationInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
