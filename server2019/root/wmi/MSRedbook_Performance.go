...
type MSRedbook_Performance struct { 
	*cim.WmiInstance
	...
	func NewMSRedbook_PerformanceEx1(instance *cim.WmiInstance) (newInstance *MSRedbook_Performance, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSRedbook_Performance, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
