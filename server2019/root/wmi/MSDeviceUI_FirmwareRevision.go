...
type MSDeviceUI_FirmwareRevision struct { 
	*MSDeviceUI
	...
	func NewMSDeviceUI_FirmwareRevisionEx1(instance *cim.WmiInstance) (newInstance *MSDeviceUI_FirmwareRevision, err error) {tmp, err := NewMSDeviceUIEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSDeviceUI_FirmwareRevision, err error) {tmp, err := NewMSDeviceUIEx6(hostName, wmiNamespace, userName, password, domainName, query)
