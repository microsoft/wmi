...
type ObHandleDuplicateEvent struct { 
	*ObTrace
	...
	func NewObHandleDuplicateEventEx1(instance *cim.WmiInstance) (newInstance *ObHandleDuplicateEvent, err error) {tmp, err := NewObTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ObHandleDuplicateEvent, err error) {tmp, err := NewObTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
