...
type HeapSubsegmentReuseThresholdActivated struct { 
	*HeapTrace_V2
	...
	func NewHeapSubsegmentReuseThresholdActivatedEx1(instance *cim.WmiInstance) (newInstance *HeapSubsegmentReuseThresholdActivated, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapSubsegmentReuseThresholdActivated, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
