...
func NewMSNdis_NetworkLinkSpeedEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NetworkLinkSpeed, err error) {
...
func NewMSNdis_NetworkLinkSpeedEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_NetworkLinkSpeed, err error) {
