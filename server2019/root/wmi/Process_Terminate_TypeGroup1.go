...
type Process_Terminate_TypeGroup1 struct { 
	*Process_V2
	...
	func NewProcess_Terminate_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Process_Terminate_TypeGroup1, err error) {tmp, err := NewProcess_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Process_Terminate_TypeGroup1, err error) {tmp, err := NewProcess_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
