...
type ProcessorAcpiCsdDependency struct { 
	*cim.WmiInstance
	...
	func NewProcessorAcpiCsdDependencyEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiCsdDependency, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorAcpiCsdDependency, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
