...
type SampledProfileInterval_V3 struct { 
	*PerfInfo
	...
	func NewSampledProfileInterval_V3Ex1(instance *cim.WmiInstance) (newInstance *SampledProfileInterval_V3, err error) {tmp, err := NewPerfInfoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SampledProfileInterval_V3, err error) {tmp, err := NewPerfInfoEx6(hostName, wmiNamespace, userName, password, domainName, query)
