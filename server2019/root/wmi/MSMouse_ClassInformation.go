...
type MSMouse_ClassInformation struct { 
	*MSMouse
	...
	func NewMSMouse_ClassInformationEx1(instance *cim.WmiInstance) (newInstance *MSMouse_ClassInformation, err error) {tmp, err := NewMSMouseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMouse_ClassInformation, err error) {tmp, err := NewMSMouseEx6(hostName, wmiNamespace, userName, password, domainName, query)
