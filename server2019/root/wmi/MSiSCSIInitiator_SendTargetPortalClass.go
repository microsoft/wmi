...
type MSiSCSIInitiator_SendTargetPortalClass struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_SendTargetPortalClassEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_SendTargetPortalClass, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_SendTargetPortalClass, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSiSCSIInitiator_SendTargetPortalClass) Refresh() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Refresh" );
	if err != nil { return }
