...
type MSNdis_EthernetReceiveErrorAlignment struct { 
	*MSNdis
	...
	func NewMSNdis_EthernetReceiveErrorAlignmentEx1(instance *cim.WmiInstance) (newInstance *MSNdis_EthernetReceiveErrorAlignment, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_EthernetReceiveErrorAlignment, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
