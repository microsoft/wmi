...
type MSMCAInfo_RawCMCEvent struct { 
	*WMIEvent
	...
	func NewMSMCAInfo_RawCMCEventEx1(instance *cim.WmiInstance) (newInstance *MSMCAInfo_RawCMCEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAInfo_RawCMCEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
