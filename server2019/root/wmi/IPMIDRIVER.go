...
type IPMIDRIVER struct { 
	*EventTrace
	...
	func NewIPMIDRIVEREx1(instance *cim.WmiInstance) (newInstance *IPMIDRIVER, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IPMIDRIVER, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
