...
func NewSystemConfig_V1_IRQEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_IRQ, err error) {
...
func NewSystemConfig_V1_IRQEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SystemConfig_V1_IRQ, err error) {
