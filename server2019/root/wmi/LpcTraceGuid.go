...
type LpcTraceGuid struct { 
	*EventTrace
	...
	func NewLpcTraceGuidEx1(instance *cim.WmiInstance) (newInstance *LpcTraceGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LpcTraceGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
