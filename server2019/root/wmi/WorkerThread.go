...
type WorkerThread struct { 
	*Thread_V2
	...
	func NewWorkerThreadEx1(instance *cim.WmiInstance) (newInstance *WorkerThread, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WorkerThread, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
