...
type WmiMonitorColorCharacteristics struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorColorCharacteristicsEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorColorCharacteristics, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorColorCharacteristics, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
