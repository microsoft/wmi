...
type MSNdis_DeviceWakeOnMagicPacketOnly struct { 
	*MSNdis
	...
	func NewMSNdis_DeviceWakeOnMagicPacketOnlyEx1(instance *cim.WmiInstance) (newInstance *MSNdis_DeviceWakeOnMagicPacketOnly, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_DeviceWakeOnMagicPacketOnly, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
