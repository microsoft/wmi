...
type Header_Extension_V0_TypeGroup struct { 
	*EventTraceEvent_V0
	...
	func NewHeader_Extension_V0_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_Extension_V0_TypeGroup, err error) {tmp, err := NewEventTraceEvent_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Header_Extension_V0_TypeGroup, err error) {tmp, err := NewEventTraceEvent_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
