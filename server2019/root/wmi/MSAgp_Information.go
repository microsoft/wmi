...
type MSAgp_Information struct { 
	*MSAgp
	...
	func NewMSAgp_InformationEx1(instance *cim.WmiInstance) (newInstance *MSAgp_Information, err error) {tmp, err := NewMSAgpEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSAgp_Information, err error) {tmp, err := NewMSAgpEx6(hostName, wmiNamespace, userName, password, domainName, query)
