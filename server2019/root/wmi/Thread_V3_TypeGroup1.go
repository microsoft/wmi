...
func NewThread_V3_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Thread_V3_TypeGroup1, err error) {
...
func NewThread_V3_TypeGroup1Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Thread_V3_TypeGroup1, err error) {
