...
type MSNdis_StatusHDSplitCurrentConfig struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusHDSplitCurrentConfigEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusHDSplitCurrentConfig, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusHDSplitCurrentConfig, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
