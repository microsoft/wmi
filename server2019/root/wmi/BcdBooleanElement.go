...
type BcdBooleanElement struct { 
	*BcdElement
	...
	func NewBcdBooleanElementEx1(instance *cim.WmiInstance) (newInstance *BcdBooleanElement, err error) {tmp, err := NewBcdElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdBooleanElement, err error) {tmp, err := NewBcdElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
