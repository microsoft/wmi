...
type MSFC_HBAAdapterMethods struct { 
	*cim.WmiInstance
	...
	func NewMSFC_HBAAdapterMethodsEx1(instance *cim.WmiInstance) (newInstance *MSFC_HBAAdapterMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_HBAAdapterMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFC_HBAAdapterMethods) GetDiscoveredPortAttributes( /* IN */ PortIndex uint32,
 ...
 /* OUT */ PortAttributes MSFC_HBAPortAttributesResults) (err error) {_, err = instance.InvokeMethod("GetDiscoveredPortAttributes" , PortIndex, DiscoveredPortIndex)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) GetPortAttributesByWWN( /* IN */ wwn []uint8,
 /* OUT */ HBAStatus uint32,
 /* OUT */ PortAttributes MSFC_HBAPortAttributesResults) (err error) {_, err = instance.InvokeMethod("GetPortAttributesByWWN" , wwn)
	if err != nil { return }
	return
...
// 
func (instance *MSFC_HBAAdapterMethods) RefreshInformation() (err error) {_, err = instance.InvokeMethodWithReturn("RefreshInformation" );
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendCTPassThru( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ ResponseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendCTPassThru" , PortWWN, RequestBufferCount, RequestBuffer)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendRNID( /* IN */ wwn []uint8,
 ...
 /* OUT */ ResponseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendRNID" , wwn, wwntype)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendRNIDV2( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ RspBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendRNIDV2" , PortWWN, DestWWN, DestFCID, NodeIdDataFormat)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) GetFC3MgmtInfo( /* OUT */ HBAStatus uint32,
 /* OUT */ MgmtInfo HBAFC3MgmtInfo) (err error) {_, err = instance.InvokeMethod("GetFC3MgmtInfo" )
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SetFC3MgmtInfo( /* IN */ MgmtInfo HBAFC3MgmtInfo,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SetFC3MgmtInfo" , MgmtInfo)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendRPL( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ TotalRspBufferSize uint32,
 /* OUT */ ActualRspBufferSize uint32,
 /* OUT */ RspBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendRPL" , PortWWN, AgentWWN, agent_domain, portIndex)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendRPS( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ TotalRspBufferSize uint32,
 /* OUT */ ActualRspBufferSize uint32,
 /* OUT */ RspBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendRPS" , PortWWN, AgentWWN, ObjectWWN, AgentDomain, ObjectPortNumber)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendSRL( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ TotalRspBufferSize uint32,
 /* OUT */ ActualRspBufferSize uint32,
 /* OUT */ RspBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendSRL" , PortWWN, WWN, Domain)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendLIRR( /* IN */ SourceWWN []uint8,
 ...
 /* OUT */ TotalRspBufferSize uint32,
 /* OUT */ ActualRspBufferSize uint32,
 /* OUT */ RspBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendLIRR" , SourceWWN, DestWWN, Function, Type)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) GetFC4Statistics( /* IN */ PortWWN []uint8,
 /* IN */ FC4Type uint8,
 /* OUT */ HBAStatus uint32,
 /* OUT */ FC4Statistics MSFC_FC4STATISTICS) (err error) {_, err = instance.InvokeMethod("GetFC4Statistics" , PortWWN, FC4Type)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) GetFCPStatistics( /* IN */ ScsiId HBAScsiID,
 /* OUT */ HBAStatus uint32,
 /* OUT */ FC4Statistics MSFC_FC4STATISTICS) (err error) {_, err = instance.InvokeMethod("GetFCPStatistics" , ScsiId)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) ScsiInquiry( /* IN */ Cdb []uint8,
 ...
 /* OUT */ SenseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("ScsiInquiry" , Cdb, HbaPortWWN, DiscoveredPortWWN, FcLun)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) ScsiReadCapacity( /* IN */ Cdb []uint8,
 ...
 /* OUT */ ScsiStatus uint8,
 /* OUT */ ResponseBuffer []uint8,
 /* OUT */ SenseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("ScsiReadCapacity" , Cdb, HbaPortWWN, DiscoveredPortWWN, FcLun)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) ScsiReportLuns( /* IN */ Cdb []uint8,
 ...
 /* OUT */ ScsiStatus uint8,
 /* OUT */ ResponseBuffer []uint8,
 /* OUT */ SenseBuffer []uint8) (err error) {_, err = instance.InvokeMethod("ScsiReportLuns" , Cdb, HbaPortWWN, DiscoveredPortWWN)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) GetEventBuffer( /* OUT */ HBAStatus uint32,
 ...
 /* OUT */ Events []MSFC_EventBuffer) (err error) {_, err = instance.InvokeMethod("GetEventBuffer" )
	if err != nil { return }
	return
...
func (instance *MSFC_HBAAdapterMethods) SendRLS( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ TotalRspBufferSize uint32,
 /* OUT */ ActualRspBufferSize uint32,
 /* OUT */ RspBuffer []uint8) (err error) {_, err = instance.InvokeMethod("SendRLS" , PortWWN, DestWWN)
	if err != nil { return }
	return
