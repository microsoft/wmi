...
type MSNdis_HDSplitParameters struct { 
	*MSNdis
	...
	func NewMSNdis_HDSplitParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_HDSplitParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_HDSplitParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
