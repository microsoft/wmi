...
type SamCreateAliasInDom_Start struct { 
	*SamCreateAliasInDom
	...
	func NewSamCreateAliasInDom_StartEx1(instance *cim.WmiInstance) (newInstance *SamCreateAliasInDom_Start, err error) {tmp, err := NewSamCreateAliasInDomEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamCreateAliasInDom_Start, err error) {tmp, err := NewSamCreateAliasInDomEx6(hostName, wmiNamespace, userName, password, domainName, query)
