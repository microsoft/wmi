...
type LoaderCodedEvent struct { 
	*Image_V2
	...
	func NewLoaderCodedEventEx1(instance *cim.WmiInstance) (newInstance *LoaderCodedEvent, err error) {tmp, err := NewImage_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LoaderCodedEvent, err error) {tmp, err := NewImage_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
