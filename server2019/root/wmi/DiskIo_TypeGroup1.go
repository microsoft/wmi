...
type DiskIo_TypeGroup1 struct { 
	*DiskIo
	...
	func NewDiskIo_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *DiskIo_TypeGroup1, err error) {tmp, err := NewDiskIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DiskIo_TypeGroup1, err error) {tmp, err := NewDiskIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
