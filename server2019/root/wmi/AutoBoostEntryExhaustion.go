...
type AutoBoostEntryExhaustion struct { 
	*Thread_V2
	...
	func NewAutoBoostEntryExhaustionEx1(instance *cim.WmiInstance) (newInstance *AutoBoostEntryExhaustion, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AutoBoostEntryExhaustion, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
