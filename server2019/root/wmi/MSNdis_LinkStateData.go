...
type MSNdis_LinkStateData struct { 
	*MSNdis
	...
	func NewMSNdis_LinkStateDataEx1(instance *cim.WmiInstance) (newInstance *MSNdis_LinkStateData, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_LinkStateData, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
