...
func NewMSMCAEvent_PlatformSpecificErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_PlatformSpecificError, err error) {
...
func NewMSMCAEvent_PlatformSpecificErrorEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSMCAEvent_PlatformSpecificError, err error) {
