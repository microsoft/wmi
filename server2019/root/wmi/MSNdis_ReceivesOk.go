...
type MSNdis_ReceivesOk struct { 
	*MSNdis
	...
	func NewMSNdis_ReceivesOkEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceivesOk, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceivesOk, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
