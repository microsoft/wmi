...
type MSFC_FC4STATISTICS struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FC4STATISTICSEx1(instance *cim.WmiInstance) (newInstance *MSFC_FC4STATISTICS, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FC4STATISTICS, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
