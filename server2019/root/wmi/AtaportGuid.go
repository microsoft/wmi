...
type AtaportGuid struct { 
	*EventTrace
	...
	func NewAtaportGuidEx1(instance *cim.WmiInstance) (newInstance *AtaportGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AtaportGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
