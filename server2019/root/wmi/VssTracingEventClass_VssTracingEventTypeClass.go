...
type VssTracingEventClass_VssTracingEventTypeClass struct { 
	*VssTracingEventClass
	...
	func NewVssTracingEventClass_VssTracingEventTypeClassEx1(instance *cim.WmiInstance) (newInstance *VssTracingEventClass_VssTracingEventTypeClass, err error) {tmp, err := NewVssTracingEventClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VssTracingEventClass_VssTracingEventTypeClass, err error) {tmp, err := NewVssTracingEventClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
