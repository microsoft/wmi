...
type Process_V0_TypeGroup1 struct { 
	*Process_V0
	...
	func NewProcess_V0_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Process_V0_TypeGroup1, err error) {tmp, err := NewProcess_V0Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Process_V0_TypeGroup1, err error) {tmp, err := NewProcess_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
