...
type Registry_ChangeNotification struct { 
	*Registry
	...
	func NewRegistry_ChangeNotificationEx1(instance *cim.WmiInstance) (newInstance *Registry_ChangeNotification, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_ChangeNotification, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
