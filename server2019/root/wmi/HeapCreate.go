...
type HeapCreate struct { 
	*HeapTrace
	...
	func NewHeapCreateEx1(instance *cim.WmiInstance) (newInstance *HeapCreate, err error) {tmp, err := NewHeapTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapCreate, err error) {tmp, err := NewHeapTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
