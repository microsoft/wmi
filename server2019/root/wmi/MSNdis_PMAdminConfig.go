...
type MSNdis_PMAdminConfig struct { 
	*MSNdis
	...
	func NewMSNdis_PMAdminConfigEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PMAdminConfig, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PMAdminConfig, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
