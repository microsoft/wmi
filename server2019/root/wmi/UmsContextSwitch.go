...
type UmsContextSwitch struct { 
	*UmsEvent
	...
	func NewUmsContextSwitchEx1(instance *cim.WmiInstance) (newInstance *UmsContextSwitch, err error) {tmp, err := NewUmsEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UmsContextSwitch, err error) {tmp, err := NewUmsEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
