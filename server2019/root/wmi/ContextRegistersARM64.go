...
type ContextRegistersARM64 struct { 
	*PerfInfo_V2
	...
	func NewContextRegistersARM64Ex1(instance *cim.WmiInstance) (newInstance *ContextRegistersARM64, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ContextRegistersARM64, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
