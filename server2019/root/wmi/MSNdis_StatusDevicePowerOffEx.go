...
type MSNdis_StatusDevicePowerOffEx struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusDevicePowerOffExEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusDevicePowerOffEx, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusDevicePowerOffEx, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
