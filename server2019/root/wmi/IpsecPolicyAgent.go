...
type IpsecPolicyAgent struct { 
	*EventTrace
	...
	func NewIpsecPolicyAgentEx1(instance *cim.WmiInstance) (newInstance *IpsecPolicyAgent, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IpsecPolicyAgent, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
