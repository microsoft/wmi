...
type UdpIp_Fail struct { 
	*UdpIp
	...
	func NewUdpIp_FailEx1(instance *cim.WmiInstance) (newInstance *UdpIp_Fail, err error) {tmp, err := NewUdpIpEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UdpIp_Fail, err error) {tmp, err := NewUdpIpEx6(hostName, wmiNamespace, userName, password, domainName, query)
