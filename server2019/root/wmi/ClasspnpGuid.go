...
type ClasspnpGuid struct { 
	*EventTrace
	...
	func NewClasspnpGuidEx1(instance *cim.WmiInstance) (newInstance *ClasspnpGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClasspnpGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
