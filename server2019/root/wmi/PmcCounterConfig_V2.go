...
type PmcCounterConfig_V2 struct { 
	*PerfInfo_V2
	...
	func NewPmcCounterConfig_V2Ex1(instance *cim.WmiInstance) (newInstance *PmcCounterConfig_V2, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PmcCounterConfig_V2, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
