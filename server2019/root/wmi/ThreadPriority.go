...
type ThreadPriority struct { 
	*Thread_V3
	...
	func NewThreadPriorityEx1(instance *cim.WmiInstance) (newInstance *ThreadPriority, err error) {tmp, err := NewThread_V3Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ThreadPriority, err error) {tmp, err := NewThread_V3Ex6(hostName, wmiNamespace, userName, password, domainName, query)
