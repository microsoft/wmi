...
type ClusBfltPathInformation struct { 
	*cim.WmiInstance
	...
	func NewClusBfltPathInformationEx1(instance *cim.WmiInstance) (newInstance *ClusBfltPathInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltPathInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
