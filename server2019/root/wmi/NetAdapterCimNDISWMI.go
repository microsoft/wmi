...
type NetAdapterCimNDISWMI struct { 
	*EventTrace
	...
	func NewNetAdapterCimNDISWMIEx1(instance *cim.WmiInstance) (newInstance *NetAdapterCimNDISWMI, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NetAdapterCimNDISWMI, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
