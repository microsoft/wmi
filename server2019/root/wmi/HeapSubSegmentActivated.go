...
type HeapSubSegmentActivated struct { 
	*HeapTrace_V2
	...
	func NewHeapSubSegmentActivatedEx1(instance *cim.WmiInstance) (newInstance *HeapSubSegmentActivated, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapSubSegmentActivated, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
