...
type FileIo_ReadWrite struct { 
	*FileIo
	...
	func NewFileIo_ReadWriteEx1(instance *cim.WmiInstance) (newInstance *FileIo_ReadWrite, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_ReadWrite, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
