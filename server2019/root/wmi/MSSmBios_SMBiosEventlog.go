...
type MSSmBios_SMBiosEventlog struct { 
	*MS_SmBios
	...
	func NewMSSmBios_SMBiosEventlogEx1(instance *cim.WmiInstance) (newInstance *MSSmBios_SMBiosEventlog, err error) {tmp, err := NewMS_SmBiosEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSmBios_SMBiosEventlog, err error) {tmp, err := NewMS_SmBiosEx6(hostName, wmiNamespace, userName, password, domainName, query)
