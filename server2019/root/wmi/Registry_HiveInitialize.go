...
type Registry_HiveInitialize struct { 
	*Registry
	...
	func NewRegistry_HiveInitializeEx1(instance *cim.WmiInstance) (newInstance *Registry_HiveInitialize, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_HiveInitialize, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
