...
type BFn struct { 
	*cim.WmiInstance
	...
	func NewBFnEx1(instance *cim.WmiInstance) (newInstance *BFn, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BFn, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
// <param name="Data" type="BDat ">Fn buf</param>
func (instance *BFn) DoBFn( /* IN/OUT */ Data BDat) (err error) {_, err = instance.InvokeMethod("DoBFn" )
	if err != nil { return }
	return
