...
type FirewallAPI struct { 
	*EventTrace
	...
	func NewFirewallAPIEx1(instance *cim.WmiInstance) (newInstance *FirewallAPI, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FirewallAPI, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
