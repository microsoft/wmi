...
type AcpiGenAddr struct { 
	*cim.WmiInstance
	...
	func NewAcpiGenAddrEx1(instance *cim.WmiInstance) (newInstance *AcpiGenAddr, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AcpiGenAddr, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
