...
type Sbp2portGuid struct { 
	*EventTrace
	...
	func NewSbp2portGuidEx1(instance *cim.WmiInstance) (newInstance *Sbp2portGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Sbp2portGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
