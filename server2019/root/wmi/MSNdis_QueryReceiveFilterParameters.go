...
type MSNdis_QueryReceiveFilterParameters struct { 
	*MSNdis
	...
	func NewMSNdis_QueryReceiveFilterParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_QueryReceiveFilterParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_QueryReceiveFilterParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_QueryReceiveFilterParameters) WmiQueryReceiveFilterParameters( /* IN */ Header MSNdis_WmiMethodHeader,
 /* IN/OUT */ ReceiveFilterParameters MSNdis_ReceiveFilterParameters) (err error) {_, err = instance.InvokeMethod("WmiQueryReceiveFilterParameters" , Header)
	if err != nil { return }
	return
