...
type WHEAPageOfflineMethods struct { 
	*WHEA
	...
	func NewWHEAPageOfflineMethodsEx1(instance *cim.WmiInstance) (newInstance *WHEAPageOfflineMethods, err error) {tmp, err := NewWHEAEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WHEAPageOfflineMethods, err error) {tmp, err := NewWHEAEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *WHEAPageOfflineMethods) WheaPageOfflineInterfaceRtn( /* IN */ InputLength uint32,
 ...
 /* OUT */ Status uint32) (err error) {_, err = instance.InvokeMethod("WheaPageOfflineInterfaceRtn" , InputLength, InputBuffer)
	if err != nil { return }
	return
