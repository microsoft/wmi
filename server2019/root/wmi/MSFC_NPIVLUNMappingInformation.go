...
type MSFC_NPIVLUNMappingInformation struct { 
	*cim.WmiInstance
	...
	func NewMSFC_NPIVLUNMappingInformationEx1(instance *cim.WmiInstance) (newInstance *MSFC_NPIVLUNMappingInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_NPIVLUNMappingInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
