...
type ClusBfltDeviceInformation struct { 
	*cim.WmiInstance
	...
	func NewClusBfltDeviceInformationEx1(instance *cim.WmiInstance) (newInstance *ClusBfltDeviceInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltDeviceInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
