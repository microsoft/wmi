...
type CritSecInit struct { 
	*CritSecTrace
	...
	func NewCritSecInitEx1(instance *cim.WmiInstance) (newInstance *CritSecInit, err error) {tmp, err := NewCritSecTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CritSecInit, err error) {tmp, err := NewCritSecTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
