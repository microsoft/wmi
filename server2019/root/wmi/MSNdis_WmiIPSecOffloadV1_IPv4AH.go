...
type MSNdis_WmiIPSecOffloadV1_IPv4AH struct { 
	*MSNdis
	...
	func NewMSNdis_WmiIPSecOffloadV1_IPv4AHEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiIPSecOffloadV1_IPv4AH, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiIPSecOffloadV1_IPv4AH, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
