...
type DriverMajorFunctionCall struct { 
	*DiskIo_V2
	...
	func NewDriverMajorFunctionCallEx1(instance *cim.WmiInstance) (newInstance *DriverMajorFunctionCall, err error) {tmp, err := NewDiskIo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DriverMajorFunctionCall, err error) {tmp, err := NewDiskIo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
