...
type MSNdis_StatusPortState struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusPortStateEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusPortState, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusPortState, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
