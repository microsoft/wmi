...
type BcdDeviceLocateElementChildData struct { 
	*BcdDeviceLocateData
	...
	func NewBcdDeviceLocateElementChildDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceLocateElementChildData, err error) {tmp, err := NewBcdDeviceLocateDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdDeviceLocateElementChildData, err error) {tmp, err := NewBcdDeviceLocateDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
