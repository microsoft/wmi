...
type MSNdis_StatusProtocolBind struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusProtocolBindEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusProtocolBind, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusProtocolBind, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
