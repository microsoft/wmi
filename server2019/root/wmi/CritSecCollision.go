...
type CritSecCollision struct { 
	*CritSecTrace
	...
	func NewCritSecCollisionEx1(instance *cim.WmiInstance) (newInstance *CritSecCollision, err error) {tmp, err := NewCritSecTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CritSecCollision, err error) {tmp, err := NewCritSecTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
