...
type MSiSCSI_InitiatorNodeFailureEvent struct { 
	*__ExtrinsicEvent
	...
	func NewMSiSCSI_InitiatorNodeFailureEventEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_InitiatorNodeFailureEvent, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_InitiatorNodeFailureEvent, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
