...
type HBAFCPScsiEntry struct { 
	*cim.WmiInstance
	...
	func NewHBAFCPScsiEntryEx1(instance *cim.WmiInstance) (newInstance *HBAFCPScsiEntry, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HBAFCPScsiEntry, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
