...
type TcpIp_V1_Fail struct { 
	*TcpIp_V1
	...
	func NewTcpIp_V1_FailEx1(instance *cim.WmiInstance) (newInstance *TcpIp_V1_Fail, err error) {tmp, err := NewTcpIp_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TcpIp_V1_Fail, err error) {tmp, err := NewTcpIp_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
