...
type MSStorageDriver_ScsiInfoExceptions struct { 
	*MSStorageDriver
	...
	func NewMSStorageDriver_ScsiInfoExceptionsEx1(instance *cim.WmiInstance) (newInstance *MSStorageDriver_ScsiInfoExceptions, err error) {tmp, err := NewMSStorageDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSStorageDriver_ScsiInfoExceptions, err error) {tmp, err := NewMSStorageDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
