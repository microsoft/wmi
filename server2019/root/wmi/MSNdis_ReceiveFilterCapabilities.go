...
type MSNdis_ReceiveFilterCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveFilterCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveFilterCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveFilterCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
