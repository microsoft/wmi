...
type MSNdis_PhysicalMediumType struct { 
	*MSNdis
	...
	func NewMSNdis_PhysicalMediumTypeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PhysicalMediumType, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PhysicalMediumType, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
