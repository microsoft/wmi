...
func NewMSNdis_80211_NetworkTypesSupportedEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_NetworkTypesSupported, err error) {
...
func NewMSNdis_80211_NetworkTypesSupportedEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_80211_NetworkTypesSupported, err error) {
