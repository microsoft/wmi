...
type UmsScheduledPark struct { 
	*UmsEvent
	...
	func NewUmsScheduledParkEx1(instance *cim.WmiInstance) (newInstance *UmsScheduledPark, err error) {tmp, err := NewUmsEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UmsScheduledPark, err error) {tmp, err := NewUmsEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
