...
type WmiMonitorBasicDisplayParams struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorBasicDisplayParamsEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorBasicDisplayParams, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorBasicDisplayParams, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
