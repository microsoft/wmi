...
type FileIo_Info struct { 
	*FileIo
	...
	func NewFileIo_InfoEx1(instance *cim.WmiInstance) (newInstance *FileIo_Info, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_Info, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
