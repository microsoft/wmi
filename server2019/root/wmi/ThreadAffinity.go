...
type ThreadAffinity struct { 
	*Thread_V2
	...
	func NewThreadAffinityEx1(instance *cim.WmiInstance) (newInstance *ThreadAffinity, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ThreadAffinity, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
