...
type MSNdis_ReceiveScaleCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_ReceiveScaleCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ReceiveScaleCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ReceiveScaleCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_ReceiveScaleCapabilities) WmiQueryReceiveScaleCapabilities( /* IN */ Header MSNdis_WmiMethodHeader,
 /* OUT */ RssCaps MSNdis_WmiReceiveScaleCapabilities) (err error) {_, err = instance.InvokeMethod("WmiQueryReceiveScaleCapabilities" , Header)
	if err != nil { return }
	return
