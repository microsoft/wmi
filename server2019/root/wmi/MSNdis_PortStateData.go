...
type MSNdis_PortStateData struct { 
	*MSNdis
	...
	func NewMSNdis_PortStateDataEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PortStateData, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PortStateData, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
