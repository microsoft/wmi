...
type MSNdis_FddiLongCurrentAddress struct { 
	*MSNdis
	...
	func NewMSNdis_FddiLongCurrentAddressEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiLongCurrentAddress, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_FddiLongCurrentAddress, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
