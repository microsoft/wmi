...
type KernelPerfStates struct { 
	*MSKernelPpmClass
	...
	func NewKernelPerfStatesEx1(instance *cim.WmiInstance) (newInstance *KernelPerfStates, err error) {tmp, err := NewMSKernelPpmClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelPerfStates, err error) {tmp, err := NewMSKernelPpmClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
