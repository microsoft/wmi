...
type Thread_V2_TypeGroup1 struct { 
	*Thread_V2
	...
	func NewThread_V2_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *Thread_V2_TypeGroup1, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Thread_V2_TypeGroup1, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
