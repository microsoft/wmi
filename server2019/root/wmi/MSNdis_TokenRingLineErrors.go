...
type MSNdis_TokenRingLineErrors struct { 
	*MSNdis
	...
	func NewMSNdis_TokenRingLineErrorsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TokenRingLineErrors, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TokenRingLineErrors, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
