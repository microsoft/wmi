...
type MSNdis_PMCapabilityState struct { 
	*MSNdis
	...
	func NewMSNdis_PMCapabilityStateEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PMCapabilityState, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PMCapabilityState, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
