...
type MSMCAEvent_CPUError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_CPUErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_CPUError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_CPUError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
