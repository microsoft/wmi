...
type FileIo_V2_Create struct { 
	*FileIo_V2
	...
	func NewFileIo_V2_CreateEx1(instance *cim.WmiInstance) (newInstance *FileIo_V2_Create, err error) {tmp, err := NewFileIo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_V2_Create, err error) {tmp, err := NewFileIo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
