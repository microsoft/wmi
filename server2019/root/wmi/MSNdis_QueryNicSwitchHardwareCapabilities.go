...
type MSNdis_QueryNicSwitchHardwareCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_QueryNicSwitchHardwareCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_QueryNicSwitchHardwareCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_QueryNicSwitchHardwareCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_QueryNicSwitchHardwareCapabilities) WmiQueryNICSwitchHardwareCapabilities( /* IN */ Header MSNdis_WmiMethodHeader,
 /* OUT */ NicSwitchHardwareCapabilities MSNdis_NicSwitchCapabilities) (err error) {_, err = instance.InvokeMethod("WmiQueryNICSwitchHardwareCapabilities" , Header)
	if err != nil { return }
	return
