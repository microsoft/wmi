...
type SamGetAliasMem_Start struct { 
	*SamGetAliasMem
	...
	func NewSamGetAliasMem_StartEx1(instance *cim.WmiInstance) (newInstance *SamGetAliasMem_Start, err error) {tmp, err := NewSamGetAliasMemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamGetAliasMem_Start, err error) {tmp, err := NewSamGetAliasMemEx6(hostName, wmiNamespace, userName, password, domainName, query)
