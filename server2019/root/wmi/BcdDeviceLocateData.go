...
type BcdDeviceLocateData struct { 
	*BcdDeviceData
	...
	func NewBcdDeviceLocateDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceLocateData, err error) {tmp, err := NewBcdDeviceDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdDeviceLocateData, err error) {tmp, err := NewBcdDeviceDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
