...
type MSFC_FibrePortHBAMethods struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FibrePortHBAMethodsEx1(instance *cim.WmiInstance) (newInstance *MSFC_FibrePortHBAMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FibrePortHBAMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
// 
func (instance *MSFC_FibrePortHBAMethods) ResetStatistics() (err error) {_, err = instance.InvokeMethodWithReturn("ResetStatistics" );
	if err != nil { return }
	return
