...
type ISR_MSI struct { 
	*PerfInfo_V2
	...
	func NewISR_MSIEx1(instance *cim.WmiInstance) (newInstance *ISR_MSI, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISR_MSI, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
