...
type WMIBinaryMofResource struct { 
	*cim.WmiInstance
	...
	func NewWMIBinaryMofResourceEx1(instance *cim.WmiInstance) (newInstance *WMIBinaryMofResource, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WMIBinaryMofResource, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
