...
type MSNdis_AtmMaxAal5PacketSize struct { 
	*MSNdis
	...
	func NewMSNdis_AtmMaxAal5PacketSizeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmMaxAal5PacketSize, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmMaxAal5PacketSize, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
