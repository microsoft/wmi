...
type MSFC_HBAFCPInfo struct { 
	*cim.WmiInstance
	...
	func NewMSFC_HBAFCPInfoEx1(instance *cim.WmiInstance) (newInstance *MSFC_HBAFCPInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_HBAFCPInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFC_HBAFCPInfo) GetFcpTargetMapping( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ Entry []HBAFCPScsiEntry) (err error) {_, err = instance.InvokeMethod("GetFcpTargetMapping" , HbaPortWWN, InEntryCount)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAFCPInfo) GetFcpPersistentBinding( /* IN */ InEntryCount uint32,
 ...
 /* OUT */ TotalEntryCount uint32,
 /* OUT */ OutEntryCount uint32,
 /* OUT */ Entry []HBAFCPBindingEntry) (err error) {_, err = instance.InvokeMethod("GetFcpPersistentBinding" , InEntryCount)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAFCPInfo) GetBindingCapability( /* IN */ PortWWN []uint8,
 /* OUT */ HBAStatus uint32,
 /* OUT */ BindType uint32) (err error) {_, err = instance.InvokeMethod("GetBindingCapability" , PortWWN)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAFCPInfo) GetBindingSupport( /* IN */ PortWWN []uint8,
 /* OUT */ HBAStatus uint32,
 /* OUT */ BindType uint32) (err error) {_, err = instance.InvokeMethod("GetBindingSupport" , PortWWN)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAFCPInfo) SetBindingSupport( /* IN */ PortWWN []uint8,
 /* IN */ BindType uint32,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SetBindingSupport" , PortWWN, BindType)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAFCPInfo) GetPersistentBinding2( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ TotalEntryCount uint32,
 /* OUT */ OutEntryCount uint32,
 /* OUT */ Bindings []HBAFCPBindingEntry2) (err error) {_, err = instance.InvokeMethod("GetPersistentBinding2" , PortWWN, InEntryCount)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAFCPInfo) SetPersistentEntry( /* IN */ PortWWN []uint8,
 ...
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SetPersistentEntry" , PortWWN, Binding)
	if err != nil { return }
	return
...
func (instance *MSFC_HBAFCPInfo) RemovePersistentEntry( /* IN */ PortWWN []uint8,
 /* IN */ Binding HBAFCPBindingEntry2,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("RemovePersistentEntry" , PortWWN, Binding)
	if err != nil { return }
	return
