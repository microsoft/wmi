...
type ClusBfltHddBindingInformation struct { 
	*cim.WmiInstance
	...
	func NewClusBfltHddBindingInformationEx1(instance *cim.WmiInstance) (newInstance *ClusBfltHddBindingInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltHddBindingInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
