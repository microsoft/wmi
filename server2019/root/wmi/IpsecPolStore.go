...
type IpsecPolStore struct { 
	*EventTrace
	...
	func NewIpsecPolStoreEx1(instance *cim.WmiInstance) (newInstance *IpsecPolStore, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IpsecPolStore, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
