...
type FileIo_V2_Info struct { 
	*FileIo_V2
	...
	func NewFileIo_V2_InfoEx1(instance *cim.WmiInstance) (newInstance *FileIo_V2_Info, err error) {tmp, err := NewFileIo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_V2_Info, err error) {tmp, err := NewFileIo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
