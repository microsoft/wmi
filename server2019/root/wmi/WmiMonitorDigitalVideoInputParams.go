...
type WmiMonitorDigitalVideoInputParams struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorDigitalVideoInputParamsEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorDigitalVideoInputParams, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorDigitalVideoInputParams, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
