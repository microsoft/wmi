...
type BDat struct { 
	*cim.WmiInstance
	...
	func NewBDatEx1(instance *cim.WmiInstance) (newInstance *BDat, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BDat, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
