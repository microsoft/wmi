...
type Header_LastDroppedTimes_TypeGroup struct { 
	*EventTraceEvent
	...
	func NewHeader_LastDroppedTimes_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_LastDroppedTimes_TypeGroup, err error) {tmp, err := NewEventTraceEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Header_LastDroppedTimes_TypeGroup, err error) {tmp, err := NewEventTraceEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
