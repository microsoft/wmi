...
type ProcessorBiosCStates struct { 
	*MSProcessorClass
	...
	func NewProcessorBiosCStatesEx1(instance *cim.WmiInstance) (newInstance *ProcessorBiosCStates, err error) {tmp, err := NewMSProcessorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorBiosCStates, err error) {tmp, err := NewMSProcessorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
