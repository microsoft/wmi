...
type MSNdis_InterruptModerationParameters struct { 
	*MSNdis
	...
	func NewMSNdis_InterruptModerationParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_InterruptModerationParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_InterruptModerationParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
