...
type MSSmBios_SysidUUIDList struct { 
	*MS_SmBios
	...
	func NewMSSmBios_SysidUUIDListEx1(instance *cim.WmiInstance) (newInstance *MSSmBios_SysidUUIDList, err error) {tmp, err := NewMS_SmBiosEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSmBios_SysidUUIDList, err error) {tmp, err := NewMS_SmBiosEx6(hostName, wmiNamespace, userName, password, domainName, query)
