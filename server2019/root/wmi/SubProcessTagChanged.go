...
type SubProcessTagChanged struct { 
	*Thread_V2
	...
	func NewSubProcessTagChangedEx1(instance *cim.WmiInstance) (newInstance *SubProcessTagChanged, err error) {tmp, err := NewThread_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SubProcessTagChanged, err error) {tmp, err := NewThread_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
