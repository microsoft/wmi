...
type BcdDeviceQualifiedPartitionData struct { 
	*BcdDeviceData
	...
	func NewBcdDeviceQualifiedPartitionDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceQualifiedPartitionData, err error) {tmp, err := NewBcdDeviceDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdDeviceQualifiedPartitionData, err error) {tmp, err := NewBcdDeviceDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
