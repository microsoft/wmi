...
type KernelPerfStateDomainChange struct { 
	*WMIEvent
	...
	func NewKernelPerfStateDomainChangeEx1(instance *cim.WmiInstance) (newInstance *KernelPerfStateDomainChange, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelPerfStateDomainChange, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
