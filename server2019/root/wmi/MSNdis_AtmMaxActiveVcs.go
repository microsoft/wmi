...
type MSNdis_AtmMaxActiveVcs struct { 
	*MSNdis
	...
	func NewMSNdis_AtmMaxActiveVcsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmMaxActiveVcs, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmMaxActiveVcs, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
