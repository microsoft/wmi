...
type MSiSCSI_DiscoveryConfig struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_DiscoveryConfigEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_DiscoveryConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_DiscoveryConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
