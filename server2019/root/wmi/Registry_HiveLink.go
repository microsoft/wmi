...
type Registry_HiveLink struct { 
	*Registry
	...
	func NewRegistry_HiveLinkEx1(instance *cim.WmiInstance) (newInstance *Registry_HiveLink, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_HiveLink, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
