...
type MSNdis_PMCapabilities struct { 
	*MSNdis
	...
	func NewMSNdis_PMCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSNdis_PMCapabilities, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_PMCapabilities, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
