...
type AcpiPss struct { 
	*cim.WmiInstance
	...
	func NewAcpiPssEx1(instance *cim.WmiInstance) (newInstance *AcpiPss, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AcpiPss, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
