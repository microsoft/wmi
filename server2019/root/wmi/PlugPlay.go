...
type PlugPlay struct { 
	*EventTrace
	...
	func NewPlugPlayEx1(instance *cim.WmiInstance) (newInstance *PlugPlay, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PlugPlay, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
