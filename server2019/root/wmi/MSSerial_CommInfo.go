...
type MSSerial_CommInfo struct { 
	*MSSerial
	...
	func NewMSSerial_CommInfoEx1(instance *cim.WmiInstance) (newInstance *MSSerial_CommInfo, err error) {tmp, err := NewMSSerialEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSSerial_CommInfo, err error) {tmp, err := NewMSSerialEx6(hostName, wmiNamespace, userName, password, domainName, query)
