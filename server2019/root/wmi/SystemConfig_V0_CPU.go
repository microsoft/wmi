...
// SystemConfig_V0_CPU struct
type SystemConfig_V0_CPU struct { 
	*SystemConfig_V0
	...
	func NewSystemConfig_V0_CPUEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_CPU, err error) {tmp, err := NewSystemConfig_V0Ex1(instance)
		
	if err != nil { return }
	newInstance = &SystemConfig_V0_CPU {
	SystemConfig_V0: tmp,
	}
	return
	}
	...
	func NewSystemConfig_V0_CPUEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V0_CPU, err error) {tmp, err := NewSystemConfig_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SystemConfig_V0_CPU) SetPropertyAllocationGranularity(value uint32) (err error) { 
...
func (instance *SystemConfig_V0_CPU) GetPropertyAllocationGranularity()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_CPU) SetPropertyComputerName(value []byte) (err error) { 
    return instance.SetProperty("ComputerName", (value))
}

// GetComputerName gets the value of ComputerName for the instance
func (instance *SystemConfig_V0_CPU) GetPropertyComputerName()(value []byte, err error) { 
...
func (instance *SystemConfig_V0_CPU) SetPropertyDomainName(value []byte) (err error) { 
    return instance.SetProperty("DomainName", (value))
}

// GetDomainName gets the value of DomainName for the instance
func (instance *SystemConfig_V0_CPU) GetPropertyDomainName()(value []byte, err error) { 
...
func (instance *SystemConfig_V0_CPU) SetPropertyHyperThreadingFlag(value uint32) (err error) { 
...
func (instance *SystemConfig_V0_CPU) GetPropertyHyperThreadingFlag()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_CPU) SetPropertyMemSize(value uint32) (err error) { 
    return instance.SetProperty("MemSize", (value))
}

// GetMemSize gets the value of MemSize for the instance
func (instance *SystemConfig_V0_CPU) GetPropertyMemSize()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_CPU) SetPropertyMHz(value uint32) (err error) { 
    return instance.SetProperty("MHz", (value))
}

// GetMHz gets the value of MHz for the instance
func (instance *SystemConfig_V0_CPU) GetPropertyMHz()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_CPU) SetPropertyNumberOfProcessors(value uint32) (err error) { 
...
func (instance *SystemConfig_V0_CPU) GetPropertyNumberOfProcessors()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_CPU) SetPropertyPageSize(value uint32) (err error) { 
    return instance.SetProperty("PageSize", (value))
}

// GetPageSize gets the value of PageSize for the instance
func (instance *SystemConfig_V0_CPU) GetPropertyPageSize()(value uint32, err error) { 
