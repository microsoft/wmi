...
type ClusBfltCacheStoreInformation struct { 
	*cim.WmiInstance
	...
	func NewClusBfltCacheStoreInformationEx1(instance *cim.WmiInstance) (newInstance *ClusBfltCacheStoreInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusBfltCacheStoreInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
