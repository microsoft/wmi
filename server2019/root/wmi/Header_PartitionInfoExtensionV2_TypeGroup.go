...
type Header_PartitionInfoExtensionV2_TypeGroup struct { 
	*EventTraceEvent
	...
	func NewHeader_PartitionInfoExtensionV2_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_PartitionInfoExtensionV2_TypeGroup, err error) {tmp, err := NewEventTraceEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Header_PartitionInfoExtensionV2_TypeGroup, err error) {tmp, err := NewEventTraceEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
