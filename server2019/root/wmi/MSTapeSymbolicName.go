...
type MSTapeSymbolicName struct { 
	*MSTapeDriver
	...
	func NewMSTapeSymbolicNameEx1(instance *cim.WmiInstance) (newInstance *MSTapeSymbolicName, err error) {tmp, err := NewMSTapeDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSTapeSymbolicName, err error) {tmp, err := NewMSTapeDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
