...
type MSNdis_VendorDescription struct { 
	*MSNdis
	...
	func NewMSNdis_VendorDescriptionEx1(instance *cim.WmiInstance) (newInstance *MSNdis_VendorDescription, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_VendorDescription, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
