...
type MS_SM_PortInformationMethods struct { 
	*cim.WmiInstance
	...
	func NewMS_SM_PortInformationMethodsEx1(instance *cim.WmiInstance) (newInstance *MS_SM_PortInformationMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SM_PortInformationMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MS_SM_PortInformationMethods) SM_GetPortType( /* IN */ PortIndex uint32,
 ...
 /* OUT */ PortType uint32) (err error) {_, err = instance.InvokeMethod("SM_GetPortType" , PortIndex)
	if err != nil { return }
	return
...
func (instance *MS_SM_PortInformationMethods) SM_GetAdapterPortAttributes( /* IN */ PortIndex uint32,
 ...
 /* OUT */ HBAStatus uint32,
 /* OUT */ PortAttributes MS_SMHBA_PORTATTRIBUTES) (err error) {_, err = instance.InvokeMethod("SM_GetAdapterPortAttributes" , PortIndex, PortSpecificAttributesMaxSize)
	if err != nil { return }
	return
...
func (instance *MS_SM_PortInformationMethods) SM_GetDiscoveredPortAttributes( /* IN */ PortIndex uint32,
 ...
 /* IN */ PortSpecificAttributesMaxSize uint32,
 /* OUT */ HBAStatus uint32,
 /* OUT */ PortAttributes MS_SMHBA_PORTATTRIBUTES) (err error) {_, err = instance.InvokeMethod("SM_GetDiscoveredPortAttributes" , PortIndex, DiscoveredPortIndex, PortSpecificAttributesMaxSize)
	if err != nil { return }
	return
...
func (instance *MS_SM_PortInformationMethods) SM_GetPortAttributesByWWN( /* IN */ PortWWN []uint8,
 ...
 /* IN */ PortSpecificAttributesMaxSize uint32,
 /* OUT */ HBAStatus uint32,
 /* OUT */ PortAttributes MS_SMHBA_PORTATTRIBUTES) (err error) {_, err = instance.InvokeMethod("SM_GetPortAttributesByWWN" , PortWWN, DomainPortWWN, PortSpecificAttributesMaxSize)
	if err != nil { return }
	return
...
func (instance *MS_SM_PortInformationMethods) SM_GetProtocolStatistics( /* IN */ PortIndex uint32,
 ...
 /* OUT */ HBAStatus uint32,
 /* OUT */ ProtocolStatistics MS_SMHBA_PROTOCOLSTATISTICS) (err error) {_, err = instance.InvokeMethod("SM_GetProtocolStatistics" , PortIndex, ProtocolType)
	if err != nil { return }
	return
...
func (instance *MS_SM_PortInformationMethods) SM_GetPhyStatistics( /* IN */ PortIndex uint32,
 ...
 /* OUT */ PhyCounter []int64) (err error) {_, err = instance.InvokeMethod("SM_GetPhyStatistics" , PortIndex, PhyIndex, InNumOfPhyCounters)
	if err != nil { return }
	return
...
func (instance *MS_SM_PortInformationMethods) SM_GetFCPhyAttributes( /* IN */ PortIndex uint32,
 /* IN */ PhyIndex uint32,
 /* OUT */ HBAStatus uint32,
 /* OUT */ PhyType MS_SMHBA_FC_PHY) (err error) {_, err = instance.InvokeMethod("SM_GetFCPhyAttributes" , PortIndex, PhyIndex)
	if err != nil { return }
	return
...
func (instance *MS_SM_PortInformationMethods) SM_GetSASPhyAttributes( /* IN */ PortIndex uint32,
 /* IN */ PhyIndex uint32,
 /* OUT */ HBAStatus uint32,
 /* OUT */ PhyType MS_SMHBA_SAS_PHY) (err error) {_, err = instance.InvokeMethod("SM_GetSASPhyAttributes" , PortIndex, PhyIndex)
	if err != nil { return }
	return
...
// 
func (instance *MS_SM_PortInformationMethods) SM_RefreshInformation() (err error) {_, err = instance.InvokeMethodWithReturn("SM_RefreshInformation" );
	if err != nil { return }
	return
