...
type SystemConfig_V0_LogDisk struct { 
	*SystemConfig_V0
	...
	func NewSystemConfig_V0_LogDiskEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V0_LogDisk, err error) {tmp, err := NewSystemConfig_V0Ex1(instance)
		
	if err != nil { return }
	newInstance = &SystemConfig_V0_LogDisk {
	SystemConfig_V0: tmp,
	}
	return
	}
	...
	func NewSystemConfig_V0_LogDiskEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V0_LogDisk, err error) {tmp, err := NewSystemConfig_V0Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyBytesPerSector(value uint32) (err error) { 
    return instance.SetProperty("BytesPerSector", (value))
}

// GetBytesPerSector gets the value of BytesPerSector for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyBytesPerSector()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyDiskNumber(value uint32) (err error) { 
    return instance.SetProperty("DiskNumber", (value))
}

// GetDiskNumber gets the value of DiskNumber for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyDiskNumber()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyDriveLetterString(value []byte) (err error) { 
...
func (instance *SystemConfig_V0_LogDisk) GetPropertyDriveLetterString()(value []byte, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyDriveType(value uint32) (err error) { 
    return instance.SetProperty("DriveType", (value))
}

// GetDriveType gets the value of DriveType for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyDriveType()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyFileSystem(value []byte) (err error) { 
    return instance.SetProperty("FileSystem", (value))
}

// GetFileSystem gets the value of FileSystem for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyFileSystem()(value []byte, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyNumberOfFreeClusters(value int64) (err error) { 
...
func (instance *SystemConfig_V0_LogDisk) GetPropertyNumberOfFreeClusters()(value int64, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyPad1(value uint32) (err error) { 
    return instance.SetProperty("Pad1", (value))
}

// GetPad1 gets the value of Pad1 for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyPad1()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyPad2(value uint32) (err error) { 
    return instance.SetProperty("Pad2", (value))
}

// GetPad2 gets the value of Pad2 for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyPad2()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyPartitionNumber(value uint32) (err error) { 
    return instance.SetProperty("PartitionNumber", (value))
}

// GetPartitionNumber gets the value of PartitionNumber for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyPartitionNumber()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyPartitionSize(value uint64) (err error) { 
    return instance.SetProperty("PartitionSize", (value))
}

// GetPartitionSize gets the value of PartitionSize for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyPartitionSize()(value uint64, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertySectorsPerCluster(value uint32) (err error) { 
...
func (instance *SystemConfig_V0_LogDisk) GetPropertySectorsPerCluster()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertySize(value uint32) (err error) { 
    return instance.SetProperty("Size", (value))
}

// GetSize gets the value of Size for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertySize()(value uint32, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyStartOffset(value uint64) (err error) { 
    return instance.SetProperty("StartOffset", (value))
}

// GetStartOffset gets the value of StartOffset for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyStartOffset()(value uint64, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyTotalNumberOfClusters(value int64) (err error) { 
...
func (instance *SystemConfig_V0_LogDisk) GetPropertyTotalNumberOfClusters()(value int64, err error) { 
...
func (instance *SystemConfig_V0_LogDisk) SetPropertyVolumeExt(value uint32) (err error) { 
    return instance.SetProperty("VolumeExt", (value))
}

// GetVolumeExt gets the value of VolumeExt for the instance
func (instance *SystemConfig_V0_LogDisk) GetPropertyVolumeExt()(value uint32, err error) { 
