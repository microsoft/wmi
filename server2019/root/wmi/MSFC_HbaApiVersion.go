...
type MSFC_HbaApiVersion struct { 
	*cim.WmiInstance
	...
	func NewMSFC_HbaApiVersionEx1(instance *cim.WmiInstance) (newInstance *MSFC_HbaApiVersion, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_HbaApiVersion, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
