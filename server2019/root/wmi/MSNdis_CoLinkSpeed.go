...
type MSNdis_CoLinkSpeed struct { 
	*MSNdis
	...
	func NewMSNdis_CoLinkSpeedEx1(instance *cim.WmiInstance) (newInstance *MSNdis_CoLinkSpeed, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_CoLinkSpeed, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
