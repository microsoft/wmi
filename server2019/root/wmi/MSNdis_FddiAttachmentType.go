...
type MSNdis_FddiAttachmentType struct { 
	*MSNdis
	...
	func NewMSNdis_FddiAttachmentTypeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiAttachmentType, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_FddiAttachmentType, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
