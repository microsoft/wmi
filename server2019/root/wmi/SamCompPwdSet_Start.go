...
type SamCompPwdSet_Start struct { 
	*SamCompPwdSet
	...
	func NewSamCompPwdSet_StartEx1(instance *cim.WmiInstance) (newInstance *SamCompPwdSet_Start, err error) {tmp, err := NewSamCompPwdSetEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamCompPwdSet_Start, err error) {tmp, err := NewSamCompPwdSetEx6(hostName, wmiNamespace, userName, password, domainName, query)
