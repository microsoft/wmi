...
type WdfCoreTraceGuid struct { 
	*EventTrace
	...
	func NewWdfCoreTraceGuidEx1(instance *cim.WmiInstance) (newInstance *WdfCoreTraceGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WdfCoreTraceGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
