...
type HeapContract struct { 
	*HeapTrace
	...
	func NewHeapContractEx1(instance *cim.WmiInstance) (newInstance *HeapContract, err error) {tmp, err := NewHeapTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapContract, err error) {tmp, err := NewHeapTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
