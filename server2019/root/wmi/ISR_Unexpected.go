...
type ISR_Unexpected struct { 
	*PerfInfo_V2
	...
	func NewISR_UnexpectedEx1(instance *cim.WmiInstance) (newInstance *ISR_Unexpected, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ISR_Unexpected, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
