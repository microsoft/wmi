...
type MSFC_NPIVCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFC_NPIVCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFC_NPIVCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_NPIVCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
