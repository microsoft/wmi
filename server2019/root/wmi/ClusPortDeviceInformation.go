...
func NewClusPortDeviceInformationEx1(instance *cim.WmiInstance) (newInstance *ClusPortDeviceInformation, err error) {
...
func NewClusPortDeviceInformationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *ClusPortDeviceInformation, err error) {
