...
type Image_V1_Load struct { 
	*Image_V1
	...
	func NewImage_V1_LoadEx1(instance *cim.WmiInstance) (newInstance *Image_V1_Load, err error) {tmp, err := NewImage_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Image_V1_Load, err error) {tmp, err := NewImage_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
