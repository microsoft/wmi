...
type MSNdis_SetLinkParameters struct { 
	*MSNdis
	...
	func NewMSNdis_SetLinkParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_SetLinkParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_SetLinkParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_SetLinkParameters) WmiSetLinkParameters( /* IN */ MethodHeader MSNdis_WmiMethodHeader,
 ...
 /* OUT */ OutputInfo MSNdis_WmiOutputInfo) (err error) {_, err = instance.InvokeMethod("WmiSetLinkParameters" , MethodHeader, LinkParameters)
	if err != nil { return }
	return
