...
type KernelThermalConstraintChange struct { 
	*WMIEvent
	...
	func NewKernelThermalConstraintChangeEx1(instance *cim.WmiInstance) (newInstance *KernelThermalConstraintChange, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KernelThermalConstraintChange, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
