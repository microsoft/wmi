...
type MSMCAEvent_MemoryError struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_MemoryErrorEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_MemoryError, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_MemoryError, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
