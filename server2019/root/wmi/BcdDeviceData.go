...
type BcdDeviceData struct { 
	*cim.WmiInstance
	...
	func NewBcdDeviceDataEx1(instance *cim.WmiInstance) (newInstance *BcdDeviceData, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdDeviceData, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
