...
type MSFC_HBAPortStatistics struct { 
	*cim.WmiInstance
	...
	func NewMSFC_HBAPortStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSFC_HBAPortStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_HBAPortStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
