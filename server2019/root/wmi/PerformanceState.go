...
type PerformanceState struct { 
	*cim.WmiInstance
	...
	func NewPerformanceStateEx1(instance *cim.WmiInstance) (newInstance *PerformanceState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PerformanceState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
