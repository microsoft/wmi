...
type MSNdis_80211_WLanBssId struct { 
	*MSNdis
	...
	func NewMSNdis_80211_WLanBssIdEx1(instance *cim.WmiInstance) (newInstance *MSNdis_80211_WLanBssId, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_80211_WLanBssId, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
