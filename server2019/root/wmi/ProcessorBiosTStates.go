...
type ProcessorBiosTStates struct { 
	*MSProcessorClass
	...
	func NewProcessorBiosTStatesEx1(instance *cim.WmiInstance) (newInstance *ProcessorBiosTStates, err error) {tmp, err := NewMSProcessorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorBiosTStates, err error) {tmp, err := NewMSProcessorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
