...
type MSiSCSI_InitiatorSessionInfo struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_InitiatorSessionInfoEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_InitiatorSessionInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_InitiatorSessionInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
