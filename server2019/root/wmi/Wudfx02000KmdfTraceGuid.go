...
type Wudfx02000KmdfTraceGuid struct { 
	*EventTrace
	...
	func NewWudfx02000KmdfTraceGuidEx1(instance *cim.WmiInstance) (newInstance *Wudfx02000KmdfTraceGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Wudfx02000KmdfTraceGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
