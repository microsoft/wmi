...
type NtlmServerAccept_Start struct { 
	*NtlmServerAccept
	...
	func NewNtlmServerAccept_StartEx1(instance *cim.WmiInstance) (newInstance *NtlmServerAccept_Start, err error) {tmp, err := NewNtlmServerAcceptEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NtlmServerAccept_Start, err error) {tmp, err := NewNtlmServerAcceptEx6(hostName, wmiNamespace, userName, password, domainName, query)
