...
type MS_SM_TargetInformationMethods struct { 
	*cim.WmiInstance
	...
	func NewMS_SM_TargetInformationMethodsEx1(instance *cim.WmiInstance) (newInstance *MS_SM_TargetInformationMethods, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SM_TargetInformationMethods, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MS_SM_TargetInformationMethods) SM_GetTargetMapping( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ Entry []MS_SMHBA_SCSIENTRY) (err error) {_, err = instance.InvokeMethod("SM_GetTargetMapping" , HbaPortWWN, DomainPortWWN, InEntryCount)
	if err != nil { return }
	return
...
func (instance *MS_SM_TargetInformationMethods) SM_GetBindingCapability( /* IN */ HbaPortWWN []uint8,
 /* IN */ DomainPortWWN []uint8,
 /* OUT */ HBAStatus uint32,
 /* OUT */ Flags uint32) (err error) {_, err = instance.InvokeMethod("SM_GetBindingCapability" , HbaPortWWN, DomainPortWWN)
	if err != nil { return }
	return
...
func (instance *MS_SM_TargetInformationMethods) SM_GetBindingSupport( /* IN */ HbaPortWWN []uint8,
 /* IN */ DomainPortWWN []uint8,
 /* OUT */ HBAStatus uint32,
 /* OUT */ Flags uint32) (err error) {_, err = instance.InvokeMethod("SM_GetBindingSupport" , HbaPortWWN, DomainPortWWN)
	if err != nil { return }
	return
...
func (instance *MS_SM_TargetInformationMethods) SM_SetBindingSupport( /* IN */ HbaPortWWN []uint8,
 /* IN */ DomainPortWWN []uint8,
 /* IN */ Flags uint32,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_SetBindingSupport" , HbaPortWWN, DomainPortWWN, Flags)
	if err != nil { return }
	return
...
func (instance *MS_SM_TargetInformationMethods) SM_GetPersistentBinding( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ TotalEntryCount uint32,
 /* OUT */ OutEntryCount uint32,
 /* OUT */ Entry []MS_SMHBA_BINDINGENTRY) (err error) {_, err = instance.InvokeMethod("SM_GetPersistentBinding" , HbaPortWWN, DomainPortWWN, InEntryCount)
	if err != nil { return }
	return
...
func (instance *MS_SM_TargetInformationMethods) SM_SetPersistentBinding( /* IN */ HbaPortWWN []uint8,
 ...
 /* OUT */ EntryStatus []uint32) (err error) {_, err = instance.InvokeMethod("SM_SetPersistentBinding" , HbaPortWWN, DomainPortWWN, InEntryCount, Entry)
	if err != nil { return }
	return
...
func (instance *MS_SM_TargetInformationMethods) SM_RemovePersistentBinding( /* IN */ HbaPortWWN []uint8,
 ...
 /* IN */ Entry []MS_SMHBA_BINDINGENTRY,
 /* OUT */ HBAStatus uint32) (err error) {_, err = instance.InvokeMethod("SM_RemovePersistentBinding" , HbaPortWWN, DomainPortWWN, EntryCount, Entry)
	if err != nil { return }
	return
...
func (instance *MS_SM_TargetInformationMethods) SM_GetLUNStatistics( /* IN */ Lunit HBAScsiID,
 /* OUT */ HBAStatus uint32,
 /* OUT */ ProtocolStatistics MS_SMHBA_PROTOCOLSTATISTICS) (err error) {_, err = instance.InvokeMethod("SM_GetLUNStatistics" , Lunit)
	if err != nil { return }
	return
