...
type MSiSCSI_InitiatorInstanceStatistics struct { 
	*Win32_PerfRawData
	...
	func NewMSiSCSI_InitiatorInstanceStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_InitiatorInstanceStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_InitiatorInstanceStatistics, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
