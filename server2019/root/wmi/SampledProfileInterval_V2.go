...
type SampledProfileInterval_V2 struct { 
	*PerfInfo_V2
	...
	func NewSampledProfileInterval_V2Ex1(instance *cim.WmiInstance) (newInstance *SampledProfileInterval_V2, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SampledProfileInterval_V2, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
