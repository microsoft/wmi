...
type Image_Load struct { 
	*Image
	...
	func NewImage_LoadEx1(instance *cim.WmiInstance) (newInstance *Image_Load, err error) {tmp, err := NewImageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Image_Load, err error) {tmp, err := NewImageEx6(hostName, wmiNamespace, userName, password, domainName, query)
