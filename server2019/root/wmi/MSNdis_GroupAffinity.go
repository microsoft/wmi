...
func NewMSNdis_GroupAffinityEx1(instance *cim.WmiInstance) (newInstance *MSNdis_GroupAffinity, err error) {
...
func NewMSNdis_GroupAffinityEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSNdis_GroupAffinity, err error) {
