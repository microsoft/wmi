...
type LoaderPathSearchResults struct { 
	*Image
	...
	func NewLoaderPathSearchResultsEx1(instance *cim.WmiInstance) (newInstance *LoaderPathSearchResults, err error) {tmp, err := NewImageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LoaderPathSearchResults, err error) {tmp, err := NewImageEx6(hostName, wmiNamespace, userName, password, domainName, query)
