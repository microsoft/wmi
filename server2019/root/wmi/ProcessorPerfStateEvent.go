...
type ProcessorPerfStateEvent struct { 
	*WMIEvent
	...
	func NewProcessorPerfStateEventEx1(instance *cim.WmiInstance) (newInstance *ProcessorPerfStateEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorPerfStateEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
