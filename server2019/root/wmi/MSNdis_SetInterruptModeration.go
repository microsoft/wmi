...
type MSNdis_SetInterruptModeration struct { 
	*MSNdis
	...
	func NewMSNdis_SetInterruptModerationEx1(instance *cim.WmiInstance) (newInstance *MSNdis_SetInterruptModeration, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_SetInterruptModeration, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSNdis_SetInterruptModeration) WmiSetInterruptModeration( /* IN */ MethodHeader MSNdis_WmiMethodHeader,
 ...
 /* OUT */ OutputInfo MSNdis_WmiOutputInfo) (err error) {_, err = instance.InvokeMethod("WmiSetInterruptModeration" , MethodHeader, InterruptModeration)
	if err != nil { return }
	return
