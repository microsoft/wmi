...
type NtlmServerAccept_End struct { 
	*NtlmServerAccept
	...
	func NewNtlmServerAccept_EndEx1(instance *cim.WmiInstance) (newInstance *NtlmServerAccept_End, err error) {tmp, err := NewNtlmServerAcceptEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NtlmServerAccept_End, err error) {tmp, err := NewNtlmServerAcceptEx6(hostName, wmiNamespace, userName, password, domainName, query)
