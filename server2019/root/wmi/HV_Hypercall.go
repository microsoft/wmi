...
type HV_Hypercall struct { 
	*PerfInfo_V2
	...
	func NewHV_HypercallEx1(instance *cim.WmiInstance) (newInstance *HV_Hypercall, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HV_Hypercall, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
