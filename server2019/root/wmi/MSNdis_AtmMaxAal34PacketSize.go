...
type MSNdis_AtmMaxAal34PacketSize struct { 
	*MSNdis
	...
	func NewMSNdis_AtmMaxAal34PacketSizeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmMaxAal34PacketSize, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmMaxAal34PacketSize, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
