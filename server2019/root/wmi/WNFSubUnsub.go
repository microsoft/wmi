...
type WNFSubUnsub struct { 
	*WNFTrace
	...
	func NewWNFSubUnsubEx1(instance *cim.WmiInstance) (newInstance *WNFSubUnsub, err error) {tmp, err := NewWNFTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WNFSubUnsub, err error) {tmp, err := NewWNFTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
