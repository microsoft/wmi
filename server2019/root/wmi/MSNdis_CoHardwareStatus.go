...
type MSNdis_CoHardwareStatus struct { 
	*MSNdis
	...
	func NewMSNdis_CoHardwareStatusEx1(instance *cim.WmiInstance) (newInstance *MSNdis_CoHardwareStatus, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_CoHardwareStatus, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
