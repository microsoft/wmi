...
type MSKeyboard_PortInformation struct { 
	*MSKeyboard
	...
	func NewMSKeyboard_PortInformationEx1(instance *cim.WmiInstance) (newInstance *MSKeyboard_PortInformation, err error) {tmp, err := NewMSKeyboardEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSKeyboard_PortInformation, err error) {tmp, err := NewMSKeyboardEx6(hostName, wmiNamespace, userName, password, domainName, query)
