...
type SystemConfig_V4_PnP struct { 
	*SystemConfig_V4
	...
	func NewSystemConfig_V4_PnPEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V4_PnP, err error) {tmp, err := NewSystemConfig_V4Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V4_PnP, err error) {tmp, err := NewSystemConfig_V4Ex6(hostName, wmiNamespace, userName, password, domainName, query)
