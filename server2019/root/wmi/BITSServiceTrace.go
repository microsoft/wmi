...
type BITSServiceTrace struct { 
	*EventTrace
	...
	func NewBITSServiceTraceEx1(instance *cim.WmiInstance) (newInstance *BITSServiceTrace, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BITSServiceTrace, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
