...
type MSTapeDriveParam struct { 
	*MSTapeDriver
	...
	func NewMSTapeDriveParamEx1(instance *cim.WmiInstance) (newInstance *MSTapeDriveParam, err error) {tmp, err := NewMSTapeDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSTapeDriveParam, err error) {tmp, err := NewMSTapeDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
