...
type MSNdis_StatusDot11ScanConfirm struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusDot11ScanConfirmEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusDot11ScanConfirm, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusDot11ScanConfirm, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
