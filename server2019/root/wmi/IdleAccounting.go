...
type IdleAccounting struct { 
	*WMIEvent
	...
	func NewIdleAccountingEx1(instance *cim.WmiInstance) (newInstance *IdleAccounting, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IdleAccounting, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
