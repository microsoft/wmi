...
type Mpssvc struct { 
	*EventTrace
	...
	func NewMpssvcEx1(instance *cim.WmiInstance) (newInstance *Mpssvc, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Mpssvc, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
