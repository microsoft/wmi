...
type MSNdis_EthernetMaximumMulticastListSize struct { 
	*MSNdis
	...
	func NewMSNdis_EthernetMaximumMulticastListSizeEx1(instance *cim.WmiInstance) (newInstance *MSNdis_EthernetMaximumMulticastListSize, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_EthernetMaximumMulticastListSize, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
