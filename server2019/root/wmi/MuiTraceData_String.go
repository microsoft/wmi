...
type MuiTraceData_String struct { 
	*MuiTraceData
	...
	func NewMuiTraceData_StringEx1(instance *cim.WmiInstance) (newInstance *MuiTraceData_String, err error) {tmp, err := NewMuiTraceDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MuiTraceData_String, err error) {tmp, err := NewMuiTraceDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
