...
type MS_SMHBA_SAS_PHY struct { 
	*cim.WmiInstance
	...
	func NewMS_SMHBA_SAS_PHYEx1(instance *cim.WmiInstance) (newInstance *MS_SMHBA_SAS_PHY, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MS_SMHBA_SAS_PHY, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
