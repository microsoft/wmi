...
type MSiSCSIInitiator_DeviceOnSession struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSIInitiator_DeviceOnSessionEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_DeviceOnSession, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSIInitiator_DeviceOnSession, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
