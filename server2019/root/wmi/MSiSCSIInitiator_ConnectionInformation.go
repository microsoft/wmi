...
func NewMSiSCSIInitiator_ConnectionInformationEx1(instance *cim.WmiInstance) (newInstance *MSiSCSIInitiator_ConnectionInformation, err error) {
...
func NewMSiSCSIInitiator_ConnectionInformationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSiSCSIInitiator_ConnectionInformation, err error) {
