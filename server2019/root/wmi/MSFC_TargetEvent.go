...
type MSFC_TargetEvent struct { 
	*WMIEvent
	...
	func NewMSFC_TargetEventEx1(instance *cim.WmiInstance) (newInstance *MSFC_TargetEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_TargetEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
