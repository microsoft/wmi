...
type MSNdis_StatusOperationalStatus struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusOperationalStatusEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusOperationalStatus, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusOperationalStatus, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
