...
type MSNdis_WmiTcpConnectionOffload struct { 
	*MSNdis
	...
	func NewMSNdis_WmiTcpConnectionOffloadEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiTcpConnectionOffload, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiTcpConnectionOffload, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
