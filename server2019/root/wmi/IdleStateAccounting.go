...
type IdleStateAccounting struct { 
	*cim.WmiInstance
	...
	func NewIdleStateAccountingEx1(instance *cim.WmiInstance) (newInstance *IdleStateAccounting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *IdleStateAccounting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
