...
type FileIo_SimpleOp struct { 
	*FileIo
	...
	func NewFileIo_SimpleOpEx1(instance *cim.WmiInstance) (newInstance *FileIo_SimpleOp, err error) {tmp, err := NewFileIoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *FileIo_SimpleOp, err error) {tmp, err := NewFileIoEx6(hostName, wmiNamespace, userName, password, domainName, query)
