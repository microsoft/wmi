...
type ProcessorCStateEvent struct { 
	*WMIEvent
	...
	func NewProcessorCStateEventEx1(instance *cim.WmiInstance) (newInstance *ProcessorCStateEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorCStateEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
