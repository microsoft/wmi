...
type WmiMonitorBrightnessEvent struct { 
	*WMIEvent
	...
	func NewWmiMonitorBrightnessEventEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorBrightnessEvent, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorBrightnessEvent, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
