...
type ALPC_Receive_Message struct { 
	*ALPC
	...
	func NewALPC_Receive_MessageEx1(instance *cim.WmiInstance) (newInstance *ALPC_Receive_Message, err error) {tmp, err := NewALPCEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ALPC_Receive_Message, err error) {tmp, err := NewALPCEx6(hostName, wmiNamespace, userName, password, domainName, query)
