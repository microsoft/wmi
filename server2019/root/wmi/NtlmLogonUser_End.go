...
type NtlmLogonUser_End struct { 
	*NtlmLogonUser
	...
	func NewNtlmLogonUser_EndEx1(instance *cim.WmiInstance) (newInstance *NtlmLogonUser_End, err error) {tmp, err := NewNtlmLogonUserEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NtlmLogonUser_End, err error) {tmp, err := NewNtlmLogonUserEx6(hostName, wmiNamespace, userName, password, domainName, query)
