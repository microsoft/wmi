...
type Registry_TxR struct { 
	*Registry
	...
	func NewRegistry_TxREx1(instance *cim.WmiInstance) (newInstance *Registry_TxR, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_TxR, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
