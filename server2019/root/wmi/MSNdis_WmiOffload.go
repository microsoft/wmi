...
type MSNdis_WmiOffload struct { 
	*MSNdis
	...
	func NewMSNdis_WmiOffloadEx1(instance *cim.WmiInstance) (newInstance *MSNdis_WmiOffload, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_WmiOffload, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
