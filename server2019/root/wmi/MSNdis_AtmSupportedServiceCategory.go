...
type MSNdis_AtmSupportedServiceCategory struct { 
	*MSNdis
	...
	func NewMSNdis_AtmSupportedServiceCategoryEx1(instance *cim.WmiInstance) (newInstance *MSNdis_AtmSupportedServiceCategory, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_AtmSupportedServiceCategory, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
