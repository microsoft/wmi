...
type DriverCompletionRoutine struct { 
	*DiskIo_V2
	...
	func NewDriverCompletionRoutineEx1(instance *cim.WmiInstance) (newInstance *DriverCompletionRoutine, err error) {tmp, err := NewDiskIo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DriverCompletionRoutine, err error) {tmp, err := NewDiskIo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
