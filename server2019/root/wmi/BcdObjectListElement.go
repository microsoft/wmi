...
type BcdObjectListElement struct { 
	*BcdElement
	...
	func NewBcdObjectListElementEx1(instance *cim.WmiInstance) (newInstance *BcdObjectListElement, err error) {tmp, err := NewBcdElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BcdObjectListElement, err error) {tmp, err := NewBcdElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
