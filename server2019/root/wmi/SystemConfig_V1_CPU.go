...
// SystemConfig_V1_CPU struct
type SystemConfig_V1_CPU struct { 
	*SystemConfig_V1
	...
	func NewSystemConfig_V1_CPUEx1(instance *cim.WmiInstance) (newInstance *SystemConfig_V1_CPU, err error) {tmp, err := NewSystemConfig_V1Ex1(instance)
		
	if err != nil { return }
	newInstance = &SystemConfig_V1_CPU {
	SystemConfig_V1: tmp,
	}
	return
	}
	...
	func NewSystemConfig_V1_CPUEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SystemConfig_V1_CPU, err error) {tmp, err := NewSystemConfig_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SystemConfig_V1_CPU) SetPropertyAllocationGranularity(value uint32) (err error) { 
...
func (instance *SystemConfig_V1_CPU) GetPropertyAllocationGranularity()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_CPU) SetPropertyComputerName(value []byte) (err error) { 
    return instance.SetProperty("ComputerName", (value))
}

// GetComputerName gets the value of ComputerName for the instance
func (instance *SystemConfig_V1_CPU) GetPropertyComputerName()(value []byte, err error) { 
...
func (instance *SystemConfig_V1_CPU) SetPropertyDomainName(value []byte) (err error) { 
    return instance.SetProperty("DomainName", (value))
}

// GetDomainName gets the value of DomainName for the instance
func (instance *SystemConfig_V1_CPU) GetPropertyDomainName()(value []byte, err error) { 
...
func (instance *SystemConfig_V1_CPU) SetPropertyHyperThreadingFlag(value uint32) (err error) { 
...
func (instance *SystemConfig_V1_CPU) GetPropertyHyperThreadingFlag()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_CPU) SetPropertyMemSize(value uint32) (err error) { 
    return instance.SetProperty("MemSize", (value))
}

// GetMemSize gets the value of MemSize for the instance
func (instance *SystemConfig_V1_CPU) GetPropertyMemSize()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_CPU) SetPropertyMHz(value uint32) (err error) { 
    return instance.SetProperty("MHz", (value))
}

// GetMHz gets the value of MHz for the instance
func (instance *SystemConfig_V1_CPU) GetPropertyMHz()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_CPU) SetPropertyNumberOfProcessors(value uint32) (err error) { 
...
func (instance *SystemConfig_V1_CPU) GetPropertyNumberOfProcessors()(value uint32, err error) { 
...
func (instance *SystemConfig_V1_CPU) SetPropertyPageSize(value uint32) (err error) { 
    return instance.SetProperty("PageSize", (value))
}

// GetPageSize gets the value of PageSize for the instance
func (instance *SystemConfig_V1_CPU) GetPropertyPageSize()(value uint32, err error) { 
