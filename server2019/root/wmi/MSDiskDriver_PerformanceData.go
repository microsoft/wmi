...
type MSDiskDriver_PerformanceData struct { 
	*MSDiskDriver
	...
	func NewMSDiskDriver_PerformanceDataEx1(instance *cim.WmiInstance) (newInstance *MSDiskDriver_PerformanceData, err error) {tmp, err := NewMSDiskDriverEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSDiskDriver_PerformanceData, err error) {tmp, err := NewMSDiskDriverEx6(hostName, wmiNamespace, userName, password, domainName, query)
