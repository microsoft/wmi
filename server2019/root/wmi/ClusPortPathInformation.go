...
type ClusPortPathInformation struct { 
	*cim.WmiInstance
	...
	func NewClusPortPathInformationEx1(instance *cim.WmiInstance) (newInstance *ClusPortPathInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClusPortPathInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
