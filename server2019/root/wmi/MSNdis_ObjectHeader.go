...
type MSNdis_ObjectHeader struct { 
	*MSNdis
	...
	func NewMSNdis_ObjectHeaderEx1(instance *cim.WmiInstance) (newInstance *MSNdis_ObjectHeader, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_ObjectHeader, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
