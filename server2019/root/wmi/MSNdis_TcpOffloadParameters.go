...
type MSNdis_TcpOffloadParameters struct { 
	*MSNdis
	...
	func NewMSNdis_TcpOffloadParametersEx1(instance *cim.WmiInstance) (newInstance *MSNdis_TcpOffloadParameters, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_TcpOffloadParameters, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
