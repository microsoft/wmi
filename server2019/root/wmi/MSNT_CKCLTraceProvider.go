...
type MSNT_CKCLTraceProvider struct { 
	*EventTrace
	...
	func NewMSNT_CKCLTraceProviderEx1(instance *cim.WmiInstance) (newInstance *MSNT_CKCLTraceProvider, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNT_CKCLTraceProvider, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
