...
func NewSamQueryInfoDom_StartEx1(instance *cim.WmiInstance) (newInstance *SamQueryInfoDom_Start, err error) {
...
func NewSamQueryInfoDom_StartEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *SamQueryInfoDom_Start, err error) {
