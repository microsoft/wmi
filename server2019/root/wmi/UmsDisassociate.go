...
type UmsDisassociate struct { 
	*UmsEvent
	...
	func NewUmsDisassociateEx1(instance *cim.WmiInstance) (newInstance *UmsDisassociate, err error) {tmp, err := NewUmsEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *UmsDisassociate, err error) {tmp, err := NewUmsEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
