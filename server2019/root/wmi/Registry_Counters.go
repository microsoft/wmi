...
type Registry_Counters struct { 
	*Registry
	...
	func NewRegistry_CountersEx1(instance *cim.WmiInstance) (newInstance *Registry_Counters, err error) {tmp, err := NewRegistryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Registry_Counters, err error) {tmp, err := NewRegistryEx6(hostName, wmiNamespace, userName, password, domainName, query)
