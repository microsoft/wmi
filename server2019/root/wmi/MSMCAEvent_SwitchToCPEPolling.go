...
type MSMCAEvent_SwitchToCPEPolling struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_SwitchToCPEPollingEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_SwitchToCPEPolling, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_SwitchToCPEPolling, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
