...
type MSNdis_FddiFrameErrors struct { 
	*MSNdis
	...
	func NewMSNdis_FddiFrameErrorsEx1(instance *cim.WmiInstance) (newInstance *MSNdis_FddiFrameErrors, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_FddiFrameErrors, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
