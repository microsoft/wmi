...
type MSNdis_MediaConnectStatus struct { 
	*MSNdis
	...
	func NewMSNdis_MediaConnectStatusEx1(instance *cim.WmiInstance) (newInstance *MSNdis_MediaConnectStatus, err error) {tmp, err := NewMSNdisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_MediaConnectStatus, err error) {tmp, err := NewMSNdisEx6(hostName, wmiNamespace, userName, password, domainName, query)
