...
type NtlmServerAccept_Info struct { 
	*NtlmServerAccept
	...
	func NewNtlmServerAccept_InfoEx1(instance *cim.WmiInstance) (newInstance *NtlmServerAccept_Info, err error) {tmp, err := NewNtlmServerAcceptEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NtlmServerAccept_Info, err error) {tmp, err := NewNtlmServerAcceptEx6(hostName, wmiNamespace, userName, password, domainName, query)
