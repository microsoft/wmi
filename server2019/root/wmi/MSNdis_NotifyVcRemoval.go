...
type MSNdis_NotifyVcRemoval struct { 
	*WMIEvent
	...
	func NewMSNdis_NotifyVcRemovalEx1(instance *cim.WmiInstance) (newInstance *MSNdis_NotifyVcRemoval, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_NotifyVcRemoval, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
