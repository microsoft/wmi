...
type WmiMonitorConnectionParams struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorConnectionParamsEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorConnectionParams, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorConnectionParams, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
