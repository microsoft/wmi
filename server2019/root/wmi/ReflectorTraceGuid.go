...
type ReflectorTraceGuid struct { 
	*EventTrace
	...
	func NewReflectorTraceGuidEx1(instance *cim.WmiInstance) (newInstance *ReflectorTraceGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ReflectorTraceGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
