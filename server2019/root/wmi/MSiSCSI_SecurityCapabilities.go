...
type MSiSCSI_SecurityCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSiSCSI_SecurityCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSiSCSI_SecurityCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSiSCSI_SecurityCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
