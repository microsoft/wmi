...
type MSFC_FibrePortNPIVMethodsEx struct { 
	*cim.WmiInstance
	...
	func NewMSFC_FibrePortNPIVMethodsExEx1(instance *cim.WmiInstance) (newInstance *MSFC_FibrePortNPIVMethodsEx, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFC_FibrePortNPIVMethodsEx, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFC_FibrePortNPIVMethodsEx) SetChapForPhysicalPort( /* OUT */ Status FibrePortNPIVMethodsEx_Status,
 /* OPTIONAL IN */ CHAP MSFC_DH_Chap_Parameters) (err error) {_, err = instance.InvokeMethod("SetChapForPhysicalPort" , CHAP)
	if err != nil { return }
	return
...
// <param name="Status" type="FibrePortNPIVMethodsEx_Status "></param>
func (instance *MSFC_FibrePortNPIVMethodsEx) RemoveChapForPhysicalPort( /* OUT */ Status FibrePortNPIVMethodsEx_Status) (err error) {_, err = instance.InvokeMethod("RemoveChapForPhysicalPort" )
	if err != nil { return }
	return
...
func (instance *MSFC_FibrePortNPIVMethodsEx) CreateVirtualPortEx( /* OUT */ Status FibrePortNPIVMethodsEx_Status,
 ...
 /* OPTIONAL IN */ VirtualName []uint16) (err error) {_, err = instance.InvokeMethod("CreateVirtualPortEx" , WWPN, WWNN, Tag, VirtualName)
	if err != nil { return }
	return
...
func (instance *MSFC_FibrePortNPIVMethodsEx) CreateVirtualPortExUsingDHCHAP( /* OUT */ Status FibrePortNPIVMethodsEx_Status,
 ...
 /* OPTIONAL IN */ CHAP MSFC_DH_Chap_Parameters) (err error) {_, err = instance.InvokeMethod("CreateVirtualPortExUsingDHCHAP" , WWPN, WWNN, Tag, VirtualName, CHAP)
	if err != nil { return }
	return
...
func (instance *MSFC_FibrePortNPIVMethodsEx) RemoveVirtualPortEx( /* OUT */ Status FibrePortNPIVMethodsEx_Status,
 /* OPTIONAL IN */ WWPN []uint8) (err error) {_, err = instance.InvokeMethod("RemoveVirtualPortEx" , WWPN)
	if err != nil { return }
	return
...
func (instance *MSFC_FibrePortNPIVMethodsEx) RescanVirtualPort( /* OUT */ Status FibrePortNPIVMethodsEx_Status,
 /* OPTIONAL IN */ WWPN []uint8) (err error) {_, err = instance.InvokeMethod("RescanVirtualPort" , WWPN)
	if err != nil { return }
	return
