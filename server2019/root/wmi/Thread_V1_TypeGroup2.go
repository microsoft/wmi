...
type Thread_V1_TypeGroup2 struct { 
	*Thread_V1
	...
	func NewThread_V1_TypeGroup2Ex1(instance *cim.WmiInstance) (newInstance *Thread_V1_TypeGroup2, err error) {tmp, err := NewThread_V1Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Thread_V1_TypeGroup2, err error) {tmp, err := NewThread_V1Ex6(hostName, wmiNamespace, userName, password, domainName, query)
