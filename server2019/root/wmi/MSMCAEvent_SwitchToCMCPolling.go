...
type MSMCAEvent_SwitchToCMCPolling struct { 
	*WMIEvent
	...
	func NewMSMCAEvent_SwitchToCMCPollingEx1(instance *cim.WmiInstance) (newInstance *MSMCAEvent_SwitchToCMCPolling, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSMCAEvent_SwitchToCMCPolling, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
