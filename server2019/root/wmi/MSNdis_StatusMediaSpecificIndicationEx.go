...
type MSNdis_StatusMediaSpecificIndicationEx struct { 
	*WMIEvent
	...
	func NewMSNdis_StatusMediaSpecificIndicationExEx1(instance *cim.WmiInstance) (newInstance *MSNdis_StatusMediaSpecificIndicationEx, err error) {tmp, err := NewWMIEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSNdis_StatusMediaSpecificIndicationEx, err error) {tmp, err := NewWMIEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
