...
type KerbSetPassword_End struct { 
	*KerbSetPassword
	...
	func NewKerbSetPassword_EndEx1(instance *cim.WmiInstance) (newInstance *KerbSetPassword_End, err error) {tmp, err := NewKerbSetPasswordEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *KerbSetPassword_End, err error) {tmp, err := NewKerbSetPasswordEx6(hostName, wmiNamespace, userName, password, domainName, query)
