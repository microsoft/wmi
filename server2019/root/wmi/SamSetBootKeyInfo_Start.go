...
type SamSetBootKeyInfo_Start struct { 
	*SamSetBootKeyInfo
	...
	func NewSamSetBootKeyInfo_StartEx1(instance *cim.WmiInstance) (newInstance *SamSetBootKeyInfo_Start, err error) {tmp, err := NewSamSetBootKeyInfoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SamSetBootKeyInfo_Start, err error) {tmp, err := NewSamSetBootKeyInfoEx6(hostName, wmiNamespace, userName, password, domainName, query)
