...
type HeapAlloc struct { 
	*HeapTrace_V2
	...
	func NewHeapAllocEx1(instance *cim.WmiInstance) (newInstance *HeapAlloc, err error) {tmp, err := NewHeapTrace_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HeapAlloc, err error) {tmp, err := NewHeapTrace_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
