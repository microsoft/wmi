...
type WmiMonitorListedSupportedSourceModes struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorListedSupportedSourceModesEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorListedSupportedSourceModes, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorListedSupportedSourceModes, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
