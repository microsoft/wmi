...
type PmcCounterCorruption_V2 struct { 
	*PerfInfo_V2
	...
	func NewPmcCounterCorruption_V2Ex1(instance *cim.WmiInstance) (newInstance *PmcCounterCorruption_V2, err error) {tmp, err := NewPerfInfo_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PmcCounterCorruption_V2, err error) {tmp, err := NewPerfInfo_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
