...
type WNFNameSubRundown struct { 
	*WNFTrace
	...
	func NewWNFNameSubRundownEx1(instance *cim.WmiInstance) (newInstance *WNFNameSubRundown, err error) {tmp, err := NewWNFTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WNFNameSubRundown, err error) {tmp, err := NewWNFTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
