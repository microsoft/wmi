...
type ProcessorAcpiCst struct { 
	*cim.WmiInstance
	...
	func NewProcessorAcpiCstEx1(instance *cim.WmiInstance) (newInstance *ProcessorAcpiCst, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProcessorAcpiCst, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
