...
type PageFault_HeapRangeCreate struct { 
	*PageFault_V2
	...
	func NewPageFault_HeapRangeCreateEx1(instance *cim.WmiInstance) (newInstance *PageFault_HeapRangeCreate, err error) {tmp, err := NewPageFault_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PageFault_HeapRangeCreate, err error) {tmp, err := NewPageFault_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
