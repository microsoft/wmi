...
type WmiMonitorAnalogVideoInputParams struct { 
	*MSMonitorClass
	...
	func NewWmiMonitorAnalogVideoInputParamsEx1(instance *cim.WmiInstance) (newInstance *WmiMonitorAnalogVideoInputParams, err error) {tmp, err := NewMSMonitorClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WmiMonitorAnalogVideoInputParams, err error) {tmp, err := NewMSMonitorClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
