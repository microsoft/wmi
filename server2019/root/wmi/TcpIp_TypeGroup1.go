...
type TcpIp_TypeGroup1 struct { 
	*TcpIp
	...
	func NewTcpIp_TypeGroup1Ex1(instance *cim.WmiInstance) (newInstance *TcpIp_TypeGroup1, err error) {tmp, err := NewTcpIpEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TcpIp_TypeGroup1, err error) {tmp, err := NewTcpIpEx6(hostName, wmiNamespace, userName, password, domainName, query)
