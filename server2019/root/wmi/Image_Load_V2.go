...
type Image_Load_V2 struct { 
	*Image_V2
	...
	func NewImage_Load_V2Ex1(instance *cim.WmiInstance) (newInstance *Image_Load_V2, err error) {tmp, err := NewImage_V2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Image_Load_V2, err error) {tmp, err := NewImage_V2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
