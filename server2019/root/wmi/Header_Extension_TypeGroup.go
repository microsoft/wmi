...
type Header_Extension_TypeGroup struct { 
	*EventTraceEvent
	...
	func NewHeader_Extension_TypeGroupEx1(instance *cim.WmiInstance) (newInstance *Header_Extension_TypeGroup, err error) {tmp, err := NewEventTraceEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Header_Extension_TypeGroup, err error) {tmp, err := NewEventTraceEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
