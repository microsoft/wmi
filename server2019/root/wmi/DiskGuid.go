...
type DiskGuid struct { 
	*EventTrace
	...
	func NewDiskGuidEx1(instance *cim.WmiInstance) (newInstance *DiskGuid, err error) {tmp, err := NewEventTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DiskGuid, err error) {tmp, err := NewEventTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
