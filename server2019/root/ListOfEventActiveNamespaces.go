...
type __ListOfEventActiveNamespaces struct { 
	*__SystemClass
	...
	func New__ListOfEventActiveNamespacesEx1(instance *cim.WmiInstance) (newInstance *__ListOfEventActiveNamespaces, err error) {tmp, err := New__SystemClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__ListOfEventActiveNamespaces, err error) {tmp, err := New__SystemClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
