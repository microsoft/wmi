...
type __PropertyProviderCacheControl struct { 
	*__CacheControl
	...
	func New__PropertyProviderCacheControlEx1(instance *cim.WmiInstance) (newInstance *__PropertyProviderCacheControl, err error) {tmp, err := New__CacheControlEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__PropertyProviderCacheControl, err error) {tmp, err := New__CacheControlEx6(hostName, wmiNamespace, userName, password, domainName, query)
