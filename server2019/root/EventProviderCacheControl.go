...
type __EventProviderCacheControl struct { 
	*__CacheControl
	...
	func New__EventProviderCacheControlEx1(instance *cim.WmiInstance) (newInstance *__EventProviderCacheControl, err error) {tmp, err := New__CacheControlEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__EventProviderCacheControl, err error) {tmp, err := New__CacheControlEx6(hostName, wmiNamespace, userName, password, domainName, query)
