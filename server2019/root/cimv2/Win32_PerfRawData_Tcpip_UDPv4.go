...
// Win32_PerfRawData_Tcpip_UDPv4 struct
type Win32_PerfRawData_Tcpip_UDPv4 struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_Tcpip_UDPv4Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Tcpip_UDPv4, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_Tcpip_UDPv4 {
	...
	func NewWin32_PerfRawData_Tcpip_UDPv4Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Tcpip_UDPv4, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) SetPropertyDatagramsNoPortPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) GetPropertyDatagramsNoPortPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) SetPropertyDatagramsPersec(value uint32) (err error) { 
    return instance.SetProperty("DatagramsPersec", (value))
}

// GetDatagramsPersec gets the value of DatagramsPersec for the instance
func (instance *Win32_PerfRawData_Tcpip_UDPv4) GetPropertyDatagramsPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) SetPropertyDatagramsReceivedErrors(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) GetPropertyDatagramsReceivedErrors()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) SetPropertyDatagramsReceivedPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) GetPropertyDatagramsReceivedPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) SetPropertyDatagramsSentPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_UDPv4) GetPropertyDatagramsSentPersec()(value uint32, err error) { 
