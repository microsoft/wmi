...
func NewWin32_PerfRawData_Tcpip_UDPv4Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Tcpip_UDPv4, err error) {
...
func NewWin32_PerfRawData_Tcpip_UDPv4Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Tcpip_UDPv4, err error) {
