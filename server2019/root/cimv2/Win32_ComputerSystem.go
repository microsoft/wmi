...
type Win32_ComputerSystem struct { 
	*CIM_UnitaryComputerSystem
	...
	func NewWin32_ComputerSystemEx1(instance *cim.WmiInstance) (newInstance *Win32_ComputerSystem, err error) {tmp, err := NewCIM_UnitaryComputerSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ComputerSystem, err error) {tmp, err := NewCIM_UnitaryComputerSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_ComputerSystem) Rename( /* IN */ Name string,
 /* IN */ Password string,
 /* IN */ UserName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Rename" , Name, Password, UserName);
	if err != nil { return }
...
func (instance *Win32_ComputerSystem) JoinDomainOrWorkgroup( /* IN */ Name string,
 ...
 /* IN */ UserName string,
 /* IN */ AccountOU string,
 /* IN */ FJoinOptions uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("JoinDomainOrWorkgroup" , Name, Password, UserName, AccountOU, FJoinOptions);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_ComputerSystem) UnjoinDomainOrWorkgroup( /* IN */ Password string,
 /* IN */ UserName string,
 /* IN */ FUnjoinOptions uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UnjoinDomainOrWorkgroup" , Password, UserName, FUnjoinOptions);
	if err != nil { return }
	result = uint32(retVal)
	return
