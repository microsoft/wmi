...
type CIM_FRUIncludesProduct struct { 
	*cim.WmiInstance
	...
	func NewCIM_FRUIncludesProductEx1(instance *cim.WmiInstance) (newInstance *CIM_FRUIncludesProduct, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_FRUIncludesProduct, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
