...
type Win32_VolumeUserQuota struct { 
	*cim.WmiInstance
	...
	func NewWin32_VolumeUserQuotaEx1(instance *cim.WmiInstance) (newInstance *Win32_VolumeUserQuota, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_VolumeUserQuota, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
