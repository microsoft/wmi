...
type Win32_DCOMApplication struct { 
	*Win32_COMApplication
	...
	func NewWin32_DCOMApplicationEx1(instance *cim.WmiInstance) (newInstance *Win32_DCOMApplication, err error) {tmp, err := NewWin32_COMApplicationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DCOMApplication, err error) {tmp, err := NewWin32_COMApplicationEx6(hostName, wmiNamespace, userName, password, domainName, query)
