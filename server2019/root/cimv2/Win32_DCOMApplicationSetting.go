...
type Win32_DCOMApplicationSetting struct { 
	*Win32_COMSetting
	...
	func NewWin32_DCOMApplicationSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_DCOMApplicationSetting, err error) {tmp, err := NewWin32_COMSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DCOMApplicationSetting, err error) {tmp, err := NewWin32_COMSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_DCOMApplicationSetting) GetLaunchSecurityDescriptor( /* OUT */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetLaunchSecurityDescriptor" )
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_DCOMApplicationSetting) SetLaunchSecurityDescriptor( /* IN */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetLaunchSecurityDescriptor" , Descriptor);
	if err != nil { return }
...
// <param name="Descriptor" type="Win32_SecurityDescriptor "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_DCOMApplicationSetting) GetAccessSecurityDescriptor( /* OUT */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetAccessSecurityDescriptor" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_DCOMApplicationSetting) SetAccessSecurityDescriptor( /* IN */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetAccessSecurityDescriptor" , Descriptor);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="Descriptor" type="Win32_SecurityDescriptor "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_DCOMApplicationSetting) GetConfigurationSecurityDescriptor( /* OUT */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetConfigurationSecurityDescriptor" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_DCOMApplicationSetting) SetConfigurationSecurityDescriptor( /* IN */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetConfigurationSecurityDescriptor" , Descriptor);
	if err != nil { return }
	result = uint32(retVal)
	return
