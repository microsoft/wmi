...
type CIM_DeviceErrorCounts struct { 
	*CIM_StatisticalInformation
	...
	func NewCIM_DeviceErrorCountsEx1(instance *cim.WmiInstance) (newInstance *CIM_DeviceErrorCounts, err error) {tmp, err := NewCIM_StatisticalInformationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DeviceErrorCounts, err error) {tmp, err := NewCIM_StatisticalInformationEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_DeviceErrorCounts) ResetCounter( /* IN */ SelectedCounter uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ResetCounter" , SelectedCounter);
	if err != nil { return }
