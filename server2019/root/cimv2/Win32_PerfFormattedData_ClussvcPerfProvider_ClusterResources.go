...
func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterResourcesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources, err error) {
...
func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterResourcesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources, err error) {
