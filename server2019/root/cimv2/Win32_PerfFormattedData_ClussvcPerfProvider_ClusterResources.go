...
type Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterResourcesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources {
	...
	func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterResourcesEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourceControls()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourceControlsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourceFailure()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourceFailureAccessViolation()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourceFailureDeadlock()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourcesOnline()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourceTypeControls()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterResources) GetPropertyResourceTypeControlsPersec()(value uint64, err error) { 
