...
type Msft_WmiProvider_OperationEvent struct { 
	*MSFT_WmiSelfEvent
	...
	func NewMsft_WmiProvider_OperationEventEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_OperationEvent, err error) {tmp, err := NewMSFT_WmiSelfEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_WmiProvider_OperationEvent, err error) {tmp, err := NewMSFT_WmiSelfEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
