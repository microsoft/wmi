...
type Win32_1394Controller struct { 
	*CIM_Controller
	...
	func NewWin32_1394ControllerEx1(instance *cim.WmiInstance) (newInstance *Win32_1394Controller, err error) {tmp, err := NewCIM_ControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_1394Controller, err error) {tmp, err := NewCIM_ControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
