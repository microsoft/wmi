...
type CIM_Product struct { 
	*cim.WmiInstance
	...
	func NewCIM_ProductEx1(instance *cim.WmiInstance) (newInstance *CIM_Product, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Product, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
