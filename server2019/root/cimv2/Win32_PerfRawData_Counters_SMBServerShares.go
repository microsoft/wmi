...
func (instance *Win32_PerfRawData_Counters_SMBServerShares) SetPropertyCompressedResponsesPersec(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_SMBServerShares) GetPropertyCompressedResponsesPersec() (value uint64, err error) {
