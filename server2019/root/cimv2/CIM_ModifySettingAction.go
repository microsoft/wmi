...
type CIM_ModifySettingAction struct { 
	*CIM_Action
	...
	func NewCIM_ModifySettingActionEx1(instance *cim.WmiInstance) (newInstance *CIM_ModifySettingAction, err error) {tmp, err := NewCIM_ActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ModifySettingAction, err error) {tmp, err := NewCIM_ActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
