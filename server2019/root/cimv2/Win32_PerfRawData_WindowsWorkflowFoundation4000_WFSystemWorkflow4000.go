...
type Win32_PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000 struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
