...
type CIM_ElementConfiguration struct { 
	*cim.WmiInstance
	...
	func NewCIM_ElementConfigurationEx1(instance *cim.WmiInstance) (newInstance *CIM_ElementConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ElementConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
