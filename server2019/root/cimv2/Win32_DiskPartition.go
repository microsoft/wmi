...
type Win32_DiskPartition struct { 
	*CIM_DiskPartition
	...
	func NewWin32_DiskPartitionEx1(instance *cim.WmiInstance) (newInstance *Win32_DiskPartition, err error) {tmp, err := NewCIM_DiskPartitionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DiskPartition, err error) {tmp, err := NewCIM_DiskPartitionEx6(hostName, wmiNamespace, userName, password, domainName, query)
