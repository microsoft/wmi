...
type Win32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplicationsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications {
	...
	func NewWin32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplicationsEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_AuthorizationManager_AuthorizationManagerApplications, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
