...
type Win32_PerfRawData_PowerMeterCounter_PowerMeter struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_PowerMeterCounter_PowerMeterEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_PowerMeterCounter_PowerMeter, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_PowerMeterCounter_PowerMeter {
	...
	func NewWin32_PerfRawData_PowerMeterCounter_PowerMeterEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_PowerMeterCounter_PowerMeter, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
