...
type Win32_Bus struct { 
	*CIM_LogicalDevice
	...
	func NewWin32_BusEx1(instance *cim.WmiInstance) (newInstance *Win32_Bus, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Bus, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
