...
type Win32_ShareToDirectory struct { 
	*cim.WmiInstance
	...
	func NewWin32_ShareToDirectoryEx1(instance *cim.WmiInstance) (newInstance *Win32_ShareToDirectory, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ShareToDirectory, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
