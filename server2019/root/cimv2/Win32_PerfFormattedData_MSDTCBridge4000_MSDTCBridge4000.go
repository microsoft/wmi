...
type Win32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000 struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_MSDTCBridge4000_MSDTCBridge4000, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
