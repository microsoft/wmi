...
type Win32_ComClassAutoEmulator struct { 
	*cim.WmiInstance
	...
	func NewWin32_ComClassAutoEmulatorEx1(instance *cim.WmiInstance) (newInstance *Win32_ComClassAutoEmulator, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ComClassAutoEmulator, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
