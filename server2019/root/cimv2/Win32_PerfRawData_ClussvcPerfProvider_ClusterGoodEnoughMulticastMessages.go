...
type Win32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessages struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessagesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessages, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessages {
	...
	func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessagesEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterGoodEnoughMulticastMessages, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
