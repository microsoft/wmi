...
type Win32_TokenGroups struct { 
	*cim.WmiInstance
	...
	func NewWin32_TokenGroupsEx1(instance *cim.WmiInstance) (newInstance *Win32_TokenGroups, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TokenGroups, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
