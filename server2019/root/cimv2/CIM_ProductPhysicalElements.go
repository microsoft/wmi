...
type CIM_ProductPhysicalElements struct { 
	*cim.WmiInstance
	...
	func NewCIM_ProductPhysicalElementsEx1(instance *cim.WmiInstance) (newInstance *CIM_ProductPhysicalElements, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProductPhysicalElements, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
