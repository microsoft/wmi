...
type Win32_ImplementedCategory struct { 
	*cim.WmiInstance
	...
	func NewWin32_ImplementedCategoryEx1(instance *cim.WmiInstance) (newInstance *Win32_ImplementedCategory, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ImplementedCategory, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
