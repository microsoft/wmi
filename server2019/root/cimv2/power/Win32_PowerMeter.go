...
type Win32_PowerMeter struct { 
	*CIM_NumericSensor
	...
	func NewWin32_PowerMeterEx1(instance *cim.WmiInstance) (newInstance *Win32_PowerMeter, err error) {tmp, err := NewCIM_NumericSensorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PowerMeter, err error) {tmp, err := NewCIM_NumericSensorEx6(hostName, wmiNamespace, userName, password, domainName, query)
