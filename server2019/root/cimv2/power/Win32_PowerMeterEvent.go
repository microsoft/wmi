...
type Win32_PowerMeterEvent struct { 
	*__ExtrinsicEvent
	...
	func NewWin32_PowerMeterEventEx1(instance *cim.WmiInstance) (newInstance *Win32_PowerMeterEvent, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PowerMeterEvent, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
