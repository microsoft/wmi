...
type Win32_PowerPlan struct { 
	*CIM_SettingData
	...
	func NewWin32_PowerPlanEx1(instance *cim.WmiInstance) (newInstance *Win32_PowerPlan, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PowerPlan, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PowerPlan) Activate() (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("Activate" );
	if err != nil { return }
	result = (retVal > 0)
	return
