...
type Win32_PowerSettingDefinitionRangeData struct { 
	*CIM_SettingData
	...
	func NewWin32_PowerSettingDefinitionRangeDataEx1(instance *cim.WmiInstance) (newInstance *Win32_PowerSettingDefinitionRangeData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PowerSettingDefinitionRangeData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
