...
func NewWin32_PowerSettingElementSettingDataIndexEx1(instance *cim.WmiInstance) (newInstance *Win32_PowerSettingElementSettingDataIndex, err error) {
...
func NewWin32_PowerSettingElementSettingDataIndexEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PowerSettingElementSettingDataIndex, err error) {
