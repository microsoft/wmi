...
func NewWin32_PowerSettingDefinitionPossibleValueEx1(instance *cim.WmiInstance) (newInstance *Win32_PowerSettingDefinitionPossibleValue, err error) {
...
func NewWin32_PowerSettingDefinitionPossibleValueEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PowerSettingDefinitionPossibleValue, err error) {
