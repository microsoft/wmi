...
type CIM_ElementConformsToProfile struct { 
	*cim.WmiInstance
	...
	func NewCIM_ElementConformsToProfileEx1(instance *cim.WmiInstance) (newInstance *CIM_ElementConformsToProfile, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ElementConformsToProfile, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
