...
type CIM_NumericSensor struct { 
	*CIM_Sensor
	...
	func NewCIM_NumericSensorEx1(instance *cim.WmiInstance) (newInstance *CIM_NumericSensor, err error) {tmp, err := NewCIM_SensorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_NumericSensor, err error) {tmp, err := NewCIM_SensorEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_NumericSensor) RestoreDefaultThresholds() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RestoreDefaultThresholds" );
	if err != nil { return }
...
func (instance *CIM_NumericSensor) GetNonLinearFactors( /* IN */ SensorReading int32,
 ...
 /* OUT */ Tolerance int32,
 /* OUT */ Hysteresis uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetNonLinearFactors" , SensorReading)
	if err != nil { return }
