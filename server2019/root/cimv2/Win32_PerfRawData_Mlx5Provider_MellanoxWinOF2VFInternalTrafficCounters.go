...
type Win32_PerfRawData_Mlx5Provider_MellanoxWinOF2VFInternalTrafficCounters struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_Mlx5Provider_MellanoxWinOF2VFInternalTrafficCountersEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Mlx5Provider_MellanoxWinOF2VFInternalTrafficCounters, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Mlx5Provider_MellanoxWinOF2VFInternalTrafficCounters, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
