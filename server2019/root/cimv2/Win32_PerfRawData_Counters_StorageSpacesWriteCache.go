...
type Win32_PerfRawData_Counters_StorageSpacesWriteCache struct { 
	*Win32_PerfRawData
	...
	// 
	CacheCheckpointLatencyms_Base uint32
	...
	// 
	CacheReclaimablePercent_Base uint64
	...
	// 
	EvictCacheDestagedPercent_Base uint64
	...
	// 
	EvictCacheOverwritePercent_Base uint64
	...
	// 
	ReadCachePercent_Base uint64

	// 
	VdtCheckpointLatencyms uint32

	// 
	VdtCheckpointLatencyms_Base uint32
	...
	// 
	WriteBypassPercent_Base uint64
	...
	// 
	WriteCacheOverlapPercent_Base uint64

	// 
	WriteCachePercent uint64

	// 
	WriteCachePercent_Base uint64
	...
	// 
	WriteCacheUnalignedPercent_Base uint64
	...
	// 
	WriteCacheUntrimmedPercent_Base uint64
}

	func NewWin32_PerfRawData_Counters_StorageSpacesWriteCacheEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_StorageSpacesWriteCache, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_Counters_StorageSpacesWriteCache {
	...
	func NewWin32_PerfRawData_Counters_StorageSpacesWriteCacheEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Counters_StorageSpacesWriteCache, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheAdvances()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) SetPropertyCacheCheckpointLatencyms(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheCheckpointLatencyms()(value uint32, err error) { 
...
// SetCacheCheckpointLatencyms_Base sets the value of CacheCheckpointLatencyms_Base for the instance
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) SetPropertyCacheCheckpointLatencyms_Base(value uint32) (err error) { 
    return instance.SetProperty("CacheCheckpointLatencyms_Base", (value))
}

// GetCacheCheckpointLatencyms_Base gets the value of CacheCheckpointLatencyms_Base for the instance
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheCheckpointLatencyms_Base()(value uint32, err error) { 
    retValue, err := instance.GetProperty("CacheCheckpointLatencyms_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheCheckpoints()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheDataBytes()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheDataPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheDataPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("CacheDataPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheDestagesCurrent()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheReclaimableBytes()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheReclaimablePercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheReclaimablePercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("CacheReclaimablePercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheSize()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheUsedBytes()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheUsedPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyCacheUsedPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("CacheUsedPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) SetPropertyDestageReadFailureCount(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyDestageReadFailureCount()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) SetPropertyDestageWriteFailureCount(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyDestageWriteFailureCount()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyEvictCacheBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyEvictCacheDestagedBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyEvictCacheDestagedPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyEvictCacheDestagedPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("EvictCacheDestagedPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyEvictCacheOverwriteBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyEvictCacheOverwritePercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyEvictCacheOverwritePercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("EvictCacheOverwritePercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyReadBypassBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyReadBypassPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyReadBypassPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("ReadBypassPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyReadCacheBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyReadCachePercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyReadCachePercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("ReadCachePercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) SetPropertyVdtCheckpointLatencyms(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyVdtCheckpointLatencyms()(value uint32, err error) { 
...
// SetVdtCheckpointLatencyms_Base sets the value of VdtCheckpointLatencyms_Base for the instance
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) SetPropertyVdtCheckpointLatencyms_Base(value uint32) (err error) { 
    return instance.SetProperty("VdtCheckpointLatencyms_Base", (value))
}

// GetVdtCheckpointLatencyms_Base gets the value of VdtCheckpointLatencyms_Base for the instance
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyVdtCheckpointLatencyms_Base()(value uint32, err error) { 
    retValue, err := instance.GetProperty("VdtCheckpointLatencyms_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteBypassBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteBypassPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteBypassPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("WriteBypassPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheOverlapBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheOverlapPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheOverlapPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("WriteCacheOverlapPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCachePercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCachePercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("WriteCachePercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheUnalignedBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheUnalignedPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheUnalignedPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("WriteCacheUnalignedPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheUntrimmedBytesPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheUntrimmedPercent()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_StorageSpacesWriteCache) GetPropertyWriteCacheUntrimmedPercent_Base()(value uint64, err error) { 
    retValue, err := instance.GetProperty("WriteCacheUntrimmedPercent_Base")
    if err != nil {
        return
    }
    if retValue == nil {
