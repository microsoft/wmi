...
type Win32_TSPermissionsSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSPermissionsSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSPermissionsSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSPermissionsSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSPermissionsSetting) AddAccount( /* IN */ AccountName string,
 /* IN */ PermissionPreSet uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddAccount" , AccountName, PermissionPreSet);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSPermissionsSetting) RestoreDefaults() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RestoreDefaults" );
	if err != nil { return }
	result = uint32(retVal)
	return
