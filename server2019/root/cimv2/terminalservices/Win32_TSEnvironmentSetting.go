...
type Win32_TSEnvironmentSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSEnvironmentSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSEnvironmentSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSEnvironmentSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSEnvironmentSetting) InitialProgram( /* IN */ InitialProgramPath string,
 /* IN */ Startin string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("InitialProgram" , InitialProgramPath, Startin);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSEnvironmentSetting) SetClientWallPaper( /* IN */ ClientWallPaper uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetClientWallPaper" , ClientWallPaper);
	if err != nil { return }
	result = uint32(retVal)
	return
