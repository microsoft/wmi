...
type Win32_TerminalServiceToSetting struct { 
	*CIM_ElementSetting
	...
	func NewWin32_TerminalServiceToSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TerminalServiceToSetting, err error) {tmp, err := NewCIM_ElementSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TerminalServiceToSetting, err error) {tmp, err := NewCIM_ElementSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
