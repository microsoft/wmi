...
type Win32_TSLogonSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSLogonSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSLogonSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSLogonSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSLogonSetting) ExplicitLogon( /* IN */ UserName string,
 /* IN */ Domain string,
 /* IN */ Password string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ExplicitLogon" , UserName, Domain, Password);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSLogonSetting) SetPromptForPassword( /* IN */ PromptForPassword uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPromptForPassword" , PromptForPassword);
	if err != nil { return }
	result = uint32(retVal)
	return
