...
type Win32_TSGeneralSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSGeneralSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSGeneralSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSGeneralSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSGeneralSetting) SetEncryptionLevel( /* IN */ MinEncryptionLevel uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetEncryptionLevel" , MinEncryptionLevel);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSGeneralSetting) SetSecurityLayer( /* IN */ SecurityLayer uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSecurityLayer" , SecurityLayer);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSGeneralSetting) SetUserAuthenticationRequired( /* IN */ UserAuthenticationRequired uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetUserAuthenticationRequired" , UserAuthenticationRequired);
	if err != nil { return }
	result = uint32(retVal)
	return
