...
type Win32_RDFileAssociation struct { 
	*cim.WmiInstance
	...
	func NewWin32_RDFileAssociationEx1(instance *cim.WmiInstance) (newInstance *Win32_RDFileAssociation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RDFileAssociation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
