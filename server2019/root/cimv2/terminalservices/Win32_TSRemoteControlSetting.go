...
type Win32_TSRemoteControlSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSRemoteControlSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSRemoteControlSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSRemoteControlSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSRemoteControlSetting) RemoteControl( /* IN */ LevelOfControl uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoteControl" , LevelOfControl);
	if err != nil { return }
