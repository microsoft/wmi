...
type Win32_Terminal struct { 
	*CIM_LogicalElement
	...
	func NewWin32_TerminalEx1(instance *cim.WmiInstance) (newInstance *Win32_Terminal, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Terminal, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_Terminal) Enable( /* IN */ fEnableTerminal uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Enable" , fEnableTerminal);
	if err != nil { return }
...
func (instance *Win32_Terminal) Create( /* IN */ NewTerminalName string,
 /* IN */ Transport string,
 /* IN */ TerminalProtocol string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Create" , NewTerminalName, Transport, TerminalProtocol);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Terminal) Rename( /* IN */ NewTerminalName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Rename" , NewTerminalName);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Terminal) Delete( /* IN */ NewTerminalName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Delete" , NewTerminalName);
	if err != nil { return }
	result = uint32(retVal)
	return
