...
type Win32_TSGetIcon struct { 
	*CIM_LogicalElement
	...
	func NewWin32_TSGetIconEx1(instance *cim.WmiInstance) (newInstance *Win32_TSGetIcon, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSGetIcon, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSGetIcon) GetIcon( /* IN */ FilePath string,
 /* IN */ Index int32,
 /* OUT */ IconContents []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetIcon" , FilePath, Index)
	if err != nil { return }
