...
type Win32_TSSessionDirectory struct { 
	*CIM_Setting
	...
	func NewWin32_TSSessionDirectoryEx1(instance *cim.WmiInstance) (newInstance *Win32_TSSessionDirectory, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSSessionDirectory, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSSessionDirectory) SetSessionDirectoryProperty( /* IN */ PropertyName string,
 /* IN */ Value string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSessionDirectoryProperty" , PropertyName, Value);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSSessionDirectory) SetSessionDirectoryActive( /* IN */ SessionDirectoryActive uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSessionDirectoryActive" , SessionDirectoryActive);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSSessionDirectory) SetSessionDirectoryExposeServerIP( /* IN */ SessionDirectoryExposeServerIP uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSessionDirectoryExposeServerIP" , SessionDirectoryExposeServerIP);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_TSSessionDirectory) GetRedirectableAddresses( /* IN */ fTokenRedirection uint32,
 ...
 /* OUT */ NetConName []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetRedirectableAddresses" , fTokenRedirection)
	if err != nil { return }
...
func (instance *Win32_TSSessionDirectory) GetCurrentRedirectableAddresses( /* OUT */ fTokenRedirection uint32,
 /* OUT */ IPAddresses []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetCurrentRedirectableAddresses" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Win32_TSSessionDirectory) SetCurrentRedirectableAddresses( /* IN */ fTokenRedirection uint32,
 /* IN */ IPAddresses []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetCurrentRedirectableAddresses" , fTokenRedirection, IPAddresses);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSSessionDirectory) PingSessionDirectory( /* IN */ ServerName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("PingSessionDirectory" , ServerName);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSSessionDirectory) SetLoadBalancingState( /* IN */ StateValue uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetLoadBalancingState" , StateValue);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSSessionDirectory) SetServerWeight( /* IN */ ServerWeightValue uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetServerWeight" , ServerWeightValue);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_TSSessionDirectory) CreateUserDiskTemplate( /* IN */ UserDisksStorageUrl string,
 /* IN */ UserDiskMaxSizeInGB uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CreateUserDiskTemplate" , UserDisksStorageUrl, UserDiskMaxSizeInGB);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_TSSessionDirectory) EnableUserVhd( /* IN */ UvhdShareUrl string,
 /* IN */ UvhdRoamingPolicyXml string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("EnableUserVhd" , UvhdShareUrl, UvhdRoamingPolicyXml);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSSessionDirectory) DisableUserVhd() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("DisableUserVhd" );
	if err != nil { return }
	result = uint32(retVal)
	return
