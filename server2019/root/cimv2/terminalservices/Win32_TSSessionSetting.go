...
type Win32_TSSessionSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSSessionSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSSessionSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSSessionSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSSessionSetting) TimeLimit( /* IN */ SessionLimitType string,
 /* IN */ ValueLimit uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("TimeLimit" , SessionLimitType, ValueLimit);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSSessionSetting) BrokenConnection( /* IN */ BrokenConnectionAction uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("BrokenConnection" , BrokenConnectionAction);
	if err != nil { return }
	result = uint32(retVal)
	return
