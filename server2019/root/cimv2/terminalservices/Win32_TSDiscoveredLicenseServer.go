...
type Win32_TSDiscoveredLicenseServer struct { 
	*cim.WmiInstance
	...
	func NewWin32_TSDiscoveredLicenseServerEx1(instance *cim.WmiInstance) (newInstance *Win32_TSDiscoveredLicenseServer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSDiscoveredLicenseServer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
