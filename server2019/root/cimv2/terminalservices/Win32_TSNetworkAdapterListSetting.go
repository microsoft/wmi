...
type Win32_TSNetworkAdapterListSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSNetworkAdapterListSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSNetworkAdapterListSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSNetworkAdapterListSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
