...
type Win32_RDAllowListFileAssociation struct { 
	*cim.WmiInstance
	...
	func NewWin32_RDAllowListFileAssociationEx1(instance *cim.WmiInstance) (newInstance *Win32_RDAllowListFileAssociation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RDAllowListFileAssociation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
