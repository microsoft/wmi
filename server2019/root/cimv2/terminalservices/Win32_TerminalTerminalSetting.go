...
type Win32_TerminalTerminalSetting struct { 
	*CIM_ElementSetting
	...
	func NewWin32_TerminalTerminalSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TerminalTerminalSetting, err error) {tmp, err := NewCIM_ElementSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TerminalTerminalSetting, err error) {tmp, err := NewCIM_ElementSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
