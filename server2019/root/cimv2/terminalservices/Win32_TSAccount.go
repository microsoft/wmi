...
type Win32_TSAccount struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSAccountEx1(instance *cim.WmiInstance) (newInstance *Win32_TSAccount, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSAccount, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSAccount) Delete() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Delete" );
	if err != nil { return }
...
func (instance *Win32_TSAccount) ModifyPermissions( /* IN */ PermissionMask uint32,
 /* IN */ Allow bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ModifyPermissions" , PermissionMask, Allow);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_TSAccount) ModifyAuditPermissions( /* IN */ PermissionMask uint32,
 /* IN */ Success bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ModifyAuditPermissions" , PermissionMask, Success);
	if err != nil { return }
	result = uint32(retVal)
	return
