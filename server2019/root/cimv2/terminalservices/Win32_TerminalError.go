...
type Win32_TerminalError struct { 
	*__ExtendedStatus
	...
	func NewWin32_TerminalErrorEx1(instance *cim.WmiInstance) (newInstance *Win32_TerminalError, err error) {tmp, err := New__ExtendedStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TerminalError, err error) {tmp, err := New__ExtendedStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
