...
type Win32_TSVirtualIP struct { 
	*CIM_Setting
	...
	func NewWin32_TSVirtualIPEx1(instance *cim.WmiInstance) (newInstance *Win32_TSVirtualIP, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSVirtualIP, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSVirtualIP) SetVirtualIPActive( /* IN */ VirtualIPActive uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetVirtualIPActive" , VirtualIPActive);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSVirtualIP) SetVirtualIPMode( /* IN */ VirtualIPMode uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetVirtualIPMode" , VirtualIPMode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSVirtualIP) AddProgram( /* IN */ ProgramPath string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddProgram" , ProgramPath);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSVirtualIP) RemoveProgram( /* IN */ ProgramPath string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveProgram" , ProgramPath);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSVirtualIP) SetProgramList( /* IN */ ProgramList []string) (result interface{}, err error) {retVal, err := instance.InvokeMethodWithReturn("SetProgramList" , ProgramList);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSVirtualIP) SelectNetworkAdapter( /* IN */ NetworkAdapterMacAddress string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SelectNetworkAdapter" , NetworkAdapterMacAddress);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSVirtualIP) SetVirtualizeLoopbackAddressesEnabled( /* IN */ VirtualizeLoopbackAddressesEnabled uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetVirtualizeLoopbackAddressesEnabled" , VirtualizeLoopbackAddressesEnabled);
	if err != nil { return }
	result = uint32(retVal)
	return
