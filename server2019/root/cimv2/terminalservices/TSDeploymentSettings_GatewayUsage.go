...
const(
	...
	TSDeploymentSettings_GatewayUsage_UseGatewayBypassLocal TSDeploymentSettings_GatewayUsage = 1
	// UseGateway enum
	TSDeploymentSettings_GatewayUsage_UseGateway TSDeploymentSettings_GatewayUsage = 2
	// DetectGateway enum
