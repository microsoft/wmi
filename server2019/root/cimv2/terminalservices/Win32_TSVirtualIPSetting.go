...
type Win32_TSVirtualIPSetting struct { 
	*CIM_ElementSetting
	...
	func NewWin32_TSVirtualIPSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSVirtualIPSetting, err error) {tmp, err := NewCIM_ElementSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSVirtualIPSetting, err error) {tmp, err := NewCIM_ElementSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
