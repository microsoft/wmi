...
func NewWin32_TSClientSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSClientSetting, err error) {
...
func NewWin32_TSClientSettingEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_TSClientSetting, err error) {
