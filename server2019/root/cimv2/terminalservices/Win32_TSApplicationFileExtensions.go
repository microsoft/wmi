...
type Win32_TSApplicationFileExtensions struct { 
	*CIM_LogicalElement
	...
	func NewWin32_TSApplicationFileExtensionsEx1(instance *cim.WmiInstance) (newInstance *Win32_TSApplicationFileExtensions, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSApplicationFileExtensions, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSApplicationFileExtensions) FileExtensions( /* IN */ AppPath string,
 /* OUT */ Extensions []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("FileExtensions" , AppPath)
	if err != nil { return }
...
func (instance *Win32_TSApplicationFileExtensions) FileAssociations( /* IN */ AppPath string,
 /* OUT */ FileAssociations []Win32_RDFileAssociation) (result uint32, err error) {retVal, err := instance.InvokeMethod("FileAssociations" , AppPath)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
