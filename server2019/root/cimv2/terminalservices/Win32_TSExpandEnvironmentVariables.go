...
type Win32_TSExpandEnvironmentVariables struct { 
	*CIM_LogicalElement
	...
	func NewWin32_TSExpandEnvironmentVariablesEx1(instance *cim.WmiInstance) (newInstance *Win32_TSExpandEnvironmentVariables, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSExpandEnvironmentVariables, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSExpandEnvironmentVariables) EnvironmentVariables( /* IN */ OriginalString string,
 /* OUT */ ExpandedString string) (result uint32, err error) {retVal, err := instance.InvokeMethod("EnvironmentVariables" , OriginalString)
	if err != nil { return }
