...
type Win32_TSPublishedApplication struct { 
	*CIM_LogicalElement
	...
	func NewWin32_TSPublishedApplicationEx1(instance *cim.WmiInstance) (newInstance *Win32_TSPublishedApplication, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSPublishedApplication, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
