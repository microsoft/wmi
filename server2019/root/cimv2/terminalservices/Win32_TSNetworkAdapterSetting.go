...
type Win32_TSNetworkAdapterSetting struct { 
	*Win32_TerminalSetting
	...
	func NewWin32_TSNetworkAdapterSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_TSNetworkAdapterSetting, err error) {tmp, err := NewWin32_TerminalSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TSNetworkAdapterSetting, err error) {tmp, err := NewWin32_TerminalSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_TSNetworkAdapterSetting) SelectAllNetworkAdapters() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SelectAllNetworkAdapters" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSNetworkAdapterSetting) SetNetworkAdapterLanaID( /* IN */ NetworkAdapterLanaID uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetNetworkAdapterLanaID" , NetworkAdapterLanaID);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_TSNetworkAdapterSetting) SelectNetworkAdapterIP( /* IN */ NetworkAdapterIP string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SelectNetworkAdapterIP" , NetworkAdapterIP);
	if err != nil { return }
	result = uint32(retVal)
	return
