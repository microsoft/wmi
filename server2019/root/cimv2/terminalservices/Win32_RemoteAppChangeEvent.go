...
type Win32_RemoteAppChangeEvent struct { 
	*__ExtrinsicEvent
	...
	func NewWin32_RemoteAppChangeEventEx1(instance *cim.WmiInstance) (newInstance *Win32_RemoteAppChangeEvent, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RemoteAppChangeEvent, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
