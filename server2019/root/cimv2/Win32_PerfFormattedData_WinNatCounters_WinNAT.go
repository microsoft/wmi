...
type Win32_PerfFormattedData_WinNatCounters_WinNAT struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_WinNatCounters_WinNATEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_WinNatCounters_WinNAT, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_WinNatCounters_WinNAT {
	...
	func NewWin32_PerfFormattedData_WinNatCounters_WinNATEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_WinNatCounters_WinNAT, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyCurrentSessionCount()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyDroppedICMPerrorpackets()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyDroppedICMPerrorpacketsPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyDroppedPackets()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyDroppedPacketsPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyInterRoutingDomainHairpinnedPackets()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyInterRoutingDomainHairpinnedPacketsPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyIntraRoutingDomainHairpinnedPackets()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyIntraRoutingDomainHairpinnedPacketsPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyPacketsExternaltoInternal()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyPacketsInternaltoExternal()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyPacketsPersecExternaltoInternal()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertyPacketsPersecInternaltoExternal()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_WinNatCounters_WinNAT) GetPropertySessionsPersec()(value uint32, err error) { 
