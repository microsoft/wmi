...
type Win32_SecuritySettingOwner struct { 
	*cim.WmiInstance
	...
	func NewWin32_SecuritySettingOwnerEx1(instance *cim.WmiInstance) (newInstance *Win32_SecuritySettingOwner, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SecuritySettingOwner, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
