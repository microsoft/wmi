...
type Win32_Property struct { 
	*Win32_MSIResource
	...
	func NewWin32_PropertyEx1(instance *cim.WmiInstance) (newInstance *Win32_Property, err error) {tmp, err := NewWin32_MSIResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Property, err error) {tmp, err := NewWin32_MSIResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
