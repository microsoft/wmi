...
type MSFT_NetServiceStartHung struct { 
	*MSFT_SCMEventLogEvent
	...
	func NewMSFT_NetServiceStartHungEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetServiceStartHung, err error) {tmp, err := NewMSFT_SCMEventLogEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetServiceStartHung, err error) {tmp, err := NewMSFT_SCMEventLogEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
