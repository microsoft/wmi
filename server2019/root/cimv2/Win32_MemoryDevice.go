...
type Win32_MemoryDevice struct { 
	*Win32_SMBIOSMemory
	...
	func NewWin32_MemoryDeviceEx1(instance *cim.WmiInstance) (newInstance *Win32_MemoryDevice, err error) {tmp, err := NewWin32_SMBIOSMemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_MemoryDevice, err error) {tmp, err := NewWin32_SMBIOSMemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
