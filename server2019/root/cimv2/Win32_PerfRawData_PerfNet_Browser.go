...
type Win32_PerfRawData_PerfNet_Browser struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_PerfNet_BrowserEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_PerfNet_Browser, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_PerfNet_Browser, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
