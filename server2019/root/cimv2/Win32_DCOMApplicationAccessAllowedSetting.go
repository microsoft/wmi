...
type Win32_DCOMApplicationAccessAllowedSetting struct { 
	*cim.WmiInstance
	...
	func NewWin32_DCOMApplicationAccessAllowedSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_DCOMApplicationAccessAllowedSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DCOMApplicationAccessAllowedSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
