...
type Win32_Product struct { 
	*CIM_Product
	...
	func NewWin32_ProductEx1(instance *cim.WmiInstance) (newInstance *Win32_Product, err error) {tmp, err := NewCIM_ProductEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Product, err error) {tmp, err := NewCIM_ProductEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_Product) Install( /* IN */ PackageLocation string,
 /* IN */ Options string,
 /* IN */ AllUsers bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Install" , PackageLocation, Options, AllUsers);
	if err != nil { return }
...
func (instance *Win32_Product) Admin( /* IN */ PackageLocation string,
 ...
 /* IN */ Options string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Admin" , PackageLocation, TargetLocation, Options);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_Product) Advertise( /* IN */ PackageLocation string,
 /* IN */ Options string,
 /* IN */ AllUsers bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Advertise" , PackageLocation, Options, AllUsers);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Product) Reinstall( /* IN */ ReinstallMode uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Reinstall" , ReinstallMode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_Product) Upgrade( /* IN */ PackageLocation string,
 /* IN */ Options string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Upgrade" , PackageLocation, Options);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_Product) Configure( /* IN */ InstallState uint16,
 ...
 /* IN */ Options string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Configure" , InstallState, InstallLevel, Options);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Product) Uninstall() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Uninstall" );
	if err != nil { return }
	result = uint32(retVal)
	return
