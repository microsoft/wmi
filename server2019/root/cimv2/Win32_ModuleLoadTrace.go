...
type Win32_ModuleLoadTrace struct { 
	*Win32_ModuleTrace
	...
	func NewWin32_ModuleLoadTraceEx1(instance *cim.WmiInstance) (newInstance *Win32_ModuleLoadTrace, err error) {tmp, err := NewWin32_ModuleTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ModuleLoadTrace, err error) {tmp, err := NewWin32_ModuleTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
