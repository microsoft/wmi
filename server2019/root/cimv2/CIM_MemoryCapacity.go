...
type CIM_MemoryCapacity struct { 
	*CIM_PhysicalCapacity
	...
	func NewCIM_MemoryCapacityEx1(instance *cim.WmiInstance) (newInstance *CIM_MemoryCapacity, err error) {tmp, err := NewCIM_PhysicalCapacityEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_MemoryCapacity, err error) {tmp, err := NewCIM_PhysicalCapacityEx6(hostName, wmiNamespace, userName, password, domainName, query)
