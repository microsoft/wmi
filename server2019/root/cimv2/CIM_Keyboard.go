...
type CIM_Keyboard struct { 
	*CIM_UserDevice
	...
	func NewCIM_KeyboardEx1(instance *cim.WmiInstance) (newInstance *CIM_Keyboard, err error) {tmp, err := NewCIM_UserDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Keyboard, err error) {tmp, err := NewCIM_UserDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
