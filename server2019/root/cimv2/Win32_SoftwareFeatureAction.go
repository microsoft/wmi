...
type Win32_SoftwareFeatureAction struct { 
	*cim.WmiInstance
	...
	func NewWin32_SoftwareFeatureActionEx1(instance *cim.WmiInstance) (newInstance *Win32_SoftwareFeatureAction, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SoftwareFeatureAction, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
