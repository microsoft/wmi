...
type Win32_ProductResource struct { 
	*cim.WmiInstance
	...
	func NewWin32_ProductResourceEx1(instance *cim.WmiInstance) (newInstance *Win32_ProductResource, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ProductResource, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
