...
type Win32_ProductCheck struct { 
	*cim.WmiInstance
	...
	func NewWin32_ProductCheckEx1(instance *cim.WmiInstance) (newInstance *Win32_ProductCheck, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ProductCheck, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
