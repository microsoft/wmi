...
type CIM_DeviceSoftware struct { 
	*CIM_Dependency
	...
	func NewCIM_DeviceSoftwareEx1(instance *cim.WmiInstance) (newInstance *CIM_DeviceSoftware, err error) {tmp, err := NewCIM_DependencyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DeviceSoftware, err error) {tmp, err := NewCIM_DependencyEx6(hostName, wmiNamespace, userName, password, domainName, query)
