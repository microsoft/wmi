...
type CIM_ActionSequence struct { 
	*cim.WmiInstance
	...
	func NewCIM_ActionSequenceEx1(instance *cim.WmiInstance) (newInstance *CIM_ActionSequence, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ActionSequence, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
