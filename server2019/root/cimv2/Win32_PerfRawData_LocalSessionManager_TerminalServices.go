...
type Win32_PerfRawData_LocalSessionManager_TerminalServices struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_LocalSessionManager_TerminalServicesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_LocalSessionManager_TerminalServices, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_LocalSessionManager_TerminalServices, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
