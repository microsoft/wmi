...
type RegistryKeyChangeEvent struct { 
	*RegistryEvent
	...
	func NewRegistryKeyChangeEventEx1(instance *cim.WmiInstance) (newInstance *RegistryKeyChangeEvent, err error) {tmp, err := NewRegistryEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RegistryKeyChangeEvent, err error) {tmp, err := NewRegistryEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
