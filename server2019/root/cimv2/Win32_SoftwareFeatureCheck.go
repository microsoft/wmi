...
type Win32_SoftwareFeatureCheck struct { 
	*cim.WmiInstance
	...
	func NewWin32_SoftwareFeatureCheckEx1(instance *cim.WmiInstance) (newInstance *Win32_SoftwareFeatureCheck, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SoftwareFeatureCheck, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
