...
type Win32_PerfFormattedData_Counters_EventLog struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_Counters_EventLogEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_EventLog, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_Counters_EventLog, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_Counters_EventLog) SetPropertyActiveChannels(value uint32) (err error) { 
    return instance.SetProperty("ActiveChannels", (value))
}

// GetActiveChannels gets the value of ActiveChannels for the instance
func (instance *Win32_PerfFormattedData_Counters_EventLog) GetPropertyActiveChannels()(value uint32, err error) { 
