...
type Win32_POTSModem struct { 
	*CIM_PotsModem
	...
	func NewWin32_POTSModemEx1(instance *cim.WmiInstance) (newInstance *Win32_POTSModem, err error) {tmp, err := NewCIM_PotsModemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_POTSModem, err error) {tmp, err := NewCIM_PotsModemEx6(hostName, wmiNamespace, userName, password, domainName, query)
