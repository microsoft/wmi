...
type CIM_ChassisInRack struct { 
	*CIM_Container
	...
	func NewCIM_ChassisInRackEx1(instance *cim.WmiInstance) (newInstance *CIM_ChassisInRack, err error) {tmp, err := NewCIM_ContainerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ChassisInRack, err error) {tmp, err := NewCIM_ContainerEx6(hostName, wmiNamespace, userName, password, domainName, query)
