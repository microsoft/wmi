...
type Win32_NTLogEvent struct { 
	*cim.WmiInstance
	...
	func NewWin32_NTLogEventEx1(instance *cim.WmiInstance) (newInstance *Win32_NTLogEvent, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NTLogEvent, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
