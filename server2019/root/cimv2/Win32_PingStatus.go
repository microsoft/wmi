...
type Win32_PingStatus struct { 
	*cim.WmiInstance
	...
	func NewWin32_PingStatusEx1(instance *cim.WmiInstance) (newInstance *Win32_PingStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PingStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
