...
// Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc struct
type Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvcEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc {
	...
	func NewWin32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvcEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) SetPropertyBytesreceivedbyactiveDirectAccessclients(value uint64) (err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) GetPropertyBytesreceivedbyactiveDirectAccessclients()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) SetPropertyBytesreceivedbydisconnectedDirectAccessclients(value uint64) (err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) GetPropertyBytesreceivedbydisconnectedDirectAccessclients()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) SetPropertyBytestransmittedbyactiveDirectAccessclients(value uint64) (err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) GetPropertyBytestransmittedbyactiveDirectAccessclients()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) SetPropertyBytestransmittedbydisconnectedDirectAccessclients(value uint64) (err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) GetPropertyBytestransmittedbydisconnectedDirectAccessclients()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) SetPropertyCumulativenumberofDirectAccessconnectionssinceservicestart(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) GetPropertyCumulativenumberofDirectAccessconnectionssinceservicestart()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) SetPropertyMaximumnumberofremoteclientsconnectedtoserversinceservicestart(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) GetPropertyMaximumnumberofremoteclientsconnectedtoserversinceservicestart()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) SetPropertyTotalnumberofactiveDirectAccessconnections(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_RamgmtSvcCounterProvider_RaMgmtSvc) GetPropertyTotalnumberofactiveDirectAccessconnections()(value uint32, err error) { 
