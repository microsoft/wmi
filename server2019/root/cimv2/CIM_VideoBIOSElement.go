...
type CIM_VideoBIOSElement struct { 
	*CIM_SoftwareElement
	...
	func NewCIM_VideoBIOSElementEx1(instance *cim.WmiInstance) (newInstance *CIM_VideoBIOSElement, err error) {tmp, err := NewCIM_SoftwareElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VideoBIOSElement, err error) {tmp, err := NewCIM_SoftwareElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
