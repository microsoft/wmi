...
type MSFT_NetServiceRecoveryFailed struct { 
	*MSFT_SCMEventLogEvent
	...
	func NewMSFT_NetServiceRecoveryFailedEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetServiceRecoveryFailed, err error) {tmp, err := NewMSFT_SCMEventLogEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetServiceRecoveryFailed, err error) {tmp, err := NewMSFT_SCMEventLogEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
