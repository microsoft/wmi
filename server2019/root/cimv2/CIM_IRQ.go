...
type CIM_IRQ struct { 
	*CIM_SystemResource
	...
	func NewCIM_IRQEx1(instance *cim.WmiInstance) (newInstance *CIM_IRQ, err error) {tmp, err := NewCIM_SystemResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_IRQ, err error) {tmp, err := NewCIM_SystemResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
