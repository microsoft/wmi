...
type CIM_StorageError struct { 
	*cim.WmiInstance
	...
	func NewCIM_StorageErrorEx1(instance *cim.WmiInstance) (newInstance *CIM_StorageError, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_StorageError, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
