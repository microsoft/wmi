...
type Win32_DuplicateFileAction struct { 
	*CIM_CopyFileAction
	...
	func NewWin32_DuplicateFileActionEx1(instance *cim.WmiInstance) (newInstance *Win32_DuplicateFileAction, err error) {tmp, err := NewCIM_CopyFileActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DuplicateFileAction, err error) {tmp, err := NewCIM_CopyFileActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
