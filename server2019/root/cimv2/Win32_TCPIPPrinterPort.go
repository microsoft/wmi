...
type Win32_TCPIPPrinterPort struct { 
	*CIM_ServiceAccessPoint
	...
	func NewWin32_TCPIPPrinterPortEx1(instance *cim.WmiInstance) (newInstance *Win32_TCPIPPrinterPort, err error) {tmp, err := NewCIM_ServiceAccessPointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TCPIPPrinterPort, err error) {tmp, err := NewCIM_ServiceAccessPointEx6(hostName, wmiNamespace, userName, password, domainName, query)
