...
type Win32_SecuritySettingAuditing struct { 
	*cim.WmiInstance
	...
	func NewWin32_SecuritySettingAuditingEx1(instance *cim.WmiInstance) (newInstance *Win32_SecuritySettingAuditing, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SecuritySettingAuditing, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
