...
type Win32_SIDandAttributes struct { 
	*cim.WmiInstance
	...
	func NewWin32_SIDandAttributesEx1(instance *cim.WmiInstance) (newInstance *Win32_SIDandAttributes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SIDandAttributes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
