...
type MSFT_NetServiceStopControlSuccess struct { 
	*MSFT_SCMEventLogEvent
	...
	func NewMSFT_NetServiceStopControlSuccessEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetServiceStopControlSuccess, err error) {tmp, err := NewMSFT_SCMEventLogEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetServiceStopControlSuccess, err error) {tmp, err := NewMSFT_SCMEventLogEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
