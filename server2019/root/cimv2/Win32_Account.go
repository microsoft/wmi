...
type Win32_Account struct { 
	*CIM_LogicalElement
	...
	func NewWin32_AccountEx1(instance *cim.WmiInstance) (newInstance *Win32_Account, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Account, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
