...
type Win32_BaseService struct { 
	*CIM_Service
	...
	func NewWin32_BaseServiceEx1(instance *cim.WmiInstance) (newInstance *Win32_BaseService, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_BaseService, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_BaseService) PauseService() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("PauseService" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_BaseService) ResumeService() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ResumeService" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_BaseService) InterrogateService() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("InterrogateService" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_BaseService) UserControlService( /* IN */ ControlCode uint8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UserControlService" , ControlCode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_BaseService) Create( /* IN */ Name string,
 ...
 /* IN */ ServiceDependencies []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Create" , Name, DisplayName, PathName, ServiceType, ErrorControl, StartMode, DesktopInteract, StartName, StartPassword, LoadOrderGroup, LoadOrderGroupDependencies, ServiceDependencies);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_BaseService) Change( /* IN */ DisplayName string,
 ...
 /* IN */ LoadOrderGroup string,
 /* IN */ LoadOrderGroupDependencies []string,
 /* IN */ ServiceDependencies []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Change" , DisplayName, PathName, ServiceType, ErrorControl, StartMode, DesktopInteract, StartName, StartPassword, LoadOrderGroup, LoadOrderGroupDependencies, ServiceDependencies);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_BaseService) ChangeStartMode( /* IN */ StartMode string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ChangeStartMode" , StartMode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_BaseService) Delete() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Delete" );
	if err != nil { return }
	result = uint32(retVal)
	return
