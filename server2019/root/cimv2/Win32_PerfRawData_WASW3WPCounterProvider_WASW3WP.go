...
type Win32_PerfRawData_WASW3WPCounterProvider_WASW3WP struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_WASW3WPCounterProvider_WASW3WPEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_WASW3WPCounterProvider_WASW3WP, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_WASW3WPCounterProvider_WASW3WP, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
