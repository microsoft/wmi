...
type Win32_CodecFile struct { 
	*CIM_DataFile
	...
	func NewWin32_CodecFileEx1(instance *cim.WmiInstance) (newInstance *Win32_CodecFile, err error) {tmp, err := NewCIM_DataFileEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CodecFile, err error) {tmp, err := NewCIM_DataFileEx6(hostName, wmiNamespace, userName, password, domainName, query)
