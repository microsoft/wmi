...
type Win32_VolumeChangeEvent struct { 
	*Win32_DeviceChangeEvent
	...
	func NewWin32_VolumeChangeEventEx1(instance *cim.WmiInstance) (newInstance *Win32_VolumeChangeEvent, err error) {tmp, err := NewWin32_DeviceChangeEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_VolumeChangeEvent, err error) {tmp, err := NewWin32_DeviceChangeEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
