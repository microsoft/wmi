...
type CIM_PhysicalMemory struct { 
	*CIM_Chip
	...
	func NewCIM_PhysicalMemoryEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalMemory, err error) {tmp, err := NewCIM_ChipEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalMemory, err error) {tmp, err := NewCIM_ChipEx6(hostName, wmiNamespace, userName, password, domainName, query)
