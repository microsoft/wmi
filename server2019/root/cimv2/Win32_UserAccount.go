...
type Win32_UserAccount struct { 
	*Win32_Account
	...
	func NewWin32_UserAccountEx1(instance *cim.WmiInstance) (newInstance *Win32_UserAccount, err error) {tmp, err := NewWin32_AccountEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_UserAccount, err error) {tmp, err := NewWin32_AccountEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_UserAccount) Rename( /* IN */ Name string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Rename" , Name);
	if err != nil { return }
