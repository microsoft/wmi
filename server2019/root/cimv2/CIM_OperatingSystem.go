...
type CIM_OperatingSystem struct { 
	*CIM_LogicalElement
	...
	func NewCIM_OperatingSystemEx1(instance *cim.WmiInstance) (newInstance *CIM_OperatingSystem, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_OperatingSystem, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_OperatingSystem) Reboot() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Reboot" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_OperatingSystem) Shutdown() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Shutdown" );
	if err != nil { return }
	result = uint32(retVal)
	return
