...
type CIM_ElementCapacity struct { 
	*cim.WmiInstance
	...
	func NewCIM_ElementCapacityEx1(instance *cim.WmiInstance) (newInstance *CIM_ElementCapacity, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ElementCapacity, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
