...
type Win32_MotherboardDevice struct { 
	*CIM_LogicalDevice
	...
	func NewWin32_MotherboardDeviceEx1(instance *cim.WmiInstance) (newInstance *Win32_MotherboardDevice, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_MotherboardDevice, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
