...
type MSFT_WmiCancelNotificationSink struct { 
	*MSFT_WmiEssEvent
	...
	func NewMSFT_WmiCancelNotificationSinkEx1(instance *cim.WmiInstance) (newInstance *MSFT_WmiCancelNotificationSink, err error) {tmp, err := NewMSFT_WmiEssEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WmiCancelNotificationSink, err error) {tmp, err := NewMSFT_WmiEssEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
