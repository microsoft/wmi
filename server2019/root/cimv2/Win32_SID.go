...
type Win32_SID struct { 
	*cim.WmiInstance
	...
	func NewWin32_SIDEx1(instance *cim.WmiInstance) (newInstance *Win32_SID, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SID, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
