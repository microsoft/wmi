...
type CIM_USBHub struct { 
	*CIM_USBDevice
	...
	func NewCIM_USBHubEx1(instance *cim.WmiInstance) (newInstance *CIM_USBHub, err error) {tmp, err := NewCIM_USBDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_USBHub, err error) {tmp, err := NewCIM_USBDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
