...
type Win32_CDROMDrive struct { 
	*CIM_CDROMDrive
	...
	func NewWin32_CDROMDriveEx1(instance *cim.WmiInstance) (newInstance *Win32_CDROMDrive, err error) {tmp, err := NewCIM_CDROMDriveEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CDROMDrive, err error) {tmp, err := NewCIM_CDROMDriveEx6(hostName, wmiNamespace, userName, password, domainName, query)
