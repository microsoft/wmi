...
type Win32_DirectorySpecification struct { 
	*CIM_DirectorySpecification
	...
	func NewWin32_DirectorySpecificationEx1(instance *cim.WmiInstance) (newInstance *Win32_DirectorySpecification, err error) {tmp, err := NewCIM_DirectorySpecificationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DirectorySpecification, err error) {tmp, err := NewCIM_DirectorySpecificationEx6(hostName, wmiNamespace, userName, password, domainName, query)
