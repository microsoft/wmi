...
type CIM_RemoveFileAction struct { 
	*CIM_FileAction
	...
	func NewCIM_RemoveFileActionEx1(instance *cim.WmiInstance) (newInstance *CIM_RemoveFileAction, err error) {tmp, err := NewCIM_FileActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RemoveFileAction, err error) {tmp, err := NewCIM_FileActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
