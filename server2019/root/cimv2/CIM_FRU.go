...
type CIM_FRU struct { 
	*cim.WmiInstance
	...
	func NewCIM_FRUEx1(instance *cim.WmiInstance) (newInstance *CIM_FRU, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_FRU, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
