...
type Win32_NetworkConnection struct { 
	*CIM_LogicalElement
	...
	func NewWin32_NetworkConnectionEx1(instance *cim.WmiInstance) (newInstance *Win32_NetworkConnection, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NetworkConnection, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
