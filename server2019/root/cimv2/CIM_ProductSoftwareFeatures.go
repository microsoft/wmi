...
type CIM_ProductSoftwareFeatures struct { 
	*cim.WmiInstance
	...
	func NewCIM_ProductSoftwareFeaturesEx1(instance *cim.WmiInstance) (newInstance *CIM_ProductSoftwareFeatures, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProductSoftwareFeatures, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
