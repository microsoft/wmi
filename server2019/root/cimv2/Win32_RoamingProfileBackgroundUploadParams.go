...
type Win32_RoamingProfileBackgroundUploadParams struct { 
	*cim.WmiInstance
	...
	func NewWin32_RoamingProfileBackgroundUploadParamsEx1(instance *cim.WmiInstance) (newInstance *Win32_RoamingProfileBackgroundUploadParams, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RoamingProfileBackgroundUploadParams, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
