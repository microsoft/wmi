...
type Win32_NamedJobObject struct { 
	*CIM_CollectionOfMSEs
	...
	func NewWin32_NamedJobObjectEx1(instance *cim.WmiInstance) (newInstance *Win32_NamedJobObject, err error) {tmp, err := NewCIM_CollectionOfMSEsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NamedJobObject, err error) {tmp, err := NewCIM_CollectionOfMSEsEx6(hostName, wmiNamespace, userName, password, domainName, query)
