...
type MSFT_WmiConsumerProviderSinkLoaded struct { 
	*MSFT_WmiConsumerProviderEvent
	...
	func NewMSFT_WmiConsumerProviderSinkLoadedEx1(instance *cim.WmiInstance) (newInstance *MSFT_WmiConsumerProviderSinkLoaded, err error) {tmp, err := NewMSFT_WmiConsumerProviderEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WmiConsumerProviderSinkLoaded, err error) {tmp, err := NewMSFT_WmiConsumerProviderEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
