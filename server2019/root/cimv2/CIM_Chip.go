...
type CIM_Chip struct { 
	*CIM_PhysicalComponent
	...
	func NewCIM_ChipEx1(instance *cim.WmiInstance) (newInstance *CIM_Chip, err error) {tmp, err := NewCIM_PhysicalComponentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Chip, err error) {tmp, err := NewCIM_PhysicalComponentEx6(hostName, wmiNamespace, userName, password, domainName, query)
