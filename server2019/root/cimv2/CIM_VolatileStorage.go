...
type CIM_VolatileStorage struct { 
	*CIM_Memory
	...
	func NewCIM_VolatileStorageEx1(instance *cim.WmiInstance) (newInstance *CIM_VolatileStorage, err error) {tmp, err := NewCIM_MemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VolatileStorage, err error) {tmp, err := NewCIM_MemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
