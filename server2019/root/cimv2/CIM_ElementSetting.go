...
type CIM_ElementSetting struct { 
	*cim.WmiInstance
	...
	func NewCIM_ElementSettingEx1(instance *cim.WmiInstance) (newInstance *CIM_ElementSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ElementSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
