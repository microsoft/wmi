...
type CIM_ToDirectoryAction struct { 
	*cim.WmiInstance
	...
	func NewCIM_ToDirectoryActionEx1(instance *cim.WmiInstance) (newInstance *CIM_ToDirectoryAction, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ToDirectoryAction, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
