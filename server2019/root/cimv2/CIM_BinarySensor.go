...
type CIM_BinarySensor struct { 
	*CIM_Sensor
	...
	func NewCIM_BinarySensorEx1(instance *cim.WmiInstance) (newInstance *CIM_BinarySensor, err error) {tmp, err := NewCIM_SensorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_BinarySensor, err error) {tmp, err := NewCIM_SensorEx6(hostName, wmiNamespace, userName, password, domainName, query)
