...
type Win32_DesktopMonitor struct { 
	*CIM_DesktopMonitor
	...
	func NewWin32_DesktopMonitorEx1(instance *cim.WmiInstance) (newInstance *Win32_DesktopMonitor, err error) {tmp, err := NewCIM_DesktopMonitorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DesktopMonitor, err error) {tmp, err := NewCIM_DesktopMonitorEx6(hostName, wmiNamespace, userName, password, domainName, query)
