...
type MSFT_WmiConsumerProviderSinkUnloaded struct { 
	*MSFT_WmiConsumerProviderEvent
	...
	func NewMSFT_WmiConsumerProviderSinkUnloadedEx1(instance *cim.WmiInstance) (newInstance *MSFT_WmiConsumerProviderSinkUnloaded, err error) {tmp, err := NewMSFT_WmiConsumerProviderEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WmiConsumerProviderSinkUnloaded, err error) {tmp, err := NewMSFT_WmiConsumerProviderEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
