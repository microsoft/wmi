...
type Win32_PnPEntity struct { 
	*CIM_LogicalDevice
	...
	func NewWin32_PnPEntityEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPEntity, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPEntity, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PnPEntity) Enable( /* OUT */ rebootNeeded bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" )
	if err != nil { return }
...
// <param name="rebootNeeded" type="bool "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_PnPEntity) Disable( /* OUT */ rebootNeeded bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Win32_PnPEntity) GetDeviceProperties( /* OPTIONAL IN */ devicePropertyKeys []string,
 /* OUT */ deviceProperties []Win32_PnPDeviceProperty) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetDeviceProperties" , devicePropertyKeys)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
