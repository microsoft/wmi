...
type Win32_PerfRawData_Counters_IPsecIKEv2IPv4 struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_Counters_IPsecIKEv2IPv4Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_IPsecIKEv2IPv4, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_Counters_IPsecIKEv2IPv4 {
	...
	func NewWin32_PerfRawData_Counters_IPsecIKEv2IPv4Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Counters_IPsecIKEv2IPv4, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
