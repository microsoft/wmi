...
func NewWin32_POTSModemToSerialPortEx1(instance *cim.WmiInstance) (newInstance *Win32_POTSModemToSerialPort, err error) {
...
func NewWin32_POTSModemToSerialPortEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_POTSModemToSerialPort, err error) {
