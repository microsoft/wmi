...
type Win32_DisplayControllerConfiguration struct { 
	*CIM_Setting
	...
	func NewWin32_DisplayControllerConfigurationEx1(instance *cim.WmiInstance) (newInstance *Win32_DisplayControllerConfiguration, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DisplayControllerConfiguration, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
