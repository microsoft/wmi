...
type Win32_NTDomain struct { 
	*CIM_System
	...
	func NewWin32_NTDomainEx1(instance *cim.WmiInstance) (newInstance *Win32_NTDomain, err error) {tmp, err := NewCIM_SystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NTDomain, err error) {tmp, err := NewCIM_SystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
