...
type CIM_NFS struct { 
	*CIM_RemoteFileSystem
	...
	func NewCIM_NFSEx1(instance *cim.WmiInstance) (newInstance *CIM_NFS, err error) {tmp, err := NewCIM_RemoteFileSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_NFS, err error) {tmp, err := NewCIM_RemoteFileSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
