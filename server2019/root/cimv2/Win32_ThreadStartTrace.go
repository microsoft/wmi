...
type Win32_ThreadStartTrace struct { 
	*Win32_ThreadTrace
	...
	func NewWin32_ThreadStartTraceEx1(instance *cim.WmiInstance) (newInstance *Win32_ThreadStartTrace, err error) {tmp, err := NewWin32_ThreadTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ThreadStartTrace, err error) {tmp, err := NewWin32_ThreadTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
