...
type CIM_ProductFRU struct { 
	*cim.WmiInstance
	...
	func NewCIM_ProductFRUEx1(instance *cim.WmiInstance) (newInstance *CIM_ProductFRU, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProductFRU, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
