...
type Win32_MoveFileAction struct { 
	*CIM_FileAction
	...
	func NewWin32_MoveFileActionEx1(instance *cim.WmiInstance) (newInstance *Win32_MoveFileAction, err error) {tmp, err := NewCIM_FileActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_MoveFileAction, err error) {tmp, err := NewCIM_FileActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
