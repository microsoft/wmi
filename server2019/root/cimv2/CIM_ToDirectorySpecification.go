...
type CIM_ToDirectorySpecification struct { 
	*cim.WmiInstance
	...
	func NewCIM_ToDirectorySpecificationEx1(instance *cim.WmiInstance) (newInstance *CIM_ToDirectorySpecification, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ToDirectorySpecification, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
