...
// Win32_PerfRawData_Tcpip_ICMP struct
type Win32_PerfRawData_Tcpip_ICMP struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_Tcpip_ICMPEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Tcpip_ICMP, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_Tcpip_ICMP {
	...
	func NewWin32_PerfRawData_Tcpip_ICMPEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Tcpip_ICMP, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyMessagesOutboundErrors(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyMessagesOutboundErrors()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyMessagesPersec(value uint32) (err error) { 
    return instance.SetProperty("MessagesPersec", (value))
}

// GetMessagesPersec gets the value of MessagesPersec for the instance
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyMessagesPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyMessagesReceivedErrors(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyMessagesReceivedErrors()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyMessagesReceivedPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyMessagesReceivedPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyMessagesSentPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyMessagesSentPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedAddressMask(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedAddressMask()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedAddressMaskReply(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedAddressMaskReply()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedDestUnreachable(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedDestUnreachable()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedEchoPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedEchoPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedEchoReplyPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedEchoReplyPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedParameterProblem(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedParameterProblem()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedRedirectPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedRedirectPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedSourceQuench(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedSourceQuench()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedTimeExceeded(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedTimeExceeded()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedTimestampPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedTimestampPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertyReceivedTimestampReplyPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertyReceivedTimestampReplyPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentAddressMask(value uint32) (err error) { 
    return instance.SetProperty("SentAddressMask", (value))
}

// GetSentAddressMask gets the value of SentAddressMask for the instance
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentAddressMask()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentAddressMaskReply(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentAddressMaskReply()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentDestinationUnreachable(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentDestinationUnreachable()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentEchoPersec(value uint32) (err error) { 
    return instance.SetProperty("SentEchoPersec", (value))
}

// GetSentEchoPersec gets the value of SentEchoPersec for the instance
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentEchoPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentEchoReplyPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentEchoReplyPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentParameterProblem(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentParameterProblem()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentRedirectPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentRedirectPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentSourceQuench(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentSourceQuench()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentTimeExceeded(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentTimeExceeded()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentTimestampPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentTimestampPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) SetPropertySentTimestampReplyPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Tcpip_ICMP) GetPropertySentTimestampReplyPersec()(value uint32, err error) { 
