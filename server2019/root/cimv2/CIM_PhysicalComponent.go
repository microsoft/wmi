...
type CIM_PhysicalComponent struct { 
	*CIM_PhysicalElement
	...
	func NewCIM_PhysicalComponentEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalComponent, err error) {tmp, err := NewCIM_PhysicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalComponent, err error) {tmp, err := NewCIM_PhysicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
