...
type Win32_PrinterDriver struct { 
	*CIM_Service
	...
	func NewWin32_PrinterDriverEx1(instance *cim.WmiInstance) (newInstance *Win32_PrinterDriver, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PrinterDriver, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PrinterDriver) AddPrinterDriver( /* IN */ DriverInfo Win32_PrinterDriver) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddPrinterDriver" , DriverInfo);
	if err != nil { return }
