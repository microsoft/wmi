...
type CIM_Check struct { 
	*cim.WmiInstance
	...
	func NewCIM_CheckEx1(instance *cim.WmiInstance) (newInstance *CIM_Check, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Check, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_Check) Invoke() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Invoke" );
	if err != nil { return }
