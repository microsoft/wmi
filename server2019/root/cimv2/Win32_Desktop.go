...
type Win32_Desktop struct { 
	*CIM_Setting
	...
	func NewWin32_DesktopEx1(instance *cim.WmiInstance) (newInstance *Win32_Desktop, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Desktop, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
