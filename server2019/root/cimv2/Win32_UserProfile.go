...
type Win32_UserProfile struct { 
	*cim.WmiInstance
	...
	func NewWin32_UserProfileEx1(instance *cim.WmiInstance) (newInstance *Win32_UserProfile, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_UserProfile, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_UserProfile) ChangeOwner( /* IN */ NewOwnerSID string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ChangeOwner" , NewOwnerSID, Flags);
	if err != nil { return }
