...
type SoftwareLicensingTokenActivationLicense struct { 
	*cim.WmiInstance
	...
	func NewSoftwareLicensingTokenActivationLicenseEx1(instance *cim.WmiInstance) (newInstance *SoftwareLicensingTokenActivationLicense, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SoftwareLicensingTokenActivationLicense, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SoftwareLicensingTokenActivationLicense) Uninstall() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Uninstall" );
	if err != nil { return }
