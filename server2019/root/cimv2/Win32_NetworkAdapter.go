...
type Win32_NetworkAdapter struct { 
	*CIM_NetworkAdapter
	...
	func NewWin32_NetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *Win32_NetworkAdapter, err error) {tmp, err := NewCIM_NetworkAdapterEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NetworkAdapter, err error) {tmp, err := NewCIM_NetworkAdapterEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_NetworkAdapter) Enable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Enable" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_NetworkAdapter) Disable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Disable" );
	if err != nil { return }
	result = uint32(retVal)
	return
