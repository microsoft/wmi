...
type CIM_FRUPhysicalElements struct { 
	*cim.WmiInstance
	...
	func NewCIM_FRUPhysicalElementsEx1(instance *cim.WmiInstance) (newInstance *CIM_FRUPhysicalElements, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_FRUPhysicalElements, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
