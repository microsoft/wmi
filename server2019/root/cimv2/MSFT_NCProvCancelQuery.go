...
type MSFT_NCProvCancelQuery struct { 
	*MSFT_NCProvEvent
	...
	func NewMSFT_NCProvCancelQueryEx1(instance *cim.WmiInstance) (newInstance *MSFT_NCProvCancelQuery, err error) {tmp, err := NewMSFT_NCProvEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NCProvCancelQuery, err error) {tmp, err := NewMSFT_NCProvEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
