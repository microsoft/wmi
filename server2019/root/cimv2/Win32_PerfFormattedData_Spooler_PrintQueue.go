...
func NewWin32_PerfFormattedData_Spooler_PrintQueueEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Spooler_PrintQueue, err error) {
	tmp, err := NewWin32_PerfFormattedDataEx1(instance)

	if err != nil {
		return
	}
	newInstance = &Win32_PerfFormattedData_Spooler_PrintQueue{
		Win32_PerfFormattedData: tmp,
	}
	return
}

func NewWin32_PerfFormattedData_Spooler_PrintQueueEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Spooler_PrintQueue, err error) {
