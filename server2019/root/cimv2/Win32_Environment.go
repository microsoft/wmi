...
type Win32_Environment struct { 
	*CIM_SystemResource
	...
	func NewWin32_EnvironmentEx1(instance *cim.WmiInstance) (newInstance *Win32_Environment, err error) {tmp, err := NewCIM_SystemResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Environment, err error) {tmp, err := NewCIM_SystemResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
