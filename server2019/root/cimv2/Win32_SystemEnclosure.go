...
type Win32_SystemEnclosure struct { 
	*CIM_Chassis
	...
	func NewWin32_SystemEnclosureEx1(instance *cim.WmiInstance) (newInstance *Win32_SystemEnclosure, err error) {tmp, err := NewCIM_ChassisEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SystemEnclosure, err error) {tmp, err := NewCIM_ChassisEx6(hostName, wmiNamespace, userName, password, domainName, query)
