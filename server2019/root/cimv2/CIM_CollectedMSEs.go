...
type CIM_CollectedMSEs struct { 
	*cim.WmiInstance
	...
	func NewCIM_CollectedMSEsEx1(instance *cim.WmiInstance) (newInstance *CIM_CollectedMSEs, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CollectedMSEs, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
