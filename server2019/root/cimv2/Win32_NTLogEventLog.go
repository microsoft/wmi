...
type Win32_NTLogEventLog struct { 
	*cim.WmiInstance
	...
	func NewWin32_NTLogEventLogEx1(instance *cim.WmiInstance) (newInstance *Win32_NTLogEventLog, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NTLogEventLog, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
