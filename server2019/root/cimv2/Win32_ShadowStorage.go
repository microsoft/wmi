...
type Win32_ShadowStorage struct { 
	*cim.WmiInstance
	...
	func NewWin32_ShadowStorageEx1(instance *cim.WmiInstance) (newInstance *Win32_ShadowStorage, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ShadowStorage, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_ShadowStorage) Create( /* IN */ Volume string,
 ...
 /* IN */ MaxSpace uint64) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Create" , Volume, DiffVolume, MaxSpace);
	if err != nil { return }
