...
type Win32_ShortcutAction struct { 
	*CIM_Action
	...
	func NewWin32_ShortcutActionEx1(instance *cim.WmiInstance) (newInstance *Win32_ShortcutAction, err error) {tmp, err := NewCIM_ActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ShortcutAction, err error) {tmp, err := NewCIM_ActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
