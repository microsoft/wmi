...
type Win32_MountPoint struct { 
	*cim.WmiInstance
	...
	func NewWin32_MountPointEx1(instance *cim.WmiInstance) (newInstance *Win32_MountPoint, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_MountPoint, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
