...
type Win32_IP4RouteTable struct { 
	*CIM_LogicalElement
	...
	func NewWin32_IP4RouteTableEx1(instance *cim.WmiInstance) (newInstance *Win32_IP4RouteTable, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_IP4RouteTable, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
