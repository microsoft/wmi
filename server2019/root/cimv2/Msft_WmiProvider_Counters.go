...
type Msft_WmiProvider_Counters struct { 
	*cim.WmiInstance
	...
	func NewMsft_WmiProvider_CountersEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_Counters, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_WmiProvider_Counters, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
