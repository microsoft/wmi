...
type CIM_VolumeSet struct { 
	*CIM_StorageExtent
	...
	func NewCIM_VolumeSetEx1(instance *cim.WmiInstance) (newInstance *CIM_VolumeSet, err error) {tmp, err := NewCIM_StorageExtentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VolumeSet, err error) {tmp, err := NewCIM_StorageExtentEx6(hostName, wmiNamespace, userName, password, domainName, query)
