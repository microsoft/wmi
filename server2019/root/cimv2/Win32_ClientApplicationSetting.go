...
type Win32_ClientApplicationSetting struct { 
	*cim.WmiInstance
	...
	func NewWin32_ClientApplicationSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_ClientApplicationSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ClientApplicationSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
