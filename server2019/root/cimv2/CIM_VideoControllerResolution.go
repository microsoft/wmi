...
type CIM_VideoControllerResolution struct { 
	*CIM_Setting
	...
	func NewCIM_VideoControllerResolutionEx1(instance *cim.WmiInstance) (newInstance *CIM_VideoControllerResolution, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VideoControllerResolution, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
