...
type ScriptingStandardConsumerSetting struct { 
	*CIM_Setting
	...
	func NewScriptingStandardConsumerSettingEx1(instance *cim.WmiInstance) (newInstance *ScriptingStandardConsumerSetting, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ScriptingStandardConsumerSetting, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
