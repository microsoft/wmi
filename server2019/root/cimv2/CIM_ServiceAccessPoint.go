...
type CIM_ServiceAccessPoint struct { 
	*CIM_LogicalElement
	...
	func NewCIM_ServiceAccessPointEx1(instance *cim.WmiInstance) (newInstance *CIM_ServiceAccessPoint, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ServiceAccessPoint, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
