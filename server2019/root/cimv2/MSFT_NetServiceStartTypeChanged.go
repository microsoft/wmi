...
type MSFT_NetServiceStartTypeChanged struct { 
	*MSFT_SCMEventLogEvent
	...
	func NewMSFT_NetServiceStartTypeChangedEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetServiceStartTypeChanged, err error) {tmp, err := NewMSFT_SCMEventLogEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetServiceStartTypeChanged, err error) {tmp, err := NewMSFT_SCMEventLogEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
