...
type Win32_BIOS struct { 
	*CIM_BIOSElement
	...
	func NewWin32_BIOSEx1(instance *cim.WmiInstance) (newInstance *Win32_BIOS, err error) {tmp, err := NewCIM_BIOSElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_BIOS, err error) {tmp, err := NewCIM_BIOSElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
