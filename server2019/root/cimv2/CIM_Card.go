...
type CIM_Card struct { 
	*CIM_PhysicalPackage
	...
	func NewCIM_CardEx1(instance *cim.WmiInstance) (newInstance *CIM_Card, err error) {tmp, err := NewCIM_PhysicalPackageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Card, err error) {tmp, err := NewCIM_PhysicalPackageEx6(hostName, wmiNamespace, userName, password, domainName, query)
