...
type CIM_CollectionSetting struct { 
	*cim.WmiInstance
	...
	func NewCIM_CollectionSettingEx1(instance *cim.WmiInstance) (newInstance *CIM_CollectionSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CollectionSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
