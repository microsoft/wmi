...
type Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVMEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM {
	...
	func NewWin32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVMEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyAddedMemory()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyAveragePressure()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyGuestVisiblePhysicalMemory()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyMaximumPressure()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyMemoryAddOperations()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyMemoryRemoveOperations()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyMinimumPressure()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyPhysicalMemory()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertyRemovedMemory()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_BalancerStats_HyperVDynamicMemoryVM) GetPropertySmartPagingWorkingSetSize()(value uint32, err error) { 
