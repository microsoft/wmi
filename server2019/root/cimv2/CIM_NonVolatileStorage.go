...
type CIM_NonVolatileStorage struct { 
	*CIM_Memory
	...
	func NewCIM_NonVolatileStorageEx1(instance *cim.WmiInstance) (newInstance *CIM_NonVolatileStorage, err error) {tmp, err := NewCIM_MemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_NonVolatileStorage, err error) {tmp, err := NewCIM_MemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
