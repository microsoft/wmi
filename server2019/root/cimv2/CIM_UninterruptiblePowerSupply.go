...
type CIM_UninterruptiblePowerSupply struct { 
	*CIM_PowerSupply
	...
	func NewCIM_UninterruptiblePowerSupplyEx1(instance *cim.WmiInstance) (newInstance *CIM_UninterruptiblePowerSupply, err error) {tmp, err := NewCIM_PowerSupplyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_UninterruptiblePowerSupply, err error) {tmp, err := NewCIM_PowerSupplyEx6(hostName, wmiNamespace, userName, password, domainName, query)
