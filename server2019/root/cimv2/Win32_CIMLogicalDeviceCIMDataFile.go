...
type Win32_CIMLogicalDeviceCIMDataFile struct { 
	*CIM_Dependency
	...
	func NewWin32_CIMLogicalDeviceCIMDataFileEx1(instance *cim.WmiInstance) (newInstance *Win32_CIMLogicalDeviceCIMDataFile, err error) {tmp, err := NewCIM_DependencyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CIMLogicalDeviceCIMDataFile, err error) {tmp, err := NewCIM_DependencyEx6(hostName, wmiNamespace, userName, password, domainName, query)
