...
type Win32_PhysicalMemoryArray struct { 
	*CIM_PhysicalPackage
	...
	func NewWin32_PhysicalMemoryArrayEx1(instance *cim.WmiInstance) (newInstance *Win32_PhysicalMemoryArray, err error) {tmp, err := NewCIM_PhysicalPackageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PhysicalMemoryArray, err error) {tmp, err := NewCIM_PhysicalPackageEx6(hostName, wmiNamespace, userName, password, domainName, query)
