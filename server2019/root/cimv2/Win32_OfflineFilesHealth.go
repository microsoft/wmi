...
type Win32_OfflineFilesHealth struct { 
	*cim.WmiInstance
	...
	func NewWin32_OfflineFilesHealthEx1(instance *cim.WmiInstance) (newInstance *Win32_OfflineFilesHealth, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_OfflineFilesHealth, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
