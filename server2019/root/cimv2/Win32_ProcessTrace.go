...
type Win32_ProcessTrace struct { 
	*Win32_SystemTrace
	...
	func NewWin32_ProcessTraceEx1(instance *cim.WmiInstance) (newInstance *Win32_ProcessTrace, err error) {tmp, err := NewWin32_SystemTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ProcessTrace, err error) {tmp, err := NewWin32_SystemTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
