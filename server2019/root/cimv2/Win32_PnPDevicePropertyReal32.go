...
type Win32_PnPDevicePropertyReal32 struct { 
	*Win32_PnPDeviceProperty
	...
	func NewWin32_PnPDevicePropertyReal32Ex1(instance *cim.WmiInstance) (newInstance *Win32_PnPDevicePropertyReal32, err error) {tmp, err := NewWin32_PnPDevicePropertyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDevicePropertyReal32, err error) {tmp, err := NewWin32_PnPDevicePropertyEx6(hostName, wmiNamespace, userName, password, domainName, query)
