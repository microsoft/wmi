...
type MSFT_NCProvClientConnected struct { 
	*MSFT_NCProvEvent
	...
	func NewMSFT_NCProvClientConnectedEx1(instance *cim.WmiInstance) (newInstance *MSFT_NCProvClientConnected, err error) {tmp, err := NewMSFT_NCProvEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NCProvClientConnected, err error) {tmp, err := NewMSFT_NCProvEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
