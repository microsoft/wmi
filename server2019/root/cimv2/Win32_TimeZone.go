...
type Win32_TimeZone struct { 
	*CIM_Setting
	...
	func NewWin32_TimeZoneEx1(instance *cim.WmiInstance) (newInstance *Win32_TimeZone, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TimeZone, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
