...
type Win32_PortConnector struct { 
	*CIM_PhysicalConnector
	...
	func NewWin32_PortConnectorEx1(instance *cim.WmiInstance) (newInstance *Win32_PortConnector, err error) {tmp, err := NewCIM_PhysicalConnectorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PortConnector, err error) {tmp, err := NewCIM_PhysicalConnectorEx6(hostName, wmiNamespace, userName, password, domainName, query)
