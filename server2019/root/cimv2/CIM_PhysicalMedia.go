...
type CIM_PhysicalMedia struct { 
	*CIM_PhysicalComponent
	...
	func NewCIM_PhysicalMediaEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalMedia, err error) {tmp, err := NewCIM_PhysicalComponentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalMedia, err error) {tmp, err := NewCIM_PhysicalComponentEx6(hostName, wmiNamespace, userName, password, domainName, query)
