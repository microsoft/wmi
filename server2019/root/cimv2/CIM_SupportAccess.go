...
type CIM_SupportAccess struct { 
	*cim.WmiInstance
	...
	func NewCIM_SupportAccessEx1(instance *cim.WmiInstance) (newInstance *CIM_SupportAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SupportAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
