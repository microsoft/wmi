...
type CIM_RemoveDirectoryAction struct { 
	*CIM_DirectoryAction
	...
	func NewCIM_RemoveDirectoryActionEx1(instance *cim.WmiInstance) (newInstance *CIM_RemoveDirectoryAction, err error) {tmp, err := NewCIM_DirectoryActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RemoveDirectoryAction, err error) {tmp, err := NewCIM_DirectoryActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
