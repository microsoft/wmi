...
func (instance *Win32_PerfFormattedData_HvStats_HyperVHypervisorLogicalProcessor) SetPropertyHWPRequestMSRContextSwitchesPersec(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_HvStats_HyperVHypervisorLogicalProcessor) GetPropertyHWPRequestMSRContextSwitchesPersec() (value uint64, err error) {
