...
type Win32_FolderRedirectionHealth struct { 
	*cim.WmiInstance
	...
	func NewWin32_FolderRedirectionHealthEx1(instance *cim.WmiInstance) (newInstance *Win32_FolderRedirectionHealth, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_FolderRedirectionHealth, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
