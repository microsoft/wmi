...
type Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_Counters_SecuritySystemWideStatisticsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics {
	...
	func NewWin32_PerfFormattedData_Counters_SecuritySystemWideStatisticsEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyActiveSchannelSessionCacheEntries(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyActiveSchannelSessionCacheEntries()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyDigestAuthentications(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyDigestAuthentications()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyForwardedKerberosRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyForwardedKerberosRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCarmoredASRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCarmoredASRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCarmoredTGSRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCarmoredTGSRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCASRequests(value uint32) (err error) { 
    return instance.SetProperty("KDCASRequests", (value))
}

// GetKDCASRequests gets the value of KDCASRequests for the instance
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCASRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCclaimsawareASRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCclaimsawareASRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCclaimsawareserviceassertedidentityTGSrequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCclaimsawareserviceassertedidentityTGSrequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCclaimsawareTGSRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCclaimsawareTGSRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCclassictypeconstraineddelegationTGSRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCclassictypeconstraineddelegationTGSRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCkeytrustASRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCkeytrustASRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCresourcetypeconstraineddelegationTGSRequests(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCresourcetypeconstraineddelegationTGSRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKDCTGSRequests(value uint32) (err error) { 
    return instance.SetProperty("KDCTGSRequests", (value))
}

// GetKDCTGSRequests gets the value of KDCTGSRequests for the instance
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKDCTGSRequests()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyKerberosAuthentications(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyKerberosAuthentications()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertyNTLMAuthentications(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertyNTLMAuthentications()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertySchannelSessionCacheEntries(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertySchannelSessionCacheEntries()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertySSLClientSideFullHandshakes(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertySSLClientSideFullHandshakes()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertySSLClientSideReconnectHandshakes(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertySSLClientSideReconnectHandshakes()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertySSLServerSideFullHandshakes(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertySSLServerSideFullHandshakes()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) SetPropertySSLServerSideReconnectHandshakes(value uint32) (err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_SecuritySystemWideStatistics) GetPropertySSLServerSideReconnectHandshakes()(value uint32, err error) { 
