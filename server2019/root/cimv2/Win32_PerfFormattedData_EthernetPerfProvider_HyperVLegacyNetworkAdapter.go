...
type Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter {
	...
	func NewWin32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapterEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
