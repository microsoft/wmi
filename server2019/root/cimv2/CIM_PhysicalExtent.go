...
type CIM_PhysicalExtent struct { 
	*CIM_StorageExtent
	...
	func NewCIM_PhysicalExtentEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalExtent, err error) {tmp, err := NewCIM_StorageExtentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalExtent, err error) {tmp, err := NewCIM_StorageExtentEx6(hostName, wmiNamespace, userName, password, domainName, query)
