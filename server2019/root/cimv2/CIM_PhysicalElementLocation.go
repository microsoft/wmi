...
type CIM_PhysicalElementLocation struct { 
	*cim.WmiInstance
	...
	func NewCIM_PhysicalElementLocationEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalElementLocation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalElementLocation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
