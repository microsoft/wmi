...
type NTEventlogProviderConfig struct { 
	*cim.WmiInstance
	...
	func NewNTEventlogProviderConfigEx1(instance *cim.WmiInstance) (newInstance *NTEventlogProviderConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NTEventlogProviderConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
