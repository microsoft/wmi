...
// Win32_PerfFormattedData_OfflineFiles_ClientSideCaching struct
...
func NewWin32_PerfFormattedData_OfflineFiles_ClientSideCachingEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching, err error) {
	tmp, err := NewWin32_PerfFormattedDataEx1(instance)

	if err != nil {
		return
	}
	newInstance = &Win32_PerfFormattedData_OfflineFiles_ClientSideCaching{
		Win32_PerfFormattedData: tmp,
	}
	return
}

func NewWin32_PerfFormattedData_OfflineFiles_ClientSideCachingEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertyApplicationBytesReadFromCache(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertyApplicationBytesReadFromCache() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertyApplicationBytesReadFromServer(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertyApplicationBytesReadFromServer() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertyApplicationBytesReadFromServerNotCached(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertyApplicationBytesReadFromServerNotCached() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertyPrefetchBytesReadFromCache(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertyPrefetchBytesReadFromCache() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertyPrefetchBytesReadFromServer(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertyPrefetchBytesReadFromServer() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertyPrefetchOperationsQueued(value uint32) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertyPrefetchOperationsQueued() (value uint32, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertySMBBranchCacheBytesPublished(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertySMBBranchCacheBytesPublished() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertySMBBranchCacheBytesReceived(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertySMBBranchCacheBytesReceived() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertySMBBranchCacheBytesRequested(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertySMBBranchCacheBytesRequested() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertySMBBranchCacheBytesRequestedFromServer(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertySMBBranchCacheBytesRequestedFromServer() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertySMBBranchCacheHashBytesReceived(value uint64) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertySMBBranchCacheHashBytesReceived() (value uint64, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertySMBBranchCacheHashesReceived(value uint32) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertySMBBranchCacheHashesReceived() (value uint32, err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) SetPropertySMBBranchCacheHashesRequested(value uint32) (err error) {
...
func (instance *Win32_PerfFormattedData_OfflineFiles_ClientSideCaching) GetPropertySMBBranchCacheHashesRequested() (value uint32, err error) {
