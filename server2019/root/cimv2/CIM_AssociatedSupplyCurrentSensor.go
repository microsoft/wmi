...
type CIM_AssociatedSupplyCurrentSensor struct { 
	*CIM_AssociatedSensor
	...
	func NewCIM_AssociatedSupplyCurrentSensorEx1(instance *cim.WmiInstance) (newInstance *CIM_AssociatedSupplyCurrentSensor, err error) {tmp, err := NewCIM_AssociatedSensorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AssociatedSupplyCurrentSensor, err error) {tmp, err := NewCIM_AssociatedSensorEx6(hostName, wmiNamespace, userName, password, domainName, query)
