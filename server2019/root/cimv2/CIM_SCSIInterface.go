...
type CIM_SCSIInterface struct { 
	*CIM_ControlledBy
	...
	func NewCIM_SCSIInterfaceEx1(instance *cim.WmiInstance) (newInstance *CIM_SCSIInterface, err error) {tmp, err := NewCIM_ControlledByEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SCSIInterface, err error) {tmp, err := NewCIM_ControlledByEx6(hostName, wmiNamespace, userName, password, domainName, query)
