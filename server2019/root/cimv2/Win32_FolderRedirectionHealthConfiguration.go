...
type Win32_FolderRedirectionHealthConfiguration struct { 
	*cim.WmiInstance
	...
	func NewWin32_FolderRedirectionHealthConfigurationEx1(instance *cim.WmiInstance) (newInstance *Win32_FolderRedirectionHealthConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_FolderRedirectionHealthConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
