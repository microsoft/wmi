...
type Win32_PerfRawData_MdvFilterPerfProvider_CascadesMetaDataVolume struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_MdvFilterPerfProvider_CascadesMetaDataVolumeEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_MdvFilterPerfProvider_CascadesMetaDataVolume, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_MdvFilterPerfProvider_CascadesMetaDataVolume, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
