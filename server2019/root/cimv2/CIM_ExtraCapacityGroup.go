...
type CIM_ExtraCapacityGroup struct { 
	*CIM_RedundancyGroup
	...
	func NewCIM_ExtraCapacityGroupEx1(instance *cim.WmiInstance) (newInstance *CIM_ExtraCapacityGroup, err error) {tmp, err := NewCIM_RedundancyGroupEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ExtraCapacityGroup, err error) {tmp, err := NewCIM_RedundancyGroupEx6(hostName, wmiNamespace, userName, password, domainName, query)
