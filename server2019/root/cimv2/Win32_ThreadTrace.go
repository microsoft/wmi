...
type Win32_ThreadTrace struct { 
	*Win32_SystemTrace
	...
	func NewWin32_ThreadTraceEx1(instance *cim.WmiInstance) (newInstance *Win32_ThreadTrace, err error) {tmp, err := NewWin32_SystemTraceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ThreadTrace, err error) {tmp, err := NewWin32_SystemTraceEx6(hostName, wmiNamespace, userName, password, domainName, query)
