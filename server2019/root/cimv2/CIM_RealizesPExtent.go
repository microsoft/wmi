...
type CIM_RealizesPExtent struct { 
	*CIM_Realizes
	...
	func NewCIM_RealizesPExtentEx1(instance *cim.WmiInstance) (newInstance *CIM_RealizesPExtent, err error) {tmp, err := NewCIM_RealizesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RealizesPExtent, err error) {tmp, err := NewCIM_RealizesEx6(hostName, wmiNamespace, userName, password, domainName, query)
