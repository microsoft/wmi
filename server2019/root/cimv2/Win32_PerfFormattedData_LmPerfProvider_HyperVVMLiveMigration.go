...
func NewWin32_PerfFormattedData_LmPerfProvider_HyperVVMLiveMigrationEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_LmPerfProvider_HyperVVMLiveMigration, err error) {
...
func NewWin32_PerfFormattedData_LmPerfProvider_HyperVVMLiveMigrationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_LmPerfProvider_HyperVVMLiveMigration, err error) {
