...
type CIM_PhysicalLink struct { 
	*CIM_PhysicalElement
	...
	func NewCIM_PhysicalLinkEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalLink, err error) {tmp, err := NewCIM_PhysicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalLink, err error) {tmp, err := NewCIM_PhysicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
