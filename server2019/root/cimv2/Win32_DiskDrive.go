...
type Win32_DiskDrive struct { 
	*CIM_DiskDrive
	...
	func NewWin32_DiskDriveEx1(instance *cim.WmiInstance) (newInstance *Win32_DiskDrive, err error) {tmp, err := NewCIM_DiskDriveEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DiskDrive, err error) {tmp, err := NewCIM_DiskDriveEx6(hostName, wmiNamespace, userName, password, domainName, query)
