...
type Win32_PerfRawData_MSDTCBridge4000_MSDTCBridge4000 struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_MSDTCBridge4000_MSDTCBridge4000Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_MSDTCBridge4000_MSDTCBridge4000, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_MSDTCBridge4000_MSDTCBridge4000, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
