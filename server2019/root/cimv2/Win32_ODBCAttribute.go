...
type Win32_ODBCAttribute struct { 
	*CIM_Setting
	...
	func NewWin32_ODBCAttributeEx1(instance *cim.WmiInstance) (newInstance *Win32_ODBCAttribute, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ODBCAttribute, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
