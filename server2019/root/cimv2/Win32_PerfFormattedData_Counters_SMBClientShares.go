...
type Win32_PerfFormattedData_Counters_SMBClientShares struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_Counters_SMBClientSharesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_SMBClientShares, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	func NewWin32_PerfFormattedData_Counters_SMBClientSharesEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_Counters_SMBClientShares, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
