...
type Win32_LogicalDisk struct { 
	*CIM_LogicalDisk
	...
	func NewWin32_LogicalDiskEx1(instance *cim.WmiInstance) (newInstance *Win32_LogicalDisk, err error) {tmp, err := NewCIM_LogicalDiskEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_LogicalDisk, err error) {tmp, err := NewCIM_LogicalDiskEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_LogicalDisk) ScheduleAutoChk( /* IN */ LogicalDisk []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ScheduleAutoChk" , LogicalDisk);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_LogicalDisk) ExcludeFromAutochk( /* IN */ LogicalDisk []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ExcludeFromAutochk" , LogicalDisk);
	if err != nil { return }
	result = uint32(retVal)
	return
