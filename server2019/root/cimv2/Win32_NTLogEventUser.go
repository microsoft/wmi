...
type Win32_NTLogEventUser struct { 
	*cim.WmiInstance
	...
	func NewWin32_NTLogEventUserEx1(instance *cim.WmiInstance) (newInstance *Win32_NTLogEventUser, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NTLogEventUser, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
