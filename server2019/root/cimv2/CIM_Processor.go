...
type CIM_Processor struct { 
	*CIM_LogicalDevice
	...
	func NewCIM_ProcessorEx1(instance *cim.WmiInstance) (newInstance *CIM_Processor, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Processor, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
