...
func NewWin32_PerfRawData_Mlx4EthProvider_MellanoxAdapterQoSCountersEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Mlx4EthProvider_MellanoxAdapterQoSCounters, err error) {
	tmp, err := NewWin32_PerfRawDataEx1(instance)

	if err != nil {
		return
	}
	newInstance = &Win32_PerfRawData_Mlx4EthProvider_MellanoxAdapterQoSCounters{
		Win32_PerfRawData: tmp,
	}
	return
}

func NewWin32_PerfRawData_Mlx4EthProvider_MellanoxAdapterQoSCountersEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Mlx4EthProvider_MellanoxAdapterQoSCounters, err error) {
