...
type CIM_Fan struct { 
	*CIM_CoolingDevice
	...
	func NewCIM_FanEx1(instance *cim.WmiInstance) (newInstance *CIM_Fan, err error) {tmp, err := NewCIM_CoolingDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Fan, err error) {tmp, err := NewCIM_CoolingDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_Fan) SetSpeed( /* IN */ DesiredSpeed uint64) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSpeed" , DesiredSpeed);
	if err != nil { return }
