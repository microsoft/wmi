...
type Win32_TokenPrivileges struct { 
	*cim.WmiInstance
	...
	func NewWin32_TokenPrivilegesEx1(instance *cim.WmiInstance) (newInstance *Win32_TokenPrivileges, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TokenPrivileges, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
