...
type Win32_PnPDevicePropertyUint32Array struct { 
	*Win32_PnPDeviceProperty
	...
	func NewWin32_PnPDevicePropertyUint32ArrayEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPDevicePropertyUint32Array, err error) {tmp, err := NewWin32_PnPDevicePropertyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDevicePropertyUint32Array, err error) {tmp, err := NewWin32_PnPDevicePropertyEx6(hostName, wmiNamespace, userName, password, domainName, query)
