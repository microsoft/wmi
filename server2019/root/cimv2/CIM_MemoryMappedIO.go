...
type CIM_MemoryMappedIO struct { 
	*CIM_SystemResource
	...
	func NewCIM_MemoryMappedIOEx1(instance *cim.WmiInstance) (newInstance *CIM_MemoryMappedIO, err error) {tmp, err := NewCIM_SystemResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_MemoryMappedIO, err error) {tmp, err := NewCIM_SystemResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
