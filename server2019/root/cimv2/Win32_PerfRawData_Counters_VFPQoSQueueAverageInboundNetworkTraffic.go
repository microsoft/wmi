...
type Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic struct {
	*Win32_PerfRawData
...
func NewWin32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTrafficEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic, err error) {
	tmp, err := NewWin32_PerfRawDataEx1(instance)

	if err != nil {
		return
	}
	newInstance = &Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic{
		Win32_PerfRawData: tmp,
	}
	return
}

func NewWin32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTrafficEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundBytesAllowedThroughtheQueue(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundBytesAllowedThroughtheQueue() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundBytesDropped(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundBytesDropped() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundBytesEnteringtheQueue(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundBytesEnteringtheQueue() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundBytesQueuedduetoBacklog(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundBytesQueuedduetoBacklog() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundBytesQueuedduetoInsufficientTokens(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundBytesQueuedduetoInsufficientTokens() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundBytesResumed(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundBytesResumed() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundPacketsAllowedThroughtheQueue(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundPacketsAllowedThroughtheQueue() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundPacketsDropped(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundPacketsDropped() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundPacketsEnteringtheQueue(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundPacketsEnteringtheQueue() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundPacketsQueuedduetoBacklog(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundPacketsQueuedduetoBacklog() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundPacketsQueuedduetoInsufficientTokens(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundPacketsQueuedduetoInsufficientTokens() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) SetPropertyAverageInboundPacketsResumed(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_Counters_VFPQoSQueueAverageInboundNetworkTraffic) GetPropertyAverageInboundPacketsResumed() (value uint64, err error) {
