...
type CIM_MonitorResolution struct { 
	*CIM_Setting
	...
	func NewCIM_MonitorResolutionEx1(instance *cim.WmiInstance) (newInstance *CIM_MonitorResolution, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_MonitorResolution, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
