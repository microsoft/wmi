...
type Win32_ReserveCost struct { 
	*CIM_Check
	...
	func NewWin32_ReserveCostEx1(instance *cim.WmiInstance) (newInstance *Win32_ReserveCost, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ReserveCost, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
