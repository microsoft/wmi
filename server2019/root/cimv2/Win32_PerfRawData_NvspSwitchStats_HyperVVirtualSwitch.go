...
func NewWin32_PerfRawData_NvspSwitchStats_HyperVVirtualSwitchEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_NvspSwitchStats_HyperVVirtualSwitch, err error) {
...
func NewWin32_PerfRawData_NvspSwitchStats_HyperVVirtualSwitchEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_NvspSwitchStats_HyperVVirtualSwitch, err error) {
