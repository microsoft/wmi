...
type Win32_PageFile struct { 
	*CIM_DataFile
	...
	func NewWin32_PageFileEx1(instance *cim.WmiInstance) (newInstance *Win32_PageFile, err error) {tmp, err := NewCIM_DataFileEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PageFile, err error) {tmp, err := NewCIM_DataFileEx6(hostName, wmiNamespace, userName, password, domainName, query)
