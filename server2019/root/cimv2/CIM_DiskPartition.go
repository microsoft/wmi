...
type CIM_DiskPartition struct { 
	*CIM_StorageExtent
	...
	func NewCIM_DiskPartitionEx1(instance *cim.WmiInstance) (newInstance *CIM_DiskPartition, err error) {tmp, err := NewCIM_StorageExtentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DiskPartition, err error) {tmp, err := NewCIM_StorageExtentEx6(hostName, wmiNamespace, userName, password, domainName, query)
