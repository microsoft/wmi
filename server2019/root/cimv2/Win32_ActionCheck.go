...
type Win32_ActionCheck struct { 
	*cim.WmiInstance
	...
	func NewWin32_ActionCheckEx1(instance *cim.WmiInstance) (newInstance *Win32_ActionCheck, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ActionCheck, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
