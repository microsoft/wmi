...
type Win32_ServiceControl struct { 
	*Win32_MSIResource
	...
	func NewWin32_ServiceControlEx1(instance *cim.WmiInstance) (newInstance *Win32_ServiceControl, err error) {tmp, err := NewWin32_MSIResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ServiceControl, err error) {tmp, err := NewWin32_MSIResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
