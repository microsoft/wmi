...
type MSFT_WmiConsumerProviderEvent struct { 
	*MSFT_WmiProviderEvent
	...
	func NewMSFT_WmiConsumerProviderEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_WmiConsumerProviderEvent, err error) {tmp, err := NewMSFT_WmiProviderEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WmiConsumerProviderEvent, err error) {tmp, err := NewMSFT_WmiProviderEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
