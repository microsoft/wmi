...
type MSFT_NCProvEvent struct { 
	*__ExtrinsicEvent
	...
	func NewMSFT_NCProvEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_NCProvEvent, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NCProvEvent, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
