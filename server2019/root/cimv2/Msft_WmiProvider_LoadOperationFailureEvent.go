...
type Msft_WmiProvider_LoadOperationFailureEvent struct { 
	*Msft_WmiProvider_OperationEvent
	...
	func NewMsft_WmiProvider_LoadOperationFailureEventEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_LoadOperationFailureEvent, err error) {tmp, err := NewMsft_WmiProvider_OperationEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_WmiProvider_LoadOperationFailureEvent, err error) {tmp, err := NewMsft_WmiProvider_OperationEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
