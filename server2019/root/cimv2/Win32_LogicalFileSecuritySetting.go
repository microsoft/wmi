...
type Win32_LogicalFileSecuritySetting struct { 
	*Win32_SecuritySetting
	...
	func NewWin32_LogicalFileSecuritySettingEx1(instance *cim.WmiInstance) (newInstance *Win32_LogicalFileSecuritySetting, err error) {tmp, err := NewWin32_SecuritySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_LogicalFileSecuritySetting, err error) {tmp, err := NewWin32_SecuritySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
