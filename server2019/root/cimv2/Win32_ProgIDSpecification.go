...
type Win32_ProgIDSpecification struct { 
	*CIM_Check
	...
	func NewWin32_ProgIDSpecificationEx1(instance *cim.WmiInstance) (newInstance *Win32_ProgIDSpecification, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ProgIDSpecification, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
