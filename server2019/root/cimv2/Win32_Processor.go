...
type Win32_Processor struct { 
	*CIM_Processor
	...
	func NewWin32_ProcessorEx1(instance *cim.WmiInstance) (newInstance *Win32_Processor, err error) {tmp, err := NewCIM_ProcessorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Processor, err error) {tmp, err := NewCIM_ProcessorEx6(hostName, wmiNamespace, userName, password, domainName, query)
