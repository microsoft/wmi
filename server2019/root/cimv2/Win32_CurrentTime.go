...
type Win32_CurrentTime struct { 
	*cim.WmiInstance
	...
	func NewWin32_CurrentTimeEx1(instance *cim.WmiInstance) (newInstance *Win32_CurrentTime, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CurrentTime, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
