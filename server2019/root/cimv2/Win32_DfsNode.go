...
type Win32_DfsNode struct { 
	*CIM_LogicalElement
	...
	func NewWin32_DfsNodeEx1(instance *cim.WmiInstance) (newInstance *Win32_DfsNode, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DfsNode, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_DfsNode) Create( /* IN */ DfsEntryPath string,
 ...
 /* IN */ ShareName string,
 /* OPTIONAL IN */ Description string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Create" , DfsEntryPath, ServerName, ShareName, Description);
	if err != nil { return }
