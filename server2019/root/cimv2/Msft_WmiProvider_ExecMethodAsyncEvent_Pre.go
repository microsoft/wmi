...
type Msft_WmiProvider_ExecMethodAsyncEvent_Pre struct { 
	*Msft_WmiProvider_OperationEvent_Pre
	...
	func NewMsft_WmiProvider_ExecMethodAsyncEvent_PreEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_ExecMethodAsyncEvent_Pre, err error) {tmp, err := NewMsft_WmiProvider_OperationEvent_PreEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_WmiProvider_ExecMethodAsyncEvent_Pre, err error) {tmp, err := NewMsft_WmiProvider_OperationEvent_PreEx6(hostName, wmiNamespace, userName, password, domainName, query)
