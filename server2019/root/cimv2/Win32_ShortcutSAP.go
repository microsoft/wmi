...
type Win32_ShortcutSAP struct { 
	*cim.WmiInstance
	...
	func NewWin32_ShortcutSAPEx1(instance *cim.WmiInstance) (newInstance *Win32_ShortcutSAP, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ShortcutSAP, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
