...
type Win32_ProcessStartup struct { 
	*Win32_MethodParameterClass
	...
	func NewWin32_ProcessStartupEx1(instance *cim.WmiInstance) (newInstance *Win32_ProcessStartup, err error) {tmp, err := NewWin32_MethodParameterClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ProcessStartup, err error) {tmp, err := NewWin32_MethodParameterClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
