...
type Win32_DMAChannel struct { 
	*CIM_DMA
	...
	func NewWin32_DMAChannelEx1(instance *cim.WmiInstance) (newInstance *Win32_DMAChannel, err error) {tmp, err := NewCIM_DMAEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DMAChannel, err error) {tmp, err := NewCIM_DMAEx6(hostName, wmiNamespace, userName, password, domainName, query)
