...
type Win32_PnPDevicePropertySint8 struct { 
	*Win32_PnPDeviceProperty
	...
	func NewWin32_PnPDevicePropertySint8Ex1(instance *cim.WmiInstance) (newInstance *Win32_PnPDevicePropertySint8, err error) {tmp, err := NewWin32_PnPDevicePropertyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDevicePropertySint8, err error) {tmp, err := NewWin32_PnPDevicePropertyEx6(hostName, wmiNamespace, userName, password, domainName, query)
