...
type Win32_SecuritySettingAccess struct { 
	*cim.WmiInstance
	...
	func NewWin32_SecuritySettingAccessEx1(instance *cim.WmiInstance) (newInstance *Win32_SecuritySettingAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SecuritySettingAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
