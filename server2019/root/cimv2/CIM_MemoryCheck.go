...
type CIM_MemoryCheck struct { 
	*CIM_Check
	...
	func NewCIM_MemoryCheckEx1(instance *cim.WmiInstance) (newInstance *CIM_MemoryCheck, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_MemoryCheck, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
