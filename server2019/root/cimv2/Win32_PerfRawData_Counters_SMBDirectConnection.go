...
type Win32_PerfRawData_Counters_SMBDirectConnection struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_Counters_SMBDirectConnectionEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_SMBDirectConnection, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Counters_SMBDirectConnection, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfRawData_Counters_SMBDirectConnection) SetPropertySpuriousRCQNotificationEvents(value uint64) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBDirectConnection) GetPropertySpuriousRCQNotificationEvents()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBDirectConnection) SetPropertySpuriousSCQNotificationEvents(value uint64) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBDirectConnection) GetPropertySpuriousSCQNotificationEvents()(value uint64, err error) { 
