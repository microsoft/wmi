...
type Win32_PerfFormattedData_CsvFsPerfProvider_ClusterCSVFSDirectIO struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_CsvFsPerfProvider_ClusterCSVFSDirectIOEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_CsvFsPerfProvider_ClusterCSVFSDirectIO, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_CsvFsPerfProvider_ClusterCSVFSDirectIO, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
