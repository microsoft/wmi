...
type Win32_OperatingSystem struct { 
	*CIM_OperatingSystem
	...
	func NewWin32_OperatingSystemEx1(instance *cim.WmiInstance) (newInstance *Win32_OperatingSystem, err error) {tmp, err := NewCIM_OperatingSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_OperatingSystem, err error) {tmp, err := NewCIM_OperatingSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_OperatingSystem) Win32Shutdown( /* IN */ Flags int32,
 /* IN */ Reserved int32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Win32Shutdown" , Flags, Reserved);
	if err != nil { return }
...
func (instance *Win32_OperatingSystem) Win32ShutdownTracker( /* IN */ Timeout uint32,
 ...
 /* IN */ Flags int32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Win32ShutdownTracker" , Timeout, Comment, ReasonCode, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_OperatingSystem) SetDateTime( /* IN */ LocalDateTime string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDateTime" , LocalDateTime);
	if err != nil { return }
	result = uint32(retVal)
	return
