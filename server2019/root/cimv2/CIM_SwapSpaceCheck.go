...
type CIM_SwapSpaceCheck struct { 
	*CIM_Check
	...
	func NewCIM_SwapSpaceCheckEx1(instance *cim.WmiInstance) (newInstance *CIM_SwapSpaceCheck, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SwapSpaceCheck, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
