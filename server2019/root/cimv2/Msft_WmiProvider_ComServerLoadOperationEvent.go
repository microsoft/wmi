...
type Msft_WmiProvider_ComServerLoadOperationEvent struct { 
	*Msft_WmiProvider_OperationEvent
	...
	func NewMsft_WmiProvider_ComServerLoadOperationEventEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_ComServerLoadOperationEvent, err error) {tmp, err := NewMsft_WmiProvider_OperationEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_WmiProvider_ComServerLoadOperationEvent, err error) {tmp, err := NewMsft_WmiProvider_OperationEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
