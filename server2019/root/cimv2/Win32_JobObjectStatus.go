...
type Win32_JobObjectStatus struct { 
	*__ExtendedStatus
	...
	func NewWin32_JobObjectStatusEx1(instance *cim.WmiInstance) (newInstance *Win32_JobObjectStatus, err error) {tmp, err := New__ExtendedStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_JobObjectStatus, err error) {tmp, err := New__ExtendedStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
