...
type Msft_WmiProvider_PutInstanceAsyncEvent_Post struct { 
	*Msft_WmiProvider_OperationEvent_Post
	...
	func NewMsft_WmiProvider_PutInstanceAsyncEvent_PostEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_PutInstanceAsyncEvent_Post, err error) {tmp, err := NewMsft_WmiProvider_OperationEvent_PostEx1(instance)
		
	if err != nil { return }
	newInstance = &Msft_WmiProvider_PutInstanceAsyncEvent_Post {
	...
	func NewMsft_WmiProvider_PutInstanceAsyncEvent_PostEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_WmiProvider_PutInstanceAsyncEvent_Post, err error) {tmp, err := NewMsft_WmiProvider_OperationEvent_PostEx6(hostName, wmiNamespace, userName, password, domainName, query)
