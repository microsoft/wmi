...
type Win32_SMBIOSMemory struct { 
	*CIM_StorageExtent
	...
	func NewWin32_SMBIOSMemoryEx1(instance *cim.WmiInstance) (newInstance *Win32_SMBIOSMemory, err error) {tmp, err := NewCIM_StorageExtentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SMBIOSMemory, err error) {tmp, err := NewCIM_StorageExtentEx6(hostName, wmiNamespace, userName, password, domainName, query)
