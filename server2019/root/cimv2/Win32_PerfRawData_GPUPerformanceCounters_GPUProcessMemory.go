...
func NewWin32_PerfRawData_GPUPerformanceCounters_GPUProcessMemoryEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_GPUPerformanceCounters_GPUProcessMemory, err error) {
...
func NewWin32_PerfRawData_GPUPerformanceCounters_GPUProcessMemoryEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_GPUPerformanceCounters_GPUProcessMemory, err error) {
