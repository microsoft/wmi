...
type Win32_PerfRawData_GPUPerformanceCounters_GPUProcessMemory struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_GPUPerformanceCounters_GPUProcessMemoryEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_GPUPerformanceCounters_GPUProcessMemory, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_GPUPerformanceCounters_GPUProcessMemory {
	...
	func NewWin32_PerfRawData_GPUPerformanceCounters_GPUProcessMemoryEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_GPUPerformanceCounters_GPUProcessMemory, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
