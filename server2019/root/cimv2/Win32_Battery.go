...
type Win32_Battery struct { 
	*CIM_Battery
	...
	func NewWin32_BatteryEx1(instance *cim.WmiInstance) (newInstance *Win32_Battery, err error) {tmp, err := NewCIM_BatteryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Battery, err error) {tmp, err := NewCIM_BatteryEx6(hostName, wmiNamespace, userName, password, domainName, query)
