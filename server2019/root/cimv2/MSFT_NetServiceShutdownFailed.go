...
type MSFT_NetServiceShutdownFailed struct { 
	*MSFT_SCMEventLogEvent
	...
	func NewMSFT_NetServiceShutdownFailedEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetServiceShutdownFailed, err error) {tmp, err := NewMSFT_SCMEventLogEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetServiceShutdownFailed, err error) {tmp, err := NewMSFT_SCMEventLogEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
