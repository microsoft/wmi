...
type CIM_PCVideoController struct { 
	*CIM_VideoController
	...
	func NewCIM_PCVideoControllerEx1(instance *cim.WmiInstance) (newInstance *CIM_PCVideoController, err error) {tmp, err := NewCIM_VideoControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PCVideoController, err error) {tmp, err := NewCIM_VideoControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
