...
type CIM_ActsAsSpare struct { 
	*cim.WmiInstance
	...
	func NewCIM_ActsAsSpareEx1(instance *cim.WmiInstance) (newInstance *CIM_ActsAsSpare, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ActsAsSpare, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
