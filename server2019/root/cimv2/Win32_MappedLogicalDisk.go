...
type Win32_MappedLogicalDisk struct { 
	*CIM_LogicalDisk
	...
	func NewWin32_MappedLogicalDiskEx1(instance *cim.WmiInstance) (newInstance *Win32_MappedLogicalDisk, err error) {tmp, err := NewCIM_LogicalDiskEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_MappedLogicalDisk, err error) {tmp, err := NewCIM_LogicalDiskEx6(hostName, wmiNamespace, userName, password, domainName, query)
