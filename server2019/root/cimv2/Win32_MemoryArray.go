...
type Win32_MemoryArray struct { 
	*Win32_SMBIOSMemory
	...
	func NewWin32_MemoryArrayEx1(instance *cim.WmiInstance) (newInstance *Win32_MemoryArray, err error) {tmp, err := NewWin32_SMBIOSMemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_MemoryArray, err error) {tmp, err := NewWin32_SMBIOSMemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
