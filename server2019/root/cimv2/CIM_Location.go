...
type CIM_Location struct { 
	*cim.WmiInstance
	...
	func NewCIM_LocationEx1(instance *cim.WmiInstance) (newInstance *CIM_Location, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Location, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
