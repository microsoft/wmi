...
type CIM_PCMCIAController struct { 
	*CIM_Controller
	...
	func NewCIM_PCMCIAControllerEx1(instance *cim.WmiInstance) (newInstance *CIM_PCMCIAController, err error) {tmp, err := NewCIM_ControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PCMCIAController, err error) {tmp, err := NewCIM_ControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
