...
type Win32_EnvironmentSpecification struct { 
	*CIM_Check
	...
	func NewWin32_EnvironmentSpecificationEx1(instance *cim.WmiInstance) (newInstance *Win32_EnvironmentSpecification, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_EnvironmentSpecification, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
