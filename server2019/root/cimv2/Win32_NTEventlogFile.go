...
type Win32_NTEventlogFile struct { 
	*CIM_DataFile
	...
	func NewWin32_NTEventlogFileEx1(instance *cim.WmiInstance) (newInstance *Win32_NTEventlogFile, err error) {tmp, err := NewCIM_DataFileEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NTEventlogFile, err error) {tmp, err := NewCIM_DataFileEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_NTEventlogFile) ClearEventlog( /* IN */ ArchiveFileName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ClearEventlog" , ArchiveFileName);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_NTEventlogFile) BackupEventlog( /* IN */ ArchiveFileName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("BackupEventlog" , ArchiveFileName);
	if err != nil { return }
	result = uint32(retVal)
	return
