...
type CIM_PhysicalCapacity struct { 
	*cim.WmiInstance
	...
	func NewCIM_PhysicalCapacityEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalCapacity, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalCapacity, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
