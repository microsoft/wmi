...
type CIM_CacheMemory struct { 
	*CIM_Memory
	...
	func NewCIM_CacheMemoryEx1(instance *cim.WmiInstance) (newInstance *CIM_CacheMemory, err error) {tmp, err := NewCIM_MemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CacheMemory, err error) {tmp, err := NewCIM_MemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
