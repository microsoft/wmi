...
type Win32_Binary struct { 
	*Win32_MSIResource
	...
	func NewWin32_BinaryEx1(instance *cim.WmiInstance) (newInstance *Win32_Binary, err error) {tmp, err := NewWin32_MSIResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Binary, err error) {tmp, err := NewWin32_MSIResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
