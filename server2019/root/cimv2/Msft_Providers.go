...
type Msft_Providers struct { 
	*cim.WmiInstance
	...
	func NewMsft_ProvidersEx1(instance *cim.WmiInstance) (newInstance *Msft_Providers, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_Providers, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msft_Providers) Suspend() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Suspend" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msft_Providers) Resume() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Resume" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msft_Providers) UnLoad() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UnLoad" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Msft_Providers) Load( /* IN */ Namespace string,
 ...
 /* IN */ Locale string,
 /* IN */ provider string,
 /* IN */ TransactionIdentifier string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Load" , Namespace, User, Locale, provider, TransactionIdentifier);
	if err != nil { return }
	result = uint32(retVal)
	return
