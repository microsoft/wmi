...
type Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor struct {
	...
	//
	PercentGuestIdleTime_Base uint64
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) SetPropertyHWPRequestMSRContextSwitchesPersec(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) GetPropertyHWPRequestMSRContextSwitchesPersec() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) SetPropertyNMIInterruptsCost(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) GetPropertyNMIInterruptsCost() (value uint64, err error) {
...
// SetNMIInterruptsCost_Base sets the value of NMIInterruptsCost_Base for the instance
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) SetPropertyNMIInterruptsCost_Base(value uint64) (err error) {
	return instance.SetProperty("NMIInterruptsCost_Base", value)
}

// GetNMIInterruptsCost_Base gets the value of NMIInterruptsCost_Base for the instance
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) GetPropertyNMIInterruptsCost_Base() (value uint64, err error) {
	retValue, err := instance.GetProperty("NMIInterruptsCost_Base")
	if err != nil {
		return
	}
	value, ok := retValue.(uint64)
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) SetPropertyNMIInterruptsPersec(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) GetPropertyNMIInterruptsPersec() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) SetPropertyPercentGuestIdleTime(value uint64) (err error) {
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) GetPropertyPercentGuestIdleTime() (value uint64, err error) {
...
// SetPercentGuestIdleTime_Base sets the value of PercentGuestIdleTime_Base for the instance
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) SetPropertyPercentGuestIdleTime_Base(value uint64) (err error) {
	return instance.SetProperty("PercentGuestIdleTime_Base", value)
}

// GetPercentGuestIdleTime_Base gets the value of PercentGuestIdleTime_Base for the instance
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorVirtualProcessor) GetPropertyPercentGuestIdleTime_Base() (value uint64, err error) {
	retValue, err := instance.GetProperty("PercentGuestIdleTime_Base")
	if err != nil {
		return
	}
	value, ok := retValue.(uint64)
