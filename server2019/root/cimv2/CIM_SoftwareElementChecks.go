...
type CIM_SoftwareElementChecks struct { 
	*cim.WmiInstance
	...
	func NewCIM_SoftwareElementChecksEx1(instance *cim.WmiInstance) (newInstance *CIM_SoftwareElementChecks, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SoftwareElementChecks, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
