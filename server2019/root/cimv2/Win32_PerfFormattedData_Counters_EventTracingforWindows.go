...
type Win32_PerfFormattedData_Counters_EventTracingforWindows struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_Counters_EventTracingforWindowsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_EventTracingforWindows, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_Counters_EventTracingforWindows {
	...
	func NewWin32_PerfFormattedData_Counters_EventTracingforWindowsEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_Counters_EventTracingforWindows, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_Counters_EventTracingforWindows) GetPropertyTotalMemoryUsageNonPagedPool()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_EventTracingforWindows) GetPropertyTotalMemoryUsagePagedPool()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_EventTracingforWindows) GetPropertyTotalNumberofActiveSessions()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_EventTracingforWindows) GetPropertyTotalNumberofDistinctDisabledProviders()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_EventTracingforWindows) GetPropertyTotalNumberofDistinctEnabledProviders()(value uint32, err error) { 
...
func (instance *Win32_PerfFormattedData_Counters_EventTracingforWindows) GetPropertyTotalNumberofDistinctPreEnabledProviders()(value uint32, err error) { 
