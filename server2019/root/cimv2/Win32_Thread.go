...
type Win32_Thread struct { 
	*CIM_Thread
	...
	func NewWin32_ThreadEx1(instance *cim.WmiInstance) (newInstance *Win32_Thread, err error) {tmp, err := NewCIM_ThreadEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Thread, err error) {tmp, err := NewCIM_ThreadEx6(hostName, wmiNamespace, userName, password, domainName, query)
