...
type Win32_ParallelPort struct { 
	*CIM_ParallelController
	...
	func NewWin32_ParallelPortEx1(instance *cim.WmiInstance) (newInstance *Win32_ParallelPort, err error) {tmp, err := NewCIM_ParallelControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ParallelPort, err error) {tmp, err := NewCIM_ParallelControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
