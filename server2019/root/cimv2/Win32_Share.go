...
type Win32_Share struct { 
	*CIM_LogicalElement
	...
	func NewWin32_ShareEx1(instance *cim.WmiInstance) (newInstance *Win32_Share, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Share, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_Share) Create( /* IN */ Path string,
 ...
 /* OPTIONAL IN */ Access Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Create" , Path, Name, Type, MaximumAllowed, Description, Password, Access);
	if err != nil { return }
...
func (instance *Win32_Share) SetShareInfo( /* OPTIONAL IN */ MaximumAllowed uint32,
 /* OPTIONAL IN */ Description string,
 /* OPTIONAL IN */ Access Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetShareInfo" , MaximumAllowed, Description, Access);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Share) GetAccessMask() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("GetAccessMask" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Share) Delete() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Delete" );
	if err != nil { return }
	result = uint32(retVal)
	return
