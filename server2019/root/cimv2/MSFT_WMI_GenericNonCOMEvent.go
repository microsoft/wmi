...
type MSFT_WMI_GenericNonCOMEvent struct { 
	*__ExtrinsicEvent
	...
	func NewMSFT_WMI_GenericNonCOMEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_WMI_GenericNonCOMEvent, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WMI_GenericNonCOMEvent, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
