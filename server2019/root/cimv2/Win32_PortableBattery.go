...
type Win32_PortableBattery struct { 
	*CIM_Battery
	...
	func NewWin32_PortableBatteryEx1(instance *cim.WmiInstance) (newInstance *Win32_PortableBattery, err error) {tmp, err := NewCIM_BatteryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PortableBattery, err error) {tmp, err := NewCIM_BatteryEx6(hostName, wmiNamespace, userName, password, domainName, query)
