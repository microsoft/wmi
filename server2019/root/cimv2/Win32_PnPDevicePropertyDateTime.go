...
type Win32_PnPDevicePropertyDateTime struct { 
	*Win32_PnPDeviceProperty
	...
	func NewWin32_PnPDevicePropertyDateTimeEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPDevicePropertyDateTime, err error) {tmp, err := NewWin32_PnPDevicePropertyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDevicePropertyDateTime, err error) {tmp, err := NewWin32_PnPDevicePropertyEx6(hostName, wmiNamespace, userName, password, domainName, query)
