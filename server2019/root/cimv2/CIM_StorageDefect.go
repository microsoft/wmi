...
type CIM_StorageDefect struct { 
	*cim.WmiInstance
	...
	func NewCIM_StorageDefectEx1(instance *cim.WmiInstance) (newInstance *CIM_StorageDefect, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_StorageDefect, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
