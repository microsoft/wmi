...
type Win32_LogicalProgramGroup struct { 
	*Win32_ProgramGroupOrItem
	...
	func NewWin32_LogicalProgramGroupEx1(instance *cim.WmiInstance) (newInstance *Win32_LogicalProgramGroup, err error) {tmp, err := NewWin32_ProgramGroupOrItemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_LogicalProgramGroup, err error) {tmp, err := NewWin32_ProgramGroupOrItemEx6(hostName, wmiNamespace, userName, password, domainName, query)
