...
type CIM_CollectedCollections struct { 
	*cim.WmiInstance
	...
	func NewCIM_CollectedCollectionsEx1(instance *cim.WmiInstance) (newInstance *CIM_CollectedCollections, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CollectedCollections, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
