...
type CIM_VersionCompatibilityCheck struct { 
	*CIM_Check
	...
	func NewCIM_VersionCompatibilityCheckEx1(instance *cim.WmiInstance) (newInstance *CIM_VersionCompatibilityCheck, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VersionCompatibilityCheck, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
