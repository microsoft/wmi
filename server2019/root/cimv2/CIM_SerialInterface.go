...
type CIM_SerialInterface struct { 
	*CIM_ControlledBy
	...
	func NewCIM_SerialInterfaceEx1(instance *cim.WmiInstance) (newInstance *CIM_SerialInterface, err error) {tmp, err := NewCIM_ControlledByEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SerialInterface, err error) {tmp, err := NewCIM_ControlledByEx6(hostName, wmiNamespace, userName, password, domainName, query)
