...
type CIM_FlatPanel struct { 
	*CIM_Display
	...
	func NewCIM_FlatPanelEx1(instance *cim.WmiInstance) (newInstance *CIM_FlatPanel, err error) {tmp, err := NewCIM_DisplayEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_FlatPanel, err error) {tmp, err := NewCIM_DisplayEx6(hostName, wmiNamespace, userName, password, domainName, query)
