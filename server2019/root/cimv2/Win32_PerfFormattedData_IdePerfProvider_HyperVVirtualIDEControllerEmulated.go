...
type Win32_PerfFormattedData_IdePerfProvider_HyperVVirtualIDEControllerEmulated struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_IdePerfProvider_HyperVVirtualIDEControllerEmulatedEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_IdePerfProvider_HyperVVirtualIDEControllerEmulated, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_IdePerfProvider_HyperVVirtualIDEControllerEmulated, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
