...
type Win32_DiskQuota struct { 
	*cim.WmiInstance
	...
	func NewWin32_DiskQuotaEx1(instance *cim.WmiInstance) (newInstance *Win32_DiskQuota, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DiskQuota, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
