...
type Win32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkMessages struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkMessagesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkMessages, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkMessages {
	...
	func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkMessagesEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkMessages, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
