...
type Win32_PointingDevice struct { 
	*CIM_PointingDevice
	...
	func NewWin32_PointingDeviceEx1(instance *cim.WmiInstance) (newInstance *Win32_PointingDevice, err error) {tmp, err := NewCIM_PointingDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PointingDevice, err error) {tmp, err := NewCIM_PointingDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
