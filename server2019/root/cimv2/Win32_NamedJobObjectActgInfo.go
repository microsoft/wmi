...
type Win32_NamedJobObjectActgInfo struct { 
	*CIM_StatisticalInformation
	...
	func NewWin32_NamedJobObjectActgInfoEx1(instance *cim.WmiInstance) (newInstance *Win32_NamedJobObjectActgInfo, err error) {tmp, err := NewCIM_StatisticalInformationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NamedJobObjectActgInfo, err error) {tmp, err := NewCIM_StatisticalInformationEx6(hostName, wmiNamespace, userName, password, domainName, query)
