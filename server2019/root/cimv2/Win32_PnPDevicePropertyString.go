...
type Win32_PnPDevicePropertyString struct { 
	*Win32_PnPDeviceProperty
	...
	func NewWin32_PnPDevicePropertyStringEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPDevicePropertyString, err error) {tmp, err := NewWin32_PnPDevicePropertyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDevicePropertyString, err error) {tmp, err := NewWin32_PnPDevicePropertyEx6(hostName, wmiNamespace, userName, password, domainName, query)
