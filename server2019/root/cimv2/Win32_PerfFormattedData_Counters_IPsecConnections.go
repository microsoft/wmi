...
func NewWin32_PerfFormattedData_Counters_IPsecConnectionsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_IPsecConnections, err error) {
...
func NewWin32_PerfFormattedData_Counters_IPsecConnectionsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_IPsecConnections, err error) {
