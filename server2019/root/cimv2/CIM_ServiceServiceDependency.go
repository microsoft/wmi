...
type CIM_ServiceServiceDependency struct { 
	*CIM_Dependency
	...
	func NewCIM_ServiceServiceDependencyEx1(instance *cim.WmiInstance) (newInstance *CIM_ServiceServiceDependency, err error) {tmp, err := NewCIM_DependencyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ServiceServiceDependency, err error) {tmp, err := NewCIM_DependencyEx6(hostName, wmiNamespace, userName, password, domainName, query)
