...
type CIM_FromDirectoryAction struct { 
	*cim.WmiInstance
	...
	func NewCIM_FromDirectoryActionEx1(instance *cim.WmiInstance) (newInstance *CIM_FromDirectoryAction, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_FromDirectoryAction, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
