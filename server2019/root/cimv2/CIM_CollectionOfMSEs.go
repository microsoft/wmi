...
type CIM_CollectionOfMSEs struct { 
	*cim.WmiInstance
	...
	func NewCIM_CollectionOfMSEsEx1(instance *cim.WmiInstance) (newInstance *CIM_CollectionOfMSEs, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CollectionOfMSEs, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
