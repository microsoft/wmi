...
type CIM_DMA struct { 
	*CIM_SystemResource
	...
	func NewCIM_DMAEx1(instance *cim.WmiInstance) (newInstance *CIM_DMA, err error) {tmp, err := NewCIM_SystemResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DMA, err error) {tmp, err := NewCIM_SystemResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
