...
type CIM_Export struct { 
	*cim.WmiInstance
	...
	func NewCIM_ExportEx1(instance *cim.WmiInstance) (newInstance *CIM_Export, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Export, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
