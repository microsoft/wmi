...
type Win32_IniFileSpecification struct { 
	*CIM_FileSpecification
	...
	func NewWin32_IniFileSpecificationEx1(instance *cim.WmiInstance) (newInstance *Win32_IniFileSpecification, err error) {tmp, err := NewCIM_FileSpecificationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_IniFileSpecification, err error) {tmp, err := NewCIM_FileSpecificationEx6(hostName, wmiNamespace, userName, password, domainName, query)
