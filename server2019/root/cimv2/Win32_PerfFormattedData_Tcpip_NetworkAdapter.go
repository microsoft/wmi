...
func NewWin32_PerfFormattedData_Tcpip_NetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Tcpip_NetworkAdapter, err error) {
...
func NewWin32_PerfFormattedData_Tcpip_NetworkAdapterEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Tcpip_NetworkAdapter, err error) {
