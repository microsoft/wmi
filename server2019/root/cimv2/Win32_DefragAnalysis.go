...
type Win32_DefragAnalysis struct { 
	*cim.WmiInstance
	...
	func NewWin32_DefragAnalysisEx1(instance *cim.WmiInstance) (newInstance *Win32_DefragAnalysis, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DefragAnalysis, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
