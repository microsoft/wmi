...
type Win32_SoftwareFeature struct { 
	*CIM_SoftwareFeature
	...
	func NewWin32_SoftwareFeatureEx1(instance *cim.WmiInstance) (newInstance *Win32_SoftwareFeature, err error) {tmp, err := NewCIM_SoftwareFeatureEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SoftwareFeature, err error) {tmp, err := NewCIM_SoftwareFeatureEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_SoftwareFeature) Reinstall( /* IN */ ReinstallMode uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Reinstall" , ReinstallMode);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_SoftwareFeature) Configure( /* IN */ InstallState uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Configure" , InstallState);
	if err != nil { return }
	result = uint32(retVal)
	return
