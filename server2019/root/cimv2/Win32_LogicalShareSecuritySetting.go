...
type Win32_LogicalShareSecuritySetting struct { 
	*Win32_SecuritySetting
	...
	func NewWin32_LogicalShareSecuritySettingEx1(instance *cim.WmiInstance) (newInstance *Win32_LogicalShareSecuritySetting, err error) {tmp, err := NewWin32_SecuritySettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_LogicalShareSecuritySetting, err error) {tmp, err := NewWin32_SecuritySettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
