...
type CIM_ProductParentChild struct { 
	*cim.WmiInstance
	...
	func NewCIM_ProductParentChildEx1(instance *cim.WmiInstance) (newInstance *CIM_ProductParentChild, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProductParentChild, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
