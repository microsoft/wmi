...
type Win32_PortResource struct { 
	*Win32_SystemMemoryResource
	...
	func NewWin32_PortResourceEx1(instance *cim.WmiInstance) (newInstance *Win32_PortResource, err error) {tmp, err := NewWin32_SystemMemoryResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PortResource, err error) {tmp, err := NewWin32_SystemMemoryResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
