...
type Win32_SoftwareElementResource struct { 
	*Win32_ManagedSystemElementResource
	...
	func NewWin32_SoftwareElementResourceEx1(instance *cim.WmiInstance) (newInstance *Win32_SoftwareElementResource, err error) {tmp, err := NewWin32_ManagedSystemElementResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SoftwareElementResource, err error) {tmp, err := NewWin32_ManagedSystemElementResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
