...
type Win32_PerfFormattedData_Counters_StorportUnitQueue struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_Counters_StorportUnitQueueEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_StorportUnitQueue, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_Counters_StorportUnitQueue, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
