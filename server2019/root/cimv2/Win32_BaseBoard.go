...
type Win32_BaseBoard struct { 
	*CIM_Card
	...
	func NewWin32_BaseBoardEx1(instance *cim.WmiInstance) (newInstance *Win32_BaseBoard, err error) {tmp, err := NewCIM_CardEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_BaseBoard, err error) {tmp, err := NewCIM_CardEx6(hostName, wmiNamespace, userName, password, domainName, query)
