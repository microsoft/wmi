...
type CIM_SettingContext struct { 
	*cim.WmiInstance
	...
	func NewCIM_SettingContextEx1(instance *cim.WmiInstance) (newInstance *CIM_SettingContext, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SettingContext, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
