...
type Win32_Volume struct { 
	*CIM_StorageVolume
	...
	func NewWin32_VolumeEx1(instance *cim.WmiInstance) (newInstance *Win32_Volume, err error) {tmp, err := NewCIM_StorageVolumeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Volume, err error) {tmp, err := NewCIM_StorageVolumeEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_Volume) Chkdsk( /* IN */ FixErrors bool,
 ...
 /* IN */ OkToRunAtBootUp bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Chkdsk" , FixErrors, VigorousIndexCheck, SkipFolderCycle, ForceDismount, RecoverBadSectors, OkToRunAtBootUp);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Volume) ScheduleAutoChk( /* IN */ Volume []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ScheduleAutoChk" , Volume);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Volume) ExcludeFromAutoChk( /* IN */ Volume []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ExcludeFromAutoChk" , Volume);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_Volume) Format( /* IN */ FileSystem string,
 ...
 /* IN */ Version uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Format" , FileSystem, QuickFormat, ClusterSize, Label, EnableCompression, Version);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_Volume) Defrag( /* IN */ Force bool,
 /* OUT */ DefragAnalysis interface{}) (result uint32, err error) {retVal, err := instance.InvokeMethod("Defrag" , Force)
	if err != nil { return }
...
func (instance *Win32_Volume) DefragAnalysis( /* OUT */ DefragRecommended bool,
 /* OUT */ DefragAnalysis interface{}) (result uint32, err error) {retVal, err := instance.InvokeMethod("DefragAnalysis" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Volume) AddMountPoint( /* IN */ Directory string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddMountPoint" , Directory);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Volume) Mount() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Mount" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Win32_Volume) Dismount( /* IN */ Force bool,
 /* IN */ Permanent bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Dismount" , Force, Permanent);
	if err != nil { return }
	result = uint32(retVal)
	return
