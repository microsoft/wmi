...
type MSFT_NetTakeOwnership struct { 
	*MSFT_SCMEventLogEvent
	...
	func NewMSFT_NetTakeOwnershipEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetTakeOwnership, err error) {tmp, err := NewMSFT_SCMEventLogEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetTakeOwnership, err error) {tmp, err := NewMSFT_SCMEventLogEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
