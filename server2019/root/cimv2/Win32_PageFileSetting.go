...
type Win32_PageFileSetting struct { 
	*CIM_Setting
	...
	func NewWin32_PageFileSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_PageFileSetting, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PageFileSetting, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
