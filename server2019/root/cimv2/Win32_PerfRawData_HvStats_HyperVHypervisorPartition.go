...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorPartition) SetPropertyPages1Persec(value uint64) (err error) {
	return instance.SetProperty("Pages1Persec", value)
}

// GetPages1Persec gets the value of Pages1Persec for the instance
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorPartition) GetPropertyPages1Persec() (value uint64, err error) {
...
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorPartition) SetPropertyPages2Persec(value uint64) (err error) {
	return instance.SetProperty("Pages2Persec", value)
}

// GetPages2Persec gets the value of Pages2Persec for the instance
func (instance *Win32_PerfRawData_HvStats_HyperVHypervisorPartition) GetPropertyPages2Persec() (value uint64, err error) {
