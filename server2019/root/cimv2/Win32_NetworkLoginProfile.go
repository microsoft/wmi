...
type Win32_NetworkLoginProfile struct { 
	*CIM_Setting
	...
	func NewWin32_NetworkLoginProfileEx1(instance *cim.WmiInstance) (newInstance *Win32_NetworkLoginProfile, err error) {tmp, err := NewCIM_SettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NetworkLoginProfile, err error) {tmp, err := NewCIM_SettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
