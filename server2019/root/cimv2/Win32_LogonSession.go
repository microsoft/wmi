...
type Win32_LogonSession struct { 
	*Win32_Session
	...
	func NewWin32_LogonSessionEx1(instance *cim.WmiInstance) (newInstance *Win32_LogonSession, err error) {tmp, err := NewWin32_SessionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_LogonSession, err error) {tmp, err := NewWin32_SessionEx6(hostName, wmiNamespace, userName, password, domainName, query)
