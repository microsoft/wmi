...
type Win32_IDEController struct { 
	*CIM_Controller
	...
	func NewWin32_IDEControllerEx1(instance *cim.WmiInstance) (newInstance *Win32_IDEController, err error) {tmp, err := NewCIM_ControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_IDEController, err error) {tmp, err := NewCIM_ControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
