...
type MSFT_WmiThreadPoolEvent struct { 
	*MSFT_WmiEssEvent
	...
	func NewMSFT_WmiThreadPoolEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_WmiThreadPoolEvent, err error) {tmp, err := NewMSFT_WmiEssEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WmiThreadPoolEvent, err error) {tmp, err := NewMSFT_WmiEssEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
