...
type Win32_ApplicationCommandLine struct { 
	*CIM_ServiceAccessBySAP
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ApplicationCommandLine, err error) {tmp, err := NewCIM_ServiceAccessBySAPEx6(hostName, wmiNamespace, userName, password, domainName, query)
