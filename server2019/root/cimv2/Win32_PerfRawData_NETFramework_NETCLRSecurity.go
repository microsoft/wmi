...
type Win32_PerfRawData_NETFramework_NETCLRSecurity struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_NETFramework_NETCLRSecurityEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_NETFramework_NETCLRSecurity, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_NETFramework_NETCLRSecurity {
	...
	func NewWin32_PerfRawData_NETFramework_NETCLRSecurityEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_NETFramework_NETCLRSecurity, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
