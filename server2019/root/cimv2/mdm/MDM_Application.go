...
type MDM_Application struct { 
	*cim.WmiInstance
	...
	func NewMDM_ApplicationEx1(instance *cim.WmiInstance) (newInstance *MDM_Application, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Application, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
