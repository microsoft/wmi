...
type MDM_SecurityStatus struct { 
	*cim.WmiInstance
	...
	func NewMDM_SecurityStatusEx1(instance *cim.WmiInstance) (newInstance *MDM_SecurityStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_SecurityStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
