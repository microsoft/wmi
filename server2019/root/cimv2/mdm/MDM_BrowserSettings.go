...
type MDM_BrowserSettings struct { 
	*cim.WmiInstance
	...
	func NewMDM_BrowserSettingsEx1(instance *cim.WmiInstance) (newInstance *MDM_BrowserSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_BrowserSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
