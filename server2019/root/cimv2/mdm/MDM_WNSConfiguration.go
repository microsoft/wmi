...
type MDM_WNSConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMDM_WNSConfigurationEx1(instance *cim.WmiInstance) (newInstance *MDM_WNSConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WNSConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_WNSConfiguration) UpdateConfiguration( /* IN */ ConfigString string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UpdateConfiguration" , ConfigString);
	if err != nil { return }
