...
type MDM_VpnApplicationTrigger struct { 
	*cim.WmiInstance
	...
	func NewMDM_VpnApplicationTriggerEx1(instance *cim.WmiInstance) (newInstance *MDM_VpnApplicationTrigger, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_VpnApplicationTrigger, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
