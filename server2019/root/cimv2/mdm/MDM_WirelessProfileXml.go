...
type MDM_WirelessProfileXml struct { 
	*cim.WmiInstance
	...
	func NewMDM_WirelessProfileXmlEx1(instance *cim.WmiInstance) (newInstance *MDM_WirelessProfileXml, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WirelessProfileXml, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
