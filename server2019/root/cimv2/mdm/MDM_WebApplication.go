...
type MDM_WebApplication struct { 
	*cim.WmiInstance
	...
	func NewMDM_WebApplicationEx1(instance *cim.WmiInstance) (newInstance *MDM_WebApplication, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WebApplication, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
