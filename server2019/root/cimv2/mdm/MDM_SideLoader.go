...
type MDM_SideLoader struct { 
	*cim.WmiInstance
	...
	func NewMDM_SideLoaderEx1(instance *cim.WmiInstance) (newInstance *MDM_SideLoader, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_SideLoader, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_SideLoader) ActivateKey( /* IN */ ProductKey string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ActivateKey" , ProductKey);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_SideLoader) AddCertificate( /* IN */ CertificateBlob string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddCertificate" , CertificateBlob);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_SideLoader) UnActivateLOB() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UnActivateLOB" );
	if err != nil { return }
	result = uint32(retVal)
	return
