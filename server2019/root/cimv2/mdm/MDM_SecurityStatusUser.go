...
type MDM_SecurityStatusUser struct { 
	*cim.WmiInstance
	...
	func NewMDM_SecurityStatusUserEx1(instance *cim.WmiInstance) (newInstance *MDM_SecurityStatusUser, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_SecurityStatusUser, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
