...
type MDM_Restrictions struct { 
	*cim.WmiInstance
	...
	func NewMDM_RestrictionsEx1(instance *cim.WmiInstance) (newInstance *MDM_Restrictions, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Restrictions, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
