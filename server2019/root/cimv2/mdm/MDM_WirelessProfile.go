...
type MDM_WirelessProfile struct { 
	*cim.WmiInstance
	...
	func NewMDM_WirelessProfileEx1(instance *cim.WmiInstance) (newInstance *MDM_WirelessProfile, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WirelessProfile, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
