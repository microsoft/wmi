...
type MDM_MgmtAuthority struct { 
	*cim.WmiInstance
	...
	func NewMDM_MgmtAuthorityEx1(instance *cim.WmiInstance) (newInstance *MDM_MgmtAuthority, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_MgmtAuthority, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_MgmtAuthority) CreateNewAuthority( /* IN */ AuthorityName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CreateNewAuthority" , AuthorityName);
	if err != nil { return }
