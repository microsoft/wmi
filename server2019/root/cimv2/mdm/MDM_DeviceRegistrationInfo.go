...
type MDM_DeviceRegistrationInfo struct { 
	*cim.WmiInstance
	...
	func NewMDM_DeviceRegistrationInfoEx1(instance *cim.WmiInstance) (newInstance *MDM_DeviceRegistrationInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DeviceRegistrationInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
