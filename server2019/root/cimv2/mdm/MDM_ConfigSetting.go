...
type MDM_ConfigSetting struct { 
	*cim.WmiInstance
	...
	func NewMDM_ConfigSettingEx1(instance *cim.WmiInstance) (newInstance *MDM_ConfigSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ConfigSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
