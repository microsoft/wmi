...
type MDM_RemoteApplication struct { 
	*cim.WmiInstance
	...
	func NewMDM_RemoteApplicationEx1(instance *cim.WmiInstance) (newInstance *MDM_RemoteApplication, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_RemoteApplication, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
