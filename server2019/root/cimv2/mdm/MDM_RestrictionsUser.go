...
type MDM_RestrictionsUser struct { 
	*cim.WmiInstance
	...
	func NewMDM_RestrictionsUserEx1(instance *cim.WmiInstance) (newInstance *MDM_RestrictionsUser, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_RestrictionsUser, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
