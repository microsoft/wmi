...
type MDM_Updates struct { 
	*cim.WmiInstance
	...
	func NewMDM_UpdatesEx1(instance *cim.WmiInstance) (newInstance *MDM_Updates, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Updates, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
