...
type MDM_ApplicationSetting struct { 
	*cim.WmiInstance
	...
	func NewMDM_ApplicationSettingEx1(instance *cim.WmiInstance) (newInstance *MDM_ApplicationSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ApplicationSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
