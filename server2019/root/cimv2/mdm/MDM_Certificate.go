...
type MDM_Certificate struct { 
	*cim.WmiInstance
	...
	func NewMDM_CertificateEx1(instance *cim.WmiInstance) (newInstance *MDM_Certificate, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Certificate, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
