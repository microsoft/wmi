...
type MDM_ApplicationFramework struct { 
	*cim.WmiInstance
	...
	func NewMDM_ApplicationFrameworkEx1(instance *cim.WmiInstance) (newInstance *MDM_ApplicationFramework, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ApplicationFramework, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
