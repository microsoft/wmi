...
type MDM_RemoteAppUserCookie struct { 
	*cim.WmiInstance
	...
	func NewMDM_RemoteAppUserCookieEx1(instance *cim.WmiInstance) (newInstance *MDM_RemoteAppUserCookie, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_RemoteAppUserCookie, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
