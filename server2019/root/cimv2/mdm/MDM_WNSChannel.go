...
type MDM_WNSChannel struct { 
	*cim.WmiInstance
	...
	func NewMDM_WNSChannelEx1(instance *cim.WmiInstance) (newInstance *MDM_WNSChannel, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WNSChannel, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
