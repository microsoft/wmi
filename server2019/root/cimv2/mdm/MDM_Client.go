...
type MDM_Client struct { 
	*cim.WmiInstance
	...
	func NewMDM_ClientEx1(instance *cim.WmiInstance) (newInstance *MDM_Client, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Client, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Client) SendUnenrollRequest( /* IN */ DeviceClientID string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SendUnenrollRequest" , DeviceClientID);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_Client) LockWorkstation() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("LockWorkstation" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_Client) ResetUserPassword( /* IN */ ConfigString string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ResetUserPassword" , ConfigString);
	if err != nil { return }
	result = uint32(retVal)
	return
