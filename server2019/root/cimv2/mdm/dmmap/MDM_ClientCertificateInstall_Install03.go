...
type MDM_ClientCertificateInstall_Install03 struct { 
	*cim.WmiInstance
	...
	func NewMDM_ClientCertificateInstall_Install03Ex1(instance *cim.WmiInstance) (newInstance *MDM_ClientCertificateInstall_Install03, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ClientCertificateInstall_Install03, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_ClientCertificateInstall_Install03) EnrollMethod() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("EnrollMethod" );
	if err != nil { return }
