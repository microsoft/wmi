...
type MDM_WindowsDefenderApplicationGuard_Audit01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_WindowsDefenderApplicationGuard_Audit01Ex1(instance *cim.WmiInstance) (newInstance *MDM_WindowsDefenderApplicationGuard_Audit01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WindowsDefenderApplicationGuard_Audit01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
