...
type MDM_Policy_Config01_UserRights02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_UserRights02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_UserRights02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_UserRights02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_UserRights02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_UserRights02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyAccessCredentialManagerAsTrustedCaller()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyAccessFromNetwork()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyActAsPartOfTheOperatingSystem()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyAllowLocalLogOn()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyBackupFilesAndDirectories()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyChangeSystemTime()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyCreateGlobalObjects()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyCreatePageFile()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyCreatePermanentSharedObjects()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyCreateSymbolicLinks()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyCreateToken()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyDebugPrograms()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyDenyAccessFromNetwork()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyDenyLocalLogOn()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyDenyRemoteDesktopServicesLogOn()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyEnableDelegation()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyGenerateSecurityAudits()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyImpersonateClient()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyIncreaseSchedulingPriority()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyLoadUnloadDeviceDrivers()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyLockMemory()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyManageAuditingAndSecurityLog()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyManageVolume()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyModifyFirmwareEnvironment()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyModifyObjectLabel()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyProfileSingleProcess()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyRemoteShutdown()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyRestoreFilesAndDirectories()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_UserRights02) GetPropertyTakeOwnership()(value string, err error) { 
