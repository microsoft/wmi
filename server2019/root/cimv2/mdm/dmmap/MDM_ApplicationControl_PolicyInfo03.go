...
type MDM_ApplicationControl_PolicyInfo03 struct { 
	*cim.WmiInstance
	...
	func NewMDM_ApplicationControl_PolicyInfo03Ex1(instance *cim.WmiInstance) (newInstance *MDM_ApplicationControl_PolicyInfo03, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ApplicationControl_PolicyInfo03, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
