...
// MDM_Policy_Result01_DisplayEnhancement02 struct
type MDM_Policy_Result01_DisplayEnhancement02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_DisplayEnhancement02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_DisplayEnhancement02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_DisplayEnhancement02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_DisplayEnhancement02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_DisplayEnhancement02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyAutobrightnessLuxToNitsCurve(value string) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyAutobrightnessLuxToNitsCurve()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyDefaultAdaptiveColorAdaptationStrength(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyDefaultAdaptiveColorAdaptationStrength()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyDefaultBatterySaverBrightnessMultiplier(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyDefaultBatterySaverBrightnessMultiplier()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyDefaultBrightnessSliderPercentage(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyDefaultBrightnessSliderPercentage()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyDefaultDimBrightnessMultiplier(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyDefaultDimBrightnessMultiplier()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyInstanceID(value string) (err error) { 
    return instance.SetProperty("InstanceID", (value))
}

// GetInstanceID gets the value of InstanceID for the instance
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyIsAdaptiveColorOnByDefault(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyIsAdaptiveColorOnByDefault()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyIsAutobrightnessOnByDefault(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyIsAutobrightnessOnByDefault()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyParentID(value string) (err error) { 
    return instance.SetProperty("ParentID", (value))
}

// GetParentID gets the value of ParentID for the instance
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) SetPropertyShouldStopTransitionDuringHandsOnDisplay(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_DisplayEnhancement02) GetPropertyShouldStopTransitionDuringHandsOnDisplay()(value int32, err error) { 
