...
type MDM_DeviceStatus_OS01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_DeviceStatus_OS01Ex1(instance *cim.WmiInstance) (newInstance *MDM_DeviceStatus_OS01, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_DeviceStatus_OS01 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_DeviceStatus_OS01Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DeviceStatus_OS01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
