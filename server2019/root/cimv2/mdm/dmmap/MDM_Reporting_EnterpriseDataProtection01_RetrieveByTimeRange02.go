...
type MDM_Reporting_EnterpriseDataProtection01_RetrieveByTimeRange02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Reporting_EnterpriseDataProtection01_RetrieveByTimeRange02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Reporting_EnterpriseDataProtection01_RetrieveByTimeRange02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Reporting_EnterpriseDataProtection01_RetrieveByTimeRange02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
