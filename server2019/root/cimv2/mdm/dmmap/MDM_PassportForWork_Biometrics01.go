...
func NewMDM_PassportForWork_Biometrics01Ex1(instance *cim.WmiInstance) (newInstance *MDM_PassportForWork_Biometrics01, err error) {
...
func NewMDM_PassportForWork_Biometrics01Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_PassportForWork_Biometrics01, err error) {
