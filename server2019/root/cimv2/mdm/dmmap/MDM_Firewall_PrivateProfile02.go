...
type MDM_Firewall_PrivateProfile02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Firewall_PrivateProfile02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Firewall_PrivateProfile02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Firewall_PrivateProfile02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Firewall_PrivateProfile02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Firewall_PrivateProfile02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyAllowLocalIpsecPolicyMerge()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyAllowLocalPolicyMerge()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyAuthAppsAllowUserPrefMerge()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyDefaultInboundAction()(value int32, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyDefaultOutboundAction()(value int32, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyDisableInboundNotifications()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyDisableStealthMode()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyDisableStealthModeIpsecSecuredPacketExemption()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyDisableUnicastResponsesToMulticastBroadcast()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyEnableFirewall()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) SetPropertyEnableLogDroppedPackets(value bool) (err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyEnableLogDroppedPackets()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) SetPropertyEnableLogIgnoredRules(value bool) (err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyEnableLogIgnoredRules()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) SetPropertyEnableLogSuccessConnections(value bool) (err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyEnableLogSuccessConnections()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyGlobalPortsAllowUserPrefMerge()(value bool, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) SetPropertyLogFilePath(value string) (err error) { 
    return instance.SetProperty("LogFilePath", (value))
}

// GetLogFilePath gets the value of LogFilePath for the instance
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyLogFilePath()(value string, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) SetPropertyLogMaxFileSize(value int32) (err error) { 
    return instance.SetProperty("LogMaxFileSize", (value))
}

// GetLogMaxFileSize gets the value of LogMaxFileSize for the instance
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyLogMaxFileSize()(value int32, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Firewall_PrivateProfile02) GetPropertyShielded()(value bool, err error) { 
