...
type MDM_AppLocker_Script03 struct { 
	*cim.WmiInstance
	...
	func NewMDM_AppLocker_Script03Ex1(instance *cim.WmiInstance) (newInstance *MDM_AppLocker_Script03, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_AppLocker_Script03, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
