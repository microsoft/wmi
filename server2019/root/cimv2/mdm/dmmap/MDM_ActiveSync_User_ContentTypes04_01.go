...
type MDM_ActiveSync_User_ContentTypes04_01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_ActiveSync_User_ContentTypes04_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_ActiveSync_User_ContentTypes04_01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ActiveSync_User_ContentTypes04_01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
