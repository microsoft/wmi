...
// MDM_Policy_Config01_MSSLegacy02 struct
type MDM_Policy_Config01_MSSLegacy02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_MSSLegacy02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_MSSLegacy02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_MSSLegacy02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_MSSLegacy02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_MSSLegacy02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_MSSLegacy02) SetPropertyAllowICMPRedirectsToOverrideOSPFGeneratedRoutes(value string) (err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) GetPropertyAllowICMPRedirectsToOverrideOSPFGeneratedRoutes()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) SetPropertyAllowTheComputerToIgnoreNetBIOSNameReleaseRequestsExceptFromWINSServers(value string) (err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) GetPropertyAllowTheComputerToIgnoreNetBIOSNameReleaseRequestsExceptFromWINSServers()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) SetPropertyInstanceID(value string) (err error) { 
    return instance.SetProperty("InstanceID", (value))
}

// GetInstanceID gets the value of InstanceID for the instance
func (instance *MDM_Policy_Config01_MSSLegacy02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) SetPropertyIPSourceRoutingProtectionLevel(value string) (err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) GetPropertyIPSourceRoutingProtectionLevel()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) SetPropertyIPv6SourceRoutingProtectionLevel(value string) (err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) GetPropertyIPv6SourceRoutingProtectionLevel()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSLegacy02) SetPropertyParentID(value string) (err error) { 
    return instance.SetProperty("ParentID", (value))
}

// GetParentID gets the value of ParentID for the instance
func (instance *MDM_Policy_Config01_MSSLegacy02) GetPropertyParentID()(value string, err error) { 
