...
func NewMDM_eUICCs_Actions02Ex1(instance *cim.WmiInstance) (newInstance *MDM_eUICCs_Actions02, err error) {
...
func NewMDM_eUICCs_Actions02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_eUICCs_Actions02, err error) {
