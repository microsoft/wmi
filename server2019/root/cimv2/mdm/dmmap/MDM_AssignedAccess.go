...
type MDM_AssignedAccess struct { 
	*cim.WmiInstance
	...
	func NewMDM_AssignedAccessEx1(instance *cim.WmiInstance) (newInstance *MDM_AssignedAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_AssignedAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
