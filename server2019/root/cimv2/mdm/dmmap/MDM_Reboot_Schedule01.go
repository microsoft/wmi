...
type MDM_Reboot_Schedule01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Reboot_Schedule01Ex1(instance *cim.WmiInstance) (newInstance *MDM_Reboot_Schedule01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Reboot_Schedule01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
