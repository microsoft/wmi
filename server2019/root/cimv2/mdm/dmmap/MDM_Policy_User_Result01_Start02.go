...
type MDM_Policy_User_Result01_Start02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_User_Result01_Start02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_User_Result01_Start02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_User_Result01_Start02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_User_Result01_Start02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_User_Result01_Start02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyDisableContextMenus()(value int32, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyForceStartSize()(value int32, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyHideAppList()(value int32, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyHideFrequentlyUsedApps()(value int32, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyHidePeopleBar()(value int32, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyHideRecentJumplists()(value int32, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyHideRecentlyAddedApps()(value int32, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_User_Result01_Start02) GetPropertyStartLayout()(value string, err error) { 
