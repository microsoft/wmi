...
type MDM_Update_ApprovedUpdates01_01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Update_ApprovedUpdates01_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_Update_ApprovedUpdates01_01, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Update_ApprovedUpdates01_01 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Update_ApprovedUpdates01_01Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Update_ApprovedUpdates01_01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
