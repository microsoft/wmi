...
type MDM_Update struct { 
	*cim.WmiInstance
	...
	func NewMDM_UpdateEx1(instance *cim.WmiInstance) (newInstance *MDM_Update, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Update, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
