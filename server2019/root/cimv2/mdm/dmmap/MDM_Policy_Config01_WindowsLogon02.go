...
type MDM_Policy_Config01_WindowsLogon02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_WindowsLogon02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_WindowsLogon02, err error) {tmp, err := instance, nil
	...
	func NewMDM_Policy_Config01_WindowsLogon02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_WindowsLogon02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
