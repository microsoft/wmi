...
type MDM_SharedPC struct { 
	*cim.WmiInstance
	...
	func NewMDM_SharedPCEx1(instance *cim.WmiInstance) (newInstance *MDM_SharedPC, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_SharedPC, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
