...
type MDM_Policy_Config01_RemoteShell02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_RemoteShell02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_RemoteShell02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_RemoteShell02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_RemoteShell02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_RemoteShell02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertyAllowRemoteShellAccess()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertyMaxConcurrentUsers()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertySpecifyIdleTimeout()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertySpecifyMaxMemory()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertySpecifyMaxProcesses()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertySpecifyMaxRemoteShells()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_RemoteShell02) GetPropertySpecifyShellTimeout()(value string, err error) { 
