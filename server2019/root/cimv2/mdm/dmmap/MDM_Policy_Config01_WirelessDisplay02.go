...
type MDM_Policy_Config01_WirelessDisplay02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_WirelessDisplay02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_WirelessDisplay02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_WirelessDisplay02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_WirelessDisplay02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_WirelessDisplay02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_WirelessDisplay02) SetPropertyAllowMovementDetectionOnInfrastructure(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_WirelessDisplay02) GetPropertyAllowMovementDetectionOnInfrastructure()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_WirelessDisplay02) SetPropertyAllowPCReceiverToBeTCPServer(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_WirelessDisplay02) GetPropertyAllowPCReceiverToBeTCPServer()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_WirelessDisplay02) SetPropertyAllowPCSenderToBeTCPClient(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_WirelessDisplay02) GetPropertyAllowPCSenderToBeTCPClient()(value int32, err error) { 
