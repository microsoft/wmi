...
type MDM_EnterpriseModernAppManagement_AppManagement01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnterpriseModernAppManagement_AppManagement01Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseModernAppManagement_AppManagement01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnterpriseModernAppManagement_AppManagement01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_EnterpriseModernAppManagement_AppManagement01) UpdateScanMethod() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UpdateScanMethod" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_EnterpriseModernAppManagement_AppManagement01) RemovePackageMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemovePackageMethod" , param);
	if err != nil { return }
	result = uint32(retVal)
	return
