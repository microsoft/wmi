...
type MDM_Win32CompatibilityAppraiser_CompatibilityAppraiser01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Win32CompatibilityAppraiser_CompatibilityAppraiser01Ex1(instance *cim.WmiInstance) (newInstance *MDM_Win32CompatibilityAppraiser_CompatibilityAppraiser01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Win32CompatibilityAppraiser_CompatibilityAppraiser01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
