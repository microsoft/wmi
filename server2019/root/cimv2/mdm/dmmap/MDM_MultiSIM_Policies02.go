...
type MDM_MultiSIM_Policies02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_MultiSIM_Policies02Ex1(instance *cim.WmiInstance) (newInstance *MDM_MultiSIM_Policies02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_MultiSIM_Policies02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
