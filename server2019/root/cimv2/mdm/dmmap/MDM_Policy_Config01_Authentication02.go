...
type MDM_Policy_Config01_Authentication02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_Authentication02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_Authentication02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_Authentication02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_Authentication02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_Authentication02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyAllowAadPasswordReset(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyAllowAadPasswordReset()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyAllowFastReconnect(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyAllowFastReconnect()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyAllowSecondaryAuthenticationDevice(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyAllowSecondaryAuthenticationDevice()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyEnableFastFirstSignIn(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyEnableFastFirstSignIn()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyEnableWebSignIn(value int32) (err error) { 
    return instance.SetProperty("EnableWebSignIn", (value))
}

// GetEnableWebSignIn gets the value of EnableWebSignIn for the instance
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyEnableWebSignIn()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyInstanceID(value string) (err error) { 
    return instance.SetProperty("InstanceID", (value))
}

// GetInstanceID gets the value of InstanceID for the instance
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyParentID(value string) (err error) { 
    return instance.SetProperty("ParentID", (value))
}

// GetParentID gets the value of ParentID for the instance
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) SetPropertyPreferredAadTenantDomainName(value string) (err error) { 
...
func (instance *MDM_Policy_Config01_Authentication02) GetPropertyPreferredAadTenantDomainName()(value string, err error) { 
