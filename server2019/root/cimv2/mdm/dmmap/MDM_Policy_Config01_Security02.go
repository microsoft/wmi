...
type MDM_Policy_Config01_Security02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_Security02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_Security02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_Security02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_Security02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_Security02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyAllowAddProvisioningPackage(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyAllowAddProvisioningPackage()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyAllowRemoveProvisioningPackage(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyAllowRemoveProvisioningPackage()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyClearTPMIfNotReady(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyClearTPMIfNotReady()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyConfigureWindowsPasswords(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyConfigureWindowsPasswords()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyInstanceID(value string) (err error) { 
    return instance.SetProperty("InstanceID", (value))
}

// GetInstanceID gets the value of InstanceID for the instance
func (instance *MDM_Policy_Config01_Security02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyParentID(value string) (err error) { 
    return instance.SetProperty("ParentID", (value))
}

// GetParentID gets the value of ParentID for the instance
func (instance *MDM_Policy_Config01_Security02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyPreventAutomaticDeviceEncryptionForAzureADJoinedDevices(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyPreventAutomaticDeviceEncryptionForAzureADJoinedDevices()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyRecoveryEnvironmentAuthentication(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyRecoveryEnvironmentAuthentication()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyRequireDeviceEncryption(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyRequireDeviceEncryption()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyRequireProvisioningPackageSignature(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyRequireProvisioningPackageSignature()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Security02) SetPropertyRequireRetrieveHealthCertificateOnBoot(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Security02) GetPropertyRequireRetrieveHealthCertificateOnBoot()(value int32, err error) { 
