...
type MDM_Policy_Result01_WindowsConnectionManager02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_WindowsConnectionManager02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_WindowsConnectionManager02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_WindowsConnectionManager02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_WindowsConnectionManager02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_WindowsConnectionManager02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
