...
type MDM_EnterpriseModernAppManagement_AppManagement01_03 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnterpriseModernAppManagement_AppManagement01_03Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseModernAppManagement_AppManagement01_03, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnterpriseModernAppManagement_AppManagement01_03, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
