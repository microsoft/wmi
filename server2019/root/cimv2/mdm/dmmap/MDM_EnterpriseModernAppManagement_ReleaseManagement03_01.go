...
type MDM_EnterpriseModernAppManagement_ReleaseManagement03_01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnterpriseModernAppManagement_ReleaseManagement03_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseModernAppManagement_ReleaseManagement03_01, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_EnterpriseModernAppManagement_ReleaseManagement03_01 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_EnterpriseModernAppManagement_ReleaseManagement03_01Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnterpriseModernAppManagement_ReleaseManagement03_01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
