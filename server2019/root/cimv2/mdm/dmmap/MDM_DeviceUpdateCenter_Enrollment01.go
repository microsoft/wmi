...
type MDM_DeviceUpdateCenter_Enrollment01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_DeviceUpdateCenter_Enrollment01Ex1(instance *cim.WmiInstance) (newInstance *MDM_DeviceUpdateCenter_Enrollment01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DeviceUpdateCenter_Enrollment01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
