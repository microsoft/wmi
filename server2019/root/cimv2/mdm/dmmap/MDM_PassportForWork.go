...
type MDM_PassportForWork struct { 
	*cim.WmiInstance
	...
	func NewMDM_PassportForWorkEx1(instance *cim.WmiInstance) (newInstance *MDM_PassportForWork, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_PassportForWork, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
