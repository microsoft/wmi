...
type MDM_Policy_Result01_DeviceHealthMonitoring02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_DeviceHealthMonitoring02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_DeviceHealthMonitoring02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_DeviceHealthMonitoring02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_DeviceHealthMonitoring02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_DeviceHealthMonitoring02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_DeviceHealthMonitoring02) GetPropertyAllowDeviceHealthMonitoring()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_DeviceHealthMonitoring02) GetPropertyConfigDeviceHealthMonitoringScope()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_DeviceHealthMonitoring02) GetPropertyConfigDeviceHealthMonitoringUploadDestination()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_DeviceHealthMonitoring02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_DeviceHealthMonitoring02) GetPropertyParentID()(value string, err error) { 
