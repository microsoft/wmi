...
// MDM_Policy_Result01_Storage02 struct
type MDM_Policy_Result01_Storage02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_Storage02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_Storage02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_Storage02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_Storage02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_Storage02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyAllowDiskHealthModelUpdates(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyAllowDiskHealthModelUpdates()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyAllowStorageSenseGlobal(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyAllowStorageSenseGlobal()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyAllowStorageSenseTemporaryFilesCleanup(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyAllowStorageSenseTemporaryFilesCleanup()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyConfigStorageSenseCloudContentDehydrationThreshold(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyConfigStorageSenseCloudContentDehydrationThreshold()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyConfigStorageSenseDownloadsCleanupThreshold(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyConfigStorageSenseDownloadsCleanupThreshold()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyConfigStorageSenseGlobalCadence(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyConfigStorageSenseGlobalCadence()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyConfigStorageSenseRecycleBinCleanupThreshold(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyConfigStorageSenseRecycleBinCleanupThreshold()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyEnhancedStorageDevices(value string) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyEnhancedStorageDevices()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyInstanceID(value string) (err error) { 
    return instance.SetProperty("InstanceID", (value))
}

// GetInstanceID gets the value of InstanceID for the instance
func (instance *MDM_Policy_Result01_Storage02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyParentID(value string) (err error) { 
    return instance.SetProperty("ParentID", (value))
}

// GetParentID gets the value of ParentID for the instance
func (instance *MDM_Policy_Result01_Storage02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyRemovableDiskDenyWriteAccess(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyRemovableDiskDenyWriteAccess()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyWPDDevicesDenyReadAccessPerDevice(value string) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyWPDDevicesDenyReadAccessPerDevice()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) SetPropertyWPDDevicesDenyWriteAccessPerDevice(value string) (err error) { 
...
func (instance *MDM_Policy_Result01_Storage02) GetPropertyWPDDevicesDenyWriteAccessPerDevice()(value string, err error) { 
