...
type MDM_Reporting_SecurityAuditing01_RetrieveByCount02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Reporting_SecurityAuditing01_RetrieveByCount02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Reporting_SecurityAuditing01_RetrieveByCount02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Reporting_SecurityAuditing01_RetrieveByCount02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
