...
type MDM_PassportForWork_User_Policies02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_PassportForWork_User_Policies02Ex1(instance *cim.WmiInstance) (newInstance *MDM_PassportForWork_User_Policies02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_PassportForWork_User_Policies02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_PassportForWork_User_Policies02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_PassportForWork_User_Policies02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
