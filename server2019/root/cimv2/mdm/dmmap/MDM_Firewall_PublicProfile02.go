...
type MDM_Firewall_PublicProfile02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Firewall_PublicProfile02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Firewall_PublicProfile02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Firewall_PublicProfile02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
