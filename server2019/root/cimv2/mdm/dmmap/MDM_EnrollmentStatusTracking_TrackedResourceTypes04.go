...
type MDM_EnrollmentStatusTracking_TrackedResourceTypes04 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnrollmentStatusTracking_TrackedResourceTypes04Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnrollmentStatusTracking_TrackedResourceTypes04, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnrollmentStatusTracking_TrackedResourceTypes04, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
