...
type MDM_VPNv2_Sso03 struct { 
	*cim.WmiInstance
	...
	func NewMDM_VPNv2_Sso03Ex1(instance *cim.WmiInstance) (newInstance *MDM_VPNv2_Sso03, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_VPNv2_Sso03, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
