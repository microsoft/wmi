...
type MDM_Update_Rollback01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Update_Rollback01Ex1(instance *cim.WmiInstance) (newInstance *MDM_Update_Rollback01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Update_Rollback01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Update_Rollback01) QualityUpdateMethod() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("QualityUpdateMethod" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_Update_Rollback01) FeatureUpdateMethod() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("FeatureUpdateMethod" );
	if err != nil { return }
	result = uint32(retVal)
	return
