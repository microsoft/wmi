...
type MDM_Policy_Result01_MixedReality02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_MixedReality02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_MixedReality02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_MixedReality02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_MixedReality02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_MixedReality02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyAADGroupMembershipCacheValidityInDays(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyAADGroupMembershipCacheValidityInDays()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyAutomaticDisplayAdjustment(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyAutomaticDisplayAdjustment()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyBrightnessButtonDisabled(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyBrightnessButtonDisabled()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyEyeTrackingCalibrationPrompt(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyEyeTrackingCalibrationPrompt()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyFallbackDiagnostics(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyFallbackDiagnostics()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyHeadTrackingMode(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyHeadTrackingMode()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyInstanceID(value string) (err error) { 
    return instance.SetProperty("InstanceID", (value))
}

// GetInstanceID gets the value of InstanceID for the instance
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyMicrophoneDisabled(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyMicrophoneDisabled()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyParentID(value string) (err error) { 
    return instance.SetProperty("ParentID", (value))
}

// GetParentID gets the value of ParentID for the instance
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyVisitorAutoLogon(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyVisitorAutoLogon()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) SetPropertyVolumeButtonDisabled(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_MixedReality02) GetPropertyVolumeButtonDisabled()(value int32, err error) { 
