...
type MDM_WindowsLicensing_Subscriptions01_01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_WindowsLicensing_Subscriptions01_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_WindowsLicensing_Subscriptions01_01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WindowsLicensing_Subscriptions01_01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
