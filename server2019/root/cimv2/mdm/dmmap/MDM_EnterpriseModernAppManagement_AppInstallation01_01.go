...
type MDM_EnterpriseModernAppManagement_AppInstallation01_01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnterpriseModernAppManagement_AppInstallation01_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseModernAppManagement_AppInstallation01_01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnterpriseModernAppManagement_AppInstallation01_01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_EnterpriseModernAppManagement_AppInstallation01_01) StoreInstallMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("StoreInstallMethod" , param);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_EnterpriseModernAppManagement_AppInstallation01_01) HostedInstallMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("HostedInstallMethod" , param);
	if err != nil { return }
	result = uint32(retVal)
	return
