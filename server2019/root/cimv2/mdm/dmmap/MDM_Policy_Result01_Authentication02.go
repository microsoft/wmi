...
type MDM_Policy_Result01_Authentication02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_Authentication02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_Authentication02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_Authentication02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_Authentication02) SetPropertyConfigureWebSignInAllowedUrls(value string) (err error) { 
...
func (instance *MDM_Policy_Result01_Authentication02) GetPropertyConfigureWebSignInAllowedUrls()(value string, err error) { 
