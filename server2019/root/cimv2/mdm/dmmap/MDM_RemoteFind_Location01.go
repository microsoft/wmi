...
type MDM_RemoteFind_Location01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_RemoteFind_Location01Ex1(instance *cim.WmiInstance) (newInstance *MDM_RemoteFind_Location01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_RemoteFind_Location01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
