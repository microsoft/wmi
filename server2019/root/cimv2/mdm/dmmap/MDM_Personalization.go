...
type MDM_Personalization struct { 
	*cim.WmiInstance
	...
	func NewMDM_PersonalizationEx1(instance *cim.WmiInstance) (newInstance *MDM_Personalization, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Personalization, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
