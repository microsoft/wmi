...
func NewMDM_AppLocker_MSI03Ex1(instance *cim.WmiInstance) (newInstance *MDM_AppLocker_MSI03, err error) {
...
func NewMDM_AppLocker_MSI03Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_AppLocker_MSI03, err error) {
