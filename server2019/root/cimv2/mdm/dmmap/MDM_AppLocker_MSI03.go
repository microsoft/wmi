...
type MDM_AppLocker_MSI03 struct { 
	*cim.WmiInstance
	...
	func NewMDM_AppLocker_MSI03Ex1(instance *cim.WmiInstance) (newInstance *MDM_AppLocker_MSI03, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_AppLocker_MSI03 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_AppLocker_MSI03Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_AppLocker_MSI03, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
