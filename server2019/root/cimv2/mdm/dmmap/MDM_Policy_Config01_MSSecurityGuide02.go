...
type MDM_Policy_Config01_MSSecurityGuide02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_MSSecurityGuide02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_MSSecurityGuide02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_MSSecurityGuide02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_MSSecurityGuide02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_MSSecurityGuide02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyApplyUACRestrictionsToLocalAccountsOnNetworkLogon()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyConfigureSMBV1ClientDriver()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyConfigureSMBV1Server()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyEnableStructuredExceptionHandlingOverwriteProtection()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyTurnOnWindowsDefenderProtectionAgainstPotentiallyUnwantedApplications()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_MSSecurityGuide02) GetPropertyWDigestAuthentication()(value string, err error) { 
