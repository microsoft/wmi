...
type MDM_EnterpriseDataProtection struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnterpriseDataProtectionEx1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseDataProtection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnterpriseDataProtection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
