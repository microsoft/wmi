...
type MDM_Policy_User_Result01_Notifications02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_User_Result01_Notifications02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_User_Result01_Notifications02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_User_Result01_Notifications02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_User_Result01_Notifications02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_User_Result01_Notifications02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
