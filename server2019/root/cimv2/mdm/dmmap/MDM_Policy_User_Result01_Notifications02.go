...
func NewMDM_Policy_User_Result01_Notifications02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_User_Result01_Notifications02, err error) {
...
func NewMDM_Policy_User_Result01_Notifications02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Policy_User_Result01_Notifications02, err error) {
