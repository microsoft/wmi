...
type MDM_DevicePreparation_BootstrapperAgent01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_DevicePreparation_BootstrapperAgent01Ex1(instance *cim.WmiInstance) (newInstance *MDM_DevicePreparation_BootstrapperAgent01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DevicePreparation_BootstrapperAgent01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
