...
type MDM_WindowsAdvancedThreatProtection_Configuration01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_WindowsAdvancedThreatProtection_Configuration01Ex1(instance *cim.WmiInstance) (newInstance *MDM_WindowsAdvancedThreatProtection_Configuration01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WindowsAdvancedThreatProtection_Configuration01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
