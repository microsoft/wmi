...
type MDM_EnterpriseModernAppManagement_AutoUpdateSettings05 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnterpriseModernAppManagement_AutoUpdateSettings05Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseModernAppManagement_AutoUpdateSettings05, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnterpriseModernAppManagement_AutoUpdateSettings05, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
