...
func NewMDM_EnterpriseModernAppManagement_EffectiveRelease03Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseModernAppManagement_EffectiveRelease03, err error) {
...
func NewMDM_EnterpriseModernAppManagement_EffectiveRelease03Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_EnterpriseModernAppManagement_EffectiveRelease03, err error) {
