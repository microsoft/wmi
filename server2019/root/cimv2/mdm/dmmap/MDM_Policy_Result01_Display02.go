...
type MDM_Policy_Result01_Display02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_Display02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_Display02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_Display02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_Display02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_Display02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_Display02) GetPropertyDisablePerProcessDpiForApps()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Display02) GetPropertyEnablePerProcessDpi()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_Display02) GetPropertyEnablePerProcessDpiForApps()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Display02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Display02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Display02) GetPropertyTurnOffGdiDPIScalingForApps()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_Display02) GetPropertyTurnOnGdiDPIScalingForApps()(value string, err error) { 
