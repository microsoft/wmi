...
type MDM_Policy_Config01_KioskBrowser02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_KioskBrowser02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_KioskBrowser02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_KioskBrowser02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
