...
type MDM_SecureAssessment struct { 
	*cim.WmiInstance
	...
	func NewMDM_SecureAssessmentEx1(instance *cim.WmiInstance) (newInstance *MDM_SecureAssessment, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_SecureAssessment, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
