...
type MDM_Policy_Config01_Messaging02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_Messaging02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_Messaging02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_Messaging02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_Messaging02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_Messaging02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
