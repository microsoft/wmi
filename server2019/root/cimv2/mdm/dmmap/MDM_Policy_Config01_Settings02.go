...
type MDM_Policy_Config01_Settings02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_Settings02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_Settings02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_Settings02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_Settings02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_Settings02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowAutoPlay()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowDataSense()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowDateTime()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowEditDeviceName()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowLanguage()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowOnlineTips()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowPowerSleep()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowRegion()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowSignInOptions()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowVPN()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowWorkplace()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyAllowYourAccount()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) SetPropertyEnableBatteryCapacity(value int32) (err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyEnableBatteryCapacity()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyPageVisibilityList()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Settings02) GetPropertyParentID()(value string, err error) { 
