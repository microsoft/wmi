...
type MDM_WindowsLicensing struct { 
	*cim.WmiInstance
	...
	func NewMDM_WindowsLicensingEx1(instance *cim.WmiInstance) (newInstance *MDM_WindowsLicensing, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WindowsLicensing, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_WindowsLicensing) UpgradeEditionWithProductKeyMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UpgradeEditionWithProductKeyMethod" , param);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_WindowsLicensing) ChangeProductKeyMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ChangeProductKeyMethod" , param);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_WindowsLicensing) UpgradeEditionWithLicenseMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UpgradeEditionWithLicenseMethod" , param);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MDM_WindowsLicensing) CheckApplicabilityMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CheckApplicabilityMethod" , param);
	if err != nil { return }
	result = uint32(retVal)
	return
