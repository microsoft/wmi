...
type MDM_LanguagePackManagement_Install01_01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_LanguagePackManagement_Install01_01Ex1(instance *cim.WmiInstance) (newInstance *MDM_LanguagePackManagement_Install01_01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_LanguagePackManagement_Install01_01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_LanguagePackManagement_Install01_01) StartInstallationMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("StartInstallationMethod" , param);
	if err != nil { return }
