...
type MDM_Policy_Config01_Power02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_Power02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_Power02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_Power02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_Power02) SetPropertyAllowHibernate(value int32) (err error) { 
    return instance.SetProperty("AllowHibernate", (value))
}

// GetAllowHibernate gets the value of AllowHibernate for the instance
func (instance *MDM_Policy_Config01_Power02) GetPropertyAllowHibernate()(value int32, err error) { 
