...
type MDM_DeviceStatus struct { 
	*cim.WmiInstance
	...
	func NewMDM_DeviceStatusEx1(instance *cim.WmiInstance) (newInstance *MDM_DeviceStatus, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_DeviceStatus {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_DeviceStatusEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DeviceStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
