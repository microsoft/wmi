...
func NewMDM_DeviceStatusEx1(instance *cim.WmiInstance) (newInstance *MDM_DeviceStatus, err error) {
...
func NewMDM_DeviceStatusEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_DeviceStatus, err error) {
