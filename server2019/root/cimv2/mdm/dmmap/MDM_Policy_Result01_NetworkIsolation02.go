...
func NewMDM_Policy_Result01_NetworkIsolation02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_NetworkIsolation02, err error) {
...
func NewMDM_Policy_Result01_NetworkIsolation02Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MDM_Policy_Result01_NetworkIsolation02, err error) {
