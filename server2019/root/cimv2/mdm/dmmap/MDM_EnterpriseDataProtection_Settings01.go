...
type MDM_EnterpriseDataProtection_Settings01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnterpriseDataProtection_Settings01Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnterpriseDataProtection_Settings01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnterpriseDataProtection_Settings01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
