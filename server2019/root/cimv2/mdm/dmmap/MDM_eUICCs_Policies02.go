...
type MDM_eUICCs_Policies02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_eUICCs_Policies02Ex1(instance *cim.WmiInstance) (newInstance *MDM_eUICCs_Policies02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_eUICCs_Policies02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
