...
type MDM_DevDetail_Microsoft02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_DevDetail_Microsoft02Ex1(instance *cim.WmiInstance) (newInstance *MDM_DevDetail_Microsoft02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DevDetail_Microsoft02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
