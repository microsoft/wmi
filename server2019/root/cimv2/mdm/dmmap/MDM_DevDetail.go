...
type MDM_DevDetail struct { 
	*cim.WmiInstance
	...
	func NewMDM_DevDetailEx1(instance *cim.WmiInstance) (newInstance *MDM_DevDetail, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DevDetail, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
