...
type MDM_DevDetail_Ext01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_DevDetail_Ext01Ex1(instance *cim.WmiInstance) (newInstance *MDM_DevDetail_Ext01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DevDetail_Ext01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
