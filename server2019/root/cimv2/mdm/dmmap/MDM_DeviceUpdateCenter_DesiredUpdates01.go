...
type MDM_DeviceUpdateCenter_DesiredUpdates01 struct { 
	*cim.WmiInstance
	...
	func NewMDM_DeviceUpdateCenter_DesiredUpdates01Ex1(instance *cim.WmiInstance) (newInstance *MDM_DeviceUpdateCenter_DesiredUpdates01, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_DeviceUpdateCenter_DesiredUpdates01, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
