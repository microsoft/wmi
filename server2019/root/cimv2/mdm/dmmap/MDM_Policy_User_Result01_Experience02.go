...
type MDM_Policy_User_Result01_Experience02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_User_Result01_Experience02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_User_Result01_Experience02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_User_Result01_Experience02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_User_Result01_Experience02) SetPropertyAllowSpotlightCollection(value int32) (err error) { 
...
func (instance *MDM_Policy_User_Result01_Experience02) GetPropertyAllowSpotlightCollection()(value int32, err error) { 
