...
type MDM_RemoteFind struct { 
	*cim.WmiInstance
	...
	func NewMDM_RemoteFindEx1(instance *cim.WmiInstance) (newInstance *MDM_RemoteFind, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_RemoteFind, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
