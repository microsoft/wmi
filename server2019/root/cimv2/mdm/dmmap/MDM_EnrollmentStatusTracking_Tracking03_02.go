...
type MDM_EnrollmentStatusTracking_Tracking03_02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_EnrollmentStatusTracking_Tracking03_02Ex1(instance *cim.WmiInstance) (newInstance *MDM_EnrollmentStatusTracking_Tracking03_02, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_EnrollmentStatusTracking_Tracking03_02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
