...
type MDM_Policy_Config01_Defender02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_Defender02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_Defender02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_Defender02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_Defender02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_Defender02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowArchiveScanning()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowBehaviorMonitoring()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowCloudProtection()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowEmailScanning()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowFullScanOnMappedNetworkDrives()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowFullScanRemovableDriveScanning()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowIntrusionPreventionSystem()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowIOAVProtection()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowOnAccessProtection()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowRealtimeMonitoring()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowScanningNetworkFiles()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowScriptScanning()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAllowUserUIAccess()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAttackSurfaceReductionOnlyExclusions()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAttackSurfaceReductionRules()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyAvgCPULoadFactor()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyCheckForSignaturesBeforeRunningScan()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyCloudBlockLevel()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyCloudExtendedTimeout()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyControlledFolderAccessAllowedApplications()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyControlledFolderAccessProtectedFolders()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyDaysToRetainCleanedMalware()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyDisableCatchupFullScan()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyDisableCatchupQuickScan()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyEnableControlledFolderAccess()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyEnableLowCPUPriority()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyEnableNetworkProtection()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyExcludedExtensions()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyExcludedPaths()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyExcludedProcesses()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyPUAProtection()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyRealTimeScanDirection()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyScanParameter()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyScheduleQuickScanTime()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyScheduleScanDay()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyScheduleScanTime()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertySignatureUpdateFallbackOrder()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertySignatureUpdateFileSharesSources()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertySignatureUpdateInterval()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertySubmitSamplesConsent()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_Defender02) GetPropertyThreatSeverityDefaultAction()(value string, err error) { 
