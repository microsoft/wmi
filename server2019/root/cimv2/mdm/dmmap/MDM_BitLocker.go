...
type MDM_BitLocker struct { 
	*cim.WmiInstance
	...
	func NewMDM_BitLockerEx1(instance *cim.WmiInstance) (newInstance *MDM_BitLocker, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_BitLocker, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_BitLocker) RotateRecoveryPasswordsMethod( /* IN */ param string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RotateRecoveryPasswordsMethod" , param);
	if err != nil { return }
