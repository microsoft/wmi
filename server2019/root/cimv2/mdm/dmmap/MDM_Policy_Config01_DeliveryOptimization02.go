...
type MDM_Policy_Config01_DeliveryOptimization02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Config01_DeliveryOptimization02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Config01_DeliveryOptimization02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Config01_DeliveryOptimization02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Config01_DeliveryOptimization02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Config01_DeliveryOptimization02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOAbsoluteMaxCacheSize()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOAllowVPNPeerCaching()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOCacheHost()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDODelayForegroundDownloadFromHttp()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDODownloadMode()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOGroupId()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOGroupIdSource()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMaxCacheAge()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMaxCacheSize()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMinBackgroundQos()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMinBatteryPercentageAllowedToUpload()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMinDiskSizeAllowedToPeer()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMinFileSizeToCache()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMinRAMAllowedToPeer()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOModifyCacheDrive()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOMonthlyUploadDataCap()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOPercentageMaxForegroundBandwidth()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDORestrictPeerSelectionBy()(value int32, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOSetHoursToLimitBackgroundDownloadBandwidth()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyDOSetHoursToLimitForegroundDownloadBandwidth()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Config01_DeliveryOptimization02) GetPropertyParentID()(value string, err error) { 
