...
type MDM_Policy_Result01_System02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_System02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_System02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_System02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_System02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_System02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_System02) SetPropertyAllowDesktopAnalyticsProcessing(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_System02) GetPropertyAllowDesktopAnalyticsProcessing()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_System02) SetPropertyAllowMicrosoftManagedDesktopProcessing(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_System02) GetPropertyAllowMicrosoftManagedDesktopProcessing()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_System02) SetPropertyAllowUpdateComplianceProcessing(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_System02) GetPropertyAllowUpdateComplianceProcessing()(value int32, err error) { 
...
func (instance *MDM_Policy_Result01_System02) SetPropertyAllowWUfBCloudProcessing(value int32) (err error) { 
...
func (instance *MDM_Policy_Result01_System02) GetPropertyAllowWUfBCloudProcessing()(value int32, err error) { 
