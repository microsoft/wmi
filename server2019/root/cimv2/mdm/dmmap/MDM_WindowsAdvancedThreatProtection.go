...
type MDM_WindowsAdvancedThreatProtection struct { 
	*cim.WmiInstance
	...
	func NewMDM_WindowsAdvancedThreatProtectionEx1(instance *cim.WmiInstance) (newInstance *MDM_WindowsAdvancedThreatProtection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_WindowsAdvancedThreatProtection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
