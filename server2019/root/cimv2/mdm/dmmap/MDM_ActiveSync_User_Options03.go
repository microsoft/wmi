...
type MDM_ActiveSync_User_Options03 struct { 
	*cim.WmiInstance
	...
	func NewMDM_ActiveSync_User_Options03Ex1(instance *cim.WmiInstance) (newInstance *MDM_ActiveSync_User_Options03, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ActiveSync_User_Options03, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
