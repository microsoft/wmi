...
type MDM_Policy_Result01_RemoteManagement02 struct { 
	*cim.WmiInstance
	...
	func NewMDM_Policy_Result01_RemoteManagement02Ex1(instance *cim.WmiInstance) (newInstance *MDM_Policy_Result01_RemoteManagement02, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MDM_Policy_Result01_RemoteManagement02 {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMDM_Policy_Result01_RemoteManagement02Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_Policy_Result01_RemoteManagement02, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyAllowBasicAuthentication_Client()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyAllowBasicAuthentication_Service()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyAllowCredSSPAuthenticationClient()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyAllowCredSSPAuthenticationService()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyAllowRemoteServerManagement()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyAllowUnencryptedTraffic_Client()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyAllowUnencryptedTraffic_Service()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyDisallowDigestAuthentication()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyDisallowNegotiateAuthenticationClient()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyDisallowNegotiateAuthenticationService()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyDisallowStoringOfRunAsCredentials()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyInstanceID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyParentID()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertySpecifyChannelBindingTokenHardeningLevel()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyTrustedHosts()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyTurnOnCompatibilityHTTPListener()(value string, err error) { 
...
func (instance *MDM_Policy_Result01_RemoteManagement02) GetPropertyTurnOnCompatibilityHTTPSListener()(value string, err error) { 
