...
type MDM_ApplicationControl struct { 
	*cim.WmiInstance
	...
	func NewMDM_ApplicationControlEx1(instance *cim.WmiInstance) (newInstance *MDM_ApplicationControl, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MDM_ApplicationControl, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
