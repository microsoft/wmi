...
type MSFT_NetServiceStartFailed struct { 
	*MSFT_SCMEventLogEvent
	...
	func NewMSFT_NetServiceStartFailedEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetServiceStartFailed, err error) {tmp, err := NewMSFT_SCMEventLogEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetServiceStartFailed, err error) {tmp, err := NewMSFT_SCMEventLogEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
