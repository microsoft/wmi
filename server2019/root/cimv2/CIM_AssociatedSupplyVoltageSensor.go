...
type CIM_AssociatedSupplyVoltageSensor struct { 
	*CIM_AssociatedSensor
	...
	func NewCIM_AssociatedSupplyVoltageSensorEx1(instance *cim.WmiInstance) (newInstance *CIM_AssociatedSupplyVoltageSensor, err error) {tmp, err := NewCIM_AssociatedSensorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AssociatedSupplyVoltageSensor, err error) {tmp, err := NewCIM_AssociatedSensorEx6(hostName, wmiNamespace, userName, password, domainName, query)
