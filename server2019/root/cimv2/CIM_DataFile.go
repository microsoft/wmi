...
type CIM_DataFile struct { 
	*CIM_LogicalFile
	...
	func NewCIM_DataFileEx1(instance *cim.WmiInstance) (newInstance *CIM_DataFile, err error) {tmp, err := NewCIM_LogicalFileEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DataFile, err error) {tmp, err := NewCIM_LogicalFileEx6(hostName, wmiNamespace, userName, password, domainName, query)
