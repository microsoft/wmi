...
type CIM_Container struct { 
	*CIM_Component
	...
	func NewCIM_ContainerEx1(instance *cim.WmiInstance) (newInstance *CIM_Container, err error) {tmp, err := NewCIM_ComponentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Container, err error) {tmp, err := NewCIM_ComponentEx6(hostName, wmiNamespace, userName, password, domainName, query)
