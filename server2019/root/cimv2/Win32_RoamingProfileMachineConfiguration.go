...
type Win32_RoamingProfileMachineConfiguration struct { 
	*cim.WmiInstance
	...
	func NewWin32_RoamingProfileMachineConfigurationEx1(instance *cim.WmiInstance) (newInstance *Win32_RoamingProfileMachineConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RoamingProfileMachineConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
