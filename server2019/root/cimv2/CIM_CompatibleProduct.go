...
type CIM_CompatibleProduct struct { 
	*cim.WmiInstance
	...
	func NewCIM_CompatibleProductEx1(instance *cim.WmiInstance) (newInstance *CIM_CompatibleProduct, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CompatibleProduct, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
