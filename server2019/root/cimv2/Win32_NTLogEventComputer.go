...
type Win32_NTLogEventComputer struct { 
	*cim.WmiInstance
	...
	func NewWin32_NTLogEventComputerEx1(instance *cim.WmiInstance) (newInstance *Win32_NTLogEventComputer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_NTLogEventComputer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
