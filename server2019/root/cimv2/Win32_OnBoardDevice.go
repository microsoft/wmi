...
type Win32_OnBoardDevice struct { 
	*CIM_PhysicalComponent
	...
	func NewWin32_OnBoardDeviceEx1(instance *cim.WmiInstance) (newInstance *Win32_OnBoardDevice, err error) {tmp, err := NewCIM_PhysicalComponentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_OnBoardDevice, err error) {tmp, err := NewCIM_PhysicalComponentEx6(hostName, wmiNamespace, userName, password, domainName, query)
