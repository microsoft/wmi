...
type Win32_DCOMApplicationLaunchAllowedSetting struct { 
	*cim.WmiInstance
	...
	func NewWin32_DCOMApplicationLaunchAllowedSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_DCOMApplicationLaunchAllowedSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DCOMApplicationLaunchAllowedSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
