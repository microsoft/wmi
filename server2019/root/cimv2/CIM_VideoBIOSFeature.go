...
type CIM_VideoBIOSFeature struct { 
	*CIM_SoftwareFeature
	...
	func NewCIM_VideoBIOSFeatureEx1(instance *cim.WmiInstance) (newInstance *CIM_VideoBIOSFeature, err error) {tmp, err := NewCIM_SoftwareFeatureEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VideoBIOSFeature, err error) {tmp, err := NewCIM_SoftwareFeatureEx6(hostName, wmiNamespace, userName, password, domainName, query)
