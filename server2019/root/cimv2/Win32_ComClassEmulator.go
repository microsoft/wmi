...
type Win32_ComClassEmulator struct { 
	*cim.WmiInstance
	...
	func NewWin32_ComClassEmulatorEx1(instance *cim.WmiInstance) (newInstance *Win32_ComClassEmulator, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ComClassEmulator, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
