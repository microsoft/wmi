...
type Win32_LUID struct { 
	*cim.WmiInstance
	...
	func NewWin32_LUIDEx1(instance *cim.WmiInstance) (newInstance *Win32_LUID, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_LUID, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
