...
type Win32_RoamingUserHealthConfiguration struct { 
	*cim.WmiInstance
	...
	func NewWin32_RoamingUserHealthConfigurationEx1(instance *cim.WmiInstance) (newInstance *Win32_RoamingUserHealthConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RoamingUserHealthConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
