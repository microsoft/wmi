...
type Win32_AccountSID struct { 
	*cim.WmiInstance
	...
	func NewWin32_AccountSIDEx1(instance *cim.WmiInstance) (newInstance *Win32_AccountSID, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_AccountSID, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
