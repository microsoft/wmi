...
type CIM_AdjacentSlots struct { 
	*cim.WmiInstance
	...
	func NewCIM_AdjacentSlotsEx1(instance *cim.WmiInstance) (newInstance *CIM_AdjacentSlots, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AdjacentSlots, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
