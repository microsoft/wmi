...
func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterGlobalUpdateManagerMessagesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterGlobalUpdateManagerMessages, err error) {
...
func NewWin32_PerfFormattedData_ClussvcPerfProvider_ClusterGlobalUpdateManagerMessagesEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_ClussvcPerfProvider_ClusterGlobalUpdateManagerMessages, err error) {
