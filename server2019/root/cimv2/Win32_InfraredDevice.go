...
type Win32_InfraredDevice struct { 
	*CIM_InfraredController
	...
	func NewWin32_InfraredDeviceEx1(instance *cim.WmiInstance) (newInstance *Win32_InfraredDevice, err error) {tmp, err := NewCIM_InfraredControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_InfraredDevice, err error) {tmp, err := NewCIM_InfraredControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
