...
type CIM_Chassis struct { 
	*CIM_PhysicalFrame
	...
	func NewCIM_ChassisEx1(instance *cim.WmiInstance) (newInstance *CIM_Chassis, err error) {tmp, err := NewCIM_PhysicalFrameEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Chassis, err error) {tmp, err := NewCIM_PhysicalFrameEx6(hostName, wmiNamespace, userName, password, domainName, query)
