...
type Win32_ServiceSpecificationService struct { 
	*cim.WmiInstance
	...
	func NewWin32_ServiceSpecificationServiceEx1(instance *cim.WmiInstance) (newInstance *Win32_ServiceSpecificationService, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ServiceSpecificationService, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
