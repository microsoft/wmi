...
type CIM_DiscreteSensor struct { 
	*CIM_Sensor
	...
	func NewCIM_DiscreteSensorEx1(instance *cim.WmiInstance) (newInstance *CIM_DiscreteSensor, err error) {tmp, err := NewCIM_SensorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DiscreteSensor, err error) {tmp, err := NewCIM_SensorEx6(hostName, wmiNamespace, userName, password, domainName, query)
