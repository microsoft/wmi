...
type Win32_PnPDeviceProperty struct { 
	*cim.WmiInstance
	...
	func NewWin32_PnPDevicePropertyEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPDeviceProperty, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDeviceProperty, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
