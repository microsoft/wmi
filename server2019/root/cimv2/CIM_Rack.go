...
type CIM_Rack struct { 
	*CIM_PhysicalFrame
	...
	func NewCIM_RackEx1(instance *cim.WmiInstance) (newInstance *CIM_Rack, err error) {tmp, err := NewCIM_PhysicalFrameEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Rack, err error) {tmp, err := NewCIM_PhysicalFrameEx6(hostName, wmiNamespace, userName, password, domainName, query)
