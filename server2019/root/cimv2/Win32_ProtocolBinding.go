...
type Win32_ProtocolBinding struct { 
	*cim.WmiInstance
	...
	func NewWin32_ProtocolBindingEx1(instance *cim.WmiInstance) (newInstance *Win32_ProtocolBinding, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ProtocolBinding, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
