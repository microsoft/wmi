...
type CIM_Slot struct { 
	*CIM_PhysicalConnector
	...
	func NewCIM_SlotEx1(instance *cim.WmiInstance) (newInstance *CIM_Slot, err error) {tmp, err := NewCIM_PhysicalConnectorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Slot, err error) {tmp, err := NewCIM_PhysicalConnectorEx6(hostName, wmiNamespace, userName, password, domainName, query)
