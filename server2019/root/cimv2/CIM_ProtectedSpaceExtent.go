...
type CIM_ProtectedSpaceExtent struct { 
	*CIM_StorageExtent
	...
	func NewCIM_ProtectedSpaceExtentEx1(instance *cim.WmiInstance) (newInstance *CIM_ProtectedSpaceExtent, err error) {tmp, err := NewCIM_StorageExtentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProtectedSpaceExtent, err error) {tmp, err := NewCIM_StorageExtentEx6(hostName, wmiNamespace, userName, password, domainName, query)
