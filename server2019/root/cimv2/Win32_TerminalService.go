...
type Win32_TerminalService struct { 
	*Win32_Service
	...
	func NewWin32_TerminalServiceEx1(instance *cim.WmiInstance) (newInstance *Win32_TerminalService, err error) {tmp, err := NewWin32_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_TerminalService, err error) {tmp, err := NewWin32_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
