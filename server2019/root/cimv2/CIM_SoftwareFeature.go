...
type CIM_SoftwareFeature struct { 
	*CIM_LogicalElement
	...
	func NewCIM_SoftwareFeatureEx1(instance *cim.WmiInstance) (newInstance *CIM_SoftwareFeature, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SoftwareFeature, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
