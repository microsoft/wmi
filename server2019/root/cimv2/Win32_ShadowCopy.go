...
type Win32_ShadowCopy struct { 
	*CIM_LogicalElement
	...
	func NewWin32_ShadowCopyEx1(instance *cim.WmiInstance) (newInstance *Win32_ShadowCopy, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ShadowCopy, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_ShadowCopy) Create( /* IN */ Volume string,
 /* IN */ Context string,
 /* OUT */ ShadowID string) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , Volume, Context)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_ShadowCopy) Revert( /* IN */ ForceDismount bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Revert" , ForceDismount);
	if err != nil { return }
