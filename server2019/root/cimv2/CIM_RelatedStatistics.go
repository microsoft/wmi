...
type CIM_RelatedStatistics struct { 
	*cim.WmiInstance
	...
	func NewCIM_RelatedStatisticsEx1(instance *cim.WmiInstance) (newInstance *CIM_RelatedStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RelatedStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
