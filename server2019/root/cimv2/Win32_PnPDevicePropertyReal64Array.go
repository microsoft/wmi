...
type Win32_PnPDevicePropertyReal64Array struct { 
	*Win32_PnPDeviceProperty
	...
	func NewWin32_PnPDevicePropertyReal64ArrayEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPDevicePropertyReal64Array, err error) {tmp, err := NewWin32_PnPDevicePropertyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDevicePropertyReal64Array, err error) {tmp, err := NewWin32_PnPDevicePropertyEx6(hostName, wmiNamespace, userName, password, domainName, query)
