...
type Win32_PnPSignedDriver struct { 
	*CIM_Service
	...
	func NewWin32_PnPSignedDriverEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPSignedDriver, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPSignedDriver, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
