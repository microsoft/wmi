...
type CIM_VideoController struct { 
	*CIM_Controller
	...
	func NewCIM_VideoControllerEx1(instance *cim.WmiInstance) (newInstance *CIM_VideoController, err error) {tmp, err := NewCIM_ControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VideoController, err error) {tmp, err := NewCIM_ControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
