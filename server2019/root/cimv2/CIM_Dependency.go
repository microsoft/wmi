...
type CIM_Dependency struct { 
	*cim.WmiInstance
	...
	func NewCIM_DependencyEx1(instance *cim.WmiInstance) (newInstance *CIM_Dependency, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Dependency, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
