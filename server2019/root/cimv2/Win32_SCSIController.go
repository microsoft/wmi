...
type Win32_SCSIController struct { 
	*CIM_SCSIController
	...
	func NewWin32_SCSIControllerEx1(instance *cim.WmiInstance) (newInstance *Win32_SCSIController, err error) {tmp, err := NewCIM_SCSIControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SCSIController, err error) {tmp, err := NewCIM_SCSIControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
