...
type Win32_PerfRawData_ClussvcPerfProvider_ClusterCheckpointManager struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterCheckpointManagerEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterCheckpointManager, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterCheckpointManager, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
