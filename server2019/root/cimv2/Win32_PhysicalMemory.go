...
type Win32_PhysicalMemory struct { 
	*CIM_PhysicalMemory
	...
	func NewWin32_PhysicalMemoryEx1(instance *cim.WmiInstance) (newInstance *Win32_PhysicalMemory, err error) {tmp, err := NewCIM_PhysicalMemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PhysicalMemory, err error) {tmp, err := NewCIM_PhysicalMemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
