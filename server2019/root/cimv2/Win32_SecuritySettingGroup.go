...
type Win32_SecuritySettingGroup struct { 
	*cim.WmiInstance
	...
	func NewWin32_SecuritySettingGroupEx1(instance *cim.WmiInstance) (newInstance *Win32_SecuritySettingGroup, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SecuritySettingGroup, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
