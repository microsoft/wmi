...
type Win32_ScheduledJob struct { 
	*CIM_Job
	...
	func NewWin32_ScheduledJobEx1(instance *cim.WmiInstance) (newInstance *Win32_ScheduledJob, err error) {tmp, err := NewCIM_JobEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ScheduledJob, err error) {tmp, err := NewCIM_JobEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_ScheduledJob) Create( /* IN */ Command string,
 ...
 /* OUT */ JobId uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , Command, StartTime, RunRepeatedly, DaysOfWeek, DaysOfMonth, InteractWithDesktop)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_ScheduledJob) Delete() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Delete" );
	if err != nil { return }
