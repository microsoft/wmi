...
type Win32_ClassicCOMClass struct { 
	*Win32_COMClass
	...
	func NewWin32_ClassicCOMClassEx1(instance *cim.WmiInstance) (newInstance *Win32_ClassicCOMClass, err error) {tmp, err := NewWin32_COMClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ClassicCOMClass, err error) {tmp, err := NewWin32_COMClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
