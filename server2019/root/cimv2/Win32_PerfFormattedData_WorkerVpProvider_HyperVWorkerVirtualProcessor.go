...
type Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessorEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor) SetPropertyInitialAPICID(value uint64) (err error) { 
    return instance.SetProperty("InitialAPICID", (value))
}

// GetInitialAPICID gets the value of InitialAPICID for the instance
func (instance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor) GetPropertyInitialAPICID()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor) SetPropertyMPIDR(value uint64) (err error) { 
    return instance.SetProperty("MPIDR", (value))
}

// GetMPIDR gets the value of MPIDR for the instance
func (instance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor) GetPropertyMPIDR()(value uint64, err error) { 
...
func (instance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor) SetPropertyTargetSubnode(value uint64) (err error) { 
    return instance.SetProperty("TargetSubnode", (value))
}

// GetTargetSubnode gets the value of TargetSubnode for the instance
func (instance *Win32_PerfFormattedData_WorkerVpProvider_HyperVWorkerVirtualProcessor) GetPropertyTargetSubnode()(value uint64, err error) { 
