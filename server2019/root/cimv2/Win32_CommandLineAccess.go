...
type Win32_CommandLineAccess struct { 
	*CIM_ServiceAccessPoint
	...
	func NewWin32_CommandLineAccessEx1(instance *cim.WmiInstance) (newInstance *Win32_CommandLineAccess, err error) {tmp, err := NewCIM_ServiceAccessPointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CommandLineAccess, err error) {tmp, err := NewCIM_ServiceAccessPointEx6(hostName, wmiNamespace, userName, password, domainName, query)
