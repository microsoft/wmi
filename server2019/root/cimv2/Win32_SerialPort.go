...
type Win32_SerialPort struct { 
	*CIM_SerialController
	...
	func NewWin32_SerialPortEx1(instance *cim.WmiInstance) (newInstance *Win32_SerialPort, err error) {tmp, err := NewCIM_SerialControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SerialPort, err error) {tmp, err := NewCIM_SerialControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
