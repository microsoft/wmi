...
type CIM_Statistics struct { 
	*cim.WmiInstance
	...
	func NewCIM_StatisticsEx1(instance *cim.WmiInstance) (newInstance *CIM_Statistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Statistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
