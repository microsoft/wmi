...
type Win32_PerfFormattedData_HvStats_HyperVHypervisorRootPartition struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_HvStats_HyperVHypervisorRootPartitionEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_HvStats_HyperVHypervisorRootPartition, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_HvStats_HyperVHypervisorRootPartition, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfFormattedData_HvStats_HyperVHypervisorRootPartition) SetPropertyCPPCRequestedPerformanceLevel(value uint64) (err error) { 
...
func (instance *Win32_PerfFormattedData_HvStats_HyperVHypervisorRootPartition) GetPropertyCPPCRequestedPerformanceLevel()(value uint64, err error) { 
