...
type CIM_SoftwareElementActions struct { 
	*cim.WmiInstance
	...
	func NewCIM_SoftwareElementActionsEx1(instance *cim.WmiInstance) (newInstance *CIM_SoftwareElementActions, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SoftwareElementActions, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
