...
type CIM_AlarmDevice struct { 
	*CIM_LogicalDevice
	...
	func NewCIM_AlarmDeviceEx1(instance *cim.WmiInstance) (newInstance *CIM_AlarmDevice, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AlarmDevice, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_AlarmDevice) SetUrgency( /* IN */ RequestedUrgency uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetUrgency" , RequestedUrgency);
	if err != nil { return }
