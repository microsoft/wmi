...
type Win32_Process struct { 
	*CIM_Process
	...
	func NewWin32_ProcessEx1(instance *cim.WmiInstance) (newInstance *Win32_Process, err error) {tmp, err := NewCIM_ProcessEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Process, err error) {tmp, err := NewCIM_ProcessEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_Process) Create( /* IN */ CommandLine string,
 ...
 /* OUT */ ProcessId uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , CommandLine, CurrentDirectory, ProcessStartupInformation)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Process) Terminate( /* IN */ Reason uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Terminate" , Reason);
	if err != nil { return }
...
func (instance *Win32_Process) GetOwner( /* OUT */ User string,
 /* OUT */ Domain string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetOwner" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Win32_Process) GetOwnerSid( /* OUT */ Sid string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetOwnerSid" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Process) SetPriority( /* IN */ Priority int32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPriority" , Priority);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Process) AttachDebugger() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AttachDebugger" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Process) GetAvailableVirtualSize( /* OUT */ AvailableVirtualSize uint64) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetAvailableVirtualSize" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
