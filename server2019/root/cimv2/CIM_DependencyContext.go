...
type CIM_DependencyContext struct { 
	*cim.WmiInstance
	...
	func NewCIM_DependencyContextEx1(instance *cim.WmiInstance) (newInstance *CIM_DependencyContext, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DependencyContext, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
