...
func NewWin32_PerfRawData_Counters_IPHTTPSGlobalEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_IPHTTPSGlobal, err error) {
...
func NewWin32_PerfRawData_Counters_IPHTTPSGlobalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_Counters_IPHTTPSGlobal, err error) {
