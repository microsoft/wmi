...
type MSFT_WmiFilterEvent struct { 
	*MSFT_WmiEssEvent
	...
	func NewMSFT_WmiFilterEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_WmiFilterEvent, err error) {tmp, err := NewMSFT_WmiEssEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WmiFilterEvent, err error) {tmp, err := NewMSFT_WmiEssEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
