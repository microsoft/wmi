...
type CIM_PhysicalFrame struct { 
	*CIM_PhysicalPackage
	...
	func NewCIM_PhysicalFrameEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalFrame, err error) {tmp, err := NewCIM_PhysicalPackageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalFrame, err error) {tmp, err := NewCIM_PhysicalPackageEx6(hostName, wmiNamespace, userName, password, domainName, query)
