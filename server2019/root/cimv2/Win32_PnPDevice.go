...
type Win32_PnPDevice struct { 
	*cim.WmiInstance
	...
	func NewWin32_PnPDeviceEx1(instance *cim.WmiInstance) (newInstance *Win32_PnPDevice, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PnPDevice, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
