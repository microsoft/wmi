...
type Win32_CollectionStatistics struct { 
	*cim.WmiInstance
	...
	func NewWin32_CollectionStatisticsEx1(instance *cim.WmiInstance) (newInstance *Win32_CollectionStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CollectionStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
