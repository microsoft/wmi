...
type Win32_VideoController struct { 
	*CIM_PCVideoController
	...
	func NewWin32_VideoControllerEx1(instance *cim.WmiInstance) (newInstance *Win32_VideoController, err error) {tmp, err := NewCIM_PCVideoControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_VideoController, err error) {tmp, err := NewCIM_PCVideoControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
