...
type Win32_PageFileUsage struct { 
	*CIM_LogicalElement
	...
	func NewWin32_PageFileUsageEx1(instance *cim.WmiInstance) (newInstance *Win32_PageFileUsage, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PageFileUsage, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
