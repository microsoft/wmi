...
type CIM_DiskSpaceCheck struct { 
	*CIM_Check
	...
	func NewCIM_DiskSpaceCheckEx1(instance *cim.WmiInstance) (newInstance *CIM_DiskSpaceCheck, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DiskSpaceCheck, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
