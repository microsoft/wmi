...
type Win32_ServerConnection struct { 
	*CIM_LogicalElement
	...
	func NewWin32_ServerConnectionEx1(instance *cim.WmiInstance) (newInstance *Win32_ServerConnection, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ServerConnection, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
