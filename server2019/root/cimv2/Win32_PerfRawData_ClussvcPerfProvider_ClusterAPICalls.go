...
type Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterAPICallsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls {
	...
	func NewWin32_PerfRawData_ClussvcPerfProvider_ClusterAPICallsEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyClusterAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyGroupAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyKeyAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyNetworkAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyNetworkInterfaceAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyNodeAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyNotificationAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyNotificationBatchAPICallsPersec()(value uint64, err error) { 
...
func (instance *Win32_PerfRawData_ClussvcPerfProvider_ClusterAPICalls) GetPropertyResourceAPICallsPersec()(value uint64, err error) { 
