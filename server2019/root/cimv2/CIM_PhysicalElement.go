...
type CIM_PhysicalElement struct { 
	*CIM_ManagedSystemElement
	...
	func NewCIM_PhysicalElementEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalElement, err error) {tmp, err := NewCIM_ManagedSystemElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalElement, err error) {tmp, err := NewCIM_ManagedSystemElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
