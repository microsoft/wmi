...
type MSFT_NCProvNewQuery struct { 
	*MSFT_NCProvEvent
	...
	func NewMSFT_NCProvNewQueryEx1(instance *cim.WmiInstance) (newInstance *MSFT_NCProvNewQuery, err error) {tmp, err := NewMSFT_NCProvEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NCProvNewQuery, err error) {tmp, err := NewMSFT_NCProvEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
