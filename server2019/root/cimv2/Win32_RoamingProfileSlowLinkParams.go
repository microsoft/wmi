...
type Win32_RoamingProfileSlowLinkParams struct { 
	*cim.WmiInstance
	...
	func NewWin32_RoamingProfileSlowLinkParamsEx1(instance *cim.WmiInstance) (newInstance *Win32_RoamingProfileSlowLinkParams, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RoamingProfileSlowLinkParams, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
