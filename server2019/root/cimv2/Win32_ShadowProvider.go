...
type Win32_ShadowProvider struct { 
	*CIM_LogicalElement
	...
	func NewWin32_ShadowProviderEx1(instance *cim.WmiInstance) (newInstance *Win32_ShadowProvider, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ShadowProvider, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
