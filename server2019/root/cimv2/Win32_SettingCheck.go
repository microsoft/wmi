...
type Win32_SettingCheck struct { 
	*cim.WmiInstance
	...
	func NewWin32_SettingCheckEx1(instance *cim.WmiInstance) (newInstance *Win32_SettingCheck, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SettingCheck, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
