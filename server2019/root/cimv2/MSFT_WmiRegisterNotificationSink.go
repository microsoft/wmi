...
type MSFT_WmiRegisterNotificationSink struct { 
	*MSFT_WmiEssEvent
	...
	func NewMSFT_WmiRegisterNotificationSinkEx1(instance *cim.WmiInstance) (newInstance *MSFT_WmiRegisterNotificationSink, err error) {tmp, err := NewMSFT_WmiEssEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WmiRegisterNotificationSink, err error) {tmp, err := NewMSFT_WmiEssEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
