...
type CIM_SCSIController struct { 
	*CIM_Controller
	...
	func NewCIM_SCSIControllerEx1(instance *cim.WmiInstance) (newInstance *CIM_SCSIController, err error) {tmp, err := NewCIM_ControllerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SCSIController, err error) {tmp, err := NewCIM_ControllerEx6(hostName, wmiNamespace, userName, password, domainName, query)
