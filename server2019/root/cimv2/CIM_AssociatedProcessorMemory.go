...
type CIM_AssociatedProcessorMemory struct { 
	*CIM_AssociatedMemory
	...
	func NewCIM_AssociatedProcessorMemoryEx1(instance *cim.WmiInstance) (newInstance *CIM_AssociatedProcessorMemory, err error) {tmp, err := NewCIM_AssociatedMemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AssociatedProcessorMemory, err error) {tmp, err := NewCIM_AssociatedMemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
