...
type Win32_DeviceMemoryAddress struct { 
	*Win32_SystemMemoryResource
	...
	func NewWin32_DeviceMemoryAddressEx1(instance *cim.WmiInstance) (newInstance *Win32_DeviceMemoryAddress, err error) {tmp, err := NewWin32_SystemMemoryResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DeviceMemoryAddress, err error) {tmp, err := NewWin32_SystemMemoryResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
