...
type Win32_ClassicCOMClassSetting struct { 
	*Win32_COMSetting
	...
	func NewWin32_ClassicCOMClassSettingEx1(instance *cim.WmiInstance) (newInstance *Win32_ClassicCOMClassSetting, err error) {tmp, err := NewWin32_COMSettingEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ClassicCOMClassSetting, err error) {tmp, err := NewWin32_COMSettingEx6(hostName, wmiNamespace, userName, password, domainName, query)
