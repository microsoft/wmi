...
type CIM_PhysicalPackage struct { 
	*CIM_PhysicalElement
	...
	func NewCIM_PhysicalPackageEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalPackage, err error) {tmp, err := NewCIM_PhysicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalPackage, err error) {tmp, err := NewCIM_PhysicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_PhysicalPackage) IsCompatible( /* IN */ ElementToCheck CIM_PhysicalElement) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("IsCompatible" , ElementToCheck);
	if err != nil { return }
