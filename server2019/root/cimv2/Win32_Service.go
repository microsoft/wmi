...
type Win32_Service struct { 
	*Win32_BaseService
	...
	func NewWin32_ServiceEx1(instance *cim.WmiInstance) (newInstance *Win32_Service, err error) {tmp, err := NewWin32_BaseServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Service, err error) {tmp, err := NewWin32_BaseServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_Service) GetSecurityDescriptor( /* OUT */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSecurityDescriptor" )
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_Service) SetSecurityDescriptor( /* IN */ Descriptor Win32_SecurityDescriptor) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSecurityDescriptor" , Descriptor);
	if err != nil { return }
