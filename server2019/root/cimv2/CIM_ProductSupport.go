...
type CIM_ProductSupport struct { 
	*cim.WmiInstance
	...
	func NewCIM_ProductSupportEx1(instance *cim.WmiInstance) (newInstance *CIM_ProductSupport, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProductSupport, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
