...
type CIM_ParticipatesInSet struct { 
	*cim.WmiInstance
	...
	func NewCIM_ParticipatesInSetEx1(instance *cim.WmiInstance) (newInstance *CIM_ParticipatesInSet, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ParticipatesInSet, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
