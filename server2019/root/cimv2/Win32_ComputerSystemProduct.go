...
type Win32_ComputerSystemProduct struct { 
	*CIM_Product
	...
	func NewWin32_ComputerSystemProductEx1(instance *cim.WmiInstance) (newInstance *Win32_ComputerSystemProduct, err error) {tmp, err := NewCIM_ProductEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ComputerSystemProduct, err error) {tmp, err := NewCIM_ProductEx6(hostName, wmiNamespace, userName, password, domainName, query)
