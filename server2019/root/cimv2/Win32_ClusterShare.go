...
type Win32_ClusterShare struct { 
	*Win32_Share
	...
	func NewWin32_ClusterShareEx1(instance *cim.WmiInstance) (newInstance *Win32_ClusterShare, err error) {tmp, err := NewWin32_ShareEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ClusterShare, err error) {tmp, err := NewWin32_ShareEx6(hostName, wmiNamespace, userName, password, domainName, query)
