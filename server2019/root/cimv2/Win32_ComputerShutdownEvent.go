...
type Win32_ComputerShutdownEvent struct { 
	*Win32_ComputerSystemEvent
	...
	func NewWin32_ComputerShutdownEventEx1(instance *cim.WmiInstance) (newInstance *Win32_ComputerShutdownEvent, err error) {tmp, err := NewWin32_ComputerSystemEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ComputerShutdownEvent, err error) {tmp, err := NewWin32_ComputerSystemEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
