...
type Win32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000 struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000Ex1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000 {
	...
	func NewWin32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000Ex6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
