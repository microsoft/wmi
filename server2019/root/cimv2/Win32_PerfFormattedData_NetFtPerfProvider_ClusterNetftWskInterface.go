...
type Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterface struct { 
	*Win32_PerfFormattedData
	...
	func NewWin32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterfaceEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterface, err error) {tmp, err := NewWin32_PerfFormattedDataEx1(instance)
		
	if err != nil { return }
	newInstance = &Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterface {
	...
	func NewWin32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterfaceEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftWskInterface, err error) {tmp, err := NewWin32_PerfFormattedDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
