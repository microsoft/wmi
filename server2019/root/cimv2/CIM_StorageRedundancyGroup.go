...
type CIM_StorageRedundancyGroup struct { 
	*CIM_RedundancyGroup
	...
	func NewCIM_StorageRedundancyGroupEx1(instance *cim.WmiInstance) (newInstance *CIM_StorageRedundancyGroup, err error) {tmp, err := NewCIM_RedundancyGroupEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_StorageRedundancyGroup, err error) {tmp, err := NewCIM_RedundancyGroupEx6(hostName, wmiNamespace, userName, password, domainName, query)
