...
type Win32_SystemSlot struct { 
	*CIM_Slot
	...
	func NewWin32_SystemSlotEx1(instance *cim.WmiInstance) (newInstance *Win32_SystemSlot, err error) {tmp, err := NewCIM_SlotEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SystemSlot, err error) {tmp, err := NewCIM_SlotEx6(hostName, wmiNamespace, userName, password, domainName, query)
