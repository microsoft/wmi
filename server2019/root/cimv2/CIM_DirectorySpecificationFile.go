...
type CIM_DirectorySpecificationFile struct { 
	*cim.WmiInstance
	...
	func NewCIM_DirectorySpecificationFileEx1(instance *cim.WmiInstance) (newInstance *CIM_DirectorySpecificationFile, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DirectorySpecificationFile, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
