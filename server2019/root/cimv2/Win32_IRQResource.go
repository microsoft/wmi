...
type Win32_IRQResource struct { 
	*CIM_IRQ
	...
	func NewWin32_IRQResourceEx1(instance *cim.WmiInstance) (newInstance *Win32_IRQResource, err error) {tmp, err := NewCIM_IRQEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_IRQResource, err error) {tmp, err := NewCIM_IRQEx6(hostName, wmiNamespace, userName, password, domainName, query)
