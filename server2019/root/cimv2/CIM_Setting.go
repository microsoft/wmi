...
type CIM_Setting struct { 
	*cim.WmiInstance
	...
	func NewCIM_SettingEx1(instance *cim.WmiInstance) (newInstance *CIM_Setting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Setting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
