...
type CIM_RedundancyGroup struct { 
	*CIM_LogicalElement
	...
	func NewCIM_RedundancyGroupEx1(instance *cim.WmiInstance) (newInstance *CIM_RedundancyGroup, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RedundancyGroup, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
