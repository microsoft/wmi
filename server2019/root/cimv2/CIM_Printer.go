...
type CIM_Printer struct { 
	*CIM_LogicalDevice
	...
	func NewCIM_PrinterEx1(instance *cim.WmiInstance) (newInstance *CIM_Printer, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Printer, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
