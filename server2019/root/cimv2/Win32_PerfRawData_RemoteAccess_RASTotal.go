...
func NewWin32_PerfRawData_RemoteAccess_RASTotalEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_RemoteAccess_RASTotal, err error) {
	tmp, err := NewWin32_PerfRawDataEx1(instance)

	if err != nil {
		return
	}
	newInstance = &Win32_PerfRawData_RemoteAccess_RASTotal{
		Win32_PerfRawData: tmp,
	}
	return
}

func NewWin32_PerfRawData_RemoteAccess_RASTotalEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfRawData_RemoteAccess_RASTotal, err error) {
