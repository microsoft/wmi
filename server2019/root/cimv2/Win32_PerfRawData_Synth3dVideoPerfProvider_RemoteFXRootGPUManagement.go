...
type Win32_PerfRawData_Synth3dVideoPerfProvider_RemoteFXRootGPUManagement struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_Synth3dVideoPerfProvider_RemoteFXRootGPUManagementEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Synth3dVideoPerfProvider_RemoteFXRootGPUManagement, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Synth3dVideoPerfProvider_RemoteFXRootGPUManagement, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
