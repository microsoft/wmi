...
type CIM_ProductProductDependency struct { 
	*cim.WmiInstance
	...
	func NewCIM_ProductProductDependencyEx1(instance *cim.WmiInstance) (newInstance *CIM_ProductProductDependency, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ProductProductDependency, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
