...
type CIM_USBDevice struct { 
	*CIM_LogicalDevice
	...
	func NewCIM_USBDeviceEx1(instance *cim.WmiInstance) (newInstance *CIM_USBDevice, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_USBDevice, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_USBDevice) GetDescriptor( /* IN */ RequestType uint8,
 ...
 /* OUT */ Buffer []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetDescriptor" , RequestType, RequestValue, RequestIndex)
	if err != nil { return }
