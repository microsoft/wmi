...
type Win32_PrintJob struct { 
	*CIM_Job
	...
	func NewWin32_PrintJobEx1(instance *cim.WmiInstance) (newInstance *Win32_PrintJob, err error) {tmp, err := NewCIM_JobEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PrintJob, err error) {tmp, err := NewCIM_JobEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PrintJob) Pause() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Pause" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Win32_PrintJob) Resume() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Resume" );
	if err != nil { return }
	result = uint32(retVal)
	return
