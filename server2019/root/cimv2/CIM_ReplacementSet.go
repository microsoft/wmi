...
type CIM_ReplacementSet struct { 
	*cim.WmiInstance
	...
	func NewCIM_ReplacementSetEx1(instance *cim.WmiInstance) (newInstance *CIM_ReplacementSet, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ReplacementSet, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
