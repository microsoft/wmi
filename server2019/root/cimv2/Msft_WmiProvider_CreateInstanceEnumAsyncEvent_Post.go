...
type Msft_WmiProvider_CreateInstanceEnumAsyncEvent_Post struct { 
	*Msft_WmiProvider_OperationEvent_Post
	...
	func NewMsft_WmiProvider_CreateInstanceEnumAsyncEvent_PostEx1(instance *cim.WmiInstance) (newInstance *Msft_WmiProvider_CreateInstanceEnumAsyncEvent_Post, err error) {tmp, err := NewMsft_WmiProvider_OperationEvent_PostEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msft_WmiProvider_CreateInstanceEnumAsyncEvent_Post, err error) {tmp, err := NewMsft_WmiProvider_OperationEvent_PostEx6(hostName, wmiNamespace, userName, password, domainName, query)
