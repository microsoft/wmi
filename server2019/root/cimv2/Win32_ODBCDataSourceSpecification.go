...
type Win32_ODBCDataSourceSpecification struct { 
	*CIM_Check
	...
	func NewWin32_ODBCDataSourceSpecificationEx1(instance *cim.WmiInstance) (newInstance *Win32_ODBCDataSourceSpecification, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ODBCDataSourceSpecification, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
