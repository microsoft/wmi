...
type Win32_SoftwareElementCondition struct { 
	*CIM_Check
	...
	func NewWin32_SoftwareElementConditionEx1(instance *cim.WmiInstance) (newInstance *Win32_SoftwareElementCondition, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SoftwareElementCondition, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
