...
type Win32_ComponentCategory struct { 
	*CIM_LogicalElement
	...
	func NewWin32_ComponentCategoryEx1(instance *cim.WmiInstance) (newInstance *Win32_ComponentCategory, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ComponentCategory, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
