...
type Win32_RemoveFileAction struct { 
	*CIM_RemoveFileAction
	...
	func NewWin32_RemoveFileActionEx1(instance *cim.WmiInstance) (newInstance *Win32_RemoveFileAction, err error) {tmp, err := NewCIM_RemoveFileActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_RemoveFileAction, err error) {tmp, err := NewCIM_RemoveFileActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
