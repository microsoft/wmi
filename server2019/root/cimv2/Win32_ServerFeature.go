...
type Win32_ServerFeature struct { 
	*cim.WmiInstance
	...
	func NewWin32_ServerFeatureEx1(instance *cim.WmiInstance) (newInstance *Win32_ServerFeature, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ServerFeature, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
