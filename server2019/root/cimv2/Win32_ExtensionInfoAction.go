...
type Win32_ExtensionInfoAction struct { 
	*CIM_Action
	...
	func NewWin32_ExtensionInfoActionEx1(instance *cim.WmiInstance) (newInstance *Win32_ExtensionInfoAction, err error) {tmp, err := NewCIM_ActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_ExtensionInfoAction, err error) {tmp, err := NewCIM_ActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
