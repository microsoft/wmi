...
type CIM_StatisticalInformation struct { 
	*cim.WmiInstance
	...
	func NewCIM_StatisticalInformationEx1(instance *cim.WmiInstance) (newInstance *CIM_StatisticalInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_StatisticalInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
