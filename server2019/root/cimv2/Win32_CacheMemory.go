...
type Win32_CacheMemory struct { 
	*CIM_CacheMemory
	...
	func NewWin32_CacheMemoryEx1(instance *cim.WmiInstance) (newInstance *Win32_CacheMemory, err error) {tmp, err := NewCIM_CacheMemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CacheMemory, err error) {tmp, err := NewCIM_CacheMemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
