...
type Win32_IP4PersistedRouteTable struct { 
	*CIM_LogicalElement
	...
	func NewWin32_IP4PersistedRouteTableEx1(instance *cim.WmiInstance) (newInstance *Win32_IP4PersistedRouteTable, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_IP4PersistedRouteTable, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
