...
type Win32_PerfRawData_MmPerfProvider_HyperVVMWorkerProcessMemoryManager struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_MmPerfProvider_HyperVVMWorkerProcessMemoryManagerEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_MmPerfProvider_HyperVVMWorkerProcessMemoryManager, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_MmPerfProvider_HyperVVMWorkerProcessMemoryManager, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
