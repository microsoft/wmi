...
type Win32_PerfRawData_ESENT_DatabaseInstances struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_ESENT_DatabaseInstancesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_ESENT_DatabaseInstances, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_ESENT_DatabaseInstances, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
