...
type Win32_PerfRawData_Counters_SMBClientShares struct { 
	*Win32_PerfRawData
	...
	func NewWin32_PerfRawData_Counters_SMBClientSharesEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfRawData_Counters_SMBClientShares, err error) {tmp, err := NewWin32_PerfRawDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PerfRawData_Counters_SMBClientShares, err error) {tmp, err := NewWin32_PerfRawDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) SetPropertyAttemptedCompressedRequestsPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) GetPropertyAttemptedCompressedRequestsPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) SetPropertyCompressedBytesSentPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) GetPropertyCompressedBytesSentPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) SetPropertyCompressedResponsesPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) GetPropertyCompressedResponsesPersec()(value uint32, err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) SetPropertySuccessfulCompressedRequestsPersec(value uint32) (err error) { 
...
func (instance *Win32_PerfRawData_Counters_SMBClientShares) GetPropertySuccessfulCompressedRequestsPersec()(value uint32, err error) { 
