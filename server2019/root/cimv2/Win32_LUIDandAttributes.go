...
type Win32_LUIDandAttributes struct { 
	*cim.WmiInstance
	...
	func NewWin32_LUIDandAttributesEx1(instance *cim.WmiInstance) (newInstance *Win32_LUIDandAttributes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_LUIDandAttributes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
