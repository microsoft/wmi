...
type CIM_InstalledOS struct { 
	*CIM_SystemComponent
	...
	func NewCIM_InstalledOSEx1(instance *cim.WmiInstance) (newInstance *CIM_InstalledOS, err error) {tmp, err := NewCIM_SystemComponentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_InstalledOS, err error) {tmp, err := NewCIM_SystemComponentEx6(hostName, wmiNamespace, userName, password, domainName, query)
