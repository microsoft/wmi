...
func NewWin32_PerfFormattedData_Counters_SMBBandwidthLimitsEx1(instance *cim.WmiInstance) (newInstance *Win32_PerfFormattedData_Counters_SMBBandwidthLimits, err error) {
...
func NewWin32_PerfFormattedData_Counters_SMBBandwidthLimitsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Win32_PerfFormattedData_Counters_SMBBandwidthLimits, err error) {
