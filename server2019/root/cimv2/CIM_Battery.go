...
type CIM_Battery struct { 
	*CIM_LogicalDevice
	...
	func NewCIM_BatteryEx1(instance *cim.WmiInstance) (newInstance *CIM_Battery, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Battery, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
