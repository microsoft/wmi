...
type Win32_PatchPackage struct { 
	*Win32_MSIResource
	...
	func NewWin32_PatchPackageEx1(instance *cim.WmiInstance) (newInstance *Win32_PatchPackage, err error) {tmp, err := NewWin32_MSIResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_PatchPackage, err error) {tmp, err := NewWin32_MSIResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
