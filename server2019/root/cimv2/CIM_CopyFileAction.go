...
type CIM_CopyFileAction struct { 
	*CIM_FileAction
	...
	func NewCIM_CopyFileActionEx1(instance *cim.WmiInstance) (newInstance *CIM_CopyFileAction, err error) {tmp, err := NewCIM_FileActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_CopyFileAction, err error) {tmp, err := NewCIM_FileActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
