...
type CIM_BIOSFeature struct { 
	*CIM_SoftwareFeature
	...
	func NewCIM_BIOSFeatureEx1(instance *cim.WmiInstance) (newInstance *CIM_BIOSFeature, err error) {tmp, err := NewCIM_SoftwareFeatureEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_BIOSFeature, err error) {tmp, err := NewCIM_SoftwareFeatureEx6(hostName, wmiNamespace, userName, password, domainName, query)
