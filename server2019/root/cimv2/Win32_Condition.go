...
type Win32_Condition struct { 
	*CIM_Check
	...
	func NewWin32_ConditionEx1(instance *cim.WmiInstance) (newInstance *Win32_Condition, err error) {tmp, err := NewCIM_CheckEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_Condition, err error) {tmp, err := NewCIM_CheckEx6(hostName, wmiNamespace, userName, password, domainName, query)
