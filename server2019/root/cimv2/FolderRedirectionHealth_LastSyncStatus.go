...
const (
	...
	// Conflict enum
	FolderRedirectionHealth_LastSyncStatus_Conflict FolderRedirectionHealth_LastSyncStatus = 1
	// Warning enum
	FolderRedirectionHealth_LastSyncStatus_Warning FolderRedirectionHealth_LastSyncStatus = 2
	// Error enum
