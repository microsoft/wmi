...
type Win32_SoftwareElement struct { 
	*CIM_SoftwareElement
	...
	func NewWin32_SoftwareElementEx1(instance *cim.WmiInstance) (newInstance *Win32_SoftwareElement, err error) {tmp, err := NewCIM_SoftwareElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_SoftwareElement, err error) {tmp, err := NewCIM_SoftwareElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
