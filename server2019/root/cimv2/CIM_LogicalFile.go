...
type CIM_LogicalFile struct { 
	*CIM_LogicalElement
	...
	func NewCIM_LogicalFileEx1(instance *cim.WmiInstance) (newInstance *CIM_LogicalFile, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_LogicalFile, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_LogicalFile) TakeOwnerShip() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("TakeOwnerShip" );
	if err != nil { return }
...
func (instance *CIM_LogicalFile) ChangeSecurityPermissions( /* IN */ SecurityDescriptor Win32_SecurityDescriptor,
 /* IN */ Option uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ChangeSecurityPermissions" , SecurityDescriptor, Option);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_LogicalFile) Copy( /* IN */ FileName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Copy" , FileName);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_LogicalFile) Rename( /* IN */ FileName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Rename" , FileName);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_LogicalFile) Delete() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Delete" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_LogicalFile) Compress() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Compress" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_LogicalFile) Uncompress() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Uncompress" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *CIM_LogicalFile) TakeOwnerShipEx( /* OUT */ StopFileName string,
 ...
 /* OPTIONAL IN */ Recursive bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("TakeOwnerShipEx" , StartFileName, Recursive)
	if err != nil { return }
...
func (instance *CIM_LogicalFile) ChangeSecurityPermissionsEx( /* IN */ SecurityDescriptor Win32_SecurityDescriptor,
 ...
 /* OPTIONAL IN */ StartFileName string,
 /* OPTIONAL IN */ Recursive bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("ChangeSecurityPermissionsEx" , SecurityDescriptor, Option, StartFileName, Recursive)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *CIM_LogicalFile) CopyEx( /* IN */ FileName string,
 /* OUT */ StopFileName string,
 /* OPTIONAL IN */ StartFileName string,
 /* OPTIONAL IN */ Recursive bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("CopyEx" , FileName, StartFileName, Recursive)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *CIM_LogicalFile) DeleteEx( /* OUT */ StopFileName string,
 /* OPTIONAL IN */ StartFileName string) (result uint32, err error) {retVal, err := instance.InvokeMethod("DeleteEx" , StartFileName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *CIM_LogicalFile) CompressEx( /* OUT */ StopFileName string,
 /* OPTIONAL IN */ StartFileName string,
 /* OPTIONAL IN */ Recursive bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("CompressEx" , StartFileName, Recursive)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *CIM_LogicalFile) UncompressEx( /* OUT */ StopFileName string,
 /* OPTIONAL IN */ StartFileName string,
 /* OPTIONAL IN */ Recursive bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("UncompressEx" , StartFileName, Recursive)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *CIM_LogicalFile) GetEffectivePermission( /* IN */ Permissions uint32) (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("GetEffectivePermission" , Permissions);
	if err != nil { return }
	result = (retVal > 0)
	return
