...
type Win32_CheckCheck struct { 
	*cim.WmiInstance
	...
	func NewWin32_CheckCheckEx1(instance *cim.WmiInstance) (newInstance *Win32_CheckCheck, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_CheckCheck, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
