...
type MSFT_NetFirewallDynamicKeywordAddress struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_NetFirewallDynamicKeywordAddressEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetFirewallDynamicKeywordAddress, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetFirewallDynamicKeywordAddress, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetFirewallDynamicKeywordAddress) UpdateDynamicKeywordAddress( /* IN */ Id string,
 /* IN */ Addresses string,
 /* IN */ Append bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UpdateDynamicKeywordAddress" , Id, Addresses, Append);
	if err != nil { return }
