...
type MSFT_NetIPInterface struct { 
	*CIM_LANEndpoint
	...
	func NewMSFT_NetIPInterfaceEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIPInterface, err error) {tmp, err := NewCIM_LANEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIPInterface, err error) {tmp, err := NewCIM_LANEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
