...
type MSFT_NetIKEPSKAuthProposal struct { 
	*MSFT_NetIKEAuthProposal
	...
	func NewMSFT_NetIKEPSKAuthProposalEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIKEPSKAuthProposal, err error) {tmp, err := NewMSFT_NetIKEAuthProposalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIKEPSKAuthProposal, err error) {tmp, err := NewMSFT_NetIKEAuthProposalEx6(hostName, wmiNamespace, userName, password, domainName, query)
