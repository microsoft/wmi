...
type MSFT_Net6to4Configuration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_Net6to4ConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_Net6to4Configuration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_Net6to4Configuration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_Net6to4Configuration) Reset( /* IN */ State bool,
 ...
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_Net6to4Configuration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , State, AutoSharing, RelayName, RelayState, ResolutionInterval, PassThru)
	if err != nil { return }
