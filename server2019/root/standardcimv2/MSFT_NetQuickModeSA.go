...
type MSFT_NetQuickModeSA struct { 
	*CIM_IPsecSAEndpoint
	...
	func NewMSFT_NetQuickModeSAEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetQuickModeSA, err error) {tmp, err := NewCIM_IPsecSAEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetQuickModeSA, err error) {tmp, err := NewCIM_IPsecSAEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
