...
type MSFT_NetAdapterChecksumOffloadSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterChecksumOffloadSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterChecksumOffloadSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterChecksumOffloadSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterChecksumOffloadSettingData) Enable( /* IN */ IpIPv4 bool,
 ...
 /* OUT */ cmdletOutput MSFT_NetAdapterChecksumOffloadSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , IpIPv4, TcpIPv4, TcpIPv6, UdpIPv4, UdpIPv6, RxTxControl)
	if err != nil { return }
...
func (instance *MSFT_NetAdapterChecksumOffloadSettingData) Disable( /* IN */ IpIPv4 bool,
 ...
 /* IN */ UdpIPv6 bool,
 /* IN */ RxTxControl uint32,
 /* OUT */ cmdletOutput MSFT_NetAdapterChecksumOffloadSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , IpIPv4, TcpIPv4, TcpIPv6, UdpIPv4, UdpIPv6, RxTxControl)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
