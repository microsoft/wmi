...
type MSFT_NetIKEAuthSet struct { 
	*CIM_IKEAction
	...
	func NewMSFT_NetIKEAuthSetEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIKEAuthSet, err error) {tmp, err := NewCIM_IKEActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIKEAuthSet, err error) {tmp, err := NewCIM_IKEActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
