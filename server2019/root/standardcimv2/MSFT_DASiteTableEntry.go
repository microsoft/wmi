...
type MSFT_DASiteTableEntry struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_DASiteTableEntryEx1(instance *cim.WmiInstance) (newInstance *MSFT_DASiteTableEntry, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DASiteTableEntry, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_DASiteTableEntry) Enable( /* IN */ EntryPointName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Enable" , EntryPointName);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_DASiteTableEntry) Disable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Disable" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_DASiteTableEntry) Rename( /* IN */ NewName string,
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_DASiteTableEntry) (result uint32, err error) {retVal, err := instance.InvokeMethod("Rename" , NewName, PassThru)
	if err != nil { return }
...
func (instance *MSFT_DASiteTableEntry) Reset( /* IN */ TeredoServerIP bool,
 ...
 /* IN */ GslbIP bool,
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_DASiteTableEntry) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , TeredoServerIP, IPHttpsProfile, GslbIP, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
