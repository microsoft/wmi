...
type MSFT_NetFirewallHyperVVMCreator struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_NetFirewallHyperVVMCreatorEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetFirewallHyperVVMCreator, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetFirewallHyperVVMCreator, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetFirewallHyperVVMCreator) RegisterHyperVVMCreator( /* IN */ VMCreatorId string,
 /* IN */ FriendlyName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RegisterHyperVVMCreator" , VMCreatorId, FriendlyName);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetFirewallHyperVVMCreator) UnregisterHyperVVMCreator( /* IN */ VMCreatorId string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UnregisterHyperVVMCreator" , VMCreatorId);
	if err != nil { return }
	result = uint32(retVal)
	return
