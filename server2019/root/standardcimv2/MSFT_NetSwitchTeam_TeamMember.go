...
type MSFT_NetSwitchTeam_TeamMember struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetSwitchTeam_TeamMemberEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetSwitchTeam_TeamMember, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetSwitchTeam_TeamMember, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
