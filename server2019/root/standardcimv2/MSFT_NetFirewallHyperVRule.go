...
type MSFT_NetFirewallHyperVRule struct { 
	*CIM_PolicyRule
	...
	func NewMSFT_NetFirewallHyperVRuleEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetFirewallHyperVRule, err error) {tmp, err := NewCIM_PolicyRuleEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetFirewallHyperVRule, err error) {tmp, err := NewCIM_PolicyRuleEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetFirewallHyperVRule) Enable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Enable" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetFirewallHyperVRule) Disable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Disable" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetFirewallHyperVRule) Rename( /* IN */ NewName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Rename" , NewName);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetFirewallHyperVRule) EnumerateFull( /* OUT */ Dependents []CIM_ManagedSystemElement) (result uint32, err error) {retVal, err := instance.InvokeMethod("EnumerateFull" )
	if err != nil { return }
