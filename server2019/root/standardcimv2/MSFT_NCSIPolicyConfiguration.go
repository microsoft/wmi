...
type MSFT_NCSIPolicyConfiguration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NCSIPolicyConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_NCSIPolicyConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NCSIPolicyConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NCSIPolicyConfiguration) Reset( /* IN */ CorporateDNSProbeHostAddress bool,
 ...
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NCSIPolicyConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , CorporateDNSProbeHostAddress, CorporateDNSProbeHostName, CorporateSitePrefixList, CorporateWebsiteProbeURL, DomainLocationDeterminationURL, PassThru)
	if err != nil { return }
