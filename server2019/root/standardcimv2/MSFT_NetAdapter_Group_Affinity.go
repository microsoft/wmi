...
type MSFT_NetAdapter_Group_Affinity struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapter_Group_AffinityEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapter_Group_Affinity, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapter_Group_Affinity, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
