...
type MSFT_NetAdapterPowerManagement_Offload_RsnRekey struct { 
	*MSFT_NetAdapterPowerManagement_Offload
	...
	func NewMSFT_NetAdapterPowerManagement_Offload_RsnRekeyEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterPowerManagement_Offload_RsnRekey, err error) {tmp, err := NewMSFT_NetAdapterPowerManagement_OffloadEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterPowerManagement_Offload_RsnRekey, err error) {tmp, err := NewMSFT_NetAdapterPowerManagement_OffloadEx6(hostName, wmiNamespace, userName, password, domainName, query)
