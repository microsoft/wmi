...
type MSFT_NetAdapterLsoEncapsulationTypes struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterLsoEncapsulationTypesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterLsoEncapsulationTypes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterLsoEncapsulationTypes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
