...
type MSFT_NetIPAddress struct { 
	*CIM_IPProtocolEndpoint
	...
	func NewMSFT_NetIPAddressEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIPAddress, err error) {tmp, err := NewCIM_IPProtocolEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIPAddress, err error) {tmp, err := NewCIM_IPProtocolEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetIPAddress) Create( /* IN */ InterfaceIndex uint32,
 ...
 /* IN */ PassThru bool,
 /* OUT */ CmdletOutput []MSFT_NetIPAddress) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , InterfaceIndex, InterfaceAlias, IPAddress, AddressFamily, PrefixLength, Type, PrefixOrigin, SuffixOrigin, AddressState, ValidLifetime, PreferredLifetime, SkipAsSource, DefaultGateway, PolicyStore, PassThru)
	if err != nil { return }
