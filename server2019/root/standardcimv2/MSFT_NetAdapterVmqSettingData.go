...
type MSFT_NetAdapterVmqSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterVmqSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterVmqSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterVmqSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterVmqSettingData) Enable( /* OUT */ cmdletOutput MSFT_NetAdapterVmqSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" )
	if err != nil { return }
...
// <param name="cmdletOutput" type="MSFT_NetAdapterVmqSettingData "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapterVmqSettingData) Disable( /* OUT */ cmdletOutput MSFT_NetAdapterVmqSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
