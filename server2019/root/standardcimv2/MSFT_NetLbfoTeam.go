...
type MSFT_NetLbfoTeam struct { 
	*MSFT_NetImPlatTeam
	...
	func NewMSFT_NetLbfoTeamEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetLbfoTeam, err error) {tmp, err := NewMSFT_NetImPlatTeamEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetLbfoTeam, err error) {tmp, err := NewMSFT_NetImPlatTeamEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetLbfoTeam) Rename( /* IN */ Name string,
 /* IN */ NewName string,
 /* OUT */ CmdletOutput MSFT_NetLbfoTeam) (result uint32, err error) {retVal, err := instance.InvokeMethod("Rename" , Name, NewName)
	if err != nil { return }
