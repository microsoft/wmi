...
type MSFT_NetEventWFPCaptureProvider struct { 
	*MSFT_NetEventProviderBase
	...
	func NewMSFT_NetEventWFPCaptureProviderEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetEventWFPCaptureProvider, err error) {tmp, err := NewMSFT_NetEventProviderBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetEventWFPCaptureProvider, err error) {tmp, err := NewMSFT_NetEventProviderBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
