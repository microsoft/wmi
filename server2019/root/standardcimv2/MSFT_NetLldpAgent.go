...
type MSFT_NetLldpAgent struct { 
	*MSFT_NetLldpMsap
	...
	func NewMSFT_NetLldpAgentEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetLldpAgent, err error) {tmp, err := NewMSFT_NetLldpMsapEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetLldpAgent, err error) {tmp, err := NewMSFT_NetLldpMsapEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetLldpAgent) Enable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Enable" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetLldpAgent) Disable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Disable" );
	if err != nil { return }
	result = uint32(retVal)
	return
