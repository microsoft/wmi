...
type CIM_PolicyRule struct { 
	*CIM_PolicySet
	...
	func NewCIM_PolicyRuleEx1(instance *cim.WmiInstance) (newInstance *CIM_PolicyRule, err error) {tmp, err := NewCIM_PolicySetEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PolicyRule, err error) {tmp, err := NewCIM_PolicySetEx6(hostName, wmiNamespace, userName, password, domainName, query)
