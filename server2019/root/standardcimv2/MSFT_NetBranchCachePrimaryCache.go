...
type MSFT_NetBranchCachePrimaryCache struct { 
	*MSFT_NetBranchCacheCache
	...
	func NewMSFT_NetBranchCachePrimaryCacheEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetBranchCachePrimaryCache, err error) {tmp, err := NewMSFT_NetBranchCacheCacheEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetBranchCachePrimaryCache, err error) {tmp, err := NewMSFT_NetBranchCacheCacheEx6(hostName, wmiNamespace, userName, password, domainName, query)
