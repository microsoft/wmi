...
type MSFT_NetDnsTransitionConfiguration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetDnsTransitionConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetDnsTransitionConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetDnsTransitionConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetDnsTransitionConfiguration) Enable( /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetDnsTransitionConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , PassThru)
	if err != nil { return }
...
func (instance *MSFT_NetDnsTransitionConfiguration) Disable( /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetDnsTransitionConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_NetDnsTransitionConfiguration) Reset( /* IN */ State bool,
 ...
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetDnsTransitionConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , State, OnlySendAQuery, Latency, AlwaysSynthesize, PrefixMapping, ExclusionList, SendInterface, AcceptInterface, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
