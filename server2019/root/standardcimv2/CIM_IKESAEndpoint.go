...
type CIM_IKESAEndpoint struct { 
	*CIM_SecurityAssociationEndpoint
	...
	func NewCIM_IKESAEndpointEx1(instance *cim.WmiInstance) (newInstance *CIM_IKESAEndpoint, err error) {tmp, err := NewCIM_SecurityAssociationEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_IKESAEndpoint, err error) {tmp, err := NewCIM_SecurityAssociationEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
