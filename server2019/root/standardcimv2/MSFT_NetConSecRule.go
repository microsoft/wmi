...
type MSFT_NetConSecRule struct { 
	*MSFT_NetSARule
	...
	func NewMSFT_NetConSecRuleEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetConSecRule, err error) {tmp, err := NewMSFT_NetSARuleEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetConSecRule, err error) {tmp, err := NewMSFT_NetSARuleEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetConSecRule) SyncPolicyDelta( /* IN */ Servers []string,
 ...
 /* OUT */ Output []MSFT_NetSecDeltaCollection) (result uint32, err error) {retVal, err := instance.InvokeMethod("SyncPolicyDelta" , Servers, Domains, EndpointType, AddressType, DnsServers)
	if err != nil { return }
...
func (instance *MSFT_NetConSecRule) SetPolicyDelta( /* IN */ Action uint16,
 ...
 /* IN */ EndpointType uint16,
 /* IN */ PassThru bool,
 /* OUT */ Output []MSFT_NetConSecRule) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetPolicyDelta" , Action, IPv6Addresses, IPv4Addresses, EndpointType, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetConSecRule) EnumerateFull( /* OUT */ Dependents []CIM_ManagedSystemElement) (result uint32, err error) {retVal, err := instance.InvokeMethod("EnumerateFull" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_NetConSecRule) Find( /* IN */ LocalAddress string,
 ...
 /* OUT */ CmdletOutput []MSFT_NetConSecRule) (result uint32, err error) {retVal, err := instance.InvokeMethod("Find" , LocalAddress, RemoteAddress, Protocol, LocalPort, RemotePort)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetConSecRule) Enable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Enable" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetConSecRule) Disable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Disable" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetConSecRule) Rename( /* IN */ NewName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Rename" , NewName);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_NetConSecRule) CloneObject( /* IN */ NewName string,
 ...
 /* IN */ NewGPOSession string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CloneObject" , NewName, NewPolicyStore, NewGPOSession);
	if err != nil { return }
	result = uint32(retVal)
	return
