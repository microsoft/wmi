...
type MSFT_NetIPsecIdentity struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetIPsecIdentityEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIPsecIdentity, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIPsecIdentity, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
