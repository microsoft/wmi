...
type CIM_FilterEntryBase struct { 
	*CIM_LogicalElement
	...
	func NewCIM_FilterEntryBaseEx1(instance *cim.WmiInstance) (newInstance *CIM_FilterEntryBase, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_FilterEntryBase, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
