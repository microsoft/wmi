...
type CIM_SecurityAssociationEndpoint struct { 
	*CIM_ProtocolEndpoint
	...
	func NewCIM_SecurityAssociationEndpointEx1(instance *cim.WmiInstance) (newInstance *CIM_SecurityAssociationEndpoint, err error) {tmp, err := NewCIM_ProtocolEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SecurityAssociationEndpoint, err error) {tmp, err := NewCIM_ProtocolEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
