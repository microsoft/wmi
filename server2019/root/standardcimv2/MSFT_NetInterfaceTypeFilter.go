...
type MSFT_NetInterfaceTypeFilter struct { 
	*CIM_FilterEntryBase
	...
	func NewMSFT_NetInterfaceTypeFilterEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetInterfaceTypeFilter, err error) {tmp, err := NewCIM_FilterEntryBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetInterfaceTypeFilter, err error) {tmp, err := NewCIM_FilterEntryBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
