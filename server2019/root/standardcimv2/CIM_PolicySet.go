...
type CIM_PolicySet struct { 
	*CIM_Policy
	...
	func NewCIM_PolicySetEx1(instance *cim.WmiInstance) (newInstance *CIM_PolicySet, err error) {tmp, err := NewCIM_PolicyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PolicySet, err error) {tmp, err := NewCIM_PolicyEx6(hostName, wmiNamespace, userName, password, domainName, query)
