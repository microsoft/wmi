...
type MSFT_NetNatSession struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetNatSessionEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetNatSession, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetNatSession, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
