...
type CIM_ConcreteJob struct { 
	*CIM_Job
	...
	func NewCIM_ConcreteJobEx1(instance *cim.WmiInstance) (newInstance *CIM_ConcreteJob, err error) {tmp, err := NewCIM_JobEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ConcreteJob, err error) {tmp, err := NewCIM_JobEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_ConcreteJob) RequestStateChange( /* IN */ RequestedState uint16,
 /* IN */ TimeoutPeriod string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RequestStateChange" , RequestedState, TimeoutPeriod);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_ConcreteJob) GetError( /* OUT */ Error CIM_Error) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetError" )
	if err != nil { return }
