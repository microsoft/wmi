...
type MSFT_NetISATAPConfiguration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetISATAPConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetISATAPConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetISATAPConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetISATAPConfiguration) Reset( /* IN */ State bool,
 ...
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetISATAPConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , State, Router, ResolutionState, ResolutionInterval, PassThru)
	if err != nil { return }
