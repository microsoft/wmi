...
type MSFT_NetAdapterDataPathConfigurationSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterDataPathConfigurationSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterDataPathConfigurationSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterDataPathConfigurationSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
