...
type MSFT_NetIKEQMCryptoProposal struct { 
	*MSFT_NetIKECryptoProposal
	...
	func NewMSFT_NetIKEQMCryptoProposalEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIKEQMCryptoProposal, err error) {tmp, err := NewMSFT_NetIKECryptoProposalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIKEQMCryptoProposal, err error) {tmp, err := NewMSFT_NetIKECryptoProposalEx6(hostName, wmiNamespace, userName, password, domainName, query)
