...
type MSFT_NetAdapterChecksumOffloadCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterChecksumOffloadCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterChecksumOffloadCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterChecksumOffloadCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
