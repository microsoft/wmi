...
type MSFT_NetAdapter_PacketDirectCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapter_PacketDirectCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapter_PacketDirectCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapter_PacketDirectCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
