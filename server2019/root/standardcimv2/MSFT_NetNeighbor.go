...
type MSFT_NetNeighbor struct { 
	*CIM_RemoteServiceAccessPoint
	...
	func NewMSFT_NetNeighborEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetNeighbor, err error) {tmp, err := NewCIM_RemoteServiceAccessPointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetNeighbor, err error) {tmp, err := NewCIM_RemoteServiceAccessPointEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetNeighbor) Create( /* IN */ InterfaceIndex uint32,
 ...
 /* IN */ PassThru bool,
 /* OUT */ CmdletOutput []MSFT_NetNeighbor) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , InterfaceIndex, InterfaceAlias, IPAddress, PolicyStore, LinkLayerAddress, State, AddressFamily, PassThru)
	if err != nil { return }
