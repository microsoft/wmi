...
type MSFT_NetTeredoConfiguration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetTeredoConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetTeredoConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetTeredoConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetTeredoConfiguration) Reset( /* IN */ Type bool,
 ...
 /* IN */ ServerShunt bool,
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetTeredoConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , Type, ServerName, RefreshInterval, ClientPort, ServerVirtualIP, DefaultQualified, ServerShunt, PassThru)
	if err != nil { return }
