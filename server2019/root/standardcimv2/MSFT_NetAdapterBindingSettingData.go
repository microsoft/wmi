...
type MSFT_NetAdapterBindingSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterBindingSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterBindingSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterBindingSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterBindingSettingData) Enable( /* OUT */ cmdletOutput MSFT_NetAdapterBindingSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" )
	if err != nil { return }
...
// <param name="cmdletOutput" type="MSFT_NetAdapterBindingSettingData "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapterBindingSettingData) Disable( /* OUT */ cmdletOutput MSFT_NetAdapterBindingSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
