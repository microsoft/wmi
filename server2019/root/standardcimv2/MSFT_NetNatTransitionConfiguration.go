...
type MSFT_NetNatTransitionConfiguration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetNatTransitionConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetNatTransitionConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetNatTransitionConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetNatTransitionConfiguration) Enable( /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetNatTransitionConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , PassThru)
	if err != nil { return }
...
func (instance *MSFT_NetNatTransitionConfiguration) Disable( /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetNatTransitionConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
