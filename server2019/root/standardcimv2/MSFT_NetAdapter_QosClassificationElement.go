...
type MSFT_NetAdapter_QosClassificationElement struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapter_QosClassificationElementEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapter_QosClassificationElement, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapter_QosClassificationElement, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
