...
type MSFT_NetIKECertAuthProposal struct { 
	*MSFT_NetIKEAuthProposal
	...
	func NewMSFT_NetIKECertAuthProposalEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIKECertAuthProposal, err error) {tmp, err := NewMSFT_NetIKEAuthProposalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIKECertAuthProposal, err error) {tmp, err := NewMSFT_NetIKEAuthProposalEx6(hostName, wmiNamespace, userName, password, domainName, query)
