...
type MSFT_NetLldpMsap struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetLldpMsapEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetLldpMsap, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetLldpMsap, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
