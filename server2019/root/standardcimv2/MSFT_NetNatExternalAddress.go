...
type MSFT_NetNatExternalAddress struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetNatExternalAddressEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetNatExternalAddress, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetNatExternalAddress, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
