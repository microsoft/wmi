...
type CIM_SARule struct { 
	*CIM_PolicyRule
	...
	func NewCIM_SARuleEx1(instance *cim.WmiInstance) (newInstance *CIM_SARule, err error) {tmp, err := NewCIM_PolicyRuleEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SARule, err error) {tmp, err := NewCIM_PolicyRuleEx6(hostName, wmiNamespace, userName, password, domainName, query)
