...
type MSFT_NetLbfoTeamNic struct { 
	*MSFT_NetImPlatAdapter
	...
	func NewMSFT_NetLbfoTeamNicEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetLbfoTeamNic, err error) {tmp, err := NewMSFT_NetImPlatAdapterEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetLbfoTeamNic, err error) {tmp, err := NewMSFT_NetImPlatAdapterEx6(hostName, wmiNamespace, userName, password, domainName, query)
