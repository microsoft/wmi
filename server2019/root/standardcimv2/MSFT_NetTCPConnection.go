...
type MSFT_NetTCPConnection struct { 
	*MSFT_NetTransportConnection
	...
	func NewMSFT_NetTCPConnectionEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetTCPConnection, err error) {tmp, err := NewMSFT_NetTransportConnectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetTCPConnection, err error) {tmp, err := NewMSFT_NetTransportConnectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
