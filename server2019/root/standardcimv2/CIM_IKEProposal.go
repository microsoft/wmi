...
type CIM_IKEProposal struct { 
	*CIM_SAProposal
	...
	func NewCIM_IKEProposalEx1(instance *cim.WmiInstance) (newInstance *CIM_IKEProposal, err error) {tmp, err := NewCIM_SAProposalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_IKEProposal, err error) {tmp, err := NewCIM_SAProposalEx6(hostName, wmiNamespace, userName, password, domainName, query)
