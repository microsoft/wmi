...
type MSFT_NetAdapterPowerManagement_WakePattern_Bitmap struct { 
	*MSFT_NetAdapterPowerManagement_WakePattern
	...
	func NewMSFT_NetAdapterPowerManagement_WakePattern_BitmapEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterPowerManagement_WakePattern_Bitmap, err error) {tmp, err := NewMSFT_NetAdapterPowerManagement_WakePatternEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterPowerManagement_WakePattern_Bitmap, err error) {tmp, err := NewMSFT_NetAdapterPowerManagement_WakePatternEx6(hostName, wmiNamespace, userName, password, domainName, query)
