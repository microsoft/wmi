...
type MSFT_NetIKECryptoSet struct { 
	*CIM_IKEAction
	...
	func NewMSFT_NetIKECryptoSetEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIKECryptoSet, err error) {tmp, err := NewCIM_IKEActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIKECryptoSet, err error) {tmp, err := NewCIM_IKEActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
