...
type MSFT_NetIKEQMCryptoSet struct { 
	*MSFT_NetIKECryptoSet
	...
	func NewMSFT_NetIKEQMCryptoSetEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIKEQMCryptoSet, err error) {tmp, err := NewMSFT_NetIKECryptoSetEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIKEQMCryptoSet, err error) {tmp, err := NewMSFT_NetIKECryptoSetEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetIKEQMCryptoSet) Rename( /* IN */ NewName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Rename" , NewName);
	if err != nil { return }
...
func (instance *MSFT_NetIKEQMCryptoSet) CloneObject( /* IN */ NewName string,
 ...
 /* IN */ NewGPOSession string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CloneObject" , NewName, NewID, NewPolicyStore, NewGPOSession);
	if err != nil { return }
	result = uint32(retVal)
	return
