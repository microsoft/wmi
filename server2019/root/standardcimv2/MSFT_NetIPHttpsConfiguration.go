...
type MSFT_NetIPHttpsConfiguration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetIPHttpsConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIPHttpsConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIPHttpsConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetIPHttpsConfiguration) EnableProfile( /* IN */ Profile string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("EnableProfile" , Profile);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetIPHttpsConfiguration) DisableProfile() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("DisableProfile" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_NetIPHttpsConfiguration) AddCertBinding( /* IN */ CertificateHash string,
 ...
 /* IN */ NullEncryption bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddCertBinding" , CertificateHash, ApplicationId, IpPort, CertificateStoreName, NullEncryption);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetIPHttpsConfiguration) RemoveCertBinding() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveCertBinding" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_NetIPHttpsConfiguration) Rename( /* IN */ NewName string,
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetIPHttpsConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Rename" , NewName, PassThru)
	if err != nil { return }
...
func (instance *MSFT_NetIPHttpsConfiguration) Reset( /* IN */ State bool,
 ...
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_NetIPHttpsConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , State, AuthMode, StrongCRLRequired, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
