...
type MSFT_NetBaseIPProtocol struct { 
	*CIM_ProtocolEndpoint
	...
	func NewMSFT_NetBaseIPProtocolEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetBaseIPProtocol, err error) {tmp, err := NewCIM_ProtocolEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetBaseIPProtocol, err error) {tmp, err := NewCIM_ProtocolEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
