...
type MSFT_NetEventVmNetworkAdapter struct { 
	*MSFT_NetEventPacketCaptureTarget
	...
	func NewMSFT_NetEventVmNetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetEventVmNetworkAdapter, err error) {tmp, err := NewMSFT_NetEventPacketCaptureTargetEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetEventVmNetworkAdapter, err error) {tmp, err := NewMSFT_NetEventPacketCaptureTargetEx6(hostName, wmiNamespace, userName, password, domainName, query)
