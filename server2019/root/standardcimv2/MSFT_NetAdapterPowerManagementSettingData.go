...
type MSFT_NetAdapterPowerManagementSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterPowerManagementSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterPowerManagementSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterPowerManagementSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterPowerManagementSettingData) Enable( /* OUT */ cmdletOutput MSFT_NetAdapterPowerManagementSettingData,
 ...
 /* OPTIONAL IN */ WakeOnPattern bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , ArpOffload, D0PacketCoalescing, DeviceSleepOnDisconnect, NSOffload, RsnRekeyOffload, SelectiveSuspend, WakeOnMagicPacket, WakeOnPattern)
	if err != nil { return }
...
func (instance *MSFT_NetAdapterPowerManagementSettingData) Disable( /* OUT */ cmdletOutput MSFT_NetAdapterPowerManagementSettingData,
 ...
 /* OPTIONAL IN */ SelectiveSuspend bool,
 /* OPTIONAL IN */ WakeOnMagicPacket bool,
 /* OPTIONAL IN */ WakeOnPattern bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , ArpOffload, D0PacketCoalescing, DeviceSleepOnDisconnect, NSOffload, RsnRekeyOffload, SelectiveSuspend, WakeOnMagicPacket, WakeOnPattern)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
