...
type MSFT_NetLbfoTeamMember struct { 
	*MSFT_NetImPlatAdapter
	...
	func NewMSFT_NetLbfoTeamMemberEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetLbfoTeamMember, err error) {tmp, err := NewMSFT_NetImPlatAdapterEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetLbfoTeamMember, err error) {tmp, err := NewMSFT_NetImPlatAdapterEx6(hostName, wmiNamespace, userName, password, domainName, query)
