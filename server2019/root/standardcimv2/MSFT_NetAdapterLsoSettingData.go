...
type MSFT_NetAdapterLsoSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterLsoSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterLsoSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterLsoSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterLsoSettingData) Enable( /* IN */ IPv4 bool,
 /* IN */ IPv6 bool,
 /* OUT */ cmdletOutput MSFT_NetAdapterLsoSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , IPv4, IPv6)
	if err != nil { return }
...
func (instance *MSFT_NetAdapterLsoSettingData) Disable( /* IN */ IPv4 bool,
 /* IN */ IPv6 bool,
 /* OUT */ cmdletOutput MSFT_NetAdapterLsoSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , IPv4, IPv6)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
