...
type CIM_DNSGeneralSettingData struct { 
	*CIM_IPAssignmentSettingData
	...
	func NewCIM_DNSGeneralSettingDataEx1(instance *cim.WmiInstance) (newInstance *CIM_DNSGeneralSettingData, err error) {tmp, err := NewCIM_IPAssignmentSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DNSGeneralSettingData, err error) {tmp, err := NewCIM_IPAssignmentSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
