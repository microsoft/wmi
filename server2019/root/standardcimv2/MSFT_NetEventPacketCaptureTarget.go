...
type MSFT_NetEventPacketCaptureTarget struct { 
	*CIM_LogicalElement
	...
	func NewMSFT_NetEventPacketCaptureTargetEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetEventPacketCaptureTarget, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetEventPacketCaptureTarget, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
