...
type MSFT_NetAdapterAdvancedPropertySettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterAdvancedPropertySettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterAdvancedPropertySettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterAdvancedPropertySettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterAdvancedPropertySettingData) Reset( /* OUT */ CmdletOutput MSFT_NetAdapterAdvancedPropertySettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" )
	if err != nil { return }
