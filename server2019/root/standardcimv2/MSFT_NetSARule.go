...
type MSFT_NetSARule struct { 
	*CIM_SARule
	...
	func NewMSFT_NetSARuleEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetSARule, err error) {tmp, err := NewCIM_SARuleEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetSARule, err error) {tmp, err := NewCIM_SARuleEx6(hostName, wmiNamespace, userName, password, domainName, query)
