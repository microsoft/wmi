...
type MSFT_NetAdapter_RscStatistics struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapter_RscStatisticsEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapter_RscStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapter_RscStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
