...
type CIM_PolicyActionStructure struct { 
	*CIM_PolicyComponent
	...
	func NewCIM_PolicyActionStructureEx1(instance *cim.WmiInstance) (newInstance *CIM_PolicyActionStructure, err error) {tmp, err := NewCIM_PolicyComponentEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PolicyActionStructure, err error) {tmp, err := NewCIM_PolicyComponentEx6(hostName, wmiNamespace, userName, password, domainName, query)
