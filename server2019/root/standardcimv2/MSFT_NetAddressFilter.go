...
type MSFT_NetAddressFilter struct { 
	*CIM_FilterEntryBase
	...
	func NewMSFT_NetAddressFilterEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAddressFilter, err error) {tmp, err := NewCIM_FilterEntryBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAddressFilter, err error) {tmp, err := NewCIM_FilterEntryBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAddressFilter) QueryIsolationType( /* IN */ InterfaceIndex uint32,
 ...
 /* OUT */ IsolationType uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("QueryIsolationType" , InterfaceIndex, RemoteAddress)
	if err != nil { return }
