...
type MSFT_NetUDPSetting struct { 
	*CIM_PolicyAction
	...
	func NewMSFT_NetUDPSettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetUDPSetting, err error) {tmp, err := NewCIM_PolicyActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetUDPSetting, err error) {tmp, err := NewCIM_PolicyActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
