...
type CIM_BindsToLANEndpoint struct { 
	*CIM_BindsTo
	...
	func NewCIM_BindsToLANEndpointEx1(instance *cim.WmiInstance) (newInstance *CIM_BindsToLANEndpoint, err error) {tmp, err := NewCIM_BindsToEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_BindsToLANEndpoint, err error) {tmp, err := NewCIM_BindsToEx6(hostName, wmiNamespace, userName, password, domainName, query)
