...
type CIM_RemoteServiceAccessPoint struct { 
	*CIM_ServiceAccessPoint
	...
	func NewCIM_RemoteServiceAccessPointEx1(instance *cim.WmiInstance) (newInstance *CIM_RemoteServiceAccessPoint, err error) {tmp, err := NewCIM_ServiceAccessPointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_RemoteServiceAccessPoint, err error) {tmp, err := NewCIM_ServiceAccessPointEx6(hostName, wmiNamespace, userName, password, domainName, query)
