...
type CIM_IPsecSAEndpoint struct { 
	*CIM_SecurityAssociationEndpoint
	...
	func NewCIM_IPsecSAEndpointEx1(instance *cim.WmiInstance) (newInstance *CIM_IPsecSAEndpoint, err error) {tmp, err := NewCIM_SecurityAssociationEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_IPsecSAEndpoint, err error) {tmp, err := NewCIM_SecurityAssociationEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
