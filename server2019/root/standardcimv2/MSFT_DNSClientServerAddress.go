...
type MSFT_DNSClientServerAddress struct { 
	*CIM_RemoteServiceAccessPoint
	...
	func NewMSFT_DNSClientServerAddressEx1(instance *cim.WmiInstance) (newInstance *MSFT_DNSClientServerAddress, err error) {tmp, err := NewCIM_RemoteServiceAccessPointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DNSClientServerAddress, err error) {tmp, err := NewCIM_RemoteServiceAccessPointEx6(hostName, wmiNamespace, userName, password, domainName, query)
