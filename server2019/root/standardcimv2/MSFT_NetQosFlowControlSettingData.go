...
func (instance *MSFT_NetQosFlowControlSettingData) Disable( /* OUT */ Output MSFT_NetQosFlowControlSettingData) (result uint32, err error) {
...
// <param name="Output" type="MSFT_NetQosFlowControlSettingData "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetQosFlowControlSettingData) Enable( /* OUT */ Output MSFT_NetQosFlowControlSettingData) (result uint32, err error) {
