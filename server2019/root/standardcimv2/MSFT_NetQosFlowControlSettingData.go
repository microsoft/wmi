...
type MSFT_NetQosFlowControlSettingData struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetQosFlowControlSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetQosFlowControlSettingData, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
		
	if err != nil { return }
	newInstance = &MSFT_NetQosFlowControlSettingData {
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetQosFlowControlSettingData, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
// <param name="Output" type="MSFT_NetQosFlowControlSettingData "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetQosFlowControlSettingData) Disable( /* OUT */ Output MSFT_NetQosFlowControlSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" )
	if err != nil { return }
...
// <param name="Output" type="MSFT_NetQosFlowControlSettingData "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetQosFlowControlSettingData) Enable( /* OUT */ Output MSFT_NetQosFlowControlSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetQosFlowControlSettingData) SwitchPolicySet( /* IN */ PolicySet uint8,
