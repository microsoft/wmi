...
type MSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingData) Enable( /* IN */ EncapsulationType uint16,
 /* OUT */ cmdletOutput MSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , EncapsulationType)
	if err != nil { return }
...
func (instance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingData) Disable( /* IN */ EncapsulationType uint16,
 /* OUT */ cmdletOutput MSFT_NetAdapterEncapsulatedPacketTaskOffloadSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , EncapsulationType)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
