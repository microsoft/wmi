...
type MSFT_NetPrefixPolicy struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_NetPrefixPolicyEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetPrefixPolicy, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetPrefixPolicy, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetPrefixPolicy) Create( /* IN */ Prefix string,
 ...
 /* IN */ PassThru bool,
 /* OUT */ CmdletOutput []MSFT_NetPrefixPolicy) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , Prefix, Precedence, Label, PolicyStore, PassThru)
	if err != nil { return }
