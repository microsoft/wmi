...
type MSFT_NetSecDeltaCollection struct { 
	*CIM_SettingData
	...
	func NewMSFT_NetSecDeltaCollectionEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetSecDeltaCollection, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetSecDeltaCollection, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
