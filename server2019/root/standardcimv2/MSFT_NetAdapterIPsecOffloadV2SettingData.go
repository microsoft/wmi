...
func (instance *MSFT_NetAdapterIPsecOffloadV2SettingData) Set( /* IN */ Enabled bool,
	/* IN */ NoRestart bool,
	/* IN */ PassThru bool,
	/* OUT */ cmdletOutput MSFT_NetAdapterIPsecOffloadV2SettingData) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Set", Enabled, NoRestart, PassThru)
	if err != nil {
		return
	}
...
func (instance *MSFT_NetAdapterIPsecOffloadV2SettingData) Enable( /* IN */ NoRestart bool,
	/* IN */ PassThru bool,
	/* OUT */ cmdletOutput MSFT_NetAdapterIPsecOffloadV2SettingData) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Enable", NoRestart, PassThru)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *MSFT_NetAdapterIPsecOffloadV2SettingData) Disable( /* IN */ NoRestart bool,
	/* IN */ PassThru bool,
	/* OUT */ cmdletOutput MSFT_NetAdapterIPsecOffloadV2SettingData) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Disable", NoRestart, PassThru)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
