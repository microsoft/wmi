...
type MSFT_NetAdapterSriovCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterSriovCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterSriovCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterSriovCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
