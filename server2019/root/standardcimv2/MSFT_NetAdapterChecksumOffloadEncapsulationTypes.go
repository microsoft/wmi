...
type MSFT_NetAdapterChecksumOffloadEncapsulationTypes struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterChecksumOffloadEncapsulationTypesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterChecksumOffloadEncapsulationTypes, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterChecksumOffloadEncapsulationTypes, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
