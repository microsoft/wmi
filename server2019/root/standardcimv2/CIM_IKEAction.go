...
type CIM_IKEAction struct { 
	*CIM_SANegotiationAction
	...
	func NewCIM_IKEActionEx1(instance *cim.WmiInstance) (newInstance *CIM_IKEAction, err error) {tmp, err := NewCIM_SANegotiationActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_IKEAction, err error) {tmp, err := NewCIM_SANegotiationActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
