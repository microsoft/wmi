...
type MSFT_NetTeredoState struct { 
	*CIM_ElementSettingData
	...
	func NewMSFT_NetTeredoStateEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetTeredoState, err error) {tmp, err := NewCIM_ElementSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetTeredoState, err error) {tmp, err := NewCIM_ElementSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
