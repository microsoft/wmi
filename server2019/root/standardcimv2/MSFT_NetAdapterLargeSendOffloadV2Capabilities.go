...
type MSFT_NetAdapterLargeSendOffloadV2Capabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterLargeSendOffloadV2CapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterLargeSendOffloadV2Capabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterLargeSendOffloadV2Capabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
