...
type MSFT_NetAdapterPowerManagement_Offload struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterPowerManagement_OffloadEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterPowerManagement_Offload, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterPowerManagement_Offload, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
