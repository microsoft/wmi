...
type MSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilitiesEx struct { 
	*MSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilities
	...
	func NewMSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilitiesExEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilitiesEx, err error) {tmp, err := NewMSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilitiesEx, err error) {tmp, err := NewMSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
