...
type MSFT_NetInterfaceFilter struct { 
	*CIM_FilterEntryBase
	...
	func NewMSFT_NetInterfaceFilterEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetInterfaceFilter, err error) {tmp, err := NewCIM_FilterEntryBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetInterfaceFilter, err error) {tmp, err := NewCIM_FilterEntryBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
