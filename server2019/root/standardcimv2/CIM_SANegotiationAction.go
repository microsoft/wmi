...
type CIM_SANegotiationAction struct { 
	*CIM_SAAction
	...
	func NewCIM_SANegotiationActionEx1(instance *cim.WmiInstance) (newInstance *CIM_SANegotiationAction, err error) {tmp, err := NewCIM_SAActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SANegotiationAction, err error) {tmp, err := NewCIM_SAActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
