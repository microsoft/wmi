...
type MSFT_NetAdapterUdpSegmentationOffloadCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterUdpSegmentationOffloadCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterUdpSegmentationOffloadCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterUdpSegmentationOffloadCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
