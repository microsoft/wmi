...
type MSFT_NetImPlatAdapter struct { 
	*CIM_EnabledLogicalElement
	...
	func NewMSFT_NetImPlatAdapterEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetImPlatAdapter, err error) {tmp, err := NewCIM_EnabledLogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetImPlatAdapter, err error) {tmp, err := NewCIM_EnabledLogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
