...
type MSFT_NetTransportConnection struct { 
	*CIM_NetworkPipe
	...
	func NewMSFT_NetTransportConnectionEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetTransportConnection, err error) {tmp, err := NewCIM_NetworkPipeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetTransportConnection, err error) {tmp, err := NewCIM_NetworkPipeEx6(hostName, wmiNamespace, userName, password, domainName, query)
