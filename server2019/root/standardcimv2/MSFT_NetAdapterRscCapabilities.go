...
type MSFT_NetAdapterRscCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterRscCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterRscCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterRscCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
