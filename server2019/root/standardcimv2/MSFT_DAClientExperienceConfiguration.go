...
type MSFT_DAClientExperienceConfiguration struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_DAClientExperienceConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_DAClientExperienceConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DAClientExperienceConfiguration, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_DAClientExperienceConfiguration) Reset( /* IN */ CorporateResources bool,
 ...
 /* IN */ PassThru bool,
 /* OUT */ OutputObject MSFT_DAClientExperienceConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" , CorporateResources, IPsecTunnelEndpoints, PreferLocalNamesAllowed, UserInterface, SupportEmail, FriendlyName, PassiveMode, CustomCommands, ManualEntryPointSelectionAllowed, GslbFqdn, ForceTunneling, PassThru)
	if err != nil { return }
