...
type MSFT_NetAdapterLargeSendOffloadV1Capabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterLargeSendOffloadV1CapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterLargeSendOffloadV1Capabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterLargeSendOffloadV1Capabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
