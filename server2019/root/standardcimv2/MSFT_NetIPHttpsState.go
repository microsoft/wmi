...
type MSFT_NetIPHttpsState struct { 
	*CIM_ElementSettingData
	...
	func NewMSFT_NetIPHttpsStateEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetIPHttpsState, err error) {tmp, err := NewCIM_ElementSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetIPHttpsState, err error) {tmp, err := NewCIM_ElementSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
