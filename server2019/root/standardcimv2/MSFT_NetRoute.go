...
type MSFT_NetRoute struct { 
	*CIM_NextHopRoute
	...
	func NewMSFT_NetRouteEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetRoute, err error) {tmp, err := NewCIM_NextHopRouteEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetRoute, err error) {tmp, err := NewCIM_NextHopRouteEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetRoute) Create( /* IN */ InterfaceIndex uint32,
 ...
 /* IN */ PassThru bool,
 /* OUT */ CmdletOutput []MSFT_NetRoute) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , InterfaceIndex, InterfaceAlias, DestinationPrefix, NextHop, Publish, RouteMetric, Protocol, CompartmentId, ValidLifetime, PreferredLifetime, PolicyStore, AddressFamily, PassThru)
	if err != nil { return }
...
func (instance *MSFT_NetRoute) Find( /* IN */ InterfaceIndex uint32,
 ...
 /* OUT */ CmdletOutput []CIM_ManagedElement) (result uint32, err error) {retVal, err := instance.InvokeMethod("Find" , InterfaceIndex, LocalIPAddress, RemoteIPAddress)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
