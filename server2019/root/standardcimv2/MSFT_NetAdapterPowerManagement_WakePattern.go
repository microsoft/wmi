...
type MSFT_NetAdapterPowerManagement_WakePattern struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterPowerManagement_WakePatternEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterPowerManagement_WakePattern, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterPowerManagement_WakePattern, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
