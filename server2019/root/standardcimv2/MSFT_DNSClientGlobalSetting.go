...
type MSFT_DNSClientGlobalSetting struct { 
	*CIM_DNSGeneralSettingData
	...
	func NewMSFT_DNSClientGlobalSettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_DNSClientGlobalSetting, err error) {tmp, err := NewCIM_DNSGeneralSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DNSClientGlobalSetting, err error) {tmp, err := NewCIM_DNSGeneralSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
