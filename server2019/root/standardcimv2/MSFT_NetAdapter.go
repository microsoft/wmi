...
type MSFT_NetAdapter struct { 
	*CIM_NetworkPort
	...
	func NewMSFT_NetAdapterEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapter, err error) {tmp, err := NewCIM_NetworkPortEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapter, err error) {tmp, err := NewCIM_NetworkPortEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapter) Enable( /* OUT */ CmdletOutput MSFT_NetAdapter) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" )
	if err != nil { return }
...
// <param name="CmdletOutput" type="MSFT_NetAdapter "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapter) Disable( /* OUT */ CmdletOutput MSFT_NetAdapter) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="CmdletOutput" type="MSFT_NetAdapter "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapter) Restart( /* OUT */ CmdletOutput MSFT_NetAdapter) (result uint32, err error) {retVal, err := instance.InvokeMethod("Restart" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="CmdletOutput" type="MSFT_NetAdapter "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapter) Lock( /* OUT */ CmdletOutput MSFT_NetAdapter) (result uint32, err error) {retVal, err := instance.InvokeMethod("Lock" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="CmdletOutput" type="MSFT_NetAdapter "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapter) Unlock( /* OUT */ CmdletOutput MSFT_NetAdapter) (result uint32, err error) {retVal, err := instance.InvokeMethod("Unlock" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_NetAdapter) Rename( /* IN */ NewName string,
 /* OUT */ CmdletOutput MSFT_NetAdapter) (result uint32, err error) {retVal, err := instance.InvokeMethod("Rename" , NewName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
