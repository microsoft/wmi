...
type MSFT_NetFirewallProfile struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_NetFirewallProfileEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetFirewallProfile, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetFirewallProfile, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
