...
type MSFT_NetEventNetworkAdapter struct { 
	*MSFT_NetEventPacketCaptureTarget
	...
	func NewMSFT_NetEventNetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetEventNetworkAdapter, err error) {tmp, err := NewMSFT_NetEventPacketCaptureTargetEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetEventNetworkAdapter, err error) {tmp, err := NewMSFT_NetEventPacketCaptureTargetEx6(hostName, wmiNamespace, userName, password, domainName, query)
