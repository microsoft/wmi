...
type MSFT_NetEventVFPProvider struct { 
	*MSFT_NetEventProviderBase
	...
	func NewMSFT_NetEventVFPProviderEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetEventVFPProvider, err error) {tmp, err := NewMSFT_NetEventProviderBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetEventVFPProvider, err error) {tmp, err := NewMSFT_NetEventProviderBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
