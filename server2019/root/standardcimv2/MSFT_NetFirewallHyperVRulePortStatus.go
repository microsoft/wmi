...
type MSFT_NetFirewallHyperVRulePortStatus struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetFirewallHyperVRulePortStatusEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetFirewallHyperVRulePortStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetFirewallHyperVRulePortStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
