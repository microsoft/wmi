...
type MSFT_NetEventProviderBase struct { 
	*CIM_LogicalElement
	...
	func NewMSFT_NetEventProviderBaseEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetEventProviderBase, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetEventProviderBase, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
