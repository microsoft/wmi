...
type MSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilities struct { 
	*cim.WmiInstance
	...
	func NewMSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilities, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterEncapsulatedPacketTaskOffloadCapabilities, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
