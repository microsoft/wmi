...
type MSFT_NetFirewallHyperVVMSetting struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_NetFirewallHyperVVMSettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetFirewallHyperVVMSetting, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetFirewallHyperVVMSetting, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
