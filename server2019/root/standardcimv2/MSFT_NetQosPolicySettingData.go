...
type MSFT_NetQosPolicySettingData struct { 
	*MSFT_NetSettingData
	...
	func NewMSFT_NetQosPolicySettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetQosPolicySettingData, err error) {tmp, err := NewMSFT_NetSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetQosPolicySettingData, err error) {tmp, err := NewMSFT_NetSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
