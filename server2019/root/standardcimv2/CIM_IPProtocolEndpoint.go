...
type CIM_IPProtocolEndpoint struct { 
	*CIM_ProtocolEndpoint
	...
	func NewCIM_IPProtocolEndpointEx1(instance *cim.WmiInstance) (newInstance *CIM_IPProtocolEndpoint, err error) {tmp, err := NewCIM_ProtocolEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_IPProtocolEndpoint, err error) {tmp, err := NewCIM_ProtocolEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
