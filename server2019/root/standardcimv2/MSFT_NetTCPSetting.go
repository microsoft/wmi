...
type MSFT_NetTCPSetting struct { 
	*CIM_PolicyAction
	...
	func NewMSFT_NetTCPSettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetTCPSetting, err error) {tmp, err := NewCIM_PolicyActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetTCPSetting, err error) {tmp, err := NewCIM_PolicyActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
