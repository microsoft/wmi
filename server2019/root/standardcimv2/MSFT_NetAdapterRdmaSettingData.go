...
type MSFT_NetAdapterRdmaSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterRdmaSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterRdmaSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterRdmaSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterRdmaSettingData) Enable( /* OUT */ cmdletOutput MSFT_NetAdapterRdmaSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" )
	if err != nil { return }
...
// <param name="cmdletOutput" type="MSFT_NetAdapterRdmaSettingData "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapterRdmaSettingData) Disable( /* OUT */ cmdletOutput MSFT_NetAdapterRdmaSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
