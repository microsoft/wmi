...
type MSFT_NetAdapterQosSettingData struct { 
	*MSFT_NetAdapterSettingData
	...
	func NewMSFT_NetAdapterQosSettingDataEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetAdapterQosSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetAdapterQosSettingData, err error) {tmp, err := NewMSFT_NetAdapterSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_NetAdapterQosSettingData) Enable( /* OUT */ CmdletOutput MSFT_NetAdapterQosSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" )
	if err != nil { return }
...
// <param name="CmdletOutput" type="MSFT_NetAdapterQosSettingData "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_NetAdapterQosSettingData) Disable( /* OUT */ CmdletOutput MSFT_NetAdapterQosSettingData) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
