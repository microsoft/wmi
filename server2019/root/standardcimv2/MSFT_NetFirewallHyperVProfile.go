...
type MSFT_NetFirewallHyperVProfile struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_NetFirewallHyperVProfileEx1(instance *cim.WmiInstance) (newInstance *MSFT_NetFirewallHyperVProfile, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_NetFirewallHyperVProfile, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
