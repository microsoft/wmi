...
type ServiceToEndpointAssociation struct { 
	*cim.WmiInstance
	...
	func NewServiceToEndpointAssociationEx1(instance *cim.WmiInstance) (newInstance *ServiceToEndpointAssociation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceToEndpointAssociation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
