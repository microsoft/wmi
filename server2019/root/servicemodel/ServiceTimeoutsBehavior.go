...
type ServiceTimeoutsBehavior struct { 
	*Behavior
	...
	func NewServiceTimeoutsBehaviorEx1(instance *cim.WmiInstance) (newInstance *ServiceTimeoutsBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceTimeoutsBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
