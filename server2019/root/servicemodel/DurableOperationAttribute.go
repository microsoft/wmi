...
func NewDurableOperationAttributeEx1(instance *cim.WmiInstance) (newInstance *DurableOperationAttribute, err error) {
...
func NewDurableOperationAttributeEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DurableOperationAttribute, err error) {
