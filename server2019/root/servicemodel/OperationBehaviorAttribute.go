...
type OperationBehaviorAttribute struct { 
	*Behavior
	...
	func NewOperationBehaviorAttributeEx1(instance *cim.WmiInstance) (newInstance *OperationBehaviorAttribute, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *OperationBehaviorAttribute, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
