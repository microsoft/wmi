...
type PeerCustomResolverBindingElement struct { 
	*PeerResolverBindingElement
	...
	func NewPeerCustomResolverBindingElementEx1(instance *cim.WmiInstance) (newInstance *PeerCustomResolverBindingElement, err error) {tmp, err := NewPeerResolverBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PeerCustomResolverBindingElement, err error) {tmp, err := NewPeerResolverBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
