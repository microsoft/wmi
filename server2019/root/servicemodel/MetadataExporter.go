...
type MetadataExporter struct { 
	*cim.WmiInstance
	...
	func NewMetadataExporterEx1(instance *cim.WmiInstance) (newInstance *MetadataExporter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MetadataExporter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
