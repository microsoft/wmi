...
type MustUnderstandBehavior struct { 
	*Behavior
	...
	func NewMustUnderstandBehaviorEx1(instance *cim.WmiInstance) (newInstance *MustUnderstandBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MustUnderstandBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
