...
type ServiceAuthorizationBehavior struct { 
	*Behavior
	...
	func NewServiceAuthorizationBehaviorEx1(instance *cim.WmiInstance) (newInstance *ServiceAuthorizationBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceAuthorizationBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
