...
type PeerTransportSecuritySettings struct { 
	*cim.WmiInstance
	...
	func NewPeerTransportSecuritySettingsEx1(instance *cim.WmiInstance) (newInstance *PeerTransportSecuritySettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PeerTransportSecuritySettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
