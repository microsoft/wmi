...
type Service struct { 
	*cim.WmiInstance
	...
	func NewServiceEx1(instance *cim.WmiInstance) (newInstance *Service, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Service, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
