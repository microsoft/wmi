...
type SymmetricSecurityBindingElement struct { 
	*SecurityBindingElement
	...
	func NewSymmetricSecurityBindingElementEx1(instance *cim.WmiInstance) (newInstance *SymmetricSecurityBindingElement, err error) {tmp, err := NewSecurityBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SymmetricSecurityBindingElement, err error) {tmp, err := NewSecurityBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
