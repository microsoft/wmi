...
type CompositeDuplexBindingElement struct { 
	*BindingElement
	...
	func NewCompositeDuplexBindingElementEx1(instance *cim.WmiInstance) (newInstance *CompositeDuplexBindingElement, err error) {tmp, err := NewBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CompositeDuplexBindingElement, err error) {tmp, err := NewBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
