...
type AsymmetricSecurityBindingElement struct { 
	*SecurityBindingElement
	...
	func NewAsymmetricSecurityBindingElementEx1(instance *cim.WmiInstance) (newInstance *AsymmetricSecurityBindingElement, err error) {tmp, err := NewSecurityBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AsymmetricSecurityBindingElement, err error) {tmp, err := NewSecurityBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
