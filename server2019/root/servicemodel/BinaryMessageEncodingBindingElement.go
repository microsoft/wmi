...
type BinaryMessageEncodingBindingElement struct { 
	*MessageEncodingBindingElement
	...
	func NewBinaryMessageEncodingBindingElementEx1(instance *cim.WmiInstance) (newInstance *BinaryMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BinaryMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
