...
type SslStreamSecurityBindingElement struct { 
	*BindingElement
	...
	func NewSslStreamSecurityBindingElementEx1(instance *cim.WmiInstance) (newInstance *SslStreamSecurityBindingElement, err error) {tmp, err := NewBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SslStreamSecurityBindingElement, err error) {tmp, err := NewBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
