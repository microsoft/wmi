...
type XmlDictionaryReaderQuotas struct { 
	*cim.WmiInstance
	...
	func NewXmlDictionaryReaderQuotasEx1(instance *cim.WmiInstance) (newInstance *XmlDictionaryReaderQuotas, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *XmlDictionaryReaderQuotas, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
