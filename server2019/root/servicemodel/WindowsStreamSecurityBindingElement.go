...
func NewWindowsStreamSecurityBindingElementEx1(instance *cim.WmiInstance) (newInstance *WindowsStreamSecurityBindingElement, err error) {
...
func NewWindowsStreamSecurityBindingElementEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *WindowsStreamSecurityBindingElement, err error) {
