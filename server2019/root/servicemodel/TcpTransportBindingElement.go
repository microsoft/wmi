...
type TcpTransportBindingElement struct { 
	*ConnectionOrientedTransportBindingElement
	...
	func NewTcpTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *TcpTransportBindingElement, err error) {tmp, err := NewConnectionOrientedTransportBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TcpTransportBindingElement, err error) {tmp, err := NewConnectionOrientedTransportBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
