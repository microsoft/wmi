...
type Binding struct { 
	*cim.WmiInstance
	...
	func NewBindingEx1(instance *cim.WmiInstance) (newInstance *Binding, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Binding, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
