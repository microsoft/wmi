...
type NamedPipeConnectionPoolSettings struct { 
	*cim.WmiInstance
	...
	func NewNamedPipeConnectionPoolSettingsEx1(instance *cim.WmiInstance) (newInstance *NamedPipeConnectionPoolSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NamedPipeConnectionPoolSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
