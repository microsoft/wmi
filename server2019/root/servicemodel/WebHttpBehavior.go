...
type WebHttpBehavior struct { 
	*Behavior
	...
	func NewWebHttpBehaviorEx1(instance *cim.WmiInstance) (newInstance *WebHttpBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebHttpBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
