...
type TransactionFlowAttribute struct { 
	*Behavior
	...
	func NewTransactionFlowAttributeEx1(instance *cim.WmiInstance) (newInstance *TransactionFlowAttribute, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TransactionFlowAttribute, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
