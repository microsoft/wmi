...
type Channel struct { 
	*cim.WmiInstance
	...
	func NewChannelEx1(instance *cim.WmiInstance) (newInstance *Channel, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Channel, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
