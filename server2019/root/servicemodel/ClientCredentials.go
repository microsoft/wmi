...
type ClientCredentials struct { 
	*Behavior
	...
	func NewClientCredentialsEx1(instance *cim.WmiInstance) (newInstance *ClientCredentials, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClientCredentials, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
