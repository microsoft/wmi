...
type WorkflowRuntimeBehavior struct { 
	*Behavior
	...
	func NewWorkflowRuntimeBehaviorEx1(instance *cim.WmiInstance) (newInstance *WorkflowRuntimeBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WorkflowRuntimeBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
