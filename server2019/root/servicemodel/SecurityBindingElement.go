...
type SecurityBindingElement struct { 
	*BindingElement
	...
	func NewSecurityBindingElementEx1(instance *cim.WmiInstance) (newInstance *SecurityBindingElement, err error) {tmp, err := NewBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SecurityBindingElement, err error) {tmp, err := NewBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
