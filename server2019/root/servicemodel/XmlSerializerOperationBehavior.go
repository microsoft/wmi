...
type XmlSerializerOperationBehavior struct { 
	*Behavior
	...
	func NewXmlSerializerOperationBehaviorEx1(instance *cim.WmiInstance) (newInstance *XmlSerializerOperationBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *XmlSerializerOperationBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
