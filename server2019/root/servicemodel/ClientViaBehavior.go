...
type ClientViaBehavior struct { 
	*Behavior
	...
	func NewClientViaBehaviorEx1(instance *cim.WmiInstance) (newInstance *ClientViaBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ClientViaBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
