...
type TransactionFlowBindingElement struct { 
	*BindingElement
	...
	func NewTransactionFlowBindingElementEx1(instance *cim.WmiInstance) (newInstance *TransactionFlowBindingElement, err error) {tmp, err := NewBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TransactionFlowBindingElement, err error) {tmp, err := NewBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
