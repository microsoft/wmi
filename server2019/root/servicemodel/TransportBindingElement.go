...
type TransportBindingElement struct { 
	*BindingElement
	...
	func NewTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *TransportBindingElement, err error) {tmp, err := NewBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TransportBindingElement, err error) {tmp, err := NewBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
