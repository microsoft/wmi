...
type DeliveryRequirementsAttribute struct { 
	*Behavior
	...
	func NewDeliveryRequirementsAttributeEx1(instance *cim.WmiInstance) (newInstance *DeliveryRequirementsAttribute, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DeliveryRequirementsAttribute, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
