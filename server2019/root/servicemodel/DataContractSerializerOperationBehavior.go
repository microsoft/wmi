...
type DataContractSerializerOperationBehavior struct { 
	*Behavior
	...
	func NewDataContractSerializerOperationBehaviorEx1(instance *cim.WmiInstance) (newInstance *DataContractSerializerOperationBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DataContractSerializerOperationBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
