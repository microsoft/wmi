...
type AppDomainInfo struct { 
	*cim.WmiInstance
	...
	func NewAppDomainInfoEx1(instance *cim.WmiInstance) (newInstance *AppDomainInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AppDomainInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
