...
type ServiceDebugBehavior struct { 
	*Behavior
	...
	func NewServiceDebugBehaviorEx1(instance *cim.WmiInstance) (newInstance *ServiceDebugBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceDebugBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
