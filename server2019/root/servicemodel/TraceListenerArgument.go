...
type TraceListenerArgument struct { 
	*cim.WmiInstance
	...
	func NewTraceListenerArgumentEx1(instance *cim.WmiInstance) (newInstance *TraceListenerArgument, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TraceListenerArgument, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
