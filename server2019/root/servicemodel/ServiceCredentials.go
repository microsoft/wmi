...
type ServiceCredentials struct { 
	*Behavior
	...
	func NewServiceCredentialsEx1(instance *cim.WmiInstance) (newInstance *ServiceCredentials, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceCredentials, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
