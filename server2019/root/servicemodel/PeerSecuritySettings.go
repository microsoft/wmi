...
type PeerSecuritySettings struct { 
	*cim.WmiInstance
	...
	func NewPeerSecuritySettingsEx1(instance *cim.WmiInstance) (newInstance *PeerSecuritySettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PeerSecuritySettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
