...
type Endpoint struct { 
	*cim.WmiInstance
	...
	func NewEndpointEx1(instance *cim.WmiInstance) (newInstance *Endpoint, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Endpoint, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Endpoint) GetOperationCounterInstanceName( /* IN */ Operation string) (result string, err error) {retVal, err := instance.InvokeMethodWithReturn("GetOperationCounterInstanceName" , Operation);
	if err != nil { return }
