...
type PeerResolverBindingElement struct { 
	*BindingElement
	...
	func NewPeerResolverBindingElementEx1(instance *cim.WmiInstance) (newInstance *PeerResolverBindingElement, err error) {tmp, err := NewBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PeerResolverBindingElement, err error) {tmp, err := NewBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
