...
type MsmqTransportBindingElement struct { 
	*MsmqBindingElementBase
	...
	func NewMsmqTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *MsmqTransportBindingElement, err error) {tmp, err := NewMsmqBindingElementBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsmqTransportBindingElement, err error) {tmp, err := NewMsmqBindingElementBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
