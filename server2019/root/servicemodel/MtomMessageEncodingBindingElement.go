...
type MtomMessageEncodingBindingElement struct { 
	*MessageEncodingBindingElement
	...
	func NewMtomMessageEncodingBindingElementEx1(instance *cim.WmiInstance) (newInstance *MtomMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx1(instance)
		
	if err != nil { return }
	newInstance = &MtomMessageEncodingBindingElement {
	...
	func NewMtomMessageEncodingBindingElementEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MtomMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MtomMessageEncodingBindingElement) SetPropertyEncoding(value string) (err error) { 
    return instance.SetProperty("Encoding", (value))
}

// GetEncoding gets the value of Encoding for the instance
func (instance *MtomMessageEncodingBindingElement) GetPropertyEncoding()(value string, err error) { 
...
func (instance *MtomMessageEncodingBindingElement) SetPropertyMaxReadPoolSize(value int32) (err error) { 
    return instance.SetProperty("MaxReadPoolSize", (value))
}

// GetMaxReadPoolSize gets the value of MaxReadPoolSize for the instance
func (instance *MtomMessageEncodingBindingElement) GetPropertyMaxReadPoolSize()(value int32, err error) { 
...
func (instance *MtomMessageEncodingBindingElement) SetPropertyMaxWritePoolSize(value int32) (err error) { 
...
func (instance *MtomMessageEncodingBindingElement) GetPropertyMaxWritePoolSize()(value int32, err error) { 
...
func (instance *MtomMessageEncodingBindingElement) SetPropertyReaderQuotas(value XmlDictionaryReaderQuotas) (err error) { 
    return instance.SetProperty("ReaderQuotas", (value))
}

// GetReaderQuotas gets the value of ReaderQuotas for the instance
func (instance *MtomMessageEncodingBindingElement) GetPropertyReaderQuotas()(value XmlDictionaryReaderQuotas, err error) { 
