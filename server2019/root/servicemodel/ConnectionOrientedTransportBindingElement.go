...
type ConnectionOrientedTransportBindingElement struct { 
	*TransportBindingElement
	...
	func NewConnectionOrientedTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *ConnectionOrientedTransportBindingElement, err error) {tmp, err := NewTransportBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ConnectionOrientedTransportBindingElement, err error) {tmp, err := NewTransportBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
