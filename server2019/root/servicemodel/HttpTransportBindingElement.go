...
type HttpTransportBindingElement struct { 
	*TransportBindingElement
	...
	func NewHttpTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *HttpTransportBindingElement, err error) {tmp, err := NewTransportBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HttpTransportBindingElement, err error) {tmp, err := NewTransportBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
