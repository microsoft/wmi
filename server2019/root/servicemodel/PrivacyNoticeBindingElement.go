...
type PrivacyNoticeBindingElement struct { 
	*BindingElement
	...
	func NewPrivacyNoticeBindingElementEx1(instance *cim.WmiInstance) (newInstance *PrivacyNoticeBindingElement, err error) {tmp, err := NewBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PrivacyNoticeBindingElement, err error) {tmp, err := NewBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
