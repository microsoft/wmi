...
type ServiceThrottlingBehavior struct { 
	*Behavior
	...
	func NewServiceThrottlingBehaviorEx1(instance *cim.WmiInstance) (newInstance *ServiceThrottlingBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceThrottlingBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
