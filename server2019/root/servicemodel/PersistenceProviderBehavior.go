...
type PersistenceProviderBehavior struct { 
	*Behavior
	...
	func NewPersistenceProviderBehaviorEx1(instance *cim.WmiInstance) (newInstance *PersistenceProviderBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PersistenceProviderBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
