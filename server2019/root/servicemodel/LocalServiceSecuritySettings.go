...
type LocalServiceSecuritySettings struct { 
	*cim.WmiInstance
	...
	func NewLocalServiceSecuritySettingsEx1(instance *cim.WmiInstance) (newInstance *LocalServiceSecuritySettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *LocalServiceSecuritySettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
