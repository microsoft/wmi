...
type WebGetAttribute struct { 
	*Behavior
	...
	func NewWebGetAttributeEx1(instance *cim.WmiInstance) (newInstance *WebGetAttribute, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebGetAttribute, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
