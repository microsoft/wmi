...
type WebMessageEncodingBindingElement struct { 
	*MessageEncodingBindingElement
	...
	func NewWebMessageEncodingBindingElementEx1(instance *cim.WmiInstance) (newInstance *WebMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WebMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
