...
type ServiceSecurityAuditBehavior struct { 
	*Behavior
	...
	func NewServiceSecurityAuditBehaviorEx1(instance *cim.WmiInstance) (newInstance *ServiceSecurityAuditBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceSecurityAuditBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
