...
type ServiceAppDomain struct { 
	*cim.WmiInstance
	...
	func NewServiceAppDomainEx1(instance *cim.WmiInstance) (newInstance *ServiceAppDomain, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceAppDomain, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
