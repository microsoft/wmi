...
type ServiceBehaviorAttribute struct { 
	*Behavior
	...
	func NewServiceBehaviorAttributeEx1(instance *cim.WmiInstance) (newInstance *ServiceBehaviorAttribute, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServiceBehaviorAttribute, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
