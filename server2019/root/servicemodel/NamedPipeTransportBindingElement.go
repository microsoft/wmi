...
type NamedPipeTransportBindingElement struct { 
	*ConnectionOrientedTransportBindingElement
	...
	func NewNamedPipeTransportBindingElementEx1(instance *cim.WmiInstance) (newInstance *NamedPipeTransportBindingElement, err error) {tmp, err := NewConnectionOrientedTransportBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NamedPipeTransportBindingElement, err error) {tmp, err := NewConnectionOrientedTransportBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
