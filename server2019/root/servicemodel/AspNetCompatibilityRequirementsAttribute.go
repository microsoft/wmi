...
type AspNetCompatibilityRequirementsAttribute struct { 
	*Behavior
	...
	func NewAspNetCompatibilityRequirementsAttributeEx1(instance *cim.WmiInstance) (newInstance *AspNetCompatibilityRequirementsAttribute, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AspNetCompatibilityRequirementsAttribute, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
