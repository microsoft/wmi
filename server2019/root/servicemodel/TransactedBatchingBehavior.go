...
type TransactedBatchingBehavior struct { 
	*Behavior
	...
	func NewTransactedBatchingBehaviorEx1(instance *cim.WmiInstance) (newInstance *TransactedBatchingBehavior, err error) {tmp, err := NewBehaviorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TransactedBatchingBehavior, err error) {tmp, err := NewBehaviorEx6(hostName, wmiNamespace, userName, password, domainName, query)
