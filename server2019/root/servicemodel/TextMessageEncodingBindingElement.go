...
type TextMessageEncodingBindingElement struct { 
	*MessageEncodingBindingElement
	...
	func NewTextMessageEncodingBindingElementEx1(instance *cim.WmiInstance) (newInstance *TextMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *TextMessageEncodingBindingElement, err error) {tmp, err := NewMessageEncodingBindingElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
