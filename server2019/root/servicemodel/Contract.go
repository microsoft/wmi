...
type Contract struct { 
	*cim.WmiInstance
	...
	func NewContractEx1(instance *cim.WmiInstance) (newInstance *Contract, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Contract, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
