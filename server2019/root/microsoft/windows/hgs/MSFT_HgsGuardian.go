...
type MSFT_HgsGuardian struct { 
	*cim.WmiInstance
	...
	func NewMSFT_HgsGuardianEx1(instance *cim.WmiInstance) (newInstance *MSFT_HgsGuardian, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HgsGuardian, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_HgsGuardian) NewByAcceptCertificates( /* IN */ Name string,
 ...
 /* OUT */ cmdletOutput MSFT_HgsGuardian) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByAcceptCertificates" , Name, EncryptionCertificate, SigningCertificate, SigningCertificatePassword, EncryptionCertificatePassword, AllowExpired, AllowUntrustedRoot)
	if err != nil { return }
...
func (instance *MSFT_HgsGuardian) NewByCertificateThumbprints( /* IN */ Name string,
 ...
 /* IN */ AllowExpired bool,
 /* IN */ AllowUntrustedRoot bool,
 /* OUT */ cmdletOutput MSFT_HgsGuardian) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByCertificateThumbprints" , Name, SigningCertificateThumbprint, EncryptionCertificateThumbprint, AllowExpired, AllowUntrustedRoot)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsGuardian) NewByGenerateCertificates( /* IN */ Name string,
 ...
 /* OUT */ cmdletOutput MSFT_HgsGuardian) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByGenerateCertificates" , Name, GenerateCertificates)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsGuardian) Import( /* IN */ Path string,
 ...
 /* IN */ AllowExpired bool,
 /* IN */ AllowUntrustedRoot bool,
 /* OUT */ cmdletOutput MSFT_HgsGuardian) (result uint32, err error) {retVal, err := instance.InvokeMethod("Import" , Path, Name, AllowExpired, AllowUntrustedRoot)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsGuardian) Export( /* IN */ Path string,
 /* IN */ InputObject MSFT_HgsGuardian) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Export" , Path, InputObject);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_HgsGuardian) Remove( /* IN */ Name string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Remove" , Name);
	if err != nil { return }
	result = uint32(retVal)
	return
