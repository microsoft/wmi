...
type MSFT_HgsKeyProtector struct { 
	*cim.WmiInstance
	...
	func NewMSFT_HgsKeyProtectorEx1(instance *cim.WmiInstance) (newInstance *MSFT_HgsKeyProtector, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HgsKeyProtector, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_HgsKeyProtector) NewByGuardians( /* IN */ AllowUntrustedRoot bool,
 ...
 /* OUT */ cmdletOutput MSFT_HgsKeyProtector) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByGuardians" , AllowUntrustedRoot, AllowExpired, Owner, Guardian)
	if err != nil { return }
...
func (instance *MSFT_HgsKeyProtector) Grant( /* IN */ KeyProtector MSFT_HgsKeyProtector,
 ...
 /* OUT */ cmdletOutput MSFT_HgsKeyProtector) (result uint32, err error) {retVal, err := instance.InvokeMethod("Grant" , KeyProtector, Guardian, AllowExpired, AllowUntrustedRoot)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsKeyProtector) Revoke( /* IN */ KeyProtector MSFT_HgsKeyProtector,
 /* IN */ Guardian MSFT_HgsGuardian,
 /* OUT */ cmdletOutput MSFT_HgsKeyProtector) (result uint32, err error) {retVal, err := instance.InvokeMethod("Revoke" , KeyProtector, Guardian)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsKeyProtector) ConvertToByRawBytes( /* IN */ Bytes []uint8,
 /* OUT */ cmdletOutput MSFT_HgsKeyProtector) (result uint32, err error) {retVal, err := instance.InvokeMethod("ConvertToByRawBytes" , Bytes)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
