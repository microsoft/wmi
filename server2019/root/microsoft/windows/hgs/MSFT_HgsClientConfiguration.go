...
type MSFT_HgsClientConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMSFT_HgsClientConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_HgsClientConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HgsClientConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_HgsClientConfiguration) Get( /* OUT */ cmdletOutput MSFT_HgsClientConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" )
	if err != nil { return }
...
func (instance *MSFT_HgsClientConfiguration) IsHostTrusted( /* IN */ AttestationServerUrl string,
 ...
 /* OUT */ AttestationSubstatus uint64) (result uint32, err error) {retVal, err := instance.InvokeMethod("IsHostTrusted" , AttestationServerUrl)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsClientConfiguration) SetByChangeToLocalMode( /* IN */ EnableLocalMode bool,
 /* OUT */ cmdletOutput MSFT_HgsClientConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByChangeToLocalMode" , EnableLocalMode)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsClientConfiguration) SetBySecureHostingServiceMode( /* IN */ KeyProtectionServerUrl string,
 ...
 /* OPTIONAL IN */ FallbackAttestationServerUrl []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetBySecureHostingServiceMode" , KeyProtectionServerUrl, AttestationServerUrl, FallbackKeyProtectionServerUrl, FallbackAttestationServerUrl)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
