...
type MSFT_HgsKeyProtectorOperations struct { 
	*cim.WmiInstance
	...
	func NewMSFT_HgsKeyProtectorOperationsEx1(instance *cim.WmiInstance) (newInstance *MSFT_HgsKeyProtectorOperations, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HgsKeyProtectorOperations, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_HgsKeyProtectorOperations) UnwrapKeyProtector( /* IN */ IngressKeyProtector []uint8,
 ...
 /* OUT */ EgressKeyProtector []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("UnwrapKeyProtector" , IngressKeyProtector)
	if err != nil { return }
...
func (instance *MSFT_HgsKeyProtectorOperations) CreateKeyProtector( /* OUT */ EncryptedTransferKey []uint8,
 /* OUT */ EncryptedWrappingKey []uint8,
 /* OUT */ EncryptedKeys []uint8,
 /* OUT */ EgressKeyProtector []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateKeyProtector" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsKeyProtectorOperations) EncryptDataWithKeyProtector( /* IN */ BaseKeyProtector []uint8,
 ...
 /* OUT */ EncryptedData []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("EncryptDataWithKeyProtector" , BaseKeyProtector, UniqueEncryptionIdentifier, PlaintextData, RollKeyProtector)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_HgsKeyProtectorOperations) DecryptDataWithKeyProtector( /* IN */ BaseKeyProtector []uint8,
 ...
 /* OUT */ PlaintextData []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("DecryptDataWithKeyProtector" , BaseKeyProtector, EncryptedData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
