...
type DiagnosticInfo struct { 
	*cim.WmiInstance
	...
	func NewDiagnosticInfoEx1(instance *cim.WmiInstance) (newInstance *DiagnosticInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DiagnosticInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
