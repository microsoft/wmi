...
type MSFT_SmbWitnessClient struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbWitnessClientEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbWitnessClient, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbWitnessClient, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SmbWitnessClient) MoveClient( /* IN */ ClientName string,
 ...
 /* IN */ NetworkName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("MoveClient" , ClientName, DestinationNode, NetworkName);
	if err != nil { return }
