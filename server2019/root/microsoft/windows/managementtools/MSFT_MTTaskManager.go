...
type MSFT_MTTaskManager struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_MTTaskManagerEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTTaskManager, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTTaskManager, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_MTTaskManager) SetInterval( /* IN */ Seconds uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetInterval" , Seconds);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_MTTaskManager) ForceRefresh() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ForceRefresh" );
	if err != nil { return }
	result = uint32(retVal)
	return
