...
type MSFT_MTRegistryKey struct { 
	*MSFT_MTRegistryObject
	...
	func NewMSFT_MTRegistryKeyEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTRegistryKey, err error) {tmp, err := NewMSFT_MTRegistryObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTRegistryKey, err error) {tmp, err := NewMSFT_MTRegistryObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_MTRegistryKey) GetSubKeys( /* OUT */ Results []MSFT_MTRegistryKey) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSubKeys" )
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_MTRegistryKey) GetValues( /* OUT */ Results []MSFT_MTRegistryValue) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetValues" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MTRegistryKey) Rename( /* IN */ NewName string,
 /* OUT */ Result MSFT_MTRegistryKey) (result uint32, err error) {retVal, err := instance.InvokeMethod("Rename" , NewName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MTRegistryKey) GetKey( /* IN */ Name string,
 /* OUT */ Result MSFT_MTRegistryKey) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetKey" , Name)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
