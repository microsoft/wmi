...
type MSFT_MTEventChannel struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_MTEventChannelEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTEventChannel, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTEventChannel, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_MTEventChannel) Enable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Enable" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_MTEventChannel) Disable() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Disable" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_MTEventChannel) ClearLogFile() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ClearLogFile" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_MTEventChannel) GetEventRecords( /* IN */ FilterXml string,
 ...
 /* IN */ BatchSize uint32,
 /* OUT */ Result []MSFT_MTEventRecord) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetEventRecords" , FilterXml, Skip, Top, ReverseDirection, BatchSize)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_MTEventChannel) GetWindowsEventChannels( /* OUT */ Result []MSFT_MTEventChannel) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetWindowsEventChannels" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
