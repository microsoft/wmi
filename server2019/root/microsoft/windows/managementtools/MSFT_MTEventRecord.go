...
type MSFT_MTEventRecord struct { 
	*cim.WmiInstance
	...
	func NewMSFT_MTEventRecordEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTEventRecord, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTEventRecord, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
