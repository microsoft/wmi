...
type MSFT_MTLogicalProcessor struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_MTLogicalProcessorEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTLogicalProcessor, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTLogicalProcessor, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
