...
type MSFT_MTNetworkAdapter struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_MTNetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTNetworkAdapter, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTNetworkAdapter, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
