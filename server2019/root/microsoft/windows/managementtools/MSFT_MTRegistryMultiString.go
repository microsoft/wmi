...
type MSFT_MTRegistryMultiString struct { 
	*MSFT_MTRegistryValue
	...
	func NewMSFT_MTRegistryMultiStringEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTRegistryMultiString, err error) {tmp, err := NewMSFT_MTRegistryValueEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTRegistryMultiString, err error) {tmp, err := NewMSFT_MTRegistryValueEx6(hostName, wmiNamespace, userName, password, domainName, query)
