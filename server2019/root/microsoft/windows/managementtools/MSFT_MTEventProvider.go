...
type MSFT_MTEventProvider struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_MTEventProviderEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTEventProvider, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTEventProvider, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_MTEventProvider) GetChannels( /* OUT */ Result []MSFT_MTEventChannel) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetChannels" )
	if err != nil { return }
...
func (instance *MSFT_MTEventProvider) GetProvidersAndWindowsEventChannels( /* OUT */ EventProviders []MSFT_MTEventProvider,
 /* OUT */ WindowsEventChannels []MSFT_MTEventChannel) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetProvidersAndWindowsEventChannels" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
