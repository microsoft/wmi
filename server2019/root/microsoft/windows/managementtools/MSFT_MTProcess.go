...
type MSFT_MTProcess struct { 
	*CIM_ManagedElement
	...
	func NewMSFT_MTProcessEx1(instance *cim.WmiInstance) (newInstance *MSFT_MTProcess, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MTProcess, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_MTProcess) CreateDump( /* OUT */ DumpFilePath string) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateDump" )
	if err != nil { return }
...
func (instance *MSFT_MTProcess) CreateProcess( /* IN */ CommandLine string,
 ...
 /* OUT */ ActualCommandLine string) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateProcess" , CommandLine, WaitMilliseconds)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
