...
type Win32_DeviceGuard struct { 
	*cim.WmiInstance
	...
	func NewWin32_DeviceGuardEx1(instance *cim.WmiInstance) (newInstance *Win32_DeviceGuard, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Win32_DeviceGuard, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
