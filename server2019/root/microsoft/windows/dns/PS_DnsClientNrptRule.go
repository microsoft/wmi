...
type PS_DnsClientNrptRule struct { 
	*cim.WmiInstance
	...
	func NewPS_DnsClientNrptRuleEx1(instance *cim.WmiInstance) (newInstance *PS_DnsClientNrptRule, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_DnsClientNrptRule, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_DnsClientNrptRule) Add( /* IN */ GpoName string,
 ...
 /* IN */ Namespace []string,
 /* IN */ Server string,
 /* OUT */ cmdletOutput DnsClientNrptRule) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , GpoName, DANameServers, DAIPsecRequired, DAIPsecEncryptionType, DAProxyServerName, DnsSecEnable, PassThru, DAProxyType, DnsSecValidationRequired, DAEnable, IPsecTrustAuthority, Comment, DisplayName, DnsSecIPsecRequired, DnsSecIPsecEncryptionType, NameServers, NameEncoding, Namespace, Server)
	if err != nil { return }
...
func (instance *PS_DnsClientNrptRule) Remove( /* IN */ GpoName string,
 ...
 /* IN */ Server string,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput DnsClientNrptRule) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , GpoName, Name, PassThru, Server, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DnsClientNrptRule) Get( /* IN */ GpoName string,
 /* IN */ Name []string,
 /* IN */ Server string,
 /* OUT */ cmdletOutput []DnsClientNrptRule) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , GpoName, Name, Server)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
