...
type DnsClientPolicyConfiguration struct { 
	*cim.WmiInstance
	...
	func NewDnsClientPolicyConfigurationEx1(instance *cim.WmiInstance) (newInstance *DnsClientPolicyConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DnsClientPolicyConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
