...
type PS_DnsClientNrptGlobal struct { 
	*cim.WmiInstance
	...
	func NewPS_DnsClientNrptGlobalEx1(instance *cim.WmiInstance) (newInstance *PS_DnsClientNrptGlobal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_DnsClientNrptGlobal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_DnsClientNrptGlobal) Set( /* IN */ EnableDAForAllNetworks string,
 ...
 /* IN */ Server string,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput DnsClientNrptGlobal) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , EnableDAForAllNetworks, GpoName, SecureNameQueryFallback, QueryPolicy, Server, PassThru)
	if err != nil { return }
...
func (instance *PS_DnsClientNrptGlobal) Get( /* IN */ Server string,
 /* IN */ GpoName string,
 /* OUT */ cmdletOutput DnsClientNrptGlobal) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , Server, GpoName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
