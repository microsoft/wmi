...
func NewMSFT_VsmIdkSigningCertificateEx1(instance *cim.WmiInstance) (newInstance *MSFT_VsmIdkSigningCertificate, err error) {
...
func NewMSFT_VsmIdkSigningCertificateEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_VsmIdkSigningCertificate, err error) {
