...
type MSFT_VsmIdkEncryptionCertificate struct { 
	*cim.WmiInstance
	...
	func NewMSFT_VsmIdkEncryptionCertificateEx1(instance *cim.WmiInstance) (newInstance *MSFT_VsmIdkEncryptionCertificate, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VsmIdkEncryptionCertificate, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
