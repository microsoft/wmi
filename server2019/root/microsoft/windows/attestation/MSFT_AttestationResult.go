...
type MSFT_AttestationResult struct { 
	*cim.WmiInstance
	...
	func NewMSFT_AttestationResultEx1(instance *cim.WmiInstance) (newInstance *MSFT_AttestationResult, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_AttestationResult, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
