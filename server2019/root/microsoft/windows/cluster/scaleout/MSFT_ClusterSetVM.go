...
type MSFT_ClusterSetVM struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetVMEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSetVM, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSetVM, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_ClusterSetVM) Online() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Online" );
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_ClusterSetVM) Offline() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Offline" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_ClusterSetVM) Move( /* IN */ Node string,
 /* IN */ MoveType uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Move" , Node, MoveType);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_ClusterSetVM) DestroyVm( /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("DestroyVm" , Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_ClusterSetVM) UnclusterVm( /* IN */ Force bool,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UnclusterVm" , Force, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_ClusterSetVM) SetVmProperties( /* IN */ AvailabilitySetName string,
 /* IN */ PlacementCondition string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetVmProperties" , AvailabilitySetName, PlacementCondition);
	if err != nil { return }
	result = uint32(retVal)
	return
