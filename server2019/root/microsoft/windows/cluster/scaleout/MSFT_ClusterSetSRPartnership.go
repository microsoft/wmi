...
type MSFT_ClusterSetSRPartnership struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetSRPartnershipEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSetSRPartnership, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSetSRPartnership, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_ClusterSetSRPartnership) RemoveSRPartnership( /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveSRPartnership" , Flags);
	if err != nil { return }
...
func (instance *MSFT_ClusterSetSRPartnership) SetSRPartnershipProperties( /* IN */ Name string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSRPartnershipProperties" , Name, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
