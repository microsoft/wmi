...
type MSFT_ClusterSet struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSet, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MSFT_ClusterSet {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMSFT_ClusterSetEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSet, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_ClusterSet) AddMember( /* IN */ Name string,
 /* IN */ Flags uint32,
 /* OUT */ Member MSFT_ClusterSetMember) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddMember" , Name, Flags)
	if err != nil { return }
...
func (instance *MSFT_ClusterSet) AddVm( /* IN */ vmConfig string,
 ...
 /* IN */ vmName string,
 /* IN */ vmHost string,
 /* OUT */ VM MSFT_ClusterSetVM) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddVm" , vmConfig, vmId, vmName, vmHost)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ClusterSet) GetOptimalNodeForVm( /* IN */ VmMemory uint32,
 ...
 /* OUT */ Node MSFT_ClusterSetNode) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetOptimalNodeForVm" , VmMemory, VmVirtualCoreCount, VmCpuReservation, VmFlags, Version, LocalDiskSize, PlacementCondition, AvailabilitySetName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ClusterSet) DoOp( /* IN */ operation string,
 ...
 /* IN */ param2 string,
 /* IN */ param3 string,
 /* OUT */ outparam1 string) (result uint32, err error) {retVal, err := instance.InvokeMethod("DoOp" , operation, param1, param2, param3)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ClusterSet) Set( /* IN */ NamespaceRoot string,
 /* IN */ VMFailoverMode uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Set" , NamespaceRoot, VMFailoverMode);
	if err != nil { return }
...
func (instance *MSFT_ClusterSet) AddSRPartnership( /* IN */ Name string,
 ...
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddSRPartnership" , Name, SourceClusterName, SourceRGName, DestinationClusterName, DestinationRGName, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
