...
type MSFT_ClusterSetFaultDomain struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetFaultDomainEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSetFaultDomain, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSetFaultDomain, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_ClusterSetFaultDomain) CreateFaultDomain( /* IN */ FDName string,
 ...
 /* IN */ Flags uint32,
 /* OUT */ CreatedFaultDomain MSFT_ClusterSetFaultDomain) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateFaultDomain" , FDName, ClusterName, FDType, Description, Flags)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_ClusterSetFaultDomain) RemoveFaultDomain( /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveFaultDomain" , Flags);
	if err != nil { return }
...
func (instance *MSFT_ClusterSetFaultDomain) AddMembers( /* IN */ ClusterName []string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddMembers" , ClusterName, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_ClusterSetFaultDomain) RemoveMembers( /* IN */ ClusterName []string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveMembers" , ClusterName, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
