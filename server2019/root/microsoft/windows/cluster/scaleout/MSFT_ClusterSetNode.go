...
type MSFT_ClusterSetNode struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetNodeEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSetNode, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSetNode, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
