...
type MSFT_ClusterSetKey struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetKeyEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSetKey, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSetKey, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
