...
type MSFT_ClusterSetAvailabilitySet struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetAvailabilitySetEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSetAvailabilitySet, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSetAvailabilitySet, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_ClusterSetAvailabilitySet) CreateAvailabilitySet( /* IN */ AvailabilitySetName string,
 ...
 /* IN */ Flags uint32,
 /* OUT */ CreatedAvailabilitySet MSFT_ClusterSetAvailabilitySet) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateAvailabilitySet" , AvailabilitySetName, FaultDomains, UpdateDomains, FDType, ParticipantName, SoftEnforcement, Flags)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_ClusterSetAvailabilitySet) RemoveAvailabilitySet( /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveAvailabilitySet" , Flags);
	if err != nil { return }
...
func (instance *MSFT_ClusterSetAvailabilitySet) AddParticipant( /* IN */ ParticipantName []string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddParticipant" , ParticipantName, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_ClusterSetAvailabilitySet) RemoveParticipant( /* IN */ ParticipantName []string,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveParticipant" , ParticipantName, Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
