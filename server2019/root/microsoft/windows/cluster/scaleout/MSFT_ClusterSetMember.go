...
type MSFT_ClusterSetMember struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusterSetMemberEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusterSetMember, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusterSetMember, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_ClusterSetMember) Evict( /* IN */ Force bool,
 /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Evict" , Force, Flags);
	if err != nil { return }
...
func (instance *MSFT_ClusterSetMember) GetKey( /* IN */ KeyType uint32,
 /* IN */ Flags uint32,
 /* OUT */ key MSFT_ClusterSetKey) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetKey" , KeyType, Flags)
	if err != nil { return }
...
func (instance *MSFT_ClusterSetMember) ClusterLocalVm( /* IN */ vmConfig string,
 ...
 /* OUT */ VM MSFT_ClusterSetVM) (result uint32, err error) {retVal, err := instance.InvokeMethod("ClusterLocalVm" , vmConfig, Id, Name, AvailabilitySetName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_ClusterSetMember) AddTags( /* IN */ Tag []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddTags" , Tag);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_ClusterSetMember) RemoveTags( /* IN */ Tag []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveTags" , Tag);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_ClusterSetMember) AddVM( /* IN */ VMId string,
 ...
 /* IN */ RegisterAll bool,
 /* IN */ AvailabilitySetName string,
 /* OUT */ VM []MSFT_ClusterSetVM) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddVM" , VMId, VMName, RegisterAll, AvailabilitySetName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
