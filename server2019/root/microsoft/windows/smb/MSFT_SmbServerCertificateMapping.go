...
type MSFT_SmbServerCertificateMapping struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbServerCertificateMappingEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbServerCertificateMapping, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbServerCertificateMapping, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SmbServerCertificateMapping) AddServerCertificateMapping( /* IN */ Name string,
 ...
 /* OUT */ CreatedMapping MSFT_SmbServerCertificateMapping) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddServerCertificateMapping" , Name, Subject, Thumbprint, DisplayName, StoreName, Type, Flags, RequireClientAuthentication, SkipClientCertificateAccessCheck)
	if err != nil { return }
...
func (instance *MSFT_SmbServerCertificateMapping) SetServerCertificateMapping( /* IN */ Name string,
 ...
 /* IN */ RequireClientAuthentication bool,
 /* IN */ SkipClientCertificateAccessCheck bool,
 /* OUT */ CreatedMapping MSFT_SmbServerCertificateMapping) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetServerCertificateMapping" , Name, Thumbprint, StoreName, Flags, RequireClientAuthentication, SkipClientCertificateAccessCheck)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_SmbServerCertificateMapping) GrantClientAccessToServer( /* IN */ IdentifierType uint32,
 ...
 /* OUT */ Output []MSFT_SmbServerCertificateMappingAccessControlEntry) (result uint32, err error) {retVal, err := instance.InvokeMethod("GrantClientAccessToServer" , IdentifierType, Identifier, Description)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_SmbServerCertificateMapping) RevokeClientAccessToServer( /* IN */ IdentifierType uint32,
 /* IN */ Identifier string,
 /* OUT */ Output []MSFT_SmbServerCertificateMappingAccessControlEntry) (result uint32, err error) {retVal, err := instance.InvokeMethod("RevokeClientAccessToServer" , IdentifierType, Identifier)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_SmbServerCertificateMapping) BlockClientAccessToServer( /* IN */ IdentifierType uint32,
 /* IN */ Identifier string,
 /* IN */ Description string,
 /* OUT */ Output []MSFT_SmbServerCertificateMappingAccessControlEntry) (result uint32, err error) {retVal, err := instance.InvokeMethod("BlockClientAccessToServer" , IdentifierType, Identifier, Description)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_SmbServerCertificateMapping) UnblockClientAccessToServer( /* IN */ IdentifierType uint32,
 /* IN */ Identifier string,
 /* OUT */ Output []MSFT_SmbServerCertificateMappingAccessControlEntry) (result uint32, err error) {retVal, err := instance.InvokeMethod("UnblockClientAccessToServer" , IdentifierType, Identifier)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="Output" type="MSFT_SmbServerCertificateMappingAccessControlEntry []"></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_SmbServerCertificateMapping) GetAccessControlEntries( /* OUT */ Output []MSFT_SmbServerCertificateMappingAccessControlEntry) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetAccessControlEntries" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
