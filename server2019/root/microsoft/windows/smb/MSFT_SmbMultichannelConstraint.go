...
type MSFT_SmbMultichannelConstraint struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbMultichannelConstraintEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbMultichannelConstraint, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbMultichannelConstraint, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SmbMultichannelConstraint) CreateConstraint( /* IN */ ServerName string,
 ...
 /* OUT */ Output []MSFT_SmbMultichannelConstraint) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateConstraint" , ServerName, InterfaceIndex, InterfaceAlias)
	if err != nil { return }
