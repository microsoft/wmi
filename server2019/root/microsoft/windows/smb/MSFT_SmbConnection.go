...
type MSFT_SmbConnection struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbConnectionEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbConnection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbConnection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
