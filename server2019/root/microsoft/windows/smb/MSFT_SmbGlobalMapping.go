...
type MSFT_SmbGlobalMapping struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbGlobalMappingEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbGlobalMapping, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbGlobalMapping, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SmbGlobalMapping) Create( /* IN */ LocalPath string,
 ...
 /* OPTIONAL IN */ UseWriteThrough bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , LocalPath, RemotePath, Credential, Persistent, RequireIntegrity, RequirePrivacy, FullAccess, DenyAccess, UseWriteThrough)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_SmbGlobalMapping) Remove( /* IN */ Force bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Remove" , Force);
	if err != nil { return }
