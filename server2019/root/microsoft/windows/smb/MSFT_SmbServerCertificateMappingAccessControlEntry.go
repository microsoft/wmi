...
type MSFT_SmbServerCertificateMappingAccessControlEntry struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbServerCertificateMappingAccessControlEntryEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbServerCertificateMappingAccessControlEntry, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbServerCertificateMappingAccessControlEntry, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
