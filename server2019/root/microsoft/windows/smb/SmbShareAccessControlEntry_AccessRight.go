...
const(
	...
	// _4 enum
	SmbShareAccessControlEntry_AccessRight__4 SmbShareAccessControlEntry_AccessRight = 1
	// _5 enum
	SmbShareAccessControlEntry_AccessRight__5 SmbShareAccessControlEntry_AccessRight = 2
	// _6 enum
