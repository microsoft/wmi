...
type MSFT_SmbClientNetworkInterface struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbClientNetworkInterfaceEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbClientNetworkInterface, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbClientNetworkInterface, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
