...
func NewMSFT_SmbComponentEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbComponent, err error) {
...
func NewMSFT_SmbComponentEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_SmbComponent, err error) {
