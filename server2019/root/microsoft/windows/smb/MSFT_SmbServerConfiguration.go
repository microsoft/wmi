...
type MSFT_SmbServerConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbServerConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbServerConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbServerConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SmbServerConfiguration) GetConfiguration( /* OUT */ Output MSFT_SmbServerConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetConfiguration" )
	if err != nil { return }
