...
type MSFT_SmbServerNetworkInterface struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbServerNetworkInterfaceEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbServerNetworkInterface, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbServerNetworkInterface, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
