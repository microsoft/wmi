...
type MSFT_SmbShareChangeEvent struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbShareChangeEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbShareChangeEvent, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbShareChangeEvent, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
