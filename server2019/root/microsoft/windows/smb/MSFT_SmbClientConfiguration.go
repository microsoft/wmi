...
type MSFT_SmbClientConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbClientConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbClientConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbClientConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SmbClientConfiguration) GetConfiguration( /* OUT */ Output MSFT_SmbClientConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetConfiguration" )
	if err != nil { return }
