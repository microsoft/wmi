...
type MSFT_SmbShareAccessControlEntry struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbShareAccessControlEntryEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbShareAccessControlEntry, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbShareAccessControlEntry, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
