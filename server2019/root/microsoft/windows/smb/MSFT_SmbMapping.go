...
type MSFT_SmbMapping struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SmbMappingEx1(instance *cim.WmiInstance) (newInstance *MSFT_SmbMapping, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SmbMapping, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SmbMapping) Remove( /* IN */ UpdateProfile bool,
 /* IN */ Force bool,
 /* IN */ GlobalMapping bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Remove" , UpdateProfile, Force, GlobalMapping);
	if err != nil { return }
...
func (instance *MSFT_SmbMapping) Create( /* IN */ LocalPath string,
 ...
 /* OPTIONAL IN */ GlobalMapping bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , LocalPath, RemotePath, UserName, Password, Persistent, SaveCredentials, HomeFolder, RequireIntegrity, RequirePrivacy, UseWriteThrough, TransportType, SkipCertificateCheck, CompressNetworkTraffic, GlobalMapping)
	if err != nil { return }
