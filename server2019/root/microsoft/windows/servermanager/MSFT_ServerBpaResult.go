...
type MSFT_ServerBpaResult struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerBpaResultEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerBpaResult, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerBpaResult, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
