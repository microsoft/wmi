...
type MSFT_ServerEventDetail struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerEventDetailEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerEventDetail, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerEventDetail, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
