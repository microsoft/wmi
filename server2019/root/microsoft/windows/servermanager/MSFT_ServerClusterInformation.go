...
type MSFT_ServerClusterInformation struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerClusterInformationEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerClusterInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerClusterInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
