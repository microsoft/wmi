...
type MSFT_ServerManagerDeploymentError struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerManagerDeploymentErrorEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerManagerDeploymentError, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerManagerDeploymentError, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
