...
type MSFT_ServerError struct { 
	*CIM_Error
	...
	func NewMSFT_ServerErrorEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerError, err error) {tmp, err := NewCIM_ErrorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerError, err error) {tmp, err := NewCIM_ErrorEx6(hostName, wmiNamespace, userName, password, domainName, query)
