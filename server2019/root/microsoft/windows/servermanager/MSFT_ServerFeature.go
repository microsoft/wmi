...
type MSFT_ServerFeature struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerFeatureEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerFeature, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerFeature, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
