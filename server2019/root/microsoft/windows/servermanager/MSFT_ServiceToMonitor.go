...
type MSFT_ServiceToMonitor struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServiceToMonitorEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServiceToMonitor, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServiceToMonitor, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
