...
type MSFT_ServerManagerRequestGuid struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerManagerRequestGuidEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerManagerRequestGuid, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerManagerRequestGuid, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
