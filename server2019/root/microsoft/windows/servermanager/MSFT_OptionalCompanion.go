...
type MSFT_OptionalCompanion struct { 
	*cim.WmiInstance
	...
	func NewMSFT_OptionalCompanionEx1(instance *cim.WmiInstance) (newInstance *MSFT_OptionalCompanion, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_OptionalCompanion, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
