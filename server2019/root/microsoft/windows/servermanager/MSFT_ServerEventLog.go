...
type MSFT_ServerEventLog struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerEventLogEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerEventLog, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerEventLog, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
