...
type MSFT_ServerInventory struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerInventoryEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerInventory, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerInventory, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
