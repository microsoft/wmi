...
type MSFT_ServerNetworkAdapter struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerNetworkAdapterEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerNetworkAdapter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerNetworkAdapter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
