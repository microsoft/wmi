...
type MSFT_ServerServiceDetail struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerServiceDetailEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerServiceDetail, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerServiceDetail, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
