...
type MSFT_ServerOperatingSystem struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerOperatingSystemEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerOperatingSystem, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerOperatingSystem, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
