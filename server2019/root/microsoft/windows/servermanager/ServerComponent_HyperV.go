...
type ServerComponent_HyperV struct { 
	*MSFT_ServerManagerServerComponentDescriptor
	...
	func NewServerComponent_HyperVEx1(instance *cim.WmiInstance) (newInstance *ServerComponent_HyperV, err error) {tmp, err := NewMSFT_ServerManagerServerComponentDescriptorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ServerComponent_HyperV, err error) {tmp, err := NewMSFT_ServerManagerServerComponentDescriptorEx6(hostName, wmiNamespace, userName, password, domainName, query)
