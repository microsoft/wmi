...
type MSFT_ServerManagerRequestState struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerManagerRequestStateEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerManagerRequestState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerManagerRequestState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
