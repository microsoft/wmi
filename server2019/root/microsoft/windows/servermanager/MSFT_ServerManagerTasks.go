...
type MSFT_ServerManagerTasks struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerManagerTasksEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerManagerTasks, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerManagerTasks, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_ServerManagerTasks) GetCounterSamplesAtTime( /* IN */ CollectorName string,
 ...
 /* IN */ BatchSize uint32,
 /* OUT */ cmdletOutput []MSFT_ServerPerformanceCounterSamples) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetCounterSamplesAtTime" , CollectorName, CounterPaths, Timestamps, BatchSize)
	if err != nil { return }
...
func (instance *MSFT_ServerManagerTasks) GetCounterSamplesInTimeRange( /* IN */ CollectorName string,
 ...
 /* IN */ EndTime string,
 /* IN */ BatchSize uint32,
 /* OUT */ cmdletOutput []MSFT_ServerPerformanceCounterSamples) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetCounterSamplesInTimeRange" , CollectorName, CounterPaths, StartTime, EndTime, BatchSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ServerManagerTasks) GetPerformanceCollectorState( /* IN */ CollectorName string,
 /* OUT */ cmdletOutput uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetPerformanceCollectorState" , CollectorName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ServerManagerTasks) SetPerformanceCollectorState( /* IN */ CollectorName string,
 /* IN */ State uint8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPerformanceCollectorState" , CollectorName, State);
	if err != nil { return }
...
func (instance *MSFT_ServerManagerTasks) GetServerBpaResult( /* IN */ BpaXPaths []string,
 /* IN */ BatchSize uint32,
 /* OUT */ cmdletOutput []MSFT_ServerBpaResult) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetServerBpaResult" , BpaXPaths, BatchSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_ServerManagerTasks) GetServerClusterName( /* OUT */ cmdletOutput []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetServerClusterName" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ServerManagerTasks) GetServerEventDetail( /* IN */ Logs []string,
 ...
 /* OUT */ cmdletOutput []MSFT_ServerEventDetail) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetServerEventDetail" , Logs, Levels, StartTimes, EndTimes, BatchSize, QueryFiles, QueryFileIds)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ServerManagerTasks) GetServerFeature( /* IN */ FilterFlags uint32,
 ...
 /* OUT */ cmdletOutput []MSFT_ServerFeature) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetServerFeature" , FilterFlags, BatchSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ServerManagerTasks) GetServerInventory( /* IN */ SMServerId string,
 ...
 /* OUT */ EventLogs []MSFT_ServerEventLog) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetServerInventory" , SMServerId)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ServerManagerTasks) GetServerServiceDetail( /* IN */ Services []string,
 /* IN */ BatchSize uint32,
 /* OUT */ cmdletOutput []MSFT_ServerServiceDetail) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetServerServiceDetail" , Services, BatchSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_ServerManagerTasks) RemoveServerPerformanceLog( /* IN */ CollectorName string,
 /* IN */ MillisecondThreshold uint64) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveServerPerformanceLog" , CollectorName, MillisecondThreshold);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_ServerManagerTasks) GetServerEventDetailEx( /* IN */ FilterXml string,
 ...
 /* IN */ BatchSize uint32,
 /* OUT */ cmdletOutput []MSFT_ServerEventDetail) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetServerEventDetailEx" , FilterXml, Skip, Top, ReverseDirection, BatchSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
