...
type MSFT_ServerManagerServerComponent struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ServerManagerServerComponentEx1(instance *cim.WmiInstance) (newInstance *MSFT_ServerManagerServerComponent, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ServerManagerServerComponent, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
