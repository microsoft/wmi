...
type MSFT_EtwTraceProvider struct { 
	*CIM_LogicalElement
	...
	func NewMSFT_EtwTraceProviderEx1(instance *cim.WmiInstance) (newInstance *MSFT_EtwTraceProvider, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_EtwTraceProvider, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
