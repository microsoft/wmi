...
type MSFT_CAU_Legacy_Upgrade_Install_Result struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CAU_Legacy_Upgrade_Install_ResultEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAU_Legacy_Upgrade_Install_Result, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAU_Legacy_Upgrade_Install_Result, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
