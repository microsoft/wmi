...
type MSFT_CAU_InstallUpdateInfo struct { 
	*MSFT_CAU_DownloadUpdateInfo
	...
	func NewMSFT_CAU_InstallUpdateInfoEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAU_InstallUpdateInfo, err error) {tmp, err := NewMSFT_CAU_DownloadUpdateInfoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAU_InstallUpdateInfo, err error) {tmp, err := NewMSFT_CAU_DownloadUpdateInfoEx6(hostName, wmiNamespace, userName, password, domainName, query)
