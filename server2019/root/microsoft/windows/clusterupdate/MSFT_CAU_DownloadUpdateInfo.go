...
type MSFT_CAU_DownloadUpdateInfo struct { 
	*MSFT_CAU_ScanUpdateInfo
	...
	func NewMSFT_CAU_DownloadUpdateInfoEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAU_DownloadUpdateInfo, err error) {tmp, err := NewMSFT_CAU_ScanUpdateInfoEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAU_DownloadUpdateInfo, err error) {tmp, err := NewMSFT_CAU_ScanUpdateInfoEx6(hostName, wmiNamespace, userName, password, domainName, query)
