...
type MSFT_CAURun_Report_ID struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CAURun_Report_IDEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAURun_Report_ID, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAURun_Report_ID, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
