...
type MSFT_CAURun_Report_Chunk struct { 
	*MSFT_CAURun_Report_ID
	...
	func NewMSFT_CAURun_Report_ChunkEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAURun_Report_Chunk, err error) {tmp, err := NewMSFT_CAURun_Report_IDEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAURun_Report_Chunk, err error) {tmp, err := NewMSFT_CAURun_Report_IDEx6(hostName, wmiNamespace, userName, password, domainName, query)
