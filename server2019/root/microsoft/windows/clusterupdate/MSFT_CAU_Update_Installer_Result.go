...
type MSFT_CAU_Update_Installer_Result struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CAU_Update_Installer_ResultEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAU_Update_Installer_Result, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MSFT_CAU_Update_Installer_Result {
	WmiInstance: tmp,
	}
	return
	}
	...
	func NewMSFT_CAU_Update_Installer_ResultEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAU_Update_Installer_Result, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
