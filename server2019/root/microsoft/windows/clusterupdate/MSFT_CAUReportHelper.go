...
type MSFT_CAUReportHelper struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CAUReportHelperEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAUReportHelper, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAUReportHelper, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_CAUReportHelper) GetReportIDs( /* OUT */ ReportID []MSFT_CAURun_Report_ID) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetReportIDs" )
	if err != nil { return }
...
func (instance *MSFT_CAUReportHelper) GetReport( /* IN */ ReportId MSFT_CAURun_Report_ID,
 /* IN */ ChunkSize uint32,
 /* OUT */ ReportChunks []MSFT_CAURun_Report_Chunk) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetReport" , ReportId, ChunkSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUReportHelper) PutReport( /* IN */ ReportSize uint64,
 ...
 /* IN */ LastChunk bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("PutReport" , ReportSize, ReportChunk, LastChunk);
	if err != nil { return }
