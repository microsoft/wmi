...
type MSFT_CAUNode struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CAUNodeEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAUNode, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAUNode, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_CAUNode) RebootRequired() (result bool, err error) {retVal, err := instance.InvokeMethodWithReturn("RebootRequired" );
	if err != nil { return }
	result = (retVal > 0)
	return
...
func (instance *MSFT_CAUNode) ScanUpdates( /* IN */ QueryString string,
 ...
 /* OUT */ Info []MSFT_CAU_ScanUpdateInfo) (result uint32, err error) {retVal, err := instance.InvokeMethod("ScanUpdates" , QueryString, IncludeRecommendedUpdates, FeatureUpdatesOnly)
	if err != nil { return }
...
func (instance *MSFT_CAUNode) DownloadUpdates( /* IN */ QueryString string,
 /* IN */ IncludeRecommendedUpdates bool,
 /* IN */ FeatureUpdatesOnly bool,
 /* OUT */ Info []MSFT_CAU_DownloadUpdateInfo) (result uint32, err error) {retVal, err := instance.InvokeMethod("DownloadUpdates" , QueryString, IncludeRecommendedUpdates, FeatureUpdatesOnly)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) InstallUpdates( /* IN */ QueryString string,
 /* IN */ IncludeRecommendedUpdates bool,
 /* IN */ FeatureUpdatesOnly bool,
 /* OUT */ Info []MSFT_CAU_InstallUpdateInfo) (result uint32, err error) {retVal, err := instance.InvokeMethod("InstallUpdates" , QueryString, IncludeRecommendedUpdates, FeatureUpdatesOnly)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) CommitFUpdatesWua( /* IN */ QueryString string,
 /* OUT */ Result MSFT_CAU_CommitFUpdateWuaResult) (result uint32, err error) {retVal, err := instance.InvokeMethod("CommitFUpdatesWua" , QueryString)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) RunUpdateInstaller( /* IN */ InstallerProgramPath string,
 ...
 /* OUT */ Result MSFT_CAU_Update_Installer_Result) (result uint32, err error) {retVal, err := instance.InvokeMethod("RunUpdateInstaller" , InstallerProgramPath, Parameters, UpdatePath, RequireSmbEncryption)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) RunUpgradeLegacyMediaInterface( /* IN */ PathToSetup string,
 ...
 /* OUT */ Result MSFT_CAU_Legacy_Upgrade_Install_Result) (result uint32, err error) {retVal, err := instance.InvokeMethod("RunUpgradeLegacyMediaInterface" , PathToSetup, CmdLineArgs)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) RunUpgradeInstallAudiInterface( /* IN */ PathToSetup string,
 ...
 /* OUT */ Result MSFT_CAU_Audi_Install_Result) (result uint32, err error) {retVal, err := instance.InvokeMethod("RunUpgradeInstallAudiInterface" , PathToSetup, PathToDeploymentCab)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) RunUpgradeCommitAudiInterface( /* IN */ PathToSetup string,
 /* IN */ UpdateId string,
 /* IN */ PathToDeploymentCab string,
 /* OUT */ Result MSFT_CAU_Audi_Commit_Result) (result uint32, err error) {retVal, err := instance.InvokeMethod("RunUpgradeCommitAudiInterface" , PathToSetup, UpdateId, PathToDeploymentCab)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) GetPostRebootResult( /* IN */ PathToSetup string,
 /* IN */ UpdateId string,
 /* IN */ PathToDeploymentCab string,
 /* OUT */ ErrorCode MSFT_CAU_Audi_GetPostRebootResult_Result) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetPostRebootResult" , PathToSetup, UpdateId, PathToDeploymentCab)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_CAUNode) GenerateDeviceInfoFilesFU( /* IN */ PathToFiles string,
 /* IN */ PathToDeploymentCab string,
 /* OUT */ Result MSFT_CAU_Audi_GenerateDeviceInfoFilesFU_Result) (result uint32, err error) {retVal, err := instance.InvokeMethod("GenerateDeviceInfoFilesFU" , PathToFiles, PathToDeploymentCab)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
