...
type MSFT_CAU_ScanUpdateInfo struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CAU_ScanUpdateInfoEx1(instance *cim.WmiInstance) (newInstance *MSFT_CAU_ScanUpdateInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_CAU_ScanUpdateInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
