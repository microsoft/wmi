...
func NewCIM_WebApplicationProxyAvailableADFSRelyingPartyEx1(instance *cim.WmiInstance) (newInstance *CIM_WebApplicationProxyAvailableADFSRelyingParty, err error) {
...
func NewCIM_WebApplicationProxyAvailableADFSRelyingPartyEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *CIM_WebApplicationProxyAvailableADFSRelyingParty, err error) {
...
func (instance *CIM_WebApplicationProxyAvailableADFSRelyingParty) Get( /* OUT */ cmdletOutput []RelyingPartyMetadata) (result uint32, err error) {
