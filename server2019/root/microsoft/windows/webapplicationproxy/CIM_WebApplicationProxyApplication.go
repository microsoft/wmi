...
type CIM_WebApplicationProxyApplication struct { 
	*cim.WmiInstance
	...
	func NewCIM_WebApplicationProxyApplicationEx1(instance *cim.WmiInstance) (newInstance *CIM_WebApplicationProxyApplication, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_WebApplicationProxyApplication, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_WebApplicationProxyApplication) GetByID( /* IN */ ID string,
 /* OUT */ cmdletOutput []PublishedWebApp) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByID" , ID)
	if err != nil { return }
...
func (instance *CIM_WebApplicationProxyApplication) GetByName( /* IN */ Name string,
 /* OUT */ cmdletOutput []PublishedWebApp) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByName" , Name)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_WebApplicationProxyApplication) RemoveByID( /* IN */ ID []string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveByID" , ID);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_WebApplicationProxyApplication) RemoveByName( /* IN */ Name string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveByName" , Name);
	if err != nil { return }
	result = uint32(retVal)
	return
