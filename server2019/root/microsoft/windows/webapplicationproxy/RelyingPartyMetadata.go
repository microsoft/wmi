...
type RelyingPartyMetadata struct { 
	*cim.WmiInstance
	...
	func NewRelyingPartyMetadataEx1(instance *cim.WmiInstance) (newInstance *RelyingPartyMetadata, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RelyingPartyMetadata, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
