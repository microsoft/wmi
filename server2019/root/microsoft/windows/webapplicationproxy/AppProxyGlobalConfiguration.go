...
type AppProxyGlobalConfiguration struct { 
	*cim.WmiInstance
	...
	func NewAppProxyGlobalConfigurationEx1(instance *cim.WmiInstance) (newInstance *AppProxyGlobalConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *AppProxyGlobalConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
