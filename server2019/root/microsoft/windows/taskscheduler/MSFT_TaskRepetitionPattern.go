...
type MSFT_TaskRepetitionPattern struct { 
	*cim.WmiInstance
	...
	func NewMSFT_TaskRepetitionPatternEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskRepetitionPattern, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskRepetitionPattern, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
