...
type MSFT_TaskComHandlerAction struct { 
	*MSFT_TaskAction
	...
	func NewMSFT_TaskComHandlerActionEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskComHandlerAction, err error) {tmp, err := NewMSFT_TaskActionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskComHandlerAction, err error) {tmp, err := NewMSFT_TaskActionEx6(hostName, wmiNamespace, userName, password, domainName, query)
