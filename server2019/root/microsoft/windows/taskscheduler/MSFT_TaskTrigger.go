...
type MSFT_TaskTrigger struct { 
	*cim.WmiInstance
	...
	func NewMSFT_TaskTriggerEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskTrigger, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskTrigger, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
