...
type MSFT_ClusteredScheduledTask struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ClusteredScheduledTaskEx1(instance *cim.WmiInstance) (newInstance *MSFT_ClusteredScheduledTask, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ClusteredScheduledTask, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
