...
type MSFT_TaskMonthlyTrigger struct { 
	*MSFT_TaskTrigger
	...
	func NewMSFT_TaskMonthlyTriggerEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskMonthlyTrigger, err error) {tmp, err := NewMSFT_TaskTriggerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskMonthlyTrigger, err error) {tmp, err := NewMSFT_TaskTriggerEx6(hostName, wmiNamespace, userName, password, domainName, query)
