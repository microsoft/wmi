...
type MSFT_TaskBootTrigger struct { 
	*MSFT_TaskTrigger
	...
	func NewMSFT_TaskBootTriggerEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskBootTrigger, err error) {tmp, err := NewMSFT_TaskTriggerEx1(instance)
		
	if err != nil { return }
	newInstance = &MSFT_TaskBootTrigger {
	...
	func NewMSFT_TaskBootTriggerEx6(hostName string,
	wmiNamespace string,
	userName string,
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskBootTrigger, err error) {tmp, err := NewMSFT_TaskTriggerEx6(hostName, wmiNamespace, userName, password, domainName, query)
