...
func NewMSFT_TaskBootTriggerEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskBootTrigger, err error) {
...
func NewMSFT_TaskBootTriggerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_TaskBootTrigger, err error) {
