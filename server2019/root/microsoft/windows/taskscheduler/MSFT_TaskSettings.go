...
type MSFT_TaskSettings struct { 
	*cim.WmiInstance
	...
	func NewMSFT_TaskSettingsEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
