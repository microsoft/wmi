...
type MSFT_TaskNetworkSettings struct { 
	*cim.WmiInstance
	...
	func NewMSFT_TaskNetworkSettingsEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskNetworkSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskNetworkSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
