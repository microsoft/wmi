...
func NewMSFT_TaskPrincipalEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskPrincipal, err error) {
...
func NewMSFT_TaskPrincipalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *MSFT_TaskPrincipal, err error) {
