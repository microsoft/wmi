...
type MSFT_TaskSettings3 struct { 
	*MSFT_TaskSettings2
	...
	func NewMSFT_TaskSettings3Ex1(instance *cim.WmiInstance) (newInstance *MSFT_TaskSettings3, err error) {tmp, err := NewMSFT_TaskSettings2Ex1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskSettings3, err error) {tmp, err := NewMSFT_TaskSettings2Ex6(hostName, wmiNamespace, userName, password, domainName, query)
