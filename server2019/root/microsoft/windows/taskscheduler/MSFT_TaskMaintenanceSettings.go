...
type MSFT_TaskMaintenanceSettings struct { 
	*cim.WmiInstance
	...
	func NewMSFT_TaskMaintenanceSettingsEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskMaintenanceSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskMaintenanceSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
