...
type MSFT_TaskNamedValue struct { 
	*cim.WmiInstance
	...
	func NewMSFT_TaskNamedValueEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskNamedValue, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskNamedValue, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
