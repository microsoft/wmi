...
type MSFT_TaskSettings2 struct { 
	*MSFT_TaskSettings
	...
	func NewMSFT_TaskSettings2Ex1(instance *cim.WmiInstance) (newInstance *MSFT_TaskSettings2, err error) {tmp, err := NewMSFT_TaskSettingsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskSettings2, err error) {tmp, err := NewMSFT_TaskSettingsEx6(hostName, wmiNamespace, userName, password, domainName, query)
