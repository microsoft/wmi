...
type MSFT_TaskDynamicInfo struct { 
	*cim.WmiInstance
	...
	func NewMSFT_TaskDynamicInfoEx1(instance *cim.WmiInstance) (newInstance *MSFT_TaskDynamicInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_TaskDynamicInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
