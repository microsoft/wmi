...
type MSFT_ScheduledTask struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ScheduledTaskEx1(instance *cim.WmiInstance) (newInstance *MSFT_ScheduledTask, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ScheduledTask, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
