...
type MSFT_OdbcPerfCounter struct { 
	*cim.WmiInstance
	...
	func NewMSFT_OdbcPerfCounterEx1(instance *cim.WmiInstance) (newInstance *MSFT_OdbcPerfCounter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_OdbcPerfCounter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
