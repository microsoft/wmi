...
type MSFT_OdbcKeyValuePair struct { 
	*cim.WmiInstance
	...
	func NewMSFT_OdbcKeyValuePairEx1(instance *cim.WmiInstance) (newInstance *MSFT_OdbcKeyValuePair, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_OdbcKeyValuePair, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
