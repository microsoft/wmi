...
type MSFT_WdacBidTrace struct { 
	*cim.WmiInstance
	...
	func NewMSFT_WdacBidTraceEx1(instance *cim.WmiInstance) (newInstance *MSFT_WdacBidTrace, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WdacBidTrace, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
