...
type MSFT_OdbcDriver struct { 
	*cim.WmiInstance
	...
	func NewMSFT_OdbcDriverEx1(instance *cim.WmiInstance) (newInstance *MSFT_OdbcDriver, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_OdbcDriver, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
