...
type RemoteAccessConfiguration struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessConfigurationEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
