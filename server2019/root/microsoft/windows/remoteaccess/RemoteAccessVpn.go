...
type RemoteAccessVpn struct { 
	*RemoteAccessCommon
	...
	func NewRemoteAccessVpnEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessVpn, err error) {tmp, err := NewRemoteAccessCommonEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessVpn, err error) {tmp, err := NewRemoteAccessCommonEx6(hostName, wmiNamespace, userName, password, domainName, query)
