...
type VpnServerIPsecDefaultConfiguration struct { 
	*VpnServerIPsecConfiguration
	...
	func NewVpnServerIPsecDefaultConfigurationEx1(instance *cim.WmiInstance) (newInstance *VpnServerIPsecDefaultConfiguration, err error) {tmp, err := NewVpnServerIPsecConfigurationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnServerIPsecDefaultConfiguration, err error) {tmp, err := NewVpnServerIPsecConfigurationEx6(hostName, wmiNamespace, userName, password, domainName, query)
