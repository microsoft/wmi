...
type DAClientEntrypoint struct { 
	*cim.WmiInstance
	...
	func NewDAClientEntrypointEx1(instance *cim.WmiInstance) (newInstance *DAClientEntrypoint, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAClientEntrypoint, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
