...
type RemoteAccessMonitoringConnection struct { 
	*RemoteAccessConnection
	...
	func NewRemoteAccessMonitoringConnectionEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessMonitoringConnection, err error) {tmp, err := NewRemoteAccessConnectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessMonitoringConnection, err error) {tmp, err := NewRemoteAccessConnectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
