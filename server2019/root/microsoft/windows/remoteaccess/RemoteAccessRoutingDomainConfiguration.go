...
type RemoteAccessRoutingDomainConfiguration struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessRoutingDomainConfigurationEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessRoutingDomainConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessRoutingDomainConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
