...
type BgpStatistics struct { 
	*cim.WmiInstance
	...
	func NewBgpStatisticsEx1(instance *cim.WmiInstance) (newInstance *BgpStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
