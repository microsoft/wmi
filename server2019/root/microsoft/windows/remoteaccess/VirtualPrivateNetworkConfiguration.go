...
type VirtualPrivateNetworkConfiguration struct { 
	*cim.WmiInstance
	...
	func NewVirtualPrivateNetworkConfigurationEx1(instance *cim.WmiInstance) (newInstance *VirtualPrivateNetworkConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VirtualPrivateNetworkConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
