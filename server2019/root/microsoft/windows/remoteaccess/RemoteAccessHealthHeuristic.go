...
type RemoteAccessHealthHeuristic struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessHealthHeuristicEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessHealthHeuristic, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessHealthHeuristic, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
