...
type VpnMultiTenancy struct { 
	*RemoteAccessCommon
	...
	func NewVpnMultiTenancyEx1(instance *cim.WmiInstance) (newInstance *VpnMultiTenancy, err error) {tmp, err := NewRemoteAccessCommonEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnMultiTenancy, err error) {tmp, err := NewRemoteAccessCommonEx6(hostName, wmiNamespace, userName, password, domainName, query)
