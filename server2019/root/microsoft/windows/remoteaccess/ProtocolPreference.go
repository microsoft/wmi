...
type ProtocolPreference struct { 
	*cim.WmiInstance
	...
	func NewProtocolPreferenceEx1(instance *cim.WmiInstance) (newInstance *ProtocolPreference, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ProtocolPreference, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
