...
type VpnRoutingDomainDefaultConfig struct { 
	*VpnRoutingDomainConfig
	...
	func NewVpnRoutingDomainDefaultConfigEx1(instance *cim.WmiInstance) (newInstance *VpnRoutingDomainDefaultConfig, err error) {tmp, err := NewVpnRoutingDomainConfigEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnRoutingDomainDefaultConfig, err error) {tmp, err := NewVpnRoutingDomainConfigEx6(hostName, wmiNamespace, userName, password, domainName, query)
