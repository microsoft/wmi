...
type VSIDConfiguration struct { 
	*cim.WmiInstance
	...
	func NewVSIDConfigurationEx1(instance *cim.WmiInstance) (newInstance *VSIDConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VSIDConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
