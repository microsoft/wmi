...
type PS_RemoteAccessRadius struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessRadiusEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessRadius, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessRadius, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessRadius) Add( /* IN */ ServerName string,
 ...
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput []RemoteAccessRadiusServer) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , ServerName, SharedSecret, ComputerName, Port, Score, Timeout, Purpose, AccountingOnOffMsg, MsgAuthenticator, EntrypointName, PassThru)
	if err != nil { return }
...
func (instance *PS_RemoteAccessRadius) Remove( /* IN */ ServerName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ EntrypointName string,
 /* OUT */ cmdletOutput []RemoteAccessRadiusServerPurpose) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , ServerName, Purpose, ComputerName, PassThru, EntrypointName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessRadius) Set( /* IN */ ComputerName string,
 ...
 /* IN */ EntrypointName string,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput []RemoteAccessRadiusServer) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , ComputerName, Purpose, Port, Score, ServerName, Timeout, SharedSecret, AccountingOnOffMsg, MsgAuthenticator, EntrypointName, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessRadius) Get( /* IN */ Purpose string,
 /* IN */ ComputerName string,
 /* IN */ EntrypointName string,
 /* OUT */ cmdletOutput []RemoteAccessRadiusServer) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , Purpose, ComputerName, EntrypointName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
