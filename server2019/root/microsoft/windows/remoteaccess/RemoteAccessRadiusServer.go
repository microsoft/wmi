...
type RemoteAccessRadiusServer struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessRadiusServerEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessRadiusServer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessRadiusServer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
