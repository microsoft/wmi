...
type RoutingDomainConfiguration struct { 
	*cim.WmiInstance
	...
	func NewRoutingDomainConfigurationEx1(instance *cim.WmiInstance) (newInstance *RoutingDomainConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RoutingDomainConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
