...
type PS_VpnS2SInterface struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnS2SInterfaceEx1(instance *cim.WmiInstance) (newInstance *PS_VpnS2SInterface, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnS2SInterface, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnS2SInterface) AddGreInterface( /* IN */ Name string,
 ...
 /* IN */ SourceIpAddress string,
 /* IN */ GreTunnel bool,
 /* OUT */ cmdletOutput VpnS2SInterface) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddGreInterface" , Name, GreKey, Destination, AdminStatus, EnableQoS, TxBandwidthKbps, RxBandwidthKbps, IPv4Subnet, IPv6Subnet, PassThru, RoutingDomain, InternalIPv4, InternalIPv6, IPv4Address, IPv6Address, SourceIpAddress, GreTunnel)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnS2SInterface) Remove( /* IN */ Name []string,
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput []VpnS2SInterface) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , Name, PassThru, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnS2SInterface) Get( /* IN */ Name string,
 /* IN */ RoutingDomain string,
 /* OUT */ cmdletOutput []VpnS2SInterface) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , Name, RoutingDomain)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnS2SInterface) Connect( /* IN */ Name string,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput VpnS2SInterface) (result uint32, err error) {retVal, err := instance.InvokeMethod("Connect" , Name, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnS2SInterface) Disconnect( /* IN */ Name string,
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput VpnS2SInterface) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disconnect" , Name, PassThru, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnS2SInterface) SetGreInterface( /* IN */ Name string,
 ...
 /* IN */ Force bool,
 /* IN */ GreTunnel bool,
 /* OUT */ cmdletOutput VpnS2SInterface) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetGreInterface" , Name, GreKey, Destination, AdminStatus, EnableQoS, TxBandwidthKbps, RxBandwidthKbps, IPv4Subnet, IPv6Subnet, PassThru, InternalIPv4, InternalIPv6, IPv4Address, IPv6Address, SourceIpAddress, Force, GreTunnel)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
