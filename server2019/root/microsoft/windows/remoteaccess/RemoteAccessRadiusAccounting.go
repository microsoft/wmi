...
type RemoteAccessRadiusAccounting struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessRadiusAccountingEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessRadiusAccounting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessRadiusAccounting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
