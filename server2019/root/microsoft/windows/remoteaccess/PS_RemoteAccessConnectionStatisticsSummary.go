...
type PS_RemoteAccessConnectionStatisticsSummary struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessConnectionStatisticsSummaryEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessConnectionStatisticsSummary, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessConnectionStatisticsSummary, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessConnectionStatisticsSummary) GetByAccountingStatistics( /* IN */ StartDateTime string,
 ...
 /* OUT */ cmdletOutput RemoteAccessAccountingSummary) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByAccountingStatistics" , StartDateTime, EndDateTime, ComputerName)
	if err != nil { return }
...
func (instance *PS_RemoteAccessConnectionStatisticsSummary) GetByActiveStatistics( /* IN */ ComputerName string,
 /* OUT */ cmdletOutput RemoteAccessMonitoringSummary) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByActiveStatistics" , ComputerName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
