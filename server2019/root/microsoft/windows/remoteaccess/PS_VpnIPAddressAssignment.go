...
type PS_VpnIPAddressAssignment struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnIPAddressAssignmentEx1(instance *cim.WmiInstance) (newInstance *PS_VpnIPAddressAssignment, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnIPAddressAssignment, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnIPAddressAssignment) SetByVpnIPAddressAssignment( /* IN */ PassThru bool,
 ...
 /* OUT */ cmdletOutput VpnIPAddressAssignment) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByVpnIPAddressAssignment" , PassThru, IPAddressRange, ComputerName, IPAssignmentMethod, IPv6Prefix)
	if err != nil { return }
...
func (instance *PS_VpnIPAddressAssignment) SetByVpnIPv6PrefixEntrypoint( /* IN */ ComputerName string,
 ...
 /* IN */ IPv6Prefix string,
 /* OUT */ cmdletOutput VpnIPAddressAssignment) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByVpnIPv6PrefixEntrypoint" , ComputerName, PassThru, EntrypointName, IPv6Prefix)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
