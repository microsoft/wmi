...
type RemoteAccessInboxAccounting struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessInboxAccountingEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessInboxAccounting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessInboxAccounting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
