...
type MultiTenantVpnIPAddressRange struct { 
	*VpnIPAddressRange
	...
	func NewMultiTenantVpnIPAddressRangeEx1(instance *cim.WmiInstance) (newInstance *MultiTenantVpnIPAddressRange, err error) {tmp, err := NewVpnIPAddressRangeEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MultiTenantVpnIPAddressRange, err error) {tmp, err := NewVpnIPAddressRangeEx6(hostName, wmiNamespace, userName, password, domainName, query)
