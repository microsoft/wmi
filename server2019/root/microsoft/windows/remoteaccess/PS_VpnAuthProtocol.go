...
func NewPS_VpnAuthProtocolEx1(instance *cim.WmiInstance) (newInstance *PS_VpnAuthProtocol, err error) {
...
func NewPS_VpnAuthProtocolEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_VpnAuthProtocol, err error) {
...
func (instance *PS_VpnAuthProtocol) Set( /* IN */ UserAuthProtocolAccepted []string,
	...
	/* OUT */ cmdletOutput VpnAuthProtocol) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Set", UserAuthProtocolAccepted, TunnelAuthProtocolsAdvertised, RootCertificateNameToAccept, CertificateAdvertised, SharedSecret, PassThru, CertificateEKUsToAccept)
	if err != nil {
		return
	}
...
// <param name="cmdletOutput" type="VpnAuthProtocol "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *PS_VpnAuthProtocol) Get( /* OUT */ cmdletOutput VpnAuthProtocol) (result uint32, err error) {
