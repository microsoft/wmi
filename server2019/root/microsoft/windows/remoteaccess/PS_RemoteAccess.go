...
type PS_RemoteAccess struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccess) InstallByDAPrerequisiteChecks( /* IN */ ComputerName string,
 ...
 /* OUT */ Status bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("InstallByDAPrerequisiteChecks" , ComputerName, Prerequisite)
	if err != nil { return }
...
func (instance *PS_RemoteAccess) InstallByDirectAccess( /* IN */ ComputerName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput RemoteAccessCommon) (result uint32, err error) {retVal, err := instance.InvokeMethod("InstallByDirectAccess" , ComputerName, DAInstallType, ClientGpoName, InternalInterface, InternetInterface, NlsCertificate, NlsUrl, NoPrerequisite, ServerGpoName, ConnectToAddress, DeployNat, PassThru, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccess) InstallByMultiTenant( /* IN */ ComputerName string,
 ...
 /* OUT */ cmdletOutput RemoteAccessCommon) (result uint32, err error) {retVal, err := instance.InvokeMethod("InstallByMultiTenant" , ComputerName, MultiTenancy, VpnType, MsgAuthenticator, PassThru, RadiusPort, RadiusScore, RadiusServer, RadiusTimeout, SharedSecret, CapacityKbps)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccess) InstallByVpn( /* IN */ ComputerName string,
 ...
 /* OUT */ cmdletOutput RemoteAccessCommon) (result uint32, err error) {retVal, err := instance.InvokeMethod("InstallByVpn" , ComputerName, VpnType, IPAddressRange, RadiusServer, Legacy, SharedSecret, RadiusTimeout, RadiusScore, RadiusPort, MsgAuthenticator, PassThru, IPv6Prefix, EntrypointName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccess) Uninstall( /* IN */ VpnType string,
 ...
 /* IN */ EntrypointName string,
 /* IN */ Force bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Uninstall" , VpnType, ComputerName, EntrypointName, Force);
	if err != nil { return }
...
func (instance *PS_RemoteAccess) Set( /* IN */ SslCertificate []uint8,
 ...
 /* IN */ Force bool,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput RemoteAccessCommon) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , SslCertificate, ComputerName, InternetInterface, InternalInterface, CapacityKbps, UseHttp, Force, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccess) Get( /* IN */ ComputerName string,
 /* IN */ EntrypointName string,
 /* OUT */ cmdletOutput RemoteAccessCommon) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , ComputerName, EntrypointName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
