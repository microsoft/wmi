...
type PS_DAEntryPoint struct { 
	*cim.WmiInstance
	...
	func NewPS_DAEntryPointEx1(instance *cim.WmiInstance) (newInstance *PS_DAEntryPoint, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_DAEntryPoint, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_DAEntryPoint) Add( /* IN */ ComputerName string,
 ...
 /* IN */ Force bool,
 /* OUT */ cmdletOutput DAEntryPoint) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , ComputerName, ServerGpoName, Name, GslbIP, DeployNat, NoPrerequisite, PassThru, RemoteAccessServer, InternalInterface, InternetInterface, ClientIPv6Prefix, ConnectToAddress, Force)
	if err != nil { return }
...
func (instance *PS_DAEntryPoint) Remove( /* IN */ ComputerName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput DAEntryPoint) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , ComputerName, Name, PassThru, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAEntryPoint) Set( /* IN */ ComputerName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ NewName string,
 /* OUT */ cmdletOutput DAEntryPoint) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , ComputerName, Name, GslbIP, PassThru, NewName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAEntryPoint) Get( /* IN */ ComputerName string,
 /* IN */ Name string,
 /* OUT */ cmdletOutput DAEntryPoint) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , ComputerName, Name)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
