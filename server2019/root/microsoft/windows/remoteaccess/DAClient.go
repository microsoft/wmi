...
type DAClient struct { 
	*cim.WmiInstance
	...
	func NewDAClientEx1(instance *cim.WmiInstance) (newInstance *DAClient, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAClient, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
