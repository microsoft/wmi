...
type DAClientSettings struct { 
	*cim.WmiInstance
	...
	func NewDAClientSettingsEx1(instance *cim.WmiInstance) (newInstance *DAClientSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAClientSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
