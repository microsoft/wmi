...
type DAMgmtHost struct { 
	*cim.WmiInstance
	...
	func NewDAMgmtHostEx1(instance *cim.WmiInstance) (newInstance *DAMgmtHost, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAMgmtHost, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
