...
type VpnTrafficSelector struct { 
	*cim.WmiInstance
	...
	func NewVpnTrafficSelectorEx1(instance *cim.WmiInstance) (newInstance *VpnTrafficSelector, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnTrafficSelector, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
