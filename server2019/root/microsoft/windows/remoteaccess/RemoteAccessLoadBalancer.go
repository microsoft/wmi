...
type RemoteAccessLoadBalancer struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessLoadBalancerEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessLoadBalancer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessLoadBalancer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
