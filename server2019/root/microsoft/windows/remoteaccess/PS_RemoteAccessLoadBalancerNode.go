...
type PS_RemoteAccessLoadBalancerNode struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessLoadBalancerNodeEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessLoadBalancerNode, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessLoadBalancerNode, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessLoadBalancerNode) Add( /* IN */ RemoteAccessServer string,
 ...
 /* IN */ Force bool,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput RemoteAccessLoadBalancerNode) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , RemoteAccessServer, InternalInterface, InternetInterface, VpnIPAddressRange, ComputerName, Force, PassThru)
	if err != nil { return }
...
func (instance *PS_RemoteAccessLoadBalancerNode) Remove( /* IN */ RemoteAccessServer string,
 ...
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput string) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , RemoteAccessServer, ComputerName, PassThru, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
