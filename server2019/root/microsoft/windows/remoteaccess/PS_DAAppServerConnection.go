...
func NewPS_DAAppServerConnectionEx1(instance *cim.WmiInstance) (newInstance *PS_DAAppServerConnection, err error) {
...
func NewPS_DAAppServerConnectionEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_DAAppServerConnection, err error) {
...
func (instance *PS_DAAppServerConnection) Set( /* IN */ ConnectionType string,
	...
	/* IN */ PassThru bool,
	/* OUT */ cmdletOutput DAAppServerConnection) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Set", ConnectionType, TrafficProtection, ComputerName, PassThru)
	if err != nil {
		return
	}
