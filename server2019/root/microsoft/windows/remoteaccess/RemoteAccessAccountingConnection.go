...
type RemoteAccessAccountingConnection struct { 
	*RemoteAccessConnection
	...
	func NewRemoteAccessAccountingConnectionEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessAccountingConnection, err error) {tmp, err := NewRemoteAccessConnectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessAccountingConnection, err error) {tmp, err := NewRemoteAccessConnectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
