...
type BgpRouteCounter struct { 
	*cim.WmiInstance
	...
	func NewBgpRouteCounterEx1(instance *cim.WmiInstance) (newInstance *BgpRouteCounter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpRouteCounter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
