...
type VpnRoutingDomainConfig struct { 
	*RoutingDomainConfiguration
	...
	func NewVpnRoutingDomainConfigEx1(instance *cim.WmiInstance) (newInstance *VpnRoutingDomainConfig, err error) {tmp, err := NewRoutingDomainConfigurationEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnRoutingDomainConfig, err error) {tmp, err := NewRoutingDomainConfigurationEx6(hostName, wmiNamespace, userName, password, domainName, query)
