...
type BgpRouteAggregateConfig struct { 
	*cim.WmiInstance
	...
	func NewBgpRouteAggregateConfigEx1(instance *cim.WmiInstance) (newInstance *BgpRouteAggregateConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpRouteAggregateConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
