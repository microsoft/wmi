...
func NewPS_RemoteAccessConfigurationEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessConfiguration, err error) {
...
func NewPS_RemoteAccessConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_RemoteAccessConfiguration, err error) {
...
func (instance *PS_RemoteAccessConfiguration) Get( /* OUT */ cmdletOutput RemoteAccessConfiguration) (result uint32, err error) {
...
func (instance *PS_RemoteAccessConfiguration) Set( /* IN */ Configuration RemoteAccessConfiguration,
	...
	/* IN */ PassThru bool,
	/* OUT */ cmdletOutput RemoteAccessConfiguration) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Set", Configuration, RestartServiceIfRequired, PassThru)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
