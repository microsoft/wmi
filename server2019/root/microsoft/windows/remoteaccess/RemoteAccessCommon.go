...
type RemoteAccessCommon struct { 
	*RemoteAccessCore
	...
	func NewRemoteAccessCommonEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessCommon, err error) {tmp, err := NewRemoteAccessCoreEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessCommon, err error) {tmp, err := NewRemoteAccessCoreEx6(hostName, wmiNamespace, userName, password, domainName, query)
