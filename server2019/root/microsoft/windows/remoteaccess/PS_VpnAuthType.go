...
type PS_VpnAuthType struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnAuthTypeEx1(instance *cim.WmiInstance) (newInstance *PS_VpnAuthType, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnAuthType, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnAuthType) Set( /* IN */ Type string,
 ...
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput VpnAuth) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , Type, RadiusServer, SharedSecret, RadiusTimeout, RadiusScore, RadiusPort, ComputerName, MsgAuthenticator, EntrypointName, PassThru)
	if err != nil { return }
