...
type RemoteAccessServerAuthConfiguration struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessServerAuthConfigurationEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessServerAuthConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessServerAuthConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
