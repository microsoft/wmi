...
type EapConfiguration struct { 
	*cim.WmiInstance
	...
	func NewEapConfigurationEx1(instance *cim.WmiInstance) (newInstance *EapConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *EapConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
