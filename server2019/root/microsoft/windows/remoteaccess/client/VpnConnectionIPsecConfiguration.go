...
type VpnConnectionIPsecConfiguration struct { 
	*cim.WmiInstance
	...
	func NewVpnConnectionIPsecConfigurationEx1(instance *cim.WmiInstance) (newInstance *VpnConnectionIPsecConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnConnectionIPsecConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
