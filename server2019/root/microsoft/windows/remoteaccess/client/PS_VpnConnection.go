...
type PS_VpnConnection struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnConnectionEx1(instance *cim.WmiInstance) (newInstance *PS_VpnConnection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnConnection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnConnection) GetPropertyDnsConfig()(value []PS_VpnConnectionTriggerDnsConfiguration, err error) { 
    ...
    for _, interfaceValue := range retValue.([]interface{}) {
        valuetmp, ok := interfaceValue.(PS_VpnConnectionTriggerDnsConfiguration); 
        if !ok {
            err = errors.Wrapf(errors.InvalidType, " PS_VpnConnectionTriggerDnsConfiguration is Invalid. Expected %s", reflect.TypeOf(interfaceValue))
            return  
        }
        value = append(value, PS_VpnConnectionTriggerDnsConfiguration(valuetmp))
    }
...
func (instance *PS_VpnConnection) GetPropertyProxy()(value PS_VpnConnectionProxy, err error) { 
    ...
    valuetmp, ok := retValue.(PS_VpnConnectionProxy); 
    if !ok {
        err = errors.Wrapf(errors.InvalidType, " PS_VpnConnectionProxy is Invalid. Expected %s", reflect.TypeOf(retValue))
        return  
    }

    value = PS_VpnConnectionProxy(valuetmp)
...
func (instance *PS_VpnConnection) GetPropertyRoutes()(value []PS_VpnConnectionRoute, err error) { 
    ...
    for _, interfaceValue := range retValue.([]interface{}) {
        valuetmp, ok := interfaceValue.(PS_VpnConnectionRoute); 
        if !ok {
            err = errors.Wrapf(errors.InvalidType, " PS_VpnConnectionRoute is Invalid. Expected %s", reflect.TypeOf(interfaceValue))
            return  
        }
        value = append(value, PS_VpnConnectionRoute(valuetmp))
    }
...
func (instance *PS_VpnConnection) GetPropertyServerList()(value []PS_VpnServerAddress, err error) { 
    ...
    for _, interfaceValue := range retValue.([]interface{}) {
        valuetmp, ok := interfaceValue.(PS_VpnServerAddress); 
        if !ok {
            err = errors.Wrapf(errors.InvalidType, " PS_VpnServerAddress is Invalid. Expected %s", reflect.TypeOf(interfaceValue))
            return  
        }
        value = append(value, PS_VpnServerAddress(valuetmp))
    }
...
func (instance *PS_VpnConnection) Remove( /* IN */ Name []string,
 ...
 /* OUT */ cmdletOutput []VpnCommonConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , Name, Force, PassThru, AllUserConnection)
	if err != nil { return }
...
func (instance *PS_VpnConnection) Get( /* IN */ Name []string,
 /* IN */ AllUserConnection bool,
 /* OUT */ cmdletOutput []VpnCommonConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , Name, AllUserConnection)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnConnection) Set( /* IN */ ServerAddress string,
 ...
 /* IN */ DnsSuffix string,
 /* OUT */ cmdletOutput VpnConnection) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , ServerAddress, AllUserConnection, SplitTunneling, RememberCredential, TunnelType, PassThru, Force, L2tpPsk, AuthenticationMethod, EapConfigXmlStream, Name, UseWinlogonCredential, EncryptionLevel, MachineCertificateEKUFilter, MachineCertificateIssuerFilter, ServerList, IdleDisconnectSeconds, DnsSuffix)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnConnection) SetByThirdParty( /* IN */ Name string,
 ...
 /* OUT */ cmdletOutput ThirdPartyVpnConnection) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByThirdParty" , Name, ServerAddress, RememberCredential, SplitTunneling, PassThru, Force, ServerList, DnsSuffix, IdleDisconnectSeconds, PlugInApplicationID, CustomConfiguration, ThirdPartyVpn)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnConnection) Add( /* IN */ Name string,
 ...
 /* IN */ MachineCertificateEKUFilter []string,
 /* IN */ ServerList []VpnServerAddress,
 /* OUT */ cmdletOutput VpnConnection) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , Name, ServerAddress, TunnelType, AllUserConnection, RememberCredential, IdleDisconnectSeconds, DnsSuffix, SplitTunneling, Force, PassThru, L2tpPsk, UseWinlogonCredential, EapConfigXmlStream, AuthenticationMethod, EncryptionLevel, MachineCertificateIssuerFilter, MachineCertificateEKUFilter, ServerList)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnConnection) NewByThirdParty( /* IN */ Name string,
 ...
 /* IN */ PlugInApplicationID string,
 /* IN */ CustomConfiguration string,
 /* OUT */ cmdletOutput ThirdPartyVpnConnection) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByThirdParty" , Name, ServerAddress, RememberCredential, SplitTunneling, PassThru, Force, ServerList, DnsSuffix, IdleDisconnectSeconds, PlugInApplicationID, CustomConfiguration)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
