...
type PS_EapConfiguration struct { 
	*cim.WmiInstance
	...
	func NewPS_EapConfigurationEx1(instance *cim.WmiInstance) (newInstance *PS_EapConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_EapConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_EapConfiguration) NewByEapMsChapv2Auth( /* IN */ UseWinlogonCredential bool,
 /* OUT */ cmdletOutput EapConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByEapMsChapv2Auth" , UseWinlogonCredential)
	if err != nil { return }
...
func (instance *PS_EapConfiguration) NewByEapTlsAuth( /* IN */ Tls bool,
 ...
 /* OUT */ cmdletOutput EapConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByEapTlsAuth" , Tls, UserCertificate, VerifyServerIdentity)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_EapConfiguration) NewByEapTtlsAuth( /* IN */ Ttls bool,
 ...
 /* OUT */ cmdletOutput EapConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByEapTtlsAuth" , Ttls, UseWinlogonCredential, TunnledNonEapAuthMethod, TunnledEapAuthMethod)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_EapConfiguration) NewByPeapAuth( /* IN */ Peap bool,
 ...
 /* IN */ TunnledEapAuthMethod string,
 /* OUT */ cmdletOutput EapConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("NewByPeapAuth" , Peap, VerifyServerIdentity, EnableNap, FastReconnect, TunnledEapAuthMethod)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
