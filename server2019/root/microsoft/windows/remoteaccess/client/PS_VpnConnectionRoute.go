...
type PS_VpnConnectionRoute struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnConnectionRouteEx1(instance *cim.WmiInstance) (newInstance *PS_VpnConnectionRoute, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnConnectionRoute, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnConnectionRoute) Add( /* IN */ ConnectionName string,
 ...
 /* OUT */ cmdletOutput MSFT_NetRoute) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , ConnectionName, DestinationPrefix, RouteMetric, PassThru, AllUserConnection)
	if err != nil { return }
...
func (instance *PS_VpnConnectionRoute) Remove( /* IN */ ConnectionName string,
 ...
 /* IN */ AllUserConnection bool,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput MSFT_NetRoute) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , ConnectionName, DestinationPrefix, AllUserConnection, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
