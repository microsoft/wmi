...
type VpnConnectionTriggerDnsConfiguration struct { 
	*cim.WmiInstance
	...
	func NewVpnConnectionTriggerDnsConfigurationEx1(instance *cim.WmiInstance) (newInstance *VpnConnectionTriggerDnsConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnConnectionTriggerDnsConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
