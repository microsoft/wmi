...
func (instance *MSFT_NetRoute) Create( /* IN */ InterfaceIndex uint32,
 ...
 /* IN */ PassThru bool,
 /* OUT */ CmdletOutput []MSFT_NetRoute) (result uint32, err error) {retVal, err := instance.InvokeMethod("Create" , InterfaceIndex, InterfaceAlias, DestinationPrefix, NextHop, Publish, RouteMetric, Protocol, ValidLifetime, PreferredLifetime, PolicyStore, AddressFamily, PassThru)
	if err != nil { return }
...
func (instance *MSFT_NetRoute) Select( /* IN */ InterfaceIndex uint32,
 ...
 /* OUT */ CmdletOutput []CIM_ManagedElement) (result uint32, err error) {retVal, err := instance.InvokeMethod("Select" , InterfaceIndex, LocalIPAddress, RemoteIPAddress)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
