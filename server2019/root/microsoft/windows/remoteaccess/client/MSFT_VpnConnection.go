...
type MSFT_VpnConnection struct { 
	*cim.WmiInstance
	...
	func NewMSFT_VpnConnectionEx1(instance *cim.WmiInstance) (newInstance *MSFT_VpnConnection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VpnConnection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_VpnConnection) Set( /* IN */ Profile string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Set" , Profile);
	if err != nil { return }
