...
type VpnConnectionProxy struct { 
	*cim.WmiInstance
	...
	func NewVpnConnectionProxyEx1(instance *cim.WmiInstance) (newInstance *VpnConnectionProxy, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnConnectionProxy, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
