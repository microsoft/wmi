...
type VpnCommonConfig struct { 
	*cim.WmiInstance
	...
	func NewVpnCommonConfigEx1(instance *cim.WmiInstance) (newInstance *VpnCommonConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnCommonConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
