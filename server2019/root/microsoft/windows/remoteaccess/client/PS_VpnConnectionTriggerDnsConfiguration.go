...
type PS_VpnConnectionTriggerDnsConfiguration struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnConnectionTriggerDnsConfigurationEx1(instance *cim.WmiInstance) (newInstance *PS_VpnConnectionTriggerDnsConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnConnectionTriggerDnsConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnConnectionTriggerDnsConfiguration) Add( /* IN */ ConnectionName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput VpnConnectionTriggerDnsConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , ConnectionName, DnsSuffix, DnsIPAddress, PassThru, Force)
	if err != nil { return }
...
func (instance *PS_VpnConnectionTriggerDnsConfiguration) Set( /* IN */ ConnectionName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput VpnConnectionTriggerDnsConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , ConnectionName, DnsSuffix, DnsIPAddress, DnsSuffixSearchList, PassThru, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_VpnConnectionTriggerDnsConfiguration) Remove( /* IN */ ConnectionName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput []VpnConnectionTriggerDnsConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Remove" , ConnectionName, DnsSuffix, PassThru, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
