...
type VpnConnectionTrigger struct { 
	*cim.WmiInstance
	...
	func NewVpnConnectionTriggerEx1(instance *cim.WmiInstance) (newInstance *VpnConnectionTrigger, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnConnectionTrigger, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
