...
type VpnConnectionTriggerTrustedNetwork struct { 
	*cim.WmiInstance
	...
	func NewVpnConnectionTriggerTrustedNetworkEx1(instance *cim.WmiInstance) (newInstance *VpnConnectionTriggerTrustedNetwork, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnConnectionTriggerTrustedNetwork, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
