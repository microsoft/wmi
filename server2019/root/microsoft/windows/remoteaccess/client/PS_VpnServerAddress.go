...
type PS_VpnServerAddress struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnServerAddressEx1(instance *cim.WmiInstance) (newInstance *PS_VpnServerAddress, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnServerAddress, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnServerAddress) New( /* IN */ ServerAddress string,
 ...
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput VpnServerAddress) (result uint32, err error) {retVal, err := instance.InvokeMethod("New" , ServerAddress, FriendlyName, PassThru)
	if err != nil { return }
