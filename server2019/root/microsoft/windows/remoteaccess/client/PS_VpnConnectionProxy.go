...
type PS_VpnConnectionProxy struct { 
	*cim.WmiInstance
	...
	func NewPS_VpnConnectionProxyEx1(instance *cim.WmiInstance) (newInstance *PS_VpnConnectionProxy, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_VpnConnectionProxy, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_VpnConnectionProxy) Set( /* IN */ AutoDetect bool,
 ...
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput VpnConnectionProxy) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , AutoDetect, AutoConfigurationScript, ProxyServer, BypassProxyForLocal, ExceptionPrefix, ConnectionName, PassThru)
	if err != nil { return }
