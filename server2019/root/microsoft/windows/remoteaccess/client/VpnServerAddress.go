...
type VpnServerAddress struct { 
	*cim.WmiInstance
	...
	func NewVpnServerAddressEx1(instance *cim.WmiInstance) (newInstance *VpnServerAddress, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnServerAddress, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
