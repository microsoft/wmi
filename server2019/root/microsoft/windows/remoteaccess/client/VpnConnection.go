...
type VpnConnection struct { 
	*VpnCommonConfig
	...
	func NewVpnConnectionEx1(instance *cim.WmiInstance) (newInstance *VpnConnection, err error) {tmp, err := NewVpnCommonConfigEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnConnection, err error) {tmp, err := NewVpnCommonConfigEx6(hostName, wmiNamespace, userName, password, domainName, query)
