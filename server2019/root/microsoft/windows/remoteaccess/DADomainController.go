...
func NewDADomainControllerEx1(instance *cim.WmiInstance) (newInstance *DADomainController, err error) {
...
func NewDADomainControllerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *DADomainController, err error) {
