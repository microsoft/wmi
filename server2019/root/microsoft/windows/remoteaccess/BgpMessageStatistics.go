...
type BgpMessageStatistics struct { 
	*cim.WmiInstance
	...
	func NewBgpMessageStatisticsEx1(instance *cim.WmiInstance) (newInstance *BgpMessageStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpMessageStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
