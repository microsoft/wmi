...
type VpnAuth struct { 
	*cim.WmiInstance
	...
	func NewVpnAuthEx1(instance *cim.WmiInstance) (newInstance *VpnAuth, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnAuth, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
