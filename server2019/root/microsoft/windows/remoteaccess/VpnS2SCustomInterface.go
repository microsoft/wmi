...
func NewVpnS2SCustomInterfaceEx1(instance *cim.WmiInstance) (newInstance *VpnS2SCustomInterface, err error) {
...
func NewVpnS2SCustomInterfaceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *VpnS2SCustomInterface, err error) {
