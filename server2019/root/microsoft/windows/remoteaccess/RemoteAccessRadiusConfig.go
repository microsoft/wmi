...
type RemoteAccessRadiusConfig struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessRadiusConfigEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessRadiusConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessRadiusConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
