...
type GreS2SInterface struct { 
	*VpnS2SInterface
	...
	func NewGreS2SInterfaceEx1(instance *cim.WmiInstance) (newInstance *GreS2SInterface, err error) {tmp, err := NewVpnS2SInterfaceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GreS2SInterface, err error) {tmp, err := NewVpnS2SInterfaceEx6(hostName, wmiNamespace, userName, password, domainName, query)
