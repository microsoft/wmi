...
type PS_RemoteAccessRoutingDomain struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessRoutingDomainEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessRoutingDomain, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessRoutingDomain, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessRoutingDomain) Get( /* IN */ Name string,
 /* OUT */ cmdletOutput []VpnRoutingDomainConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , Name)
	if err != nil { return }
...
func (instance *PS_RemoteAccessRoutingDomain) Enable( /* IN */ Name string,
 /* IN */ PassThru bool,
 /* IN */ Type uint32,
 /* OUT */ cmdletOutput RoutingDomainConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , Name, PassThru, Type)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessRoutingDomain) Disable( /* IN */ Name string,
 ...
 /* IN */ PassThru bool,
 /* IN */ Type uint32,
 /* OUT */ cmdletOutput RoutingDomainConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , Name, Force, PassThru, Type)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessRoutingDomain) SetByCustomPolicy( /* IN */ Name string,
 ...
 /* IN */ DHGroup uint32,
 /* OUT */ cmdletOutput VpnRoutingDomainConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByCustomPolicy" , Name, IdleDisconnectSec, InterimAccountingPeriodSec, IPAddressRange, IPv6Prefix, SaLifeTimeSec, MMSaLifeTimeSec, NetBiosIPAddress, MaximumVpnConnections, TenantName, PassThru, Force, EnableQoS, TxBandwidthKbps, RxBandwidthKbps, DnsIPAddress, CustomPolicy, AuthenticationTransformConstant, CipherTransformConstant, EncryptionMethod, IntegrityCheckMethod, PfsGroup, SaRenegotiationDataSizeKB, DHGroup)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessRoutingDomain) SetByEncryptionType( /* IN */ Name string,
 ...
 /* OUT */ cmdletOutput VpnRoutingDomainConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByEncryptionType" , Name, InterimAccountingPeriodSec, IPAddressRange, IPv6Prefix, NetBiosIPAddress, MaximumVpnConnections, TenantName, PassThru, Force, EnableQoS, TxBandwidthKbps, RxBandwidthKbps, DnsIPAddress, EncryptionType)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
