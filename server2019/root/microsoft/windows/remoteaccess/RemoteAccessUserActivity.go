...
func NewRemoteAccessUserActivityEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessUserActivity, err error) {
...
func NewRemoteAccessUserActivityEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessUserActivity, err error) {
