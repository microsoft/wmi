...
type RemoteAccessError struct { 
	*MSFT_WmiError
	...
	func NewRemoteAccessErrorEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessError, err error) {tmp, err := NewMSFT_WmiErrorEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessError, err error) {tmp, err := NewMSFT_WmiErrorEx6(hostName, wmiNamespace, userName, password, domainName, query)
