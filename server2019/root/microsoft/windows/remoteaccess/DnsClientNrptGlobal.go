...
type DnsClientNrptGlobal struct { 
	*cim.WmiInstance
	...
	func NewDnsClientNrptGlobalEx1(instance *cim.WmiInstance) (newInstance *DnsClientNrptGlobal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DnsClientNrptGlobal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
