...
type PS_RemoteAccessLoadBalancer struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessLoadBalancerEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessLoadBalancer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessLoadBalancer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessLoadBalancer) SetByDisableLoadBalancing( /* IN */ ComputerName string,
 ...
 /* IN */ Disable bool,
 /* IN */ Force bool,
 /* OUT */ cmdletOutput RemoteAccessLoadBalancer) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByDisableLoadBalancing" , ComputerName, PassThru, Disable, Force)
	if err != nil { return }
...
func (instance *PS_RemoteAccessLoadBalancer) SetByEnableLoadBalancing( /* IN */ ComputerName string,
 ...
 /* OUT */ cmdletOutput RemoteAccessLoadBalancer) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByEnableLoadBalancing" , ComputerName, PassThru, UseThirdPartyLoadBalancer, InternetDedicatedIPAddress, InternalDedicatedIPAddress, InternetVirtualIPAddress, InternalVirtualIPAddress)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLoadBalancer) SetByThirdPartyLoadBalancer( /* IN */ ComputerName string,
 ...
 /* OUT */ cmdletOutput RemoteAccessLoadBalancer) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetByThirdPartyLoadBalancer" , ComputerName, PassThru, ThirdPartyLoadBalancer)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLoadBalancer) Get( /* IN */ ComputerName string,
 ...
 /* IN */ Brief bool,
 /* OUT */ cmdletOutput RemoteAccessLoadBalancer) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , ComputerName, EntrypointName, Brief)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
