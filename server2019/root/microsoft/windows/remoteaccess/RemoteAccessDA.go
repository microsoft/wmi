...
type RemoteAccessDA struct { 
	*RemoteAccessCommon
	...
	func NewRemoteAccessDAEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessDA, err error) {tmp, err := NewRemoteAccessCommonEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessDA, err error) {tmp, err := NewRemoteAccessCommonEx6(hostName, wmiNamespace, userName, password, domainName, query)
