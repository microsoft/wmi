...
type VpnS2SDefaultInterface struct { 
	*VpnS2SInterface
	...
	func NewVpnS2SDefaultInterfaceEx1(instance *cim.WmiInstance) (newInstance *VpnS2SDefaultInterface, err error) {tmp, err := NewVpnS2SInterfaceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnS2SDefaultInterface, err error) {tmp, err := NewVpnS2SInterfaceEx6(hostName, wmiNamespace, userName, password, domainName, query)
