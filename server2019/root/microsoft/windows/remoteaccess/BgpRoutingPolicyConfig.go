...
type BgpRoutingPolicyConfig struct { 
	*cim.WmiInstance
	...
	func NewBgpRoutingPolicyConfigEx1(instance *cim.WmiInstance) (newInstance *BgpRoutingPolicyConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpRoutingPolicyConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
