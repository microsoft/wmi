...
type VpnS2SMultiTenantDefaultInterface struct { 
	*VpnS2SDefaultInterface
	...
	func NewVpnS2SMultiTenantDefaultInterfaceEx1(instance *cim.WmiInstance) (newInstance *VpnS2SMultiTenantDefaultInterface, err error) {tmp, err := NewVpnS2SDefaultInterfaceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnS2SMultiTenantDefaultInterface, err error) {tmp, err := NewVpnS2SDefaultInterfaceEx6(hostName, wmiNamespace, userName, password, domainName, query)
