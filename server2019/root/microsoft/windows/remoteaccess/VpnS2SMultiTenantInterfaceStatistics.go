...
type VpnS2SMultiTenantInterfaceStatistics struct { 
	*VpnS2SInterfaceStatistics
	...
	func NewVpnS2SMultiTenantInterfaceStatisticsEx1(instance *cim.WmiInstance) (newInstance *VpnS2SMultiTenantInterfaceStatistics, err error) {tmp, err := NewVpnS2SInterfaceStatisticsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnS2SMultiTenantInterfaceStatistics, err error) {tmp, err := NewVpnS2SInterfaceStatisticsEx6(hostName, wmiNamespace, userName, password, domainName, query)
