...
type DAAppServerConnection struct { 
	*cim.WmiInstance
	...
	func NewDAAppServerConnectionEx1(instance *cim.WmiInstance) (newInstance *DAAppServerConnection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAAppServerConnection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
