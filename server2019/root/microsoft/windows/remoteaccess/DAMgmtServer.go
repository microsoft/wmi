...
type DAMgmtServer struct { 
	*cim.WmiInstance
	...
	func NewDAMgmtServerEx1(instance *cim.WmiInstance) (newInstance *DAMgmtServer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAMgmtServer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
