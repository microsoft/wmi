...
type RemoteAccessConnectionSummary struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessConnectionSummaryEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessConnectionSummary, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessConnectionSummary, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
