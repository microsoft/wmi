...
type InterfaceIpFilter struct { 
	*cim.WmiInstance
	...
	func NewInterfaceIpFilterEx1(instance *cim.WmiInstance) (newInstance *InterfaceIpFilter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *InterfaceIpFilter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
