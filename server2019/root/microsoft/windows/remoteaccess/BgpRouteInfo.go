...
type BgpRouteInfo struct { 
	*cim.WmiInstance
	...
	func NewBgpRouteInfoEx1(instance *cim.WmiInstance) (newInstance *BgpRouteInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpRouteInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
