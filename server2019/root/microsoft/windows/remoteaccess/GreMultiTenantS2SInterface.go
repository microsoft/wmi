...
type GreMultiTenantS2SInterface struct { 
	*GreS2SInterface
	...
	func NewGreMultiTenantS2SInterfaceEx1(instance *cim.WmiInstance) (newInstance *GreMultiTenantS2SInterface, err error) {tmp, err := NewGreS2SInterfaceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GreMultiTenantS2SInterface, err error) {tmp, err := NewGreS2SInterfaceEx6(hostName, wmiNamespace, userName, password, domainName, query)
