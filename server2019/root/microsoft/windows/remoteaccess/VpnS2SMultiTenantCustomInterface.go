...
type VpnS2SMultiTenantCustomInterface struct { 
	*VpnS2SCustomInterface
	...
	func NewVpnS2SMultiTenantCustomInterfaceEx1(instance *cim.WmiInstance) (newInstance *VpnS2SMultiTenantCustomInterface, err error) {tmp, err := NewVpnS2SCustomInterfaceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnS2SMultiTenantCustomInterface, err error) {tmp, err := NewVpnS2SCustomInterfaceEx6(hostName, wmiNamespace, userName, password, domainName, query)
