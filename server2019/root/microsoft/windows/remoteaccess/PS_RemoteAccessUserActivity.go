...
func NewPS_RemoteAccessUserActivityEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessUserActivity, err error) {
...
func NewPS_RemoteAccessUserActivityEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_RemoteAccessUserActivity, err error) {
...
func (instance *PS_RemoteAccessUserActivity) GetByHostIP( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput []RemoteAccessUserActivity) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetByHostIP", ComputerName, HostIPAddress, EndDateTime, StartDateTime)
	if err != nil {
		return
	}
...
func (instance *PS_RemoteAccessUserActivity) GetBySessionId( /* IN */ ComputerName string,
	/* IN */ SessionId uint64,
	/* OUT */ cmdletOutput []RemoteAccessUserActivity) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetBySessionId", ComputerName, SessionId)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
...
func (instance *PS_RemoteAccessUserActivity) GetByUserName( /* IN */ ComputerName string,
	...
	/* IN */ StartDateTime string,
	/* OUT */ cmdletOutput []RemoteAccessUserActivity) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetByUserName", ComputerName, UserName, EndDateTime, StartDateTime)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
