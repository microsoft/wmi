...
type DAEntryPoint struct { 
	*DAEntryPointBase
	...
	func NewDAEntryPointEx1(instance *cim.WmiInstance) (newInstance *DAEntryPoint, err error) {tmp, err := NewDAEntryPointBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAEntryPoint, err error) {tmp, err := NewDAEntryPointBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
