...
func NewBgpCustomNetworkInfoEx1(instance *cim.WmiInstance) (newInstance *BgpCustomNetworkInfo, err error) {
...
func NewBgpCustomNetworkInfoEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *BgpCustomNetworkInfo, err error) {
