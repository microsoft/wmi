...
type PS_BgpRoutingPolicy struct { 
	*cim.WmiInstance
	...
	func NewPS_BgpRoutingPolicyEx1(instance *cim.WmiInstance) (newInstance *PS_BgpRoutingPolicy, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_BgpRoutingPolicy, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_BgpRoutingPolicy) Add( /* IN */ PassThru bool,
 ...
 /* OUT */ cmdletOutput BgpRoutingPolicyConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , PassThru, RoutingDomain, IgnorePrefix, Name, MatchCommunity, NewLocalPref, AddCommunity, Force, NewMED, PolicyType, NewNextHop, RemoveCommunity, MatchPrefix, MatchASNRange, MatchNextHop, ClearMED, RemoveAllCommunities)
	if err != nil { return }
...
func (instance *PS_BgpRoutingPolicy) Get( /* IN */ Name []string,
 /* IN */ PolicyType uint32,
 /* IN */ RoutingDomain string,
 /* OUT */ cmdletOutput []BgpRoutingPolicyConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , Name, PolicyType, RoutingDomain)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_BgpRoutingPolicy) GetForAllRoutingDomains( /* IN */ AllRoutingDomains bool,
 /* OUT */ cmdletOutput []BgpRoutingPolicyConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetForAllRoutingDomains" , AllRoutingDomains)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_BgpRoutingPolicy) Set( /* IN */ Name string,
 ...
 /* IN */ NewNextHop string,
 /* IN */ RemoveAllCommunities bool,
 /* OUT */ cmdletOutput BgpRoutingPolicyConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , Name, PassThru, PolicyType, RoutingDomain, Force, AddCommunity, RemoveCommunity, RemovePolicyClause, MatchASNRange, IgnorePrefix, MatchCommunity, MatchPrefix, MatchNextHop, ClearMED, NewLocalPref, NewMED, NewNextHop, RemoveAllCommunities)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
