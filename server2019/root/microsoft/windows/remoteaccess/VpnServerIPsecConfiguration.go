...
func NewVpnServerIPsecConfigurationEx1(instance *cim.WmiInstance) (newInstance *VpnServerIPsecConfiguration, err error) {
...
func NewVpnServerIPsecConfigurationEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *VpnServerIPsecConfiguration, err error) {
