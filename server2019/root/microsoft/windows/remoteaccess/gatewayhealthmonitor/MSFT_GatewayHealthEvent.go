...
type MSFT_GatewayHealthEvent struct { 
	*cim.WmiInstance
	...
	func NewMSFT_GatewayHealthEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_GatewayHealthEvent, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_GatewayHealthEvent, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
