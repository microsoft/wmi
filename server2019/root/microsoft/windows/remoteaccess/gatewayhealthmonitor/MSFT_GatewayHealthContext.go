...
type MSFT_GatewayHealthContext struct { 
	*cim.WmiInstance
	...
	func NewMSFT_GatewayHealthContextEx1(instance *cim.WmiInstance) (newInstance *MSFT_GatewayHealthContext, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_GatewayHealthContext, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
