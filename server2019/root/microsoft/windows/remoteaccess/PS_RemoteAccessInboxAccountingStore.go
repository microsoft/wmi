...
type PS_RemoteAccessInboxAccountingStore struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessInboxAccountingStoreEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessInboxAccountingStore, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessInboxAccountingStore, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessInboxAccountingStore) Set( /* IN */ StoreLimit string,
 ...
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput RemoteAccessInboxAccounting) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , StoreLimit, ComputerName, PassThru)
	if err != nil { return }
...
func (instance *PS_RemoteAccessInboxAccountingStore) Clear( /* IN */ ComputerName string,
 ...
 /* IN */ Force bool,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput RemoteAccessInboxAccounting) (result uint32, err error) {retVal, err := instance.InvokeMethod("Clear" , ComputerName, StartDateTime, EndDateTime, Force, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
