...
type VpnIPAddressRange struct { 
	*cim.WmiInstance
	...
	func NewVpnIPAddressRangeEx1(instance *cim.WmiInstance) (newInstance *VpnIPAddressRange, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnIPAddressRange, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
