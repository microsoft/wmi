...
type DAOtpAuthentication struct { 
	*cim.WmiInstance
	...
	func NewDAOtpAuthenticationEx1(instance *cim.WmiInstance) (newInstance *DAOtpAuthentication, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAOtpAuthentication, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
