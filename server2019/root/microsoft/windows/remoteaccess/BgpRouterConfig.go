...
type BgpRouterConfig struct { 
	*cim.WmiInstance
	...
	func NewBgpRouterConfigEx1(instance *cim.WmiInstance) (newInstance *BgpRouterConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpRouterConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
