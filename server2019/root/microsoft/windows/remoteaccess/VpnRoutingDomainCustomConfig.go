...
func NewVpnRoutingDomainCustomConfigEx1(instance *cim.WmiInstance) (newInstance *VpnRoutingDomainCustomConfig, err error) {
...
func NewVpnRoutingDomainCustomConfigEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *VpnRoutingDomainCustomConfig, err error) {
