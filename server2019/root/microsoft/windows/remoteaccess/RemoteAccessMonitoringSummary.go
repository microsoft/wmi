...
type RemoteAccessMonitoringSummary struct { 
	*RemoteAccessConnectionSummary
	...
	func NewRemoteAccessMonitoringSummaryEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessMonitoringSummary, err error) {tmp, err := NewRemoteAccessConnectionSummaryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessMonitoringSummary, err error) {tmp, err := NewRemoteAccessConnectionSummaryEx6(hostName, wmiNamespace, userName, password, domainName, query)
