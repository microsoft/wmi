...
type BgpPeerConfig struct { 
	*cim.WmiInstance
	...
	func NewBgpPeerConfigEx1(instance *cim.WmiInstance) (newInstance *BgpPeerConfig, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *BgpPeerConfig, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
