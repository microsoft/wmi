...
func NewPS_RemoteAccessConnectionStatisticsEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessConnectionStatistics, err error) {
...
func NewPS_RemoteAccessConnectionStatisticsEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_RemoteAccessConnectionStatistics, err error) {
...
func (instance *PS_RemoteAccessConnectionStatistics) GetByAccountingStatistics( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput []RemoteAccessAccountingConnection) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetByAccountingStatistics", ComputerName, StartDateTime, EndDateTime)
	if err != nil {
		return
	}
...
func (instance *PS_RemoteAccessConnectionStatistics) GetByActiveStatistics( /* IN */ ComputerName string,
	...
	/* OUT */ cmdletOutput []RemoteAccessMonitoringConnection) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("GetByActiveStatistics", ComputerName, ResourceName, RoutingDomain)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
