...
type VpnS2SInterface struct { 
	*cim.WmiInstance
	...
	func NewVpnS2SInterfaceEx1(instance *cim.WmiInstance) (newInstance *VpnS2SInterface, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnS2SInterface, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
