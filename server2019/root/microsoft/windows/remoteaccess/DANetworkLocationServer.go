...
type DANetworkLocationServer struct { 
	*cim.WmiInstance
	...
	func NewDANetworkLocationServerEx1(instance *cim.WmiInstance) (newInstance *DANetworkLocationServer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DANetworkLocationServer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
