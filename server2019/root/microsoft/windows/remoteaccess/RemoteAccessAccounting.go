...
func NewRemoteAccessAccountingEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessAccounting, err error) {
...
func NewRemoteAccessAccountingEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessAccounting, err error) {
