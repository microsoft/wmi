...
type PS_BgpRouter struct { 
	*cim.WmiInstance
	...
	func NewPS_BgpRouterEx1(instance *cim.WmiInstance) (newInstance *PS_BgpRouter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_BgpRouter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_BgpRouter) Add( /* IN */ BgpIdentifier string,
 ...
 /* OUT */ cmdletOutput BgpRouterConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Add" , BgpIdentifier, LocalASN, IPv6Routing, CompareMEDAcrossASN, DefaultGatewayRouting, PassThru, Force, RoutingDomain, LocalIPv6Address, TransitRouting, RouteReflector, ClusterId, ClientToClientReflection)
	if err != nil { return }
...
func (instance *PS_BgpRouter) Remove( /* IN */ RoutingDomain []string,
 /* IN */ Force bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Remove" , RoutingDomain, Force);
	if err != nil { return }
...
func (instance *PS_BgpRouter) Get( /* IN */ RoutingDomain []string,
 /* OUT */ cmdletOutput []BgpRouterConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , RoutingDomain)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_BgpRouter) Set( /* IN */ BgpIdentifier string,
 ...
 /* IN */ ClusterId uint32,
 /* IN */ ClientToClientReflection uint32,
 /* OUT */ cmdletOutput BgpRouterConfig) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , BgpIdentifier, LocalASN, CompareMEDAcrossASN, DefaultGatewayRouting, IPv6Routing, RoutingDomain, PassThru, Force, LocalIPv6Address, TransitRouting, RouteReflector, ClusterId, ClientToClientReflection)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
