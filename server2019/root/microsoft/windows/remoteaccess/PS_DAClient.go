...
type PS_DAClient struct { 
	*cim.WmiInstance
	...
	func NewPS_DAClientEx1(instance *cim.WmiInstance) (newInstance *PS_DAClient, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_DAClient, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_DAClient) AddByClientDownlevelSGGpo( /* IN */ ComputerName string,
 ...
 /* OUT */ cmdletOutput DAClient) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddByClientDownlevelSGGpo" , ComputerName, PassThru, DownlevelGpoName, DownlevelSecurityGroupNameList, EntrypointName)
	if err != nil { return }
...
func (instance *PS_DAClient) AddByClientSGGpo( /* IN */ ComputerName string,
 ...
 /* IN */ GpoName []string,
 /* OUT */ cmdletOutput DAClient) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddByClientSGGpo" , ComputerName, PassThru, SecurityGroupNameList, GpoName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAClient) RemoveByClientDownlevelSGGpo( /* IN */ ComputerName string,
 ...
 /* OUT */ cmdletOutput DAClient) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveByClientDownlevelSGGpo" , ComputerName, PassThru, DownlevelSecurityGroupNameList, EntrypointName, DownlevelDomainName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAClient) RemoveByClientSGGpo( /* IN */ ComputerName string,
 ...
 /* OUT */ cmdletOutput DAClient) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveByClientSGGpo" , ComputerName, PassThru, SecurityGroupNameList, DomainName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAClient) Set( /* IN */ ComputerName string,
 ...
 /* IN */ Downlevel string,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput DAClientSettings) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , ComputerName, ForceTunnel, OnlyRemoteComputers, Downlevel, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAClient) Get( /* IN */ ComputerName string,
 /* IN */ EntrypointName string,
 /* OUT */ cmdletOutput DAClient) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , ComputerName, EntrypointName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
