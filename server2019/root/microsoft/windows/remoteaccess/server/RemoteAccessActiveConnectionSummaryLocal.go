...
type RemoteAccessActiveConnectionSummaryLocal struct { 
	*RemoteAccessConnectionSummaryLocal
	...
	func NewRemoteAccessActiveConnectionSummaryLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessActiveConnectionSummaryLocal, err error) {tmp, err := NewRemoteAccessConnectionSummaryLocalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessActiveConnectionSummaryLocal, err error) {tmp, err := NewRemoteAccessConnectionSummaryLocalEx6(hostName, wmiNamespace, userName, password, domainName, query)
