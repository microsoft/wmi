...
func NewRemoteAccessUserActivityLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessUserActivityLocal, err error) {
...
func NewRemoteAccessUserActivityLocalEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *RemoteAccessUserActivityLocal, err error) {
