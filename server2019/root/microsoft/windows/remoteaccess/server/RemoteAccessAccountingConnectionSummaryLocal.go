...
type RemoteAccessAccountingConnectionSummaryLocal struct { 
	*RemoteAccessConnectionSummaryLocal
	...
	func NewRemoteAccessAccountingConnectionSummaryLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessAccountingConnectionSummaryLocal, err error) {tmp, err := NewRemoteAccessConnectionSummaryLocalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessAccountingConnectionSummaryLocal, err error) {tmp, err := NewRemoteAccessConnectionSummaryLocalEx6(hostName, wmiNamespace, userName, password, domainName, query)
