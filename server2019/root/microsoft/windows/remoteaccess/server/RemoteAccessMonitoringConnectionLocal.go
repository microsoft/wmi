...
type RemoteAccessMonitoringConnectionLocal struct { 
	*RemoteAccessConnectionLocal
	...
	func NewRemoteAccessMonitoringConnectionLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessMonitoringConnectionLocal, err error) {tmp, err := NewRemoteAccessConnectionLocalEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessMonitoringConnectionLocal, err error) {tmp, err := NewRemoteAccessConnectionLocalEx6(hostName, wmiNamespace, userName, password, domainName, query)
