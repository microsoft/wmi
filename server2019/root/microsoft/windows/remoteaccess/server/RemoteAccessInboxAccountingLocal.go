...
type RemoteAccessInboxAccountingLocal struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessInboxAccountingLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessInboxAccountingLocal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessInboxAccountingLocal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
