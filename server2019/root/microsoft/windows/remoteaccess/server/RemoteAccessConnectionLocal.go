...
type RemoteAccessConnectionLocal struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessConnectionLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessConnectionLocal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessConnectionLocal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
