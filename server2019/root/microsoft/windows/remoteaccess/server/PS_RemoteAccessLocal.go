...
type PS_RemoteAccessLocal struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessLocalEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessLocal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessLocal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessLocal) CheckServerPreRequisites( /* OUT */ Status []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("CheckServerPreRequisites" )
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *PS_RemoteAccessLocal) Sync( /* IN */ Options uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Sync" , Options);
	if err != nil { return }
...
func (instance *PS_RemoteAccessLocal) CheckInterfaces( /* IN */ IntranetInterface string,
 ...
 /* OUT */ Status bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("CheckInterfaces" , IntranetInterface, InternetInterface, BehindNat, ConnectTo, isNlbDeployed)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) GetInterfaces( /* IN/OUT */ DeploymentMode uint32,
 ...
 /* OUT */ InternetInterfaces []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetInterfaces" , ConnectTo, isNlbDeployed)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) GetCorpPrefix( /* IN */ IntranetInterface string,
 /* IN */ InternetInterface string,
 /* OUT */ Result DACorpPrefixConfiguration) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetCorpPrefix" , IntranetInterface, InternetInterface)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) EnableFirewallGroup( /* IN */ FirewallGroupName string,
 /* IN */ bEnable bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("EnableFirewallGroup" , FirewallGroupName, bEnable);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_RemoteAccessLocal) CreateSelfSignedCertificate( /* IN */ SubjectName string,
 ...
 /* IN */ Purpose uint32,
 /* OUT */ EncodedCertificate []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateSelfSignedCertificate" , SubjectName, FriendlyName, Purpose)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) EnrollWebServerCertificate( /* IN */ TemplateName string,
 ...
 /* OUT */ EncodedCertificate []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("EnrollWebServerCertificate" , TemplateName, SubjectName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *PS_RemoteAccessLocal) GetConfigurationVersion( /* OUT */ ConfigVersion RemoteAccessConfigurationVersion) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetConfigurationVersion" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) SetVpnPorts( /* IN */ IsVpnEnabled bool,
 /* IN */ IsS2SVpnEnabled bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetVpnPorts" , IsVpnEnabled, IsS2SVpnEnabled);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_RemoteAccessLocal) GetDACertificateFromRawData( /* IN */ CertificateRawData []uint8,
 ...
 /* IN */ Purpose uint32,
 /* OUT */ EncodedCertificate DACertificateContext) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetDACertificateFromRawData" , CertificateRawData, CertificateRawDataType, Purpose)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) GetDACertificateFromSubjectName( /* IN */ SubjectName string,
 ...
 /* IN */ Flags uint32,
 /* OUT */ EncodedCertificate DACertificateContext) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetDACertificateFromSubjectName" , SubjectName, IncludeSelfSigned, Flags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) FindNLSCertificate( /* IN */ SiteAddresses []DASiteAddresses,
 ...
 /* OUT */ EncodedCertificate DACertificateContext) (result uint32, err error) {retVal, err := instance.InvokeMethod("FindNLSCertificate" , SiteAddresses, ConnectToAddress, MachineNamesForAllSites, IncludeSelfSigned)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) GetValidDACertificates( /* IN */ Purpose uint32,
 /* OUT */ EncodedCertificate []DACertificateContext) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetValidDACertificates" , Purpose)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessLocal) SetSSTPCertificate( /* IN */ CertificateHash []uint8,
 /* IN */ UseHttps bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetSSTPCertificate" , CertificateHash, UseHttps);
	if err != nil { return }
	result = uint32(retVal)
	return
