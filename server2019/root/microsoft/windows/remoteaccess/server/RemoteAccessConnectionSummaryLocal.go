...
type RemoteAccessConnectionSummaryLocal struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessConnectionSummaryLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessConnectionSummaryLocal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessConnectionSummaryLocal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
