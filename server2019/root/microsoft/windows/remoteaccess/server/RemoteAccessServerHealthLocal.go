...
type RemoteAccessServerHealthLocal struct { 
	*cim.WmiInstance
	...
	func NewRemoteAccessServerHealthLocalEx1(instance *cim.WmiInstance) (newInstance *RemoteAccessServerHealthLocal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RemoteAccessServerHealthLocal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
