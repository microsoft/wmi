...
type PS_RemoteAccessUserActivityLocal struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessUserActivityLocalEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessUserActivityLocal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessUserActivityLocal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessUserActivityLocal) GetByAccountingUserActivity( /* IN */ StartDateTime string,
 ...
 /* IN */ UserName string,
 /* OUT */ cmdletOutput []RemoteAccessUserActivityLocal) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByAccountingUserActivity" , StartDateTime, EndDateTime, HostIPAddress, UserName)
	if err != nil { return }
...
func (instance *PS_RemoteAccessUserActivityLocal) GetByActiveUserActivity( /* IN */ UserName string,
 /* IN */ HostIPAddress string,
 /* OUT */ cmdletOutput []RemoteAccessUserActivityLocal) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByActiveUserActivity" , UserName, HostIPAddress)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_RemoteAccessUserActivityLocal) GetBySessionId( /* IN */ SessionId uint64,
 /* OUT */ cmdletOutput []RemoteAccessUserActivityLocal) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetBySessionId" , SessionId)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
