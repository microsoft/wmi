...
type DACertificateContext struct { 
	*cim.WmiInstance
	...
	func NewDACertificateContextEx1(instance *cim.WmiInstance) (newInstance *DACertificateContext, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DACertificateContext, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
