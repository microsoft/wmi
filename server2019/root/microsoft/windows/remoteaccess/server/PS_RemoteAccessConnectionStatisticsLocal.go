...
type PS_RemoteAccessConnectionStatisticsLocal struct { 
	*cim.WmiInstance
	...
	func NewPS_RemoteAccessConnectionStatisticsLocalEx1(instance *cim.WmiInstance) (newInstance *PS_RemoteAccessConnectionStatisticsLocal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_RemoteAccessConnectionStatisticsLocal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_RemoteAccessConnectionStatisticsLocal) GetByAccountingStatistics( /* IN */ StartDateTime string,
 ...
 /* OUT */ cmdletOutput []RemoteAccessAccountingConnectionLocal) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByAccountingStatistics" , StartDateTime, EndDateTime)
	if err != nil { return }
...
func (instance *PS_RemoteAccessConnectionStatisticsLocal) GetByActiveStatistics( /* IN */ ResourceName string,
 /* OUT */ cmdletOutput []RemoteAccessMonitoringConnectionLocal) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetByActiveStatistics" , ResourceName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
