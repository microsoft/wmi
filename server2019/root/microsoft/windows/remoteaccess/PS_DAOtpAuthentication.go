...
type PS_DAOtpAuthentication struct { 
	*cim.WmiInstance
	...
	func NewPS_DAOtpAuthenticationEx1(instance *cim.WmiInstance) (newInstance *PS_DAOtpAuthentication, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_DAOtpAuthentication, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_DAOtpAuthentication) Enable( /* IN */ RadiusServer string,
 ...
 /* OUT */ cmdletOutput DAOtpAuthentication) (result uint32, err error) {retVal, err := instance.InvokeMethod("Enable" , RadiusServer, ComputerName, RadiusPort, CAServer, CertificateTemplateName, SharedSecret, UserSecurityGroupName, Force, PassThru, SigningCertificateTemplateName)
	if err != nil { return }
...
func (instance *PS_DAOtpAuthentication) Disable( /* IN */ ComputerName string,
 /* IN */ Force bool,
 /* IN */ PassThru bool,
 /* OUT */ cmdletOutput DAOtpAuthentication) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disable" , ComputerName, Force, PassThru)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAOtpAuthentication) Get( /* IN */ ComputerName string,
 /* OUT */ cmdletOutput DAOtpAuthentication) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , ComputerName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_DAOtpAuthentication) Set( /* IN */ ComputerName string,
 ...
 /* IN */ PassThru bool,
 /* IN */ SigningCertificateTemplateName string,
 /* OUT */ cmdletOutput DAOtpAuthentication) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , ComputerName, CertificateTemplateName, CAServer, UserSecurityGroupName, DisableTwoFactorBypass, PassThru, SigningCertificateTemplateName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
