...
type RouteInfo struct { 
	*cim.WmiInstance
	...
	func NewRouteInfoEx1(instance *cim.WmiInstance) (newInstance *RouteInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RouteInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
