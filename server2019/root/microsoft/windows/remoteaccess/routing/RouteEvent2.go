...
type RouteEvent2 struct { 
	*cim.WmiInstance
	...
	func NewRouteEvent2Ex1(instance *cim.WmiInstance) (newInstance *RouteEvent2, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RouteEvent2, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
