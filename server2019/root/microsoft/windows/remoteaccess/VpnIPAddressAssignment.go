...
type VpnIPAddressAssignment struct { 
	*cim.WmiInstance
	...
	func NewVpnIPAddressAssignmentEx1(instance *cim.WmiInstance) (newInstance *VpnIPAddressAssignment, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnIPAddressAssignment, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
