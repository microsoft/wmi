...
type DAEntryPointBase struct { 
	*cim.WmiInstance
	...
	func NewDAEntryPointBaseEx1(instance *cim.WmiInstance) (newInstance *DAEntryPointBase, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *DAEntryPointBase, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
