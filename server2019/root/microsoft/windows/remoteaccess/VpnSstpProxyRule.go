...
type VpnSstpProxyRule struct { 
	*cim.WmiInstance
	...
	func NewVpnSstpProxyRuleEx1(instance *cim.WmiInstance) (newInstance *VpnSstpProxyRule, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *VpnSstpProxyRule, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
