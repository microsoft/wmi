...
type MSFT_DeliveryOptimizationConfig struct { 
	*MSFT_DOBaseStatus
	...
	func NewMSFT_DeliveryOptimizationConfigEx1(instance *cim.WmiInstance) (newInstance *MSFT_DeliveryOptimizationConfig, err error) {tmp, err := NewMSFT_DOBaseStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DeliveryOptimizationConfig, err error) {tmp, err := NewMSFT_DOBaseStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_DeliveryOptimizationConfig) SetDownloadRateLimitBps( /* IN */ background bool,
 /* IN */ limitBps uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDownloadRateLimitBps" , background, limitBps);
	if err != nil { return }
...
func (instance *MSFT_DeliveryOptimizationConfig) SetDownloadRateLimitPct( /* IN */ background bool,
 /* IN */ limitPct uint8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDownloadRateLimitPct" , background, limitPct);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_DeliveryOptimizationConfig) SetDownloadMode( /* IN */ downloadMode DeliveryOptimizationConfig_downloadMode) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDownloadMode" , downloadMode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_DeliveryOptimizationConfig) SetUploadRateLimitPct( /* IN */ limitPct uint8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetUploadRateLimitPct" , limitPct);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_DeliveryOptimizationConfig) SetMonthlyUploadLimit( /* IN */ limitGB uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetMonthlyUploadLimit" , limitGB);
	if err != nil { return }
	result = uint32(retVal)
	return
