...
type MSFT_DODownloadUsage struct { 
	*MSFT_DOUsage
	...
	func NewMSFT_DODownloadUsageEx1(instance *cim.WmiInstance) (newInstance *MSFT_DODownloadUsage, err error) {tmp, err := NewMSFT_DOUsageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DODownloadUsage, err error) {tmp, err := NewMSFT_DOUsageEx6(hostName, wmiNamespace, userName, password, domainName, query)
