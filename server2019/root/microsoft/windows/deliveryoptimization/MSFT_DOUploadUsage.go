...
type MSFT_DOUploadUsage struct { 
	*MSFT_DOUsage
	...
	func NewMSFT_DOUploadUsageEx1(instance *cim.WmiInstance) (newInstance *MSFT_DOUploadUsage, err error) {tmp, err := NewMSFT_DOUsageEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DOUploadUsage, err error) {tmp, err := NewMSFT_DOUsageEx6(hostName, wmiNamespace, userName, password, domainName, query)
