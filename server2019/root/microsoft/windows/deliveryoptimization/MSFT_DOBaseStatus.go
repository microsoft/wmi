...
type MSFT_DOBaseStatus struct { 
	*cim.WmiInstance
	...
	func NewMSFT_DOBaseStatusEx1(instance *cim.WmiInstance) (newInstance *MSFT_DOBaseStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DOBaseStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
