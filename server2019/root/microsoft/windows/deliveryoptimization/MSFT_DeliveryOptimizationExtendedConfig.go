...
type MSFT_DeliveryOptimizationExtendedConfig struct { 
	*MSFT_DOBaseStatus
	...
	func NewMSFT_DeliveryOptimizationExtendedConfigEx1(instance *cim.WmiInstance) (newInstance *MSFT_DeliveryOptimizationExtendedConfig, err error) {tmp, err := NewMSFT_DOBaseStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DeliveryOptimizationExtendedConfig, err error) {tmp, err := NewMSFT_DOBaseStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
