...
type MSFT_DeliveryOptimizationFile struct { 
	*cim.WmiInstance
	...
	func NewMSFT_DeliveryOptimizationFileEx1(instance *cim.WmiInstance) (newInstance *MSFT_DeliveryOptimizationFile, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DeliveryOptimizationFile, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_DeliveryOptimizationFile) Delete( /* IN */ fileId string,
 /* IN */ deletePinned bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Delete" , fileId, deletePinned);
	if err != nil { return }
...
func (instance *MSFT_DeliveryOptimizationFile) SetPinned( /* IN */ fileId string,
 /* IN */ pinned bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPinned" , fileId, pinned);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_DeliveryOptimizationFile) SetExpiration( /* IN */ fileId string,
 /* IN */ expiration string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetExpiration" , fileId, expiration);
	if err != nil { return }
	result = uint32(retVal)
	return
