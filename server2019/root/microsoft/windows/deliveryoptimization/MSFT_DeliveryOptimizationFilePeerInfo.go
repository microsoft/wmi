...
type MSFT_DeliveryOptimizationFilePeerInfo struct { 
	*cim.WmiInstance
	...
	func NewMSFT_DeliveryOptimizationFilePeerInfoEx1(instance *cim.WmiInstance) (newInstance *MSFT_DeliveryOptimizationFilePeerInfo, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DeliveryOptimizationFilePeerInfo, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
