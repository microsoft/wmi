...
type MSFT_DOUsage struct { 
	*MSFT_DOBaseStatus
	...
	func NewMSFT_DOUsageEx1(instance *cim.WmiInstance) (newInstance *MSFT_DOUsage, err error) {tmp, err := NewMSFT_DOBaseStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DOUsage, err error) {tmp, err := NewMSFT_DOBaseStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
