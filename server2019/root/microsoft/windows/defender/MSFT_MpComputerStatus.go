...
type MSFT_MpComputerStatus struct { 
	*BaseStatus
	...
	func NewMSFT_MpComputerStatusEx1(instance *cim.WmiInstance) (newInstance *MSFT_MpComputerStatus, err error) {tmp, err := NewBaseStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MpComputerStatus, err error) {tmp, err := NewBaseStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
