...
type PS_GatewayTunnel struct { 
	*cim.WmiInstance
	...
	func NewPS_GatewayTunnelEx1(instance *cim.WmiInstance) (newInstance *PS_GatewayTunnel, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_GatewayTunnel, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_GatewayTunnel) Get( /* IN */ TunnelName string,
 ...
 /* OUT */ cmdletOutput []PS_GatewayTunnel) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , TunnelName, RoutingDomainName)
	if err != nil { return }
...
func (instance *PS_GatewayTunnel) Remove( /* IN */ TunnelName string,
 /* IN */ RoutingDomainName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Remove" , TunnelName, RoutingDomainName);
	if err != nil { return }
...
func (instance *PS_GatewayTunnel) Connect( /* IN */ TunnelName string,
 /* IN */ RoutingDomainName string,
 /* OUT */ cmdletOutput PS_GatewayTunnel) (result uint32, err error) {retVal, err := instance.InvokeMethod("Connect" , TunnelName, RoutingDomainName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *PS_GatewayTunnel) Disconnect( /* IN */ TunnelName string,
 /* IN */ RoutingDomainName string,
 /* OUT */ cmdletOutput PS_GatewayTunnel) (result uint32, err error) {retVal, err := instance.InvokeMethod("Disconnect" , TunnelName, RoutingDomainName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
