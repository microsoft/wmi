...
func NewPS_GatewayRoutingDomainEx1(instance *cim.WmiInstance) (newInstance *PS_GatewayRoutingDomain, err error) {
...
func NewPS_GatewayRoutingDomainEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *PS_GatewayRoutingDomain, err error) {
...
func (instance *PS_GatewayRoutingDomain) Get( /* IN */ Name string,
	/* OUT */ cmdletOutput []GatewayRoutingDomainConfiguration) (result uint32, err error) {
...
func (instance *PS_GatewayRoutingDomain) Enable( /* IN */ Name string,
	...
	/* OUT */ cmdletOutput GatewayRoutingDomainConfiguration) (result uint32, err error) {
	retVal, err := instance.InvokeMethod("Enable", Name, PassThru, Type, InterfaceName)
	if err != nil {
		return
	}
	retValue := retVal[0].(int32)
