...
type GatewayTunnelStatistics struct { 
	*cim.WmiInstance
	...
	func NewGatewayTunnelStatisticsEx1(instance *cim.WmiInstance) (newInstance *GatewayTunnelStatistics, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GatewayTunnelStatistics, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *GatewayTunnelStatistics) Get( /* IN */ TunnelName string,
 ...
 /* OUT */ cmdletOutput []GatewayTunnelStatistics) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , TunnelName, RoutingDomainName)
	if err != nil { return }
