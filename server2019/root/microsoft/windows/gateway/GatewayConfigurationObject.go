...
type GatewayConfigurationObject struct { 
	*cim.WmiInstance
	...
	func NewGatewayConfigurationObjectEx1(instance *cim.WmiInstance) (newInstance *GatewayConfigurationObject, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GatewayConfigurationObject, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
