...
type GatewayRoutingDomainConfiguration struct { 
	*cim.WmiInstance
	...
	func NewGatewayRoutingDomainConfigurationEx1(instance *cim.WmiInstance) (newInstance *GatewayRoutingDomainConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *GatewayRoutingDomainConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
