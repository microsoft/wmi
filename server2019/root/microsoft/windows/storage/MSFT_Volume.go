...
func (instance *MSFT_Volume) SetPropertyReFSDedupMode(value uint32) (err error) { 
    return instance.SetProperty("ReFSDedupMode", (value))
}

// GetReFSDedupMode gets the value of ReFSDedupMode for the instance
func (instance *MSFT_Volume) GetPropertyReFSDedupMode()(value uint32, err error) { 
...
func (instance *MSFT_Volume) Format( /* IN */ FileSystem string,
 ...
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Format" , FileSystem, FileSystemLabel, AllocationUnitSize, Full, Force, Compress, ShortFileNameSupport, SetIntegrityStreams, UseLargeFRS, DisableHeatGathering, IsDAX, NoTrim, DevDrive, SHA256Checksums, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_Volume) Repair( /* IN */ OfflineScanAndFix bool,
 ...
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Repair" , OfflineScanAndFix, Scan, SpotFix, DetectLeaks, ScratchFile, Threads, Triage, DirectoryIds, Salvage, ScratchDir, TargetFile, TargetDir, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_Volume) Optimize( /* IN */ ReTrim bool,
 ...
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Optimize" , ReTrim, Analyze, Defrag, SlabConsolidate, TierOptimize, NormalPriority, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_Volume) Resize( /* IN */ Size uint64,
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Resize" , Size, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
