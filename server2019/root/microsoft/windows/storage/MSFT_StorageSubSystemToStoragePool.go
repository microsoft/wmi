...
type MSFT_StorageSubSystemToStoragePool struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSubSystemToStoragePoolEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSubSystemToStoragePool, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSubSystemToStoragePool, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
