...
type MSFT_StoragePoolToResiliencySetting struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StoragePoolToResiliencySettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_StoragePoolToResiliencySetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StoragePoolToResiliencySetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
