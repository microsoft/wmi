...
type MSFT_StorageProvider struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_StorageProviderEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageProvider, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageProvider, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageProvider) Discover( /* IN */ DiscoveryLevel uint16,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Discover" , DiscoveryLevel, RootObject, RunAsJob)
	if err != nil { return }
...
func (instance *MSFT_StorageProvider) RegisterSubsystem( /* IN */ ComputerName string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RegisterSubsystem" , ComputerName, Credential)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageProvider) UnregisterSubsystem( /* IN */ Subsystem MSFT_StorageSubSystem,
 ...
 /* IN */ Force bool,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("UnregisterSubsystem" , Subsystem, StorageSubSystemUniqueId, Force)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageProvider) SetAttributes( /* IN */ RemoteSubsystemCacheMode uint16,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetAttributes" , RemoteSubsystemCacheMode)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
