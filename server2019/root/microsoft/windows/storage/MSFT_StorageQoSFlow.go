...
type MSFT_StorageQoSFlow struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageQoSFlowEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageQoSFlow, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageQoSFlow, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
