...
type MSFT_StorageQoSVolume struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageQoSVolumeEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageQoSVolume, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageQoSVolume, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
