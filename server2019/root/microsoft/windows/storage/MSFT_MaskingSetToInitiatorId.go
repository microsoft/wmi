...
type MSFT_MaskingSetToInitiatorId struct { 
	*cim.WmiInstance
	...
	func NewMSFT_MaskingSetToInitiatorIdEx1(instance *cim.WmiInstance) (newInstance *MSFT_MaskingSetToInitiatorId, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MaskingSetToInitiatorId, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
