...
type MSFT_SBLTargetDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SBLTargetDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_SBLTargetDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SBLTargetDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
