...
type MSFT_MaskingSet struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_MaskingSetEx1(instance *cim.WmiInstance) (newInstance *MSFT_MaskingSet, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MaskingSet, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_MaskingSet) AddInitiatorId( /* IN */ InitiatorIds []string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddInitiatorId" , InitiatorIds, HostType, RunAsJob)
	if err != nil { return }
...
func (instance *MSFT_MaskingSet) RemoveInitiatorId( /* IN */ InitiatorIds []string,
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveInitiatorId" , InitiatorIds, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) AddTargetPort( /* IN */ TargetPortAddresses []string,
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddTargetPort" , TargetPortAddresses, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) RemoveTargetPort( /* IN */ TargetPortAddresses []string,
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveTargetPort" , TargetPortAddresses, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) AddVirtualDisk( /* IN */ VirtualDiskNames []string,
 ...
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddVirtualDisk" , VirtualDiskNames, DeviceNumbers, DeviceAccesses, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) RemoveVirtualDisk( /* IN */ VirtualDiskNames []string,
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveVirtualDisk" , VirtualDiskNames, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
