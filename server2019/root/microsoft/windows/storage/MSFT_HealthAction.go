...
type MSFT_HealthAction struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_HealthActionEx1(instance *cim.WmiInstance) (newInstance *MSFT_HealthAction, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HealthAction, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
