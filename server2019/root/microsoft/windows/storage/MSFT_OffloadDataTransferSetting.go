...
type MSFT_OffloadDataTransferSetting struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_OffloadDataTransferSettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_OffloadDataTransferSetting, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_OffloadDataTransferSetting, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
