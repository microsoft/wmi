...
type MSFT_FileServerToFileShare struct { 
	*cim.WmiInstance
	...
	func NewMSFT_FileServerToFileShareEx1(instance *cim.WmiInstance) (newInstance *MSFT_FileServerToFileShare, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_FileServerToFileShare, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
