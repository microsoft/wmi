...
type MSFT_HealthRecord struct { 
	*cim.WmiInstance
	...
	func NewMSFT_HealthRecordEx1(instance *cim.WmiInstance) (newInstance *MSFT_HealthRecord, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HealthRecord, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
