...
type MSFT_HealthRecordReal64 struct { 
	*MSFT_HealthRecord
	...
	func NewMSFT_HealthRecordReal64Ex1(instance *cim.WmiInstance) (newInstance *MSFT_HealthRecordReal64, err error) {tmp, err := NewMSFT_HealthRecordEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HealthRecordReal64, err error) {tmp, err := NewMSFT_HealthRecordEx6(hostName, wmiNamespace, userName, password, domainName, query)
