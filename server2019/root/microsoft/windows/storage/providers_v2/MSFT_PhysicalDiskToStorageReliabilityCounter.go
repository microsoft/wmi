...
type MSFT_PhysicalDiskToStorageReliabilityCounter struct { 
	*cim.WmiInstance
	...
	func NewMSFT_PhysicalDiskToStorageReliabilityCounterEx1(instance *cim.WmiInstance) (newInstance *MSFT_PhysicalDiskToStorageReliabilityCounter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_PhysicalDiskToStorageReliabilityCounter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
