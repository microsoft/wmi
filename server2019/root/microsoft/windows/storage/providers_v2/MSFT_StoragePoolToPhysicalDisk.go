...
type MSFT_StoragePoolToPhysicalDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StoragePoolToPhysicalDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_StoragePoolToPhysicalDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StoragePoolToPhysicalDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
