...
type MSFT_ReplicationGroupToPartition struct { 
	*cim.WmiInstance
	...
	func NewMSFT_ReplicationGroupToPartitionEx1(instance *cim.WmiInstance) (newInstance *MSFT_ReplicationGroupToPartition, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_ReplicationGroupToPartition, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
