...
type MSFT_StorageHealthSetting struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageHealthSettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageHealthSetting, err error) {tmp, err := instance, nil
		
	if err != nil { return }
	newInstance = &MSFT_StorageHealthSetting {
	WmiInstance: tmp,
	}
	return
	}
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageHealthSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
