...
func (instance *MSFT_MaskingSet) AddInitiatorId( /* IN */ InitiatorIds []string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddInitiatorId" , InitiatorIds, HostType)
	if err != nil { return }
...
func (instance *MSFT_MaskingSet) RemoveInitiatorId( /* IN */ InitiatorIds []string,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveInitiatorId" , InitiatorIds)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) AddTargetPort( /* IN */ TargetPortAddresses []string,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddTargetPort" , TargetPortAddresses)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) RemoveTargetPort( /* IN */ TargetPortAddresses []string,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveTargetPort" , TargetPortAddresses)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) AddVirtualDisk( /* IN */ VirtualDiskNames []string,
 ...
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("AddVirtualDisk" , VirtualDiskNames, DeviceNumbers, DeviceAccesses)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_MaskingSet) RemoveVirtualDisk( /* IN */ VirtualDiskNames []string,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveVirtualDisk" , VirtualDiskNames)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
