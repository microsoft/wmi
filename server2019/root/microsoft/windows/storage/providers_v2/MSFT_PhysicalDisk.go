...
type MSFT_PhysicalDisk struct { 
	*MSFT_StorageFaultDomain
	...
	func NewMSFT_PhysicalDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_PhysicalDisk, err error) {tmp, err := NewMSFT_StorageFaultDomainEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_PhysicalDisk, err error) {tmp, err := NewMSFT_StorageFaultDomainEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_PhysicalDisk) Maintenance( /* IN */ EnableIndication bool,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Maintenance" , EnableIndication)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) Maintenance2( /* IN */ EnableIndication bool,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Maintenance2" , EnableIndication, ValidateMaintenanceMode, EnableMaintenanceMode, Timeout, IgnoreDetachedVirtualDisks)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ExtendedStatus" type="MSFT_StorageExtendedStatus ">ExtendedStatus allows the storage provider to return extended (implementation specific) error information.</param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_PhysicalDisk) Reset( /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Reset" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) SetUsage( /* IN */ Usage PhysicalDisk_Usage,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetUsage" , Usage)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) SetAttributes( /* IN */ MediaType PhysicalDisk_MediaType,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetAttributes" , MediaType)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) SetAttributes2( /* IN */ MediaType uint16,
 ...
 /* IN */ IsHidden bool,
 /* OUT */ ExtendedStatus string) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetAttributes2" , MediaType, StorageEnclosureId, StorageScaleUnitId, IsHidden)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) IsDeviceCacheEnabled( /* OUT */ IsDeviceCacheEnabled bool,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("IsDeviceCacheEnabled" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) IsPowerProtected( /* OUT */ IsPowerProtected bool,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("IsPowerProtected" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) GetFirmwareInformation( /* OUT */ SupportsUpdate bool,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetFirmwareInformation" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) UpdateFirmware( /* IN */ ImagePath string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("UpdateFirmware" , ImagePath, SlotNumber)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_PhysicalDisk) Convert( /* IN */ Format uint16,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Convert" , Format, StoragePoolFriendlyName, StoragePoolVersion, StoragePoolMetadataLength, StoragePoolMinimumAllocationSize, VirtualDiskFriendlyName, VirtualDiskProvisioningType, VirtualDiskAllocationUnitSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
