...
func (instance *MSFT_StorageTier) SetAttributes2( /* IN */ ProvisioningType uint16,
 ...
 /* OUT */ ExtendedStatus string) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetAttributes2" , ProvisioningType, MediaType, FaultDomainAwareness, ColumnIsolation, ResiliencySettingName, PhysicalDiskRedundancy, NumberOfDataCopies, NumberOfGroups, NumberOfColumns, Interleave)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageTier) SetAttributes3( /* IN */ ProvisioningType uint16,
 ...
 /* IN */ NumberOfColumns uint16,
 /* IN */ Interleave uint64,
 /* OUT */ ExtendedStatus string) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetAttributes3" , ProvisioningType, AllocationUnitSize, MediaType, FaultDomainAwareness, ColumnIsolation, ResiliencySettingName, Usage, PhysicalDiskRedundancy, NumberOfDataCopies, NumberOfGroups, NumberOfColumns, Interleave)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
