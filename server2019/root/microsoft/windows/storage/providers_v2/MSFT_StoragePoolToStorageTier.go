...
type MSFT_StoragePoolToStorageTier struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StoragePoolToStorageTierEx1(instance *cim.WmiInstance) (newInstance *MSFT_StoragePoolToStorageTier, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StoragePoolToStorageTier, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
