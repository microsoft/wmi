...
type MSFT_VirtualDiskToPhysicalDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_VirtualDiskToPhysicalDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_VirtualDiskToPhysicalDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VirtualDiskToPhysicalDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
