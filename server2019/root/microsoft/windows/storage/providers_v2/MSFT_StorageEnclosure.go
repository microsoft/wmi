...
type MSFT_StorageEnclosure struct { 
	*MSFT_StorageFaultDomain
	...
	func NewMSFT_StorageEnclosureEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageEnclosure, err error) {tmp, err := NewMSFT_StorageFaultDomainEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageEnclosure, err error) {tmp, err := NewMSFT_StorageFaultDomainEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageEnclosure) IdentifyElement( /* IN */ Enable bool,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("IdentifyElement" , Enable, SlotNumbers)
	if err != nil { return }
...
func (instance *MSFT_StorageEnclosure) GetVendorData( /* IN */ PageNumber uint16,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetVendorData" , PageNumber)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageEnclosure) Maintenance( /* IN */ ValidateMaintenanceMode bool,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Maintenance" , ValidateMaintenanceMode, EnableMaintenanceMode, Timeout, Model, Manufacturer, IgnoreDetachedVirtualDisks)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageEnclosure) PowerElement( /* IN */ Off bool,
 /* IN */ SlotNumbers []uint32,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("PowerElement" , Off, SlotNumbers)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
