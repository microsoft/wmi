...
type SPACES_StorageJob struct { 
	*MSFT_StorageJob
	...
	func NewSPACES_StorageJobEx1(instance *cim.WmiInstance) (newInstance *SPACES_StorageJob, err error) {tmp, err := NewMSFT_StorageJobEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SPACES_StorageJob, err error) {tmp, err := NewMSFT_StorageJobEx6(hostName, wmiNamespace, userName, password, domainName, query)
