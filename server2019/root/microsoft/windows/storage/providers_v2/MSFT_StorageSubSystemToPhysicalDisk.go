...
type MSFT_StorageSubSystemToPhysicalDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSubSystemToPhysicalDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSubSystemToPhysicalDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSubSystemToPhysicalDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
