...
type MSFT_Volume_Repair_AsyncOutput struct { 
	*MSFT_StorageJobOutParams
	...
	func NewMSFT_Volume_Repair_AsyncOutputEx1(instance *cim.WmiInstance) (newInstance *MSFT_Volume_Repair_AsyncOutput, err error) {tmp, err := NewMSFT_StorageJobOutParamsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_Volume_Repair_AsyncOutput, err error) {tmp, err := NewMSFT_StorageJobOutParamsEx6(hostName, wmiNamespace, userName, password, domainName, query)
