...
type MSFT_StorageAlertEvent struct { 
	*MSFT_StorageEvent
	...
	func NewMSFT_StorageAlertEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageAlertEvent, err error) {tmp, err := NewMSFT_StorageEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageAlertEvent, err error) {tmp, err := NewMSFT_StorageEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
