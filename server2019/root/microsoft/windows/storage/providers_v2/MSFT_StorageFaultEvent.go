...
type MSFT_StorageFaultEvent struct { 
	*MSFT_StorageEvent
	...
	func NewMSFT_StorageFaultEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageFaultEvent, err error) {tmp, err := NewMSFT_StorageEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageFaultEvent, err error) {tmp, err := NewMSFT_StorageEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageFaultEvent) GetPropertyChangeType()(value StorageFaultEvent_ChangeType, err error) { 
    ...
    value = StorageFaultEvent_ChangeType(valuetmp)
