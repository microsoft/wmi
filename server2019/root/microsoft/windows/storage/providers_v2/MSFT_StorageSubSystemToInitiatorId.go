...
type MSFT_StorageSubSystemToInitiatorId struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSubSystemToInitiatorIdEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSubSystemToInitiatorId, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSubSystemToInitiatorId, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
