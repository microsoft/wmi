...
type MSFT_StorageSubSystemToDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSubSystemToDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSubSystemToDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSubSystemToDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
