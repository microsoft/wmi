...
type MSFT_StoragePool struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_StoragePoolEx1(instance *cim.WmiInstance) (newInstance *MSFT_StoragePool, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StoragePool, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StoragePool) GetPropertyFaultDomainAwarenessDefault()(value StoragePool_FaultDomainAwarenessDefault, err error) { 
    ...
    value = StoragePool_FaultDomainAwarenessDefault(valuetmp)
...
func (instance *MSFT_StoragePool) GetPropertyHealthStatus()(value StoragePool_HealthStatus, err error) { 
    ...
    value = StoragePool_HealthStatus(valuetmp)
...
func (instance *MSFT_StoragePool) GetPropertyOperationalStatus()(value []StoragePool_OperationalStatus, err error) { 
    ...
    for _, interfaceValue := range retValue.([]interface{}) {
        ...
        value = append(value, StoragePool_OperationalStatus(valuetmp))
    }
...
func (instance *MSFT_StoragePool) GetPropertyProvisioningTypeDefault()(value StoragePool_ProvisioningTypeDefault, err error) { 
    ...
    value = StoragePool_ProvisioningTypeDefault(valuetmp)
...
func (instance *MSFT_StoragePool) GetPropertyReadOnlyReason()(value StoragePool_ReadOnlyReason, err error) { 
    ...
    value = StoragePool_ReadOnlyReason(valuetmp)
...
func (instance *MSFT_StoragePool) GetPropertyRepairPolicy()(value StoragePool_RepairPolicy, err error) { 
    ...
    value = StoragePool_RepairPolicy(valuetmp)
...
func (instance *MSFT_StoragePool) GetPropertyRetireMissingPhysicalDisks()(value StoragePool_RetireMissingPhysicalDisks, err error) { 
    ...
    value = StoragePool_RetireMissingPhysicalDisks(valuetmp)
...
func (instance *MSFT_StoragePool) GetPropertySupportedProvisioningTypes()(value []StoragePool_SupportedProvisioningTypes, err error) { 
    ...
    for _, interfaceValue := range retValue.([]interface{}) {
        ...
        value = append(value, StoragePool_SupportedProvisioningTypes(valuetmp))
    }
...
func (instance *MSFT_StoragePool) GetPropertyUsage()(value StoragePool_Usage, err error) { 
    ...
    value = StoragePool_Usage(valuetmp)
...
func (instance *MSFT_StoragePool) GetPropertyVersion()(value StoragePool_Version, err error) { 
    ...
    value = StoragePool_Version(valuetmp)
...
func (instance *MSFT_StoragePool) CreateVirtualDisk( /* IN */ FriendlyName string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateVirtualDisk" , FriendlyName, Size, UseMaximumSize, ProvisioningType, ResiliencySettingName, Usage, OtherUsageDescription, NumberOfDataCopies, PhysicalDiskRedundancy, NumberOfColumns, AutoNumberOfColumns, Interleave, IsEnclosureAware, PhysicalDisksToUse, StorageTiers, StorageTierSizes, WriteCacheSize, AutoWriteCacheSize)
	if err != nil { return }
...
func (instance *MSFT_StoragePool) CreateVirtualDisk2( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedVirtualDisk MSFT_VirtualDisk,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateVirtualDisk2" , FriendlyName, Size, UseMaximumSize, ProvisioningType, AllocationUnitSize, MediaType, ResiliencySettingName, Usage, OtherUsageDescription, NumberOfDataCopies, PhysicalDiskRedundancy, NumberOfColumns, AutoNumberOfColumns, Interleave, NumberOfGroups, FaultDomainAwareness, ColumnIsolation, PhysicalDisksToUse, StorageTiers, StorageTierSizes, WriteCacheSize, AutoWriteCacheSize, ReadCacheSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) CreateVirtualDisk3( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedVirtualDisk MSFT_VirtualDisk,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateVirtualDisk3" , FriendlyName, Size, UseMaximumSize, ProvisioningType, AllocationUnitSize, MediaType, ResiliencySettingName, Usage, OtherUsageDescription, NumberOfDataCopies, PhysicalDiskRedundancy, NumberOfColumns, AutoNumberOfColumns, Interleave, NumberOfGroups, FaultDomainAwareness, ColumnIsolation, MinimumLogicalDataCopies, StorageFaultDomainsToUse, StorageTiers, StorageTierSizes, WriteCacheSize, AutoWriteCacheSize, WriteCacheReserveSize, ReadCacheSize, TrackValidData, IsManualAttach, AddToCluster)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) CreateVolume( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateVolume" , FriendlyName, Size, StorageTiers, StorageTierSizes, ProvisioningType, ResiliencySettingName, PhysicalDiskRedundancy, NumberOfColumns, FileSystem, AccessPath, FileServer)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) CreateVolume2( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedVolume MSFT_Volume,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateVolume2" , FriendlyName, Size, StorageTiers, StorageTierSizes, ProvisioningType, ResiliencySettingName, PhysicalDiskRedundancy, NumberOfColumns, FileSystem, AccessPath, AllocationUnitSize, ReadCacheSize, FileServer)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) CreateStorageTier( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateStorageTier" , FriendlyName, MediaType, Description)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) CreateStorageTier2( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedStorageTier MSFT_StorageTier,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateStorageTier2" , FriendlyName, ProvisioningType, MediaType, FaultDomainAwareness, ColumnIsolation, ResiliencySettingName, Interleave, NumberOfDataCopies, NumberOfGroups, NumberOfColumns, PhysicalDiskRedundancy, Description)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) CreateStorageTier3( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedStorageTier MSFT_StorageTier,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateStorageTier3" , FriendlyName, ProvisioningType, AllocationUnitSize, MediaType, FaultDomainAwareness, ColumnIsolation, StorageFaultDomainsToUse, ResiliencySettingName, Usage, Interleave, NumberOfDataCopies, NumberOfGroups, NumberOfColumns, PhysicalDiskRedundancy, Description)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ExtendedStatus" type="MSFT_StorageExtendedStatus ">ExtendedStatus allows the storage provider to return extended (implementation specific) error information.</param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_StoragePool) Upgrade( /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Upgrade" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) Optimize( /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Optimize" , RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) GetSupportedSize( /* IN */ ResiliencySettingName string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSupportedSize" , ResiliencySettingName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) GetSupportedSize2( /* IN */ ResiliencySettingName string,
 ...
 /* OUT */ VirtualDiskSizeMax uint64,
 /* OUT */ VirtualDiskSizeDivisor uint64,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSupportedSize2" , ResiliencySettingName, FaultDomainAwareness)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) SetDefaults( /* IN */ ProvisioningTypeDefault StoragePool_ProvisioningTypeDefault,
 ...
 /* IN */ AutoWriteCacheSize bool,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetDefaults" , ProvisioningTypeDefault, ResiliencySettingNameDefault, EnclosureAwareDefault, WriteCacheSizeDefault, AutoWriteCacheSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) SetDefaults2( /* IN */ ProvisioningTypeDefault uint16,
 ...
 /* IN */ WriteCacheSizeDefault uint64,
 /* IN */ AutoWriteCacheSize bool,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetDefaults2" , ProvisioningTypeDefault, MediaTypeDefault, ResiliencySettingNameDefault, FaultDomainAwarenessDefault, WriteCacheSizeDefault, AutoWriteCacheSize)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StoragePool) SetAttributes( /* IN */ IsReadOnly bool,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetAttributes" , IsReadOnly, ClearOnDeallocate, IsPowerProtected, RepairPolicy, RetireMissingPhysicalDisks, ThinProvisioningAlertThresholds)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
