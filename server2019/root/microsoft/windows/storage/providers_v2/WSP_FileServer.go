...
type WSP_FileServer struct { 
	*MSFT_FileServer
	...
	func NewWSP_FileServerEx1(instance *cim.WmiInstance) (newInstance *WSP_FileServer, err error) {tmp, err := NewMSFT_FileServerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *WSP_FileServer, err error) {tmp, err := NewMSFT_FileServerEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *WSP_FileServer) CreateFileServer( /* IN */ StorageSubSystemId string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateFileServer" , StorageSubSystemId, FriendlyName, FileSharingProtocols, HostNames)
	if err != nil { return }
