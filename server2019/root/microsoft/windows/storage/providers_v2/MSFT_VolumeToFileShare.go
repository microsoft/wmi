...
type MSFT_VolumeToFileShare struct { 
	*cim.WmiInstance
	...
	func NewMSFT_VolumeToFileShareEx1(instance *cim.WmiInstance) (newInstance *MSFT_VolumeToFileShare, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VolumeToFileShare, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
