...
type MSFT_StorageJob struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_StorageJobEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageJob, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageJob, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageJob) RequestStateChange( /* IN */ RequestedState StorageJob_RequestedState,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RequestStateChange" , RequestedState)
	if err != nil { return }
...
// <param name="ExtendedStatus" type="MSFT_StorageExtendedStatus "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_StorageJob) GetExtendedStatus( /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetExtendedStatus" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageJob) GetMessages( /* OUT */ Channels []uint16,
 /* OUT */ Messages []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetMessages" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_StorageJob) GetOutParameters( /* OUT */ OutParameters MSFT_StorageJobOutParams) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetOutParameters" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
