...
type MSFT_StorageNodeToStoragePool struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageNodeToStoragePoolEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageNodeToStoragePool, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageNodeToStoragePool, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
