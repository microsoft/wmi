...
type MSFT_StorageQoSPolicyStore struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageQoSPolicyStoreEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageQoSPolicyStore, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageQoSPolicyStore, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageQoSPolicyStore) CreatePolicy( /* IN/OUT */ Policy MSFT_StorageQoSPolicy) (result int32, err error) {retVal, err := instance.InvokeMethod("CreatePolicy" )
	if err != nil { return }
...
// <param name="ReturnValue" type="int32 "></param>
func (instance *MSFT_StorageQoSPolicyStore) SetAttributes( /* IN */ IOPSNormalizationSize uint32) (result int32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetAttributes" , IOPSNormalizationSize);
	if err != nil { return }
	result = int32(retVal)
	return
