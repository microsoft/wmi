...
type MSFT_StorageQoSPolicy struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageQoSPolicyEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageQoSPolicy, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageQoSPolicy, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageQoSPolicy) SetAttributes( /* IN */ NewName string,
 ...
 /* IN */ BandwidthLimit uint64) (result int32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetAttributes" , NewName, Limit, Reservation, BandwidthLimit);
	if err != nil { return }
	result = int32(retVal)
	return
...
// <param name="ReturnValue" type="int32 "></param>
func (instance *MSFT_StorageQoSPolicy) DeletePolicy() (result int32, err error) {retVal, err := instance.InvokeMethodWithReturn("DeletePolicy" );
	if err != nil { return }
	result = int32(retVal)
	return
