...
type MSFT_iSCSIConnectionToiSCSITargetPortal struct { 
	*cim.WmiInstance
	...
	func NewMSFT_iSCSIConnectionToiSCSITargetPortalEx1(instance *cim.WmiInstance) (newInstance *MSFT_iSCSIConnectionToiSCSITargetPortal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_iSCSIConnectionToiSCSITargetPortal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
