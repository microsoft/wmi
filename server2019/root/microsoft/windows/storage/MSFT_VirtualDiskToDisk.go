...
type MSFT_VirtualDiskToDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_VirtualDiskToDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_VirtualDiskToDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VirtualDiskToDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
