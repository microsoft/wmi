...
type MSFT_VirtualDiskToReplicaPeer struct { 
	*MSFT_Synchronized
	...
	func NewMSFT_VirtualDiskToReplicaPeerEx1(instance *cim.WmiInstance) (newInstance *MSFT_VirtualDiskToReplicaPeer, err error) {tmp, err := NewMSFT_SynchronizedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VirtualDiskToReplicaPeer, err error) {tmp, err := NewMSFT_SynchronizedEx6(hostName, wmiNamespace, userName, password, domainName, query)
