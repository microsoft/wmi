...
type MSFT_StorageSetting struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSettingEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageSetting) Get( /* OUT */ StorageSetting MSFT_StorageSetting) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" )
	if err != nil { return }
...
func (instance *MSFT_StorageSetting) Set( /* IN */ NewDiskPolicy uint16,
 /* IN */ ScrubPolicy uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Set" , NewDiskPolicy, ScrubPolicy);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_StorageSetting) UpdateHostStorageCache() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("UpdateHostStorageCache" );
	if err != nil { return }
	result = uint32(retVal)
	return
