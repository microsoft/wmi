...
type MSFT_iSCSITargetPortal struct { 
	*cim.WmiInstance
	...
	func NewMSFT_iSCSITargetPortalEx1(instance *cim.WmiInstance) (newInstance *MSFT_iSCSITargetPortal, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_iSCSITargetPortal, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_iSCSITargetPortal) New( /* IN */ TargetPortalAddress string,
 ...
 /* OUT */ CreatedTargetPortal MSFT_iSCSITargetPortal) (result uint32, err error) {retVal, err := instance.InvokeMethod("New" , TargetPortalAddress, TargetPortalPortNumber, InitiatorInstanceName, InitiatorPortalAddress, AuthenticationType, ChapUsername, ChapSecret, IsHeaderDigest, IsDataDigest)
	if err != nil { return }
...
func (instance *MSFT_iSCSITargetPortal) Remove( /* IN */ InitiatorInstanceName string,
 /* IN */ InitiatorPortalAddress string,
 /* IN */ TargetPortalPortNumber uint16,
 /* IN */ TargetPortalAddress string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Remove" , InitiatorInstanceName, InitiatorPortalAddress, TargetPortalPortNumber, TargetPortalAddress);
	if err != nil { return }
...
func (instance *MSFT_iSCSITargetPortal) Update( /* IN */ InitiatorInstanceName string,
 ...
 /* IN */ TargetPortalPortNumber uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Update" , InitiatorInstanceName, InitiatorPortalAddress, TargetPortalAddress, TargetPortalPortNumber);
	if err != nil { return }
	result = uint32(retVal)
	return
