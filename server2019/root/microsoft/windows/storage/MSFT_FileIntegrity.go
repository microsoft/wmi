...
type MSFT_FileIntegrity struct { 
	*cim.WmiInstance
	...
	func NewMSFT_FileIntegrityEx1(instance *cim.WmiInstance) (newInstance *MSFT_FileIntegrity, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_FileIntegrity, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_FileIntegrity) Get( /* IN */ FileName string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , FileName)
	if err != nil { return }
...
func (instance *MSFT_FileIntegrity) Repair( /* IN */ FileName string,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Repair" , FileName)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_FileIntegrity) Set( /* IN */ FileName string,
 /* IN */ Enable bool,
 /* IN */ Enforce bool,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Set" , FileName, Enable, Enforce)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
