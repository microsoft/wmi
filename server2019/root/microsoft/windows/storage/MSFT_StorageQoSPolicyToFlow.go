...
type MSFT_StorageQoSPolicyToFlow struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageQoSPolicyToFlowEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageQoSPolicyToFlow, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageQoSPolicyToFlow, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
