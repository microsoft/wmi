...
type MSFT_StorageHealthStatusChangeEvent struct { 
	*MSFT_StorageEvent
	...
	func NewMSFT_StorageHealthStatusChangeEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageHealthStatusChangeEvent, err error) {tmp, err := NewMSFT_StorageEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageHealthStatusChangeEvent, err error) {tmp, err := NewMSFT_StorageEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
