...
func (instance *MSFT_StorageSubSystem) CreateStoragePool( /* IN */ FriendlyName string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateStoragePool" , FriendlyName, Usage, OtherUsageDescription, PhysicalDisks, ResiliencySettingNameDefault, ProvisioningTypeDefault, MediaTypeDefault, LogicalSectorSizeDefault, MetadataLength, MinimumAllocationSize, EnclosureAwareDefault, FaultDomainAwarenessDefault, WriteCacheSizeDefault, AutoWriteCacheSize, Version, RunAsJob)
	if err != nil { return }
...
func (instance *MSFT_StorageSubSystem) CreateMaskingSet( /* IN */ FriendlyName string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateMaskingSet" , FriendlyName, VirtualDiskNames, DeviceAccesses, DeviceNumbers, TargetPortAddresses, InitiatorAddresses, HostType, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageSubSystem) SetAttributes( /* IN */ AutomaticClusteringEnabled bool,
 ...
 /* IN */ FaultDomainAwarenessDefault uint16,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetAttributes" , AutomaticClusteringEnabled, VirtualDiskRepairEnabled, VirtualDiskRepairQueueDepth, FaultDomainAwarenessDefault)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageSubSystem) DeleteReplicationRelationship( /* IN */ SourceReplicationGroup MSFT_ReplicationGroup,
 ...
 /* IN */ RunAsJob bool,
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("DeleteReplicationRelationship" , SourceReplicationGroup, TargetGroupReplicaPeer, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageSubSystem) CreateReplicationGroup( /* IN */ FriendlyName string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateReplicationGroup" , FriendlyName, Description, StorageElements, ReplicationSettings, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageSubSystem) CreateFileServer( /* IN */ FriendlyName string,
 ...
 /* OUT */ CreatedStorageJob MSFT_StorageJob,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("CreateFileServer" , FriendlyName, FileSharingProtocols, HostNames, RunAsJob)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
