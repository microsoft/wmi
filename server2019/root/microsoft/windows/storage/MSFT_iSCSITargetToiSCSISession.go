...
type MSFT_iSCSITargetToiSCSISession struct { 
	*cim.WmiInstance
	...
	func NewMSFT_iSCSITargetToiSCSISessionEx1(instance *cim.WmiInstance) (newInstance *MSFT_iSCSITargetToiSCSISession, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_iSCSITargetToiSCSISession, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
