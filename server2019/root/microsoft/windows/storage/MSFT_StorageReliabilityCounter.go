...
type MSFT_StorageReliabilityCounter struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_StorageReliabilityCounterEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageReliabilityCounter, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageReliabilityCounter, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageReliabilityCounter) Reset() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Reset" );
	if err != nil { return }
