...
type MSFT_StorageScaleUnit struct { 
	*MSFT_StorageFaultDomain
	...
	func NewMSFT_StorageScaleUnitEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageScaleUnit, err error) {tmp, err := NewMSFT_StorageFaultDomainEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageScaleUnit, err error) {tmp, err := NewMSFT_StorageFaultDomainEx6(hostName, wmiNamespace, userName, password, domainName, query)
