...
type MSFT_StorageHealth struct { 
	*MSFT_StorageObject
	...
	func NewMSFT_StorageHealthEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageHealth, err error) {tmp, err := NewMSFT_StorageObjectEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageHealth, err error) {tmp, err := NewMSFT_StorageObjectEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_StorageHealth) GetSetting( /* IN */ Name string,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSetting" , Name)
	if err != nil { return }
...
func (instance *MSFT_StorageHealth) SetSetting( /* IN */ Name string,
 /* IN */ Value string,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("SetSetting" , Name, Value)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageHealth) RemoveSetting( /* IN */ Name string,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveSetting" , Name)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageHealth) GetReport( /* IN */ TargetObject MSFT_StorageObject,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetReport" , TargetObject, Count)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageHealth) Maintenance( /* IN */ TargetObject MSFT_StorageFaultDomain,
 ...
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("Maintenance" , TargetObject, ValidateMaintenanceMode, EnableMaintenanceMode, IgnoreDetachedVirtualDisks, Timeout, Model, Manufacturer, ValidationFlags)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_StorageHealth) RemoveIntent( /* IN */ TargetObject MSFT_StorageObject,
 /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("RemoveIntent" , TargetObject)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
