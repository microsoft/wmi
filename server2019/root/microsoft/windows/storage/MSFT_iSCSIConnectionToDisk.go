...
type MSFT_iSCSIConnectionToDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_iSCSIConnectionToDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_iSCSIConnectionToDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_iSCSIConnectionToDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
