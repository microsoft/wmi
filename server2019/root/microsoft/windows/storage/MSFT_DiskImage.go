...
type MSFT_DiskImage struct { 
	*cim.WmiInstance
	...
	func NewMSFT_DiskImageEx1(instance *cim.WmiInstance) (newInstance *MSFT_DiskImage, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DiskImage, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_DiskImage) Mount( /* IN */ Access uint16,
 ...
 /* OUT */ DiskImage MSFT_DiskImage) (result uint32, err error) {retVal, err := instance.InvokeMethod("Mount" , Access, NoDriveLetter)
	if err != nil { return }
...
// <param name="DiskImage" type="MSFT_DiskImage "></param>
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_DiskImage) Dismount( /* OUT */ DiskImage MSFT_DiskImage) (result uint32, err error) {retVal, err := instance.InvokeMethod("Dismount" )
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
