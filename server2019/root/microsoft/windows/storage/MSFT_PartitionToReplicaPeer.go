...
type MSFT_PartitionToReplicaPeer struct { 
	*MSFT_Synchronized
	...
	func NewMSFT_PartitionToReplicaPeerEx1(instance *cim.WmiInstance) (newInstance *MSFT_PartitionToReplicaPeer, err error) {tmp, err := NewMSFT_SynchronizedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_PartitionToReplicaPeer, err error) {tmp, err := NewMSFT_SynchronizedEx6(hostName, wmiNamespace, userName, password, domainName, query)
