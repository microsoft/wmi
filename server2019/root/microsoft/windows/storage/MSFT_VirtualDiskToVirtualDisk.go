...
type MSFT_VirtualDiskToVirtualDisk struct { 
	*MSFT_Synchronized
	...
	func NewMSFT_VirtualDiskToVirtualDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_VirtualDiskToVirtualDisk, err error) {tmp, err := NewMSFT_SynchronizedEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VirtualDiskToVirtualDisk, err error) {tmp, err := NewMSFT_SynchronizedEx6(hostName, wmiNamespace, userName, password, domainName, query)
