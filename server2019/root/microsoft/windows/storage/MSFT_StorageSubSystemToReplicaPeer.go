...
type MSFT_StorageSubSystemToReplicaPeer struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSubSystemToReplicaPeerEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSubSystemToReplicaPeer, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSubSystemToReplicaPeer, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
