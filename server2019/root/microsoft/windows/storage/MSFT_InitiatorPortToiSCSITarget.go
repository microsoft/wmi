...
type MSFT_InitiatorPortToiSCSITarget struct { 
	*cim.WmiInstance
	...
	func NewMSFT_InitiatorPortToiSCSITargetEx1(instance *cim.WmiInstance) (newInstance *MSFT_InitiatorPortToiSCSITarget, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_InitiatorPortToiSCSITarget, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
