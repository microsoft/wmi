...
type MSFT_FileStorageTier struct { 
	*cim.WmiInstance
	...
	func NewMSFT_FileStorageTierEx1(instance *cim.WmiInstance) (newInstance *MSFT_FileStorageTier, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_FileStorageTier, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_FileStorageTier) Get( /* IN */ FilePath string,
 ...
 /* OUT */ FileStorageTier []MSFT_FileStorageTier) (result uint32, err error) {retVal, err := instance.InvokeMethod("Get" , FilePath, VolumeDriveLetter, VolumePath, Volume, PinnedState, PinnedStorageTierClass, AllocatedStorageTierClass)
	if err != nil { return }
...
func (instance *MSFT_FileStorageTier) Set( /* IN */ FilePath string,
 ...
 /* IN */ DesiredStorageTier MSFT_StorageTier) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Set" , FilePath, DesiredStorageTierFriendlyName, DesiredStorageTierUniqueId, DesiredStorageTierClass, DesiredStorageTier);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_FileStorageTier) Clear( /* IN */ FilePath string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Clear" , FilePath);
	if err != nil { return }
	result = uint32(retVal)
	return
