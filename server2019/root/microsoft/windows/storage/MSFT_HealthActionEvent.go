...
type MSFT_HealthActionEvent struct { 
	*MSFT_StorageEvent
	...
	func NewMSFT_HealthActionEventEx1(instance *cim.WmiInstance) (newInstance *MSFT_HealthActionEvent, err error) {tmp, err := NewMSFT_StorageEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_HealthActionEvent, err error) {tmp, err := NewMSFT_StorageEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
