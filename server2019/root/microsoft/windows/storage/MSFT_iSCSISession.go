...
type MSFT_iSCSISession struct { 
	*cim.WmiInstance
	...
	func NewMSFT_iSCSISessionEx1(instance *cim.WmiInstance) (newInstance *MSFT_iSCSISession, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_iSCSISession, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_iSCSISession) Register( /* IN */ IsMultipathEnabled bool,
 ...
 /* IN */ ChapSecret string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Register" , IsMultipathEnabled, ChapUsername, ChapSecret);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_iSCSISession) Unregister() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Unregister" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_iSCSISession) SetCHAPSecret( /* IN */ ChapSecret string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetCHAPSecret" , ChapSecret);
	if err != nil { return }
	result = uint32(retVal)
	return
