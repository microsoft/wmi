...
type MSFT_SBLTargetCacheConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SBLTargetCacheConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_SBLTargetCacheConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SBLTargetCacheConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SBLTargetCacheConfiguration) NotifyDisk( /* IN */ DiskGuid string,
 ...
 /* IN */ EnclosureId string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("NotifyDisk" , DiskGuid, PoolId, Name, Description, Manufacturer, ProductId, Serial, SlotNumber, EnclosureId);
	if err != nil { return }
...
func (instance *MSFT_SBLTargetCacheConfiguration) NotifyEnclosure( /* IN */ EnclosureGuid string,
 ...
 /* IN */ Manufacturer string,
 /* IN */ ProductId string,
 /* IN */ Serial string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("NotifyEnclosure" , EnclosureGuid, Name, Description, Manufacturer, ProductId, Serial);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_SBLTargetCacheConfiguration) NotifyDiskStateChange( /* IN */ DiskGuid string,
 /* IN */ StateChange uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("NotifyDiskStateChange" , DiskGuid, StateChange);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_SBLTargetCacheConfiguration) SetDiskUsage( /* IN */ DiskGuid string,
 /* IN */ UseForStorageSpacesDirect uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDiskUsage" , DiskGuid, UseForStorageSpacesDirect);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_SBLTargetCacheConfiguration) StartOptimize( /* IN */ Flags uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("StartOptimize" , Flags);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_SBLTargetCacheConfiguration) CheckSystemSupportsCacheState( /* IN */ CacheState uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CheckSystemSupportsCacheState" , CacheState);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_SBLTargetCacheConfiguration) CheckDiskSupportsCacheState( /* IN */ DiskGuid string,
 /* IN */ CacheState uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("CheckDiskSupportsCacheState" , DiskGuid, CacheState);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_SBLTargetCacheConfiguration) CheckAllDisksSupportCache( /* IN */ CacheState uint32,
 ...
 /* OUT */ SupportStatuses []uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("CheckAllDisksSupportCache" , CacheState)
	if err != nil { return }
...
func (instance *MSFT_SBLTargetCacheConfiguration) QueryBoundDevices( /* IN */ DiskGuid string,
 /* OUT */ BoundDiskGuids []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("QueryBoundDevices" , DiskGuid)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *MSFT_SBLTargetCacheConfiguration) SetDiskCacheMode( /* IN */ DiskGuid string,
 ...
 /* IN */ Force bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDiskCacheMode" , DiskGuid, CacheMode, Flags, Originator, Force);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *MSFT_SBLTargetCacheConfiguration) SetDiskCacheHint( /* IN */ DiskGuid string,
 /* IN */ CacheHint uint32,
 /* IN */ Flags uint32,
 /* IN */ Originator uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDiskCacheHint" , DiskGuid, CacheHint, Flags, Originator);
	if err != nil { return }
	result = uint32(retVal)
	return
