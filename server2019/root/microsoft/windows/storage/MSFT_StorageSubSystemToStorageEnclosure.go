...
type MSFT_StorageSubSystemToStorageEnclosure struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSubSystemToStorageEnclosureEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSubSystemToStorageEnclosure, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSubSystemToStorageEnclosure, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
