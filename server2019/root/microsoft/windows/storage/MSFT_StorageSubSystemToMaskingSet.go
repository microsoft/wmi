...
type MSFT_StorageSubSystemToMaskingSet struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageSubSystemToMaskingSetEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageSubSystemToMaskingSet, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageSubSystemToMaskingSet, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
