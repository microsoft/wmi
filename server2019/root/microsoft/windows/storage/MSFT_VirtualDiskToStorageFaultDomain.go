...
type MSFT_VirtualDiskToStorageFaultDomain struct { 
	*cim.WmiInstance
	...
	func NewMSFT_VirtualDiskToStorageFaultDomainEx1(instance *cim.WmiInstance) (newInstance *MSFT_VirtualDiskToStorageFaultDomain, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_VirtualDiskToStorageFaultDomain, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
