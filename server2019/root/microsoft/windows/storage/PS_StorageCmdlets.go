...
type PS_StorageCmdlets struct { 
	*cim.WmiInstance
	...
	func NewPS_StorageCmdletsEx1(instance *cim.WmiInstance) (newInstance *PS_StorageCmdlets, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_StorageCmdlets, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *PS_StorageCmdlets) SetDisk( /* IN */ InputObject []MSFT_Disk,
 ...
 /* IN */ IsOffline bool,
 /* IN */ Signature uint32,
 /* IN */ Guid string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetDisk" , InputObject, UniqueId, Path, Number, PartitionStyle, IsReadOnly, IsOffline, Signature, Guid);
	if err != nil { return }
...
func (instance *PS_StorageCmdlets) SetVolume( /* IN */ InputObject []MSFT_Volume,
 ...
 /* IN */ DedupMode uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetVolume" , InputObject, UniqueId, Path, FileSystemLabel, DriveLetter, NewFileSystemLabel, DedupMode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_StorageCmdlets) SetPartition( /* IN */ InputObject []MSFT_Partition,
 ...
 /* IN */ IsDAX bool,
 /* IN */ MbrType uint16,
 /* IN */ GptType string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPartition" , InputObject, DiskId, Offset, DiskNumber, PartitionNumber, DriveLetter, NewDriveLetter, IsOffline, IsReadOnly, NoDefaultDriveLetter, IsActive, IsHidden, IsShadowCopy, IsDAX, MbrType, GptType);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_StorageCmdlets) SetPhysicalDisk( /* IN */ InputObject []MSFT_PhysicalDisk,
 ...
 /* IN */ IsHidden bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetPhysicalDisk" , InputObject, UniqueId, FriendlyName, NewFriendlyName, Description, Usage, MediaType, StorageEnclosureId, StorageScaleUnitId, IsHidden);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_StorageCmdlets) SetStorageTier( /* IN */ InputObject []MSFT_StorageTier,
 ...
 /* IN */ NumberOfColumns uint16,
 /* IN */ Interleave uint64,
 /* IN */ Description string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetStorageTier" , InputObject, UniqueId, FriendlyName, NewFriendlyName, ProvisioningType, AllocationUnitSize, MediaType, FaultDomainAwareness, ColumnIsolation, ResiliencySettingName, Usage, PhysicalDiskRedundancy, NumberOfDataCopies, NumberOfGroups, NumberOfColumns, Interleave, Description);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_StorageCmdlets) SetStorageSubSystem( /* IN */ InputObject []MSFT_StorageSubSystem,
 ...
 /* IN */ FaultDomainAwarenessDefault uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetStorageSubSystem" , InputObject, UniqueId, Name, FriendlyName, Description, AutomaticClusteringEnabled, VirtualDiskRepairEnabled, VirtualDiskRepairQueueDepth, FaultDomainAwarenessDefault);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_StorageCmdlets) AddPhysicalDisk( /* IN */ StoragePool MSFT_StoragePool,
 ...
 /* IN */ Usage uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddPhysicalDisk" , StoragePool, StoragePoolUniqueId, StoragePoolName, StoragePoolFriendlyName, VirtualDisk, VirtualDiskUniqueId, VirtualDiskName, VirtualDiskFriendlyName, PhysicalDisks, Usage);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_StorageCmdlets) RemovePhysicalDisk( /* IN */ StoragePool MSFT_StoragePool,
 ...
 /* IN */ VirtualDiskName string,
 /* IN */ VirtualDiskFriendlyName string,
 /* IN */ PhysicalDisks []MSFT_PhysicalDisk) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemovePhysicalDisk" , StoragePool, StoragePoolUniqueId, StoragePoolName, StoragePoolFriendlyName, VirtualDisk, VirtualDiskUniqueId, VirtualDiskName, VirtualDiskFriendlyName, PhysicalDisks);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *PS_StorageCmdlets) LaunchProviderHost( /* OUT */ ExtendedStatus MSFT_StorageExtendedStatus) (result uint32, err error) {retVal, err := instance.InvokeMethod("LaunchProviderHost" )
	if err != nil { return }
...
func (instance *PS_StorageCmdlets) SetFileShare( /* IN */ InputObject []MSFT_FileShare,
 ...
 /* IN */ Name string,
 /* IN */ Description string,
 /* IN */ EncryptData bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetFileShare" , InputObject, UniqueId, Name, Description, EncryptData);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *PS_StorageCmdlets) GetStorageReliabilityCounter( /* IN */ PhysicalDisk MSFT_PhysicalDisk,
 /* IN */ Disk MSFT_Disk,
 /* OUT */ StorageReliabilityCounter MSFT_StorageReliabilityCounter) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetStorageReliabilityCounter" , PhysicalDisk, Disk)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
