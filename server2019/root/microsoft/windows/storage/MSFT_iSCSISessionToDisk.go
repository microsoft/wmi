...
type MSFT_iSCSISessionToDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_iSCSISessionToDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_iSCSISessionToDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_iSCSISessionToDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
