...
type MSFT_iSCSITarget struct { 
	*cim.WmiInstance
	...
	func NewMSFT_iSCSITargetEx1(instance *cim.WmiInstance) (newInstance *MSFT_iSCSITarget, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_iSCSITarget, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_iSCSITarget) Disconnect( /* IN */ SessionIdentifier string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Disconnect" , SessionIdentifier);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *MSFT_iSCSITarget) Update() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Update" );
	if err != nil { return }
	result = uint32(retVal)
	return
