...
type MSFT_StorageEnclosureToPhysicalDisk struct { 
	*cim.WmiInstance
	...
	func NewMSFT_StorageEnclosureToPhysicalDiskEx1(instance *cim.WmiInstance) (newInstance *MSFT_StorageEnclosureToPhysicalDisk, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_StorageEnclosureToPhysicalDisk, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
