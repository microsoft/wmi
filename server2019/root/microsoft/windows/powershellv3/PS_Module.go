...
type PS_Module struct { 
	*CIM_ManagedElement
	...
	func NewPS_ModuleEx1(instance *cim.WmiInstance) (newInstance *PS_Module, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_Module, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
