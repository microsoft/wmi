...
type PS_ModuleFile struct { 
	*CIM_ManagedElement
	...
	func NewPS_ModuleFileEx1(instance *cim.WmiInstance) (newInstance *PS_ModuleFile, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *PS_ModuleFile, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
