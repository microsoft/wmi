...
type MSFT_WebResourceManager struct { 
	*OMI_ResourceModuleManager
	...
	func NewMSFT_WebResourceManagerEx1(instance *cim.WmiInstance) (newInstance *MSFT_WebResourceManager, err error) {tmp, err := NewOMI_ResourceModuleManagerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WebResourceManager, err error) {tmp, err := NewOMI_ResourceModuleManagerEx6(hostName, wmiNamespace, userName, password, domainName, query)
