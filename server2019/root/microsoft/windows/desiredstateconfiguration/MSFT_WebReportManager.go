...
type MSFT_WebReportManager struct { 
	*OMI_ReportManager
	...
	func NewMSFT_WebReportManagerEx1(instance *cim.WmiInstance) (newInstance *MSFT_WebReportManager, err error) {tmp, err := NewOMI_ReportManagerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_WebReportManager, err error) {tmp, err := NewOMI_ReportManagerEx6(hostName, wmiNamespace, userName, password, domainName, query)
