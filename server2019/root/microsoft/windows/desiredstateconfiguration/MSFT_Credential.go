...
type MSFT_Credential struct { 
	*cim.WmiInstance
	...
	func NewMSFT_CredentialEx1(instance *cim.WmiInstance) (newInstance *MSFT_Credential, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_Credential, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
