...
type MSFT_FileDownloadManager struct { 
	*OMI_ConfigurationDownloadManager
	...
	func NewMSFT_FileDownloadManagerEx1(instance *cim.WmiInstance) (newInstance *MSFT_FileDownloadManager, err error) {tmp, err := NewOMI_ConfigurationDownloadManagerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_FileDownloadManager, err error) {tmp, err := NewOMI_ConfigurationDownloadManagerEx6(hostName, wmiNamespace, userName, password, domainName, query)
