...
type MSFT_FileResourceManager struct { 
	*OMI_ResourceModuleManager
	...
	func NewMSFT_FileResourceManagerEx1(instance *cim.WmiInstance) (newInstance *MSFT_FileResourceManager, err error) {tmp, err := NewOMI_ResourceModuleManagerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_FileResourceManager, err error) {tmp, err := NewOMI_ResourceModuleManagerEx6(hostName, wmiNamespace, userName, password, domainName, query)
