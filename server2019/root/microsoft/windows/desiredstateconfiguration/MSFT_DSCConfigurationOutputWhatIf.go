...
type MSFT_DSCConfigurationOutputWhatIf struct { 
	*MSFT_DSCConfigurationOutput
	...
	func NewMSFT_DSCConfigurationOutputWhatIfEx1(instance *cim.WmiInstance) (newInstance *MSFT_DSCConfigurationOutputWhatIf, err error) {tmp, err := NewMSFT_DSCConfigurationOutputEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DSCConfigurationOutputWhatIf, err error) {tmp, err := NewMSFT_DSCConfigurationOutputEx6(hostName, wmiNamespace, userName, password, domainName, query)
