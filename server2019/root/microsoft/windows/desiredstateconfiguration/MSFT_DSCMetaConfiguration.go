...
type MSFT_DSCMetaConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMSFT_DSCMetaConfigurationEx1(instance *cim.WmiInstance) (newInstance *MSFT_DSCMetaConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DSCMetaConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
