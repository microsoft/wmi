...
type OMI_BaseResource struct { 
	*cim.WmiInstance
	...
	func NewOMI_BaseResourceEx1(instance *cim.WmiInstance) (newInstance *OMI_BaseResource, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *OMI_BaseResource, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
