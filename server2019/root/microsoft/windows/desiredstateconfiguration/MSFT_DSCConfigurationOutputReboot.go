...
type MSFT_DSCConfigurationOutputReboot struct { 
	*MSFT_DSCConfigurationOutput
	...
	func NewMSFT_DSCConfigurationOutputRebootEx1(instance *cim.WmiInstance) (newInstance *MSFT_DSCConfigurationOutputReboot, err error) {tmp, err := NewMSFT_DSCConfigurationOutputEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DSCConfigurationOutputReboot, err error) {tmp, err := NewMSFT_DSCConfigurationOutputEx6(hostName, wmiNamespace, userName, password, domainName, query)
