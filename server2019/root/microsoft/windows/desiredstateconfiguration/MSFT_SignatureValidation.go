...
type MSFT_SignatureValidation struct { 
	*OMI_MetaConfigurationResource
	...
	func NewMSFT_SignatureValidationEx1(instance *cim.WmiInstance) (newInstance *MSFT_SignatureValidation, err error) {tmp, err := NewOMI_MetaConfigurationResourceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SignatureValidation, err error) {tmp, err := NewOMI_MetaConfigurationResourceEx6(hostName, wmiNamespace, userName, password, domainName, query)
