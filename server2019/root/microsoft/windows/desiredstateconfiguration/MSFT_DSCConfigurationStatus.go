...
type MSFT_DSCConfigurationStatus struct { 
	*cim.WmiInstance
	...
	func NewMSFT_DSCConfigurationStatusEx1(instance *cim.WmiInstance) (newInstance *MSFT_DSCConfigurationStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_DSCConfigurationStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
