...
type OMI_MetaConfigurationResource struct { 
	*cim.WmiInstance
	...
	func NewOMI_MetaConfigurationResourceEx1(instance *cim.WmiInstance) (newInstance *OMI_MetaConfigurationResource, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *OMI_MetaConfigurationResource, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
