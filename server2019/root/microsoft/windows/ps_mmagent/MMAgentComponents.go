...
type MMAgentComponents struct { 
	*cim.WmiInstance
	...
	func NewMMAgentComponentsEx1(instance *cim.WmiInstance) (newInstance *MMAgentComponents, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MMAgentComponents, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
