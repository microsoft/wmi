...
type MSFT_PCSVLogRecord struct { 
	*CIM_LogRecord
	...
	func NewMSFT_PCSVLogRecordEx1(instance *cim.WmiInstance) (newInstance *MSFT_PCSVLogRecord, err error) {tmp, err := NewCIM_LogRecordEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_PCSVLogRecord, err error) {tmp, err := NewCIM_LogRecordEx6(hostName, wmiNamespace, userName, password, domainName, query)
