...
type CIM_PhysicalComputerSystemView struct { 
	*CIM_View
	...
	func NewCIM_PhysicalComputerSystemViewEx1(instance *cim.WmiInstance) (newInstance *CIM_PhysicalComputerSystemView, err error) {tmp, err := NewCIM_ViewEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_PhysicalComputerSystemView, err error) {tmp, err := NewCIM_ViewEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *CIM_PhysicalComputerSystemView) ClearLog( /* IN */ LogInstanceID string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ClearLog" , LogInstanceID);
	if err != nil { return }
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("InstallSoftwareFromURI", Action, PercentComplete, Timeout , Classifications, URI, InstallOptions, InstallOptionsValues)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifyPersistentBootConfigOrder", Action, PercentComplete, Timeout , StructuredBootString)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("SetOneTimeBootSource", Action, PercentComplete, Timeout , StructuredBootString)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
