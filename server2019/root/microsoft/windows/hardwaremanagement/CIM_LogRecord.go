...
type CIM_LogRecord struct { 
	*CIM_RecordForLog
	...
	func NewCIM_LogRecordEx1(instance *cim.WmiInstance) (newInstance *CIM_LogRecord, err error) {tmp, err := NewCIM_RecordForLogEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_LogRecord, err error) {tmp, err := NewCIM_RecordForLogEx6(hostName, wmiNamespace, userName, password, domainName, query)
