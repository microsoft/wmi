...
type CIM_Job struct { 
	*CIM_LogicalElement
	...
	func NewCIM_JobEx1(instance *cim.WmiInstance) (newInstance *CIM_Job, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Job, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *CIM_Job) KillJob( /* IN */ DeleteOnKill bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("KillJob" , DeleteOnKill);
	if err != nil { return }
