...
type HNet_PortMappingProtocol struct { 
	*cim.WmiInstance
	...
	func NewHNet_PortMappingProtocolEx1(instance *cim.WmiInstance) (newInstance *HNet_PortMappingProtocol, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_PortMappingProtocol, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
