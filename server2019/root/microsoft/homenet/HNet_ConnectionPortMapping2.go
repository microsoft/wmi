...
func NewHNet_ConnectionPortMapping2Ex1(instance *cim.WmiInstance) (newInstance *HNet_ConnectionPortMapping2, err error) {
...
func NewHNet_ConnectionPortMapping2Ex6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *HNet_ConnectionPortMapping2, err error) {
