...
type HNet_IcsSettings struct { 
	*cim.WmiInstance
	...
	func NewHNet_IcsSettingsEx1(instance *cim.WmiInstance) (newInstance *HNet_IcsSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_IcsSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
