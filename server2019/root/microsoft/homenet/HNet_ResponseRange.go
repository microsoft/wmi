...
type HNet_ResponseRange struct { 
	*cim.WmiInstance
	...
	func NewHNet_ResponseRangeEx1(instance *cim.WmiInstance) (newInstance *HNet_ResponseRange, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_ResponseRange, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
