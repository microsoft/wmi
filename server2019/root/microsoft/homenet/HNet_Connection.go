...
type HNet_Connection struct { 
	*cim.WmiInstance
	...
	func NewHNet_ConnectionEx1(instance *cim.WmiInstance) (newInstance *HNet_Connection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_Connection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
