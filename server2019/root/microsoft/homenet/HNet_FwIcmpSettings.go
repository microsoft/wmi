...
type HNet_FwIcmpSettings struct { 
	*cim.WmiInstance
	...
	func NewHNet_FwIcmpSettingsEx1(instance *cim.WmiInstance) (newInstance *HNet_FwIcmpSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_FwIcmpSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
