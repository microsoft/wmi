...
type HNet_FirewallLoggingSettings struct { 
	*cim.WmiInstance
	...
	func NewHNet_FirewallLoggingSettingsEx1(instance *cim.WmiInstance) (newInstance *HNet_FirewallLoggingSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_FirewallLoggingSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
