...
type HNet_BridgeMember struct { 
	*cim.WmiInstance
	...
	func NewHNet_BridgeMemberEx1(instance *cim.WmiInstance) (newInstance *HNet_BridgeMember, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_BridgeMember, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
