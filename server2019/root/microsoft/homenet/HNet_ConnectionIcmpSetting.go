...
type HNet_ConnectionIcmpSetting struct { 
	*cim.WmiInstance
	...
	func NewHNet_ConnectionIcmpSettingEx1(instance *cim.WmiInstance) (newInstance *HNet_ConnectionIcmpSetting, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_ConnectionIcmpSetting, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
