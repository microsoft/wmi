...
type HNet_ApplicationProtocol struct { 
	*cim.WmiInstance
	...
	func NewHNet_ApplicationProtocolEx1(instance *cim.WmiInstance) (newInstance *HNet_ApplicationProtocol, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_ApplicationProtocol, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
