...
type HNet_ConnectionProperties struct { 
	*cim.WmiInstance
	...
	func NewHNet_ConnectionPropertiesEx1(instance *cim.WmiInstance) (newInstance *HNet_ConnectionProperties, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *HNet_ConnectionProperties, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
