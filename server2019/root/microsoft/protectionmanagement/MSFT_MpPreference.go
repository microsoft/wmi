...
type MSFT_MpPreference struct { 
	*cim.WmiInstance
	...
	func NewMSFT_MpPreferenceEx1(instance *cim.WmiInstance) (newInstance *MSFT_MpPreference, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MpPreference, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
