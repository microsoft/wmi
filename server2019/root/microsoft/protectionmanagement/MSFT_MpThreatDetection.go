...
type MSFT_MpThreatDetection struct { 
	*BaseStatus
	...
	func NewMSFT_MpThreatDetectionEx1(instance *cim.WmiInstance) (newInstance *MSFT_MpThreatDetection, err error) {tmp, err := NewBaseStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_MpThreatDetection, err error) {tmp, err := NewBaseStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
