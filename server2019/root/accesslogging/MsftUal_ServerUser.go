...
type MsftUal_ServerUser struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_ServerUserEx1(instance *cim.WmiInstance) (newInstance *MsftUal_ServerUser, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_ServerUser, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
