...
type MsftUal_DeviceAccess struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_DeviceAccessEx1(instance *cim.WmiInstance) (newInstance *MsftUal_DeviceAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_DeviceAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
