...
type MsftUal_DailyUserAccess struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_DailyUserAccessEx1(instance *cim.WmiInstance) (newInstance *MsftUal_DailyUserAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_DailyUserAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
