...
type MsftUal_Dns struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_DnsEx1(instance *cim.WmiInstance) (newInstance *MsftUal_Dns, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_Dns, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
