...
type MsftUal_ServerDevice struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_ServerDeviceEx1(instance *cim.WmiInstance) (newInstance *MsftUal_ServerDevice, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_ServerDevice, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
