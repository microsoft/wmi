...
type MsftUal_UserAccess struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_UserAccessEx1(instance *cim.WmiInstance) (newInstance *MsftUal_UserAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_UserAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
