...
type MsftUal_DailyAccess struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_DailyAccessEx1(instance *cim.WmiInstance) (newInstance *MsftUal_DailyAccess, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_DailyAccess, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
