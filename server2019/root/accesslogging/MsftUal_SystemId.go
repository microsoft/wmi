...
type MsftUal_SystemId struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_SystemIdEx1(instance *cim.WmiInstance) (newInstance *MsftUal_SystemId, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_SystemId, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
