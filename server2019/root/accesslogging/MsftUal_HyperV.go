...
type MsftUal_HyperV struct { 
	*cim.WmiInstance
	...
	func NewMsftUal_HyperVEx1(instance *cim.WmiInstance) (newInstance *MsftUal_HyperV, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MsftUal_HyperV, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
