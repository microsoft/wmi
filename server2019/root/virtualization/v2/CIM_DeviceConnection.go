...
type CIM_DeviceConnection struct { 
	*CIM_Dependency
	...
	func NewCIM_DeviceConnectionEx1(instance *cim.WmiInstance) (newInstance *CIM_DeviceConnection, err error) {tmp, err := NewCIM_DependencyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_DeviceConnection, err error) {tmp, err := NewCIM_DependencyEx6(hostName, wmiNamespace, userName, password, domainName, query)
