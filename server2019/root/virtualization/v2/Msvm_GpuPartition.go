...
type Msvm_GpuPartition struct { 
	*CIM_LogicalDevice
	...
	func NewMsvm_GpuPartitionEx1(instance *cim.WmiInstance) (newInstance *Msvm_GpuPartition, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_GpuPartition, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
