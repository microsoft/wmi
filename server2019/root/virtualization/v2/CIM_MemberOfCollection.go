...
type CIM_MemberOfCollection struct { 
	*cim.WmiInstance
	...
	func NewCIM_MemberOfCollectionEx1(instance *cim.WmiInstance) (newInstance *CIM_MemberOfCollection, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_MemberOfCollection, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
