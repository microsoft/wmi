...
type Msvm_VirtualSystemMigrationServiceSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_VirtualSystemMigrationServiceSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemMigrationServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemMigrationServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
