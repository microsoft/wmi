...
type Msvm_VirtualEthernetSwitchSettingData struct { 
	*CIM_VirtualEthernetSwitchSettingData
	...
	func NewMsvm_VirtualEthernetSwitchSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualEthernetSwitchSettingData, err error) {tmp, err := NewCIM_VirtualEthernetSwitchSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualEthernetSwitchSettingData, err error) {tmp, err := NewCIM_VirtualEthernetSwitchSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
