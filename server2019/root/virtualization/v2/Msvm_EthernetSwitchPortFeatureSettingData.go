...
type Msvm_EthernetSwitchPortFeatureSettingData struct { 
	*Msvm_FeatureSettingData
	...
	func NewMsvm_EthernetSwitchPortFeatureSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPortFeatureSettingData, err error) {tmp, err := NewMsvm_FeatureSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchPortFeatureSettingData, err error) {tmp, err := NewMsvm_FeatureSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
