...
type Msvm_VirtualHardDiskSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_VirtualHardDiskSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualHardDiskSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualHardDiskSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
