...
type CIM_ControlledBy struct { 
	*CIM_DeviceConnection
	...
	func NewCIM_ControlledByEx1(instance *cim.WmiInstance) (newInstance *CIM_ControlledBy, err error) {tmp, err := NewCIM_DeviceConnectionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ControlledBy, err error) {tmp, err := NewCIM_DeviceConnectionEx6(hostName, wmiNamespace, userName, password, domainName, query)
