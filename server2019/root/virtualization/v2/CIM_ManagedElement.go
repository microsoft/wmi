...
type CIM_ManagedElement struct { 
	*cim.WmiInstance
	...
	func NewCIM_ManagedElementEx1(instance *cim.WmiInstance) (newInstance *CIM_ManagedElement, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_ManagedElement, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
