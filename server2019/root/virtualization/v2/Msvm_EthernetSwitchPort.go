...
type Msvm_EthernetSwitchPort struct { 
	*CIM_EthernetPort
	...
	func NewMsvm_EthernetSwitchPortEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPort, err error) {tmp, err := NewCIM_EthernetPortEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchPort, err error) {tmp, err := NewCIM_EthernetPortEx6(hostName, wmiNamespace, userName, password, domainName, query)
