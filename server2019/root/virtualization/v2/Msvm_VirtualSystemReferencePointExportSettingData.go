...
type Msvm_VirtualSystemReferencePointExportSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_VirtualSystemReferencePointExportSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemReferencePointExportSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemReferencePointExportSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
