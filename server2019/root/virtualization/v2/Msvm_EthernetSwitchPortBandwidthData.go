...
type Msvm_EthernetSwitchPortBandwidthData struct { 
	*Msvm_EthernetPortData
	...
	func NewMsvm_EthernetSwitchPortBandwidthDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPortBandwidthData, err error) {tmp, err := NewMsvm_EthernetPortDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchPortBandwidthData, err error) {tmp, err := NewMsvm_EthernetPortDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
