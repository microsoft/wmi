...
type Msvm_VirtualEthernetSwitchManagementService struct { 
	*CIM_VirtualSystemManagementService
	...
	func NewMsvm_VirtualEthernetSwitchManagementServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualEthernetSwitchManagementService, err error) {tmp, err := NewCIM_VirtualSystemManagementServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualEthernetSwitchManagementService, err error) {tmp, err := NewCIM_VirtualSystemManagementServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
