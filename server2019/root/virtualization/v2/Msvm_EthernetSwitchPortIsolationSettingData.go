...
type Msvm_EthernetSwitchPortIsolationSettingData struct { 
	*Msvm_EthernetSwitchPortFeatureSettingData
	...
	func NewMsvm_EthernetSwitchPortIsolationSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPortIsolationSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchPortIsolationSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
