...
type Msvm_MoveUnmanagedVhd struct { 
	*CIM_ManagedElement
	...
	func NewMsvm_MoveUnmanagedVhdEx1(instance *cim.WmiInstance) (newInstance *Msvm_MoveUnmanagedVhd, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_MoveUnmanagedVhd, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
