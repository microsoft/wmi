...
type Msvm_VirtualSystemSettingData struct { 
	*CIM_VirtualSystemSettingData
	...
	func NewMsvm_VirtualSystemSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemSettingData, err error) {tmp, err := NewCIM_VirtualSystemSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemSettingData, err error) {tmp, err := NewCIM_VirtualSystemSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
