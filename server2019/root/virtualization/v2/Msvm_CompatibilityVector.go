...
type Msvm_CompatibilityVector struct { 
	*cim.WmiInstance
	...
	func NewMsvm_CompatibilityVectorEx1(instance *cim.WmiInstance) (newInstance *Msvm_CompatibilityVector, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_CompatibilityVector, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
