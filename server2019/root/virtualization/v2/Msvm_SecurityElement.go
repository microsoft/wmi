...
type Msvm_SecurityElement struct { 
	*CIM_EnabledLogicalElement
	...
	func NewMsvm_SecurityElementEx1(instance *cim.WmiInstance) (newInstance *Msvm_SecurityElement, err error) {tmp, err := NewCIM_EnabledLogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SecurityElement, err error) {tmp, err := NewCIM_EnabledLogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
