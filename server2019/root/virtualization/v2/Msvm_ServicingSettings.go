...
type Msvm_ServicingSettings struct { 
	*cim.WmiInstance
	...
	func NewMsvm_ServicingSettingsEx1(instance *cim.WmiInstance) (newInstance *Msvm_ServicingSettings, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ServicingSettings, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
