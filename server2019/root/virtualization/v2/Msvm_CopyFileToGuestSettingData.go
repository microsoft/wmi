...
type Msvm_CopyFileToGuestSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_CopyFileToGuestSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_CopyFileToGuestSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_CopyFileToGuestSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
