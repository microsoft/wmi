...
const (
	...
	// COM1 enum
	VirtualSystemSettingData_ConsoleMode_COM1 VirtualSystemSettingData_ConsoleMode = 1
	// COM2 enum
	VirtualSystemSettingData_ConsoleMode_COM2 VirtualSystemSettingData_ConsoleMode = 2
	// None enum
