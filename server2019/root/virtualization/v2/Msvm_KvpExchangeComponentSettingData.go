...
type Msvm_KvpExchangeComponentSettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewMsvm_KvpExchangeComponentSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_KvpExchangeComponentSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_KvpExchangeComponentSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
