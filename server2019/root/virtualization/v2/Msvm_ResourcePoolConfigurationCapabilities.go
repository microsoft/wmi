...
type Msvm_ResourcePoolConfigurationCapabilities struct { 
	*CIM_Capabilities
	...
	func NewMsvm_ResourcePoolConfigurationCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_ResourcePoolConfigurationCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ResourcePoolConfigurationCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
