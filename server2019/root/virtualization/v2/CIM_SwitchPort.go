...
type CIM_SwitchPort struct { 
	*CIM_ProtocolEndpoint
	...
	func NewCIM_SwitchPortEx1(instance *cim.WmiInstance) (newInstance *CIM_SwitchPort, err error) {tmp, err := NewCIM_ProtocolEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_SwitchPort, err error) {tmp, err := NewCIM_ProtocolEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
