...
type Msvm_MemorySettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewMsvm_MemorySettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_MemorySettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_MemorySettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
