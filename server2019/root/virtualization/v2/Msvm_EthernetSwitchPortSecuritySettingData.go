...
type Msvm_EthernetSwitchPortSecuritySettingData struct { 
	*Msvm_EthernetSwitchPortFeatureSettingData
	...
	func NewMsvm_EthernetSwitchPortSecuritySettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPortSecuritySettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchPortSecuritySettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func  (instance* Msvm_EthernetSwitchPortSecuritySettingData) GetRelatedEthernetPortAllocationSettingData() (value *cim.WmiInstance, err error) {
