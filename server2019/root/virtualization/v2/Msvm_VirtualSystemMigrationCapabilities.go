...
type Msvm_VirtualSystemMigrationCapabilities struct { 
	*CIM_VirtualSystemMigrationCapabilities
	...
	func NewMsvm_VirtualSystemMigrationCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemMigrationCapabilities, err error) {tmp, err := NewCIM_VirtualSystemMigrationCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemMigrationCapabilities, err error) {tmp, err := NewCIM_VirtualSystemMigrationCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
