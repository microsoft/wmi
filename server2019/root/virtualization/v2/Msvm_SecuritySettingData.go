...
type Msvm_SecuritySettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_SecuritySettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_SecuritySettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SecuritySettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
