...
type Msvm_InternalEthernetPort struct { 
	*CIM_EthernetPort
	...
	func NewMsvm_InternalEthernetPortEx1(instance *cim.WmiInstance) (newInstance *Msvm_InternalEthernetPort, err error) {tmp, err := NewCIM_EthernetPortEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_InternalEthernetPort, err error) {tmp, err := NewCIM_EthernetPortEx6(hostName, wmiNamespace, userName, password, domainName, query)
