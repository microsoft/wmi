...
type Msvm_EthernetSwitchOperationalData struct { 
	*Msvm_EthernetSwitchData
	...
	func NewMsvm_EthernetSwitchOperationalDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchOperationalData, err error) {tmp, err := NewMsvm_EthernetSwitchDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchOperationalData, err error) {tmp, err := NewMsvm_EthernetSwitchDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
