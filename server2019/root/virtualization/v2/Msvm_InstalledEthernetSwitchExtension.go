...
type Msvm_InstalledEthernetSwitchExtension struct { 
	*CIM_ManagedSystemElement
	...
	func NewMsvm_InstalledEthernetSwitchExtensionEx1(instance *cim.WmiInstance) (newInstance *Msvm_InstalledEthernetSwitchExtension, err error) {tmp, err := NewCIM_ManagedSystemElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_InstalledEthernetSwitchExtension, err error) {tmp, err := NewCIM_ManagedSystemElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
