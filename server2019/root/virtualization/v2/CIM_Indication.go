...
type CIM_Indication struct { 
	*__ExtrinsicEvent
	...
	func NewCIM_IndicationEx1(instance *cim.WmiInstance) (newInstance *CIM_Indication, err error) {tmp, err := New__ExtrinsicEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_Indication, err error) {tmp, err := New__ExtrinsicEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
