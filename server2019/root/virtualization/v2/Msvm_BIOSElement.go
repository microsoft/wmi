...
type Msvm_BIOSElement struct { 
	*CIM_BIOSElement
	...
	func NewMsvm_BIOSElementEx1(instance *cim.WmiInstance) (newInstance *Msvm_BIOSElement, err error) {tmp, err := NewCIM_BIOSElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_BIOSElement, err error) {tmp, err := NewCIM_BIOSElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
