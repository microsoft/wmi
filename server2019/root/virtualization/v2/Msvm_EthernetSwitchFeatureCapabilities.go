...
type Msvm_EthernetSwitchFeatureCapabilities struct { 
	*CIM_Capabilities
	...
	func NewMsvm_EthernetSwitchFeatureCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchFeatureCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchFeatureCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
