...
const(
	...
	SwitchService_BridgeType_Transparent_only SwitchService_BridgeType = 2
	// SourceRoute_only enum
	SwitchService_BridgeType_SourceRoute_only SwitchService_BridgeType = 3
	// SRT enum
