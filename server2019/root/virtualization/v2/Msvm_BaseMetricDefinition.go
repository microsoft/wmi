...
type Msvm_BaseMetricDefinition struct { 
	*CIM_BaseMetricDefinition
	...
	func NewMsvm_BaseMetricDefinitionEx1(instance *cim.WmiInstance) (newInstance *Msvm_BaseMetricDefinition, err error) {tmp, err := NewCIM_BaseMetricDefinitionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_BaseMetricDefinition, err error) {tmp, err := NewCIM_BaseMetricDefinitionEx6(hostName, wmiNamespace, userName, password, domainName, query)
