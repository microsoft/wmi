...
type Msvm_TerminalServiceSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_TerminalServiceSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_TerminalServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_TerminalServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
