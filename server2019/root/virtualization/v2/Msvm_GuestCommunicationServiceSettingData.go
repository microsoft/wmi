...
type Msvm_GuestCommunicationServiceSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_GuestCommunicationServiceSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_GuestCommunicationServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_GuestCommunicationServiceSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
