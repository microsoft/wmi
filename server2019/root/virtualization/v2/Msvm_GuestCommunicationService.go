...
func NewMsvm_GuestCommunicationServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_GuestCommunicationService, err error) {
...
func NewMsvm_GuestCommunicationServiceEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_GuestCommunicationService, err error) {
...
func (instance *Msvm_GuestCommunicationService) GetRelatedGuestServiceInterfaceComponent() (value *cim.WmiInstance, err error) {
