...
type Msvm_WiFiEndpoint struct { 
	*CIM_WiFiEndpoint
	...
	func NewMsvm_WiFiEndpointEx1(instance *cim.WmiInstance) (newInstance *Msvm_WiFiEndpoint, err error) {tmp, err := NewCIM_WiFiEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_WiFiEndpoint, err error) {tmp, err := NewCIM_WiFiEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
