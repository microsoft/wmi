...
type Msvm_Synth3dVideoPool struct { 
	*CIM_ResourcePool
	...
	func NewMsvm_Synth3dVideoPoolEx1(instance *cim.WmiInstance) (newInstance *Msvm_Synth3dVideoPool, err error) {tmp, err := NewCIM_ResourcePoolEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_Synth3dVideoPool, err error) {tmp, err := NewCIM_ResourcePoolEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_Synth3dVideoPool) CalculateVideoMemoryRequirements( /* IN */ monitorResolution uint32,
 ...
 /* OUT */ requiredVideoMemory uint64) (result uint32, err error) {retVal, err := instance.InvokeMethod("CalculateVideoMemoryRequirements" , monitorResolution, numberOfMonitors)
	if err != nil { return }
