...
type CIM_MetricDefForME struct { 
	*CIM_Dependency
	...
	func NewCIM_MetricDefForMEEx1(instance *cim.WmiInstance) (newInstance *CIM_MetricDefForME, err error) {tmp, err := NewCIM_DependencyEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_MetricDefForME, err error) {tmp, err := NewCIM_DependencyEx6(hostName, wmiNamespace, userName, password, domainName, query)
