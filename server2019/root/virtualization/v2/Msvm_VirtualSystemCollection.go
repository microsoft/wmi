...
type Msvm_VirtualSystemCollection struct { 
	*CIM_CollectionOfMSEs
	...
	func NewMsvm_VirtualSystemCollectionEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemCollection, err error) {tmp, err := NewCIM_CollectionOfMSEsEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemCollection, err error) {tmp, err := NewCIM_CollectionOfMSEsEx6(hostName, wmiNamespace, userName, password, domainName, query)
