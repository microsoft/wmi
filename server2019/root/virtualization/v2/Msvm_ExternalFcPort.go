...
type Msvm_ExternalFcPort struct { 
	*CIM_FCPort
	...
	func NewMsvm_ExternalFcPortEx1(instance *cim.WmiInstance) (newInstance *Msvm_ExternalFcPort, err error) {tmp, err := NewCIM_FCPortEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ExternalFcPort, err error) {tmp, err := NewCIM_FCPortEx6(hostName, wmiNamespace, userName, password, domainName, query)
