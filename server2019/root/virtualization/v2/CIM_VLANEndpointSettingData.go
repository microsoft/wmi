...
type CIM_VLANEndpointSettingData struct { 
	*CIM_SettingData
	...
	func NewCIM_VLANEndpointSettingDataEx1(instance *cim.WmiInstance) (newInstance *CIM_VLANEndpointSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VLANEndpointSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
