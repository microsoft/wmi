...
type Msvm_VirtualSystemManagementCapabilities struct { 
	*CIM_VirtualSystemManagementCapabilities
	...
	func NewMsvm_VirtualSystemManagementCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemManagementCapabilities, err error) {tmp, err := NewCIM_VirtualSystemManagementCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemManagementCapabilities, err error) {tmp, err := NewCIM_VirtualSystemManagementCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
