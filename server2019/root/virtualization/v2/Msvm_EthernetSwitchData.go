...
type Msvm_EthernetSwitchData struct { 
	*CIM_ManagedElement
	...
	func NewMsvm_EthernetSwitchDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchData, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchData, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
