...
type Msvm_InteractiveSessionACE struct { 
	*cim.WmiInstance
	...
	func NewMsvm_InteractiveSessionACEEx1(instance *cim.WmiInstance) (newInstance *Msvm_InteractiveSessionACE, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_InteractiveSessionACE, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
