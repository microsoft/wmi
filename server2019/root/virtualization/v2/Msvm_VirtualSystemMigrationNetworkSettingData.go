...
type Msvm_VirtualSystemMigrationNetworkSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_VirtualSystemMigrationNetworkSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemMigrationNetworkSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemMigrationNetworkSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
