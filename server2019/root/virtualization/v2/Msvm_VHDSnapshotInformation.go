...
type Msvm_VHDSnapshotInformation struct { 
	*cim.WmiInstance
	...
	func NewMsvm_VHDSnapshotInformationEx1(instance *cim.WmiInstance) (newInstance *Msvm_VHDSnapshotInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VHDSnapshotInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
