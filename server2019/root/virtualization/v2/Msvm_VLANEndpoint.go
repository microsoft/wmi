...
type Msvm_VLANEndpoint struct { 
	*CIM_VLANEndpoint
	...
	func NewMsvm_VLANEndpointEx1(instance *cim.WmiInstance) (newInstance *Msvm_VLANEndpoint, err error) {tmp, err := NewCIM_VLANEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VLANEndpoint, err error) {tmp, err := NewCIM_VLANEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
