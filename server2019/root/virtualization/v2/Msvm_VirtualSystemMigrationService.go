...
func (instance *Msvm_VirtualSystemMigrationService) GetSystemCompatibilityVectors( /* IN */ ComputerSystem CIM_ComputerSystem,
 /* OUT */ CompatibilityVectors []Msvm_CompatibilityVector) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetSystemCompatibilityVectors" , ComputerSystem)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_VirtualSystemMigrationService) GetProcessorFeatureLimits( /* IN */ Options string,
 /* OUT */ CompatibilityVectors []Msvm_CompatibilityVector) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetProcessorFeatureLimits" , Options)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
