...
type CIM_AllocationCapabilities struct { 
	*CIM_Capabilities
	...
	func NewCIM_AllocationCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *CIM_AllocationCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AllocationCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
