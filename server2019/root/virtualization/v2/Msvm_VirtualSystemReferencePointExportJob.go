...
type Msvm_VirtualSystemReferencePointExportJob struct { 
	*CIM_ConcreteJob
	...
	func NewMsvm_VirtualSystemReferencePointExportJobEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemReferencePointExportJob, err error) {tmp, err := NewCIM_ConcreteJobEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemReferencePointExportJob, err error) {tmp, err := NewCIM_ConcreteJobEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_VirtualSystemReferencePointExportJob) GetErrorEx( /* OUT */ Errors []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetErrorEx" )
	if err != nil { return }
