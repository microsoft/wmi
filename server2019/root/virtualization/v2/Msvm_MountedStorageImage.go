...
type Msvm_MountedStorageImage struct { 
	*CIM_LogicalElement
	...
	func NewMsvm_MountedStorageImageEx1(instance *cim.WmiInstance) (newInstance *Msvm_MountedStorageImage, err error) {tmp, err := NewCIM_LogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_MountedStorageImage, err error) {tmp, err := NewCIM_LogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_MountedStorageImage) DetachVirtualHardDisk() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("DetachVirtualHardDisk" );
	if err != nil { return }
