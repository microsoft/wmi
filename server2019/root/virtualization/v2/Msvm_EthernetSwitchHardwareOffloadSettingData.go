...
type Msvm_EthernetSwitchHardwareOffloadSettingData struct { 
	*Msvm_EthernetSwitchFeatureSettingData
	...
	func NewMsvm_EthernetSwitchHardwareOffloadSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchHardwareOffloadSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchFeatureSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchHardwareOffloadSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchFeatureSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
