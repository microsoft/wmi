...
type Msvm_ReplicationSettingData struct { 
	*CIM_VirtualSystemSettingData
	...
	func NewMsvm_ReplicationSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_ReplicationSettingData, err error) {tmp, err := NewCIM_VirtualSystemSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ReplicationSettingData, err error) {tmp, err := NewCIM_VirtualSystemSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
