...
type CIM_AggregationMetricDefinition struct { 
	*CIM_BaseMetricDefinition
	...
	func NewCIM_AggregationMetricDefinitionEx1(instance *cim.WmiInstance) (newInstance *CIM_AggregationMetricDefinition, err error) {tmp, err := NewCIM_BaseMetricDefinitionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_AggregationMetricDefinition, err error) {tmp, err := NewCIM_BaseMetricDefinitionEx6(hostName, wmiNamespace, userName, password, domainName, query)
