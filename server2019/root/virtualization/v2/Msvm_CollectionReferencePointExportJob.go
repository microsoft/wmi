...
type Msvm_CollectionReferencePointExportJob struct { 
	*CIM_ConcreteJob
	...
	func NewMsvm_CollectionReferencePointExportJobEx1(instance *cim.WmiInstance) (newInstance *Msvm_CollectionReferencePointExportJob, err error) {tmp, err := NewCIM_ConcreteJobEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_CollectionReferencePointExportJob, err error) {tmp, err := NewCIM_ConcreteJobEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_CollectionReferencePointExportJob) GetErrorEx( /* OUT */ Errors []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetErrorEx" )
	if err != nil { return }
