...
type Msvm_LANEndpoint struct { 
	*CIM_LANEndpoint
	...
	func NewMsvm_LANEndpointEx1(instance *cim.WmiInstance) (newInstance *Msvm_LANEndpoint, err error) {tmp, err := NewCIM_LANEndpointEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_LANEndpoint, err error) {tmp, err := NewCIM_LANEndpointEx6(hostName, wmiNamespace, userName, password, domainName, query)
