...
type Msvm_NumaNode struct { 
	*CIM_EnabledLogicalElement
	...
	func NewMsvm_NumaNodeEx1(instance *cim.WmiInstance) (newInstance *Msvm_NumaNode, err error) {tmp, err := NewCIM_EnabledLogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_NumaNode, err error) {tmp, err := NewCIM_EnabledLogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
