...
type Msvm_VirtualEthernetSwitchManagementCapabilities struct { 
	*CIM_VirtualSystemManagementCapabilities
	...
	func NewMsvm_VirtualEthernetSwitchManagementCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualEthernetSwitchManagementCapabilities, err error) {tmp, err := NewCIM_VirtualSystemManagementCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualEthernetSwitchManagementCapabilities, err error) {tmp, err := NewCIM_VirtualSystemManagementCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
