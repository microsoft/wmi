...
type Msvm_Synthetic3DService struct { 
	*CIM_Service
	...
	func NewMsvm_Synthetic3DServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_Synthetic3DService, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_Synthetic3DService, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("EnableGPUForVirtualization", Action, PercentComplete, Timeout , PhysicalGPU)
	if err != nil { return }
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("DisableGPUForVirtualization", Action, PercentComplete, Timeout , PhysicalGPU)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
