...
type Msvm_FailoverNetworkAdapterSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_FailoverNetworkAdapterSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_FailoverNetworkAdapterSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_FailoverNetworkAdapterSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
