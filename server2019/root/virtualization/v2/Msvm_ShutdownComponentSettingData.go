...
type Msvm_ShutdownComponentSettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewMsvm_ShutdownComponentSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_ShutdownComponentSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ShutdownComponentSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
