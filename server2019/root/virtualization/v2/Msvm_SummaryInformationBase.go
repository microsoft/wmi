...
type Msvm_SummaryInformationBase struct { 
	*CIM_View
	...
	func NewMsvm_SummaryInformationBaseEx1(instance *cim.WmiInstance) (newInstance *Msvm_SummaryInformationBase, err error) {tmp, err := NewCIM_ViewEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SummaryInformationBase, err error) {tmp, err := NewCIM_ViewEx6(hostName, wmiNamespace, userName, password, domainName, query)
