...
type Msvm_VirtualSystemExportSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_VirtualSystemExportSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemExportSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemExportSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
