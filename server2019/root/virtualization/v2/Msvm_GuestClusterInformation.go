...
type Msvm_GuestClusterInformation struct { 
	*cim.WmiInstance
	...
	func NewMsvm_GuestClusterInformationEx1(instance *cim.WmiInstance) (newInstance *Msvm_GuestClusterInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_GuestClusterInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
