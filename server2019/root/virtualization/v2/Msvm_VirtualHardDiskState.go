...
type Msvm_VirtualHardDiskState struct { 
	*cim.WmiInstance
	...
	func NewMsvm_VirtualHardDiskStateEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualHardDiskState, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualHardDiskState, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
