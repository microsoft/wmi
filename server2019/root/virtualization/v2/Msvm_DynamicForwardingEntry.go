...
type Msvm_DynamicForwardingEntry struct { 
	*CIM_DynamicForwardingEntry
	...
	func NewMsvm_DynamicForwardingEntryEx1(instance *cim.WmiInstance) (newInstance *Msvm_DynamicForwardingEntry, err error) {tmp, err := NewCIM_DynamicForwardingEntryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_DynamicForwardingEntry, err error) {tmp, err := NewCIM_DynamicForwardingEntryEx6(hostName, wmiNamespace, userName, password, domainName, query)
