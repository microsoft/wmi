...
type Msvm_VHDSetInformation struct { 
	*cim.WmiInstance
	...
	func NewMsvm_VHDSetInformationEx1(instance *cim.WmiInstance) (newInstance *Msvm_VHDSetInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VHDSetInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
