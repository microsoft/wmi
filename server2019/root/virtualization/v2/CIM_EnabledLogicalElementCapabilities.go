...
type CIM_EnabledLogicalElementCapabilities struct { 
	*CIM_Capabilities
	...
	func NewCIM_EnabledLogicalElementCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *CIM_EnabledLogicalElementCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_EnabledLogicalElementCapabilities, err error) {tmp, err := NewCIM_CapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
