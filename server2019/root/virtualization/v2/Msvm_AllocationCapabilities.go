...
type Msvm_AllocationCapabilities struct { 
	*CIM_AllocationCapabilities
	...
	func NewMsvm_AllocationCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_AllocationCapabilities, err error) {tmp, err := NewCIM_AllocationCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_AllocationCapabilities, err error) {tmp, err := NewCIM_AllocationCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
