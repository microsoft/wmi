...
type Msvm_MetricServiceCapabilities struct { 
	*CIM_MetricServiceCapabilities
	...
	func NewMsvm_MetricServiceCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_MetricServiceCapabilities, err error) {tmp, err := NewCIM_MetricServiceCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_MetricServiceCapabilities, err error) {tmp, err := NewCIM_MetricServiceCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
