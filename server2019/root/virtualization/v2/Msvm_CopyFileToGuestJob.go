...
type Msvm_CopyFileToGuestJob struct { 
	*CIM_ConcreteJob
	...
	func NewMsvm_CopyFileToGuestJobEx1(instance *cim.WmiInstance) (newInstance *Msvm_CopyFileToGuestJob, err error) {tmp, err := NewCIM_ConcreteJobEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_CopyFileToGuestJob, err error) {tmp, err := NewCIM_ConcreteJobEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_CopyFileToGuestJob) GetErrorEx( /* OUT */ Errors []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetErrorEx" )
	if err != nil { return }
