...
type Msvm_GuestNetworkAdapterConfiguration struct { 
	*cim.WmiInstance
	...
	func NewMsvm_GuestNetworkAdapterConfigurationEx1(instance *cim.WmiInstance) (newInstance *Msvm_GuestNetworkAdapterConfiguration, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_GuestNetworkAdapterConfiguration, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
