...
type CIM_VirtualEthernetSwitchSettingData struct { 
	*CIM_VirtualSystemSettingData
	...
	func NewCIM_VirtualEthernetSwitchSettingDataEx1(instance *cim.WmiInstance) (newInstance *CIM_VirtualEthernetSwitchSettingData, err error) {tmp, err := NewCIM_VirtualSystemSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VirtualEthernetSwitchSettingData, err error) {tmp, err := NewCIM_VirtualSystemSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
