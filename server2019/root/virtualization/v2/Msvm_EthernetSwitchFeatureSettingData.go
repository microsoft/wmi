...
type Msvm_EthernetSwitchFeatureSettingData struct { 
	*Msvm_FeatureSettingData
	...
	func NewMsvm_EthernetSwitchFeatureSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchFeatureSettingData, err error) {tmp, err := NewMsvm_FeatureSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchFeatureSettingData, err error) {tmp, err := NewMsvm_FeatureSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
