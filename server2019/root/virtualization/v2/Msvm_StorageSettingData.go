...
type Msvm_StorageSettingData struct { 
	*Msvm_SystemComponentSettingData
	...
	func NewMsvm_StorageSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_StorageSettingData, err error) {tmp, err := NewMsvm_SystemComponentSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_StorageSettingData, err error) {tmp, err := NewMsvm_SystemComponentSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
