...
type Msvm_ResourcePoolSettingData struct { 
	*Msvm_AbstractResourcePoolSettingData
	...
	func NewMsvm_ResourcePoolSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_ResourcePoolSettingData, err error) {tmp, err := NewMsvm_AbstractResourcePoolSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ResourcePoolSettingData, err error) {tmp, err := NewMsvm_AbstractResourcePoolSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
