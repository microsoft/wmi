...
type Msvm_TerminalConnection struct { 
	*CIM_EnabledLogicalElement
	...
	func NewMsvm_TerminalConnectionEx1(instance *cim.WmiInstance) (newInstance *Msvm_TerminalConnection, err error) {tmp, err := NewCIM_EnabledLogicalElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_TerminalConnection, err error) {tmp, err := NewCIM_EnabledLogicalElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
