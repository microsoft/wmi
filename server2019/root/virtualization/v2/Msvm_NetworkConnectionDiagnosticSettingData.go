...
type Msvm_NetworkConnectionDiagnosticSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_NetworkConnectionDiagnosticSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_NetworkConnectionDiagnosticSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_NetworkConnectionDiagnosticSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
