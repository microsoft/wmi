...
type Msvm_TerminalService struct { 
	*CIM_Service
	...
	func NewMsvm_TerminalServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_TerminalService, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_TerminalService, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("GrantInteractiveSessionAccess", Action, PercentComplete, Timeout , ComputerSystem, Trustees)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RevokeInteractiveSessionAccess", Action, PercentComplete, Timeout , ComputerSystem, Trustees)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_TerminalService) GetInteractiveSessionACL( /* IN */ ComputerSystem CIM_ComputerSystem,
 /* OUT */ AccessControlList []string) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetInteractiveSessionACL" , ComputerSystem)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
