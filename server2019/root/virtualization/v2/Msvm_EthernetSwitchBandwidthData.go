...
type Msvm_EthernetSwitchBandwidthData struct { 
	*Msvm_EthernetSwitchData
	...
	func NewMsvm_EthernetSwitchBandwidthDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchBandwidthData, err error) {tmp, err := NewMsvm_EthernetSwitchDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchBandwidthData, err error) {tmp, err := NewMsvm_EthernetSwitchDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
