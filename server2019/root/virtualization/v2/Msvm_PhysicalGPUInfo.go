...
type Msvm_PhysicalGPUInfo struct { 
	*CIM_ManagedElement
	...
	func NewMsvm_PhysicalGPUInfoEx1(instance *cim.WmiInstance) (newInstance *Msvm_PhysicalGPUInfo, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_PhysicalGPUInfo, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
