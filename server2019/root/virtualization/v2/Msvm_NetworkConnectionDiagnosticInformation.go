...
type Msvm_NetworkConnectionDiagnosticInformation struct { 
	*cim.WmiInstance
	...
	func NewMsvm_NetworkConnectionDiagnosticInformationEx1(instance *cim.WmiInstance) (newInstance *Msvm_NetworkConnectionDiagnosticInformation, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_NetworkConnectionDiagnosticInformation, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
