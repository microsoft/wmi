...
const (
	...
	VirtualSystemManagementCapabilities_IndicationsSupported_ConcreteJobStateChangeIndicationsSupported VirtualSystemManagementCapabilities_IndicationsSupported = 3
	// VirtualSystemStateChangeIndicationsSupported enum
	VirtualSystemManagementCapabilities_IndicationsSupported_VirtualSystemStateChangeIndicationsSupported VirtualSystemManagementCapabilities_IndicationsSupported = 4
	// DMTF_Reserved enum
	VirtualSystemManagementCapabilities_IndicationsSupported_DMTF_Reserved VirtualSystemManagementCapabilities_IndicationsSupported = 5
