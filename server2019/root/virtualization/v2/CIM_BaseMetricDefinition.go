...
type CIM_BaseMetricDefinition struct { 
	*CIM_ManagedElement
	...
	func NewCIM_BaseMetricDefinitionEx1(instance *cim.WmiInstance) (newInstance *CIM_BaseMetricDefinition, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_BaseMetricDefinition, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
