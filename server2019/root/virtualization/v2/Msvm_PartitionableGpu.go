...
type Msvm_PartitionableGpu struct { 
	*CIM_ComputerSystem
	...
	func NewMsvm_PartitionableGpuEx1(instance *cim.WmiInstance) (newInstance *Msvm_PartitionableGpu, err error) {tmp, err := NewCIM_ComputerSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_PartitionableGpu, err error) {tmp, err := NewCIM_ComputerSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
