...
type Msvm_AggregationMetricDefinition struct { 
	*CIM_AggregationMetricDefinition
	...
	func NewMsvm_AggregationMetricDefinitionEx1(instance *cim.WmiInstance) (newInstance *Msvm_AggregationMetricDefinition, err error) {tmp, err := NewCIM_AggregationMetricDefinitionEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_AggregationMetricDefinition, err error) {tmp, err := NewCIM_AggregationMetricDefinitionEx6(hostName, wmiNamespace, userName, password, domainName, query)
