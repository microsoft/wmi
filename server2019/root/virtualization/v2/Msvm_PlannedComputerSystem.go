...
type Msvm_PlannedComputerSystem struct { 
	*CIM_ComputerSystem
	...
	func NewMsvm_PlannedComputerSystemEx1(instance *cim.WmiInstance) (newInstance *Msvm_PlannedComputerSystem, err error) {tmp, err := NewCIM_ComputerSystemEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_PlannedComputerSystem, err error) {tmp, err := NewCIM_ComputerSystemEx6(hostName, wmiNamespace, userName, password, domainName, query)
