...
type Msvm_DiskDrive struct { 
	*CIM_DiskDrive
	...
	func NewMsvm_DiskDriveEx1(instance *cim.WmiInstance) (newInstance *Msvm_DiskDrive, err error) {tmp, err := NewCIM_DiskDriveEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_DiskDrive, err error) {tmp, err := NewCIM_DiskDriveEx6(hostName, wmiNamespace, userName, password, domainName, query)
