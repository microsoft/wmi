...
type Msvm_SyntheticEthernetPortSettingData struct { 
	*CIM_EthernetPortAllocationSettingData
	...
	func NewMsvm_SyntheticEthernetPortSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_SyntheticEthernetPortSettingData, err error) {tmp, err := NewCIM_EthernetPortAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SyntheticEthernetPortSettingData, err error) {tmp, err := NewCIM_EthernetPortAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
