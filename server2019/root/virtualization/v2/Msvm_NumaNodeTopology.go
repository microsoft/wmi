...
type Msvm_NumaNodeTopology struct { 
	*CIM_ManagedElement
	...
	func NewMsvm_NumaNodeTopologyEx1(instance *cim.WmiInstance) (newInstance *Msvm_NumaNodeTopology, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_NumaNodeTopology, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
