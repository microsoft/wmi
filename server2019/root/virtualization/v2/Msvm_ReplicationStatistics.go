...
type Msvm_ReplicationStatistics struct { 
	*CIM_ManagedElement
	...
	func NewMsvm_ReplicationStatisticsEx1(instance *cim.WmiInstance) (newInstance *Msvm_ReplicationStatistics, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ReplicationStatistics, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
