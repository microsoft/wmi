...
type CIM_VirtualSystemManagementCapabilities struct { 
	*CIM_EnabledLogicalElementCapabilities
	...
	func NewCIM_VirtualSystemManagementCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *CIM_VirtualSystemManagementCapabilities, err error) {tmp, err := NewCIM_EnabledLogicalElementCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_VirtualSystemManagementCapabilities, err error) {tmp, err := NewCIM_EnabledLogicalElementCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
