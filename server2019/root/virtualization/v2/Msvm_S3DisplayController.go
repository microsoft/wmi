...
func NewMsvm_S3DisplayControllerEx1(instance *cim.WmiInstance) (newInstance *Msvm_S3DisplayController, err error) {
...
func NewMsvm_S3DisplayControllerEx6(hostName string,
	...
	password string,
	domainName string,
	query *query.WmiQuery) (newInstance *Msvm_S3DisplayController, err error) {
