...
type Msvm_SecurityService struct { 
	*CIM_Service
	...
	func NewMsvm_SecurityServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_SecurityService, err error) {tmp, err := NewCIM_ServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SecurityService, err error) {tmp, err := NewCIM_ServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("ModifySecuritySettings", Action, PercentComplete, Timeout , SecuritySettingData)
	if err != nil { return }
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("SetSecurityPolicy", Action, PercentComplete, Timeout , SecuritySettingData, SecurityPolicy)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("SetKeyProtector", Action, PercentComplete, Timeout , SecuritySettingData, KeyProtector)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
func (instance *Msvm_SecurityService) GetKeyProtector( /* IN */ SecuritySettingData string,
 /* OUT */ KeyProtector []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetKeyProtector" , SecuritySettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
...
/*Custom IN*/  Action cim.UserAction,
/*Custon IN*/  PercentComplete uint32,
/*Custon IN*/  Timeout uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodAsync("RestoreLastKnownGoodKeyProtector", Action, PercentComplete, Timeout , SecuritySettingData)
	if err != nil { return }
	retValue := retVal[0].(int32)
	result = uint32(retValue)
	return
