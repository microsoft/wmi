...
const (
	...
	// Not_Applicable enum
	PointingDevice_Handedness_Not_Applicable PointingDevice_Handedness = 1
	// Right_Handed_Operation enum
	PointingDevice_Handedness_Right_Handed_Operation PointingDevice_Handedness = 2
