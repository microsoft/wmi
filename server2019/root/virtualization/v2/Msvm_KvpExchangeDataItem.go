...
type Msvm_KvpExchangeDataItem struct { 
	*CIM_ManagedElement
	...
	func NewMsvm_KvpExchangeDataItemEx1(instance *cim.WmiInstance) (newInstance *Msvm_KvpExchangeDataItem, err error) {tmp, err := NewCIM_ManagedElementEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_KvpExchangeDataItem, err error) {tmp, err := NewCIM_ManagedElementEx6(hostName, wmiNamespace, userName, password, domainName, query)
