...
type Msvm_Keyboard struct { 
	*CIM_UserDevice
	...
	func NewMsvm_KeyboardEx1(instance *cim.WmiInstance) (newInstance *Msvm_Keyboard, err error) {tmp, err := NewCIM_UserDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_Keyboard, err error) {tmp, err := NewCIM_UserDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_Keyboard) PressKey( /* IN */ KeyCode uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("PressKey" , KeyCode);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_Keyboard) ReleaseKey( /* IN */ KeyCode uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ReleaseKey" , KeyCode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_Keyboard) TypeKey( /* IN */ KeyCode uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("TypeKey" , KeyCode);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Msvm_Keyboard) IsKeyPressed( /* IN */ KeyCode uint32,
 /* OUT */ KeyState bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("IsKeyPressed" , KeyCode)
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_Keyboard) TypeText( /* IN */ AsciiText string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("TypeText" , AsciiText);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_Keyboard) TypeCtrlAltDel() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("TypeCtrlAltDel" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_Keyboard) TypeScancodes( /* IN */ Scancodes []uint8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("TypeScancodes" , Scancodes);
	if err != nil { return }
	result = uint32(retVal)
	return
