...
type Msvm_TransparentBridgingService struct { 
	*CIM_TransparentBridgingService
	...
	func NewMsvm_TransparentBridgingServiceEx1(instance *cim.WmiInstance) (newInstance *Msvm_TransparentBridgingService, err error) {tmp, err := NewCIM_TransparentBridgingServiceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_TransparentBridgingService, err error) {tmp, err := NewCIM_TransparentBridgingServiceEx6(hostName, wmiNamespace, userName, password, domainName, query)
