...
type Msvm_WiFiPort struct { 
	*CIM_WiFiPort
	...
	func NewMsvm_WiFiPortEx1(instance *cim.WmiInstance) (newInstance *Msvm_WiFiPort, err error) {tmp, err := NewCIM_WiFiPortEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_WiFiPort, err error) {tmp, err := NewCIM_WiFiPortEx6(hostName, wmiNamespace, userName, password, domainName, query)
