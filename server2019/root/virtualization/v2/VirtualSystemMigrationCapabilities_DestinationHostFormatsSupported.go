...
const (
	...
	VirtualSystemMigrationCapabilities_DestinationHostFormatsSupported_IPv4DottedDecimalFormatSupported VirtualSystemMigrationCapabilities_DestinationHostFormatsSupported = 3
	// IPv6TextFormatSupported enum
	VirtualSystemMigrationCapabilities_DestinationHostFormatsSupported_IPv6TextFormatSupported VirtualSystemMigrationCapabilities_DestinationHostFormatsSupported = 4
	// DMTF_Reserved enum
