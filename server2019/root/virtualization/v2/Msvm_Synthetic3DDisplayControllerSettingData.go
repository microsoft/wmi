...
type Msvm_Synthetic3DDisplayControllerSettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewMsvm_Synthetic3DDisplayControllerSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_Synthetic3DDisplayControllerSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_Synthetic3DDisplayControllerSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
