...
type Msvm_KvpExchangeComponent struct { 
	*CIM_LogicalDevice
	...
	func NewMsvm_KvpExchangeComponentEx1(instance *cim.WmiInstance) (newInstance *Msvm_KvpExchangeComponent, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_KvpExchangeComponent, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
