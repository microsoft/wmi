...
type Msvm_Ps2Mouse struct { 
	*CIM_PointingDevice
	...
	func NewMsvm_Ps2MouseEx1(instance *cim.WmiInstance) (newInstance *Msvm_Ps2Mouse, err error) {tmp, err := NewCIM_PointingDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_Ps2Mouse, err error) {tmp, err := NewCIM_PointingDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_Ps2Mouse) GetButtonState( /* IN */ ButtonIndex uint32,
 /* OUT */ ButtonState bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetButtonState" , ButtonIndex)
	if err != nil { return }
...
func (instance *Msvm_Ps2Mouse) SetButtonState( /* IN */ ButtonIndex uint32,
 /* IN */ ButtonState bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetButtonState" , ButtonIndex, ButtonState);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_Ps2Mouse) ClickButton( /* IN */ ButtonIndex uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ClickButton" , ButtonIndex);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Msvm_Ps2Mouse) SetRelativePosition( /* IN */ HorizontalDelta int8,
 /* IN */ VerticalDelta int8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetRelativePosition" , HorizontalDelta, VerticalDelta);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_Ps2Mouse) SetScrollPosition( /* IN */ ScrollPositionDelta int8) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetScrollPosition" , ScrollPositionDelta);
	if err != nil { return }
	result = uint32(retVal)
	return
