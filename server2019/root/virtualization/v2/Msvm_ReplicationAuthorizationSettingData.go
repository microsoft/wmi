...
type Msvm_ReplicationAuthorizationSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_ReplicationAuthorizationSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_ReplicationAuthorizationSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ReplicationAuthorizationSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
