...
type Msvm_EthernetSwitchPortBandwidthSettingData struct { 
	*Msvm_EthernetSwitchPortFeatureSettingData
	...
	func NewMsvm_EthernetSwitchPortBandwidthSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPortBandwidthSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchPortBandwidthSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
