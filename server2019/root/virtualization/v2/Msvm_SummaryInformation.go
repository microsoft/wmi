...
type Msvm_SummaryInformation struct { 
	*Msvm_SummaryInformationBase
	...
	func NewMsvm_SummaryInformationEx1(instance *cim.WmiInstance) (newInstance *Msvm_SummaryInformation, err error) {tmp, err := NewMsvm_SummaryInformationBaseEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SummaryInformation, err error) {tmp, err := NewMsvm_SummaryInformationBaseEx6(hostName, wmiNamespace, userName, password, domainName, query)
