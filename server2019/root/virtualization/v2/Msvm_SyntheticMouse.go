...
type Msvm_SyntheticMouse struct { 
	*CIM_PointingDevice
	...
	func NewMsvm_SyntheticMouseEx1(instance *cim.WmiInstance) (newInstance *Msvm_SyntheticMouse, err error) {tmp, err := NewCIM_PointingDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SyntheticMouse, err error) {tmp, err := NewCIM_PointingDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *Msvm_SyntheticMouse) GetButtonState( /* IN */ ButtonIndex uint32,
 /* OUT */ IsDown bool) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetButtonState" , ButtonIndex)
	if err != nil { return }
...
func (instance *Msvm_SyntheticMouse) SetButtonState( /* IN */ ButtonIndex uint32,
 /* IN */ IsDown bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetButtonState" , ButtonIndex, IsDown);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_SyntheticMouse) ClickButton( /* IN */ ButtonIndex uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ClickButton" , ButtonIndex);
	if err != nil { return }
	result = uint32(retVal)
	return
...
func (instance *Msvm_SyntheticMouse) SetAbsolutePosition( /* IN */ HorizontalPosition int32,
 /* IN */ VerticalPosition int32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetAbsolutePosition" , HorizontalPosition, VerticalPosition);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *Msvm_SyntheticMouse) SetScrollPosition( /* IN */ ScrollPositionDelta int32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("SetScrollPosition" , ScrollPositionDelta);
	if err != nil { return }
	result = uint32(retVal)
	return
