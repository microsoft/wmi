...
type Msvm_EthernetSwitchPortTeamMappingSettingData struct { 
	*Msvm_EthernetSwitchPortFeatureSettingData
	...
	func NewMsvm_EthernetSwitchPortTeamMappingSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_EthernetSwitchPortTeamMappingSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_EthernetSwitchPortTeamMappingSettingData, err error) {tmp, err := NewMsvm_EthernetSwitchPortFeatureSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
