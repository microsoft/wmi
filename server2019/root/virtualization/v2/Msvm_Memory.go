...
type Msvm_Memory struct { 
	*CIM_Memory
	...
	func NewMsvm_MemoryEx1(instance *cim.WmiInstance) (newInstance *Msvm_Memory, err error) {tmp, err := NewCIM_MemoryEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_Memory, err error) {tmp, err := NewCIM_MemoryEx6(hostName, wmiNamespace, userName, password, domainName, query)
