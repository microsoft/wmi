...
type Msvm_SettingsDefineCapabilities struct { 
	*CIM_SettingsDefineCapabilities
	...
	func NewMsvm_SettingsDefineCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *Msvm_SettingsDefineCapabilities, err error) {tmp, err := NewCIM_SettingsDefineCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SettingsDefineCapabilities, err error) {tmp, err := NewCIM_SettingsDefineCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
