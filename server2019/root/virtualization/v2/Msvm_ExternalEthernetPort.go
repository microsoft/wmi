...
type Msvm_ExternalEthernetPort struct { 
	*CIM_EthernetPort
	...
	func NewMsvm_ExternalEthernetPortEx1(instance *cim.WmiInstance) (newInstance *Msvm_ExternalEthernetPort, err error) {tmp, err := NewCIM_EthernetPortEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_ExternalEthernetPort, err error) {tmp, err := NewCIM_EthernetPortEx6(hostName, wmiNamespace, userName, password, domainName, query)
