...
type Msvm_Physical3dGraphicsProcessor struct { 
	*CIM_LogicalDevice
	...
	func NewMsvm_Physical3dGraphicsProcessorEx1(instance *cim.WmiInstance) (newInstance *Msvm_Physical3dGraphicsProcessor, err error) {tmp, err := NewCIM_LogicalDeviceEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_Physical3dGraphicsProcessor, err error) {tmp, err := NewCIM_LogicalDeviceEx6(hostName, wmiNamespace, userName, password, domainName, query)
