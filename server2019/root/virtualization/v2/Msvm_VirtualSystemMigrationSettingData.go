...
type Msvm_VirtualSystemMigrationSettingData struct { 
	*CIM_VirtualSystemMigrationSettingData
	...
	func NewMsvm_VirtualSystemMigrationSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_VirtualSystemMigrationSettingData, err error) {tmp, err := NewCIM_VirtualSystemMigrationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_VirtualSystemMigrationSettingData, err error) {tmp, err := NewCIM_VirtualSystemMigrationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
