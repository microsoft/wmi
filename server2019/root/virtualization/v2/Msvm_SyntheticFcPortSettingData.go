...
type Msvm_SyntheticFcPortSettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewMsvm_SyntheticFcPortSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_SyntheticFcPortSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SyntheticFcPortSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
