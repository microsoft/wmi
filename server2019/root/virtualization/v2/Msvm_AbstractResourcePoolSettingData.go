...
type Msvm_AbstractResourcePoolSettingData struct { 
	*CIM_SettingData
	...
	func NewMsvm_AbstractResourcePoolSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_AbstractResourcePoolSettingData, err error) {tmp, err := NewCIM_SettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_AbstractResourcePoolSettingData, err error) {tmp, err := NewCIM_SettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
