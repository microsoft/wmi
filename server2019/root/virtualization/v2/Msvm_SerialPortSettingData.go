...
type Msvm_SerialPortSettingData struct { 
	*CIM_ResourceAllocationSettingData
	...
	func NewMsvm_SerialPortSettingDataEx1(instance *cim.WmiInstance) (newInstance *Msvm_SerialPortSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *Msvm_SerialPortSettingData, err error) {tmp, err := NewCIM_ResourceAllocationSettingDataEx6(hostName, wmiNamespace, userName, password, domainName, query)
