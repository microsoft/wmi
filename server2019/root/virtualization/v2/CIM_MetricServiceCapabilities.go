...
type CIM_MetricServiceCapabilities struct { 
	*CIM_EnabledLogicalElementCapabilities
	...
	func NewCIM_MetricServiceCapabilitiesEx1(instance *cim.WmiInstance) (newInstance *CIM_MetricServiceCapabilities, err error) {tmp, err := NewCIM_EnabledLogicalElementCapabilitiesEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CIM_MetricServiceCapabilities, err error) {tmp, err := NewCIM_EnabledLogicalElementCapabilitiesEx6(hostName, wmiNamespace, userName, password, domainName, query)
