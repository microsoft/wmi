...
type MSFT_Rule struct { 
	*cim.WmiInstance
	...
	func NewMSFT_RuleEx1(instance *cim.WmiInstance) (newInstance *MSFT_Rule, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_Rule, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
