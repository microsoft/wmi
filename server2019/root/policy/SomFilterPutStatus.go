...
type SomFilterPutStatus struct { 
	*__ExtendedStatus
	...
	func NewSomFilterPutStatusEx1(instance *cim.WmiInstance) (newInstance *SomFilterPutStatus, err error) {tmp, err := New__ExtendedStatusEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SomFilterPutStatus, err error) {tmp, err := New__ExtendedStatusEx6(hostName, wmiNamespace, userName, password, domainName, query)
