...
type MSFT_SomFilterStatus struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SomFilterStatusEx1(instance *cim.WmiInstance) (newInstance *MSFT_SomFilterStatus, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SomFilterStatus, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
