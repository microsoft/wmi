...
type MSFT_SomFilter struct { 
	*cim.WmiInstance
	...
	func NewMSFT_SomFilterEx1(instance *cim.WmiInstance) (newInstance *MSFT_SomFilter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *MSFT_SomFilter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *MSFT_SomFilter) Evaluate() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Evaluate" );
	if err != nil { return }
...
func (instance *MSFT_SomFilter) BatchEvaluate( /* IN */ filters []MSFT_SomFilter,
 /* OUT */ results []uint32) (result uint32, err error) {retVal, err := instance.InvokeMethod("BatchEvaluate" , filters)
	if err != nil { return }
