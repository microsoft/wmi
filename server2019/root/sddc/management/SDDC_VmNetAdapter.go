...
type SDDC_VmNetAdapter struct { 
	*cim.WmiInstance
	...
	func NewSDDC_VmNetAdapterEx1(instance *cim.WmiInstance) (newInstance *SDDC_VmNetAdapter, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_VmNetAdapter, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
