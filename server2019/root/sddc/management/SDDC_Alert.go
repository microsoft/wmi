...
type SDDC_Alert struct { 
	*cim.WmiInstance
	...
	func NewSDDC_AlertEx1(instance *cim.WmiInstance) (newInstance *SDDC_Alert, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Alert, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
