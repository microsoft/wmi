...
type SDDC_Server struct { 
	*cim.WmiInstance
	...
	func NewSDDC_ServerEx1(instance *cim.WmiInstance) (newInstance *SDDC_Server, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Server, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SDDC_Server) AddServer( /* IN */ ServerName string) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("AddServer" , ServerName);
	if err != nil { return }
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *SDDC_Server) RemoveServer() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("RemoveServer" );
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *SDDC_Server) PauseServer( /* IN */ DrainServer bool) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("PauseServer" , DrainServer);
	if err != nil { return }
	result = uint32(retVal)
	return
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *SDDC_Server) ResumeServer( /* IN */ FailbackType uint32) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("ResumeServer" , FailbackType);
	if err != nil { return }
	result = uint32(retVal)
	return
