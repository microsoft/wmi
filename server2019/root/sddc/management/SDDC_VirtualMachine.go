...
type SDDC_VirtualMachine struct { 
	*cim.WmiInstance
	...
	func NewSDDC_VirtualMachineEx1(instance *cim.WmiInstance) (newInstance *SDDC_VirtualMachine, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_VirtualMachine, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
// <param name="ReturnValue" type="uint32 "></param>
func (instance *SDDC_VirtualMachine) Refresh( /* IN */ RefreshType uint16) (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Refresh" , RefreshType);
	if err != nil { return }
