...
type SDDC_Metric struct { 
	*cim.WmiInstance
	...
	func NewSDDC_MetricEx1(instance *cim.WmiInstance) (newInstance *SDDC_Metric, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Metric, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
