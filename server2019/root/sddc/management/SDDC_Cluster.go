...
type SDDC_Cluster struct { 
	*cim.WmiInstance
	...
	func NewSDDC_ClusterEx1(instance *cim.WmiInstance) (newInstance *SDDC_Cluster, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Cluster, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
