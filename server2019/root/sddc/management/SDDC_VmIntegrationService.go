...
type SDDC_VmIntegrationService struct { 
	*cim.WmiInstance
	...
	func NewSDDC_VmIntegrationServiceEx1(instance *cim.WmiInstance) (newInstance *SDDC_VmIntegrationService, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_VmIntegrationService, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
