...
type SDDC_VolumeModificationTemplate struct { 
	*cim.WmiInstance
	...
	func NewSDDC_VolumeModificationTemplateEx1(instance *cim.WmiInstance) (newInstance *SDDC_VolumeModificationTemplate, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_VolumeModificationTemplate, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
