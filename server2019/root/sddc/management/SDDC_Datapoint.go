...
type SDDC_Datapoint struct { 
	*cim.WmiInstance
	...
	func NewSDDC_DatapointEx1(instance *cim.WmiInstance) (newInstance *SDDC_Datapoint, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Datapoint, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
