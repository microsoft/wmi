...
type SDDC_Vhd struct { 
	*cim.WmiInstance
	...
	func NewSDDC_VhdEx1(instance *cim.WmiInstance) (newInstance *SDDC_Vhd, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Vhd, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SDDC_Vhd) GetMetrics( /* IN */ FilePath string,
 ...
 /* IN */ TimeFrame uint16,
 /* OUT */ Metric SDDC_Metric) (result uint32, err error) {retVal, err := instance.InvokeMethod("GetMetrics" , FilePath, SeriesName, TimeFrame)
	if err != nil { return }
