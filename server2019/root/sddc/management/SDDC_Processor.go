...
type SDDC_Processor struct { 
	*cim.WmiInstance
	...
	func NewSDDC_ProcessorEx1(instance *cim.WmiInstance) (newInstance *SDDC_Processor, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Processor, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
