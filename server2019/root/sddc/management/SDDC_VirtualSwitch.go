...
type SDDC_VirtualSwitch struct { 
	*cim.WmiInstance
	...
	func NewSDDC_VirtualSwitchEx1(instance *cim.WmiInstance) (newInstance *SDDC_VirtualSwitch, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_VirtualSwitch, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
...
func (instance *SDDC_VirtualSwitch) Refresh() (result uint32, err error) {retVal, err := instance.InvokeMethodWithReturn("Refresh" );
	if err != nil { return }
