...
type SDDC_VmSnapshot struct { 
	*cim.WmiInstance
	...
	func NewSDDC_VmSnapshotEx1(instance *cim.WmiInstance) (newInstance *SDDC_VmSnapshot, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_VmSnapshot, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
