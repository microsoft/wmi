...
type SDDC_Job struct { 
	*cim.WmiInstance
	...
	func NewSDDC_JobEx1(instance *cim.WmiInstance) (newInstance *SDDC_Job, err error) {tmp, err := instance, nil
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *SDDC_Job, err error) {tmp, err := instance.GetWmiInstance(hostName, wmiNamespace, userName, password, domainName, query)
