...
type ActiveScriptEventConsumer struct { 
	*__EventConsumer
	...
	func NewActiveScriptEventConsumerEx1(instance *cim.WmiInstance) (newInstance *ActiveScriptEventConsumer, err error) {tmp, err := New__EventConsumerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *ActiveScriptEventConsumer, err error) {tmp, err := New__EventConsumerEx6(hostName, wmiNamespace, userName, password, domainName, query)
