...
type __CIMOMIdentification struct { 
	*__SystemClass
	...
	func New__CIMOMIdentificationEx1(instance *cim.WmiInstance) (newInstance *__CIMOMIdentification, err error) {tmp, err := New__SystemClassEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *__CIMOMIdentification, err error) {tmp, err := New__SystemClassEx6(hostName, wmiNamespace, userName, password, domainName, query)
