...
type CommandLineEventConsumer struct { 
	*__EventConsumer
	...
	func NewCommandLineEventConsumerEx1(instance *cim.WmiInstance) (newInstance *CommandLineEventConsumer, err error) {tmp, err := New__EventConsumerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *CommandLineEventConsumer, err error) {tmp, err := New__EventConsumerEx6(hostName, wmiNamespace, userName, password, domainName, query)
