...
type NTEventLogEventConsumer struct { 
	*__EventConsumer
	...
	func NewNTEventLogEventConsumerEx1(instance *cim.WmiInstance) (newInstance *NTEventLogEventConsumer, err error) {tmp, err := New__EventConsumerEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *NTEventLogEventConsumer, err error) {tmp, err := New__EventConsumerEx6(hostName, wmiNamespace, userName, password, domainName, query)
