...
type RegistryValueChangeEvent struct { 
	*RegistryEvent
	...
	func NewRegistryValueChangeEventEx1(instance *cim.WmiInstance) (newInstance *RegistryValueChangeEvent, err error) {tmp, err := NewRegistryEventEx1(instance)
	...
	password string,
	domainName string,
	query *query.WmiQuery ) (newInstance *RegistryValueChangeEvent, err error) {tmp, err := NewRegistryEventEx6(hostName, wmiNamespace, userName, password, domainName, query)
