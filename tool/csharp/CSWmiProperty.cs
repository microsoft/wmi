...
{
    public class CSWmiProperty : WmiProperty
    {
        public CSWmiProperty(PropertyData pData, CSWmiClass wClass) : base(pData, wClass)
        {
            HeaderComment = CSWmiSource.GetHeaderCommentText(pData.Qualifiers);
        ...
        public override string GetSourceCode()
        {
            ...
            sb.AppendFormat(CultureInfo.InvariantCulture,
                "public virtual {0} {2} {1}", Type, FixPropertyName(CSWmiMethod.FixName(Name)), IsArray ? "[]" : "");
            sb.AppendLine("{");
