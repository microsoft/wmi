...
const (
	...
	guestNetworkAdapterSettingDataQueryString = "SELECT * FROM __InstanceOperationEvent WITHIN 2 WHERE TargetInstance isa 'Msvm_GuestNetworkAdapterConfiguration' "
)
